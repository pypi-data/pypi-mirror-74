...
![PyPI - Downloads/month](https://img.shields.io/pypi/dm/spunkybot)

![Ubuntu package](https://img.shields.io/ubuntu/v/Spunkybot/spunkybot)
![Ubuntu package](https://img.shields.io/ubuntu/v/spunkybot)
![Ubuntu package](https://img.shields.io/ubuntu/v/spunkybot/1.12.0)
![Ubuntu package](https://img.shields.io/ubuntu/v/spunkybot/1.12.0-1)
![Ubuntu package](https://img.shields.io/ubuntu/v/spunkybot/master)
![Ubuntu package](https://img.shields.io/ubuntu/v/spunkybot/main)
![Ubuntu package](https://img.shields.io/ubuntu/v/spunkybot/1.12)
![Ubuntu package](https://img.shields.io/ubuntu/v/alexanderkress/spunkybot)
...
* Copy or rename the file `/conf/settings.sample.conf` to `/conf/settings.conf`
