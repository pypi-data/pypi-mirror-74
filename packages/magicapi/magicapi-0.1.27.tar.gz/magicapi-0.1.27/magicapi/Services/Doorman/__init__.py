...
token_url = "/token" if g.settings.local else f"/{g.settings.stage}/token"
...
@g.magic_router.post("/login_with_phone", tags=["Doorman"])
@need_doorman_vars
...
@g.magic_router.post("/token", tags=["Doorman"])
@need_doorman_vars
