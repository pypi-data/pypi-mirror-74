...
[boto3.GroundStation 1.14.21](https://boto3.amazonaws.com/v1/documentation/api/1.14.21/reference/services/groundstation.html#GroundStation) service
...
def get_structure() -> AntennaDownlinkConfigTypeDef:
    return {
      ...
    }
```
