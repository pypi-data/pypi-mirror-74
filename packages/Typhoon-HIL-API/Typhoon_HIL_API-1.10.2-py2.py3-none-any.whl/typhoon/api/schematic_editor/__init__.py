...
class SchematicAPI(SchematicAPIBase):
    ...
    def add_library_path(self, library_path, add_subdirs=False):
        ...
        **Example:**
        ...
        """
        return clstub().add_library_path(library_path=determine_path(
            library_path), add_subdirs=add_subdirs)
    ...
    def export_c_from_selection(self, comp_handles, output_dir):
        """
        .. deprecated:: 1.10.1
            This function is no longer supported, and will raise an error.
            Use ``export_c_from_subsystem`` instead.
        ...
        """
        raise Exception("Function 'export_c_from_selection' is no longer "
                        "supported and will be removed in future versions of "
                        "API. Please, use 'export_c_from_subsystem' instead.")
