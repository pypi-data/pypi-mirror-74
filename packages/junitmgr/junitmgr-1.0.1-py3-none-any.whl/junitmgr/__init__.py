...
class JUnitMgr(object):
    ...
    def load(self):
        ...
        self.test_suite = retobj.get('test_suite')
    ...
    def show_summary(self):
        ...
        for ts in self.test_suite:
            ...
            print("o tests : {}".format(self.test_suite.tests))
    ...
    def readXML(self, f):
        ...
        for t in test_cases:
            ...
            for child in t.iter():
                ...
                if child.tag == "skip" or child.tag == 'skipped':
                    tc.result = Skipped()
    ...
    def parseJUnit(file_name, options=None, parms=None):
        ...
        return {'summary': results, 'test_suite': test_suites}
