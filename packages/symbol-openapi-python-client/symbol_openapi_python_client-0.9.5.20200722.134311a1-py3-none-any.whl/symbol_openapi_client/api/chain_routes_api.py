...
class ChainRoutesApi(object):
    ...
    def get_chain_height(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_chain_height(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_chain_height_with_http_info(**kwargs)  # noqa: E501

    def get_chain_height_with_http_info(self, **kwargs):  # noqa: E501
        """Get the current height of the chain  # noqa: E501

        Returns the current height of the blockchain.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_chain_height_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(HeightInfoDTO, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_chain_height" % key
                )
        ...
        return self.api_client.call_api(
            ...
            response_type='HeightInfoDTO',  # noqa: E501
    ...
    def get_chain_score(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_chain_score(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: ChainScoreDTO
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.get_chain_score_with_http_info(**kwargs)  # noqa: E501
    ...
    def get_chain_score_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ChainScoreDTO',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
