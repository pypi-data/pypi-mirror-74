...
class TransactionRoutesApi(object):
    ...
    def search_confirmed_transactions(self, **kwargs):  # noqa: E501
        ...
        Returns an array of confirmed transactions.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str recipient_address: Address of an account receiving the transaction.
        :param str signer_public_key: Public key of the account signing the entity.
        ...
        :param bool embedded: When true, the endpoint also returns all the embedded aggregate transactions. Otherwise, only top-level transactions used to calcualate the block transactionsHash are returned. 
