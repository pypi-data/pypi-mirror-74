...
class Pagination(object):
    ...
    def __init__(self, page_number=None, page_size=None, total_entries=None, total_pages=None, local_vars_configuration=None):  # noqa: E501
    ...
    def total_entries(self, total_entries):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and total_entries is None:  # noqa: E501
            raise ValueError("Invalid value for `total_entries`, must not be `None`")  # noqa: E501
