...
setup(
  ...
  description = 'Implementation of beehive method for global optimization of multidimentional functions',   # Give a short description about your library
  ...
  keywords = ['beehive_method', 'optimization', 'function-optimization', 'stochastic-optimization'],   # Keywords that define your package best
