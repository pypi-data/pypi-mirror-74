...
class ContentPackagesApi(object):
    ...
    def create_with_http_info(self, relative_path, name, version, **kwargs):  # noqa: E501
        ...
        all_params = ['relative_path', 'name', 'version', 'artifact', 'file', 'repository']  # noqa: E501
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['ordering', 'name', 'name__in', 'repository_version', 'repository_version_added', 'repository_version_removed', 'limit', 'offset', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
