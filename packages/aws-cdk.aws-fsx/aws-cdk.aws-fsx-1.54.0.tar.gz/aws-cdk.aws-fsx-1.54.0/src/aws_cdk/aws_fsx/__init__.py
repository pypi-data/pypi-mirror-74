...
class CfnFileSystem(
    ...
    def __init__(
        ...
        *,
        ...
        lustre_configuration: typing.Optional[
            typing.Union["LustreConfigurationProperty", aws_cdk.core.IResolvable]
        ] = None,
        ...
        windows_configuration: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "WindowsConfigurationProperty"]
        ] = None,
    ) -> None:
    ...
    class WindowsConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            copy_tags_to_backups: typing.Optional[
            ...
            self_managed_active_directory_configuration: typing.Optional[
                typing.Union[
...
class CfnFileSystemProps:
    def __init__(
        ...
        *,
        ...
        lustre_configuration: typing.Optional[
            typing.Union[
                "CfnFileSystem.LustreConfigurationProperty", aws_cdk.core.IResolvable
            ]
        ] = None,
        security_group_ids: typing.Optional[typing.List[str]] = None,
        storage_capacity: typing.Optional[jsii.Number] = None,
        ...
        windows_configuration: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable, "CfnFileSystem.WindowsConfigurationProperty"
            ]
        ] = None,
    ) -> None:
...
class LustreMaintenanceTime(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-fsx.LustreMaintenanceTime"
):
