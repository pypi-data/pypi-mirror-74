...
class ScriptingNode(VisusDataflowPy.Node, GLObject):
    ...
    def setCode(self, code):
        return _VisusGuiPy.ScriptingNode_setCode(self, code)
...
class ViewerPreferences(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    default_panels = property(_VisusGuiPy.ViewerPreferences_default_panels_get, _VisusGuiPy.ViewerPreferences_default_panels_set)
    default_show_logos = property(_VisusGuiPy.ViewerPreferences_default_show_logos_get, _VisusGuiPy.ViewerPreferences_default_show_logos_set)
    title = property(_VisusGuiPy.ViewerPreferences_title_get, _VisusGuiPy.ViewerPreferences_title_set)
    panels = property(_VisusGuiPy.ViewerPreferences_panels_get, _VisusGuiPy.ViewerPreferences_panels_set)
    bHideTitleBar = property(_VisusGuiPy.ViewerPreferences_bHideTitleBar_get, _VisusGuiPy.ViewerPreferences_bHideTitleBar_set)
    bHideMenus = property(_VisusGuiPy.ViewerPreferences_bHideMenus_get, _VisusGuiPy.ViewerPreferences_bHideMenus_set)
    bRightHanded = property(_VisusGuiPy.ViewerPreferences_bRightHanded_get, _VisusGuiPy.ViewerPreferences_bRightHanded_set)
    screen_bounds = property(_VisusGuiPy.ViewerPreferences_screen_bounds_get, _VisusGuiPy.ViewerPreferences_screen_bounds_set)
    show_logos = property(_VisusGuiPy.ViewerPreferences_show_logos_get, _VisusGuiPy.ViewerPreferences_show_logos_set)
...
class Viewer(VisusDataflowPy.DataflowListener):
    ...
    def getBounds(self, node, bRecursive=False):
        return _VisusGuiPy.Viewer_getBounds(self, node, bRecursive)
    ...
    def computeNodeToNode(self, dst, src):
        return _VisusGuiPy.Viewer_computeNodeToNode(self, dst, src)

    def computeQueryBounds(self, query_node):
        return _VisusGuiPy.Viewer_computeQueryBounds(self, query_node)
    ...
    def addCpuTransferFunction(self, uuid, parent):
        return _VisusGuiPy.Viewer_addCpuTransferFunction(self, uuid, parent)
