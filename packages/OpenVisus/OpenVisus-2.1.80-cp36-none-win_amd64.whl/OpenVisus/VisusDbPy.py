...
class DatasetBitmask(object):
    ...
    @staticmethod
    def guess(dims, makeRegularAsSoonAsPossible=True):
...
class Dataset(object):
    ...
    def getDatasetBody(self, *args):
        return _VisusDbPy.Dataset_getDatasetBody(self, *args)
    ...
    def guessBoxQueryEndResolutions(self, logic_to_screen, logic_position, quality, progression):
        return _VisusDbPy.Dataset_guessBoxQueryEndResolutions(self, logic_to_screen, logic_position, quality, progression)
    ...
    def guessPointQueryEndResolutions(self, logic_to_screen, logic_position, quality, progression):
        return _VisusDbPy.Dataset_guessPointQueryEndResolutions(self, logic_to_screen, logic_position, quality, progression)
...
class IdxDataset(Dataset):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    idxfile = property(_VisusDbPy.IdxDataset_idxfile_get, _VisusDbPy.IdxDataset_idxfile_set)
    ...
    def getPointDim(self):
        return _VisusDbPy.IdxDataset_getPointDim(self)

    def createAccess(self, *args):
        return _VisusDbPy.IdxDataset_createAccess(self, *args)

    def createBlockQuery(self, *args):
        return _VisusDbPy.IdxDataset_createBlockQuery(self, *args)

    def convertBlockQueryToRowMajor(self, block_query):
        return _VisusDbPy.IdxDataset_convertBlockQueryToRowMajor(self, block_query)

    def beginBoxQuery(self, query):
        return _VisusDbPy.IdxDataset_beginBoxQuery(self, query)

    def nextBoxQuery(self, query):
        return _VisusDbPy.IdxDataset_nextBoxQuery(self, query)

    def executeBoxQuery(self, access, query):
        return _VisusDbPy.IdxDataset_executeBoxQuery(self, access, query)

    def createBoxQueryRequest(self, query):
        return _VisusDbPy.IdxDataset_createBoxQueryRequest(self, query)
    ...
    def createEquivalentBoxQuery(self, mode, block_query):
        return _VisusDbPy.IdxDataset_createEquivalentBoxQuery(self, mode, block_query)

    def adjustBoxQueryFilterBox(self, query, filter, box, H):
        return _VisusDbPy.IdxDataset_adjustBoxQueryFilterBox(self, query, filter, box, H)

    def createPointQuery(self, *args):
        return _VisusDbPy.IdxDataset_createPointQuery(self, *args)

    def guessPointQueryEndResolutions(self, logic_to_screen, logic_position, quality, progression):
        return _VisusDbPy.IdxDataset_guessPointQueryEndResolutions(self, logic_to_screen, logic_position, quality, progression)

    def guessPointQueryNumberOfSamples(self, logic_to_screen, logic_position, end_resolution):
        return _VisusDbPy.IdxDataset_guessPointQueryNumberOfSamples(self, logic_to_screen, logic_position, end_resolution)

    def beginPointQuery(self, query):
        return _VisusDbPy.IdxDataset_beginPointQuery(self, query)

    def executePointQuery(self, access, query):
        return _VisusDbPy.IdxDataset_executePointQuery(self, access, query)

    def nextPointQuery(self, query):
        return _VisusDbPy.IdxDataset_nextPointQuery(self, query)

    def compressDataset(self, *args):
        return _VisusDbPy.IdxDataset_compressDataset(self, *args)

    def createFilter(self, field):
        return _VisusDbPy.IdxDataset_createFilter(self, field)

    def computeFilter(self, *args):
        return _VisusDbPy.IdxDataset_computeFilter(self, *args)
...
class IdxMultipleDataset(IdxDataset):
    ...
    def createDownQuery(self, ACCESS, QUERY, dataset_name, fieldname):
        return _VisusDbPy.IdxMultipleDataset_createDownQuery(self, ACCESS, QUERY, dataset_name, fieldname)

    def executeDownQuery(self, QUERY, query):
        return _VisusDbPy.IdxMultipleDataset_executeDownQuery(self, QUERY, query)
