...
class VectorInt64(_object):
    ...
    def __init__(self, *args):
        this = _VisusKernelPy.new_VectorInt64(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
VectorInt64_swigregister = _VisusKernelPy.VectorInt64_swigregister
...
class StringTree(_object):
    ...
    __swig_setmethods__["childs"] = _VisusKernelPy.StringTree_childs_set
    __swig_getmethods__["childs"] = _VisusKernelPy.StringTree_childs_get
    if _newclass:
        childs = _swig_property(_VisusKernelPy.StringTree_childs_get, _VisusKernelPy.StringTree_childs_set)
...
class BoxNd(_object):
    ...
    if _newclass:
        getEdges = staticmethod(_VisusKernelPy.BoxNd_getEdges)
    else:
        getEdges = _VisusKernelPy.BoxNd_getEdges
...
BoxNd_getEdges = _VisusKernelPy.BoxNd_getEdges
...
class BoxNi(_object):
    ...
    if _newclass:
        getEdges = staticmethod(_VisusKernelPy.BoxNi_getEdges)
    else:
        getEdges = _VisusKernelPy.BoxNi_getEdges
...
BoxNi_getEdges = _VisusKernelPy.BoxNi_getEdges
...
class ArrayUtils(_object):
    ...
    if _newclass:
        applyTransferFunction = staticmethod(_VisusKernelPy.ArrayUtils_applyTransferFunction)
    else:
        applyTransferFunction = _VisusKernelPy.ArrayUtils_applyTransferFunction
...
ArrayUtils_applyTransferFunction = _VisusKernelPy.ArrayUtils_applyTransferFunction
...
class SingleTransferFunction(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["name"] = _VisusKernelPy.SingleTransferFunction_name_set
    __swig_getmethods__["name"] = _VisusKernelPy.SingleTransferFunction_name_get
    if _newclass:
        name = _swig_property(_VisusKernelPy.SingleTransferFunction_name_get, _VisusKernelPy.SingleTransferFunction_name_set)
    __swig_setmethods__["color"] = _VisusKernelPy.SingleTransferFunction_color_set
    __swig_getmethods__["color"] = _VisusKernelPy.SingleTransferFunction_color_get
    if _newclass:
        color = _swig_property(_VisusKernelPy.SingleTransferFunction_color_get, _VisusKernelPy.SingleTransferFunction_color_set)
...
class TransferFunction(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["functions"] = _VisusKernelPy.TransferFunction_functions_set
    __swig_getmethods__["functions"] = _VisusKernelPy.TransferFunction_functions_get
    if _newclass:
        functions = _swig_property(_VisusKernelPy.TransferFunction_functions_get, _VisusKernelPy.TransferFunction_functions_set)
    ...
    def __init__(self):
        this = _VisusKernelPy.new_TransferFunction()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    if _newclass:
        guessName = staticmethod(_VisusKernelPy.TransferFunction_guessName)
    else:
        guessName = _VisusKernelPy.TransferFunction_guessName
    if _newclass:
        guessColor = staticmethod(_VisusKernelPy.TransferFunction_guessColor)
    else:
        guessColor = _VisusKernelPy.TransferFunction_guessColor
...
TransferFunction_guessName = _VisusKernelPy.TransferFunction_guessName

def TransferFunction_guessColor(I):
    return _VisusKernelPy.TransferFunction_guessColor(I)
TransferFunction_guessColor = _VisusKernelPy.TransferFunction_guessColor
