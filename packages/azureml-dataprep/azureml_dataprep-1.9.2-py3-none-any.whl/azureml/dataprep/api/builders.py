...
from .engineapi.typedefinitions import (FieldInference, DataSourceProperties,
                                        ...
                                        ReplaceValueFunction, StringMissingReplacementOption, SummaryFunction, _get_prop_descriptions,
...
class ColumnTypesBuilder:
    ...
    def conversion_candidates(self) -> Dict[str, InferenceInfo]:
        ...
        .. remarks::
            ...
            * Tuple of :class:`FieldType.DATE <azureml.dataprep.FieldType>` and List of format strings (single format string is also supported) - user override for date conversions.
