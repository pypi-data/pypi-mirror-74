...
any Python environment, including Jupyter Notebooks or your favorite Python IDE. For examples of using the data
prep API, see https://github.com/microsoft/AMLDataPrepDocs.
"""
