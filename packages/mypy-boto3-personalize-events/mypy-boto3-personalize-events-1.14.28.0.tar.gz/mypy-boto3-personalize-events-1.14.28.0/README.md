...
[boto3.PersonalizeEvents 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/personalize-events.html#PersonalizeEvents) service
...
`mypy_boto3_personalize_events` and other installed services.
