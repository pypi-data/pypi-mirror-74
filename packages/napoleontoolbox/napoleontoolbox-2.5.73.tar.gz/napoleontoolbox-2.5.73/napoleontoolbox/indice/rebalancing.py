...
def to_hedged_euro(weight_data = None, rates_data = None):
    ...
    data['p_n_l_dollars'] = data['indice_usd'] .pct_change()

    data['indice_eur'] = data['indice_usd']/data['EUR-USD']

    data['indice_hedged_eur'] = data['indice_eur'] * data['EUR-USD'] / data['previous_EUR-USD']

    data['p_n_l_eurs'] = data['indice_eur'].pct_change()
