...
def proj_model(x_pol, y_pol, inc,
               dens_lum, sigma_lum, qintr_lum,
               dens_pot, sigma_pot, qintr_pot,
               beta, gamma, nrad, nang, nlos, epsrel, moment, align):
    """
...
class jam_axi_proj:
    ...
    .. code-block:: python
        ...
        jam = jam_axi_proj(
                ...
                plot=True, quiet=False, rbh=0.01, data=None, sigmapsf=0.,
                step=0., moment='zz', vmax=None, vmin=None, nlos=65,
                epsrel=1e-2, align='cyl', kwargs={})
    ...
    def __init__(self, surf_lum, sigma_lum, qobs_lum, surf_pot, sigma_pot, qobs_pot,
                 inc, mbh, distance, xbin, ybin, beta=None, gamma=None,
                 errors=None, flux_obs=None, goodbins=None, kappa=None, ml=None,
                 nang=10, normpsf=1., nrad=20, pixang=0., pixsize=0., plot=True,
                 quiet=False, rbh=0.01, data=None, sigmapsf=0., step=0.,
                 moment='zz', vmax=None, vmin=None, nlos=65, epsrel=1e-2,
                 align='cyl', **kwargs):
        ...
        if not quiet:
            print(f'jam_axi_{align}_{moment}_proj elapsed time sec: {clock() - t:.2f}')
