...
def copy_objects(src_bucket_name, tgt_bucket_name, file):
    if fds_client.does_object_exists(tgt_bucket_name, file):
        return
        
    fds_client.copy_object(src_bucket_name, file, tgt_bucket_name, file)
