...
class TestSandbox:
    ...
    def after_scenario(self, context, scenario):
        ...
        if hook_error:
            raise Exception("Exception during after_scenario hook")
    ...
    def start_recording(self):
        ...
        leftover_recording_processes = run(f"pgrep -fla qecore_start_recording").strip("\n")
    ...
    def set_background(self, color=None, background_image=None, background_image_revert=False):
        ...
        if self.background_image_revert:
            self.background_image_location = run(f"gsettings get org.gnome.desktop.background picture-uri").strip("\n")
