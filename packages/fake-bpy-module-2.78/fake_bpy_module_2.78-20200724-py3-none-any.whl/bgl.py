...
def glAccum(op: typing.Union[str, int], value: float):
    ''' Operate on the accumulation buffer.

    :param op: The accumulation buffer operation.
    :type op: typing.Union[str, int]
...
def glAlphaFunc(func: typing.Union[str, int], ref: float):
...
def glAreTexturesResident(
        n: int, textures: typing.Union['Buffer', 'bpy.context.object'],
        residences: typing.Union[bool, 'Buffer', 'bpy.context.object']):
    ...
    :type residences: typing.Union[bool, 'Buffer', 'bpy.context.object']
    '''
...
def glBegin(mode: typing.Union[str, int]):
...
def glBitmap(width: int, height: int, xorig: float, yorig: float, xmove: float,
             ymove: float,
             bitmap: typing.Union['Buffer', 'bpy.context.object']):
    ''' Draw a bitmap
    ...
    :type height: int
    :param xorig: Specify the location of the origin in the bitmap image. The origin is measured from the lower left corner of the bitmap, with right and up being the positive axes.
    :type xorig: float
    ...
    :type yorig: float
    :param xmove: Specify the x and y offsets to be added to the current raster position after the bitmap is drawn.
    :type xmove: float
    ...
    :type bitmap: typing.Union['Buffer', 'bpy.context.object']
    '''
...
def glCallLists(n: int, type: typing.Union[str, int],
                lists: typing.Union['Buffer', 'bpy.context.object']):
    ...
    :type lists: typing.Union['Buffer', 'bpy.context.object']
    '''
...
def glClearAccum(red: float, green: float, blue: float, alpha: float):
    ''' Specify clear values for the accumulation buffer

    :param red: Specify the red, green, blue, and alpha values used when the accumulation buffer is cleared. The initial values are all 0.
    :type red: float
    :param green: Specify the red, green, blue, and alpha values used when the accumulation buffer is cleared. The initial values are all 0.
    :type green: float
    :param blue: Specify the red, green, blue, and alpha values used when the accumulation buffer is cleared. The initial values are all 0.
    :type blue: float
...
def glColorMaterial(face: typing.Union[str, int],
...
def glCopyPixels(x: int, y: int, width: int, height: int,
    ...
    :type x: int
    :param y: Specify the window coordinates of the lower left corner of the rectangular region of pixels to be copied.
    :type y: int
    :param width: Specify the dimensions of the rectangular region of pixels to be copied. Both must be non-negative.
    :type width: int
    :param height: Specify the dimensions of the rectangular region of pixels to be copied. Both must be non-negative.
    :type height: int
...
def glDrawPixels(width: int, height: int, format: typing.Union[str, int],
                 type: typing.Union[str, int],
                 pixels: typing.Union['Buffer', 'bpy.context.object']):
    ''' Write a block of pixels to the frame buffer

    :param width: Specify the dimensions of the pixel rectangle to be written into the frame buffer.
    :type width: int
...
def glFrustum(left: float, right: float, bottom: float, top: float,
...
def glGetClipPlane(plane: typing.Union[str, int],
                   equation: typing.Union['Buffer', 'bpy.context.object']):
...
def glGetPolygonStipple(mask: typing.Union['Buffer', 'bpy.context.object']):
    ''' Return the polygon stipple pattern

    :param mask: Returns the stipple pattern. The initial value is all 1's.
    :type mask: typing.Union['Buffer', 'bpy.context.object']
    '''
...
def glIndex(c: 'Buffer'):
    ''' B{glIndexd, glIndexf, glIndexi, glIndexs, glIndexdv, glIndexfv, glIndexiv, glIndexsv} Set the current color index
...
def glMatrixMode(mode: typing.Union[str, int]):
...
def glNewList(list: int, mode: typing.Union[str, int]):
    ''' Create or replace a display list
...
def glOrtho(left: float, right: float, bottom: float, top: float, zNear: float,
            zFar: float):
...
def glPixelZoom(xfactor: float, yfactor: float):
...
def glPolygonStipple(mask: typing.Union['Buffer', 'bpy.context.object']):
...
def glRenderMode(mode: typing.Union[str, int]):
...
def glShadeModel(mode: typing.Union[str, int]):
...
def glVertex(x, y, z, w, v: 'Buffer'):
    ''' B{glVertex2d, glVertex2f, glVertex2i, glVertex2s, glVertex3d, glVertex3f, glVertex3i, glVertex3s, glVertex4d, glVertex4f, glVertex4i, glVertex4s, glVertex2dv, glVertex2fv, glVertex2iv, glVertex2sv, glVertex3dv, glVertex3fv, glVertex3iv, glVertex3sv, glVertex4dv, glVertex4fv, glVertex4iv, glVertex4sv} Specify a vertex

    :param x: Specify x, y, z, and w coordinates of a vertex. Not all parameters are present in all forms of the command.
    :param y: Specify x, y, z, and w coordinates of a vertex. Not all parameters are present in all forms of the command.
    :param z: Specify x, y, z, and w coordinates of a vertex. Not all parameters are present in all forms of the command.
...
def gluProject(objx, objy, objz, modelMatrix: 'Buffer', projMatrix: 'Buffer',
               viewport: 'Buffer', winx: 'Buffer', winy: 'Buffer',
               winz: 'Buffer'):
    ''' Map object coordinates to window coordinates.

    :param objx: Specify the object coordinates.
    :param objy: Specify the object coordinates.
    ...
    :type winx: 'Buffer'
    :param winy: Return the computed window coordinates.
    :type winy: 'Buffer'
...
def gluUnProject(winx, winy, winz, modelMatrix: 'Buffer', projMatrix: 'Buffer',
                 viewport: 'Buffer', objx: 'Buffer', objy: 'Buffer',
                 objz: 'Buffer'):
    ''' Map object coordinates to window coordinates.

    :param winx: Specify the window coordinates to be mapped.
    :param winy: Specify the window coordinates to be mapped.
    ...
    :type objx: 'Buffer'
    :param objy: Return the computed object coordinates.
    :type objy: 'Buffer'
...
GL_2_BYTES: float = None

GL_3D: float = None

GL_3D_COLOR: float = None

GL_3D_COLOR_TEXTURE: float = None

GL_3_BYTES: float = None

GL_4D_COLOR_TEXTURE: float = None

GL_4_BYTES: float = None

GL_ACCUM: float = None

GL_ACCUM_ALPHA_BITS: float = None

GL_ACCUM_BLUE_BITS: float = None

GL_ACCUM_BUFFER_BIT: float = None

GL_ACCUM_CLEAR_VALUE: float = None

GL_ACCUM_GREEN_BITS: float = None

GL_ACCUM_RED_BITS: float = None
...
GL_ADD_SIGNED: float = None

GL_ALIASED_LINE_WIDTH_RANGE: float = None

GL_ALIASED_POINT_SIZE_RANGE: float = None

GL_ALL_ATTRIB_BITS: float = None

GL_ALPHA: float = None

GL_ALPHA12: float = None

GL_ALPHA16: float = None

GL_ALPHA4: float = None

GL_ALPHA8: float = None

GL_ALPHA_BIAS: float = None

GL_ALPHA_BITS: float = None

GL_ALPHA_INTEGER: float = None

GL_ALPHA_SCALE: float = None

GL_ALPHA_TEST: float = None

GL_ALPHA_TEST_FUNC: float = None

GL_ALPHA_TEST_REF: float = None

GL_ALREADY_SIGNALED: float = None

GL_ALWAYS: float = None

GL_AMBIENT: float = None

GL_AMBIENT_AND_DIFFUSE: float = None
...
GL_ATTRIB_STACK_DEPTH: float = None

GL_AUTO_NORMAL: float = None
...
GL_BITMAP: float = None

GL_BITMAP_TOKEN: float = None
...
GL_BLUE_BIAS: float = None

GL_BLUE_BITS: float = None

GL_BLUE_INTEGER: float = None

GL_BLUE_SCALE: float = None
...
GL_C3F_V3F: float = None

GL_C4F_N3F_V3F: float = None

GL_C4UB_V2F: float = None

GL_C4UB_V3F: float = None

GL_CCW: float = None

GL_CLAMP: float = None

GL_CLAMP_FRAGMENT_COLOR: float = None
...
GL_CLAMP_VERTEX_COLOR: float = None

GL_CLEAR: float = None

GL_CLIENT_ACTIVE_TEXTURE: float = None

GL_CLIENT_ALL_ATTRIB_BITS: float = None

GL_CLIENT_ATTRIB_STACK_DEPTH: float = None

GL_CLIENT_PIXEL_STORE_BIT: float = None

GL_CLIENT_VERTEX_ARRAY_BIT: float = None
...
GL_CLIP_PLANE0: float = None

GL_CLIP_PLANE1: float = None

GL_CLIP_PLANE2: float = None

GL_CLIP_PLANE3: float = None

GL_CLIP_PLANE4: float = None

GL_CLIP_PLANE5: float = None

GL_COEFF: float = None

GL_COLOR: float = None

GL_COLOR_ARRAY: float = None

GL_COLOR_ARRAY_BUFFER_BINDING: float = None

GL_COLOR_ARRAY_POINTER: float = None

GL_COLOR_ARRAY_SIZE: float = None

GL_COLOR_ARRAY_STRIDE: float = None

GL_COLOR_ARRAY_TYPE: float = None
...
GL_COLOR_INDEX: float = None

GL_COLOR_INDEXES: float = None

GL_COLOR_LOGIC_OP: float = None

GL_COLOR_MATERIAL: float = None

GL_COLOR_MATERIAL_FACE: float = None

GL_COLOR_MATERIAL_PARAMETER: float = None

GL_COLOR_SUM: float = None

GL_COLOR_WRITEMASK: float = None

GL_COMBINE: float = None

GL_COMBINE_ALPHA: float = None

GL_COMBINE_RGB: float = None

GL_COMPARE_REF_TO_TEXTURE: float = None

GL_COMPARE_R_TO_TEXTURE: float = None

GL_COMPILE: float = None

GL_COMPILE_AND_EXECUTE: float = None

GL_COMPILE_STATUS: float = None

GL_COMPRESSED_ALPHA: float = None

GL_COMPRESSED_INTENSITY: float = None

GL_COMPRESSED_LUMINANCE: float = None

GL_COMPRESSED_LUMINANCE_ALPHA: float = None
...
GL_COMPRESSED_SLUMINANCE: float = None

GL_COMPRESSED_SLUMINANCE_ALPHA: float = None
...
GL_CONSTANT: float = None

GL_CONSTANT_ALPHA: float = None

GL_CONSTANT_ATTENUATION: float = None
...
GL_COORD_REPLACE: float = None

GL_COPY: float = None

GL_COPY_INVERTED: float = None

GL_COPY_PIXEL_TOKEN: float = None
...
GL_CURRENT_BIT: float = None

GL_CURRENT_COLOR: float = None

GL_CURRENT_FOG_COORD: float = None

GL_CURRENT_FOG_COORDINATE: float = None

GL_CURRENT_INDEX: float = None

GL_CURRENT_NORMAL: float = None

GL_CURRENT_PROGRAM: float = None

GL_CURRENT_QUERY: float = None

GL_CURRENT_RASTER_COLOR: float = None

GL_CURRENT_RASTER_DISTANCE: float = None

GL_CURRENT_RASTER_INDEX: float = None

GL_CURRENT_RASTER_POSITION: float = None

GL_CURRENT_RASTER_POSITION_VALID: float = None

GL_CURRENT_RASTER_SECONDARY_COLOR: float = None

GL_CURRENT_RASTER_TEXTURE_COORDS: float = None

GL_CURRENT_SECONDARY_COLOR: float = None

GL_CURRENT_TEXTURE_COORDS: float = None
...
GL_DEPTH_BIAS: float = None

GL_DEPTH_BITS: float = None
...
GL_DEPTH_TEXTURE_MODE: float = None

GL_DEPTH_WRITEMASK: float = None

GL_DIFFUSE: float = None

GL_DITHER: float = None

GL_DOMAIN: float = None

GL_DONT_CARE: float = None

GL_DOT3_RGB: float = None

GL_DOT3_RGBA: float = None
...
GL_DRAW_PIXEL_TOKEN: float = None
...
GL_EDGE_FLAG: float = None

GL_EDGE_FLAG_ARRAY: float = None

GL_EDGE_FLAG_ARRAY_BUFFER_BINDING: float = None

GL_EDGE_FLAG_ARRAY_POINTER: float = None

GL_EDGE_FLAG_ARRAY_STRIDE: float = None

GL_ELEMENT_ARRAY_BUFFER: float = None

GL_ELEMENT_ARRAY_BUFFER_BINDING: float = None

GL_EMISSION: float = None

GL_ENABLE_BIT: float = None

GL_EQUAL: float = None

GL_EQUIV: float = None

GL_EVAL_BIT: float = None
...
GL_EYE_LINEAR: float = None

GL_EYE_PLANE: float = None

GL_FALSE: float = None

GL_FASTEST: float = None

GL_FEEDBACK: float = None

GL_FEEDBACK_BUFFER_POINTER: float = None

GL_FEEDBACK_BUFFER_SIZE: float = None

GL_FEEDBACK_BUFFER_TYPE: float = None
...
GL_FOG_BIT: float = None

GL_FOG_COLOR: float = None

GL_FOG_COORD: float = None

GL_FOG_COORDINATE: float = None

GL_FOG_COORDINATE_ARRAY: float = None

GL_FOG_COORDINATE_ARRAY_BUFFER_BINDING: float = None

GL_FOG_COORDINATE_ARRAY_POINTER: float = None

GL_FOG_COORDINATE_ARRAY_STRIDE: float = None

GL_FOG_COORDINATE_ARRAY_TYPE: float = None

GL_FOG_COORDINATE_SOURCE: float = None

GL_FOG_COORD_ARRAY: float = None

GL_FOG_COORD_ARRAY_BUFFER_BINDING: float = None

GL_FOG_COORD_ARRAY_POINTER: float = None

GL_FOG_COORD_ARRAY_STRIDE: float = None

GL_FOG_COORD_ARRAY_TYPE: float = None

GL_FOG_COORD_SRC: float = None

GL_FOG_DENSITY: float = None

GL_FOG_END: float = None

GL_FOG_HINT: float = None

GL_FOG_INDEX: float = None

GL_FOG_MODE: float = None

GL_FOG_START: float = None

GL_FRAGMENT_DEPTH: float = None
...
GL_GENERATE_MIPMAP: float = None

GL_GENERATE_MIPMAP_HINT: float = None
...
GL_GREEN_BIAS: float = None

GL_GREEN_BITS: float = None

GL_GREEN_INTEGER: float = None

GL_GREEN_SCALE: float = None

GL_HALF_FLOAT: float = None

GL_HINT_BIT: float = None
...
GL_INDEX_ARRAY: float = None

GL_INDEX_ARRAY_BUFFER_BINDING: float = None

GL_INDEX_ARRAY_POINTER: float = None

GL_INDEX_ARRAY_STRIDE: float = None

GL_INDEX_ARRAY_TYPE: float = None

GL_INDEX_BITS: float = None

GL_INDEX_CLEAR_VALUE: float = None

GL_INDEX_LOGIC_OP: float = None

GL_INDEX_MODE: float = None

GL_INDEX_OFFSET: float = None

GL_INDEX_SHIFT: float = None

GL_INDEX_WRITEMASK: float = None

GL_INFO_LOG_LENGTH: float = None

GL_INT: float = None

GL_INTENSITY: float = None

GL_INTENSITY12: float = None

GL_INTENSITY16: float = None

GL_INTENSITY4: float = None

GL_INTENSITY8: float = None

GL_INTERLEAVED_ATTRIBS: float = None

GL_INTERPOLATE: float = None
...
GL_LIGHT0: float = None

GL_LIGHT1: float = None

GL_LIGHT2: float = None

GL_LIGHT3: float = None

GL_LIGHT4: float = None

GL_LIGHT5: float = None

GL_LIGHT6: float = None

GL_LIGHT7: float = None

GL_LIGHTING: float = None

GL_LIGHTING_BIT: float = None

GL_LIGHT_MODEL_AMBIENT: float = None

GL_LIGHT_MODEL_COLOR_CONTROL: float = None

GL_LIGHT_MODEL_LOCAL_VIEWER: float = None

GL_LIGHT_MODEL_TWO_SIDE: float = None

GL_LINE: float = None

GL_LINEAR: float = None

GL_LINEAR_ATTENUATION: float = None
...
GL_LINE_BIT: float = None

GL_LINE_LOOP: float = None

GL_LINE_RESET_TOKEN: float = None

GL_LINE_SMOOTH: float = None

GL_LINE_SMOOTH_HINT: float = None

GL_LINE_STIPPLE: float = None

GL_LINE_STIPPLE_PATTERN: float = None

GL_LINE_STIPPLE_REPEAT: float = None

GL_LINE_STRIP: float = None

GL_LINE_STRIP_ADJACENCY: float = None

GL_LINE_TOKEN: float = None
...
GL_LIST_BASE: float = None

GL_LIST_BIT: float = None

GL_LIST_INDEX: float = None

GL_LIST_MODE: float = None

GL_LOAD: float = None

GL_LOGIC_OP: float = None

GL_LOGIC_OP_MODE: float = None

GL_LOWER_LEFT: float = None

GL_LUMINANCE: float = None

GL_LUMINANCE12: float = None

GL_LUMINANCE12_ALPHA12: float = None

GL_LUMINANCE12_ALPHA4: float = None

GL_LUMINANCE16: float = None

GL_LUMINANCE16_ALPHA16: float = None

GL_LUMINANCE4: float = None

GL_LUMINANCE4_ALPHA4: float = None

GL_LUMINANCE6_ALPHA2: float = None

GL_LUMINANCE8: float = None

GL_LUMINANCE8_ALPHA8: float = None

GL_LUMINANCE_ALPHA: float = None

GL_MAJOR_VERSION: float = None

GL_MAP1_COLOR_4: float = None

GL_MAP1_GRID_DOMAIN: float = None

GL_MAP1_GRID_SEGMENTS: float = None

GL_MAP1_INDEX: float = None

GL_MAP1_NORMAL: float = None

GL_MAP1_TEXTURE_COORD_1: float = None

GL_MAP1_TEXTURE_COORD_2: float = None

GL_MAP1_TEXTURE_COORD_3: float = None

GL_MAP1_TEXTURE_COORD_4: float = None

GL_MAP1_VERTEX_3: float = None

GL_MAP1_VERTEX_4: float = None

GL_MAP2_COLOR_4: float = None

GL_MAP2_GRID_DOMAIN: float = None

GL_MAP2_GRID_SEGMENTS: float = None

GL_MAP2_INDEX: float = None

GL_MAP2_NORMAL: float = None

GL_MAP2_TEXTURE_COORD_1: float = None

GL_MAP2_TEXTURE_COORD_2: float = None

GL_MAP2_TEXTURE_COORD_3: float = None

GL_MAP2_TEXTURE_COORD_4: float = None

GL_MAP2_VERTEX_3: float = None

GL_MAP2_VERTEX_4: float = None

GL_MAP_COLOR: float = None
...
GL_MAX_ATTRIB_STACK_DEPTH: float = None

GL_MAX_CLIENT_ATTRIB_STACK_DEPTH: float = None

GL_MAX_CLIP_DISTANCES: float = None

GL_MAX_CLIP_PLANES: float = None
...
GL_MAX_LIGHTS: float = None

GL_MAX_LIST_NESTING: float = None

GL_MAX_MODELVIEW_STACK_DEPTH: float = None

GL_MAX_NAME_STACK_DEPTH: float = None

GL_MAX_PIXEL_MAP_TABLE: float = None

GL_MAX_PROGRAM_TEXEL_OFFSET: float = None

GL_MAX_PROJECTION_STACK_DEPTH: float = None
...
GL_MAX_TEXTURE_COORDS: float = None
...
GL_MAX_TEXTURE_STACK_DEPTH: float = None

GL_MAX_TEXTURE_UNITS: float = None
...
GL_MODELVIEW: float = None

GL_MODELVIEW_MATRIX: float = None

GL_MODELVIEW_STACK_DEPTH: float = None

GL_MODULATE: float = None

GL_MULT: float = None

GL_MULTISAMPLE: float = None

GL_MULTISAMPLE_BIT: float = None

GL_N3F_V3F: float = None

GL_NAME_STACK_DEPTH: float = None
...
GL_NORMALIZE: float = None

GL_NORMAL_ARRAY: float = None

GL_NORMAL_ARRAY_BUFFER_BINDING: float = None

GL_NORMAL_ARRAY_POINTER: float = None

GL_NORMAL_ARRAY_STRIDE: float = None

GL_NORMAL_ARRAY_TYPE: float = None

GL_NORMAL_MAP: float = None
...
GL_OBJECT_LINEAR: float = None

GL_OBJECT_PLANE: float = None
...
GL_OPERAND0_ALPHA: float = None

GL_OPERAND0_RGB: float = None

GL_OPERAND1_ALPHA: float = None

GL_OPERAND1_RGB: float = None

GL_OPERAND2_ALPHA: float = None

GL_OPERAND2_RGB: float = None
...
GL_PASS_THROUGH_TOKEN: float = None

GL_PERSPECTIVE_CORRECTION_HINT: float = None

GL_PIXEL_MAP_A_TO_A: float = None

GL_PIXEL_MAP_A_TO_A_SIZE: float = None

GL_PIXEL_MAP_B_TO_B: float = None

GL_PIXEL_MAP_B_TO_B_SIZE: float = None

GL_PIXEL_MAP_G_TO_G: float = None

GL_PIXEL_MAP_G_TO_G_SIZE: float = None

GL_PIXEL_MAP_I_TO_A: float = None

GL_PIXEL_MAP_I_TO_A_SIZE: float = None

GL_PIXEL_MAP_I_TO_B: float = None

GL_PIXEL_MAP_I_TO_B_SIZE: float = None

GL_PIXEL_MAP_I_TO_G: float = None

GL_PIXEL_MAP_I_TO_G_SIZE: float = None

GL_PIXEL_MAP_I_TO_I: float = None

GL_PIXEL_MAP_I_TO_I_SIZE: float = None

GL_PIXEL_MAP_I_TO_R: float = None

GL_PIXEL_MAP_I_TO_R_SIZE: float = None

GL_PIXEL_MAP_R_TO_R: float = None

GL_PIXEL_MAP_R_TO_R_SIZE: float = None

GL_PIXEL_MAP_S_TO_S: float = None

GL_PIXEL_MAP_S_TO_S_SIZE: float = None

GL_PIXEL_MODE_BIT: float = None
...
GL_POINT_BIT: float = None

GL_POINT_DISTANCE_ATTENUATION: float = None

GL_POINT_FADE_THRESHOLD_SIZE: float = None

GL_POINT_SIZE: float = None

GL_POINT_SIZE_GRANULARITY: float = None

GL_POINT_SIZE_MAX: float = None

GL_POINT_SIZE_MIN: float = None

GL_POINT_SIZE_RANGE: float = None

GL_POINT_SMOOTH: float = None

GL_POINT_SMOOTH_HINT: float = None

GL_POINT_SPRITE: float = None

GL_POINT_SPRITE_COORD_ORIGIN: float = None

GL_POINT_TOKEN: float = None

GL_POLYGON: float = None

GL_POLYGON_BIT: float = None
...
GL_POLYGON_STIPPLE: float = None

GL_POLYGON_STIPPLE_BIT: float = None

GL_POLYGON_TOKEN: float = None

GL_POSITION: float = None

GL_PREVIOUS: float = None

GL_PRIMARY_COLOR: float = None
...
GL_PROJECTION: float = None

GL_PROJECTION_MATRIX: float = None

GL_PROJECTION_STACK_DEPTH: float = None
...
GL_QUADRATIC_ATTENUATION: float = None

GL_QUADS: float = None

GL_QUADS_FOLLOW_PROVOKING_VERTEX_CONVENTION: float = None

GL_QUAD_STRIP: float = None
...
GL_RED_BIAS: float = None

GL_RED_BITS: float = None

GL_RED_INTEGER: float = None

GL_RED_SCALE: float = None

GL_REFLECTION_MAP: float = None

GL_RENDER: float = None
...
GL_RENDER_MODE: float = None

GL_REPEAT: float = None

GL_REPLACE: float = None

GL_RESCALE_NORMAL: float = None

GL_RETURN: float = None
...
GL_RGBA_MODE: float = None

GL_RGB_INTEGER: float = None

GL_RGB_SCALE: float = None
...
GL_SCISSOR_BIT: float = None

GL_SCISSOR_BOX: float = None

GL_SCISSOR_TEST: float = None

GL_SECONDARY_COLOR_ARRAY: float = None

GL_SECONDARY_COLOR_ARRAY_BUFFER_BINDING: float = None

GL_SECONDARY_COLOR_ARRAY_POINTER: float = None

GL_SECONDARY_COLOR_ARRAY_SIZE: float = None

GL_SECONDARY_COLOR_ARRAY_STRIDE: float = None

GL_SECONDARY_COLOR_ARRAY_TYPE: float = None

GL_SELECT: float = None

GL_SELECTION_BUFFER_POINTER: float = None

GL_SELECTION_BUFFER_SIZE: float = None

GL_SEPARATE_ATTRIBS: float = None

GL_SEPARATE_SPECULAR_COLOR: float = None
...
GL_SHADE_MODEL: float = None

GL_SHADING_LANGUAGE_VERSION: float = None

GL_SHININESS: float = None
...
GL_SINGLE_COLOR: float = None

GL_SLUMINANCE: float = None

GL_SLUMINANCE8: float = None

GL_SLUMINANCE8_ALPHA8: float = None

GL_SLUMINANCE_ALPHA: float = None

GL_SMOOTH: float = None
...
GL_SOURCE0_ALPHA: float = None

GL_SOURCE0_RGB: float = None

GL_SOURCE1_ALPHA: float = None

GL_SOURCE1_RGB: float = None

GL_SOURCE2_ALPHA: float = None

GL_SOURCE2_RGB: float = None

GL_SPECULAR: float = None

GL_SPHERE_MAP: float = None

GL_SPOT_CUTOFF: float = None

GL_SPOT_DIRECTION: float = None

GL_SPOT_EXPONENT: float = None

GL_SRC0_ALPHA: float = None

GL_SRC0_RGB: float = None

GL_SRC1_ALPHA: float = None

GL_SRC1_COLOR: float = None

GL_SRC1_RGB: float = None

GL_SRC2_ALPHA: float = None

GL_SRC2_RGB: float = None
...
GL_STACK_OVERFLOW: float = None

GL_STACK_UNDERFLOW: float = None
...
GL_T2F_C3F_V3F: float = None

GL_T2F_C4F_N3F_V3F: float = None

GL_T2F_C4UB_V3F: float = None

GL_T2F_N3F_V3F: float = None

GL_T2F_V3F: float = None

GL_T4F_C4F_N3F_V4F: float = None

GL_T4F_V4F: float = None
...
GL_TEXTURE_COMPONENTS: float = None
...
GL_TEXTURE_COORD_ARRAY: float = None

GL_TEXTURE_COORD_ARRAY_BUFFER_BINDING: float = None

GL_TEXTURE_COORD_ARRAY_POINTER: float = None

GL_TEXTURE_COORD_ARRAY_SIZE: float = None

GL_TEXTURE_COORD_ARRAY_STRIDE: float = None

GL_TEXTURE_COORD_ARRAY_TYPE: float = None
...
GL_TEXTURE_ENV: float = None

GL_TEXTURE_ENV_COLOR: float = None

GL_TEXTURE_ENV_MODE: float = None

GL_TEXTURE_FILTER_CONTROL: float = None

GL_TEXTURE_FIXED_SAMPLE_LOCATIONS: float = None

GL_TEXTURE_GEN_MODE: float = None

GL_TEXTURE_GEN_Q: float = None

GL_TEXTURE_GEN_R: float = None

GL_TEXTURE_GEN_S: float = None

GL_TEXTURE_GEN_T: float = None
...
GL_TEXTURE_INTENSITY_SIZE: float = None

GL_TEXTURE_INTENSITY_TYPE: float = None

GL_TEXTURE_INTERNAL_FORMAT: float = None

GL_TEXTURE_LOD_BIAS: float = None

GL_TEXTURE_LUMINANCE_SIZE: float = None

GL_TEXTURE_LUMINANCE_TYPE: float = None

GL_TEXTURE_MAG_FILTER: float = None

GL_TEXTURE_MATRIX: float = None
...
GL_TEXTURE_PRIORITY: float = None
...
GL_TEXTURE_RESIDENT: float = None

GL_TEXTURE_SAMPLES: float = None

GL_TEXTURE_SHARED_SIZE: float = None

GL_TEXTURE_STACK_DEPTH: float = None
...
GL_TRANSPOSE_COLOR_MATRIX: float = None

GL_TRANSPOSE_MODELVIEW_MATRIX: float = None

GL_TRANSPOSE_PROJECTION_MATRIX: float = None

GL_TRANSPOSE_TEXTURE_MATRIX: float = None
...
GL_VERTEX_ARRAY: float = None

GL_VERTEX_ARRAY_BINDING: float = None

GL_VERTEX_ARRAY_BUFFER_BINDING: float = None

GL_VERTEX_ARRAY_POINTER: float = None

GL_VERTEX_ARRAY_SIZE: float = None

GL_VERTEX_ARRAY_STRIDE: float = None

GL_VERTEX_ARRAY_TYPE: float = None
...
GL_VERTEX_PROGRAM_TWO_SIDE: float = None

GL_VERTEX_SHADER: float = None

GL_VIEWPORT: float = None

GL_VIEWPORT_BIT: float = None

GL_WAIT_FAILED: float = None

GL_WEIGHT_ARRAY_BUFFER_BINDING: float = None
...
GL_ZOOM_X: float = None

GL_ZOOM_Y: float = None
