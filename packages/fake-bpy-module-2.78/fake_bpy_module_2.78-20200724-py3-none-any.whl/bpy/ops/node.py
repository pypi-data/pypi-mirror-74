...
def add_and_link_node(settings: typing.Union[
        typing.List['bpy.types.NodeSetting'], 'bpy_prop_collection'] = None,
    ...
    :type settings: typing.Union[typing.List['bpy.types.NodeSetting'], 'bpy_prop_collection']
...
def add_file(filepath: str = "",
    ...
    :param name: Name, Datablock name to assign
    :type name: str
    '''
...
def add_node(settings: typing.Union[typing.List['bpy.types.NodeSetting'],
...
def add_search(settings: typing.Union[typing.List['bpy.types.NodeSetting'],
                                      'bpy_prop_collection'] = None,
               use_transform: bool = False,
               type: str = "",
