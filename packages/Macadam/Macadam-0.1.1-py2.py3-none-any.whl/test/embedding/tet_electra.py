...
def _tet_electra_embedding():
    ######## tet electra
    path_embed = "D:/soft_install/dataset/bert-model/google_electra/electra_small"
    path_check_point = path_embed + "/electra_model.ckpt"
    path_config = path_embed + "/config.json"
    ...
    electra_embed = ElectraEmbedding(params)
    electra_embed.build_embedding(path_checkpoint=path_check_point,
