...
if __name__=="__main__":
    ...
    for [network_type, embed_type, token_type] in nets[7:9]: # nets[4:]:
...
# nohup python tet_all_baidu_2019.py > predict_batch.log 2>&1 &
