...
_RequiredInputPrepareScheduleActionSettingsTypeDef = TypedDict(
    "_RequiredInputPrepareScheduleActionSettingsTypeDef", {"InputAttachmentNameReference": str}
)
_OptionalInputPrepareScheduleActionSettingsTypeDef = TypedDict(
    "_OptionalInputPrepareScheduleActionSettingsTypeDef",
    {"InputClippingSettings": "InputClippingSettingsTypeDef", "UrlPath": List[str]},
    total=False,
)


class InputPrepareScheduleActionSettingsTypeDef(
    _RequiredInputPrepareScheduleActionSettingsTypeDef,
    _OptionalInputPrepareScheduleActionSettingsTypeDef,
):
    pass
