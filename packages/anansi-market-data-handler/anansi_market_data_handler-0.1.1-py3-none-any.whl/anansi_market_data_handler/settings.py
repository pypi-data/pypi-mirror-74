...
class GeneralFormat:
    def __init__(self, fmt: str, unit: str):
        self.fmt = fmt
        self.unit = unit


class CandleStickFormat:
    info = ["Open_time", "Open", "High", "Low", "Close", "Volume"]  # , "Close_time"]
    time_ = "datetime_string"
...
class Binance_:
    api_key = None
    api_secret = None
    CandleTime = GeneralFormat(fmt="timestamp", unit="milliseconds")
