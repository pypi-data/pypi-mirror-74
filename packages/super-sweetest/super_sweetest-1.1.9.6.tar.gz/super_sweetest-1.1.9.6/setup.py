...
setup(
    ...
    version="1.1.9.6",  # 版本号，数值大的会优先被pip
    keywords=("pip", "super_sweetest", "featureextraction"),
    description="automation tools",
    long_description="automation tools: requests,appium,selenium,air_android,air_ios,adb,poco......增加mqtt协议请求/支持混合http，app和mqtt执行端， 使用命令super_sweetest -h 获取帮助",
    license="MIT Licence",
