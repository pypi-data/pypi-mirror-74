...
class MqttRun:
    ...
    def reset_file_tree(file_name, project_name, test_environment):
        ...
        lib_dst_path = os.path.join(
            case_path, project_name + "-Project-api", test_environment, file_name)
    ...
    def exec_mqtt_test(test_name):
        ...
        sheet_name = '*'
        # X-Sweetest的测试参数
        desired_caps = {'platformName': 'mqtt'}
        # 通过X-Sweetest执行自动化测试
        server_url = ''
            ...
            try:
                ...
                if length > 0:
                    ...
                    try:
                        ...
                        self.exec_mqtt_test(test_name=value_dict['test_name'])
