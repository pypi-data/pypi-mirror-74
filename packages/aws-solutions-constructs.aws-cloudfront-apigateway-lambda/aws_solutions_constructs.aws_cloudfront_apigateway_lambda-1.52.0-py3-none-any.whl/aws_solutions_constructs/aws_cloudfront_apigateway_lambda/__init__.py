...
class CloudFrontToApiGatewayToLambda(
    ...
    def __init__(
        ...
        id: str,
        *,
        api_gateway_props: typing.Optional[
            aws_cdk.aws_apigateway.LambdaRestApiProps
        ] = None,
        cloud_front_distribution_props: typing.Any = None,
        existing_lambda_obj: typing.Optional[aws_cdk.aws_lambda.Function] = None,
        insert_http_security_headers: typing.Optional[bool] = None,
...
class CloudFrontToApiGatewayToLambdaProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(api_gateway_props, dict):
            api_gateway_props = aws_cdk.aws_apigateway.LambdaRestApiProps(
                **api_gateway_props
            )
    ...
    def api_gateway_props(
        self,
    ) -> typing.Optional[aws_cdk.aws_apigateway.LambdaRestApiProps]:
