...
class AutoMLStep(PipelineStep):
    ...
    :param passthru_automl_config: Indicates whether the AutoMLConfig will be passed through without parsing.
        The default is no parsing. Pass through can be disabled to use parameter specific operations such as
        parameterization via :class:`azureml.pipeline.core.PipelineParameter`.
    ...
    def __init__(self, name, automl_config, inputs=None, outputs=None, script_repl_params=None,
        ...
        :param hash_paths: DEPRECATED. A list of paths to hash when checking for changes to the pipeline
            ...
            the step contents from a previous run.
        :type hash_paths: list
        :param passthru_automl_config: Indicates whether AutoMLConfig will be passed through without parsing.
            The default is no parsing. Pass through can be disabled to use parameter specific operations such as
            parameterization via :class:`azureml.pipeline.core.PipelineParameter`.
        :type passthru_automl_config: bool
        """
