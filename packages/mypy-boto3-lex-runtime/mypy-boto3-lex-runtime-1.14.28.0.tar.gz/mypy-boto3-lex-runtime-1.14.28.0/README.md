...
[boto3.LexRuntimeService 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/lex-runtime.html#LexRuntimeService) service
...
def get_structure() -> ButtonTypeDef:
    return {
      ...
    }
```
...
`mypy_boto3_lex_runtime` and other installed services.
...
session_client = boto3.Session().client("lex-runtime")
```
