...
class PullRequestCheck(
    ...
    def __init__(
        ...
        *,
        ...
        post_comment: typing.Optional[bool] = None,
        privileged: typing.Optional[bool] = None,
        project_name: typing.Optional[str] = None,
        role: typing.Optional[aws_cdk.aws_iam.IRole] = None,
        update_approval_state: typing.Optional[bool] = None,
    ) -> None:
        """
        :param scope: -
        :param id: -
...
class PullRequestCheckProps:
    ...
    @builtins.property
    def post_comment(self) -> typing.Optional[bool]:
        """Specifies whether comments should be written in the request.

        default
        :default: true
        """
        return self._values.get("post_comment")
    ...
    @builtins.property
    def update_approval_state(self) -> typing.Optional[bool]:
        """Indicates whether the approval state [APPROVE, REVOKE] should be updated.

        default
        :default: true
        """
        return self._values.get("update_approval_state")
