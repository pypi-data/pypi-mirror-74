...
class message(object):
    ...
    def __init__(self, connector=IOT_Device, data=None, recv_confirm=None, recv_timeout=5, message_type=types.DATA, message_direction=directions.OUT, send_as_daemon=True, question=None):
