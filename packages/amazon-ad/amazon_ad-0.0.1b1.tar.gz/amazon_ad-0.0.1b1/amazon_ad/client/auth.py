...
class ZADAuthClient(BaseClient):
    ...
    def __init__(self, client_id, client_secret, country="US", timeout=None, auto_retry=True, *args, **kwargs):
        super(ZADAuthClient, self).__init__(timeout, auto_retry, *args, **kwargs)
        self.client_id = client_id
        self.client_secret = client_secret
        self.country = country

    def get_api_base_url(self):
        return get_endpoint(self.country, 'TOKEN')

    def authorization_url(self, redirect_uri):
        base_url= get_endpoint(self.country, 'AUTHORIZATION')
