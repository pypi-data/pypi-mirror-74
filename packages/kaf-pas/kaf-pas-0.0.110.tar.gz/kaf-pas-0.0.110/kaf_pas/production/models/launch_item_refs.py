...
class Launch_item_refs(AuditModel):
    ...
    item_refs = ForeignKeyProtect(Item_refs, blank=True, null=True)
    ...
    class Meta:
        ...
        constraints = [
            ...
            UniqueConstraint(fields=['child_id', 'launch_id', 'props', 'qty', 'qty_per_one'], condition=Q(parent_id=None), name='Launch_item_refs_unique_constraint_0'),
            UniqueConstraint(fields=['child_id', 'launch_id', 'parent_id', 'props', 'qty', 'qty_per_one'], name='Launch_item_refs_unique_constraint_1'),
        ]
