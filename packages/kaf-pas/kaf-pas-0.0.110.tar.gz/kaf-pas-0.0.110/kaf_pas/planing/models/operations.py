...
from isc_common import delAttr, setAttr, delAttr1
...
class OperationsQuerySet(BaseRefQuerySet, CommonManagetWithLookUpFieldsQuerySet):
    ...
    def create(self, **kwargs):
        ...
        operation_history = delAttr1(kwargs, 'id')
        setAttr(operation_history, 'operation', res)
        setAttr(operation_history, 'hcreator', res.creator)
        Operation_history.objects.create(**operation_history)
        return res
