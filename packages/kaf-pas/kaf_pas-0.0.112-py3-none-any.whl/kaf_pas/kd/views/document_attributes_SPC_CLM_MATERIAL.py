...
def Document_attributes_SPC_CLM_MATERIAL_Fetch(request):
    return JsonResponse(
        DSResponse(
            request=request,
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_MATERIAL_Add(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_MATERIAL_Update(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_MATERIAL_Remove(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_MATERIAL_Lookup(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_MATERIAL_Info(request):
...
@JsonResponseWithException()
def Document_attributes_SPC_CLM_MATERIAL_Copy(request):
