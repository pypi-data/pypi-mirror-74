...
def test_initializer_lecun_uniform(system_dict):
    forward = True;

    test = "test_initializer_lecun_uniform";
    ...
    if(forward):
        try:
            ...
            gtf.Compile_Network(network, data_shape=(3, 32, 32), network_initializer="lecun_uniform");
