...
def test_initializer_orthogonal_uniform(system_dict):
    forward = True;

    test = "test_initializer_orthogonal_uniform";
    ...
    if(forward):
        try:
            ...
            gtf.Compile_Network(network, use_gpu=False, network_initializer="orthogonal_uniform");
