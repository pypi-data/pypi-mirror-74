...
def test_initializer_orthogonal_normal(system_dict):
    forward = True;

    test = "test_initializer_orthogonal_normal";
    ...
    if(forward):
        try:
            ...
            gtf.Compile_Network(network, use_gpu=False, network_initializer="orthogonal_normal");
