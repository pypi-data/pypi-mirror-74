...
For examples of some of the utilities offered, please see [documentation website](opensoundscape.org). We plan to add more vignettes and documentation soon.
...
Already familiar with installing python packages via pip? The pip command is `pip install opensoundscape==0.4.1`
