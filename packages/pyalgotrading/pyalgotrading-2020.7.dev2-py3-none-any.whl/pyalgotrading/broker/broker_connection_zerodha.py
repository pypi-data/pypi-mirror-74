...
class BrokerConnectionZerodha(BrokerConnectionBase):
    ...
    def get_instrument(self, segment: str, tradingsymbol: str) -> Instrument:
        ...
        instrument = Instrument(segment=_inst['segment'], tradingsymbol=_inst['tradingsymbol'], broker_token=_inst['instrument_token'], tick_size=_inst['tick_size'], lot_size=_inst['lot_size'], expiry=_inst['expiry'], strike_price=_inst['strike'])
        return instrument
