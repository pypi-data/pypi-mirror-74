...
class ServerStorage:
    ...
    def __init__(self, path):
        """
        Метод, создающий движок базы данных.
        """
        self.database_engine = create_engine(f'sqlite:///db/{path}', echo=False, pool_recycle=7200,
    ...
    def user_login(self, username, ip_address, port, key):
        """
        Метод, выполняющийся при авторизации пользователя.
        Производит запись данных о подключении в базу данных.
        Обновляет открытый ключ пользователя, при случае его изменения.
        """
    ...
    def get_hash(self, name):
        """
        Метод, возвращающий хэш пользователя.
        """
        user = self.session.query(self.AllUsers).filter_by(name=name).first()
    ...
    def check_user(self, name):
        """
        Метод, проверящий наличие зарегистрированного пользователя.
        """
    ...
    def process_message(self, sender, recipient):
        """
        Метод, фиксирующий передачу сообщения и делает соответствующие отметки в БД.
        """
    ...
    def active_users_list(self):
        """
        Метод, возвращающий список подключенных пользователей.
        """
    ...
    def login_history(self, username=None):
        """
        Метод, возвращающий историю входов по пользователю или всем пользователям.
        """
