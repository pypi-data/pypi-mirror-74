...
class StatWindow(QDialog):
    """
    Класс - окно вывода статистики пользователей.
    Содержит всю основную логику работы модуля вывода статистики.
    ...
    def initUI(self):
        """
        Метод формирования рабочего окна модуля
        """
        # Настройки окна:
    ...
    def create_stat_model(self):
        """
        Метод, реализующий заполнение таблицы историей сообщений.
        """
