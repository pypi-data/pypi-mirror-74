...
class StackInstanceService(object):
    ...
    def __init__(self, infrastructure_target=None, provisioning_parameters=None, cloud_provider='generic', secrets=None, resources=None, agent='', packages=None, tags=None, local_vars_configuration=None):  # noqa: E501
