...
setup(
    ...
    description="Type annotations for boto3.MarketplaceEntitlementService 1.14.25 service, generated by mypy-boto3-buider 2.2.0",
    classifiers=[
    ...
    package_data={"mypy_boto3_marketplace_entitlement": ["py.typed"]},
    python_requires=">=3.6",
    project_urls={
