...
[boto3.MarketplaceEntitlementService 1.14.27](https://boto3.amazonaws.com/v1/documentation/api/1.14.27/reference/services/marketplace-entitlement.html#MarketplaceEntitlementService) service
