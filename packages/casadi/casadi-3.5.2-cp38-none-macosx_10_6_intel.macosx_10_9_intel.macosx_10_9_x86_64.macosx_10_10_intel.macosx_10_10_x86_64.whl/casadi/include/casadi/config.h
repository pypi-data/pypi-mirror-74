...
#define CASADI_GIT_DESCRIBE "3.3.0-296.6a7d535"  // NOLINT(whitespace/line_length)
...
#define CASADI_COMPILER "/usr/local/bin/g++-4.9"  // NOLINT(whitespace/line_length)
#define CASADI_COMPILER_FLAGS " -std=c++11 -pthread -fPIC -fvisibility=hidden -fvisibility-inlines-hidden    -DUSE_CXX11 -DHAS_COPYSIGN -DHAS_ERF -DHAVE_MKSTEMPS -DCASADI_WITH_THREAD -DWITH_DEEPBIND -DCASADI_VERSION=31 -D_USE_MATH_DEFINES -D_SCL_SECURE_NO_WARNINGS -DWITH_DL -DWITH_DEPRECATED_FEATURES"  // NOLINT(whitespace/line_length)
...
#define CASADI_INSTALL_PREFIX "/Users/travis/build/casadi/binaries/casadi/python_install"  // NOLINT(whitespace/line_length)
