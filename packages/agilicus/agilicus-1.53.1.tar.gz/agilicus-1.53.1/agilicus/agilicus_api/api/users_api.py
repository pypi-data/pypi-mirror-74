...
"""
    ...
    The version of the OpenAPI document: 2020.07.15
...
class UsersApi(object):
    ...
    def list_combined_user_details_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['email', 'previous_email', 'org_id', 'limit', 'type', 'user_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('email' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `email` when calling `list_combined_user_details`, length must be greater than or equal to `1`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('previous_email' in local_var_params and  # noqa: E501
                                                        len(local_var_params['previous_email']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `previous_email` when calling `list_combined_user_details`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 500:  # noqa: E501
    ...
    def list_users_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['email', 'previous_email', 'provider', 'org_id', 'issuer', 'limit', 'type']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('email' in local_var_params and  # noqa: E501
                                                        len(local_var_params['email']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `email` when calling `list_users`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('previous_email' in local_var_params and  # noqa: E501
                                                        len(local_var_params['previous_email']) > 100):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('previous_email' in local_var_params and  # noqa: E501
                                                        len(local_var_params['previous_email']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `previous_email` when calling `list_users`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 500:  # noqa: E501
