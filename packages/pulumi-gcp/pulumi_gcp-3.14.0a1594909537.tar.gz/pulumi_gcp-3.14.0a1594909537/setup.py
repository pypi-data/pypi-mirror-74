...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.14.0-alpha.1594909537+b1c3c0ba'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.14.0-alpha.1594909537+b1c3c0ba`
                """)
            else:
                raise
