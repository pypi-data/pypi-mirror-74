...
WORKSPACE = {
    "name": "Digly",
    "path": environmental_variables.get("DIGLY_WORKSPACE"),
}
OS_ENV = (
...
class Settings:
    ...
    database_location = localize_path("db", "digly.db")

    # set a logger cache outside the Digly object to avoid
    ...
    # state of instantiation of Digly
    Digly_is_running = False

    # This is where currently the pods server is hosted
    pods_server_endpoint = "https://us-central1-digly-pods.cloudfunctions.net"
    pods_fashion_server_endpoint = (
        "https://us-central1-digly-pods-fashion.cloudfunctions.net"
    )
    pods_food_server_endpoint = (
        "https://us-central1-digly-pods-food.cloudfunctions.net"
    )
    pods_travel_server_endpoint = (
        "https://us-central1-digly-pods-travel.cloudfunctions.net"
    )
    pods_sports_server_endpoint = (
        "https://us-central1-digly-pods-sports.cloudfunctions.net"
    )
    pods_entertainment_server_endpoint = (
        "https://us-central1-digly-pods-entertainment.cloudfunctions.net"
    )
