...
from tensorflow_probability.python.internal._jax import batched_rejection_sampler as brs
...
from tensorflow_probability.python.internal._jax import implementation_selection
...
def random_gamma(
  ...
  def _sample(concentration, rate):
    ...
    def grad(*dys):
      ...
      # enum.
      dy = dys[0]
      JAX_MODE = True   # pylint: disable=invalid-name
      if JAX_MODE:
        dy = dy[0]
