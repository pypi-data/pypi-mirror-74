...
#   `tensorflow_probability/substrates/numpy/experimental/inference_gym/internal/data.py`
...
# interacting with it.
import numpy as np
from tensorflow_probability.python.internal.backend.numpy.compat import v2 as otf

from tensorflow_probability.substrates.numpy.experimental.inference_gym.internal.datasets import synthetic_item_response_theory as synthetic_item_response_theory_lib  # pylint: disable=g-import-not-at-top
from tensorflow_probability.substrates.numpy.experimental.inference_gym.internal.datasets import synthetic_log_gaussian_cox_process as synthetic_log_gaussian_cox_process_lib  # pylint: disable=g-import-not-at-top
