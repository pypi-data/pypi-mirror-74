...
from tensorflow_probability.python.bijectors._numpy import chain
from tensorflow_probability.python.bijectors._numpy import scale as scale_lib
from tensorflow_probability.python.bijectors._numpy import shift as shift_lib
