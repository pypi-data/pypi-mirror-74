...
from tensorflow_probability.python.internal._numpy import name_util
...
from tensorflow_probability.python.internal.backend.numpy import private as numpy_text  # pylint: disable=g-direct-tensorflow-import
