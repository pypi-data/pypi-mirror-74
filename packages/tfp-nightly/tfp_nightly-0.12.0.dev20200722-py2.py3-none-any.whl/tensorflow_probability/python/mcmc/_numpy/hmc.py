...
from tensorflow_probability.python.mcmc._numpy import metropolis_hastings
from tensorflow_probability.python.mcmc.internal._numpy import leapfrog_integrator as leapfrog_impl
from tensorflow_probability.python.mcmc.internal._numpy import util as mcmc_util
from tensorflow_probability.python.util._numpy.seed_stream import SeedStream
...
warnings.filterwarnings('always',
                        module='tensorflow_probability.*hmc',
...
class UncalibratedHamiltonianMonteCarlo(kernel_base.TransitionKernel):
  ...
  def __init__(self,
    ...
    if seed is not None and tf.executing_eagerly():
      # TODO(b/68017812): Re-enable once TFE supports `tf.random.stateless_shuffle` seed.
