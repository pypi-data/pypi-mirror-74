...
[boto3.ForecastQueryService 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/forecastquery.html#ForecastQueryService) service
...
`mypy_boto3_forecastquery` and other installed services.
...
session_client = boto3.Session().client("forecastquery")
```
