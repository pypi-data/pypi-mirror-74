...
ALL_MODELS = ['GenericWizardGeneratorAgent', 'retrieval_no_knowledge', 'wizard_hierarchical', 'wizard_retrieval_interactive','human_eval']
...
def set_args():
    ...
    args['dialogs_path'] = '/private/home/margaretli/ParlAI/data/pairwise_eval_experiments/wizard_eval_json_unseen'
