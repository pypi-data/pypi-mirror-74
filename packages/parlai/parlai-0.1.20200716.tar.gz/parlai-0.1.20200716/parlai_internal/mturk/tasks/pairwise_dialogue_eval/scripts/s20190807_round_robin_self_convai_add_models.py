...
OLD_MODELS = ['kvmemnn', 'repetition_model_setting35_settinginf', 'hf', 'lic', 'interesting_nidf_model_bfw_setting_04', 'human_eval']
NEW_MODELS = ['inquisitive', 'polyencoder']
