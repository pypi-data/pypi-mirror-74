...
def set_args():
    ...
    args['reward'] = 0.5
    args['num_onboarding_tasks'] = 5
    args['num_conversations'] = 30
    args['max_hits_per_worker'] = 21
    ...
    args['block_qualification'] = 'pairwise_dialogue_block_20190429_debug_run'
    args['task_description'] = {'num_subtasks': 5}
    args['assignment_duration_in_seconds'] = 600
    # CHANGE TIMEOUT TIME LENGTH?
