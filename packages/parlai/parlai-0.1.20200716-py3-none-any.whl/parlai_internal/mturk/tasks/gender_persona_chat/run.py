...
def main():
    ...
    argparser.add_argument(
        '-min_t', '--min_turns', default=8, type=int, help='minimum number of turns'
    )
    argparser.add_argument(
        '-mt', '--max_turns', default=12, type=int, help='maximal number of chat turns'
    )
    argparser.add_argument(
        '-mx_rsp_time',
        '--max_resp_time',
    ...
    argparser.add_argument(
        '-rt', '--range_turn', default='8,10', help='sample range of number of turns'
    )
    argparser.add_argument(
        '--personas-path', default=None, help='specify path for personas data'
    )
    ...
    opt['extract_personas_path'] = os.path.join(opt['datapath'], 'gender_persona_chat')
