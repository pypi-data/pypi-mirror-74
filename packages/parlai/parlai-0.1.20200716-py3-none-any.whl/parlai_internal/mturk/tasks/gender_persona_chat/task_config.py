...
<br>
<br>
<b>You will be given a small passage from Wikipedia to help prompt discussion with your partner. </b> For example, your given topic could be:
<br>
<br>
...
His work is also known for its influence on the philosophy of science.</b>
<br>
<br>
Chat with the other person naturally and <b><span style="color:blue">have a friendly and personal conversation about the given topic using the information provided,
and stick to you own characters at the same time.
<span style="color:blue"></b>
<br>
<b>You will need to annotate the gender of the person/people you talked about, for each message you sent.</b> 
You can only send new messages after you annotated previous ones.
<br>
<br>
