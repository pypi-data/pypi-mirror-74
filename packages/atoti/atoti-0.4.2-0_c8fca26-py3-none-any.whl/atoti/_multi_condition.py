...
class MultiCondition(Condition, MeasureConvertible):
    ...
    def __and__(self, other: Condition) -> MultiCondition:
        ...
        This allows users to write longer conditions when filtering measures.
    ...
    def _to_measure(self, agg_fun: Optional[str] = None) -> BooleanMeasure:
        ...
        Transforms all of the level conditions into measures and return
        the logical conjunction of all the values.
        """
        ...
        from ._functions.measure import conjunction  # type: ignore
