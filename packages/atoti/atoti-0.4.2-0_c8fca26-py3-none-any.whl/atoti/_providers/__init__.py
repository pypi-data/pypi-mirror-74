...
These are optimization to pre-aggregate some store columns up to certain levels.
One can choose the levels and the measures (among store aggregations) to build the provider on.
If a step of a query uses a subset of the aggregate provider's levels and measures it can use this provider
...
There are actually 2 kind of aggregate providers: the bitmap and the leaf.
