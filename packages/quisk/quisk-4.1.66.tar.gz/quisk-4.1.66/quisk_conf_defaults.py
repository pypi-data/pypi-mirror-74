...
# for CW operation. For Linux you must install the libsoundio-dev package and re-make, and you
# must use an Alsa device for the radio sound playback device. There are no special requirements
# for Windows.
