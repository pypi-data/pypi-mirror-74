...
class SetupPhase:
    ...
    def run(
        ...
        transformed_data_context, feature_sweeped_state_container = PhaseUtil.set_problem_info_for_featurized_data(
            current_run,
            automl_parent_run,
            fit_iteration_parameters_dict,
            automl_settings,
    ...
    def _validate_training_data(
        ...
        training_utilities.validate_training_data_dict(fit_iteration_parameters_dict, automl_settings, logger)
