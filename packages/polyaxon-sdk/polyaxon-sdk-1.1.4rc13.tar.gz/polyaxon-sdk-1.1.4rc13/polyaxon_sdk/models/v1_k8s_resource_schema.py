...
class V1K8sResourceSchema(object):
    ...
    """
    openapi_types = {"name": "str", "mount_path": "str", "items": "list[str]"}

    attribute_map = {"name": "name", "mount_path": "mount_path", "items": "items"}

    def __init__(
        self, name=None, mount_path=None, items=None, local_vars_configuration=None
    ):  # noqa: E501
