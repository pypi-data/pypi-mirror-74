...
class AccessResourcesV1Api(object):
    ...
    def patch_access_resource_with_http_info(
        ...
        all_params = ["owner", "access_resource_uuid", "body"]
        all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        if self.api_client.client_side_validation and (
            "access_resource_uuid" not in local_var_params
            or local_var_params["access_resource_uuid"] is None  # noqa: E501
        ):  # noqa: E501
            raise ApiValueError(
        ...
        if "access_resource_uuid" in local_var_params:
            path_params["access_resource.uuid"] = local_var_params[
