...
class AgentsV1Api(object):
    ...
    def get_agent_token(self, owner, agent, **kwargs):  # noqa: E501
        """Get agent token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_agent_token(owner, agent, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.get_agent_token_with_http_info(owner, agent, **kwargs)  # noqa: E501

    def get_agent_token_with_http_info(self, owner, agent, **kwargs):  # noqa: E501
        """Get agent token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_agent_token_with_http_info(owner, agent, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `owner` when calling `get_agent_token`"
            )  # noqa: E501
        # verify the required parameter 'agent' is set
        if self.api_client.client_side_validation and (
            "agent" not in local_var_params
            or local_var_params["agent"] is None  # noqa: E501
        ):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `agent` when calling `get_agent_token`"
            )  # noqa: E501
    ...
    def patch_agent_with_http_info(
        ...
        all_params = ["owner", "agent_uuid", "body"]
        all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        if self.api_client.client_side_validation and (
            "agent_uuid" not in local_var_params
            or local_var_params["agent_uuid"] is None  # noqa: E501
        ):  # noqa: E501
            raise ApiValueError(
    ...
    def patch_agent_token_with_http_info(
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `owner` when calling `patch_agent_token`"
            )  # noqa: E501
        # verify the required parameter 'agent' is set
        if self.api_client.client_side_validation and (
            "agent" not in local_var_params
            ...
            raise ApiValueError(
                "Missing the required parameter `agent` when calling `patch_agent_token`"
            )  # noqa: E501
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and (
            "body" not in local_var_params
            ...
            raise ApiValueError(
                "Missing the required parameter `body` when calling `patch_agent_token`"
            )  # noqa: E501
    ...
    def update_agent_token_with_http_info(
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `owner` when calling `update_agent_token`"
            )  # noqa: E501
        # verify the required parameter 'agent' is set
        if self.api_client.client_side_validation and (
            "agent" not in local_var_params
            ...
            raise ApiValueError(
                "Missing the required parameter `agent` when calling `update_agent_token`"
            )  # noqa: E501
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and (
            "body" not in local_var_params
            ...
            raise ApiValueError(
                "Missing the required parameter `body` when calling `update_agent_token`"
            )  # noqa: E501
