...
class UsersV1Api(object):
    ...
    def patch_tokenm(self, token_uuid, body, **kwargs):  # noqa: E501
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.patch_tokenm_with_http_info(
    ...
    def patch_tokenm_with_http_info(self, token_uuid, body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `token_uuid` when calling `patch_tokenm`"
            )  # noqa: E501
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and (
            "body" not in local_var_params
            ...
            raise ApiValueError(
                "Missing the required parameter `body` when calling `patch_tokenm`"
            )  # noqa: E501
