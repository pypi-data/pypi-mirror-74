...
class AgentStateResponseAgentState(object):
    ...
    def __init__(self, schedules=None, notifier=None, watchdogs=None, tuners=None, queued=None, stopping=None, apply=None, full=None, local_vars_configuration=None):  # noqa: E501
