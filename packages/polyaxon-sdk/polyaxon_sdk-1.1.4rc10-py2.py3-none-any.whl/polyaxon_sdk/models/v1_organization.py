...
class V1Organization(object):
    ...
    def __init__(self, user=None, user_email=None, name=None, is_public=None, created_at=None, updated_at=None, role=None, settings=None, local_vars_configuration=None):  # noqa: E501
