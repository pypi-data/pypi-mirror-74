...
class V1Installation(object):
    ...
    """
    openapi_types = {"key": "str", "version": "str", "dist": "str"}

    attribute_map = {"key": "key", "version": "version", "dist": "dist"}

    def __init__(
        self, key=None, version=None, dist=None, local_vars_configuration=None
    ):  # noqa: E501
