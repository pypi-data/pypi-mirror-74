...
class V1UriType(object):
    ...
    """
    openapi_types = {"user": "str", "password": "str", "host": "bool"}

    attribute_map = {"user": "user", "password": "password", "host": "host"}

    def __init__(
        self, user=None, password=None, host=None, local_vars_configuration=None
    ):  # noqa: E501
