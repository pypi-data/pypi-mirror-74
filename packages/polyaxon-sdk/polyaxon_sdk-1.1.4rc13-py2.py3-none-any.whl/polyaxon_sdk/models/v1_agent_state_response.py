...
class V1AgentStateResponse(object):
    ...
    """
    openapi_types = {"status": "V1Statuses", "state": "AgentStateResponseAgentState"}

    attribute_map = {"status": "status", "state": "state"}

    def __init__(
        self, status=None, state=None, local_vars_configuration=None
    ):  # noqa: E501
