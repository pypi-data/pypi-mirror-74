...
- API version: 1.1.4-rc0
- Package version: 1.1.4-rc0
...
*AgentsV1Api* | [**regenarate_agent_token**](docs/AgentsV1Api.md#regenarate_agent_token) | **POST** /api/v1/orgs/{owner}/agents/{agent}/token | Create agent token
...
*UsersV1Api* | [**delete_token**](docs/UsersV1Api.md#delete_token) | **DELETE** /api/v1/user/tokens/{uuid} | Delete token
...
*UsersV1Api* | [**patch_tokenm**](docs/UsersV1Api.md#patch_tokenm) | **PATCH** /api/v1/users/tokens/{token.uuid} | Patch token
