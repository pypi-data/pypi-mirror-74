...
class UsersV1Api(object):
    ...
    def delete_token_with_http_info(self, uuid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/user/tokens/{uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def patch_tokenm(self, token_uuid, body, **kwargs):  # noqa: E501
        """Patch token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_tokenm(token_uuid, body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.patch_tokenm_with_http_info(token_uuid, body, **kwargs)  # noqa: E501

    def patch_tokenm_with_http_info(self, token_uuid, body, **kwargs):  # noqa: E501
        """Patch token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_tokenm_with_http_info(token_uuid, body, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('token_uuid' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `token_uuid` when calling `patch_tokenm`")  # noqa: E501
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in local_var_params or  # noqa: E501
                                                        local_var_params['body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `body` when calling `patch_tokenm`")  # noqa: E501
