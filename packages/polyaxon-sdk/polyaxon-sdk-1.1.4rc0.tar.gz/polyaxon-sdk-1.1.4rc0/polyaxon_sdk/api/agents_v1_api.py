...
class AgentsV1Api(object):
    ...
    def get_agent_token_with_http_info(self, owner, agent, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('agent' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `agent` when calling `get_agent_token`")  # noqa: E501
    ...
    def regenarate_agent_token(self, owner, agent, **kwargs):  # noqa: E501
        """Create agent token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.regenarate_agent_token(owner, agent, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.regenarate_agent_token_with_http_info(owner, agent, **kwargs)  # noqa: E501

    def regenarate_agent_token_with_http_info(self, owner, agent, **kwargs):  # noqa: E501
        """Create agent token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.regenarate_agent_token_with_http_info(owner, agent, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method regenarate_agent_token" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in local_var_params or  # noqa: E501
                                                        local_var_params['owner'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `owner` when calling `regenarate_agent_token`")  # noqa: E501
        # verify the required parameter 'agent' is set
        if self.api_client.client_side_validation and ('agent' not in local_var_params or  # noqa: E501
                                                        local_var_params['agent'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `agent` when calling `regenarate_agent_token`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/orgs/{owner}/agents/{agent}/token', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
