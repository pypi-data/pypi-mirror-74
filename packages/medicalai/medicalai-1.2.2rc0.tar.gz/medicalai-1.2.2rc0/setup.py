...
setup(name='medicalai',
      ...
      download_url = 'https://github.com/aibharata/medicalAI/archive/v1.2.2-rc.zip',
      ...
      'tf_explain','numpy', 'pillow','tqdm', 'cmapy', 'albumentations', 
      'matplotlib', 'plotly', 'pandas', 'seaborn', 'sklearn', 'pydicom'],
