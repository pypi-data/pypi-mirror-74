...
from rp.libs.parso.python.tree import EndMarker
from rp.libs.parso.python.tokenize import PythonToken
...
def _get_debug_error_message(module, old_lines, new_lines):
    ...
    return (
        ...
        % (rp.libs.parso.__version__, ''.join(old_new_diff), ''.join(current_diff))
    )
