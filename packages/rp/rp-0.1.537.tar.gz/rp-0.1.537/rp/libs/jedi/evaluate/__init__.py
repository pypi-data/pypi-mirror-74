...
from rp.libs.jedi.evaluate import recursion
from rp.libs.jedi.evaluate.cache import evaluator_function_cache
from rp.libs.jedi.evaluate import helpers
from rp.libs.jedi.evaluate.names import TreeNameDefinition, ParamName
from rp.libs.jedi.evaluate.base_context import ContextualizedName, ContextualizedNode, \
    ContextSet, NO_CONTEXTS, iterate_contexts
from rp.libs.jedi.evaluate.context import ClassContext, FunctionContext, \
    AnonymousInstance, BoundMethod
from rp.libs.jedi.evaluate.context.iterable import CompForContext
from rp.libs.jedi.evaluate.syntax_tree import eval_trailer, eval_expr_stmt, \
...
class Evaluator(object):
    def __init__(self, project, environment=None, script_path=None):
        ...
        self.latest_grammar = rp.libs.parso.load_grammar(version='3.7')
