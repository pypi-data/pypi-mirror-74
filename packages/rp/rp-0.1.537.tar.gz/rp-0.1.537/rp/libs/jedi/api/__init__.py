...
from rp.libs.jedi import cache
from rp.libs.jedi.file_io import KnownContentFileIO
from rp.libs.jedi.api import classes
from rp.libs.jedi.api import interpreter
from rp.libs.jedi.api import helpers
from rp.libs.jedi.api.completion import Completion
from rp.libs.jedi.api.environment import InterpreterEnvironment
from rp.libs.jedi.api.project import get_default_project, Project
from rp.libs.jedi.evaluate import Evaluator
from rp.libs.jedi.evaluate import imports
from rp.libs.jedi.evaluate import usages
from rp.libs.jedi.evaluate.arguments import try_iter_content
from rp.libs.jedi.evaluate.helpers import get_module_names, evaluate_call_of_leaf
from rp.libs.jedi.evaluate.sys_path import transform_path_to_dotted
from rp.libs.jedi.evaluate.names import TreeNameDefinition, ParamName
from rp.libs.jedi.evaluate.syntax_tree import tree_name_to_contexts
from rp.libs.jedi.evaluate.context import ModuleContext
from rp.libs.jedi.evaluate.base_context import ContextSet
from rp.libs.jedi.evaluate.context.iterable import unpack_tuple_to_dict
from rp.libs.jedi.evaluate.gradual.conversion import convert_names, convert_contexts
from rp.libs.jedi.evaluate.gradual.utils import load_proper_stub_module
...
class Script(object):
    ...
    def __init__(self, source=None, line=None, column=None, path=None,
        ...
        self._grammar = rp.libs.parso.load_grammar()
        ...
        debug.speed('parsed')
        self._code_lines = rp.libs.parso.split_lines(source, keepends=True)
        self._code = source
