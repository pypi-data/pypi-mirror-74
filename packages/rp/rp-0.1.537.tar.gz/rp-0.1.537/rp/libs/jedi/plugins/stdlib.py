...
from rp.libs.jedi.evaluate.utils import safe_property
from rp.libs.jedi.evaluate.helpers import get_str_or_none
from rp.libs.jedi.evaluate.arguments import ValuesArguments, \
    repack_with_argument_clinic, AbstractArguments, TreeArgumentsWrapper
from rp.libs.jedi.evaluate import analysis
from rp.libs.jedi.evaluate import compiled
from rp.libs.jedi.evaluate.context.instance import BoundMethod, InstanceArguments
...
from rp.libs.jedi.evaluate.context import ClassContext, ModuleContext, \
    FunctionExecutionContext
from rp.libs.jedi.evaluate.context.klass import ClassMixin
from rp.libs.jedi.evaluate.context.function import FunctionMixin
from rp.libs.jedi.evaluate.context import iterable
from rp.libs.jedi.evaluate.lazy_context import LazyTreeContext, LazyKnownContext, \
    LazyKnownContexts
from rp.libs.jedi.evaluate.names import ContextName, BaseTreeParamName
from rp.libs.jedi.evaluate.syntax_tree import is_string
from rp.libs.jedi.evaluate.filters import AttributeOverwrite, publish_method, \
    ParserTreeFilter, DictFilter
from rp.libs.jedi.evaluate.signature import AbstractSignature, SignatureWrapper
...
def collections_namedtuple(obj, arguments, callback):
    ...
    parent_context = ModuleContext(
        ...
        file_io=None,
        string_names=None,
        code_lines=rp.libs.parso.split_lines(code, keepends=True),
    )
