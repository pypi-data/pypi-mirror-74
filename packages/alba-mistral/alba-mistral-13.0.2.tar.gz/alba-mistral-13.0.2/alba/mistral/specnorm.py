...
class SpecNormalize:
    ...
    def normalizeSpec(self):
        ...
        try:
            self.exptimes = instrument_grp["sample"]["ExpTimes"][()]
        ...
        # FFs Exposure Times
        try:
            self.exptimes_FF = instrument_grp["bright_field"]["ExpTimes"][()]
        ...
        # Images Currents
        try:
            self.currents = instrument_grp["sample"]["current"][()]
        ...
        # FFs Currents
        try:
            self.currents_FF = instrument_grp["bright_field"]["current"][()]
