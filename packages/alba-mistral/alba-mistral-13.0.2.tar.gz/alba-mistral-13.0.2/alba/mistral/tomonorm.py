...
class TomoNormalize:
    ...
    def normalize_tomo(self):
        ...
        #####################
        try:
            self.angles = nxtomo_grp["sample"]["rotation_angle"][()]
        ...
        #######################
        try:
            self.energies = instrument_grp["source"]["energy"][()]
        ...
        #######################
        try:
            self.currents_tomo = instrument_grp["sample"]["current"][()]
        ...
        #########################
        try:
            self.x_pixel_size = instrument_grp["sample"]["x_pixel_size"][()]
            self.y_pixel_size = instrument_grp["sample"]["y_pixel_size"][()]
        ...
        #############################
        self.exposuretimes_tomo = instrument_grp["sample"]["ExpTimes"][()]
        ...
        self.data_flatfield = FF_grp["data"][()]
        ...
        if self.darkfield:
            ...
            self.data_darkfield = DF_grp["data"][()]
            self.exptimes_DF = DF_grp["ExpTimes"][()]
