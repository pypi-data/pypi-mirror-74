...
def init_loguru(
    ...
    if pushover_on:
        ...
        _logger.add(pushover_handler, level=pushover_level)
    ...
    if sentry_on:
        ...
        _logger.add(sentry_breadcrumb_handler, level=sentry_breadcramp_level)

        sentry_event_handler = EventHandler(level=sentry_event_level)
        _logger.add(sentry_event_handler, level=sentry_event_level)
