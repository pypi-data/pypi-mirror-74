...
CONTRAST_RELEASE_VERSION = "3.1.2"
...
PROTOBUF_FILES = ["connect_pb2.py", "dtm_pb2.py", "settings_pb2.py"]
...
extensions = [
    Extension(
        ...
        # TODO: this is only necessary for funchook
...
class ContrastBuildExt(build_ext):
    def run(self):
        # TODO: just write this in Python eventually
        # TODO: this should probably eventually only happen at install time
...
setup(
    ...
    install_requires=["protobuf>=3.12", "psutil>=5.7"],
