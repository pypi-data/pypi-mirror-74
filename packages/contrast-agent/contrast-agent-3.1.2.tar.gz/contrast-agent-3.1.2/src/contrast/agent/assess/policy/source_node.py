...
class SourceNode(PolicyNode):
    ...
    def create_source_node(module, class_name, column_name, tags, policy_patch=True):
        ...
        node = SourceNode(
            ...
            method_name,
            target,
            policy_constants.DB_SOURCE_TYPE,
            file_name,
            tags=tags,
            policy_patch=policy_patch,
        )
    ...
    def from_dict(framework, obj):
        return SourceNode(
            ...
            obj[policy_constants.JSON_TYPE],
            framework,
            obj.get(policy_constants.JSON_TAGS, []),
            obj.get(policy_constants.JSON_SOURCE_NAME, None),
            obj.get(policy_constants.JSON_VERSION, SourceNode.ALL),
