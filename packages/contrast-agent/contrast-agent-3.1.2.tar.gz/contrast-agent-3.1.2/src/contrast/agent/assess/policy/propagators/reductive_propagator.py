...
from contrast.agent.assess.utils import cs__copy_from, get_properties


class ReductivePropagator(BasePropagator):
    def _propagate(self):
        # TODO: get someone to verify the refactor is good. see delete_tags_at_ranges
        cs__copy_from(self.target, self.first_source, 0, self.node.untags)
