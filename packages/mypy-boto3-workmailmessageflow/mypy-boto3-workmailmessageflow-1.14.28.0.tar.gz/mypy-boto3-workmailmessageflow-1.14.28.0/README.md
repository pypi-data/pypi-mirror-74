...
[boto3.WorkMailMessageFlow 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/workmailmessageflow.html#WorkMailMessageFlow) service
...
`mypy_boto3_workmailmessageflow` and other installed services.
...
session_client = boto3.Session().client("workmailmessageflow")
```
