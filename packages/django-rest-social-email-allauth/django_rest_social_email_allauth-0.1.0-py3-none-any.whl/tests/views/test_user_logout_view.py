...
class UserTokenLogoutTest(APITestCase):
    ...
    def test_authenticated_account_with_token_recognition_decides_to_logout_for_a_specific_device(
        self,
    ):
        """
    ...
    def test_authenticated_account_with_token_recognition_decides_to_logout_for_all_devices(
        self,
    ):
        """
		Ensuring the user in the system has token Authenticatian naa mean and log out once
