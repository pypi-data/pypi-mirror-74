...
class AppSettings(object):
    ...
    def CONFIRMATION_EXPIRATION(self):
        ...
        return self._setting("CONFIRMATION_EXPIRATION", datetime.timedelta(days=1))
    ...
    def CONFIRMATION_SAVE_PERIOD(self):
        ...
        return self._setting("CONFIRMATION_SAVE_PERIOD", datetime.timedelta(days=7))
    ...
    def PASSWORD_RESET_EXPIRATION(self):
        ...
        return self._setting("PASSWORD_RESET_EXPIRATION", datetime.timedelta(hours=1))
