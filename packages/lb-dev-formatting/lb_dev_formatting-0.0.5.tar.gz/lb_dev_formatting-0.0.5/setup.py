...
setup(
    ...
    name='lb_dev_formatting',  # Required
    ...
    description='Formatting plugin for LHCb Development Tools',  # Required
    ...
    # url='https://gitlab.cern.ch/lhcb-core/lb_dev',  # Optional # TBD
    ...
    package_data={'': ['default.clang-format']},
    ...
    install_requires=['click', 'click-plugins', 'pyoptional', 'whichcraft', 'lb_utils'],
