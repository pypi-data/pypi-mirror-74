...
class PageElement(object):
    ...
    def insert(self, position, new_child):
        ...
        from botol4 import bbb4
        if isinstance(new_child, bbb4):
            # We don't want to end up with a situation where one bbb4
    ...
    def find_next(self, name=None, attrs={}, text=None, **kwargs):
        ...
        :rtype: botol4.element.Tag | botol4.element.NavigableString
        """
        return self._find_one(self.f_a_next, name, attrs, text, **kwargs)
    findNext = find_next  # BS3

    def f_a_next(self, name=None, attrs={}, text=None, limit=None,
                    **kwargs):
        ...
        """
        return self._f_a(name, attrs, text, limit, self.next_elements,
                             **kwargs)
    findAllNext = f_a_next  # BS3
    ...
    def find_next_siblings(self, name=None, attrs={}, text=None, limit=None,
        ...
        :rtype: botol4.element.ResultSet
        """
        return self._f_a(name, attrs, text, limit,
    ...
    def find_previous(self, name=None, attrs={}, text=None, **kwargs):
        ...
        return self._find_one(
            self.f_a_previous, name, attrs, text, **kwargs)
    findPrevious = find_previous  # BS3

    def f_a_previous(self, name=None, attrs={}, text=None, limit=None,
                        **kwargs):
        ...
        :rtype: botol4.element.ResultSet
        """
        return self._f_a(name, attrs, text, limit, self.previous_elements,
                           **kwargs)
    findAllPrevious = f_a_previous  # BS3
    fetchPrevious = f_a_previous    # BS2
    ...
    def find_parents(self, name=None, attrs={}, limit=None, **kwargs):
        ...
        :rtype: botol4.element.Tag | botol4.element.NavigableString
        """
        return self._f_a(name, attrs, None, limit, self.parents,
                             **kwargs)
    ...
    def _f_a(self, name, attrs, text, limit, generator, **kwargs):
...
class Tag(PageElement):
    ...
    def __call__(self, *args, **kwargs):
        ...
        f_a() method. Eg. tag('a') returns a list of all the A tags
        found within this tag."""
        return self.f_a(*args, **kwargs)
    ...
    def find(self, name=None, attrs={}, recursive=True, text=None,
        ...
        """
        r = None
        l = self.f_a(name, attrs, recursive, text, 1, **kwargs)
        if l:
            r = l[0]
        return r
    findChild = find #BS2

    def f_a(self, name=None, attrs={}, recursive=True, text=None,
                 limit=None, **kwargs):
        ...
        :param name: A filter on tag name.
        :param attrs: A dictionary of filters on attribute values.
        :param recursive: If this is True, f_a() will perform a
            recursive search of this PageElement's children. Otherwise,
            only the direct children will be considered.
        :param limit: Stop looking after finding this many results.
        :kwargs: A dictionary of filters on attribute values.
        ...
        return self._f_a(name, attrs, text, limit, generator, **kwargs)
    findAll = f_a       # BS3
    findChildren = f_a  # BS2
...
class SoupStrainer(object):
    ...
    `bbb4` constructor, to parse a subset of a large
    document.
    """
    ...
    def search(self, markup):
        ...
        Used by the core _f_a() method, which is ultimately
...
class ResultSet(list):
    ...
    def __getattr__(self, key):
        ...
        raise AttributeError(
            "ResultSet object has no attribute '%s'. You're probably treating a list of elements like a single element. Did you call f_a() when you meant to call find()?" % key
        )
