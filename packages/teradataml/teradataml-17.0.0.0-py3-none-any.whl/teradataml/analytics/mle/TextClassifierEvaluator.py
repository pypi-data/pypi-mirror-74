...
class TextClassifierEvaluator:
    ...
    def __init__(self,
        ...
        self.__arg_info_matrix.append(["predict_column", self.predict_column, False, (str)])
    ...
    def __validate(self):
        ...
        argument values.
        """
        if isinstance(self.object, TextClassifier):
        ...
        self.__awu._validate_input_table_datatype(self.object, "object", TextClassifier)
        ...
        self.__awu._validate_input_columns_not_empty(self.predict_column, "predict_column")
        self.__awu._validate_dataframe_has_argument_columns(self.predict_column, "predict_column", self.object, "object", False)
    ...
    def __form_tdml_query(self):
        ...
        self.__func_other_args.append(UtilFuncs._teradata_collapse_arglist(UtilFuncs._teradata_quote_arg(self.predict_column, "\""), "'"))
        self.__func_other_arg_json_datatypes.append("COLUMNS")
