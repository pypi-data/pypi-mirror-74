...
class DTW:
    ...
    def __init__(self,
        ...
        self.__arg_info_matrix.append(["mapping_data", self.mapping_data, False, (DataFrame)])
        self.__arg_info_matrix.append(["mapping_data_partition_column", self.mapping_data_partition_column, False, (str,list)])
