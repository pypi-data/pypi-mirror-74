...
setup(
  ...
  packages = ['FreeTAKServer', 'FreeTAKServer.controllers', 'FreeTAKServer.controllers.configuration', 'FreeTAKServer.controllers.model', 'FreeTAKServer.controllers.logs'],   # Chose the same as "name"
  version = '0.9.9.02',      # Start with a small number and increase it with every change you make
