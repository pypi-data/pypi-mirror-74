...
class AIOZMQServer(InterstateServer):
    ...
    async def start(self, loop):
        ...
        control_queue = Queue()
        inbound_wire_message_queue = Queue()

        inbound_worker = InboundWorker(router, inbound_wire_message_queue)
        ...
        demultiplexer = StreamDemultiplexer(inbound_wire_message_queue, agent, self._serialization)
