...
class Cycle:
    def __init__(self):
        self.required = ['defaultSource', 'endDate', 'functionalUnitMeasure', 'dataCompleteness']
        self.fields = OrderedDict()
...
class Practices:
    def __init__(self):
        self.required = []
        self.fields = OrderedDict()
        self.fields['type'] = SchemaType.PRACTICES.value
...
class Site:
    def __init__(self):
        self.required = ['defaultSource', 'country']
        self.fields = OrderedDict()
