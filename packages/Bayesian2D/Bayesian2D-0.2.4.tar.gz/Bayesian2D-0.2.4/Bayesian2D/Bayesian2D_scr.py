...
def Bayesian2D(x_bounds, y_bounds, starting_n, iterations, max_min, exploration, function = 'Rosenbrock' ):
    ...
    x, y, z_best = results(objective, acquisition, starting_n, x_bounds, y_bounds, iterations, e, model, max_min)
...
# y_res = ([])
# for i in range(5):
#     x , y , z_b = Bayesian2D(([-100, 100]), ([-100, 100]), 100, 400, 'minimum', 0.01)
#     x_res.append(x)
#     y_res.append(y)
#     res.append(z_b)
# print(x_res, y_res, res)

Bayesian2D(([-100, 100]), ([-100, 100]), 100, 400, 'minimum', 0.1)