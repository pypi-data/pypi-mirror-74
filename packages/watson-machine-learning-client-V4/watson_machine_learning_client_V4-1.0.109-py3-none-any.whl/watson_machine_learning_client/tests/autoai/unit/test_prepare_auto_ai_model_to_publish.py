...
from watson_machine_learning_client.experiment.autoai.utils import prepare_auto_ai_model_to_publish
from watson_machine_learning_client.helpers import get_credentials_from_config
...
class TestPrepareAutoaiModelToPublish(unittest.TestCase):
    ...
    def setUp(cls) -> None:
        ...
        cls.client_cloud = WatsonMachineLearningAPIClient(cls.wml_credentials_cloud)
        cls.client_cp4d = WatsonMachineLearningAPIClient(cls.wml_credentials_cp4d, cls.project_id)
