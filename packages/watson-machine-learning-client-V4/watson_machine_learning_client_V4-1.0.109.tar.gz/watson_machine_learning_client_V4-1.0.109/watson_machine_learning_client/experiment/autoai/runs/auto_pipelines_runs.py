...
class AutoPipelinesRuns(BaseAutoPipelinesRuns):
    ...
    def get_params(self, run_id: str = None) -> dict:
        ...
        csv_separator = optimizer_config['entity']['document']['pipelines'][0]['nodes'][0]['parameters'].get('input_file_separator', ',')
        excel_sheet = optimizer_config['entity']['document']['pipelines'][0]['nodes'][0]['parameters'].get('excel_sheet', 0)
