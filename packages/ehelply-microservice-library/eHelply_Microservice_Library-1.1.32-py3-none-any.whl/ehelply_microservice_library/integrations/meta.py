...
class Meta(Integration):
    ...
    def create(self, service: str, type_str: str, entity_uuid: str, meta: MetaCreate) -> Union[MetaDynamo, None, bool]:
        ...
        response = self.m2m.requests.post(self.get_base_url() + "/service/" + service + "/type/" + type_str + "/entity/" + entity_uuid,
            json=data)
    ...
    def get_using_uuid(self, meta_uuid: str, detailed: bool = False, custom: bool = False, dates: bool = False) -> Union[None, bool, MetaGet]:
        """
        Get meta
        :param meta_uuid:
        :param detailed:
    ...
    def delete(self, service: str, type_str: str, entity_uuid: str):
        ...
        return self.m2m.requests.delete(
            self.get_base_url() + "/service/" + service + "/type/" + type_str + "/entity/" + entity_uuid).json()
    ...
    def delete_using_uuid(self, meta_uuid: str):
        ...
        return self.m2m.requests.delete(self.get_base_url() + "/" + meta_uuid).json()
