    ...
    if user_input:
        if re.search("[^0-9]", user_input):
            if re.search("[a-zA-Z]", user_input):
                ...
                print("you put in a symbol, please try again")
        else:
            print("you put in an int, please try again")
    else:
        print("you put in nothing, please try again")
    return True
            ...
            if re.search("[0-9]", user_string):
                ...
                if user_string not in list_bad_inputs:
                    if user_string < cap:
                        ...
                        print("your input was higher than ten, please try again")
                else:
                    print("your input has already been picked please try again")
            else:
                print("your input had symbols, please try again")
        else:
            print("Your input was a string, please try again")
    else:
        print("you inputted nothing, please try again")
    return True
