...
[boto3.AppConfig 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/appconfig.html#AppConfig) service
...
`mypy_boto3_appconfig` and other installed services.
...
session_client = boto3.Session().client("appconfig")
```
