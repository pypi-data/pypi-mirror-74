...
set_target_properties(mahi::clipper PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libclipper.a"
  )
...
set_target_properties(mahi::gui PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmahi-gui.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS mahi::gui )
list(APPEND _IMPORT_CHECK_FILES_FOR_mahi::gui "${_IMPORT_PREFIX}/lib/libmahi-gui.a" )
