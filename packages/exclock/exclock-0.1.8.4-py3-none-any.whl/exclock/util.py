...
CLOCK_DIR_IN_SYS = ASSET_DIR_IN_SYS / "clock"
SOUND_DIR_IN_SYS = ASSET_DIR_IN_SYS / "sound"

DEFAULT_IMAGE_PATH = ASSET_DIR_IN_PROG / "icon.png"
...
def notify(title: str, message: str) -> None:
    message = quote(title + "\n" + message)
    os.system(f'(xmessage -nearmouse {message}) &')
