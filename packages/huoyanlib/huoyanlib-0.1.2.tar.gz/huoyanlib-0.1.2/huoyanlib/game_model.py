...
def gobang():
    ...
    def main():
        ...
        pygame.display.set_caption('人机五子棋')
    ...
    class AI:
        ...
        def _get_stone_color(self, point, x_offset, y_offset, next_b):
            x = point.X + x_offset
            y = point.Y + y_offset
            if 0 <= x < self._line_points and 0 <= y < self._line_points:
                if self._checkerboard[y][x] == self._my.Value:
    ...
    while True:
        ...
        for x in range(12):
            for x in pan3[x]:
                print(x, end='')
            print("")
        q1 = input("请输入您要挖开那个格的那一行：")
        q2 = input("请输入您要挖开那个格的那一列：")
        q3 = input("它是雷吗？y/n")
        try:
            q1 = int(q1)
            q2 = int(q2)
            ...
            print(a[aa][bb])
            o()
            if a[aa][bb] == "o" and q3 == "n":
                o()
                print("\033[1;33m额，您挖到了雷，您输了，点运行重新开始")
                break
            elif pan3 == a:
                o()
                print("恭喜，您赢了！")
                ...
                if a[aa][bb] == "#":
                    o()
                    print("\n\033[1;46m您没有挖到东西\033[1;0m\n")
                    pan3[aa][bb] = "\033[1;42m", a[aa][bb]
                elif a[aa + 1][bb] != "o":
                    pan3[aa + 1][bb] = a[aa + 1][bb]
                elif a[aa - 1][bb] != "o":
                    pan3[aa - 1][bb] = a[aa - 1][bb]
                elif a[aa][bb + 1] != "o":
                    pan3[aa][bb + 1] = a[aa][bb + 1]
                elif a[aa][bb - 1] != "o":
                    pan3[aa][bb - 1] = a[aa][bb - 1]
                pan3[aa][bb] = a[aa][bb]
        except ValueError:
            o()
            print("\033[1;31m输入错误，请重新输入！\033[1;0m")
        except IndexError:
            o()
            print("\033[1;31m输入错误，请重新输入！\033[1;0m")