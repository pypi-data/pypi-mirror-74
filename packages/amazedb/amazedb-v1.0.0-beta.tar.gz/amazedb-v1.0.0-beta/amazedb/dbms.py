'''
The utils.database.db module is used to create, update, read from and write to the
...
class db:
    ...
    def __init__(self, name: str, dbPath: str = '.', safeMode: bool = True, preLoad: bool = True):
    ...
    def getGroup(self, name: str, safeMode: bool = True, preLoad: bool = False):
        ...
        if name not in self.groups:
            ...
            # Otherwise
                ...
                raise group.GroupNotFoundError(f'The requested group {name} has no been created.')
    ...
    def import_data(self, path, key):
        ...
        # Some other exception
            ...
            raise Exception('Encountered a problem while importing {}: \n\t\t{}'.format(path, exc))
