...
[boto3.CodeBuild 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/codebuild.html#CodeBuild) service
...
def get_structure() -> BuildArtifactsTypeDef:
    return {
      ...
    }
```
