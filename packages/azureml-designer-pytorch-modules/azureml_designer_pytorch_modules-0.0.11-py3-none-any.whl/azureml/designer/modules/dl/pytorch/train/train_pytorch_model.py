...
def load_dataset(data_path):
    try:
        ...
        ErrorMapping.rethrow(e, NotLabeledDatasetError(dataset_name=data_path))
...
def save_trained_model(trained_model_path, best_model, init_params, class_to_idx, task_type):
        ...
        "dependencies": [
            "python=3.6.8", {
                "pip": [
                    ...
                    "azureml-designer-pytorch-modules==0.0.11",
                ]
            }
        ]
    }
