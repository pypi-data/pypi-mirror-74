...
from nectarine.typing import get_generic_args, get_generic_collection_origin, is_number, is_linear_collection, is_tuple
...
def env(
    ...
    """
    Configure a provider that uses the program environment
