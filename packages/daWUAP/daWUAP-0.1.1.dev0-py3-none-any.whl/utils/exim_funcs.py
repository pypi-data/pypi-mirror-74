...
def import_obs_from_csv(fn_input_csv, fn_out_json=None, year=None, sep=',', crops=None):
    """produces a json file with list of observation dictionaries """
    ...
    if crops is not None:
        #df_in = df_in.drop(labels=crops, level=2)
