...
import fast_tracker.core.solr_node

import fast_tracker.api.time_trace
import fast_tracker.api.object_wrapper


class SolrTrace(fast_tracker.api.time_trace.TimeTrace):
    ...
    def create_node(self):
        return fast_tracker.core.solr_node.SolrNode(
...
class SolrTraceWrapper(object):
    ...
    def __call__(self, *args, **kwargs):
        parent = fast_tracker.api.time_trace.current_trace()
        if not parent:
...
def wrap_solr_trace(module, object_path, library, command):
    fast_tracker.api.object_wrapper.wrap_object(module, object_path, SolrTraceWrapper, (library, command))
