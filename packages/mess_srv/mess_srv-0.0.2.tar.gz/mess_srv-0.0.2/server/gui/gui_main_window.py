...
from server.gui.gui_stat_window import StatWindow
from server.gui.gui_config_window import ConfigWindow
from server.gui.gui_user_add import RegisterUser
from server.gui.gui_user_remove import DelUserDialog
...
class MainWindow(QMainWindow):
    def __init__(self, database, server, config):
        ...
        self.setWindowTitle('Messenger Server v0.01')
