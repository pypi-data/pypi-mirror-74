...
class ConfigWindow(QDialog):
    ...
    def initUI(self):
        ...
        self.db_path.insert(self.config['SETTINGS']['db_path'])
        self.db_file.insert(self.config['SETTINGS']['db_file'])
        self.port.insert(self.config['SETTINGS']['port'])
        self.ip.insert(self.config['SETTINGS']['ip_addr'])
    ...
    def save_server_config(self):
        ...
        try:
            ...
            self.config['SETTINGS']['ip_addr'] = self.ip.text()
            if 1023 < port < 65536:
