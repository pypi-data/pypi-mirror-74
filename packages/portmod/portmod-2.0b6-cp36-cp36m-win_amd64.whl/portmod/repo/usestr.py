...
def use_reduce(
    ...
    @param excludeall: List of flags for which negated conditionals are always treated
                       as inactive.
    ...
    @param is_valid_flag: Function that decides if a given use flag might be used in
                          use conditionals
...
def parse_usestr(usestr: str, token_class: Optional[Type] = str):
    """
    Adapted from portage's check_required_use
