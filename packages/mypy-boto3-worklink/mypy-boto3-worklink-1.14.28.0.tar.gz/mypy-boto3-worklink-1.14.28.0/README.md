...
[boto3.WorkLink 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/worklink.html#WorkLink) service
...
`mypy_boto3_worklink` and other installed services.
