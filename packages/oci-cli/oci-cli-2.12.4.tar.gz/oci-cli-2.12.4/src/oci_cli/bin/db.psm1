...
function GetOciSubcommands_db() {
    $ociSubcommands = @{
        ...
        'db autonomous-database' = 'change-compartment create create-from-backup-id create-from-backup-timestamp create-from-clone data-safe delete fail-over generate-wallet get list restart restore start stop switchover update'
        ...
        'db system' = 'change-compartment get get-exadata-iorm-config launch launch-from-backup list patch terminate update update-exadata-iorm-config'
...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db autonomous-database list' = 'all autonomous-container-database-id compartment-id db-version db-workload display-name from-json help infrastructure-type is-data-guard-enabled is-free-tier lifecycle-state limit page page-size sort-by sort-order'
        ...
        'db autonomous-database update' = 'admin-password autonomous-database-id cpu-core-count data-storage-size-in-tbs db-name db-version defined-tags display-name force freeform-tags from-json help if-match is-auto-scaling-enabled is-data-guard-enabled is-free-tier license-model max-wait-seconds nsg-ids private-endpoint-label subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
        ...
        'db maintenance-run update' = 'from-json help if-match is-enabled maintenance-run-id max-wait-seconds time-scheduled wait-for-state wait-interval-seconds'
