...
function GetOciSubcommands_compute() {
    $ociSubcommands = @{
        'compute' = 'boot-volume-attachment console-history dedicated-vm-host dedicated-vm-host-instance device image image-shape-compatibility-entry instance instance-console-connection pic shape vnic-attachment volume-attachment'
...
function GetOciCommandsToLongParams_compute() {
    $ociCommandsToLongParams = @{
        ...
        'compute instance launch' = 'agent-config assign-public-ip availability-domain boot-volume-size-in-gbs compartment-id dedicated-vm-host-id defined-tags display-name extended-metadata fault-domain freeform-tags from-json help hostname-label image-id ipxe-script-file is-pv-encryption-in-transit-enabled launch-options max-wait-seconds metadata nsg-ids private-ip shape shape-config skip-source-dest-check source-boot-volume-id source-details ssh-authorized-keys-file subnet-id user-data-file vnic-display-name wait-for-state wait-interval-seconds'
        ...
        'compute instance update' = 'agent-config defined-tags display-name extended-metadata force freeform-tags from-json help if-match instance-id max-wait-seconds metadata shape shape-config wait-for-state wait-interval-seconds'
