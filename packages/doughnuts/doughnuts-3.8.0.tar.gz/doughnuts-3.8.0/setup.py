...
['doughnuts',
 ...
 'doughnuts.general',
 'doughnuts.libs',
 'doughnuts.main_plugins',
 'doughnuts.webshell_plugins',
 'doughnuts.webshell_template']

package_data = \
{'': ['*'],
 'doughnuts': ['auxiliary/av/*',
               'auxiliary/ld_preload/*',
               'auxiliary/priv/*',
               'auxiliary/reshell/*',
               'auxiliary/udf/*',
               'auxiliary/udf/mysql/linux/32/*',
               'auxiliary/udf/mysql/linux/64/*',
               'auxiliary/udf/mysql/windows/32/*',
               'auxiliary/udf/mysql/windows/64/*',
               'auxiliary/udf/postgresql/linux/32/8.2/*',
               'auxiliary/udf/postgresql/linux/32/8.3/*',
               'auxiliary/udf/postgresql/linux/32/8.4/*',
               'auxiliary/udf/postgresql/linux/32/9.0/*',
               'auxiliary/udf/postgresql/linux/64/8.2/*',
               'auxiliary/udf/postgresql/linux/64/8.3/*',
