...
class TestAssertTestIDs(unittest.TestCase):
    ...
    def test_single(self):
        assertTestIDs(self, ['byot.fixtures.UnittestTest.test_pass'],
                      fixtures.make_case())

    def test_several(self):
        assertTestIDs(self, ['byot.fixtures.UnittestTest.test_pass',
                             'byot.fixtures.UnittestTest.test_pass'],
...
file: t/__init__.py
import os
from byot import loaders, matchers
def load_tests(loader, std_tests, pattern):
...
''')
        ...
        sys.path.insert(0, os.path.join(os.getcwd(), 't'))
        assertTestIDs(self, ['t1.test.T.test_pass'],
