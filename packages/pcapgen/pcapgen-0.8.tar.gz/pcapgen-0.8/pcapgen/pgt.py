...
class HTTP:
    ...
    def make_POST_pcap(self, pcapname, fileobj, content_encoding, transfer_encoding, content_type):
        ...
        # Don't append random strings for HTTP POST! Let it start with 0th offset
        # prefix = randtext() + "="
        prefix = ""
        fp = getattr(fileobj, 'get_{0}'.format(content_encoding))
...
class Email:
    """
    The Email() class is responsible for SMTP, POP3 and IMAP,
    considering the similiarities between them
    """
    ...
    def make_SMTP_pcap(self, pcapname, email):
        ...
        banner = "220 {0} Microsoft ESMTP MAIL Service, Version: 6.0.3790.3959 ready at  {1}, {2:02} {3} 2020 {4:02}:{5:02}:{6:02} {7}{8:02}00\r\n"
...
if __name__ == '__main__':
    ...
    for file in args:
        ...
        for proto in protocols:
            print("\n[*] Generating {0} packet traces..".format(proto.__class__.__name__))
