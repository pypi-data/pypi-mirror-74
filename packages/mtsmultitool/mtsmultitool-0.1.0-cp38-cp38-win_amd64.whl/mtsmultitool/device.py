...
def export_key_pair(sk: ecdsa.SigningKey, name: str, out_dir: str = None):
    """
...
def generate_manifest(fw_upgrade: FirmwareUpgrade, required_version: list or None,
                      class_desc: str, vendor_dns: str = None) -> dict:
    """
    ...
    :param class_desc: Class description used to generate class_id using UUID3
