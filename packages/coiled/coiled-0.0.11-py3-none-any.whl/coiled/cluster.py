...
class CoiledCluster(distributed.deploy.Cluster):
...
class Cluster(CoiledCluster):
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "Cluster has been renamed to CoiledCluster. Please "
            "switch to using CoiledCluster as Cluster will be "
