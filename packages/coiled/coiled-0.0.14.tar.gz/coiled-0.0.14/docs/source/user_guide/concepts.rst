...
.. note::
    ...
    When you create your Coiled account you'll have two software
...
.. code-block:: python
    ...
    coiled.delete_software_environments(name="my-pip-env")
...
``coiled`` comes with a command line interface, ``coiled install``, for creating
a Coiled conda software environment locally on your machine. This is useful
...
.. note::
    ...
    When you create your Coiled account you'll have a "default"
