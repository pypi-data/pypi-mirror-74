...
class CfnCanary(
    ...
    def __init__(
        ...
        *,
        ...
        name: str,
        run_config: typing.Union[aws_cdk.core.IResolvable, "RunConfigProperty"],
        runtime_version: str,
    ...
    def run_config(self) -> typing.Union[aws_cdk.core.IResolvable, "RunConfigProperty"]:
    ...
    @run_config.setter
    def run_config(
        self, value: typing.Union[aws_cdk.core.IResolvable, "RunConfigProperty"]
    ) -> None:
...
class CfnCanaryProps:
    def __init__(
        ...
        *,
        ...
        run_config: typing.Union[
            aws_cdk.core.IResolvable, "CfnCanary.RunConfigProperty"
        ],
        runtime_version: str,
        ...
        tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]] = None,
        vpc_config: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "CfnCanary.VPCConfigProperty"]
        ] = None,
    ) -> None:
    ...
    def run_config(
        self,
    ) -> typing.Union[aws_cdk.core.IResolvable, "CfnCanary.RunConfigProperty"]:
        """``AWS::Synthetics::Canary.RunConfig``.
