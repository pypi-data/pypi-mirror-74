...
import kw618.k_finance.utils_quant as Q
...
try:
    ...
    print(
        ...
        # 2. 远程 mysql
try:
    if socket.gethostname() != "iZbp1fp1ljg8kuditz9t94Z":
        # pymysql
        ...
        # pandas专用引擎
        remote_engine = create_engine('mysql+pymysql://root:kw618@121.40.240.153:3306/ttt_db?charset=utf8')
except:
    print(k_tb(10))  ## except中, 可以呈现详细的报错信息
    print(
