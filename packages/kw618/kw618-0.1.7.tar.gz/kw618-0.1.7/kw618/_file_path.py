...
if platform.system() == "Windows":
    ...
    REMOTE_HOST = "121.40.240.153" # 阿里云的ip
    REMOTE_HOST = "kw618.xyz" # 阿里云的ip
    FILE_PATH_FOR_DESKTOP = f"/root/{user_name}/Desktop"
    FILE_PATH_FOR_MYBOX = f"/root/{user_name}/MyBox"
    # FILE_PATH_FOR_KW618 = f"/root/{user_name}/MyBox/kw618/kw618" # 尽量减少使用这个文件路径 (因为它是pypi包, 不应该有固定路径!!!)
    FILE_PATH_FOR_MYCODE = f"/root/{user_name}/MyBox/MyCode"
    FILE_PATH_FOR_LIBS = f"/root/{user_name}/MyBox/MyCode/Libs"
    FILE_PATH_FOR_ZIRU_CODE = f"/root/{user_name}/MyBox/MyCode/BusinessProj/Ziru"
    FILE_PATH_FOR_ZIRU = f"/root/{user_name}/MyBox/工作相关/自如"
    FILE_PATH_FOR_VUE = f"/root/{user_name}/MyBox/VueProj"
