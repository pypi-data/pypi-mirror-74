...
class CogniteGeospatialClient:
            ...
            if layer is not None:
                for layer_attribute in layer.attributes:
                    ...
                    if data is not None and len(data.items) > 0:
                        ...
                        if layer_attribute.type == AttributeTypeDTO.DOUBLE:
                        ...
                        elif layer_attribute.type == AttributeTypeDTO.STRING:
                            spatial_object.add_text(layer_attribute.name, str(byte_buffer, "utf-8"))
    ...
    def get_attributes(
        ...
        async def get_attributes(
            ...
            layer_types = {l.name: l.type for l in layer.attributes}
            result = {}
        ...
        if attributes is not None:
            for name, value in attributes.items():
                if not _is_primitive(value):
                    ...
                    await self.add_spatial_item_data_async(item.id, name, value, attribute.type)
