...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of cognite.geospatial._client.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = cognite.geospatial._client.Configuration(
    ...
    Note you can use the constants defined in the cognite.geospatial._client.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = cognite.geospatial._client.Configuration(
        signing_info = cognite.geospatial._client.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://api.cognitedata.com",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("cognite.geospatial._client")
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: playground\n"\
               "SDK Package Version: 1.0-SNAPSHOT".\
