...
class Client:
    ...
    def upload_data(self, data):
        ...
        Args:
            data (bytes or file path): The data to upload. If a path is given,
                content type will be inferred if possible.
        Returns:
        ...
        if isinstance(data, str) and os.path.exists(data):
            with open(row_data, "rb") as f:
                content_type, _ = mimetypes.guess_type(row_data)
                data = (f.read(), os.path.basename(row_data), content_type)
