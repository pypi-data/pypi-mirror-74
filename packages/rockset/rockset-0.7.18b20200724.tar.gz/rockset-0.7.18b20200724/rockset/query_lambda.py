...
Execute a specfic Query Lambda version
--------------------------------------
...
from rockset.swagger_client.models import (
    ...
    UpdateQueryLambdaRequest, ExecuteQueryLambdaRequest, QueryParameter
)
...
class QueryLambdaVersion(rockset.swagger_client.models.QueryLambdaVersion):
    ...
    def update(self, query, description=None):
        """Updates the query associated with thie Query Lambda and returns
        ...
        Returns:
            QueryLambda: a QueryLambda object that represents the new version
        """
        ql_sql = _convert_query_to_qlsql(query)
