    ...
    def __init__(
        ...
        *,
        distributions: typing.Union[
            ...
            typing.List[typing.Union["DistributionProperty", aws_cdk.core.IResolvable]],
        ],
        name: str,
        description: typing.Optional[str] = None,
        tags: typing.Optional[typing.Mapping[str, str]] = None,
    ...
    def __init__(
        ...
        *,
        ...
        image_tests_configuration: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "ImageTestsConfigurationProperty"]
        ] = None,
        tags: typing.Optional[typing.Mapping[str, str]] = None,
    ) -> None:
...
class CfnImagePipeline(
    ...
    def __init__(
        ...
        *,
        ...
        schedule: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "ScheduleProperty"]
        ] = None,
    ...
    def schedule(
        self,
    ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "ScheduleProperty"]]:
...
class CfnImagePipelineProps:
    def __init__(
        ...
        *,
        ...
        schedule: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "CfnImagePipeline.ScheduleProperty"]
        ] = None,
        status: typing.Optional[str] = None,
        tags: typing.Optional[typing.Mapping[str, str]] = None,
    ) -> None:
    ...
    def image_tests_configuration(
        ...
        typing.Union[
            aws_cdk.core.IResolvable, "CfnImagePipeline.ImageTestsConfigurationProperty"
        ]
    ]:
        """``AWS::ImageBuilder::ImagePipeline.ImageTestsConfiguration``.
...
class CfnImageProps:
    def __init__(
        ...
        *,
        ...
        image_tests_configuration: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable, "CfnImage.ImageTestsConfigurationProperty"
            ]
        ] = None,
        tags: typing.Optional[typing.Mapping[str, str]] = None,
    ) -> None:
    ...
    def __init__(
        ...
        *,
        components: typing.Union[
            aws_cdk.core.IResolvable,
            typing.List[
                typing.Union[aws_cdk.core.IResolvable, "ComponentConfigurationProperty"]
            ],
        ],
        name: str,
        parent_image: str,
        ...
        block_device_mappings: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        aws_cdk.core.IResolvable, "InstanceBlockDeviceMappingProperty"
                    ]
                ],
            ]
        ] = None,
