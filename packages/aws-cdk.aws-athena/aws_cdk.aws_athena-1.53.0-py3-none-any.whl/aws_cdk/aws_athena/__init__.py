...
class CfnWorkGroup(
    ...
    def __init__(
        ...
        *,
        ...
        work_group_configuration: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "WorkGroupConfigurationProperty"]
        ] = None,
        work_group_configuration_updates: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable, "WorkGroupConfigurationUpdatesProperty"
            ]
        ] = None,
    ) -> None:
    ...
    def work_group_configuration_updates(
        ...
        typing.Union[aws_cdk.core.IResolvable, "WorkGroupConfigurationUpdatesProperty"]
    ]:
    ...
    class ResultConfigurationProperty:
        ...
        def encryption_configuration(
            ...
            typing.Union[
                aws_cdk.core.IResolvable, "CfnWorkGroup.EncryptionConfigurationProperty"
            ]
        ]:
    ...
    @jsii.data_type(
        jsii_type="@aws-cdk/aws-athena.CfnWorkGroup.TagsProperty",
        jsii_struct_bases=[],
        name_mapping={"tags": "tags"},
    )
    class TagsProperty:
        def __init__(
            self, *, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]] = None
        ) -> None:
            """
        ...
        def __init__(
            ...
            *,
            ...
            result_configuration: typing.Optional[
                typing.Union[
                    aws_cdk.core.IResolvable, "CfnWorkGroup.ResultConfigurationProperty"
                ]
            ] = None,
        ) -> None:
            """
...
class CfnWorkGroupProps:
    def __init__(
        ...
        *,
        ...
        state: typing.Optional[str] = None,
        tags: typing.Optional["CfnWorkGroup.TagsProperty"] = None,
        work_group_configuration: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable, "CfnWorkGroup.WorkGroupConfigurationProperty"
            ]
        ] = None,
        work_group_configuration_updates: typing.Optional[
            typing.Union[
        ...
        if isinstance(tags, dict):
            tags = CfnWorkGroup.TagsProperty(**tags)
        self._values = {
            "name": name,
        }
        if description is not None:
