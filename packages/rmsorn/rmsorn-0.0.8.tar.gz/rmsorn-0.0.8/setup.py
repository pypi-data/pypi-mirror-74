...
setup(
    ...
    keywords = """Brain-Inspired Computing,Artificial Neural Networks,Neuro Informatics, 
                  Spiking Cortical Networks, Reinformcement Learning, Neural Connectomics,Neuroscience, Artificial General Intelligence, Neural Information Processing""" ,
    url = "https://github.com/Saran-nns/rm_sorn",
    packages=['rmsorn'],
    data_files = ["LICENSE"],
