...
setup(
  ...
  version = '1.2.0-alpha.1',      # Start with a small number and increase it with every change you make
  ...
  url = 'https://github.com/scoopgracie/scrapesy',   # Provide either the link to your github or to your website
  keywords = ['scrape', 'web', 'scraper', 'scraping'],   # Keywords that define your package best
