    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_developer_tools_notifications._jsii": [
            "cdk-developer-tools-notifications@1.0.21.jsii.tgz"
        ],
        "cloudcomponents.cdk_developer_tools_notifications": [
            "py.typed"
        ]
    ...
    "install_requires": [
        "jsii>=1.9.0, <2.0.0",
        "publication>=0.0.3",
        "aws-cdk.aws-codebuild>=1.53.0, <2.0.0",
        "aws-cdk.aws-codecommit>=1.53.0, <2.0.0",
        "aws-cdk.aws-codedeploy>=1.53.0, <2.0.0",
        "aws-cdk.aws-codepipeline>=1.53.0, <2.0.0",
        "aws-cdk.aws-codestarnotifications>=1.53.0, <2.0.0",
        "aws-cdk.aws-iam>=1.53.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.53.0, <2.0.0",
        "aws-cdk.aws-lambda-event-sources>=1.53.0, <2.0.0",
        "aws-cdk.aws-sns>=1.53.0, <2.0.0",
        "aws-cdk.core>=1.53.0, <2.0.0",
        "cloudcomponents.cdk-chatops>=1.0.20, <2.0.0"
    ],
    "classifiers": [
