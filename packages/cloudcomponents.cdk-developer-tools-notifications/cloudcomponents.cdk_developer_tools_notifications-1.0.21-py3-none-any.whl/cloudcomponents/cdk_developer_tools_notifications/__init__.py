...
class INotificationRule(jsii.compat.Protocol):
    ...
    def notification_rule_arn(self) -> str:
        ...
...
class INotificationTarget(jsii.compat.Protocol):
    @builtins.staticmethod
    def __jsii_proxy_class__():
    ...
    def bind(
        self, scope: aws_cdk.core.Construct, rule: "INotificationRule"
...
class MSTeamsIncomingWebhook(
    ...
    def __init__(
        self, webhook: cloudcomponents.cdk_chatops.MSTeamsIncomingWebhookConfiguration
    ) -> None:
        """
        :param webhook: -
        """
    ...
    @jsii.member(jsii_name="bind")
    def bind(
        self, scope: aws_cdk.core.Construct, _rule: "INotificationRule"
    ) -> "NotificationTargetProperty":
        """
        :param scope: -
        :param _rule: -
...
class NotificationRule(
    ...
    def __init__(
        ...
        *,
        events: typing.List[
            typing.Union[
                "RepositoryEvent", "ProjectEvent", "ApplicationEvent", "PipelineEvent"
            ]
        ],
        resource: str,
        name: str,
...
class NotificationTargetProperty:
    def __init__(self, *, target_address: str, target_type: "TargetType") -> None:
        """
...
@jsii.enum(jsii_type="@cloudcomponents/cdk-developer-tools-notifications.PipelineEvent")
...
class PipelineNotificationRuleProps(CommonNotificationRuleProps):
    ...
    def pipeline(self) -> aws_cdk.aws_codepipeline.IPipeline:
        return self._values.get("pipeline")
...
class SlackChannel(
    ...
    def __init__(
        self, channel: cloudcomponents.cdk_chatops.ISlackChannelConfiguration
    ) -> None:
        """
        :param channel: -
        """
    ...
    @jsii.member(jsii_name="bind")
    def bind(
        self, _scope: aws_cdk.core.Construct, _rule: "INotificationRule"
    ) -> "NotificationTargetProperty":
        """
        :param _scope: -
        :param _rule: -
    ...
    def __init__(
        ...
        *,
        application: typing.Union[
            aws_cdk.aws_codedeploy.IServerApplication,
            aws_cdk.aws_codedeploy.ILambdaApplication,
            aws_cdk.aws_codedeploy.IEcsApplication,
        ],
