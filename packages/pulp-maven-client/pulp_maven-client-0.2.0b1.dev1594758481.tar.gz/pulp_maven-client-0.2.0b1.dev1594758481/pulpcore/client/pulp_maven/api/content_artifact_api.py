...
class ContentArtifactApi(object):
    ...
    def create(self, data, **kwargs):  # noqa: E501
        ...
        :param MavenMavenArtifact data: (required)
    ...
    def create_with_http_info(self, data, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(MavenMavenArtifact, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            response_type='MavenMavenArtifact',  # noqa: E501
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['ordering', 'group_id', 'artifact_id', 'version', 'filename', 'repository_version', 'repository_version_added', 'repository_version_removed', 'limit', 'offset', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def read(self, maven_artifact_href, **kwargs):  # noqa: E501
        """Inspect a maven artifact  # noqa: E501

        A ViewSet for MavenArtifact.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(maven_artifact_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str maven_artifact_href: URI of Maven Artifact. e.g.: /pulp/api/v3/content/maven/artifact/1/ (required)
        :param str fields: A list of fields to include in the response.
        :param str exclude_fields: A list of fields to exclude from the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(maven_artifact_href, **kwargs)  # noqa: E501

    def read_with_http_info(self, maven_artifact_href, **kwargs):  # noqa: E501
        """Inspect a maven artifact  # noqa: E501

        A ViewSet for MavenArtifact.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(maven_artifact_href, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['maven_artifact_href', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('maven_artifact_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['maven_artifact_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `maven_artifact_href` when calling `read`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'maven_artifact_href' in local_var_params:
            path_params['maven_artifact_href'] = local_var_params['maven_artifact_href']  # noqa: E501
