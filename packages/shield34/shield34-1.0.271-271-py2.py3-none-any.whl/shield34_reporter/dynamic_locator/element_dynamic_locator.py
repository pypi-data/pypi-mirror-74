...
class ElementDynamicLocator():
    ...
    def internal_web_driver_find_element(driver, by, value):
        ...
        RunReportContainer.add_report_csv_row(
            WebDriverFindElementCsvRow(DriverUtils.get_current_driver(), by + ": " + value))
        try:
    ...
    def internal_web_driver_find_elements(driver, by, value):
        ...
        RunReportContainer.add_report_csv_row(ActionStartedCsvRow())
        RunReportContainer.add_report_csv_row(
            WebDriverFindElementsCsvRow(DriverUtils.get_current_driver(), by + ": " + value))
        try:
    ...
    def internal_web_element_find_element(parent_web_element, by, value):
        ...
        RunReportContainer.add_report_csv_row(ActionStartedCsvRow())
        RunReportContainer.add_report_csv_row(
            WebElementFindElementCsvRow(parent_web_element, DriverUtils.get_current_driver(), by + ": " + value))
        try:
    ...
    def internal_web_element_find_elements(parent_web_element, by, value):
        ...
        RunReportContainer.add_report_csv_row(ActionStartedCsvRow())
        RunReportContainer.add_report_csv_row(
            WebElementFindElementsCsvRow(parent_web_element, DriverUtils.get_current_driver(), by + ": " + value))
    ...
    def dynamic_element_add_to_console_log(by, value, dynamic_by, dynamic_value):
        if is_module_available('robot'):
            ...
            if dynamic_value is not None and dynamic_by is not None and by is not None and value is not None:
                BuiltIn().log('Shield34 Dynamic Element Locator: Using test’s locator: ' + '"' + by + ':' + value + '"' + ' was unsuccessful, Shield34 used the dynamic element locator ' + '"' + dynamic_by + ':' +  dynamic_value + '"' + ' successfully',
                              level='WARN')
            #Shield34Logger.logger.console( 'Shield34 Dynamic Element Locator: Using test’s locator: ' + '"' + by + ':' + value + '"' + 'was unsuccessful, Shield34 used the dynamic element locator ' + '"' + dynamic_by + ':' +  dynamic_value + '"' + 'successfully')
            #web_driver = DriverUtils.get_current_driver()
            #web_driver.execute_script("console.log( arguments[0] + ':' + arguments[1] + ' was unsuccessful, Shield34 used the dynamic element locator ' +  arguments[2] + ':' + arguments[3] +  ' successfully')", by, value, , )
