...
setup(
    ...
    url=URL,
    # exclude files that require nuscenes
    packages=find_packages(exclude=["tests", "*.tests", "*.tests.*", "tests.*",
                                    'planning_centric_metrics/data.py',
                                    'planning_centric_metrics/explore.py',
                                    'planning_centric_metrics/tools.py',
                                    'planning_centric_metrics/train.py',
                                    ]),
