...
if __name__ == "__main__":
    ...
    agent = DeepQAgent.example(config=selected_config(agent_type='dqn', mode='stack'), n_episodes=20000,
                               max_episode_steps=10000, render=True, update_every=1, checkpoint_every=1000)
    agent.save()
