...
class ParameterSweep(object):
    ...
    def prepareSimulation(self, MagnetName, folder, cleanFolder = True,  OffsetNumber = 0):
        ...
        for i in trange(self.SweepMatrix.shape[0], file=sys.stdout, desc='Excel Files'):
            ...
            for j in range(self.SweepMatrix.shape[1]):
                ...
                if (self.ParametersToSweep[j] == "overwrite_f_internalVoids_inGroup"):
                    ...
                    # exValue = self.VoidRatio-self.SweepMatrix[i, j]
                    # setVal = self._generateImitate(self.ParametersLEDET.getAttribute(getattr(self.ParametersLEDET, "Inputs"), "overwrite_f_externalVoids_inGroup"), exValue)
