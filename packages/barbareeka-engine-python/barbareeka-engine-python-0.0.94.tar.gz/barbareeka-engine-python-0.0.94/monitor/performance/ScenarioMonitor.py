...
class ScenarioMonitor(object):
    ...
    def __init__(self, smartBOT):
        ...
        self.screen_shot_generator = ScreenShotGenerator(self.smartBOT)
    ...
    def start(self):
        ...
        screen_shot_thread = multiprocessing.Process(target=self.screen_shot_generator.generate_screenshot)
    ...
    def stop(self, scenario, smartBOT):
        ...
        ScenarioMonitor.screen_shot_generator.update_screenshot_statistics(self.screen_shot_generator.screenshots)
