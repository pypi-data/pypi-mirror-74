...
id = "191dd73035fdc1cd06ee3532f828ca5853b4e4bc"
date = "2020-07-23 15:47:31 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "191dd73035fdc1cd06ee3532f828ca5853b4e4bc":
        return
    msg = "Program id (191dd73035fdc1cd06ee3532f828ca5853b4e4bc) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
