...
id = "e6edc20d7ae94223228efe24c64a4f0ab5d495ae"
date = "2020-07-10 18:17:14 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "e6edc20d7ae94223228efe24c64a4f0ab5d495ae":
        return
    msg = "Program id (e6edc20d7ae94223228efe24c64a4f0ab5d495ae) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
