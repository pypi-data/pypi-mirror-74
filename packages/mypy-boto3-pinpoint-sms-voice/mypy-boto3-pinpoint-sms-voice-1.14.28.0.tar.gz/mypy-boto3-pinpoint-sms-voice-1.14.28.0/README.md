...
[boto3.PinpointSMSVoice 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/pinpoint-sms-voice.html#PinpointSMSVoice) service
...
`mypy_boto3_pinpoint_sms_voice` and other installed services.
...
session_client = boto3.Session().client("pinpoint-sms-voice")
```
