...
class FirewallApiRouter(VersionRouter):
    ...
    function_library = {
        "delete_firewall_fw_set": {"4.8.4-4.10.1": delete_firewall_fw_set},
        "delete_firewall_rule_by_position": {
            "4.8.4-4.10.1": delete_firewall_rule_by_position
        },
        "delete_firewall_rule_by_rule": {"4.8.4-4.10.1": delete_firewall_rule_by_rule},
        "delete_firewall_subgroup": {"4.8.4-4.10.1": delete_firewall_subgroup},
        "get_firewall_fw_sets": {"4.8.4-4.10.1": get_firewall_fw_sets},
        "post_create_firewall_fw_set": {"4.8.4-4.10.1": post_create_firewall_fw_set},
