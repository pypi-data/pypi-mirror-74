...
class Fema(Api):
    ...
    def get_nfip(self, search_item, location_type, csv=False, limit=100, output_dir=None, extra_param=None):
        ...
        api_datas = self.call_api(search_item, "fema", "nfip", location_type, limit=limit, extra_param=extra_param)
