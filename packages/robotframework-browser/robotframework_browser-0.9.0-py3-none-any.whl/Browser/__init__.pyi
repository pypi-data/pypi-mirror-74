...
class Browser:
    ...
    def click_with_options(self, selector: str, button: MouseButton = MouseButton.left, click_count: int = 1, delay: Optional[str] = 'None', position_x: Optional[int] = None, position_y: Optional[int] = None, *modifiers: KeyboardModifier): ...
    def close_all_browsers(self): ...
    def close_browser(self): ...
    def close_context(self): ...
    def close_page(self): ...
    def deselect_options(self, selector: str): ...
    def execute_javascript_on_page(self, script: str): ...
    ...
    def http(self, url, method: RequestMethod = RequestMethod.GET, body: Optional[str] = 'None', headers: dict = {}): ...
