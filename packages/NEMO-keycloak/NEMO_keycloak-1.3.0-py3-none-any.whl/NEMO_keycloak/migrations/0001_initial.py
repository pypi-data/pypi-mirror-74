# Generated by Django 2.2.10 on 2020-02-29 00:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='realms', to='NEMO_keycloak.Server')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('realm', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='openid_profiles', to='NEMO_keycloak.Realm')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('realm', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='client', to='NEMO_keycloak.Realm')),
                ('service_account_profile', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='NEMO_keycloak.OpenIdConnectProfile')),
            ],
        ),
    ]
