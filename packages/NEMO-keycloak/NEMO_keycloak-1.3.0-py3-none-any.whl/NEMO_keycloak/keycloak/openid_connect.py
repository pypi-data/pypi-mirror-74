...
class KeycloakOpenidConnect(WellKnownMixin):
    ...
    def logout(self, refresh_token):
        ...
        return self._realm.client.post(
            ...
            data={"refresh_token": refresh_token, "client_id": self._client_id, "client_secret": self._client_secret},
        )
    ...
    def token_exchange(self, **kwargs):
        ...
        """
        return self._token_request(grant_type="urn:ietf:params:oauth:grant-type:token-exchange", **kwargs)
    ...
    def _token_request(self, grant_type, **kwargs):
        ...
        :return:
        """
        payload = {"grant_type": grant_type, "client_id": self._client_id, "client_secret": self._client_secret}
