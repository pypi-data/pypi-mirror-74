...
[boto3.AugmentedAIRuntime 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/sagemaker-a2i-runtime.html#AugmentedAIRuntime) service
...
`mypy_boto3_sagemaker_a2i_runtime` and other installed services.
...
session_client = boto3.Session().client("sagemaker-a2i-runtime")
```
