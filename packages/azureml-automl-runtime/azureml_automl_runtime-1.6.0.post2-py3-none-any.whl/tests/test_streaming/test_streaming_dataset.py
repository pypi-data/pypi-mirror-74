...
class StreamingDatasetTests(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        test_data_file = os.path.join(tests_dir_path, 'test_data', 'ts_utils', 'streamingds.csv')
    ...
    def test_get_class_labels(self):
        ...
        self.assertLess(30, len(classes))
    ...
    def test_get_num_classes(self):
        ...
        self.assertLess(30, num_classes)
    ...
    def test_get_problem_info(self):
        ...
        self.assertTrue((["A", "B", "C"] == problem_info.feature_column_names).all())
        self.assertEqual("label", problem_info.label_column_name)
    ...
    def test_get_subsampled_dataset(self):
        ...
        self.assertEqual(initial_row_count, 90024)
        ...
        self.assertEqual(subsampled_row_count, 45091)
