...
class TestEstimators(unittest.TestCase):
    ...
    def test_logistic_regression(self):
        ...
        lgbm = Estimators.get("logistic_regression", C=1)
        lgbm.fit(X, y)
    ...
    def test_invalid_estimator(self):
        lgbm = Estimators.get("invalid")
        self.assertEqual(lgbm, None)

    def test_default_estimator(self):
        lgbm = Estimators.default()
        self.assertEqual(type(lgbm), LogisticRegression)
