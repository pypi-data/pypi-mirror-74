...
class TestFTKMLTransformsGrainIndexFeaturizer(unittest.TestCase):
    ...
    def test_fit_and_transform_logged(self):
        ...
        transform = GrainIndexFeaturizer(grain_feature_prefix='grain',
                                         prefix_sep='_')
        utilities.assert_timeseries_fun_logged(transform, False, self.oj_train_slice, self.oj_test_slice)
