...
def log_classification_debug(logger: Union[logging.Logger, ActivityLogger],
                             y_test: np.ndarray,
                             y_pred_probs: np.ndarray,
                             class_labels: np.ndarray,
                             train_labels: np.ndarray,
...
def log_regression_debug(logger: Union[logging.Logger, ActivityLogger],
                         y_test: np.ndarray,
                         y_pred: np.ndarray,
                         sample_weight: Optional[np.ndarray] = None) -> None:
    """
...
def log_forecasting_debug(logger: Union[logging.Logger, ActivityLogger],
                          y_test: np.ndarray,
                          y_pred: np.ndarray,
                          sample_weight: Optional[np.ndarray] = None) -> None:
    """
