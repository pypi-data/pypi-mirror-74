...
class SafeEnforceLimits:
    ...
    def __init__(self,
        ...
        if enable_limiting:
            self.limiter = EnforceLimits(logger, **kwargs)     # type: Optional[EnforceLimits]
    ...
    def wrap(self,
             working_dir: str,
             func: 'Callable[..., T]') -> 'Callable[..., Tuple[Optional[T], Optional[BaseException], float]]':
        """
    ...
    def __call__(self, func: 'Callable[..., T]') ->\
            'Callable[..., Tuple[Optional[T], Optional[BaseException], float]]':
        """
        ...
        :return:
        """
        return self.wrap(os.getcwd(), func)
    ...
    def execute(self,
        ...
        :return:
        """
        wrapped_func = self.wrap(working_dir or os.getcwd(), func)
