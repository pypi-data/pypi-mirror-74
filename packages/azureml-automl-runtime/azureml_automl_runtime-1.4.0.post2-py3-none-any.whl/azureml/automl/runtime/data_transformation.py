...
def _sweep_featurizers(X: DataInputType,
    ...
    Tuple[DataTransformer,
          Optional[List[TransformerAndMapper]],
          Dict[str, np.dtype],
...
def _get_transformer_x(x: DataInputType,
    ...
    data_snapshot_str = _get_data_snapshot(x, column_names_and_types=columns_types_mapping)
                        ...
                        if ts_transformer.origin_column_name in X_test.index.names:
                            ...
                            if X_test.shape[0] == 0:
                                ...
                                raise InsufficientDataException(
                                    "Unable to create validation folds "
