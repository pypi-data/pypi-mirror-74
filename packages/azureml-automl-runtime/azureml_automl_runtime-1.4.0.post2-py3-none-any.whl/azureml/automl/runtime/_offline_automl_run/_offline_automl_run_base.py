...
class _OfflineAutoMLRunBase(ABC):
    """
    ...
    def add_properties(self, properties: Dict[str, Any]) -> None:
        self._update_reserved_metadata_dict(_OfflineAutoMLRunBase.PROPERTIES_FILE_NAME, properties)

    def get_properties(self) -> Dict[str, Any]:
        return self._read_reserved_metadata_dict(_OfflineAutoMLRunBase.PROPERTIES_FILE_NAME)

    def set_tags(self, tags: Dict[str, Any]) -> None:
        self._update_reserved_metadata_dict(_OfflineAutoMLRunBase.TAGS_FILE_NAME, tags)

    def get_file_path(self, file_name: str) -> str:
        return os.path.join(self.run_folder, file_name)

    def get_tags(self) -> Dict[str, Any]:
        return self._read_reserved_metadata_dict(_OfflineAutoMLRunBase.TAGS_FILE_NAME)
    ...
    def get_metrics(self, name: Optional[str] = None, recursive: bool = False, run_type: Optional[Any] = None,
        ...
        return self._read_reserved_metadata_dict(_OfflineAutoMLRunBase.METRICS_FILE_NAME)
    ...
    def log(self, name: str, value: Any, description: str = '') -> None:
        ...
        self._update_reserved_metadata_dict(_OfflineAutoMLRunBase.METRICS_FILE_NAME, {name: value})
