...
class TestFTKMLTransformsTimeIndexFeaturizer(unittest.TestCase):
    ...
    def test_fit_and_transform_logged(self):
        ...
        transform = TimeIndexFeaturizer(prune_features=False)
        utilities.assert_timeseries_fun_logged(transform, True, self.test_tsdf1, self.test_tsdf1)
        utilities.assert_timeseries_fun_logged(transform, False, self.test_tsdf1, self.test_tsdf1)
