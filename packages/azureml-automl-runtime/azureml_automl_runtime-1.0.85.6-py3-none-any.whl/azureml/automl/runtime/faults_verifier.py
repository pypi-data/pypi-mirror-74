...
from automl.client.core.common.constants import AutoMLJson
...
class VerifierManager:
    ...
    def write_result_file(self, run_context: AutoMLAbstractRunContext, logger: TelemetryActivityLogger,
