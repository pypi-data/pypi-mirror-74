...
class BiLSTMAttentionTransformer(AutoMLTransformer):
        ...
        try:
            ...
            for epoch in range(1, self._epochs + 1):
                ...
                try:
                    ...
                    raise FitException.from_exception(e, has_pii=True,
                                                      target="BiLSTMAttentionTransformer fit - train")
            ...
            raise FitException.from_exception(e, has_pii=True, target="BiLSTMAttentionTransformer fit")
    ...
    def transform(self, X):
        ...
        try:
            ...
            # Error classify overall transform fit errors
            raise TransformException.from_exception(e, has_pii=True, target="BiLSTMAttentionTransformer transform")
