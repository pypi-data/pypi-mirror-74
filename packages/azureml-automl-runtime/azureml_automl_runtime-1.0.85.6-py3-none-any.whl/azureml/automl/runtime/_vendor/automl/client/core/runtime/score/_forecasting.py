...
from automl.client.core.runtime.score import _scoring_utilities, constants, _regression
from automl.client.core.runtime.score._metric_base import Metric, NonScalarMetric
...
class ForecastMAPE(ForecastingMetric, NonScalarMetric):
    ...
    def compute(self) -> Dict[str, Any]:
        ...
        for h in grouped_values:
            ...
            self._data[h] = {
                ForecastMAPE.MAPE: _regression._mape(partial_test, partial_pred, self._logger),
