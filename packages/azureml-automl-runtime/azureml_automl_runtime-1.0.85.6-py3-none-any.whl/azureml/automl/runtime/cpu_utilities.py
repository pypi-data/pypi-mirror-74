...
@functools.lru_cache(maxsize=1)
def get_cpu_physical_core_count() -> int:
...
class ResourceUsageTracker:
    ...
    def __init__(self, output_file: Optional[str] = None) -> None:
        self._timer = None
        self._peak_mem = 0
        self._starting_cpu_time = None
        self._starting_child_cpu_time = None
        self._current_cpu_time = 0
        self._current_child_cpu_time = 0
        ...
        self._cpu_times = array.array('d')
        self._child_cpu_times = array.array('d')
        self._memory_usage = array.array('Q')
    ...
    def _record_usage_unix(self) -> None:
        ...
        self._current_cpu_time = (res.ru_utime + res.ru_stime) / 1000000
        self._current_child_cpu_time = (child_res.ru_utime + res.ru_stime) / 1000000
