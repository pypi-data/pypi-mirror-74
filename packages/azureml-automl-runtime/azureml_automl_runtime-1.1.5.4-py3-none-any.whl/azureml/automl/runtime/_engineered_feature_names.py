        ...
        for raw_feature_name in transformed_raw_feature_names:
            ...
            if transformed_feature_match_obj:
                ...
                raise UnrecognizedTransformedFeatureNameException(
                    ...
                    reference_code="_engineered_feature_names._GenerateEngineeredFeatureNames.parse_raw_feature_names",
                    has_pii=False)
...
class FeatureNamesHelper:
    ...
    def get_transformer_name(cls, transformer_number: int) -> str:
        ...
        if transformer_number is None:
            raise ArgumentException("No transformer number was provided",
                                    reference_code="_engineered_feature_names.FeatureNamesHelper.get_transformer_name",
                                    target="transformer_number", has_pii=False)

        if not isinstance(transformer_number, int):
            raise ArgumentException("The transformer number is not integer",
                                    reference_code="_engineered_feature_names.FeatureNamesHelper.get_transformer_name",
                                    target="transformer_number", has_pii=False)
...
class _FeatureTransformersAsJSONObject:
    ...
    def _validate_transformation_json_object(self) -> None:
        ...
        if self._entire_transformation_json_data is None:
            raise EngineeredFeatureNamesEmptyJsonException(
                ...
                reference_code="_engineered_feature_names."
                               "_FeatureTransformersAsJSONObject._validate_transformation_json_object",
                has_pii=False)
    ...
    def get_raw_feature_type(self) -> str:
            ...
            if transformer[_FeatureNameJSONTag.FeatureType] is not None:
                if transformer[_FeatureNameJSONTag.FeatureType] not in \
                    ...
                    raise EngineeredFeatureNamesNotSupportedFeatureTypeException(
                        ...
                        reference_code="_engineered_feature_names._FeatureTransformersAsJSONObject."
                                       "get_raw_feature_type",
                        has_pii=False)
        ...
        raise EngineeredFeatureNamesNoRawFeatureTypeException(
            ...
            reference_code="_engineered_feature_names._FeatureTransformersAsJSONObject.get_raw_feature_type",
            has_pii=False)
                ...
                if isinstance(parent_feature, int):
                    ...
                    if transformer_name not in transformer_name_dict:
                        raise EngineeredFeatureNamesTransformerNamesNotFoundException(
                            ...
                            " not found",
                            reference_code="_engineered_feature_names._FeatureTransformers."
                                           "encode_transformations_from_list",
                            has_pii=False)
    ...
    def get_datetime_transformation_name(cls, index):
        ...
        if index < 0 or index >= len(cls._datetime_sub_feature_names):
            raise EngineeredFeatureNamesUnsupportedIndexException(
                ...
                reference_code="_engineered_feature_names.DateTimeHelper.get_datetime_transformation_name",
                has_pii=False)
