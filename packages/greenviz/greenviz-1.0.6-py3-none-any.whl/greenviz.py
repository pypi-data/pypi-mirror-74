...
# plt.figure(figsize=(10,7))
        ...
        sn.heatmap(df_cm, annot=True, annot_kws={"size": 16},ax=ax,cmap= 'RdBu_r') 
...
def register():
    ...
    name=StringVar()
    name_entry=Entry(frame02, width=40 , borderwidth=3,textvariable=name)
    ...
    reg_entry=Entry(frame02 , width=40 ,borderwidth=3,textvariable=registration)
    ...
    mail_entry=Entry(frame02 , width=40 ,borderwidth=3,textvariable=email)
    ...
    pass_entry=Entry(frame02 , width=40 ,borderwidth=3,show="*",textvariable=password)
...
def login():
    ...
    global reg,passw
    reg=StringVar()
    reg_entry=Entry(frame03 , width=40 ,borderwidth=3,font="15",textvariable=reg)
    reg_entry.insert(0 , "Enter your Register number..")
    reg_entry.grid(row=4 , column=2)
    ...
    pass_label.grid(row=10 , column=0)
    passw=StringVar()
    pass_entry=Entry(frame03 , width=40 ,borderwidth=3,show="*",font="15",textvariable=passw)
    pass_entry.insert(0 , "enter your password...")
    pass_entry.grid(row=10 , column=2)
