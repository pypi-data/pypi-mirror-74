...
class FactPhoto(object):
    ...
    attribute_map = {
        ...
        'message': 'message',
        'storage_server_file_id': 'storage_server_file_id',
        'fact_time': 'fact_time'
    }

    def __init__(self, performer_id=None, trip_id=None, order_id=None, demand_key=None, message=None, storage_server_file_id=None, fact_time=None, local_vars_configuration=None):  # noqa: E501
        """FactPhoto - a model defined in OpenAPI"""  # noqa: E501
        ...
        self._message = None
        self._storage_server_file_id = None
        ...
        if storage_server_file_id is not None:
            self.storage_server_file_id = storage_server_file_id
        if fact_time is not None:
            self.fact_time = fact_time

    @property
    def performer_id(self):
        """Gets the performer_id of this FactPhoto.  # noqa: E501

        Performer's ID.  # noqa: E501

        :return: The performer_id of this FactPhoto.  # noqa: E501
        :rtype: str
        """
    ...
    def performer_id(self, performer_id):
        """Sets the performer_id of this FactPhoto.

        Performer's ID.  # noqa: E501

        :param performer_id: The performer_id of this FactPhoto.  # noqa: E501
        :type: str
        """
    ...
    @property
    def trip_id(self):
        """Gets the trip_id of this FactPhoto.  # noqa: E501

        Trip ID.  # noqa: E501

        :return: The trip_id of this FactPhoto.  # noqa: E501
        :rtype: str
        """
    ...
    def trip_id(self, trip_id):
        """Sets the trip_id of this FactPhoto.

        Trip ID.  # noqa: E501

        :param trip_id: The trip_id of this FactPhoto.  # noqa: E501
        :type: str
        """
    ...
    @property
    def order_id(self):
        """Gets the order_id of this FactPhoto.  # noqa: E501

        Order ID.  # noqa: E501

        :return: The order_id of this FactPhoto.  # noqa: E501
        :rtype: str
        """
    ...
    def order_id(self, order_id):
        """Sets the order_id of this FactPhoto.

        Order ID.  # noqa: E501

        :param order_id: The order_id of this FactPhoto.  # noqa: E501
        :type: str
        """
    ...
    @property
    def demand_key(self):
        """Gets the demand_key of this FactPhoto.  # noqa: E501

        Demand key.  # noqa: E501

        :return: The demand_key of this FactPhoto.  # noqa: E501
        :rtype: str
        """
    ...
    def demand_key(self, demand_key):
        """Sets the demand_key of this FactPhoto.

        Demand key.  # noqa: E501

        :param demand_key: The demand_key of this FactPhoto.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def message(self):
        """Gets the message of this FactPhoto.  # noqa: E501

        Message text.  # noqa: E501

        :return: The message of this FactPhoto.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this FactPhoto.

        Message text.  # noqa: E501

        :param message: The message of this FactPhoto.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def storage_server_file_id(self):
        """Gets the storage_server_file_id of this FactPhoto.  # noqa: E501

        File ID.  # noqa: E501

        :return: The storage_server_file_id of this FactPhoto.  # noqa: E501
        :rtype: str
        """
        return self._storage_server_file_id

    @storage_server_file_id.setter
    def storage_server_file_id(self, storage_server_file_id):
        """Sets the storage_server_file_id of this FactPhoto.

        File ID.  # noqa: E501

        :param storage_server_file_id: The storage_server_file_id of this FactPhoto.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                storage_server_file_id is not None and len(storage_server_file_id) > 1024):
            raise ValueError("Invalid value for `storage_server_file_id`, length must be less than or equal to `1024`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                storage_server_file_id is not None and len(storage_server_file_id) < 1):
            raise ValueError("Invalid value for `storage_server_file_id`, length must be greater than or equal to `1`")  # noqa: E501

        self._storage_server_file_id = storage_server_file_id

    @property
    def fact_time(self):
        """Gets the fact_time of this FactPhoto.  # noqa: E501

        Fact time in the [RFC 3339, section 5.6](https://tools.ietf.org/html/rfc3339#section-5.6) format.  # noqa: E501

        :return: The fact_time of this FactPhoto.  # noqa: E501
        :rtype: datetime
        """
    ...
    def fact_time(self, fact_time):
        """Sets the fact_time of this FactPhoto.

        Fact time in the [RFC 3339, section 5.6](https://tools.ietf.org/html/rfc3339#section-5.6) format.  # noqa: E501

        :param fact_time: The fact_time of this FactPhoto.  # noqa: E501
        :type: datetime
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FactPhoto):
            return False
