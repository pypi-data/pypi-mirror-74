...
class Capacity(object):
    ...
    def __init__(self, mass=1, volume=0, capacity_x=0, capacity_y=0, capacity_z=0, local_vars_configuration=None):  # noqa: E501
    ...
    def mass(self, mass):
        ...
        :type: float
        """
        if self.local_vars_configuration.client_side_validation and mass is None:  # noqa: E501
    ...
    def capacity_x(self):
        ...
        Additional capacity parameter (X) for measurement of cargoes and compartments in alternative units. In example, to account for goods in units (this parameter equals 1 for a cargo, and the maximum number or placed cargoes - for a compartment).   # noqa: E501
    ...
    def capacity_y(self):
        ...
        Additional capacity parameter (Y) for measurement of cargoes and compartments in alternative units.  # noqa: E501
    ...
    def capacity_z(self):
        ...
        Additional capacity parameter (X) for measurement of cargoes and compartments in alternative units.  # noqa: E501
