...
import vrt_ud
from vrt_ud.models.orders_result import OrdersResult  # noqa: E501
from vrt_ud.rest import ApiException

class TestOrdersResult(unittest.TestCase):
    """OrdersResult unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = vrt_ud.models.orders_result.OrdersResult()  # noqa: E501
        if include_optional :
            return OrdersResult(
                orders = [
                    vrt_ud.models.order.Order(
                        key = 'order01', 
