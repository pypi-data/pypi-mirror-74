...
from .Utils.sourceUtils import analytic1DModelSource
...
class Planewave_xy_1Dprimary(BaseNSEMSrc):
    ...
    """
    #def __init__(self, rxList, freq):
    def __init__(self, rxList, freq, sigBG1d, sigBG):    # (mod. Diego em 14 dez 2019)
        ...
        self.sigma1d = sigBG1d #None                       # (mod. Diego em 14 dez 2019)
        self.sigmaBG = sigBG                               # (mod. Diego em 14 dez 2019)
        BaseNSEMSrc.__init__(self, rxList, freq)
    ...
    def ePrimary(self, problem):
        ...
        if self.sigma1d is None:
            ...
            else: #len(problem._sigmaPrimary) == problem.mesh.nCz:
        ...
        if self._ePrimary is None:
            ...
            self._ePrimary = analytic1DModelSource(problem.mesh, self.freq, self.sigma1d)
            
            
        return self._ePrimary 

# (mod. Diego em 14 dez 2019) --------------------------------------------------
        
        # campo primario para tensormesh
...
#------------------------------------------------------------------------------
    ...
    def S_e(self, problem):
        ...
        #Map_sigma_p = Maps.SurjectVertical1D(problem.mesh)             # (mod. Diego em 14 dez 2019)
        sigma_p = self.sigmaBG #Map_sigma_p._transform(self.sigma1d)    # (mod. Diego em 14 dez 2019)
        # Make mass matrix
