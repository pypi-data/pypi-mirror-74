...
"}")
        ...
        self.title2_icon = IconLabel(self.widget_title2)
        self.title2_icon.setMinimumSize(QtCore.QSize(10, 10))
        self.title2_icon.setMaximumSize(QtCore.QSize(10, 10))
        self.title2_icon.setText("")
        self.title2_icon.setPixmap(QtGui.QPixmap(":/icons/images/material/fiber_manual_record.svg"))
        self.title2_icon.setScaledContents(True)
        self.title2_icon.setProperty("color", QtGui.QColor(153, 153, 153))
        self.title2_icon.setObjectName("title2_icon")
        self.horizontalLayout_3.addWidget(self.title2_icon)
        ...
        self.title3_icon = IconLabel(self.widget_title3)
        self.title3_icon.setMinimumSize(QtCore.QSize(10, 10))
        self.title3_icon.setMaximumSize(QtCore.QSize(10, 10))
        self.title3_icon.setText("")
        self.title3_icon.setPixmap(QtGui.QPixmap(":/icons/images/material/fiber_manual_record.svg"))
        self.title3_icon.setScaledContents(True)
        self.title3_icon.setProperty("color", QtGui.QColor(153, 153, 153))
        self.title3_icon.setObjectName("title3_icon")
        self.horizontalLayout_4.addWidget(self.title3_icon)
