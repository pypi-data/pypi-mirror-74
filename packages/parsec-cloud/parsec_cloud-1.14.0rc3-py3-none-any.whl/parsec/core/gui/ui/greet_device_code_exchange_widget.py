...
# Form implementation generated from reading ui file 'parsec/core/gui/forms/greet_device_code_exchange_widget.ui'
#
...
class Ui_GreetDeviceCodeExchangeWidget(object):
    def setupUi(self, GreetDeviceCodeExchangeWidget):
        GreetDeviceCodeExchangeWidget.setObjectName("GreetDeviceCodeExchangeWidget")
        GreetDeviceCodeExchangeWidget.resize(479, 216)
        self.verticalLayout = QtWidgets.QVBoxLayout(GreetDeviceCodeExchangeWidget)
        self.verticalLayout.setObjectName("verticalLayout")
        self.widget_greeter_code = QtWidgets.QWidget(GreetDeviceCodeExchangeWidget)
        ...
        self.widget_claimer_code = QtWidgets.QWidget(GreetDeviceCodeExchangeWidget)
        ...
        self.label_wait_info = QtWidgets.QLabel(GreetDeviceCodeExchangeWidget)
        self.label_wait_info.setAlignment(QtCore.Qt.AlignCenter)
        self.label_wait_info.setObjectName("label_wait_info")
        self.verticalLayout.addWidget(self.label_wait_info)

        self.retranslateUi(GreetDeviceCodeExchangeWidget)
        QtCore.QMetaObject.connectSlotsByName(GreetDeviceCodeExchangeWidget)

    def retranslateUi(self, GreetDeviceCodeExchangeWidget):
        _translate = QtCore.QCoreApplication.translate
        GreetDeviceCodeExchangeWidget.setWindowTitle(_translate("GreetDeviceCodeExchangeWidget", "Form"))
        self.label_2.setText(_translate("GreetDeviceCodeExchangeWidget", "TEXT_GREET_DEVICE_CODE_EXCHANGE_GIVE_CODE_INSTRUCTIONS"))
        self.label_wait.setText(_translate("GreetDeviceCodeExchangeWidget", "TEXT_GREET_DEVICE_CODE_EXCHANGE_WAIT"))
        self.label_3.setText(_translate("GreetDeviceCodeExchangeWidget", "TEXT_GREET_DEVICE_CODE_EXCHANGE_GET_CODE_INSTRUCTIONS"))
        self.label_wait_info.setText(_translate("GreetDeviceCodeExchangeWidget", "TEXT_GREET_DEVICE_WAIT_INFO"))
