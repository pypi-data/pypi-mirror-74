...
if __name__ == "__main__":
    """Creates all the ready UCD-json that this entire module needs.
    ...
    save_json("unilyze/db/ucd_property_values.json", data)
