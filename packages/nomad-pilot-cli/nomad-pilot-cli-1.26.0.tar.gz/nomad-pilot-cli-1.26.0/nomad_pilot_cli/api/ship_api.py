...
class ShipApi(object):
    ...
    def put_ship(self, carrier, package_update, **kwargs):  # noqa: E501
        """ship  # noqa: E501

        Update waybill details for specified carrier.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_ship(carrier, package_update, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str carrier: Carrier to ship with (required)
        :param PackageUpdate package_update: Package to ship (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.put_ship_with_http_info(carrier, package_update, **kwargs)  # noqa: E501

    def put_ship_with_http_info(self, carrier, package_update, **kwargs):  # noqa: E501
        """ship  # noqa: E501

        Update waybill details for specified carrier.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_ship_with_http_info(carrier, package_update, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('package_update' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `package_update` when calling `put_ship`")  # noqa: E501
