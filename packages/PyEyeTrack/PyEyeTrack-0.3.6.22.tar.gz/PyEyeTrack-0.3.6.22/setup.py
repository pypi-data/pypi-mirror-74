...
- Concurrent <br>\
Documentation <br>\
Find the official documentation [here](https://algoasylum.github.io/PyTrack/).<br>\
## License <br>\
MIT <br> \
PyEyeTrack Support <br> \
For any issues regarding pyEyeTrack, contact the pytrack support at pytracklibrary@gmail.com. <br>\
Contributors <br>\
Kanchan Sarolkar, Kimaya Badhe, Neha Chaudhari, Samruddhi Kanhed and Shrirang Karandikar.',
  ...
  download_url = 'https://github.com/algoasylum/pyEyeTrack/archive/v_03_6_17.tar.gz',    
