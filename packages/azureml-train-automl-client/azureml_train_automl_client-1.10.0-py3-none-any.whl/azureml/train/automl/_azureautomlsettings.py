...
from .constants import Scenarios, MANAGED_RUN_ID_PARAM
...
class AzureAutoMLSettings(AutoMLBaseSettings):
    ...
    def __init__(self,
        ...
        self._local_managed_run_id = kwargs.get(MANAGED_RUN_ID_PARAM, None)
        ...
        # scenarios are only supported for AzureMLClient runs.
    ...
    def apply_optional_package_filter(self) -> None:
        """Apply any missing optional pacakges to the blacklist if they arent installed."""
