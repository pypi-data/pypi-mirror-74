...
class OverrideVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by OverrideParser#choiceSweep.
    def visitChoiceSweep(self, ctx:OverrideParser.ChoiceSweepContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by OverrideParser#id_ws.
    def visitId_ws(self, ctx:OverrideParser.Id_wsContext):
        return self.visitChildren(ctx)
