...
[boto3.FMS 1.14.21](https://boto3.amazonaws.com/v1/documentation/api/1.14.21/reference/services/fms.html#FMS) service
...
def get_structure() -> ComplianceViolatorTypeDef:
    return {
      ...
    }
```
