...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, base_path=None, name=None, repository_version=None, pulp_created=None, pulp_href=None, repository=None, content_guard=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
