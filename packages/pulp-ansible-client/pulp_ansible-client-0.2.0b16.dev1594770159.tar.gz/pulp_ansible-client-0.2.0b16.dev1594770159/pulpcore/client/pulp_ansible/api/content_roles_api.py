...
class ContentRolesApi(object):
    ...
    def create(self, data, **kwargs):  # noqa: E501
        ...
        :param AnsibleRole data: (required)
    ...
    def create_with_http_info(self, data, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(AnsibleRole, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/content/ansible/roles/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='AnsibleRole',  # noqa: E501
    ...
    def list(self, **kwargs):  # noqa: E501
        ...
        :param str namespace: Filter results where namespace matches value
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['ordering', 'name', 'namespace', 'version', 'repository_version', 'repository_version_added', 'repository_version_removed', 'limit', 'offset', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/content/ansible/roles/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read(self, role_href, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str role_href: URI of Role. e.g.: /pulp/api/v3/content/ansible/roles/1/ (required)
        :param str fields: A list of fields to include in the response.
        :param str exclude_fields: A list of fields to exclude from the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def read_with_http_info(self, role_href, **kwargs):  # noqa: E501
        ...
        all_params = ['role_href', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
