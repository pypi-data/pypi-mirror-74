...
def dissolve_limited(
    ...
    :param delimit: Delimit, Delimit dissolve operation * NORMAL Regular, Delimit by face directions. * MATERIAL Material, Delimit by face material. * SEAM Seam, Delimit by edge seams. * SHARP Sharp, Delimit by sharp edges. * UV UVs, Delimit by UV coordinates.
...
def select_linked(
    ...
    :param delimit: Delimit, Delimit selected region * NORMAL Regular, Delimit by face directions. * MATERIAL Material, Delimit by face material. * SEAM Seam, Delimit by edge seams. * SHARP Sharp, Delimit by sharp edges. * UV UVs, Delimit by UV coordinates.
    :type delimit: typing.Union[typing.Set[str], typing.Set[int]]
    '''
