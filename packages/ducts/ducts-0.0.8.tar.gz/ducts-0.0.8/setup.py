...
setup(
    ...
    description='DUplex Communication and Transactional Streaming Web Framework',  # Optional
    ...
    url='https://github.com/iflb/ducts',  # Optional
    ...
    keywords='framework asyncio websocket',  # Optional
