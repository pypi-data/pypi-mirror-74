...
tikz = path # OneOrMore(path)
#:
#: Tikzpicture should handle everything from the begin to the end statement.
#: Tikz should handle the TikZ only code, that is path/node and coordinate commands.
#:
#:              __________                     
#:             |        __\begin{tikzpicture}  
#: TikzPicture |  Tikz |__  ...                 
#:             |__________\end{tikzpicture}    
#:
tikzpicture = tikz

# Ship the parser
__all__ = ["tikzpicture","tikz"]
