...
def create_app(test_config=None):
    import satyrn_flask
    path = os.path.abspath(satyrn_flask.__file__)[:-11]

    # create and configure the app
    app = Flask(__name__, instance_relative_config=True, template_folder=path + "/satyrn_flask/templates/")
    ...
    @app.route("/")
    def index():
        print(os.path.exists(app.template_folder + "index.html"))
        print(app.template_folder + "index.html")
