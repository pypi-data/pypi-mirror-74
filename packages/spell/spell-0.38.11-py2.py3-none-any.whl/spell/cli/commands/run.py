...
@click.option(
    ...
    default=None,
    hidden=True,
    help="Enable or disable auto-resume. This is only supported for spot instance machine types",
)
@stop_condition_option
@click.pass_context
def run(
...
def create_run_request(
    ...
    **kwargs
    ...
    return RunRequest(
        ...
        commit_hash=repo.commit_hash if not repo.hasGithub() else None,
        ...
        github_ref=repo.commit_hash if repo.hasGithub() else None,
        distributed=distributed,
        stop_conditions=stop_conditions,
        auto_resume=auto_resume,
    )
