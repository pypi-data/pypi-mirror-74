...
class SpellModelServerRequest(Model):
    """
    ...
    def to_payload(self):
        return {
            ...
            "repository": self.repository.to_payload(),
            "pod_autoscale_config": self.pod_autoscale_config.to_payload(),
            "resource_requirements": self.resource_requirements.to_payload(),
        }
