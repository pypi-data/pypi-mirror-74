...
class Workflow(Model):
    ...
    def __init__(
        self, id, workspace_specs=None, github_specs=None, managing_run=None, runs=None, **kwargs
    ):
        self.id = int(id)
...
class CustomModelServerRequestBase(Model):
    """
    A class used to encapsulate all of the specifications of a custom Model Server

    Keyword arguments:
    entrypoint -- path to a python file that defines the serving class
    ...
    def to_payload(self):
        payload = {
            ...
            "type": ModelServerType.CUSTOM.value,
...
class ModelServerCreateRequest(CustomModelServerRequestBase):
    """
...
class ModelServerUpdateRequest(CustomModelServerRequestBase):
    """
...
class ModelVersion(Model):
    ...
    def __init__(
        self, id, formatted_version, version, creator, created_at, resource, files, **kwargs
    ):
        self.id = id
...
class PodAutoscaleConfig(Model):
    compare_fields = ["min_pods", "max_pods", "target_cpu_utilization"]

    def __init__(self, min_pods, max_pods, target_cpu_utilization=None, **kwargs):
...
class ResourceRequirement(Model):
    compare_fields = ["memory_mebibytes", "cpu_millicores"]

    def __init__(self, memory_mebibytes=None, cpu_millicores=None, **kwargs):
...
class ModelServer(Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.server_name = server_name
        self.tag = tag
        self.type = ModelServerType(type)
