...
@jsii.data_type(
    jsii_type="@cloudcomponents/cdk-static-website.Association",
    jsii_struct_bases=[],
    name_mapping={
...
class Association:
    def __init__(
        self, *, event_type: str, function_arn: str, function_version: str
    ) -> None:
        """
        :param event_type: Specifies the event type that triggers a Lambda function invocation.
...
class LambdaFunctionAssociations(
    ...
    jsii_type="@cloudcomponents/cdk-static-website.LambdaFunctionAssociations",
):
    def __init__(
        self,
        ...
        id: str,
        *,
        assosiations: typing.List["Association"],
        distribution: aws_cdk.aws_cloudfront.CloudFrontWebDistribution,
    ) -> None:
        """
        :param scope: -
        :param id: -
        :param assosiations: The Lambda function associations.
        :param distribution: The CloudFront distribution.
        """
        props = LambdaFunctionAssociationsProps(
            assosiations=assosiations, distribution=distribution
        )

        jsii.create(LambdaFunctionAssociations, self, [scope, id, props])


@jsii.data_type(
    jsii_type="@cloudcomponents/cdk-static-website.LambdaFunctionAssociationsProps",
    jsii_struct_bases=[],
    name_mapping={"assosiations": "assosiations", "distribution": "distribution"},
)
class LambdaFunctionAssociationsProps:
    def __init__(
        self,
        *,
        assosiations: typing.List["Association"],
    ...
    @builtins.property
    def assosiations(self) -> typing.List["Association"]:
        """The Lambda function associations."""
        return self._values.get("assosiations")
    ...
    def __repr__(self) -> str:
        return "LambdaFunctionAssociationsProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class StaticWebsite(
    ...
    def add_lambda_function_associations(
        self, assosiations: typing.List["Association"]
    ) -> "LambdaFunctionAssociations":
        """
        :param assosiations: -
        """
...
__all__ = [
    ...
    "Association",
    "LambdaFunctionAssociations",
    "LambdaFunctionAssociationsProps",
    "StaticWebsite",
    "StaticWebsiteProps",
    "WebsiteAliasRecord",
