...
cdef object _rand_uint32_broadcast(np.ndarray low, np.ndarray high, object size,
    ...
    low_arr = <np.ndarray>np.PyArray_FROM_OTF(low, np.NPY_UINT64, api.NPY_ARRAY_ALIGNED | api.NPY_ARRAY_FORCECAST)
    high_arr = <np.ndarray>np.PyArray_FROM_OTF(high, np.NPY_UINT64, api.NPY_ARRAY_ALIGNED | api.NPY_ARRAY_FORCECAST)
...
cdef object _rand_uint16_broadcast(np.ndarray low, np.ndarray high, object size,
    ...
    low_arr = <np.ndarray>np.PyArray_FROM_OTF(low, np.NPY_UINT32, api.NPY_ARRAY_ALIGNED | api.NPY_ARRAY_FORCECAST)
    high_arr = <np.ndarray>np.PyArray_FROM_OTF(high, np.NPY_UINT32, api.NPY_ARRAY_ALIGNED | api.NPY_ARRAY_FORCECAST)
...
cdef object _rand_uint8_broadcast(np.ndarray low, np.ndarray high, object size,
    ...
    low_arr = <np.ndarray>np.PyArray_FROM_OTF(low, np.NPY_UINT16, api.NPY_ARRAY_ALIGNED | api.NPY_ARRAY_FORCECAST)
    high_arr = <np.ndarray>np.PyArray_FROM_OTF(high, np.NPY_UINT16, api.NPY_ARRAY_ALIGNED | api.NPY_ARRAY_FORCECAST)
...
cdef object _rand_bool_broadcast(np.ndarray low, np.ndarray high, object size,
    ...
    low_arr = <np.ndarray>np.PyArray_FROM_OTF(low, np.NPY_UINT8, api.NPY_ARRAY_ALIGNED | api.NPY_ARRAY_FORCECAST)
    high_arr = <np.ndarray>np.PyArray_FROM_OTF(high, np.NPY_UINT8, api.NPY_ARRAY_ALIGNED | api.NPY_ARRAY_FORCECAST)
...
cdef object _rand_int32_broadcast(np.ndarray low, np.ndarray high, object size,
    ...
    low_arr = <np.ndarray>np.PyArray_FROM_OTF(low, np.NPY_INT64, api.NPY_ARRAY_ALIGNED | api.NPY_ARRAY_FORCECAST)
    high_arr = <np.ndarray>np.PyArray_FROM_OTF(high, np.NPY_INT64, api.NPY_ARRAY_ALIGNED | api.NPY_ARRAY_FORCECAST)
...
cdef object _rand_int16_broadcast(np.ndarray low, np.ndarray high, object size,
    ...
    low_arr = <np.ndarray>np.PyArray_FROM_OTF(low, np.NPY_INT32, api.NPY_ARRAY_ALIGNED | api.NPY_ARRAY_FORCECAST)
    high_arr = <np.ndarray>np.PyArray_FROM_OTF(high, np.NPY_INT32, api.NPY_ARRAY_ALIGNED | api.NPY_ARRAY_FORCECAST)
...
cdef object _rand_int8_broadcast(np.ndarray low, np.ndarray high, object size,
    ...
    low_arr = <np.ndarray>np.PyArray_FROM_OTF(low, np.NPY_INT16, api.NPY_ARRAY_ALIGNED | api.NPY_ARRAY_FORCECAST)
    high_arr = <np.ndarray>np.PyArray_FROM_OTF(high, np.NPY_INT16, api.NPY_ARRAY_ALIGNED | api.NPY_ARRAY_FORCECAST)
...
cdef object _rand_uint64_broadcast(object low, object high, object size,
    ...
    if closed or np.issubdtype(dt, np.integer):
        ...
        highm1_arr = <np.ndarray>np.PyArray_FROM_OTF(high_m1, np.NPY_UINT64, api.NPY_ARRAY_ALIGNED | api.NPY_ARRAY_FORCECAST)
    else:
...
cdef object _rand_int64_broadcast(object low, object high, object size,
    ...
    if closed or np.issubdtype(dt, np.integer):
        ...
        highm1_arr = <np.ndarray>np.PyArray_FROM_OTF(high_m1, np.NPY_INT64, api.NPY_ARRAY_ALIGNED | api.NPY_ARRAY_FORCECAST)
    else:
        # If input is object or a floating type
