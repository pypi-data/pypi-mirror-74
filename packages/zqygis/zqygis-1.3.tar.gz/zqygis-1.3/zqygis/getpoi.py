...
def getpoi_adcode(adcode, lkey, keywords, pathout):
	s_output = ''
	page = 1
	while 1:
		...
		#exit()
		page += 1
	print('%s completed' % adcode)
	return s_output

def getpoi_citycode(adcode, lkey, keywords, pathout):
	s_output = ''
	ladcode = getadocde(adcode, lkey)
	for adcode in ladcode:
		out = getpoi_adcode(adcode, lkey, keywords, pathout)
		s_output += out
	return s_output

def getpoi_pcode(adcode, lkey, keywords, pathout):
	s_output = ''
	ladcode = getadocde(adcode, lkey)
	for adcode in ladcode:
		out = getpoi_citycode(adcode, lkey, keywords, pathout)
		s_output += out
	return s_output
