...
class Reaction(object):
    ...
    def setIntersurface(self, rules: List[int]):
        """
        ...
        k = _smoldyn.setReactionIntersurface(self.forward.name, rules)
        assert k == _smoldyn.ErrorCode.ok
...
def setBounds(low: List[float], high: List[float], types: Union[str, List[str]] = "r"):
    ...
    types : Union[str, List[str]]
        ...
        absorbing, and 'p' for periodic boundary. Default is 'r'. If a single
        string is given, it is applied to all dimensions.
