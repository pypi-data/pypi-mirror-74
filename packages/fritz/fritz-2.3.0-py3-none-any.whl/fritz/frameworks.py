...
class SnapMLFile(FrameworkFileBase):
    """Wrapper class for Snap ML model."""

    def __init__(self, model):
        super().__init__(SNAPML, model, True)
...
SNAPML = ModelFramework("snapml", ".pb", SnapMLFile)
...
def all_frameworks():
    ...
    """
    return [TENSORFLOW_LITE, TENSORFLOW_MOBILE, CORE_ML, KERAS, SNAPML]
