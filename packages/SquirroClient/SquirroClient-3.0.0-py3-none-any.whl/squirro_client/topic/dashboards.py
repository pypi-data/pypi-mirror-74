...
class DashboardsMixin(object):
    ...
    def new_dashboard(self, project_id, title, search=None, type=None,
                      ...
                      panels=None, sidepanel=None, mobileSections=None,
                      loaders=None, desyncFromDesktop=None, dashboard_id=None,
                      restricted=None, store=None, transparent=None,
                      layout=None):
        ...
        :param store: Dict, dashboard store state to be saved with the dashboard
    ...
    def modify_dashboard(self, project_id, dashboard_id, title=None,
                         ...
                         reset_placement=None, sections=None, panels=None,
                         sidepanel=None, loaders=None, widgets=None,
                         mobileSections=None, desyncFromDesktop=None,
                         restricted=None, store=None, master=None,
                         transparent=None, layout=None):
        """Update a dashboard.
        ...
        :param restricted: Boolean, whether the dashboard has permissions set
        :param store: Dict, dashboard store state to be saved with the dashboard
        :param master: Bool, Whether this dashboard should be the new master
            dashboard or not. Doing this operation will automatically reset the
            master flag of the previous master dashboard to False
        :param transparent: Boolean, whether the dashboard uses a transparent
            background or not
        :param layout: Dict, Dashboard layout configuration
    ...
    def get_dashboard_permissions(self, project_id, dashboard_id):
        ...
        a) permissions: list of the dashboard permission dictionaries.
        b) is_default: a flag indicating whether these are the default
        permissions on the dashboard (based on project membership)
        or not (i.e. based on explicitly saved dashboard permissions)
    ...
    def create_dashboard_permissions(self, project_id, dashboard_id,
                                     permissions_list):
        ...
        The permissions_list must be superset of the default permissions for a
        dashboard, since it is impossible to remove the admin
        from a permission list
        ...
        res = self._perform_request('post', url,
                                    data=json.dumps(permissions_list),
                                    headers=headers)
        return self._process_response(res)
