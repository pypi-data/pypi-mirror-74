...
class PipelineWorkflowMixin(object):
    ...
    def modify_pipeline_workflow(self, project_id, workflow_id, name=None,
                                 steps=None, project_default=None):
    ...
    def move_pipeline_workflow_step(self, project_id, workflow_id, step_id,
                                    after):
