...
class MachineLearningMixin(object):
        ...
        if ml_models:
            try:
                with io.BytesIO() as binary_data:
                    ...
                    config['ml_models'] =\
                        base64.b64encode(binary_data.getvalue()).decode('utf-8')
    ...
    def get_machinelearning_workflow_assets(self, project_id, ml_workflow_id,
                                            write_to_disk=None):
        ...
        url = url.format(
            self.topic_api_url, self.tenant, project_id, ml_workflow_id)
        ...
        if write_to_disk:
            ...
            with open(exported_file, 'wb') as exported_asset:
                ...
                print('Exported ML assets to ./{}'.format(exported_file))
            return
    ...
    def run_machinelearning_workflow(self, project_id, ml_workflow_id, data,
        ...
        self.wait_for_machinelearning_job(
            project_id, ml_workflow_id, ml_job_id)
        try:
            ml_job = self.get_machinelearning_job(
                project_id, ml_workflow_id, ml_job_id,
                include_results=True)['machinelearning_job']
    ...
    def wait_for_machinelearning_job(self, project_id, ml_workflow_id,
                                     ml_job_id, max_wait_time=600):
        ...
        while True:
            job = self.get_machinelearning_job(
                project_id, ml_workflow_id, ml_job_id)['machinelearning_job']
