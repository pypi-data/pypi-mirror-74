...
class SmartfiltersMixin(object):
    ...
    def get_project_smartfilters(self, project_id, tags=None,
    ...
    def update_smartfilter_from_items(self, type, type_id, name, items,
                                      negative=False):
    ...
    def protect_smartfilter(self, type, type_id, name, locked):
        ...
        """
        url = ('%(ep)s/%(version)s/%(tenant)s/smartfilter'
    ...
    def get_smartfilter_matches_for_query(self, type, type_id, name,
