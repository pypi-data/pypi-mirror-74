...
grammar_stat = '''\
slvxa_stat_number:\
    slvxa_stat_number_head1\
    slvxa_stat_number_head2\
    slvxa_stat_number_data\
    (slvxa_stat_number_head1 | slvxa_stat_number_head2 | slvxa_stat_number_data)*

slvxa_stat_number_head1: "Statistical Analysis of Data for" _S ELEM _S "Atoms in" _S pint _S "Cascades" _NL
slvxa_stat_number_head2: TTLS_HNAME_1TO4 _S TTLS_MOMX _NL
slvxa_stat_number_data: TTLS_NNAME (_S pfloat)~6 _NL

slvxa_stat_energy:\
    slvxa_stat_energy_head\
    slvxa_stat_energy_data\
    (slvxa_stat_energy_head | slvxa_stat_energy_data)*
...
class Transformer(lark.Transformer):
    ...
    def slvxa_stat_number_head1(self, args):
        elem = args[0].value
        cascades = args[1]
    ...
    def slvxa_stat_number_head2(self, args):
