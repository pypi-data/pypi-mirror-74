...
def run(input_,
    ...
    cascadedir_form is formmatable string to save data for each cascade
    config_dump_text_blocks controls output 'as-is' text block by each parser
...
if __name__ == '__main__':
    ...
    try:
        ...
        logging.critical('Error in dumper: {}'.format(e))
        import traceback
        traceback.print_exc()
