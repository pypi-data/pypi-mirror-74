...
if __name__ == "__main__":
    fastpunct = FastPunct()
    print(fastpunct.punct(["My name is sid and i want to become a data scientist.", "in theory everyone knows what a comma is", "hey how are you doing", "my name is sheela i am in love with hrithik"]))
