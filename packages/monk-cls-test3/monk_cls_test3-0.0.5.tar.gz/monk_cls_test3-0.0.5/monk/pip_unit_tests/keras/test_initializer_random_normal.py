...
def test_initializer_random_normal(system_dict):
    forward = True;

    test = "test_initializer_random_normal";
    ...
    if(forward):
        try:
            ...
            gtf.Compile_Network(network, data_shape=(3, 32, 32), network_initializer="random_normal");
