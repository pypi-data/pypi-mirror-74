...
def test_initializer_orthogonal(system_dict):
    forward = True;

    test = "test_initializer_orthogonal";
    ...
    if(forward):
        try:
            ...
            gtf.Compile_Network(network, data_shape=(3, 32, 32), network_initializer="orthogonal");
