...
def test_initializer_random_uniform(system_dict):
    forward = True;

    test = "test_initializer_random_uniform";
    ...
    if(forward):
        try:
            ...
            gtf.Compile_Network(network, data_shape=(3, 32, 32), network_initializer="random_uniform");
