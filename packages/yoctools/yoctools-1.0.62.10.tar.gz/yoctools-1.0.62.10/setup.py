...
settings.update(
    ...
    data_files=[
        ('product64', ['yoctools/build/product64']),
        ('product32', ['yoctools/build/product32']),
        ('gen_ldfile.sh', ['yoctools/build/gen_ldfile.sh']),
...
try:
    if not os.path.exists(product):
        #patch for fail installed before
        os.unlink('/usr/local/bin/product')
    else:
...
##    #import yoctools
##    print("===================================>>>>here")
##    #print(os.path.dirname(os.path.abspath(yoctools.__file__)))
##    #dist_dir = os.path.dirname(os.path.abspath(yoctools.__file__))
