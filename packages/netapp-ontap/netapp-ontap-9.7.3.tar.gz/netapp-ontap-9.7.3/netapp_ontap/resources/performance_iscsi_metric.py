...
__pdoc__ = {
    ...
    "PerformanceIscsiMetricSchema.patchable_fields": False,
    "PerformanceIscsiMetricSchema.postable_fields": False,
}


class PerformanceIscsiMetricSchema(ResourceSchema):
