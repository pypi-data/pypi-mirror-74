        ...
        for task_name, task in self.tasks.items():
            ...
            if "clas" in metric:
                ...
                if isinstance(task['predicteds'][0][0], list):
                    print("tag", task['targets'], task['predicted'])
                    task['targets'] = [[[j] for j in sub] for sub in task['targets']][0]
                    task['predicteds'] = [[[j] for j in sub] for sub in task['predicted']][0]
                    print("tag after", task['targets'], task['predicteds'])
