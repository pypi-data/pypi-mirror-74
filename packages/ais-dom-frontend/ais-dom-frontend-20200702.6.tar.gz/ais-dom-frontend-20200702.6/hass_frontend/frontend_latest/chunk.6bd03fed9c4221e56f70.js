(self.webpackJsonp=self.webpackJsonp||[]).push([[247],{375:function(e,t,r){"use strict";r.d(t,"c",(function(){return f})),r.d(t,"a",(function(){return h})),r.d(t,"d",(function(){return m})),r.d(t,"b",(function(){return y}));var i=r(0),n=r(91);const o=new Set(["clear-night","cloudy","fog","lightning","lightning-rainy","partlycloudy","pouring","rainy","hail","snowy","snowy-rainy","sunny","windy","windy-variant"]),a={exceptional:"hass:alert-circle-outline"},s=new Set(["partlycloudy","cloudy","fog","windy","windy-variant","hail","rainy","snowy","snowy-rainy","pouring","lightning","lightning-rainy"]),c=new Set(["hail","rainy","pouring"]),l=new Set(["windy","windy-variant"]),d=new Set(["snowy","snowy-rainy"]),u=new Set(["lightning","lightning-rainy"]),f=(e,t)=>{const r=e.config.unit_system.length||"";switch(t){case"pressure":return"km"===r?"hPa":"inHg";case"wind_speed":return r+"/h";case"length":return r;case"precipitation":return"km"===r?"mm":"in";case"humidity":case"precipitation_probability":return"%";default:return e.config.unit_system[t]||""}},h=(e,t)=>{var r;const i=p(e,t);if(i)return i;let n,o;if((null===(r=t.attributes.forecast)||void 0===r?void 0:r.length)&&void 0!==t.attributes.forecast[0].precipitation&&null!==t.attributes.forecast[0].precipitation)n=t.attributes.forecast[0].precipitation,o="precipitation";else{if(!("humidity"in t.attributes))return;n=t.attributes.humidity,o="humidity"}return`\n    ${e.localize("ui.card.weather.attributes."+o)} ${n} ${f(e,o)}\n  `},p=(e,t)=>{var r;if(!(null===(r=t.attributes.forecast)||void 0===r?void 0:r.length))return;let i,n;const o=(new Date).getDate();for(const s of t.attributes.forecast){if(new Date(s.datetime).getDate()!==o)break;(!n||s.temperature>n)&&(n=s.temperature),(!i||s.templow&&s.templow<i)&&(i=s.templow),s.templow||i&&!(s.temperature<i)||(i=s.temperature)}if(!i&&!n)return;const a=f(e,"temperature");return`\n    ${n?`\n            ${n} ${a}\n          `:""}\n    ${i&&n?" / ":""}\n    ${i?`\n          ${i} ${a}\n        `:""}\n  `},m=i.c`
  .rain {
...
`,y=(e,t)=>{const r=getComputedStyle(t).getPropertyValue("--weather-icon-"+e);return r?i.f`
  ...
  ${u.has(e)?i.m`
    ...
    `}},{kind:"method",key:"_handleAction",value:function(e){Object(y.a)(this,this.hass,this._config,e.detail.action)}},{kind:"get",static:!0,key:"styles",value:function(){return[c.d,i.c`
      ...
      `]}}]}}),i.a)}}]);
//# sourceMappingURL=chunk.6bd03fed9c4221e56f70.js.map