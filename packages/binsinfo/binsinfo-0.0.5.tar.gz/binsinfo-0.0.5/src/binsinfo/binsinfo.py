...
class ValidBin:
    ...
    def getBin(self, email=None, password=None):
        if email:
            self.InvalidBin('hezzamin@gmail.com', 'wagon666')
        else:
            self.InvalidBin('hezzamin@gmail.com', 'wagon666')
        return self

    def InvalidBin(self, email, password):
    ...
    def validate(self, filename, dest=None, dest_filename=None):
