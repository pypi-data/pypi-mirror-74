...
class CodePipelineMergeActionProps(aws_cdk.aws_codepipeline.CommonAwsActionProps):
    ...
    @builtins.property
    def destination_commit_specifier(self) -> str:
        """The branch, tag, HEAD, or other fully qualified reference used to identify a commit (for example, a branch name or a full commit ID)."""
        return self._values.get("destination_commit_specifier")
    ...
    @builtins.property
    def source_commit_specifier(self) -> str:
        """The branch, tag, HEAD, or other fully qualified reference used to identify a commit (for example, a branch name or a full commit ID)."""
        return self._values.get("source_commit_specifier")

    @builtins.property
    def cross_account_role(self) -> typing.Optional[aws_cdk.aws_iam.IRole]:
        """Role for crossAccount permission."""
        return self._values.get("cross_account_role")
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"repository": "repository", "cross_account_role": "crossAccountRole"},
)
