...
class Performer(object):
    ...
    def __init__(self, key=None, start_location=None, finish_location=None, transport_type=None, shifts=None, tariff=None, local_vars_configuration=None):  # noqa: E501
    ...
    def tariff(self, tariff):
        ...
        :type: Tariff
        """
        if self.local_vars_configuration.client_side_validation and tariff is None:  # noqa: E501
            raise ValueError("Invalid value for `tariff`, must not be `None`")  # noqa: E501
