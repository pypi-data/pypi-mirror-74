...
def load_log_config(config_file_name):
    ...
    if not os.path.exists(config_file_name):
        raise LogUtilsException("Log configuration file {} does not exist.".format(config_file_name))
    logging.config.fileConfig(config_file_name)
    logger.debug("Beginning logging with configuration from:" + config_file_name)
