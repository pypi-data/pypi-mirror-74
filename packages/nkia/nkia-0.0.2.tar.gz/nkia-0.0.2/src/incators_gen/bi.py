...
class BI(object):
    ...
    def process_bi(self):
        ...
        self.products_df = self.get_dataframe_from_mongo()
    ...
    def get_dataframe_from_mongo(self):
        products_df = self.mongo_conn.db.df_products.find({}).sort('created', pymongo.DESCENDING)
