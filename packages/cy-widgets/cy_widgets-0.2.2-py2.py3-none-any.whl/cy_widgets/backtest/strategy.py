...
class StrategyBacktest:
    ...
    def __init__(self, df: pd.DataFrame, strategy: BaseExchangeStrategy, pos_func, evaluate_func, result_handler):
        """回测配置初始化
        ...
        evaluate_func : (pod_df) -> df_ev
            评估方法
        result_handler : (df_ev, strategy, error_des) -> result_df
            结果处理
        """
