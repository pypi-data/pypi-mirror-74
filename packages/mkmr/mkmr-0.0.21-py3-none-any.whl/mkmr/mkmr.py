...
def main():
    ...
    if options.edit is True:
        ...
        input += "# all lines until the first comment line are part of the description\n"
        input += "#\n"
        input += "# If everything is removed then the values presented above will be used\n"
        ...
        while linenum < output_len:
            ...
            if final_desc is None:
                ...
                while linenum < output_len and not output[linenum].startswith("#"):
                    ...
                    linenum += 1
                # There is nothing more to catch, we have our final_title and final_desc
                # we can break here, knowing we caught everything we wanted.
                # In the future if we wanted more stuff we will have to change this to
                # just have a 'linenum += 1' at the end of the while loop.
                break
