...
def main():
    ...
    # normally expected
    discussion_locked = not mr.attributes["discussion_locked"]
    if not discussion_locked:
        discussion_locked = False
    else:
        discussion_locked = True

    # We need this otherwise we are given an empty dictionary, which is shown to the user as '[]' instead of nothing
    # as it should be
    if not mr.attributes["labels"]:
        labels = None
    else:
        labels = " ".join(mr.attributes["labels"])
    ...
    final_remove_branch: Optional[bool] = None
    final_target_branch: Optional[str] = None
    final_lock_discussion: Optional[bool] = None
    final_squash: Optional[bool] = None
    final_collab: Optional[bool] = None
    ...
    # - True -> Allow mainainters to push
