...
class Interpretation:
    ...
    """
    def __init__(self, key, description, tmp_dir, scoring_package_path, binned_list, labels, parameters, training_duration, log_file_path, lime_rc_csv_path, shapley_rc_csv_path, subtask_keys) -> None:
        self.key = key
        self.description = description
        self.tmp_dir = tmp_dir
    ...
    def clone(self) -> 'Interpretation':
        return Interpretation(self.key, self.description, self.tmp_dir, self.scoring_package_path, self.binned_list, self.labels, self.parameters, self.training_duration, self.log_file_path, self.lime_rc_csv_path, self.shapley_rc_csv_path, self.subtask_keys)
