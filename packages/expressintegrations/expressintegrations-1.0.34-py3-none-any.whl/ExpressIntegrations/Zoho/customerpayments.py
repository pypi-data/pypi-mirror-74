...
def create_customerpayment(customerpayment):
  post_url = f"{BASE_URL}/customerpayments"
...
def update_customerpayment(customerpayment_id, customerpayment):
  post_url = f"{BASE_URL}/customerpayments/{customerpayment_id}"
...
def search_customerpayments(customer_name=None,
  ...
  post_url = f"{BASE_URL}/customerpayments?sort_column={sort_column}"
