...
class zoho:
  ...
  def __init__(self, app, client_id, client_secret, refresh_token, organization):
    contacts.BASE_URL = f"https://{app}.zoho.com/api/v3/contacts?organization_id={organization}"
    customerpayments.BASE_URL = f"https://{app}.zoho.com/api/v3/customerpayments?organization_id={organization}"
    users.BASE_URL = f"https://{app}.zoho.com/api/v3/users?organization_id={organization}"
    items.BASE_URL = f"https://{app}.zoho.com/api/v3/items?organization_id={organization}"
    invoices.BASE_URL = f"https://{app}.zoho.com/api/v3/invoices?organization_id={organization}"
