...
class instrument(object):
    ...
    def Read( self, decode = True, NumberOfBytes = -1):
        ...
        if NumberOfBytes == -1:
            NumberOfBytes = self.__InBufferSize
    ...
    def __ReadBinaryAndDump( self, BytesPerValue = 4):
        """Binary read of multiple values, without returning any data.
        Intended for interface speed tests mainly."""
    ...
    def ReadBinary( self, BytesPerValue = 4, IqRead = False, NaNCheck = False):
