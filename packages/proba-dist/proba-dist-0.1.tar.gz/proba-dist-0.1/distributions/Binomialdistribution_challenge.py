...
class Binomial(Distribution):
    ...
    def __init__(self, p=0 , n=0 , mu = 0 , sigma = 0):
    ...
    def calculate_stdev(self):
        ...
        """
        return math.sqrt(self.calculate_mean()*(1-self.p))
    ...
    def replace_stats_with_data(self):
        ...
        """
        self.p =  sum([i for i in self.data if i in self.data]) / len(self.data)
    ...
    def pdf(self , k):
        ...
        """
        return (math.factorial(self.n)/(math.factorial(k)*math.factorial(self.n - k)))*pow(self.p , k)*pow(1- self.p ,self.n - k)
    # write a method to plot the probability density function of the binomial distribution
    
    def Binomial_plot(self , n_spaces =50):
    ...
    def __add__(self, other):
        ...
        #result.stdev = math.sqrt(pow(result.p*result.n(1-result.p),2))
        return result
        '''
        try:
    ...
    def __repr__(self):
        ...
        """
        return 'mean {}, standard deviation {:1.1f}, p {}, n {}'.format(self.mean,
                                                                      self.stdev,
                                                                      self.p,
                                                                      self.n )
