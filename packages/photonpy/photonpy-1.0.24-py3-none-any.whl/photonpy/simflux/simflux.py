...
class SimfluxProcessor:
    ...
    def drift_correct(self, framesperbin=1, drift_fn=None, sigmaMultiplier=1):
        ...
        self.g_undrifted.data[:, [loc.DataColumns.X, loc.DataColumns.Y]] -= self.g_drift[self.sum_results.get_frame_numbers(),:2]

        self.sf_undrifted = self.sf_results.clone()
        self.sf_undrifted.data[:, [loc.DataColumns.X, loc.DataColumns.Y]] -= self.sf_drift[self.sf_results.get_frame_numbers(),:2]
