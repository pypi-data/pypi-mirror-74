...
class ImageProcessor:
    def __init__(self, imgshape, inst, ctx:Context):
        ...
        self._ImgProc_AddFrame = ctx.lib.ImgProc_AddFrame
        self._ImgProc_AddFrame.argtypes = [
            InstancePtrType,
...
#CDLL_EXPORT bool ImgFilterQueue_ReadFrame(ImgFilterQueue* q, float* filtered, float* image, int& framenum)
    ...
    def PushFrame(self,img):
        ...
        self._ImgProc_AddFrame(self.inst, np.ascontiguousarray(img,dtype=np.uint16))
