...
[boto3.CodeArtifact 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/codeartifact.html#CodeArtifact) service
...
`mypy_boto3_codeartifact` and other installed services.
...
session_client = boto3.Session().client("codeartifact")
```
