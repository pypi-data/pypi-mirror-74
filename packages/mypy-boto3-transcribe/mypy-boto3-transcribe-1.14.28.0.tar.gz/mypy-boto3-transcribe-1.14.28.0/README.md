...
[boto3.TranscribeService 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/transcribe.html#TranscribeService) service
...
`mypy_boto3_transcribe` and other installed services.
...
session_client = boto3.Session().client("transcribe")
```
