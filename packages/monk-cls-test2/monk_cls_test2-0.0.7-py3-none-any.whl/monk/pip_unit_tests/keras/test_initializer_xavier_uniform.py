...
def test_initializer_xavier_uniform(system_dict):
    forward = True;

    test = "test_initializer_xavier_uniform";
    ...
    if(forward):
        try:
            ...
            gtf.Compile_Network(network, data_shape=(3, 32, 32), network_initializer="xavier_uniform");
