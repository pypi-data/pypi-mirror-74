...
class TestRegister(unittest.TestCase):
    ...
    def test_linear_input_initializes_scalar(self):
        ...
        self.assertEqual(register.state.w, .5)
        self.assertEqual(register.state.bias, 1)

        # Correctly scaled the input (the output doen't scale)
        assert_array_almost_equal(o, [-1, 1])
    ...
    def test_fixed_input_initializes_scalar(self):
        ...
        # Initialized the right parameters
        self.assertEqual(register.state.w, 1)
        self.assertEqual(register.state.bias, 0)

        # Correctly scaled the input (the output doen't scale)
        assert_array_almost_equal(o, [-1, 0])
