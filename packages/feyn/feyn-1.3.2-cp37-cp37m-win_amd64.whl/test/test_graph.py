...
#       Would it make sense, to let the lattice deal with name-to-loc mapping,
...
class TestGraph(unittest.TestCase):
    ...
    def test_invalid_graph(self):
        ...
        with self.assertRaises(RuntimeError):
            ...
            node = feyn.Interaction('cell:tanh(i,i)->i', latticeloc=(0,0,0), name="tanh")
            node._set_source(0, 0)
            node._set_source(1, 0)
