...
cloudfront.Distribution(self, "myDist",
    default_behavior={"origin": cloudfront.Origin.from_http_server(domain_name="www.example.com")}
)
```
...
class Origin(
    ...
    @jsii.member(jsii_name="fromHttpServer")
    @builtins.classmethod
    def from_http_server(
        ...
        *,
        ...
        return jsii.sinvoke(cls, "fromHttpServer", [props])
