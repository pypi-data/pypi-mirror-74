...
from .constants import DEPENDS_ATT, MakeTypeCache, PYTHON_36, ZuperTypingGlobals
    ...
    try:
        ...
        if do_it:
            ...
            if not ok:  # pragma: no cover
                ...
                msg = (
                    f"The field {k!r} of class {type_self_name} is supposed to be {T_expected_name} but found"
                    f" {T_found_name}"
                )
