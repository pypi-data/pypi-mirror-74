...
TSColumnT = TypeVar("TSColumnT", bound=TimeSeriesColumn)


class TimeSeries(ABC, Generic[TSStoreT, TSColumnT]):
    """This class provides the interface of TimeSeries."""

    def __init__(self, store: TSStoreT, columns: Optional[List[TSColumnT]] = None):
        self._store = store
    ...
    @property
    def columns(self) -> List[TSColumnT]:
        """
