...
class KiWIS(object):
    ...
    def __init__(
        ...
        self.__http_client = httpx.AsyncClient(verify=verify_ssl)
        self.__http_client_info = self.make_request("getRequestInfo", {"format": "json"}).json()[0][
            "Requests"
        ]
    ...
    def _pre_request_check(self, params, request_name):
        ...
        if "Dateformats" in self.__http_client_info[request_name] and params.get("dateformat", False):
    ...
    def _check_params(self, parameters, request_name):
        for param in parameters:
            ...
            if (
                param not in self.__http_client_info[request_name]["QueryFields"]["Content"]
                and param not in self.__http_client_info[request_name]["Optionalfields"]["Content"]
    ...
    def _check_format(self, format, request_name):
        ...
        if format not in self.__http_client_info[request_name]["Formats"]["Content"]:
            self.__logger.warning(
    ...
    def _check_date_format(self, date_formats, request_name):
        ...
        for dateformat in [
            ...
            if x not in self.__http_client_info[request_name]["Dateformats"]["Content"]
        ]:
            self.__logger.warning(
    ...
    def _check_return_fields(self, return_fields, request_name):
        ...
        return_fields_info = self.__http_client_info[request_name]["Returnfields"]["Content"]
    ...
    async def make_request_async(self, request_name, request_data) -> Union[httpx.Response, pd.DataFrame]:
        request_data.update(
            {
                "service": "kisters",
                "type": "queryServices",
        ...
        req = await self.__http_client.get(self.__kiwis_uri, params=request_data, headers=headers)
    ...
    def make_request(self, request_name, request_data) -> Union[httpx.Response, pd.DataFrame]:
        loop = asyncio.get_event_loop()
        return loop.run_until_complete(self.make_request_async(request_name, request_data))
    ...
    async def getTimeseriesList_async(
        self,
        format="objson",
        timeseriesgroup_id=None,
        returnfields=None,
        ...
        **kwargs,
        ...
        locals_ = None
        res = self._pre_request_check(locals2_, "getTimeseriesList")
        kiwis_result = await self.make_request_async("getTimeseriesList", res)
        return kiwis_result
    ...
    async def getTimeseriesEnsembleValues_async(self, format="json", **kwargs):
        kwargs.update(format=format)
        res = self._pre_request_check(kwargs, "getTimeseriesEnsembleValues")
        kiwis_result = await self.make_request_async("getTimeseriesEnsembleValues", res)
        return kiwis_result

    async def getTimeseriesValues(
        self,
        format="dajson",
        ts_id=None,
        timeseriesgroup_id=None,
    ...
    async def getTimeseriesValues_async(
        self,
        format="dajson",
        ts_id=None,
        timeseriesgroup_id=None,
        ...
        **kwargs,
        ...
        locals_ = None
        res = self._pre_request_check(locals2_, "getTimeseriesValues")
        kiwis_result = await self.make_request_async("getTimeseriesValues", res)
        return kiwis_result
