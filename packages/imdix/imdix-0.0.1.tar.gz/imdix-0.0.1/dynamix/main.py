...
from dynamix.utils import Image
from dynamix.utils import compare
from dynamix.utils import image_resize
from dynamix.utils import GENERIC_IMAGE
...
def search(image: Image, target_size: int, output: Optional[str] = None, ext: Optional[str] = None):
    ...
    while compare(high, low):
        ...
        if size_of_new_image == target_size:
