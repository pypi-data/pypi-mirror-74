...
var SpansInterface = /** @class */ (function (_super) {
    ...
    SpansInterface.prototype.render = function () {
        var _this = this;
        var _a = this.props, event = _a.event, orgId = _a.orgId, location = _a.location, organization = _a.organization;
        ...
        return (<div>
        <DiscoverQuery location={location} eventView={traceErrorsEventView} orgSlug={orgId}>
          {function (_a) {
            ...
            return (<React.Fragment>
                ...
                <Panel>
                  <TraceView event={event} searchQuery={_this.state.searchQuery} orgId={orgId} organization={organization} parsedTrace={parsedTrace} spansWithErrors={spansWithErrors}/>
                </Panel>
              </React.Fragment>);
        }}
        </DiscoverQuery>
...
var AlertContainer = styled('div')(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  margin-bottom: ", ";\n"], ["\n  margin-bottom: ", ";\n"])), space(1));
