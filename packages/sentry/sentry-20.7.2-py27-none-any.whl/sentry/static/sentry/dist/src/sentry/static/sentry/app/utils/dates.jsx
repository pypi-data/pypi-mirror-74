...
export var DEFAULT_DAY_START_TIME = '00:00:00';
export var DEFAULT_DAY_END_TIME = '23:59:59';
var DATE_FORMAT_NO_TIMEZONE = 'YYYY/MM/DD HH:mm:ss';
function getParser(local) {
...
export function getFormattedDate(dateObj, format, _a) {
    var local = (_a === void 0 ? {} : _a).local;
 ...
 */
export function setDateToTime(dateObj, timeStr, _a) {
    var local = (_a === void 0 ? {} : _a).local;
    var _b = __read(timeStr.split(':').map(function (t) { return parseInt(t, 10); }), 3), hours = _b[0], minutes = _b[1], seconds = _b[2];
...
export function getStartOfPeriodAgo(period, unit) {
...
export function intervalToMilliseconds(interval) {
    var pattern = /^(\d+)(h|m)$/;
    var matches = pattern.exec(interval);
    if (!matches) {
        return 0;
    }
    var _a = __read(matches, 3), value = _a[1], unit = _a[2];
    var multipliers = {
        h: 60 * 60,
        m: 60,
    };
...
export function parsePeriodToHours(str) {
    var result = parseStatsPeriod(str);
    if (!result) {
        return -1;
    }
...
export var use24Hours = function () { var _a, _b; return (_b = (_a = ConfigStore.get('user')) === null || _a === void 0 ? void 0 : _a.options) === null || _b === void 0 ? void 0 : _b.clock24Hours; };
export var getTimeFormat = function () { return (use24Hours() ? 'HH:mm' : 'LT'); };
