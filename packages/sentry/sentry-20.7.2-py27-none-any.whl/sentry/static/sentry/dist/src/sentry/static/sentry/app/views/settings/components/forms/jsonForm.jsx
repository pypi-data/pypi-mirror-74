...
var JsonForm = /** @class */ (function (_super) {
    ...
    JsonForm.prototype.render = function () {
        var _this = this;
        var _a = this.props, fields = _a.fields, title = _a.title, forms = _a.forms, access = _a.access, disabled = _a.disabled, features = _a.features, additionalFieldProps = _a.additionalFieldProps, renderFooter = _a.renderFooter, renderHeader = _a.renderHeader, _location = _a.location, otherProps = __rest(_a, ["fields", "title", "forms", "access", "disabled", "features", "additionalFieldProps", "renderFooter", "renderHeader", "location"]);
        var formPanelProps = {
            access: access,
            disabled: disabled,
            features: features,
