...
var getBorder = function (p) { var _a, _b; return p.border ? "border: 1px solid " + ((_b = (_a = getPriority(p)) === null || _a === void 0 ? void 0 : _a.border) !== null && _b !== void 0 ? _b : p.theme.borderDark) + ";" : ''; };
var Tag = styled(function (_a) {
    ...
    return (<div {...props}>
      {icon && (<IconWrapper>
          {React.isValidElement(icon) ? (React.cloneElement(icon, { size: 'xs' })) : typeof icon === 'string' ? (<InlineSvg src={icon} size="12px"/>) : null}
        </IconWrapper>)}
      {children}
    </div>);
})(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: inline-flex;\n  box-sizing: border-box;\n  padding: ", ";\n  font-size: ", ";\n  line-height: 1;\n  color: ", ";\n  text-align: center;\n  white-space: nowrap;\n  vertical-align: middle;\n  align-items: center;\n  border-radius: ", ";\n  text-transform: lowercase;\n  font-weight: ", ";\n  background: ", ";\n  ", ";\n  ", ";\n"], ["\n  display: inline-flex;\n  box-sizing: border-box;\n  padding: ", ";\n  font-size: ", ";\n  line-height: 1;\n  color: ", ";\n  text-align: center;\n  white-space: nowrap;\n  vertical-align: middle;\n  align-items: center;\n  border-radius: ", ";\n  text-transform: lowercase;\n  font-weight: ", ";\n  background: ", ";\n  ", ";\n  ", ";\n"])), function (p) { return (p.size === 'small' ? '0.1em 0.4em 0.2em' : '0.35em 0.8em 0.4em'); }, function (p) { return p.theme.fontSizeExtraSmall; }, function (p) { return (p.priority ? '#fff' : p.theme.gray800); }, function (p) { return (p.size === 'small' ? '0.25em' : '2em'); }, function (p) { return (p.size === 'small' ? 'bold' : 'normal'); }, function (p) { var _a, _b; return (_b = (_a = getPriority(p)) === null || _a === void 0 ? void 0 : _a.background) !== null && _b !== void 0 ? _b : p.theme.gray300; }, function (p) { return getBorder(p); }, function (p) { return getMarginLeft(p); });
