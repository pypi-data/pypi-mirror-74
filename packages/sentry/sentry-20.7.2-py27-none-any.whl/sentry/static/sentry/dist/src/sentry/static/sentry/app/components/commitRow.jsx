...
var EmailWarningIcon = styled(InlineSvg)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  position: relative;\n  margin-left: -11px;\n  border-radius: 11px;\n  margin-bottom: -25px;\n  border: 1px solid ", ";\n  background: ", ";\n"], ["\n  position: relative;\n  margin-left: -11px;\n  border-radius: 11px;\n  margin-bottom: -25px;\n  border: 1px solid ", ";\n  background: ", ";\n"])), function (p) { return p.theme.white; }, function (p) { return p.theme.yellow300; });
