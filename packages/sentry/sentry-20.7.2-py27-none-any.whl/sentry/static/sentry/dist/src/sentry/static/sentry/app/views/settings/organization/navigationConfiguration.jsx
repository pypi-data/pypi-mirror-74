...
var organizationNavigation = [
    {
        ...
        items: [
            ...
            },
            {
                ...
                show: function (_a) {
                    var access = _a.access, features = _a.features;
                    return features.has('relay') && access.has('org:write');
                },
            ...
            },
            {
                ...
                description: t('Manage organization-level integrations, including: Slack, Github, Bitbucket, Jira, and Azure DevOps'),
                id: 'integrations',
