...
var ThresholdControl = /** @class */ (function (_super) {
    ...
    ThresholdControl.prototype.render = function () {
        ...
        var _b = this.props, thresholdType = _b.thresholdType, threshold = _b.threshold, type = _b.type, _ = _b.onChange, __ = _b.onThresholdTypeChange, disabled = _b.disabled, disableThresholdType = _b.disableThresholdType, props = __rest(_b, ["thresholdType", "threshold", "type", "onChange", "onThresholdTypeChange", "disabled", "disableThresholdType"]);
        return (<div {...props}>
        ...
        <Input disabled={disabled} name={type + "Threshold"} placeholder="300" value={(_a = currentValue !== null && currentValue !== void 0 ? currentValue : threshold) !== null && _a !== void 0 ? _a : ''} onChange={this.handleThresholdChange} onBlur={this.handleThresholdBlur} 
