...
describe('CheckboxFancy', function () {
    it('renders', function () {
        var wrapper = shallow(<CheckboxFancy />);
        expect(wrapper).toMatchSnapshot();
    });
    it('isChecked', function () {
        var wrapper = mountWithTheme(<CheckboxFancy isChecked/>);
    ...
    it('isIndeterminate', function () {
        var wrapper = mountWithTheme(<CheckboxFancy isIndeterminate/>);
    ...
    it('isDisabled', function () {
        var wrapper = mountWithTheme(<CheckboxFancy isDisabled/>);
