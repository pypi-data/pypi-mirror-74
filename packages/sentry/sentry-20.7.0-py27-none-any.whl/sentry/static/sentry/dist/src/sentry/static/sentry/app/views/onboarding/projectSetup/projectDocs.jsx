...
var ProjectDocs = /** @class */ (function (_super) {
    ...
    Object.defineProperty(ProjectDocs.prototype, "missingExampleWarning", {
        ...
        get: function () {
            ...
            return (<Alert type="warning" icon="icon-circle-info">
    ...
    ProjectDocs.prototype.render = function () {
        ...
        <PanelBody withPadding>
          ...
          <Footer>
            {project && (<FirstEventIndicator organization={organization} project={project}/>)}
            <div>
        ...
        var testOnlyAlert = (<Alert type="warning">Platform documentation is not rendered in Percy Tests</Alert>);
...
var StyledPlatformIcon = styled(PlatformIcon)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  height: 24px;\n  width: 24px;\n  border-radius: 3px;\n"], ["\n  height: 24px;\n  width: 24px;\n  border-radius: 3px;\n"])));
