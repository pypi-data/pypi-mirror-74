...
import { boundsGenerator, pickSpanBarColour, generateRootSpan, getSpanID, getSpanOperation, getSpanTraceID, isGapSpan, isOrphanSpan, isEventFromBrowserJavaScriptSDK, } from './utils';
...
var SpanTree = /** @class */ (function (_super) {
    ...
    function SpanTree() {
        ...
        _this.renderRootSpan = function () {
            var _a = _this.props, dragProps = _a.dragProps, trace = _a.trace;
    ...
    SpanTree.prototype.isSpanFilteredOut = function (span) {
        var filterSpans = this.props.filterSpans;
        if (!filterSpans) {
            return false;
        }
