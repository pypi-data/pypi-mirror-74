...
var theme = __assign(__assign(__assign(__assign({ breakpoints: ['768px', '992px', '1200px', '1440px', '2560px'] }, colors), { iconSizes: iconSizes, iconDirections: {
        up: '0',
        right: '90',
        down: '180',
        left: '270',
    ...
    // Relative font sizes
    fontSizeRelativeSmall: '0.9em', fontSizeExtraSmall: '11px', fontSizeSmall: '12px', fontSizeMedium: '14px', fontSizeLarge: '16px', fontSizeExtraLarge: '18px', headerFontSize: '22px', settings: {
    ...
    badge: badge,
    button: button, charts: {
        colors: CHART_PALETTE[CHART_PALETTE.length - 1],
        // We have an array that maps `number + 1` --> list of `number` colors
        getColorPalette: function (length) {
            return CHART_PALETTE[Math.min(CHART_PALETTE.length - 1, length + 1)];
        },
