...
var DebugImage = React.memo(function (_a) {
    var image = _a.image, orgId = _a.orgId, projectId = _a.projectId, showDetails = _a.showDetails, style = _a.style;
    ...
    var combinedStatus = combineStatus(image === null || image === void 0 ? void 0 : image.debug_status, image.unwind_status);
...
var ImageIcon = styled(InlineSvg)(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n  font-size: ", ";\n  color: ", ";\n  @media (max-width: ", ") {\n    font-size: ", ";\n    margin-bottom: ", ";\n  }\n"], ["\n  font-size: ", ";\n  color: ", ";\n  @media (max-width: ", ") {\n    font-size: ", ";\n    margin-bottom: ", ";\n  }\n"])), function (p) { return p.theme.fontSizeLarge; }, function (p) { return p.theme.alert[p.type].iconColor; }, function (p) { return p.theme.breakpoints[0]; }, function (p) { return p.theme.fontSizeExtraLarge; }, space(0.5));
