        ...
        {numberOfTriggers !== 0 &&
            data.triggers.map(function (trigger, i) {
                ...
                <Actions key={"actions-" + i} hideBorder={hideBorder}>
                  {(_a = trigger.actions) === null || _a === void 0 ? void 0 : _a.map(function (action, j) { return (<Action key={j}>{action.desc}</Action>); })}
                </Actions>
              </React.Fragment>);
            })}
      </React.Fragment>);
...
var RuleType = styled('div')(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  color: ", ";\n  font-size: ", ";\n  font-weight: bold;\n  text-transform: uppercase;\n  ", ";\n"], ["\n  color: ", ";\n  font-size: ", ";\n  font-weight: bold;\n  text-transform: uppercase;\n  ", ";\n"])), function (p) { return p.theme.gray600; }, function (p) { return p.theme.fontSizeSmall; }, function (p) { return p.rowSpans && "grid-row: auto / span " + p.rowSpans; });
...
var StatusBadge = styled('div')(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n  background-color: ", ";\n  color: ", ";\n  text-transform: uppercase;\n  padding: ", " ", ";\n  font-weight: 600;\n  margin-right: ", ";\n  border-radius: ", ";\n  font-size: ", ";\n"], ["\n  background-color: ", ";\n  color: ", ";\n  text-transform: uppercase;\n  padding: ", " ", ";\n  font-weight: 600;\n  margin-right: ", ";\n  border-radius: ", ";\n  font-size: ", ";\n"])), function (p) { return p.theme.gray300; }, function (p) { return p.theme.gray700; }, space(0.25), space(0.5), space(0.5), function (p) { return p.theme.borderRadius; }, function (p) { return p.theme.fontSizeRelativeSmall; });
