...
var DataDownload = /** @class */ (function (_super) {
    ...
    DataDownload.prototype.renderOpenInDiscover = function () {
        ...
        <Button priority="primary" icon={<IconTelescope />} onClick={function () { return _this.openInDiscover(); }}>
          {t('Open in Discover')}
        </Button>
        <br />
      </React.Fragment>) : null;
    ...
    DataDownload.prototype.renderValid = function () {
        ...
        <Body>
          ...
          <p>
            ...
            link: (<a href="https://docs.sentry.io/performance-monitoring/discover-queries/query-builder/#filter-by-table-columns" target="_blank" rel="noopener noreferrer">
