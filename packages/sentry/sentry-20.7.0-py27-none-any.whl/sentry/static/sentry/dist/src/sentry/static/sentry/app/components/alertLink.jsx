...
var AlertLink = /** @class */ (function (_super) {
    ...
    AlertLink.prototype.render = function () {
        var _a = this.props, size = _a.size, priority = _a.priority, icon = _a.icon, children = _a.children, onClick = _a.onClick, withoutMarginBottom = _a.withoutMarginBottom, openInNewTab = _a.openInNewTab, to = _a.to, href = _a.href;
        return (<StyledLink to={to} href={href} onClick={onClick} size={size} priority={priority} withoutMarginBottom={withoutMarginBottom} openInNewTab={openInNewTab}>
        {icon && (<IconWrapper>
...
})(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: flex;\n  background-color: ", ";\n  color: ", ";\n  border: 1px dashed ", ";\n  padding: ", ";\n  margin-bottom: ", ";\n  border-radius: 0.25em;\n  transition: 0.2s border-color;\n\n  &.focus-visible {\n    outline: none;\n    box-shadow: ", "7f 0 0 0 2px;\n  }\n"], ["\n  display: flex;\n  background-color: ", ";\n  color: ", ";\n  border: 1px dashed ", ";\n  padding: ", ";\n  margin-bottom: ", ";\n  border-radius: 0.25em;\n  transition: 0.2s border-color;\n\n  &.focus-visible {\n    outline: none;\n    box-shadow: ", "7f 0 0 0 2px;\n  }\n"])), function (p) { return p.theme.alert[p.priority].backgroundLight; }, function (p) { return p.theme.gray700; }, function (p) { return p.theme.alert[p.priority].border; }, function (p) { return (p.size === 'small' ? space(1) + " " + space(1.5) : space(2)); }, function (p) { return (p.withoutMarginBottom ? 0 : space(3)); }, function (p) { return p.theme.alert[p.priority].border; });
