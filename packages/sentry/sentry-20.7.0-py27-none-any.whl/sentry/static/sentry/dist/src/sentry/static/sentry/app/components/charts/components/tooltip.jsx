...
function getFormatter(_a) {
    var filter = _a.filter, isGroupedByDate = _a.isGroupedByDate, showTimeInTooltip = _a.showTimeInTooltip, truncate = _a.truncate, formatAxisLabel = _a.formatAxisLabel, utc = _a.utc, _b = _a.valueFormatter, valueFormatter = _b === void 0 ? defaultValueFormatter : _b, _c = _a.nameFormatter, nameFormatter = _c === void 0 ? defaultNameFormatter : _c;
    ...
    var formatter = function (seriesParamsOrParam) {
        ...
        if (!Array.isArray(seriesParamsOrParam) &&
            ...
            var label_1 = axisFormatterOrDefault(timestamp_1, !!isGroupedByDate, !!utc, !!showTimeInTooltip);
...
export default function Tooltip(_a) {
    if (_a === void 0) { _a = {}; }
    var filter = _a.filter, isGroupedByDate = _a.isGroupedByDate, showTimeInTooltip = _a.showTimeInTooltip, formatter = _a.formatter, truncate = _a.truncate, utc = _a.utc, formatAxisLabel = _a.formatAxisLabel, valueFormatter = _a.valueFormatter, nameFormatter = _a.nameFormatter, props = __rest(_a, ["filter", "isGroupedByDate", "showTimeInTooltip", "formatter", "truncate", "utc", "formatAxisLabel", "valueFormatter", "nameFormatter"]);
    formatter =
        formatter ||
            getFormatter({
                filter: filter,
    ...
    return __assign({ show: true, trigger: 'item', backgroundColor: 'transparent', transitionDuration: 0, padding: 0, position: function (pos, _params, dom, _rec, _size) {
