...
var GroupVariant = /** @class */ (function (_super) {
    ...
    GroupVariant.prototype.renderTitle = function () {
        ...
        return (<Tooltip title={isContributing ? t('Contributing variant') : t('Non-contributing variant')}>
        <VariantTitle>
          <ContributionIcon isContributing={isContributing}/>
          {t('By')}{' '}
          {(_b = (_a = variant.description) === null || _a === void 0 ? void 0 : _a.split(' ').map(function (i) { return capitalize(i); }).join(' ')) !== null && _b !== void 0 ? _b : t('Nothing')}
        </VariantTitle>
      </Tooltip>);
    };
...
var ContributionIcon = styled(function (_a) {
    ...
    return isContributing ? (<IconCheckmark size="sm" isCircled color="green400" {...p}/>) : (<IconClose size="sm" isCircled color="red" {...p}/>);
