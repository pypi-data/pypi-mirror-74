...
import { BreadcrumbType, BreadcrumbLevelType, } from 'app/components/events/interfaces/breadcrumbsV2/types';
var options = [
    [
        {
...
describe('Filter', function () {
    ...
    it('default render', function () {
        var wrapper = mountWithTheme(<Filter options={options} onFilter={handleFilter}/>);
        ...
        expect(wrapper
            .find('OptionsGroup')
            .at(1)
            .find('ListItem')).toHaveLength(2);
        expect(wrapper).toMatchSnapshot();
    });
    it('Without Options', function () {
        var wrapper = mountWithTheme(<Filter options={[[], []]} onFilter={handleFilter}/>);
    ...
    it('With Option Type only', function () {
        var wrapper = mountWithTheme(<Filter options={[options[0], []]} onFilter={handleFilter}/>);
        var optionsGroup = wrapper.find('OptionsGroup');
