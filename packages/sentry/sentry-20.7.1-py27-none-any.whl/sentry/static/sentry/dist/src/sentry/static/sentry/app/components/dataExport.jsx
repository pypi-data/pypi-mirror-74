...
var DataExport = /** @class */ (function (_super) {
    ...
    DataExport.prototype.render = function () {
        ...
        return (<Feature features={['organizations:data-export']}>
        {inProgress ? (<NewButton size="small" priority="default" title="You can get on with your life. We'll email you when your data's ready." {...this.props} disabled icon={icon}>
            {t("We're working on it...")}
          </NewButton>) : (<NewButton onClick={debounce(this.startDataExport, 500)} disabled={disabled || false} size="small" priority="default" title="Put your data to work. Start your export and we'll email you when it's finished." icon={icon} {...this.props}>
