...
var Chart = /** @class */ (function (_super) {
    ...
    Chart.prototype.render = function () {
        ...
        return (<Component {...props} {...zoomRenderProps} legend={legend} onLegendSelectChanged={this.handleLegendSelectChanged} series={series} seriesOptions={{
            showSymbol: false,
...
var EventsChart = /** @class */ (function (_super) {
    ...
    EventsChart.prototype.render = function () {
        ...
        if (!disableReleases) {
            ...
            chartImplementation = function (chartProps) { return (<ReleaseSeries utc={utc} period={period} start={start} end={end} projects={projects}>
          {function (_a) {
