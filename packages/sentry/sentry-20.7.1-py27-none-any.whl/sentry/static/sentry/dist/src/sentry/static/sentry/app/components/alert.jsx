...
var alertStyles = function (_a) {
    ...
    return css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  display: flex;\n  margin: 0 0 ", ";\n  padding: ", " ", ";\n  font-size: 15px;\n  box-shadow: ", ";\n  border-radius: ", ";\n  background: ", ";\n  border: 1px solid ", ";\n\n  a:not([role='button']) {\n    color: ", ";\n    border-bottom: 1px dotted ", ";\n  }\n\n  ", ";\n  ", ";\n"], ["\n  display: flex;\n  margin: 0 0 ", ";\n  padding: ", " ", ";\n  font-size: 15px;\n  box-shadow: ", ";\n  border-radius: ", ";\n  background: ", ";\n  border: 1px solid ", ";\n\n  a:not([role='button']) {\n    color: ", ";\n    border-bottom: 1px dotted ", ";\n  }\n\n  ", ";\n  ", ";\n"])), space(3), space(1.5), space(2), theme.dropShadowLight, theme.borderRadius, theme.gray100, theme.borderDark, theme.textColor, theme.textColor, getAlertColorStyles(theme.alert[type]), system && getSystemAlertColorStyles(theme.alert[type]));
};
...
var Alert = styled(function (_a) {
    var type = _a.type, icon = _a.icon, iconSize = _a.iconSize, children = _a.children, className = _a.className, _system = _a.system, // don't forward to `div`
    props = __rest(_a, ["type", "icon", "iconSize", "children", "className", "system"]);
