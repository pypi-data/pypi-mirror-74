...
var DebugMeta = /** @class */ (function (_super) {
    ...
    DebugMeta.prototype.filterImage = function (image) {
        var _a = this.state, showUnused = _a.showUnused, filter = _a.filter;
        ...
        if (filter.indexOf('0x') === 0) {
            var needle = parseAddress(filter);
            if (needle > 0) {
    ...
    DebugMeta.prototype.getFrame = function () {
        ...
        return frames === null || frames === void 0 ? void 0 : frames.find(function (frame) { return frame.instructionAddr === _this.state.filter; });
    };
