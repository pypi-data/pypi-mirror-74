...
var IntegrationRepos = /** @class */ (function (_super) {
    ...
    IntegrationRepos.prototype.renderDropdown = function () {
        ...
        var onChange = this.state.integrationRepos.searchable
            ...
            : null;
        return (<DropdownAutoComplete items={items} onSelect={this.addRepo.bind(this)} onChange={onChange} menuHeader={menuHeader} emptyMessage={t('No repositories available')} noResultsMessage={t('No repositories found')} busy={this.state.dropdownBusy}>
        {function (_a) {
