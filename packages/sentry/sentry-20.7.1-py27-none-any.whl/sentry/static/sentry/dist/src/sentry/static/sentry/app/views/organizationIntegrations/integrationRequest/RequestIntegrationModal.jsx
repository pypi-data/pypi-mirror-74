...
var RequestIntegrationModal = /** @class */ (function (_super) {
    ...
    RequestIntegrationModal.prototype.render = function () {
        ...
        <Body>
          ...
          <TextareaField inline={false} flexibleControlStateSize stacked label={t('(Optional) You’ve got good reasons for installing the %s Integration. Share them with your organization owner.', name)} name="message" type="string" onChange={function (value) { return _this.setState({ message: value }); }} placeholder={t('Optional message…')}/>
          <TextBlock>
