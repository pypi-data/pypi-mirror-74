...
"""
    ...
    OpenAPI spec version: 13.0.0-beta.0
...
class PersistApi(object):
    ...
    def create_with_http_info(self, zone, key, value, **kwargs):
        ...
        return self.api_client.call_api('/persist/resources/{zone}/{key}', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_with_http_info(self, zone, key, **kwargs):
        ...
        return self.api_client.call_api('/persist/resources/{zone}/{key}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_by_id_with_http_info(self, id, **kwargs):
        ...
        return self.api_client.call_api('/persist/resources/{id}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get(self, zone, key, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get(zone, key, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_with_http_info(zone, key, **kwargs)
        else:
            (data) = self.get_with_http_info(zone, key, **kwargs)
            return data

    def get_with_http_info(self, zone, key, **kwargs):
        """
        Fetch an entry given its zone and key.
        Fetch an entry given its zone and key.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_with_http_info(zone, key, callback=callback_function)
        ...
        # verify the required parameter 'zone' is set
        if ('zone' not in params) or (params['zone'] is None):
            raise ValueError("Missing the required parameter `zone` when calling `get`")
        # verify the required parameter 'key' is set
        if ('key' not in params) or (params['key'] is None):
            raise ValueError("Missing the required parameter `key` when calling `get`")
        ...
        return self.api_client.call_api('/persist/resources/{zone}/{key}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_with_http_info(self, id, value, last_update, **kwargs):
        ...
        return self.api_client.call_api('/persist/resources/{id}', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
