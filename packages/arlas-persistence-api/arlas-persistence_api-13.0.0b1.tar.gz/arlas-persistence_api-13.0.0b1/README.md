...
*PersistApi* | [**delete_by_id**](docs/PersistApi.md#delete_by_id) | **DELETE** /persist/resource/{id} | Delete an entry given its key and id.
*PersistApi* | [**get**](docs/PersistApi.md#get) | **GET** /persist/resource/{id} | Fetch an entry given its id.
*PersistApi* | [**get1**](docs/PersistApi.md#get1) | **GET** /persist/resource/{zone}/{key} | Fetch an entry given its zone and key.
...
*PersistApi* | [**update**](docs/PersistApi.md#update) | **PUT** /persist/resource/{id} | Update an existing value.
