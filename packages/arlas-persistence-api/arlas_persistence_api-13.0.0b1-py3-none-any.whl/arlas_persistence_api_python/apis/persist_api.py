...
"""
    ...
    OpenAPI spec version: 13.0.0-beta.1
...
class PersistApi(object):
    ...
    def delete_by_id_with_http_info(self, id, **kwargs):
        ...
        return self.api_client.call_api('/persist/resource/{id}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_with_http_info(self, id, **kwargs):
        ...
        return self.api_client.call_api('/persist/resource/{id}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get1(self, zone, key, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get1(zone, key, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get1_with_http_info(zone, key, **kwargs)
        else:
            (data) = self.get1_with_http_info(zone, key, **kwargs)
            return data

    def get1_with_http_info(self, zone, key, **kwargs):
        """
        Fetch an entry given its zone and key.
        Fetch an entry given its zone and key.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get1_with_http_info(zone, key, callback=callback_function)
        ...
        # verify the required parameter 'zone' is set
        if ('zone' not in params) or (params['zone'] is None):
            raise ValueError("Missing the required parameter `zone` when calling `get1`")
        # verify the required parameter 'key' is set
        if ('key' not in params) or (params['key'] is None):
            raise ValueError("Missing the required parameter `key` when calling `get1`")
    ...
    def update_with_http_info(self, id, value, last_update, **kwargs):
        ...
        return self.api_client.call_api('/persist/resource/{id}', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
