...
------------ | ------------- | ------------- | -------------
*PersistApi* | [**create**](docs/PersistApi.md#create) | **POST** /persist/resources/{zone}/{key} | Store a new piece of data for the provided zone and key (auto generate id).
*PersistApi* | [**delete**](docs/PersistApi.md#delete) | **DELETE** /persist/resources/{zone}/{key} | Delete an entry given its key and id.
*PersistApi* | [**delete_by_id**](docs/PersistApi.md#delete_by_id) | **DELETE** /persist/resources/{id} | Delete an entry given its key and id.
*PersistApi* | [**get**](docs/PersistApi.md#get) | **GET** /persist/resources/{zone}/{key} | Fetch an entry given its zone and key.
...
*PersistApi* | [**update**](docs/PersistApi.md#update) | **PUT** /persist/resources/{id} | Update an existing value.
