...
[boto3.WAFRegional 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/waf-regional.html#WAFRegional) service
...
`mypy_boto3_waf_regional` and other installed services.
...
session_client = boto3.Session().client("waf-regional")
```
