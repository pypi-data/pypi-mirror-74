...
class CfnCodeRepository(
    ...
    def __init__(
        ...
        id: str,
        *,
        git_config: typing.Union["GitConfigProperty", aws_cdk.core.IResolvable],
    ...
    @git_config.setter
    def git_config(
        self, value: typing.Union["GitConfigProperty", aws_cdk.core.IResolvable]
    ) -> None:
    ...
    def __init__(
        ...
        *,
        git_config: typing.Union[
            "CfnCodeRepository.GitConfigProperty", aws_cdk.core.IResolvable
        ],
        code_repository_name: typing.Optional[str] = None,
    ) -> None:
...
class CfnEndpoint(
    ...
    def __init__(
        ...
        *,
        ...
        exclude_retained_variant_properties: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable,
                typing.List[
                    typing.Union[aws_cdk.core.IResolvable, "VariantPropertyProperty"]
                ],
            ]
        ] = None,
        retain_all_variant_properties: typing.Optional[
...
class CfnEndpointConfig(
    ...
    def __init__(
        ...
        id: str,
        *,
        production_variants: typing.Union[
            aws_cdk.core.IResolvable,
            typing.List[
                typing.Union[aws_cdk.core.IResolvable, "ProductionVariantProperty"]
            ],
        ],
...
class CfnEndpointConfigProps:
    ...
    def production_variants(
        ...
        typing.List[
            typing.Union[
                aws_cdk.core.IResolvable, "CfnEndpointConfig.ProductionVariantProperty"
            ]
        ],
    ]:
        """``AWS::SageMaker::EndpointConfig.ProductionVariants``.
        ...
        *,
        ...
        exclude_retained_variant_properties: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        aws_cdk.core.IResolvable, "CfnEndpoint.VariantPropertyProperty"
                    ]
                ],
            ]
        ] = None,
...
class CfnModel(
    ...
    def __init__(
        ...
        *,
        ...
        primary_container: typing.Optional[
...
class CfnModelProps:
        ...
        *,
        ...
        containers: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        aws_cdk.core.IResolvable, "CfnModel.ContainerDefinitionProperty"
                    ]
                ],
            ]
        ] = None,
        ...
        tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]] = None,
        vpc_config: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "CfnModel.VpcConfigProperty"]
        ] = None,
    ) -> None:
    ...
    def primary_container(
        ...
        typing.Union[aws_cdk.core.IResolvable, "CfnModel.ContainerDefinitionProperty"]
    ]:
        """``AWS::SageMaker::Model.PrimaryContainer``.
...
class CfnNotebookInstanceLifecycleConfig(
    ...
    def on_create(
        ...
        typing.Union[
            ...
            typing.List[
                typing.Union[
                    aws_cdk.core.IResolvable, "NotebookInstanceLifecycleHookProperty"
                ]
            ],
        ]
    ]:
...
class CfnWorkteam(
    ...
    def __init__(
        ...
        *,
        ...
        member_definitions: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable,
                typing.List[
                    typing.Union[aws_cdk.core.IResolvable, "MemberDefinitionProperty"]
                ],
            ]
        ] = None,
        notification_configuration: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "NotificationConfigurationProperty"]
        ] = None,
        tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]] = None,
    ...
    class MemberDefinitionProperty:
        def __init__(
            self,
            *,
            cognito_member_definition: typing.Union[
                aws_cdk.core.IResolvable, "CfnWorkteam.CognitoMemberDefinitionProperty"
            ],
        ) -> None:
            """
...
class CfnWorkteamProps:
        ...
        *,
        ...
        member_definitions: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        aws_cdk.core.IResolvable, "CfnWorkteam.MemberDefinitionProperty"
                    ]
                ],
            ]
        ] = None,
    ...
    def notification_configuration(
        ...
        typing.Union[
            aws_cdk.core.IResolvable, "CfnWorkteam.NotificationConfigurationProperty"
        ]
    ]:
        """``AWS::SageMaker::Workteam.NotificationConfiguration``.
