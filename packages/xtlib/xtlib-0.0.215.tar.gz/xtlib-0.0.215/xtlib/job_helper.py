...
def get_job_backend(store, core, job_id):
    ...
    job_info = get_job_record(store, job_id, {"pool_info": 1, "service_info_by_node": 1, "username": 1})
...
def get_service_node_info(store, core, job_id, node_index):
    
    backend, job_info = get_job_backend(store, core, job_id)
