...
class ImplCompute(ImplBase):
    ...
    def send_user_request(self, request, job_id, node_index):
        rd = None
    ...
    def monitor_job_node(self, job_id, jupyter, sleep, node_index, log_name, escape):
            ...
            with KeyPressChecker() as checker:
                ...
                while simple_status != "completed":
                    ...
                    if ch in request_dict:
                        ...
                        self.send_user_request(request, job_id, node_index)
        ...
        console.print("end of monitoring: {}".format(job_id))
    ...
    @hidden("log-reports", default="$logging.log-reports", help="specifies if CPU, GPU, and MEMORY reports should be included in setup log")
