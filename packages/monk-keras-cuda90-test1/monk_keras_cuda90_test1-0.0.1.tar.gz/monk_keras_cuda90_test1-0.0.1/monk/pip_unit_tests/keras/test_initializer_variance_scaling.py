...
def test_initializer_variance_scaling(system_dict):
    forward = True;

    test = "test_initializer_variance_scaling";
    ...
    if(forward):
        try:
            ...
            gtf.Compile_Network(network, data_shape=(3, 32, 32), network_initializer="variance_scaling");
