...
"""
from pinpong.pinpong import gboard
...
class SSD1306(object):
    ...
    def text(self, string='Hello World!', x=20, y=22, col=1):
        self.framebuf.text(string, x, y, col)


class SSD1306_I2C(SSD1306):
  def __init__(self, board=None, width=128, height=64, bus_num=0, addr=0x3C, external_vcc=False):
    ...
    self.board = board
    self.i2c = board.get_i2c_master(bus_num)
    self.addr = addr
    self.temp = [0x80, 0]
