...
def process_txt_init():
    words = ["ไทยออยล์","โควิด","โควิด19","โควิด-19","D/E","P/E","ออน์ไลน์","set50","set100",
             ...
             "กำไรพิเศษ","รีบาวด์","รีบาวนด์","สว่างหลังฝน","ฟ้าหลังฝน","ซีซั่น","ซีซัน","นกสกู๊ต",
             "วอลลุ่ม","ไตรมาส","ไตรมาศ","เชงเก้น","อีอีซี","ททท","ซินฟาตี้",
             "กองทุนการเงินระหว่างประเทศ","เวอร์จิน","อิควิตี้","รมต","แม็คโคร"]
