...
import datetime
from fzdata import client
from fzdata import upass
import pandas as pd
...
#     upass.set_token('')
    pro = pro_api()
#     print(pro_bar(ts_code='000001.SZ', api=pro, start_date='20180101', endupass='20181101', factors=['tor', 'vr']))
#     print(pro_bar(ts_code='000001.SH', api=pro, start_date='20180101', end_date='20181011', asset='I', freq='60min'))
...
#     print(pro_bar(api=pro, ts_code='000528.SZ',start_date='20180101', end_date='20181121', ma=[20]))
    df = pro_bar(ts_code='000002.SH', freq='1min', asset='E', start_date='2019-10-17 00:00:00', end_date='2019-10-18 10:00:00')
#     df = pro_bar(ts_code='000001.SZ', freq='1min', asset='e', start_date='20190131', end_date='20190413')
#     df = pro_bar(ts_code='000001.SZ', start_date='20190415', end_date='20190416', asset='E', factors=['tor', 'vr'])
#     df = pro_bar(ts_code='RB2001.SHF', asset='FT', freq='1min', start_date='20190925', end_date='20191001', offset=10, limit=100)
...
#     df = pro_bar(ts_code='601888.SH', adj='qfq', freq='D')
#     df = pro_bar(api=pro, ts_code='300527.SZ', start_date='20190702', end_date='', adj='qfq')
#     df = pro_bar(ts_code='300671.SZ', factors=['tor'])
#     df = pro_bar(ts_code='000001.SZ',  start_date='20190101', end_date='2019301', ma=['5, 20, 50'])
    print(df)
