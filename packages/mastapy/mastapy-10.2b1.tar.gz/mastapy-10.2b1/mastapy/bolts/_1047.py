...
from mastapy.bolts import _1038
...
class ClampedSection(_0.APIBase):
    ...
    @property
    def material(self) -> '_1038.BoltedJointMaterial':
        ...
        return constructor.new(_1038.BoltedJointMaterial)(self.wrapped.Material) if self.wrapped.Material else None
