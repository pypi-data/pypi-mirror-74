...
from mastapy.gears.gear_designs.conical import _905, _893
...
class KlingelnbergConicalGearSetDesign(_893.ConicalGearSetDesign):
    '''KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_905.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_905.KlingelnbergFinishingMethods)(value) if value else None

    @gear_finish.setter
    def gear_finish(self, value: '_905.KlingelnbergFinishingMethods'):
    ...
    @property
    def conical_meshes(self) -> 'List[_748.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_748.KlingelnbergConicalGearMeshDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_748.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_748.KlingelnbergConicalGearMeshDesign))
        return value
