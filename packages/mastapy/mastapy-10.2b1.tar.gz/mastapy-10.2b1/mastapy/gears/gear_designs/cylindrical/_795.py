...
from mastapy.gears.gear_designs.cylindrical import _835, _765
...
class CylindricalMeshLinearBacklashSpecification(_835.TolerancedValueSpecification['_765.BacklashSpecification']):
    '''CylindricalMeshLinearBacklashSpecification
