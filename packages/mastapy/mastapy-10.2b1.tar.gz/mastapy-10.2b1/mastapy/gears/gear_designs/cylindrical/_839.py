...
from mastapy.gears import _147
...
class Usage(_1139.IndependentReportablePropertiesBase['Usage']):
    '''Usage
    ...
    @property
    def safety_requirement(self) -> '_147.SafetyRequirementsAGMA':
    ...
    def safety_requirement(self, value: '_147.SafetyRequirementsAGMA'):
