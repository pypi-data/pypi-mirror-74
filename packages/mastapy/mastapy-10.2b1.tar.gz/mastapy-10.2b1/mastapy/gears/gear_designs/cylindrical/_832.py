...
from mastapy.gears.gear_designs.cylindrical import _807
...
class TiffAnalysisSettings(_1139.IndependentReportablePropertiesBase['TiffAnalysisSettings']):
    '''TiffAnalysisSettings
    ...
    @property
    def surface_material_properties(self) -> '_807.HardenedMaterialProperties':
        ...
        return constructor.new(_807.HardenedMaterialProperties)(self.wrapped.SurfaceMaterialProperties) if self.wrapped.SurfaceMaterialProperties else None

    @property
    def core_material_properties(self) -> '_807.HardenedMaterialProperties':
        ...
        return constructor.new(_807.HardenedMaterialProperties)(self.wrapped.CoreMaterialProperties) if self.wrapped.CoreMaterialProperties else None
