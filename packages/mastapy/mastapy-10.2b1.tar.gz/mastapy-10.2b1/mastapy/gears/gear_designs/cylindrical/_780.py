...
from mastapy.gears.gear_designs.cylindrical import _778
...
class CylindricalGearDesignConstraintSettings(_1144.PerMachineSettings):
    '''CylindricalGearDesignConstraintSettings
    ...
    @property
    def cylindrical_gear_design_constraints(self) -> '_778.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_778.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints else None
