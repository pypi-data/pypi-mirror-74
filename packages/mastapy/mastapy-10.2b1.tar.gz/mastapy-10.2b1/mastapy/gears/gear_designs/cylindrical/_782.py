...
from mastapy.gears import _137, _120
from mastapy.math_utility.measured_ranges import _1125
...
class CylindricalGearMeshDesign(_715.GearMeshDesign):
    '''CylindricalGearMeshDesign
    ...
    def profile_modification(self, value: '_786.CylindricalGearProfileModifications'):
    ...
    @property
    def type_of_mechanism_housing(self) -> '_838.TypeOfMechanismHousing':
        ...
        return constructor.new(_838.TypeOfMechanismHousing)(value) if value else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_838.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def centre_distance_change_method(self) -> '_120.CentreDistanceChangeMethod':
        ...
        return constructor.new(_120.CentreDistanceChangeMethod)(value) if value else None

    @centre_distance_change_method.setter
    def centre_distance_change_method(self, value: '_120.CentreDistanceChangeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def backlash_specification(self) -> '_765.BacklashSpecification':
        ...
        return constructor.new(_765.BacklashSpecification)(self.wrapped.BacklashSpecification) if self.wrapped.BacklashSpecification else None

    @property
    def valid_normal_module_range(self) -> '_1125.ShortLengthRange':
        ...
        return constructor.new(_1125.ShortLengthRange)(self.wrapped.ValidNormalModuleRange) if self.wrapped.ValidNormalModuleRange else None
    ...
    @property
    def cylindrical_meshed_gear(self) -> 'List[_794.CylindricalMeshedGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGear, constructor.new(_794.CylindricalMeshedGear))
        return value

    @property
    def gear_a(self) -> '_776.CylindricalGearDesign':
    ...
    @property
    def gear_b(self) -> '_776.CylindricalGearDesign':
