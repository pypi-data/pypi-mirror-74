...
from mastapy.gears.gear_designs.cylindrical import _776, _784
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _844, _864
...
class CylindricalGearMicroGeometry(_955.GearImplementationDetail):
    '''CylindricalGearMicroGeometry
    ...
    @property
    def left_flank(self) -> '_844.CylindricalGearFlankMicroGeometry':
        ...
        return constructor.new(_844.CylindricalGearFlankMicroGeometry)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_844.CylindricalGearFlankMicroGeometry':
        ...
        return constructor.new(_844.CylindricalGearFlankMicroGeometry)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def profile_control_point(self) -> '_784.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_784.CylindricalGearProfileMeasurement)(self.wrapped.ProfileControlPoint) if self.wrapped.ProfileControlPoint else None

    @property
    def flanks(self) -> 'List[_844.CylindricalGearFlankMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_844.CylindricalGearFlankMicroGeometry))
        return value

    @property
    def meshed_gears(self) -> 'List[_864.MeshedCylindricalGearMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_864.MeshedCylindricalGearMicroGeometry))
        return value
