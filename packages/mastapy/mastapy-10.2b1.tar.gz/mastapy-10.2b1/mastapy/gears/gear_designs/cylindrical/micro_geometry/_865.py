...
class MicroGeometryViewingOptions(_0.APIBase):
    ...
    @property
    def gear_option(self) -> '_856.DrawDefiningGearOrBoth':
        ...
        return constructor.new(_856.DrawDefiningGearOrBoth)(value) if value else None

    @gear_option.setter
    def gear_option(self, value: '_856.DrawDefiningGearOrBoth'):
