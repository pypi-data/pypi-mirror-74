...
class CylindricalGearSetDesign(_716.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_764.AddendumModificationDistributionRule':
        ...
        return constructor.new(_764.AddendumModificationDistributionRule)(value) if value else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_764.AddendumModificationDistributionRule'):
    ...
    @property
    def helical_gear_micro_geometry_option(self) -> '_303.HelicalGearMicroGeometryOption':
        ...
        return constructor.new(_303.HelicalGearMicroGeometryOption)(value) if value else None

    @helical_gear_micro_geometry_option.setter
    def helical_gear_micro_geometry_option(self, value: '_303.HelicalGearMicroGeometryOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HelicalGearMicroGeometryOption = value

    @property
    def gear_fit_system(self) -> '_802.GearFitSystems':
        ...
        return constructor.new(_802.GearFitSystems)(value) if value else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_802.GearFitSystems'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def scuffing(self) -> '_823.Scuffing':
        ...
        return constructor.new(_823.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing else None

    @property
    def micropitting(self) -> '_818.Micropitting':
        ...
        return constructor.new(_818.Micropitting)(self.wrapped.Micropitting) if self.wrapped.Micropitting else None

    @property
    def usage(self) -> '_839.Usage':
        ...
        return constructor.new(_839.Usage)(self.wrapped.Usage) if self.wrapped.Usage else None

    @property
    def ltca_settings(self) -> '_815.LtcaSettings':
        ...
        return constructor.new(_815.LtcaSettings)(self.wrapped.LTCASettings) if self.wrapped.LTCASettings else None

    @property
    def cylindrical_gear_set_manufacturing_configuration(self) -> '_410.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_410.CylindricalSetManufacturingConfig)(self.wrapped.CylindricalGearSetManufacturingConfiguration) if self.wrapped.CylindricalGearSetManufacturingConfiguration else None

    @property
    def gears(self) -> 'List[_776.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_776.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_776.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_776.CylindricalGearDesign))
        return value
    ...
    def create_optimiser(self, duty_cycle: '_263.CylindricalGearSetDutyCycleRating') -> '_788.CylindricalGearSetMacroGeometryOptimiser':
        ...
        return constructor.new(_788.CylindricalGearSetMacroGeometryOptimiser)(method_result) if method_result else None
