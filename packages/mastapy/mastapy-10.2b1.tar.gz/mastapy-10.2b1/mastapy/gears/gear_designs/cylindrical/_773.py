...
class CylindricalGearBasicRack(_772.CylindricalGearAbstractRack):
    '''CylindricalGearBasicRack
    ...
    @property
    def basic_rack_profile(self) -> '_766.BasicRackProfiles':
        ...
        return constructor.new(_766.BasicRackProfiles)(value) if value else None

    @basic_rack_profile.setter
    def basic_rack_profile(self, value: '_766.BasicRackProfiles'):
    ...
    @property
    def proportional_method_for_tip_clearance(self) -> '_833.TipAlterationCoefficientMethod':
        ...
        return constructor.new(_833.TipAlterationCoefficientMethod)(value) if value else None

    @proportional_method_for_tip_clearance.setter
    def proportional_method_for_tip_clearance(self, value: '_833.TipAlterationCoefficientMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def pinion_type_cutter_for_rating(self) -> '_783.CylindricalGearPinionTypeCutter':
        ...
        return constructor.new(_783.CylindricalGearPinionTypeCutter)(self.wrapped.PinionTypeCutterForRating) if self.wrapped.PinionTypeCutterForRating else None
