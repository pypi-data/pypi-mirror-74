...
class GearSetFCAImportSetup(_0.APIBase):
    '''GearSetFCAImportSetup
    ...
    @property
    def meshes(self) -> 'List[_782.CylindricalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_782.CylindricalGearMeshDesign))
        return value
