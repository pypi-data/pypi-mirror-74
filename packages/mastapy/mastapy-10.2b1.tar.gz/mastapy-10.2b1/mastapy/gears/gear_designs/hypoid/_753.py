...
from mastapy.gears.gear_designs.hypoid import _751, _752
...
class HypoidGearSetDesign(_932.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_751.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_751.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_751.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_751.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_752.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_752.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_752.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_752.HypoidGearMeshDesign))
        return value
