...
from mastapy.gears.gear_designs.bevel import _922, _917
...
class StraightBevelDiffGearDesign(_917.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_922.EdgeRadiusType':
        ...
        return constructor.new(_922.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_922.EdgeRadiusType'):
