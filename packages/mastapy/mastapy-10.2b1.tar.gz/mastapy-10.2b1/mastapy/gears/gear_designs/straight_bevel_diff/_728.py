...
from mastapy.gears.gear_designs.straight_bevel_diff import _729, _727, _730
...
class StraightBevelDiffGearMeshDesign(_918.BevelGearMeshDesign):
    '''StraightBevelDiffGearMeshDesign
    ...
    @property
    def straight_bevel_diff_meshed_gears(self) -> 'List[_730.StraightBevelDiffMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshedGears, constructor.new(_730.StraightBevelDiffMeshedGearDesign))
        return value
