...
from mastapy.gears.gear_designs.zerol_bevel import _720, _718, _721
...
class ZerolBevelGearMeshDesign(_918.BevelGearMeshDesign):
    '''ZerolBevelGearMeshDesign
    ...
    @property
    def zerol_bevel_meshed_gears(self) -> 'List[_721.ZerolBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshedGears, constructor.new(_721.ZerolBevelMeshedGearDesign))
        return value
