...
from mastapy.gears.gear_designs.cylindrical import _830
...
class ConicalGearDesign(_713.GearDesign):
    '''ConicalGearDesign
    ...
    @property
    def flank_measurement_border(self) -> '_581.FlankMeasurementBorder':
        ...
        return constructor.new(_581.FlankMeasurementBorder)(self.wrapped.FlankMeasurementBorder) if self.wrapped.FlankMeasurementBorder else None
