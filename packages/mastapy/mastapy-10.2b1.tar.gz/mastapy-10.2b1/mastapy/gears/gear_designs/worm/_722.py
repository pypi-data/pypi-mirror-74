...
from mastapy.gears import _152
...
class WormDesign(_723.WormGearDesign):
    '''WormDesign
    ...
    @property
    def addendum_factor(self) -> '_152.WormAddendumFactor':
        ...
        return constructor.new(_152.WormAddendumFactor)(value) if value else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_152.WormAddendumFactor'):
