...
class WormGearMeshDesign(_715.GearMeshDesign):
    '''WormGearMeshDesign
    ...
    def worm(self) -> '_722.WormDesign':
        ...
        return constructor.new(_722.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm else None

    @property
    def wheel(self) -> '_726.WormWheelDesign':
        ...
        return constructor.new(_726.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel else None
