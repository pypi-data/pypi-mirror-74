...
from mastapy.gears.gear_designs.face import _756, _755
...
class FaceGearWheelDesign(_755.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_756.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_756.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_756.FaceGearDiameterFaceWidthSpecificationMethod'):
