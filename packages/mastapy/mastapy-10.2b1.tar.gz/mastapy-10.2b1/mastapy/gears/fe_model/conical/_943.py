...
from mastapy.nodal_analysis import _1373
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.gears.fe_model.conical import _944
...
class ConicalSetFEModel(_937.GearSetFEModel):
    '''ConicalSetFEModel
    ...
    @property
    def flank_data_source(self) -> '_944.FlankDataSource':
        ...
        return constructor.new(_944.FlankDataSource)(value) if value else None

    @flank_data_source.setter
    def flank_data_source(self, value: '_944.FlankDataSource'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
