...
from mastapy.gears.cylindrical import _946, _945
...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def contact_charts(self) -> '_946.CylindricalGearLTCAContactCharts':
        ...
        return constructor.new(_946.CylindricalGearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_945.CylindricalGearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_945.CylindricalGearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None

    def contact_patch_detailed(self, result_type: '_610.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int') -> '_1080.GriddedSurface':
        ...
        return constructor.new(_1080.GriddedSurface)(method_result) if method_result else None

    def contact_patch(self, result_type: '_610.ContactResultType', include_tip_contact: 'bool') -> '_1080.GriddedSurface':
        ''' 'ContactPatch' is the original name of this method.
    ...
    def contact_patch_as_text(self, result_type: '_610.ContactResultType', include_tip_contact: 'bool', file_name_with_path: 'str'):
