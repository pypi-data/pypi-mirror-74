...
from mastapy.gears.rating.cylindrical.iso6336 import _307, _312, _311
...
class ISO6336AbstractMetalMeshSingleFlankRating(_311.ISO6336AbstractMeshSingleFlankRating):
    '''ISO6336AbstractMetalMeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_826.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_826.ScuffingTemperatureMethodsISO)(value) if value else None
    ...
    @property
    def sorted_micro_pitting_results(self) -> '_258.CylindricalGearMicroPittingResults':
        ...
        return constructor.new(_258.CylindricalGearMicroPittingResults)(self.wrapped.SortedMicroPittingResults) if self.wrapped.SortedMicroPittingResults else None

    @property
    def single_flank_rating_of_test_gears_for_micropitting(self) -> '_307.ISO63362006MeshSingleFlankRating':
        ...
        return constructor.new(_307.ISO63362006MeshSingleFlankRating)(self.wrapped.SingleFlankRatingOfTestGearsForMicropitting) if self.wrapped.SingleFlankRatingOfTestGearsForMicropitting else None

    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_312.ISO6336AbstractMetalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_312.ISO6336AbstractMetalGearSingleFlankRating))
        return value
