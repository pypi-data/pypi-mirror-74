...
class CylindricalGearSetRatingOptimisationHelper(_0.APIBase):
    ...
    @property
    def profile_shift_coefficient_optimisation_results(self) -> '_296.OptimisationResultsPair[_300.SafetyFactorOptimisationStepResultNumber]':
        ...
        return constructor.new(_296.OptimisationResultsPair)[_300.SafetyFactorOptimisationStepResultNumber](self.wrapped.ProfileShiftCoefficientOptimisationResults) if self.wrapped.ProfileShiftCoefficientOptimisationResults else None

    @property
    def helix_angle_optimisation_results(self) -> '_296.OptimisationResultsPair[_299.SafetyFactorOptimisationStepResultAngle]':
        ...
        return constructor.new(_296.OptimisationResultsPair)[_299.SafetyFactorOptimisationStepResultAngle](self.wrapped.HelixAngleOptimisationResults) if self.wrapped.HelixAngleOptimisationResults else None

    @property
    def normal_module_optimisation_results(self) -> '_296.OptimisationResultsPair[_301.SafetyFactorOptimisationStepResultShortLength]':
        ...
        return constructor.new(_296.OptimisationResultsPair)[_301.SafetyFactorOptimisationStepResultShortLength](self.wrapped.NormalModuleOptimisationResults) if self.wrapped.NormalModuleOptimisationResults else None

    @property
    def pressure_angle_optimisation_results(self) -> '_296.OptimisationResultsPair[_299.SafetyFactorOptimisationStepResultAngle]':
        ...
        return constructor.new(_296.OptimisationResultsPair)[_299.SafetyFactorOptimisationStepResultAngle](self.wrapped.PressureAngleOptimisationResults) if self.wrapped.PressureAngleOptimisationResults else None

    @property
    def all_normal_module_optimisation_results(self) -> 'List[_297.SafetyFactorOptimisationResults[_301.SafetyFactorOptimisationStepResultShortLength]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllNormalModuleOptimisationResults, constructor.new(_297.SafetyFactorOptimisationResults)[_301.SafetyFactorOptimisationStepResultShortLength])
        return value

    @property
    def all_helix_angle_optimisation_results(self) -> 'List[_297.SafetyFactorOptimisationResults[_299.SafetyFactorOptimisationStepResultAngle]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllHelixAngleOptimisationResults, constructor.new(_297.SafetyFactorOptimisationResults)[_299.SafetyFactorOptimisationStepResultAngle])
        return value

    @property
    def all_normal_pressure_angle_optimisation_results(self) -> 'List[_297.SafetyFactorOptimisationResults[_299.SafetyFactorOptimisationStepResultAngle]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllNormalPressureAngleOptimisationResults, constructor.new(_297.SafetyFactorOptimisationResults)[_299.SafetyFactorOptimisationStepResultAngle])
        return value

    @property
    def helix_angle_and_normal_pressure_angle_optimisation_results(self) -> 'List[_297.SafetyFactorOptimisationResults[_299.SafetyFactorOptimisationStepResultAngle]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HelixAngleAndNormalPressureAngleOptimisationResults, constructor.new(_297.SafetyFactorOptimisationResults)[_299.SafetyFactorOptimisationStepResultAngle])
        return value

    @property
    def all_profile_shift_optimisation_results(self) -> 'List[_297.SafetyFactorOptimisationResults[_300.SafetyFactorOptimisationStepResultNumber]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllProfileShiftOptimisationResults, constructor.new(_297.SafetyFactorOptimisationResults)[_300.SafetyFactorOptimisationStepResultNumber])
        return value
