...
from mastapy.gears.rating.cylindrical import _279
...
class ScuffingResultsRow(_0.APIBase):
    ...
    @property
    def pinion(self) -> '_279.ScuffingResultsRowGear':
        ...
        return constructor.new(_279.ScuffingResultsRowGear)(self.wrapped.Pinion) if self.wrapped.Pinion else None
