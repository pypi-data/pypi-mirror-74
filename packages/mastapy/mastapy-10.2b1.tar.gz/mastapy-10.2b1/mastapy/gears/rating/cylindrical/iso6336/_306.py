...
from mastapy.gears.rating.cylindrical.iso6336 import _302, _312
...
class ISO63362006GearSingleFlankRating(_312.ISO6336AbstractMetalGearSingleFlankRating):
    '''ISO63362006GearSingleFlankRating
    ...
    @property
    def tooth_fatigue_fracture_results(self) -> '_302.CylindricalGearToothFatigueFractureResults':
        ...
        return constructor.new(_302.CylindricalGearToothFatigueFractureResults)(self.wrapped.ToothFatigueFractureResults) if self.wrapped.ToothFatigueFractureResults else None
