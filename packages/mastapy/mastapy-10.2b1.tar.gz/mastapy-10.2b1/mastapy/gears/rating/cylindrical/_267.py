...
from mastapy.gears import _123
from mastapy.gears.gear_designs.cylindrical import _824, _823
from mastapy.materials import _74
from mastapy.gears.rating.cylindrical import _262, _261, _265
...
class CylindricalMeshSingleFlankRating(_168.MeshSingleFlankRating):
    '''CylindricalMeshSingleFlankRating
    ...
    @property
    def contact_ratio_source(self) -> '_123.ContactRatioDataSource':
        ...
        return constructor.new(_123.ContactRatioDataSource)(value) if value else None
    ...
    @property
    def coefficient_of_friction_method_flash_temperature_method(self) -> '_824.ScuffingCoefficientOfFrictionMethods':
        ...
        return constructor.new(_824.ScuffingCoefficientOfFrictionMethods)(value) if value else None
    ...
    @property
    def lubrication_detail(self) -> '_74.LubricationDetail':
        ...
        return constructor.new(_74.LubricationDetail)(self.wrapped.LubricationDetail) if self.wrapped.LubricationDetail else None

    @property
    def sorted_scuffing_results(self) -> '_262.CylindricalGearScuffingResults':
        ...
        return constructor.new(_262.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResults) if self.wrapped.SortedScuffingResults else None

    @property
    def sorted_scuffing_results_without_special_values(self) -> '_262.CylindricalGearScuffingResults':
        ...
        return constructor.new(_262.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResultsWithoutSpecialValues) if self.wrapped.SortedScuffingResultsWithoutSpecialValues else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_265.CylindricalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_265.CylindricalGearSingleFlankRating))
        return value
