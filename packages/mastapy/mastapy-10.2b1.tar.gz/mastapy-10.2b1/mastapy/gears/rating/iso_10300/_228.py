...
class ISO10300MeshSingleFlankRatingMethodB2(_224.ISO10300MeshSingleFlankRating['_193.VirtualCylindricalGearISO10300MethodB2']):
    '''ISO10300MeshSingleFlankRatingMethodB2
    ...
    @property
    def ysub_isub_for_bevel_and_zerol_bevel_gear(self) -> 'float':
        '''float: 'YsubIsubForBevelAndZerolBevelGear' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.YsubIsubForBevelAndZerolBevelGear
    ...
    @property
    def ysub_isub_for_hypoid_gear(self) -> 'float':
        '''float: 'YsubIsubForHypoidGear' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.YsubIsubForHypoidGear

    @property
    def ysub_isub(self) -> 'float':
        '''float: 'YsubIsub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.YsubIsub
    ...
    @property
    def virtual_cylindrical_gear_set_method_b2(self) -> '_196.VirtualCylindricalGearSetISO10300MethodB2':
        ...
        return constructor.new(_196.VirtualCylindricalGearSetISO10300MethodB2)(self.wrapped.VirtualCylindricalGearSetMethodB2) if self.wrapped.VirtualCylindricalGearSetMethodB2 else None

    @property
    def virtual_cylindrical_gear_set_method_b2_of_type_bevel_virtual_cylindrical_gear_set_iso10300_method_b2(self) -> '_182.BevelVirtualCylindricalGearSetISO10300MethodB2':
        ...
        if _182.BevelVirtualCylindricalGearSetISO10300MethodB2.TYPE not in self.wrapped.VirtualCylindricalGearSetMethodB2.__class__.__mro__:
        ...
        return constructor.new(_182.BevelVirtualCylindricalGearSetISO10300MethodB2)(self.wrapped.VirtualCylindricalGearSetMethodB2) if self.wrapped.VirtualCylindricalGearSetMethodB2 else None

    @property
    def virtual_cylindrical_gear_set_method_b2_of_type_hypoid_virtual_cylindrical_gear_set_iso10300_method_b2(self) -> '_185.HypoidVirtualCylindricalGearSetISO10300MethodB2':
        ...
        if _185.HypoidVirtualCylindricalGearSetISO10300MethodB2.TYPE not in self.wrapped.VirtualCylindricalGearSetMethodB2.__class__.__mro__:
        ...
        return constructor.new(_185.HypoidVirtualCylindricalGearSetISO10300MethodB2)(self.wrapped.VirtualCylindricalGearSetMethodB2) if self.wrapped.VirtualCylindricalGearSetMethodB2 else None
