...
from mastapy.gears.rating.iso_10300 import _231
...
class ISO10300SingleFlankRatingMethodB1(_231.ISO10300SingleFlankRating['_192.VirtualCylindricalGearISO10300MethodB1']):
    '''ISO10300SingleFlankRatingMethodB1
    ...
    @property
    def auxiliary_quantities_for_drive_side(self) -> 'float':
        '''float: 'AuxiliaryQuantitiesForDriveSide' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.AuxiliaryQuantitiesForDriveSide

    @property
    def auxiliary_quantities_for_coast_side(self) -> 'float':
        '''float: 'AuxiliaryQuantitiesForCoastSide' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.AuxiliaryQuantitiesForCoastSide
    ...
    @property
    def lsubasub(self) -> 'float':
        '''float: 'Lsubasub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.Lsubasub
    ...
    @property
    def relative_surface_condition_factor_for_through_hardened_and_case_hardened_steels_mean_roughness_1m(self) -> 'float':
        '''float: 'RelativeSurfaceConditionFactorForThroughHardenedAndCaseHardenedSteelsMeanRoughness1m' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.RelativeSurfaceConditionFactorForThroughHardenedAndCaseHardenedSteelsMeanRoughness1m

    @property
    def relative_surface_condition_factor_for_non_hardened_steels_mean_roughness_1m(self) -> 'float':
        '''float: 'RelativeSurfaceConditionFactorForNonHardenedSteelsMeanRoughness1m' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.RelativeSurfaceConditionFactorForNonHardenedSteelsMeanRoughness1m

    @property
    def relative_surface_condition_factor_for_grey_cast_iron_nitrided_and_nitro_carburized_steels_mean_roughness_1m(self) -> 'float':
        '''float: 'RelativeSurfaceConditionFactorForGreyCastIronNitridedAndNitroCarburizedSteelsMeanRoughness1m' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.RelativeSurfaceConditionFactorForGreyCastIronNitridedAndNitroCarburizedSteelsMeanRoughness1m

    @property
    def relative_surface_condition_factor_for_through_hardened_and_case_hardened_steels_1m_mean_roughness_4_0m(self) -> 'float':
        '''float: 'RelativeSurfaceConditionFactorForThroughHardenedAndCaseHardenedSteels1mMeanRoughness40m' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.RelativeSurfaceConditionFactorForThroughHardenedAndCaseHardenedSteels1mMeanRoughness40m

    @property
    def relative_surface_condition_factor_for_non_hardened_steels_1m_mean_roughness_4_0m(self) -> 'float':
        '''float: 'RelativeSurfaceConditionFactorForNonHardenedSteels1mMeanRoughness40m' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.RelativeSurfaceConditionFactorForNonHardenedSteels1mMeanRoughness40m

    @property
    def relative_surface_condition_factor_for_grey_cast_iron_nitrided_and_nitro_carburized_steels_1m_mean_roughness_4_0m(self) -> 'float':
        '''float: 'RelativeSurfaceConditionFactorForGreyCastIronNitridedAndNitroCarburizedSteels1mMeanRoughness40m' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.RelativeSurfaceConditionFactorForGreyCastIronNitridedAndNitroCarburizedSteels1mMeanRoughness40m
