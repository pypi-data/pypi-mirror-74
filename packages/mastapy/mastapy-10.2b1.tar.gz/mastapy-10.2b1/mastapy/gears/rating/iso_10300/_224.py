...
from mastapy.gears.rating.conical import _332
from mastapy.gears.rating.virtual_cylindrical_gears import _191
...
T = TypeVar('T', bound='_191.VirtualCylindricalGearBasic')


class ISO10300MeshSingleFlankRating(_332.ConicalMeshSingleFlankRating, Generic[T]):
    '''ISO10300MeshSingleFlankRating
    ...
    @property
    def factor_for_calculating_the_dynamic_factor_ksub_v_bsub(self) -> 'float':
        '''float: 'FactorForCalculatingTheDynamicFactorKsubVBsub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.FactorForCalculatingTheDynamicFactorKsubVBsub
    ...
    @property
    def auxiliary_factor_a_for_calculating_the_dynamic_factor_ksub_v_csub(self) -> 'float':
        '''float: 'AuxiliaryFactorAForCalculatingTheDynamicFactorKsubVCsub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.AuxiliaryFactorAForCalculatingTheDynamicFactorKsubVCsub

    @property
    def auxiliary_factor_x_for_calculating_the_dynamic_factor_ksub_v_csub(self) -> 'float':
        '''float: 'AuxiliaryFactorXForCalculatingTheDynamicFactorKsubVCsub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.AuxiliaryFactorXForCalculatingTheDynamicFactorKsubVCsub
    ...
    @property
    def sub_1sub(self) -> 'float':
        '''float: 'Sub1sub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.Sub1sub
