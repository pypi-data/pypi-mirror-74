...
from mastapy.gears.rating.iso_10300 import _224
...
class ISO10300MeshSingleFlankRatingMethodB1(_224.ISO10300MeshSingleFlankRating['_192.VirtualCylindricalGearISO10300MethodB1']):
    '''ISO10300MeshSingleFlankRatingMethodB1
    ...
    @property
    def auxiliary_value_asub_b_ssub(self) -> 'float':
        '''float: 'AuxiliaryValueAsubBSsub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.AuxiliaryValueAsubBSsub

    @property
    def auxiliary_value_bsub_b_ssub(self) -> 'float':
        '''float: 'AuxiliaryValueBsubBSsub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.AuxiliaryValueBsubBSsub

    @property
    def auxiliary_value_csub_b_ssub(self) -> 'float':
        '''float: 'AuxiliaryValueCsubBSsub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.AuxiliaryValueCsubBSsub
    ...
    @property
    def virtual_cylindrical_gear_set_method_b1(self) -> '_195.VirtualCylindricalGearSetISO10300MethodB1':
        ...
        return constructor.new(_195.VirtualCylindricalGearSetISO10300MethodB1)(self.wrapped.VirtualCylindricalGearSetMethodB1) if self.wrapped.VirtualCylindricalGearSetMethodB1 else None

    @property
    def virtual_cylindrical_gear_set_method_b1_of_type_bevel_virtual_cylindrical_gear_set_iso10300_method_b1(self) -> '_181.BevelVirtualCylindricalGearSetISO10300MethodB1':
        ...
        if _181.BevelVirtualCylindricalGearSetISO10300MethodB1.TYPE not in self.wrapped.VirtualCylindricalGearSetMethodB1.__class__.__mro__:
        ...
        return constructor.new(_181.BevelVirtualCylindricalGearSetISO10300MethodB1)(self.wrapped.VirtualCylindricalGearSetMethodB1) if self.wrapped.VirtualCylindricalGearSetMethodB1 else None

    @property
    def virtual_cylindrical_gear_set_method_b1_of_type_hypoid_virtual_cylindrical_gear_set_iso10300_method_b1(self) -> '_184.HypoidVirtualCylindricalGearSetISO10300MethodB1':
        ...
        if _184.HypoidVirtualCylindricalGearSetISO10300MethodB1.TYPE not in self.wrapped.VirtualCylindricalGearSetMethodB1.__class__.__mro__:
        ...
        return constructor.new(_184.HypoidVirtualCylindricalGearSetISO10300MethodB1)(self.wrapped.VirtualCylindricalGearSetMethodB1) if self.wrapped.VirtualCylindricalGearSetMethodB1 else None
