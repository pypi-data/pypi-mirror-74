...
from mastapy.gears.rating import _156, _155
...
class AbstractGearSetRating(_951.AbstractGearSetAnalysis):
    '''AbstractGearSetRating
    ...
    @property
    def gear_ratings(self) -> 'List[_156.AbstractGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_156.AbstractGearRating))
        return value

    @property
    def gear_mesh_ratings(self) -> 'List[_155.AbstractGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshRatings, constructor.new(_155.AbstractGearMeshRating))
        return value
