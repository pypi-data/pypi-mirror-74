...
class SpiralBevelGearRating(_341.BevelGearRating):
    '''SpiralBevelGearRating
    ...
    @property
    def spiral_bevel_gear(self) -> '_735.SpiralBevelGearDesign':
        ...
        return constructor.new(_735.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear else None
