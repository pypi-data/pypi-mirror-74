...
class StraightBevelDiffGearRating(_326.ConicalGearRating):
    '''StraightBevelDiffGearRating
    ...
    @property
    def straight_bevel_diff_gear(self) -> '_727.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_727.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGear) if self.wrapped.StraightBevelDiffGear else None
