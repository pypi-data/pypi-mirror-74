...
from mastapy.gears.rating.zerol_bevel import _171, _172
...
class ZerolBevelGearSetRating(_342.BevelGearSetRating):
    ...
    @property
    def zerol_bevel_mesh_ratings(self) -> 'List[_171.ZerolBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshRatings, constructor.new(_171.ZerolBevelGearMeshRating))
        return value

    @property
    def zerol_bevel_gear_ratings(self) -> 'List[_172.ZerolBevelGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearRatings, constructor.new(_172.ZerolBevelGearRating))
        return value
