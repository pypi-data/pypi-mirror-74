...
from mastapy.gears.gear_designs.conical import _906
...
class AGMAGleasonConicalGearMeshRating(_325.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_906.LoadDistributionFactorMethods':
        ...
        return constructor.new(_906.LoadDistributionFactorMethods)(value) if value else None
