...
class WormGearMeshRating(_162.GearMeshRating):
    '''WormGearMeshRating
    ...
    @property
    def worm_gear_mesh(self) -> '_724.WormGearMeshDesign':
        ...
        return constructor.new(_724.WormGearMeshDesign)(self.wrapped.WormGearMesh) if self.wrapped.WormGearMesh else None
