...
from mastapy.gears.manufacturing.cylindrical import _407, _397
...
class CylindricalSetManufacturingConfig(_965.GearSetImplementationDetail):
    ...
    @property
    def cylindrical_mesh_manufacturing_configurations(self) -> 'List[_407.CylindricalMeshManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshManufacturingConfigurations, constructor.new(_407.CylindricalMeshManufacturingConfig))
        return value

    @property
    def cylindrical_gear_manufacturing_configurations(self) -> 'List[_397.CylindricalGearManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearManufacturingConfigurations, constructor.new(_397.CylindricalGearManufacturingConfig))
        return value
