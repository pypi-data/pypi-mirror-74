...
class ShaperSimulationCalculator(_488.CutterSimulationCalc):
    '''ShaperSimulationCalculator
    ...
    @property
    def shaper(self) -> '_529.CylindricalGearShaperTangible':
        ...
        return constructor.new(_529.CylindricalGearShaperTangible)(self.wrapped.Shaper) if self.wrapped.Shaper else None
