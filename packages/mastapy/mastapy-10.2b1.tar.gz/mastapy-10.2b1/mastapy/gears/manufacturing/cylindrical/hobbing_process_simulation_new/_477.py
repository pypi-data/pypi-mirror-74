...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _438
...
class WormGrindingCutterCalculation(_479.WormGrindingProcessCalculation):
    '''WormGrindingCutterCalculation
    ...
    @property
    def input_gear_point_of_interest(self) -> '_438.PointOfInterest':
        ...
        return constructor.new(_438.PointOfInterest)(self.wrapped.InputGearPointOfInterest) if self.wrapped.InputGearPointOfInterest else None
