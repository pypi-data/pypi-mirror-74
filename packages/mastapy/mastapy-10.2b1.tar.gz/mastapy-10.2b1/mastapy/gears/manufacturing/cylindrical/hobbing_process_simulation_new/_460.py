...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _451
...
class HobbingProcessTotalModificationCalculation(_451.HobbingProcessCalculation):
    '''HobbingProcessTotalModificationCalculation
