...
from mastapy.gears.gear_designs.cylindrical import _770
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _441, _427
...
class PlungeShaverGeneration(_0.APIBase):
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_770.CrossedAxisCylindricalGearPairLineContact':
        ...
        return constructor.new(_770.CrossedAxisCylindricalGearPairLineContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails else None

    @property
    def points_of_interest_on_the_shaver(self) -> 'List[_441.ShaverPointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestOnTheShaver, constructor.new(_441.ShaverPointOfInterest))
        return value

    @property
    def calculation_errors(self) -> 'List[_427.CalculationError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CalculationErrors, constructor.new(_427.CalculationError))
        return value
