...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _504
...
class CylindricalManufacturedVirtualGearInMesh(_0.APIBase):
    ...
    @property
    def virtual_gear(self) -> '_504.VirtualSimulationCalculator':
        ...
        return constructor.new(_504.VirtualSimulationCalculator)(self.wrapped.VirtualGear) if self.wrapped.VirtualGear else None
