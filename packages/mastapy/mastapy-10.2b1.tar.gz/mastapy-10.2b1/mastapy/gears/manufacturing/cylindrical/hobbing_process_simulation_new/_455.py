...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _446, _451
...
class HobbingProcessPitchCalculation(_451.HobbingProcessCalculation):
    '''HobbingProcessPitchCalculation
