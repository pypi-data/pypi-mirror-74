...
from mastapy.gears.manufacturing.cylindrical.cutters import _511
...
class CylindricalWormGrinderDatabase(_395.CylindricalCutterDatabase['_511.CylindricalGearGrindingWorm']):
    '''CylindricalWormGrinderDatabase
