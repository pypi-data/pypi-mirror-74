...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _447, _479
...
class WormGrindingProcessProfileCalculation(_479.WormGrindingProcessCalculation):
    '''WormGrindingProcessProfileCalculation
    ...
    @property
    def right_flank(self) -> '_447.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_447.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_447.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_447.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
