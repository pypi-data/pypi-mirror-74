...
from mastapy.gears.gear_designs.cylindrical import _837, _801, _836
...
class PlungeShaverCalculationInputs(_0.APIBase):
    ...
    @property
    def shaver_hand(self) -> '_135.Hand':
    ...
    @shaver_hand.setter
    def shaver_hand(self, value: '_135.Hand'):
    ...
    @property
    def input_gear_geometry(self) -> '_489.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_489.CylindricalCutterSimulatableGear)(self.wrapped.InputGearGeometry) if self.wrapped.InputGearGeometry else None

    @property
    def tooth_thickness(self) -> '_837.ToothThicknessSpecificationBase':
        ...
        return constructor.new(_837.ToothThicknessSpecificationBase)(self.wrapped.ToothThickness) if self.wrapped.ToothThickness else None

    @property
    def tooth_thickness_of_type_finish_tooth_thickness_design_specification(self) -> '_801.FinishToothThicknessDesignSpecification':
        ...
        if _801.FinishToothThicknessDesignSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
        ...
        return constructor.new(_801.FinishToothThicknessDesignSpecification)(self.wrapped.ToothThickness) if self.wrapped.ToothThickness else None

    @property
    def tooth_thickness_of_type_tooth_thickness_specification(self) -> '_836.ToothThicknessSpecification':
        ...
        if _836.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
        ...
        return constructor.new(_836.ToothThicknessSpecification)(self.wrapped.ToothThickness) if self.wrapped.ToothThickness else None
