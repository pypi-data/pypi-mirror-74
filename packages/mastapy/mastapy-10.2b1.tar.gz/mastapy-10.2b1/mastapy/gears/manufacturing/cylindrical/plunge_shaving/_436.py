...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _428, _434
from mastapy.gears.manufacturing.cylindrical import _412
...
class PlungeShaverOutputs(_0.APIBase):
    ...
    @property
    def profile_modification_on_conjugate_shaver_chart_left_flank(self) -> '_6525.SMTBitmap':
        ...
        return constructor.new(_6525.SMTBitmap)(self.wrapped.ProfileModificationOnConjugateShaverChartLeftFlank) if self.wrapped.ProfileModificationOnConjugateShaverChartLeftFlank else None

    @property
    def profile_modification_on_conjugate_shaver_chart_right_flank(self) -> '_6525.SMTBitmap':
        ...
        return constructor.new(_6525.SMTBitmap)(self.wrapped.ProfileModificationOnConjugateShaverChartRightFlank) if self.wrapped.ProfileModificationOnConjugateShaverChartRightFlank else None
    ...
    @property
    def calculation_details(self) -> '_434.PlungeShaverGeneration':
        ...
        return constructor.new(_434.PlungeShaverGeneration)(self.wrapped.CalculationDetails) if self.wrapped.CalculationDetails else None
