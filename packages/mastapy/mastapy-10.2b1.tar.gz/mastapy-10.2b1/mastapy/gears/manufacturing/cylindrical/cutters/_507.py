...
class CustomisableEdgeProfile(_0.APIBase):
    '''CustomisableEdgeProfile
    ...
    @property
    def customised_cutting_edge_profile(self) -> 'List[_522.MutatableCommon]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CustomisedCuttingEdgeProfile, constructor.new(_522.MutatableCommon))
        return value
