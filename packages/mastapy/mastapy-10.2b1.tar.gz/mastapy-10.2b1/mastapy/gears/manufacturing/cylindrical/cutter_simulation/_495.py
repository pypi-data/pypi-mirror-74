...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _527
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _488
...
class FormWheelGrindingSimulationCalculator(_488.CutterSimulationCalc):
    '''FormWheelGrindingSimulationCalculator
    ...
    @property
    def profiled_grinding_wheel(self) -> '_527.CylindricalGearFormedWheelGrinderTangible':
        ...
        return constructor.new(_527.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.ProfiledGrindingWheel) if self.wrapped.ProfiledGrindingWheel else None
