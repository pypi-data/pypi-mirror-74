...
class HobSimulationCalculator(_500.RackSimulationCalculator):
    '''HobSimulationCalculator
    ...
    @property
    def hob(self) -> '_528.CylindricalGearHobShape':
        ...
        return constructor.new(_528.CylindricalGearHobShape)(self.wrapped.Hob) if self.wrapped.Hob else None
