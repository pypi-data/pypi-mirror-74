...
from mastapy.gears.manufacturing.bevel import _583, _597
...
class ManufacturingMachine(_1348.NamedDatabaseItem):
    '''ManufacturingMachine
    ...
    @property
    def machine_type(self) -> '_583.MachineTypes':
        '''MachineTypes: 'MachineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.MachineType)
        return constructor.new(_583.MachineTypes)(value) if value else None

    @machine_type.setter
    def machine_type(self, value: '_583.MachineTypes'):
    ...
    @property
    def wheel_formate_machine_type(self) -> '_597.WheelFormatMachineTypes':
        ...
        return constructor.new(_597.WheelFormatMachineTypes)(value) if value else None

    @wheel_formate_machine_type.setter
    def wheel_formate_machine_type(self, value: '_597.WheelFormatMachineTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
