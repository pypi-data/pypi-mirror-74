...
from mastapy.gears.manufacturing.bevel import _579, _572
...
class ConicalMeshManufacturingConfig(_572.ConicalMeshMicroGeometryConfigBase):
    '''ConicalMeshManufacturingConfig
    ...
    @property
    def wheel_config(self) -> '_579.ConicalWheelManufacturingConfig':
