...
class Wheel(_0.APIBase):
    ...
    def basic_conical_gear_machine_settings(self) -> '_606.BasicConicalGearMachineSettings':
        ...
        return constructor.new(_606.BasicConicalGearMachineSettings)(self.wrapped.BasicConicalGearMachineSettings) if self.wrapped.BasicConicalGearMachineSettings else None
    ...
    def basic_conical_gear_machine_settings_of_type_basic_conical_gear_machine_settings_formate(self) -> '_607.BasicConicalGearMachineSettingsFormate':
        ...
        return constructor.new(_607.BasicConicalGearMachineSettingsFormate)(self.wrapped.BasicConicalGearMachineSettings) if self.wrapped.BasicConicalGearMachineSettings else None
    ...
    def basic_conical_gear_machine_settings_of_type_basic_conical_gear_machine_settings_generated(self) -> '_608.BasicConicalGearMachineSettingsGenerated':
        ...
        return constructor.new(_608.BasicConicalGearMachineSettingsGenerated)(self.wrapped.BasicConicalGearMachineSettings) if self.wrapped.BasicConicalGearMachineSettings else None
