...
from mastapy.gears.gear_designs.conical import _908
...
class PinionFinishMachineSettings(_122.ConicalGearToothSurface):
    '''PinionFinishMachineSettings
    ...
    @property
    def toprem_letter(self) -> '_908.TopremLetter':
