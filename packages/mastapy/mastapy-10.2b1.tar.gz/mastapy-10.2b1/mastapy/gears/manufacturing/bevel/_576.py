...
from mastapy.gears.gear_designs.conical import _895, _894
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.gears.manufacturing.bevel import _561, _570, _578
...
class ConicalSetManufacturingConfig(_578.ConicalSetMicroGeometryConfigBase):
    '''ConicalSetManufacturingConfig
    ...
    @property
    def gear_manufacturing_configurations(self) -> 'List[_561.ConicalGearManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearManufacturingConfigurations, constructor.new(_561.ConicalGearManufacturingConfig))
        return value

    @property
    def meshes(self) -> 'List[_570.ConicalMeshManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_570.ConicalMeshManufacturingConfig))
        return value
