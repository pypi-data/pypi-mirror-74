...
from mastapy.math_utility.optimisation import _1099
...
class OptimisationTarget(_0.APIBase, Generic[T]):
    '''OptimisationTarget
    ...
    @property
    def input_setters(self) -> 'List[_1099.InputSetter[T]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1099.InputSetter)[T])
        return value
