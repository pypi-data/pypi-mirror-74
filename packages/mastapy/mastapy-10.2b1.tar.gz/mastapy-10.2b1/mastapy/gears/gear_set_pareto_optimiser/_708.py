...
from mastapy.gears.gear_set_pareto_optimiser import _681
...
class StraightBevelGearSetParetoOptimiser(_681.GearSetParetoOptimiser):
    '''StraightBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_733.StraightBevelGearSetDesign':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_733.StraightBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_733.StraightBevelGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_733.StraightBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_733.StraightBevelGearSetDesign))
        return value
