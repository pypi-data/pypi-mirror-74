...
class MicroGeometryDesignSpaceSearchCandidate(_676.DesignSpaceSearchCandidateBase['_634.CylindricalGearSetLoadDistributionAnalysis', 'MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearchCandidate
    ...
    @property
    def candidate(self) -> '_634.CylindricalGearSetLoadDistributionAnalysis':
        ...
        return constructor.new(_634.CylindricalGearSetLoadDistributionAnalysis)(self.wrapped.Candidate) if self.wrapped.Candidate else None
