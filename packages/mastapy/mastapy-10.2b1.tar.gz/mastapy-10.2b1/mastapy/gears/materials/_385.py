...
from mastapy.gears.materials import _380, _386
...
class KlingelnbergConicalGearMaterialDatabase(_380.GearMaterialDatabase['_386.KlingelnbergCycloPalloidConicalGearMaterial']):
    '''KlingelnbergConicalGearMaterialDatabase
