...
from mastapy.gears.materials import _372
...
class BevelGearISOMaterial(_372.BevelGearMaterial):
    '''BevelGearISOMaterial
    ...
    @property
    def quality_grade(self) -> '_83.QualityGrade':
        '''QualityGrade: 'QualityGrade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.QualityGrade)
        return constructor.new(_83.QualityGrade)(value) if value else None

    @quality_grade.setter
    def quality_grade(self, value: '_83.QualityGrade'):
