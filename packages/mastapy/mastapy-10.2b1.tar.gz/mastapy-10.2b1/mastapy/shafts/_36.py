...
class ShaftSectionEndDamageResults(_0.APIBase):
    ...
    @property
    def section_end(self) -> '_1394.SectionEnd':
        ...
        return constructor.new(_1394.SectionEnd)(value) if value else None
    ...
    def sn_curve(self) -> '_86.SNCurve':
        ...
        return constructor.new(_86.SNCurve)(self.wrapped.SNCurve) if self.wrapped.SNCurve else None

    @property
    def din743201212_alternate_strength(self) -> '_41.StressMeasurementShaftAxialBendingTorsionalComponentValues':
        ...
        return constructor.new(_41.StressMeasurementShaftAxialBendingTorsionalComponentValues)(self.wrapped.DIN743201212AlternateStrength) if self.wrapped.DIN743201212AlternateStrength else None

    @property
    def din743201212_yielding_strength(self) -> '_41.StressMeasurementShaftAxialBendingTorsionalComponentValues':
        ...
        return constructor.new(_41.StressMeasurementShaftAxialBendingTorsionalComponentValues)(self.wrapped.DIN743201212YieldingStrength) if self.wrapped.DIN743201212YieldingStrength else None

    @property
    def din743201212_influence_factor_for_mean_stress_sensitivity(self) -> '_16.ShaftAxialBendingTorsionalComponentValues':
        ...
        return constructor.new(_16.ShaftAxialBendingTorsionalComponentValues)(self.wrapped.DIN743201212InfluenceFactorForMeanStressSensitivity) if self.wrapped.DIN743201212InfluenceFactorForMeanStressSensitivity else None
    ...
    @property
    def sn_curve_axial(self) -> '_86.SNCurve':
        ...
        return constructor.new(_86.SNCurve)(self.wrapped.SNCurveAxial) if self.wrapped.SNCurveAxial else None

    @property
    def sn_curve_bending_x(self) -> '_86.SNCurve':
        ...
        return constructor.new(_86.SNCurve)(self.wrapped.SNCurveBendingX) if self.wrapped.SNCurveBendingX else None

    @property
    def sn_curve_bending_y(self) -> '_86.SNCurve':
        ...
        return constructor.new(_86.SNCurve)(self.wrapped.SNCurveBendingY) if self.wrapped.SNCurveBendingY else None

    @property
    def sn_curve_torsional(self) -> '_86.SNCurve':
        ...
        return constructor.new(_86.SNCurve)(self.wrapped.SNCurveTorsional) if self.wrapped.SNCurveTorsional else None
    ...
    @property
    def din743201212_yielding_amplitude(self) -> 'List[_41.StressMeasurementShaftAxialBendingTorsionalComponentValues]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DIN743201212YieldingAmplitude, constructor.new(_41.StressMeasurementShaftAxialBendingTorsionalComponentValues))
        return value
