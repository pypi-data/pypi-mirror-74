...
from mastapy.utility.report import _1313, _1306
...
class UserTextRow(_1306.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1313.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1313.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1313.HeadingSize'):
