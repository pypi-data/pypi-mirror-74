...
from mastapy.utility.report import _1298, _1301
...
TItem = TypeVar('TItem', bound='_1301.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1298.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
