...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1148.RoundingMethods':
        ...
        return constructor.new(_1148.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1148.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1160.Unit':
        ...
        return constructor.new(_1160.Unit)(self.wrapped.CurrentUnit) if self.wrapped.CurrentUnit else None
