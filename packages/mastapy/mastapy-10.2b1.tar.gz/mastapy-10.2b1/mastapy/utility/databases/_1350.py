...
from mastapy.utility.databases import _1348, _1345, _1344
...
TKey = TypeVar('TKey', bound='_1345.DatabaseKey')
TValue = TypeVar('TValue', bound='_0.APIBase')


class SQLDatabase(_1344.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    '''SQLDatabase
    ...
    def save(self, item: '_1348.NamedDatabaseItem'):
    ...
    def delete(self, key: '_1345.DatabaseKey'):
