...
from mastapy.utility.units_and_measurements.measurements import _1185
...
class DutyCyclePropertySummaryForce(_1354.DutyCyclePropertySummary['_1185.Force', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryForce
