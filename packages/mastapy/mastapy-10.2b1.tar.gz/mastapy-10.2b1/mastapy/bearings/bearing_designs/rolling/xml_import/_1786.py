...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1784, _1783
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1784.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1784.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1783.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1783.AbstractXmlVariableAssignment))
        return value
