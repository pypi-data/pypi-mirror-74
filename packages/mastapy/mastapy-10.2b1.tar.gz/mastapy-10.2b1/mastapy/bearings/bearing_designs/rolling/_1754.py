...
from mastapy.bearings.bearing_designs.rolling import _1755, _1773
...
class BallBearing(_1773.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1755.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1755.BallBearingShoulderDefinition))
        return value
