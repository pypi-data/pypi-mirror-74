...
from mastapy.bearings import _1527
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy._internal.implicit import overridable
from mastapy.bearings.bearing_designs.rolling import _1754
...
class ThrustBallBearing(_1754.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1527.OuterRingMounting':
        ...
        return constructor.new(_1527.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1527.OuterRingMounting'):
