...
from mastapy.bearings.bearing_designs.rolling import _1772, _1769
...
class TaperRollerBearing(_1769.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1516.BearingMeasurementType':
        ...
        return constructor.new(_1516.BearingMeasurementType)(value) if value else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1516.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_1772.RollerRibDetail':
        ...
        return constructor.new(_1772.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail else None
