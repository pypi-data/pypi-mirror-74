...
from mastapy.bearings.bearing_results.rolling import _1628, _1653
...
class LoadedCrossedRollerBearingRow(_1653.LoadedRollerBearingRow):
    '''LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1628.LoadedCrossedRollerBearingResults':
