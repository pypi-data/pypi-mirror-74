...
from mastapy.bearings.bearing_results.rolling import _1644, _1633
...
class LoadedNeedleRollerBearingRow(_1633.LoadedCylindricalRollerBearingRow):
    '''LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1644.LoadedNeedleRollerBearingResults':
