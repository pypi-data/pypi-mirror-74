...
from mastapy.bearings.bearing_results.rolling import _1617, _1648
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1648.LoadedNonBarrelRollerBearingRow):
    '''LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1617.LoadedAxialThrustCylindricalRollerBearingResults':
