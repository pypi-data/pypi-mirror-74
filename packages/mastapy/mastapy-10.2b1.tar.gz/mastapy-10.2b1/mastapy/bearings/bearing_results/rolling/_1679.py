...
from mastapy.bearings.bearing_results.rolling import _1678, _1626
...
class LoadedThrustBallBearingRow(_1626.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1678.LoadedThrustBallBearingResults':
