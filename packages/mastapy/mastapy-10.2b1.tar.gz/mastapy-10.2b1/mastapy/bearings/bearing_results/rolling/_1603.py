...
from mastapy.bearings import _1534
...
class ISO14179SettingsPerBearingType(_1139.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    '''ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self) -> '_1534.RollingBearingType':
        ...
        return constructor.new(_1534.RollingBearingType)(value) if value else None
