...
from mastapy.bearings.bearing_results.rolling import _1663, _1653
...
class LoadedSphericalRollerRadialBearingRow(_1653.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1663.LoadedSphericalRollerRadialBearingResults':
