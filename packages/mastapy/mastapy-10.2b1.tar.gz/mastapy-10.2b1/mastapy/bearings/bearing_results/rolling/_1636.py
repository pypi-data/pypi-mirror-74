...
from mastapy.bearings.bearing_results.rolling import _1635, _1626
...
class LoadedDeepGrooveBallBearingRow(_1626.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1635.LoadedDeepGrooveBallBearingResults':
