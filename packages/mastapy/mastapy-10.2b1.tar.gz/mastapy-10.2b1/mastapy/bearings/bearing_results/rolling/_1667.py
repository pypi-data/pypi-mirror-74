...
from mastapy.bearings.bearing_results.rolling import _1666, _1653
...
class LoadedSphericalRollerThrustBearingRow(_1653.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1666.LoadedSphericalRollerThrustBearingResults':
