...
from mastapy.bearings.bearing_results import _1587
...
class LoadedDetailedBearingResults(_1587.LoadedNonLinearBearingResults):
    '''LoadedDetailedBearingResults
    ...
    @property
    def lubrication(self) -> '_74.LubricationDetail':
        ...
        return constructor.new(_74.LubricationDetail)(self.wrapped.Lubrication) if self.wrapped.Lubrication else None
