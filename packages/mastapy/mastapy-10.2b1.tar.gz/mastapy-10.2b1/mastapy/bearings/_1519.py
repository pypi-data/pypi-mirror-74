...
from mastapy.bearings import (
    _1529, _1528, _1521, _1522
)
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.bearings.bearing_results.rolling.skf_module import _1716
...
class BearingSettings(_1144.PerMachineSettings):
    '''BearingSettings
    ...
    @property
    def failure_probability_for_rating_life(self) -> '_1528.RatingLife':
        ...
        return constructor.new(_1528.RatingLife)(value) if value else None

    @failure_probability_for_rating_life.setter
    def failure_probability_for_rating_life(self, value: '_1528.RatingLife'):
    ...
    @property
    def include_exponent_and_reduction_factors_in_isots162812008(self) -> '_1521.ExponentAndReductionFactorsInISO16281Calculation':
        ...
        return constructor.new(_1521.ExponentAndReductionFactorsInISO16281Calculation)(value) if value else None

    @include_exponent_and_reduction_factors_in_isots162812008.setter
    def include_exponent_and_reduction_factors_in_isots162812008(self, value: '_1521.ExponentAndReductionFactorsInISO16281Calculation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def skf_credentials(self) -> '_1716.SKFCredentials':
        ...
        return constructor.new(_1716.SKFCredentials)(self.wrapped.SKFCredentials) if self.wrapped.SKFCredentials else None
