...
from mastapy.math_utility.optimisation import _1106
...
class InputSetter(_0.APIBase, Generic[T]):
    ...
    @property
    def optimiser_input(self) -> '_1106.ParetoOptimisationInput':
        ...
        return constructor.new(_1106.ParetoOptimisationInput)(self.wrapped.OptimiserInput) if self.wrapped.OptimiserInput else None
