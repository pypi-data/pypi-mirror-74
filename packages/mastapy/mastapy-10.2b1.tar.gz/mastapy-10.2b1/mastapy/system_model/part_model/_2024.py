...
from mastapy.materials.efficiency import _105
...
class OilSeal(_2007.Connector):
    ...
    @property
    def oil_seal_material(self) -> '_105.OilSealMaterialType':
        ...
        return constructor.new(_105.OilSealMaterialType)(value) if value else None

    @oil_seal_material.setter
    def oil_seal_material(self, value: '_105.OilSealMaterialType'):
    ...
    @property
    def oil_seal_orientation(self) -> '_1590.Orientations':
    ...
    def oil_seal_orientation(self, value: '_1590.Orientations'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
