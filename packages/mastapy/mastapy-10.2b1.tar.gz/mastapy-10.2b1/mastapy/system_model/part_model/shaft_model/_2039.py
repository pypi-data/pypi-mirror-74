...
class Shaft(_1997.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2014.GuideImage':
        ...
        return constructor.new(_2014.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_2022.MountableComponent', offset: 'float'):
