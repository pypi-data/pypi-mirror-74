...
from mastapy.system_model.part_model.part_groups import _2044, _2046, _2043
...
class ParallelPartGroup(_2043.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2044.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2044.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2046.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2046.DesignMeasurements))
        return value
