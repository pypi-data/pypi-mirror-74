...
class FaceGear(_2086.Gear):
    ...
    @property
    def active_gear_design(self) -> '_755.FaceGearDesign':
    ...
    @property
    def face_gear_design(self) -> '_755.FaceGearDesign':
        ...
        return constructor.new(_755.FaceGearDesign)(self.wrapped.FaceGearDesign) if self.wrapped.FaceGearDesign else None
