...
from mastapy.system_model.part_model.gears import _2107, _2088
...
class WormGearSet(_2088.GearSet):
    '''WormGearSet
    ...
    @property
    def worm_gears(self) -> 'List[_2107.WormGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_2107.WormGear))
        return value

    @property
    def worm_meshes(self) -> 'List[_1905.WormGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_1905.WormGearMesh))
        return value
