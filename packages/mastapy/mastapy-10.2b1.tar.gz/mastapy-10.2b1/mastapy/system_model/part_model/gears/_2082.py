...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2119
from mastapy.system_model.part_model.gears import _2081, _2088
...
class CylindricalGearSet(_2088.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_787.CylindricalGearSetDesign':
    ...
    def cylindrical_gear_set_design(self) -> '_787.CylindricalGearSetDesign':
        ...
        return constructor.new(_787.CylindricalGearSetDesign)(self.wrapped.CylindricalGearSetDesign) if self.wrapped.CylindricalGearSetDesign else None

    @property
    def supercharger_rotor_set(self) -> '_2119.SuperchargerRotorSet':
        ...
        return constructor.new(_2119.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_2081.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2081.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1885.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1885.CylindricalGearMesh))
        return value

    @property
    def gear_set_designs(self) -> 'List[_787.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_787.CylindricalGearSetDesign))
        return value
