...
from mastapy.system_model.part_model import _2005, _2022
...
class Connector(_2022.MountableComponent):
    '''Connector
    ...
    def house_in(self, shaft: '_2039.Shaft', offset: Optional['float'] = float('nan')) -> '_1851.Connection':
        ...
        return constructor.new(_1851.Connection)(method_result) if method_result else None

    def try_house_in(self, shaft: '_2039.Shaft', offset: Optional['float'] = float('nan')) -> '_2005.ComponentsConnectedResult':
