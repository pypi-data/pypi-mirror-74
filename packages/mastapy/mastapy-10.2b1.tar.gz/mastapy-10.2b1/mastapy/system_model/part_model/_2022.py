...
class MountableComponent(_2004.Component):
    '''MountableComponent
    ...
    def mount_on(self, shaft: '_2039.Shaft', offset: Optional['float'] = float('nan')) -> '_1848.CoaxialConnection':
        ...
        return constructor.new(_1848.CoaxialConnection)(method_result) if method_result else None
