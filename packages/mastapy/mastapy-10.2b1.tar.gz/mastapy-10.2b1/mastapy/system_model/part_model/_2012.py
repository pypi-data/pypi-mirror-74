...
class FlexiblePinAssembly(_2034.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2081.CylindricalGear':
        ...
        return constructor.new(_2081.CylindricalGear)(self.wrapped.PlanetGear) if self.wrapped.PlanetGear else None
