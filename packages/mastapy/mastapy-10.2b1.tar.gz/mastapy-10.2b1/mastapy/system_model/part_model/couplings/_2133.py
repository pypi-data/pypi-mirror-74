...
from mastapy.nodal_analysis import _1369
...
class ConceptCoupling(_2135.Coupling):
    '''ConceptCoupling
    ...
    @property
    def coupling_type(self) -> '_1369.CouplingType':
        '''CouplingType: 'CouplingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.CouplingType)
        return constructor.new(_1369.CouplingType)(value) if value else None

    @coupling_type.setter
    def coupling_type(self, value: '_1369.CouplingType'):
