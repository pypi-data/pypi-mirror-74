...
from mastapy.system_model.part_model.couplings import _2158, _2160, _2135
...
class TorqueConverter(_2135.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2158.TorqueConverterPump':
        ...
        return constructor.new(_2158.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2160.TorqueConverterTurbine':
        ...
        return constructor.new(_2160.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
