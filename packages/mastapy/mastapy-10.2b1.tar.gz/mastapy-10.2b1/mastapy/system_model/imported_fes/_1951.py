...
from mastapy.system_model.imported_fes import _1940, _1956
...
class ImportedFEElectricMachineStatorLink(_1956.ImportedFEMultiNodeLink):
    '''ImportedFEElectricMachineStatorLink
    ...
    @property
    def electric_machine_dynamic_load_data(self) -> '_1940.ElectricMachineDynamicLoadData':
        ...
        return constructor.new(_1940.ElectricMachineDynamicLoadData)(self.wrapped.ElectricMachineDynamicLoadData) if self.wrapped.ElectricMachineDynamicLoadData else None
