...
from mastapy.nodal_analysis.dev_tools_analyses import _1467, _1458
from mastapy.nodal_analysis import _1376
from mastapy.system_model.imported_fes import _1964
...
class ImportedFEWithSelectionModalAnalysis(_1964.ImportedFEWithSelection):
    '''ImportedFEWithSelectionModalAnalysis
    ...
    @property
    def modal_draw_style(self) -> '_1467.FEModelModalAnalysisDrawStyle':
        ...
        return constructor.new(_1467.FEModelModalAnalysisDrawStyle)(self.wrapped.ModalDrawStyle) if self.wrapped.ModalDrawStyle else None
    ...
    @property
    def fe_modal_frequencies(self) -> 'List[_1376.FEModalFrequencyComparison]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEModalFrequencies, constructor.new(_1376.FEModalFrequencyComparison))
        return value
