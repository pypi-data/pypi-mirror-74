...
class ImportedFEWithSelection(_1928.BaseFEWithSelection):
    '''ImportedFEWithSelection
    ...
    @property
    def imported_fe(self) -> '_1950.ImportedFE':
        ...
        return constructor.new(_1950.ImportedFE)(self.wrapped.ImportedFE) if self.wrapped.ImportedFE else None

    @property
    def element_face_groups(self) -> 'List[_1941.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1941.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_1975.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_1975.NodeGroupWithSelection))
        return value
