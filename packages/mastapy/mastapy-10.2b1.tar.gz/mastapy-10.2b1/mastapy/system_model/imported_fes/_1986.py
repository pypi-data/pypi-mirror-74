...
from mastapy.system_model.imported_fes import _1979, _1978
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_1979.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_1979.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_1978.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1978.PerLinkExportOptions))
        return value
