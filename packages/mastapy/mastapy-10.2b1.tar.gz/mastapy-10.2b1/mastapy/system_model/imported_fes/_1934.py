...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1480
...
class ContactPairWithSelection(_0.APIBase):
    ...
    @property
    def contact_pair(self) -> '_1480.ContactPairReporting':
        ...
        return constructor.new(_1480.ContactPairReporting)(self.wrapped.ContactPair) if self.wrapped.ContactPair else None
