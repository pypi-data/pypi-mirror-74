...
from mastapy.nodal_analysis.component_mode_synthesis import _1502
from mastapy.nodal_analysis.dev_tools_analyses import _1469
from mastapy.system_model.imported_fes import _1974, _1964
...
class ImportedFEWithSelectionStaticAnalysis(_1964.ImportedFEWithSelection):
    '''ImportedFEWithSelectionStaticAnalysis
    ...
    @property
    def full_fe_results(self) -> '_1502.StaticCMSResults':
        ...
        return constructor.new(_1502.StaticCMSResults)(self.wrapped.FullFEResults) if self.wrapped.FullFEResults else None

    @property
    def static_draw_style(self) -> '_1469.FEModelStaticAnalysisDrawStyle':
        ...
        return constructor.new(_1469.FEModelStaticAnalysisDrawStyle)(self.wrapped.StaticDrawStyle) if self.wrapped.StaticDrawStyle else None

    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_1974.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsSelectedNodes, constructor.new(_1974.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def boundary_conditions_all_nodes(self) -> 'List[_1974.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAllNodes, constructor.new(_1974.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def force_results(self) -> 'List[_1124.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceResults, constructor.new(_1124.VectorWithLinearAndAngularComponents))
        return value

    @property
    def displacement_results(self) -> 'List[_1124.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DisplacementResults, constructor.new(_1124.VectorWithLinearAndAngularComponents))
        return value
