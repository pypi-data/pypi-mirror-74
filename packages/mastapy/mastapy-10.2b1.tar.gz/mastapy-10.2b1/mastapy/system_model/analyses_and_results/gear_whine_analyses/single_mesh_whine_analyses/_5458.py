...
ConicalGearMeshSingleMeshWhineAnalysis
'''
...
_CONICAL_GEAR_MESH_SINGLE_MESH_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses.SingleMeshWhineAnalyses', 'ConicalGearMeshSingleMeshWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('ConicalGearMeshSingleMeshWhineAnalysis',)


class ConicalGearMeshSingleMeshWhineAnalysis(_5479.GearMeshSingleMeshWhineAnalysis):
    '''ConicalGearMeshSingleMeshWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _CONICAL_GEAR_MESH_SINGLE_MESH_WHINE_ANALYSIS

    __hash__ = None

    def __init__(self, instance_to_wrap: 'ConicalGearMeshSingleMeshWhineAnalysis.TYPE'):
    ...
    @property
    def planetaries(self) -> 'List[ConicalGearMeshSingleMeshWhineAnalysis]':
        '''List[ConicalGearMeshSingleMeshWhineAnalysis]: 'Planetaries' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearMeshSingleMeshWhineAnalysis))
        return value
