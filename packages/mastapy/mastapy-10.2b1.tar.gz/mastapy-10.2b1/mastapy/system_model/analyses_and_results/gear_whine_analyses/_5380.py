...
class ShaftGearWhineAnalysis(_5271.AbstractShaftOrHousingGearWhineAnalysis):
    '''ShaftGearWhineAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4811.ShaftModalAnalysis':
    ...
    @property
    def system_deflection_results(self) -> '_2326.ShaftSystemDeflection':
