...
SpecialisedAssemblyGearWhineAnalysis
'''
...
from mastapy.system_model.analyses_and_results.system_deflections import (
    _2328, _2228, _2233, _2235,
    _2240, _2242, _2246, _2252,
    _2254, _2258, _2264, _2267,
    _2271, _2272, _2273, _2282,
    _2284, _2286, _2290, _2295,
    _2298, _2301, _2313, _2319,
    _2330, _2334, _2336, _2339,
    _2346, _2352, _2359, _2362
)
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5269
from mastapy._internal.python_net import python_net_import

_SPECIALISED_ASSEMBLY_GEAR_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses', 'SpecialisedAssemblyGearWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('SpecialisedAssemblyGearWhineAnalysis',)


class SpecialisedAssemblyGearWhineAnalysis(_5269.AbstractAssemblyGearWhineAnalysis):
    '''SpecialisedAssemblyGearWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _SPECIALISED_ASSEMBLY_GEAR_WHINE_ANALYSIS

    __hash__ = None

    def __init__(self, instance_to_wrap: 'SpecialisedAssemblyGearWhineAnalysis.TYPE'):
    ...
    @property
    def system_deflection_results(self) -> '_2328.SpecialisedAssemblySystemDeflection':
