...
GearSetSingleMeshWhineAnalysis
'''
...
_GEAR_SET_SINGLE_MESH_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses.SingleMeshWhineAnalyses', 'GearSetSingleMeshWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('GearSetSingleMeshWhineAnalysis',)


class GearSetSingleMeshWhineAnalysis(_5520.SpecialisedAssemblySingleMeshWhineAnalysis):
    '''GearSetSingleMeshWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _GEAR_SET_SINGLE_MESH_WHINE_ANALYSIS

    __hash__ = None

    def __init__(self, instance_to_wrap: 'GearSetSingleMeshWhineAnalysis.TYPE'):
