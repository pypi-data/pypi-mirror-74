...
class TorqueConverterConnectionGearWhineAnalysis(_5306.CouplingConnectionGearWhineAnalysis):
    '''TorqueConverterConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2350.TorqueConverterConnectionSystemDeflection':
