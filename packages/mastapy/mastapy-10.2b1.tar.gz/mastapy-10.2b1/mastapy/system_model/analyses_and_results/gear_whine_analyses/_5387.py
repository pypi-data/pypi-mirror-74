...
class SpiralBevelGearMeshGearWhineAnalysis(_5285.BevelGearMeshGearWhineAnalysis):
    '''SpiralBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2329.SpiralBevelGearMeshSystemDeflection':
