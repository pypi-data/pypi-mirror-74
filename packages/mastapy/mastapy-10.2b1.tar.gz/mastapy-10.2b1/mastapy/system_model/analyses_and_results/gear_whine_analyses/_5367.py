...
class PartToPartShearCouplingGearWhineAnalysis(_5307.CouplingGearWhineAnalysis):
    '''PartToPartShearCouplingGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2313.PartToPartShearCouplingSystemDeflection':
