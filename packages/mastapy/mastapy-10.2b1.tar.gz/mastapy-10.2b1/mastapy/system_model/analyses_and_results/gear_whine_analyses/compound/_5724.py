...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5693
...
class CVTCompoundGearWhineAnalysis(_5693.BeltDriveCompoundGearWhineAnalysis):
    '''CVTCompoundGearWhineAnalysis
