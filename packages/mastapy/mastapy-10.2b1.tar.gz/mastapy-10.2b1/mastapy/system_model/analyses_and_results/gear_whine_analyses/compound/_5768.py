...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5376
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5775
...
class RollingRingAssemblyCompoundGearWhineAnalysis(_5775.SpecialisedAssemblyCompoundGearWhineAnalysis):
    '''RollingRingAssemblyCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5376.RollingRingAssemblyGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5376.RollingRingAssemblyGearWhineAnalysis))
        return value

    @property
    def assembly_gear_whine_analysis_load_cases(self) -> 'List[_5376.RollingRingAssemblyGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyGearWhineAnalysisLoadCases, constructor.new(_5376.RollingRingAssemblyGearWhineAnalysis))
        return value
