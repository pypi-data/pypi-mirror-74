...
class BevelDifferentialSunGearGearWhineAnalysis(_5279.BevelDifferentialGearGearWhineAnalysis):
    '''BevelDifferentialSunGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2238.BevelDifferentialSunGearSystemDeflection':
