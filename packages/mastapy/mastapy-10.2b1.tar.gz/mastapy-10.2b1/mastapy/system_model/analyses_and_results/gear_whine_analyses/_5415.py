...
class ZerolBevelGearMeshGearWhineAnalysis(_5285.BevelGearMeshGearWhineAnalysis):
    '''ZerolBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2361.ZerolBevelGearMeshSystemDeflection':
