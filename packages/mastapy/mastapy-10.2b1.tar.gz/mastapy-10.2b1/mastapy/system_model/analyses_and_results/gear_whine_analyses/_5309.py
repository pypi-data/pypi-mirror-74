...
class CVTBeltConnectionGearWhineAnalysis(_5277.BeltConnectionGearWhineAnalysis):
    '''CVTBeltConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2265.CVTBeltConnectionSystemDeflection':
