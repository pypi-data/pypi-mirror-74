...
ConnectionSingleMeshWhineAnalysis
'''
...
_CONNECTION_SINGLE_MESH_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses.SingleMeshWhineAnalyses', 'ConnectionSingleMeshWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('ConnectionSingleMeshWhineAnalysis',)


class ConnectionSingleMeshWhineAnalysis(_6508.ConnectionStaticLoadAnalysisCase):
    '''ConnectionSingleMeshWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _CONNECTION_SINGLE_MESH_WHINE_ANALYSIS

    __hash__ = None

    def __init__(self, instance_to_wrap: 'ConnectionSingleMeshWhineAnalysis.TYPE'):
    ...
    @property
    def single_mesh_whine_analysis(self) -> '_5519.SingleMeshWhineAnalysis':
        ...
        return constructor.new(_5519.SingleMeshWhineAnalysis)(self.wrapped.SingleMeshWhineAnalysis) if self.wrapped.SingleMeshWhineAnalysis else None
