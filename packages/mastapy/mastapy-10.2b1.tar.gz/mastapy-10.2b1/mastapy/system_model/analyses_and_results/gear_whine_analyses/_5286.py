...
class BevelGearSetGearWhineAnalysis(_5274.AGMAGleasonConicalGearSetGearWhineAnalysis):
    '''BevelGearSetGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2240.BevelGearSetSystemDeflection':
