...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5342, _5271
...
class ImportedFEComponentGearWhineAnalysis(_5271.AbstractShaftOrHousingGearWhineAnalysis):
    '''ImportedFEComponentGearWhineAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4776.ImportedFEComponentModalAnalysis':
    ...
    @property
    def export(self) -> '_5342.GearWhineAnalysisFEExportOptions':
        ...
        return constructor.new(_5342.GearWhineAnalysisFEExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def system_deflection_results(self) -> '_2292.ImportedFEComponentSystemDeflection':
