...
class StraightBevelDiffGearMeshGearWhineAnalysis(_5285.BevelGearMeshGearWhineAnalysis):
    '''StraightBevelDiffGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2335.StraightBevelDiffGearMeshSystemDeflection':
