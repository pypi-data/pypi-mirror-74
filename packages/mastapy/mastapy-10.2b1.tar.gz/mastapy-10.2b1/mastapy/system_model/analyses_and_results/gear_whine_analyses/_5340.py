...
from mastapy.system_model.part_model.gears import (
    _2088, _2070, _2072, _2076,
    _2078, _2080, _2082, _2085,
...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5335, _5337, _5384
from mastapy.system_model.analyses_and_results.system_deflections import (
    _2286, _2228, _2235, _2240,
    _2254, _2258, _2271, _2272,
    _2273, _2282, _2290, _2295,
    _2298, _2301, _2330, _2336,
    _2339, _2359, _2362
)
from mastapy._internal.python_net import python_net_import

_GEAR_SET_GEAR_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses', 'GearSetGearWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('GearSetGearWhineAnalysis',)


class GearSetGearWhineAnalysis(_5384.SpecialisedAssemblyGearWhineAnalysis):
    '''GearSetGearWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _GEAR_SET_GEAR_WHINE_ANALYSIS

    __hash__ = None

    def __init__(self, instance_to_wrap: 'GearSetGearWhineAnalysis.TYPE'):
        super().__init__(instance_to_wrap)

    @property
    def assembly_design(self) -> '_2088.GearSet':
    ...
    @property
    def gears_gear_whine_analysis(self) -> 'List[_5335.GearGearWhineAnalysis]':
        '''List[GearGearWhineAnalysis]: 'GearsGearWhineAnalysis' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsGearWhineAnalysis, constructor.new(_5335.GearGearWhineAnalysis))
        return value

    @property
    def meshes_gear_whine_analysis(self) -> 'List[_5337.GearMeshGearWhineAnalysis]':
        '''List[GearMeshGearWhineAnalysis]: 'MeshesGearWhineAnalysis' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesGearWhineAnalysis, constructor.new(_5337.GearMeshGearWhineAnalysis))
        return value

    @property
    def system_deflection_results(self) -> '_2286.GearSetSystemDeflection':
