...
class ConceptCouplingHalfGearWhineAnalysis(_5308.CouplingHalfGearWhineAnalysis):
    '''ConceptCouplingHalfGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2251.ConceptCouplingHalfSystemDeflection':
