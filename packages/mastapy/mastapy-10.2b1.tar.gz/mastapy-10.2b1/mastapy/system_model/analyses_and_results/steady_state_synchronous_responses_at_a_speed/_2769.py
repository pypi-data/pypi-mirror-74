...
class ConicalGearMeshSteadyStateSynchronousResponseAtASpeed(_2790.GearMeshSteadyStateSynchronousResponseAtASpeed):
    '''ConicalGearMeshSteadyStateSynchronousResponseAtASpeed
    ...
    def planetaries(self) -> 'List[ConicalGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value
