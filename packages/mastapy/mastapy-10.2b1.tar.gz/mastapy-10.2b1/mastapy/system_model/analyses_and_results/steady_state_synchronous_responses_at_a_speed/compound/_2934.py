...
from mastapy.system_model.analyses_and_results.analysis_cases import _6513
...
class PartCompoundSteadyStateSynchronousResponseAtASpeed(_6513.PartCompoundAnalysis):
    '''PartCompoundSteadyStateSynchronousResponseAtASpeed
