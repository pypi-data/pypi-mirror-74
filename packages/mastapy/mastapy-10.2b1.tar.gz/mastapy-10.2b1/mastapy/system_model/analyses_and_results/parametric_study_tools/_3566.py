...
from mastapy.system_model.analyses_and_results.static_loads import _6072, _6174
from mastapy.system_model import _1814
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3567, _3568
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6174.ParametricStudyType':
        ...
        return constructor.new(_6174.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6174.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1814.ExternalFullFELoader':
        ...
        return constructor.new(_1814.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None

    @property
    def step_results(self) -> 'List[_3567.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_3567.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_3568.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_3568.ParametricStudyVariable))
        return value
