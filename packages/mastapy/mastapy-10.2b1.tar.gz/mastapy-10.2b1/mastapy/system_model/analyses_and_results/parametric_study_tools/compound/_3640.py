...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3690
...
class ComponentCompoundParametricStudyTool(_3690.PartCompoundParametricStudyTool):
    '''ComponentCompoundParametricStudyTool
