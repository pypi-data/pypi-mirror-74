...
from mastapy.system_model.analyses_and_results.static_loads import _6218, _6204
from mastapy.system_model.analyses_and_results.analysis_cases import _6502
...
class ParametricStudyTool(_6502.AnalysisCase):
    '''ParametricStudyTool
    ...
    @property
    def load_case(self) -> '_6204.StaticLoadCase':
        ...
        return constructor.new(_6204.StaticLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
