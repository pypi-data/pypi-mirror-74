...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3565, _3485
...
class RootAssemblyParametricStudyTool(_3485.AssemblyParametricStudyTool):
    '''RootAssemblyParametricStudyTool
    ...
    @property
    def parametric_study_tool_inputs(self) -> '_3565.ParametricStudyTool':
        ...
        return constructor.new(_3565.ParametricStudyTool)(self.wrapped.ParametricStudyToolInputs) if self.wrapped.ParametricStudyToolInputs else None
