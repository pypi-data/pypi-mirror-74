...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3484
...
class BevelGearSetParametricStudyTool(_3484.AGMAGleasonConicalGearSetParametricStudyTool):
    '''BevelGearSetParametricStudyTool
