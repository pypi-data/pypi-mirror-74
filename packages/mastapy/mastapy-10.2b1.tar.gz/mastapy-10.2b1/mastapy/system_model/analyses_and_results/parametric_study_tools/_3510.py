...
class ConicalGearMeshParametricStudyTool(_3537.GearMeshParametricStudyTool):
    '''ConicalGearMeshParametricStudyTool
    ...
    def planetaries(self) -> 'List[ConicalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearMeshParametricStudyTool))
        return value
