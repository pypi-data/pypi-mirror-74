...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5136
...
class CVTCompoundMultiBodyDynamicsAnalysis(_5136.BeltDriveCompoundMultiBodyDynamicsAnalysis):
    '''CVTCompoundMultiBodyDynamicsAnalysis
