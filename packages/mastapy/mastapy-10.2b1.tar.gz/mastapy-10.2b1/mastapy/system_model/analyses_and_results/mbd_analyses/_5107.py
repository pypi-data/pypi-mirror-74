...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5111, _5021
...
class TorqueConverterConnectionMultiBodyDynamicsAnalysis(_5021.CouplingConnectionMultiBodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5111.TorqueConverterStatus':
        ...
        return constructor.new(_5111.TorqueConverterStatus)(value) if value else None
