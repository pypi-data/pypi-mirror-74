...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4986
from mastapy._internal.python_net import python_net_import

_BEVEL_GEAR_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'BevelGearMultiBodyDynamicsAnalysis')
...
class BevelGearMultiBodyDynamicsAnalysis(_4986.AGMAGleasonConicalGearMultiBodyDynamicsAnalysis):
    '''BevelGearMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _BEVEL_GEAR_MULTI_BODY_DYNAMICS_ANALYSIS

    __hash__ = None

    def __init__(self, instance_to_wrap: 'BevelGearMultiBodyDynamicsAnalysis.TYPE'):
