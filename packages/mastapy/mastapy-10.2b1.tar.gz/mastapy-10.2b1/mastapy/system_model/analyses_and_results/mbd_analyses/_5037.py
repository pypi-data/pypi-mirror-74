...
class GearMeshMultiBodyDynamicsAnalysis(_5050.InterMountableComponentConnectionMultiBodyDynamicsAnalysis):
    '''GearMeshMultiBodyDynamicsAnalysis
    ...
    @property
    def contact_status(self) -> '_1381.GearMeshContactStatus':
        ...
        return constructor.new(_1381.GearMeshContactStatus)(value) if value else None
