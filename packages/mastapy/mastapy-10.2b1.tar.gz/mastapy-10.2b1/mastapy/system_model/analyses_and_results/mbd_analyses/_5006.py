...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5004, _5023
...
class ClutchMultiBodyDynamicsAnalysis(_5023.CouplingMultiBodyDynamicsAnalysis):
    '''ClutchMultiBodyDynamicsAnalysis
    ...
    @property
    def clutch_connection(self) -> '_5004.ClutchConnectionMultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5004.ClutchConnectionMultiBodyDynamicsAnalysis)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
