...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4987
...
class BevelGearSetMultiBodyDynamicsAnalysis(_4987.AGMAGleasonConicalGearSetMultiBodyDynamicsAnalysis):
    '''BevelGearSetMultiBodyDynamicsAnalysis
