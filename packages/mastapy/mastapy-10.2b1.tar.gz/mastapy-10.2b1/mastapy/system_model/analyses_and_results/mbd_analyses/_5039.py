...
class GearMultiBodyDynamicsAnalysis(_5065.MountableComponentMultiBodyDynamicsAnalysis):
    '''GearMultiBodyDynamicsAnalysis
    ...
    def gear_mesh_torque(self) -> 'List[float]':
        ...
        value = conversion.pn_to_mp_list_float(self.wrapped.GearMeshTorque)
        return value
    ...
    @property
    def peak_gear_torque(self) -> 'List[_5125.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakGearTorque, constructor.new(_5125.DynamicTorqueResultAtTime))
        return value
