...
_CLUTCH_CONNECTION_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'ClutchConnectionMultiBodyDynamicsAnalysis')
...
class ClutchConnectionMultiBodyDynamicsAnalysis(_5021.CouplingConnectionMultiBodyDynamicsAnalysis):
    '''ClutchConnectionMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _CLUTCH_CONNECTION_MULTI_BODY_DYNAMICS_ANALYSIS
