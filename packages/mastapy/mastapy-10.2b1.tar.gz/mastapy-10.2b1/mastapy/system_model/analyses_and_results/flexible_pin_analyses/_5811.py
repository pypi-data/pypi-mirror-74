...
class FlexiblePinAnalysisManufactureLevel(_5807.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_3521.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_3521.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
