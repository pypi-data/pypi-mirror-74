...
from mastapy.system_model.analyses_and_results.power_flows import _3237
from mastapy._internal.python_net import python_net_import

_BEVEL_GEAR_POWER_FLOW = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.PowerFlows', 'BevelGearPowerFlow')
...
class BevelGearPowerFlow(_3237.AGMAGleasonConicalGearPowerFlow):
    '''BevelGearPowerFlow
    ...
    def __init__(self, instance_to_wrap: 'BevelGearPowerFlow.TYPE'):
