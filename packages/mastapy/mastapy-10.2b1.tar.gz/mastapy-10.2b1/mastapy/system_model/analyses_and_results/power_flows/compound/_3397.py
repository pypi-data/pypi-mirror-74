...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3366
...
class CVTBeltConnectionCompoundPowerFlow(_3366.BeltConnectionCompoundPowerFlow):
    '''CVTBeltConnectionCompoundPowerFlow
