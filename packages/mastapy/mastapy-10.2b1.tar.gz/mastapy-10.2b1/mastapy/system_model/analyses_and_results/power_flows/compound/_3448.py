...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3392
...
class ShaftToMountableComponentConnectionCompoundPowerFlow(_3392.ConnectionCompoundPowerFlow):
    '''ShaftToMountableComponentConnectionCompoundPowerFlow
