...
from mastapy.system_model.analyses_and_results.power_flows import _3342, _3327
...
class SynchroniserPowerFlow(_3327.SpecialisedAssemblyPowerFlow):
    '''SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_3342.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_3342.SynchroniserHalfPowerFlow))
        return value
