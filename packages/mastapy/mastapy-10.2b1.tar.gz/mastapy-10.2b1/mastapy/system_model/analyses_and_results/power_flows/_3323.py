...
from mastapy.system_model.analyses_and_results.power_flows import _3316, _3239
...
class RootAssemblyPowerFlow(_3239.AssemblyPowerFlow):
    '''RootAssemblyPowerFlow
    ...
    @property
    def power_flow_inputs(self) -> '_3316.PowerFlow':
        ...
        return constructor.new(_3316.PowerFlow)(self.wrapped.PowerFlowInputs) if self.wrapped.PowerFlowInputs else None
