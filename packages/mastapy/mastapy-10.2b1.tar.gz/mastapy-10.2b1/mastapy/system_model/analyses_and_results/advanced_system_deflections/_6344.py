...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6254, _6260
...
class RootAssemblyAdvancedSystemDeflection(_6260.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6254.AdvancedSystemDeflection':
        ...
        return constructor.new(_6254.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs else None
