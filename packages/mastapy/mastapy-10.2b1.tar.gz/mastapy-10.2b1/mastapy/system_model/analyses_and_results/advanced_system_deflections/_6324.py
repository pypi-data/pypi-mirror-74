...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6318
...
class KlingelnbergCycloPalloidSpiralBevelGearMeshAdvancedSystemDeflection(_6318.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2300.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2300.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection))
        return value
