...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6259
...
class BevelGearSetAdvancedSystemDeflection(_6259.AGMAGleasonConicalGearSetAdvancedSystemDeflection):
    '''BevelGearSetAdvancedSystemDeflection
