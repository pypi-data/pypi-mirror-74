...
from mastapy.system_model.analyses_and_results import _2200, _2198
...
class DesignEntityCompoundAnalysis(_2198.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2200.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2200.DesignEntitySingleContextAnalysis))
        return value
