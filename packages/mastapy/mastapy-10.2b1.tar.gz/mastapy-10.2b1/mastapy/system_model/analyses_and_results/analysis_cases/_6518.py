...
class TimeSeriesLoadAnalysisCase(_6502.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6218.TimeSeriesLoadCase':
        ...
        return constructor.new(_6218.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
