...
from mastapy.system_model.analyses_and_results.static_loads import _6181, _6171
...
class PlanetCarrierLoadCase(_6171.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6181.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6181.PlanetarySocketManufactureError))
        return value
