...
from mastapy.system_model.analyses_and_results.static_loads import _6101, _6143
...
class ConicalGearSetLoadCase(_6143.GearSetLoadCase):
    '''ConicalGearSetLoadCase
    ...
    def get_harmonic_load_data_for_import(self) -> '_6101.ConicalGearSetHarmonicLoadData':
        ...
        return constructor.new(_6101.ConicalGearSetHarmonicLoadData)(method_result) if method_result else None
