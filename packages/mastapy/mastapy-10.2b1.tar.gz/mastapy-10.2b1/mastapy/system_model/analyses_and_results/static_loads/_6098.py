...
from mastapy.system_model.analyses_and_results.static_loads import _6099, _6138
...
class ConicalGearLoadCase(_6138.GearLoadCase):
    '''ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6099.ConicalGearManufactureError':
