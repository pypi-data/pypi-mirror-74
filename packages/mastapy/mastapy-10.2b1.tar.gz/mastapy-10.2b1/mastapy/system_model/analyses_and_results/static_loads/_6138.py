...
class GearLoadCase(_6171.MountableComponentLoadCase):
    '''GearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6139.GearManufactureError':
        ...
        return constructor.new(_6139.GearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None

    @property
    def gear_manufacture_errors_of_type_conical_gear_manufacture_error(self) -> '_6099.ConicalGearManufactureError':
        ...
        if _6099.ConicalGearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
        ...
        return constructor.new(_6099.ConicalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None

    @property
    def gear_manufacture_errors_of_type_cylindrical_gear_manufacture_error(self) -> '_6112.CylindricalGearManufactureError':
        ...
        if _6112.CylindricalGearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
        ...
        return constructor.new(_6112.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None
