...
from mastapy.gears import _143
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6255
from mastapy.system_model.analyses_and_results import _2224
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5343
from mastapy.system_model.analyses_and_results.load_case_groups import _5252, _5253, _5254
...
class StaticLoadCase(_6065.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def planetary_rating_load_sharing_method(self) -> '_143.PlanetaryRatingLoadSharingOption':
    ...
    def planetary_rating_load_sharing_method(self, value: '_143.PlanetaryRatingLoadSharingOption'):
    ...
    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2224.TESetUpForDynamicAnalysisOptions':
        ...
        return constructor.new(_2224.TESetUpForDynamicAnalysisOptions)(self.wrapped.TESetUpForDynamicAnalysesOptions) if self.wrapped.TESetUpForDynamicAnalysesOptions else None

    @property
    def gear_whine_harmonic_excitation_analysis_options(self) -> '_5343.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5343.GearWhineAnalysisOptions)(self.wrapped.GearWhineHarmonicExcitationAnalysisOptions) if self.wrapped.GearWhineHarmonicExcitationAnalysisOptions else None

    @property
    def clutch_engagements(self) -> 'List[_5252.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5252.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5253.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5253.ConceptSynchroGearEngagementStatus))
        return value

    def duplicate(self, new_design_state_group: '_5254.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
        ...
        return constructor.new(StaticLoadCase)(method_result) if method_result else None
