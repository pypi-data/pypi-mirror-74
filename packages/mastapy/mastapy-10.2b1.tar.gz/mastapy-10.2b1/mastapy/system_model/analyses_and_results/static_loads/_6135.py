...
from mastapy.system_model.analyses_and_results.static_loads import _6133, _6134, _6143
...
class FaceGearSetLoadCase(_6143.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def face_gears_load_case(self) -> 'List[_6133.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_6133.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_6134.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_6134.FaceGearMeshLoadCase))
        return value
