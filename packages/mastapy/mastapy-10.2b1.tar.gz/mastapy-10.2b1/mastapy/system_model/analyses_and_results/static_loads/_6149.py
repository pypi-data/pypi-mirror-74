...
from mastapy.system_model.analyses_and_results.static_loads import _6152, _6148, _6129
...
class HarmonicLoadDataImportFromMotorPackages(_6148.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
