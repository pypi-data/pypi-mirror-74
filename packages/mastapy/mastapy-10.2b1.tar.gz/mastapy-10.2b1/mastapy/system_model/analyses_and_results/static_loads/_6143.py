...
class GearSetLoadCase(_6196.SpecialisedAssemblyLoadCase):
    '''GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self) -> '_5038.GearMeshStiffnessModel':
        ...
        return constructor.new(_5038.GearMeshStiffnessModel)(value) if value else None

    @gear_mesh_stiffness_model.setter
    def gear_mesh_stiffness_model(self, value: '_5038.GearMeshStiffnessModel'):
