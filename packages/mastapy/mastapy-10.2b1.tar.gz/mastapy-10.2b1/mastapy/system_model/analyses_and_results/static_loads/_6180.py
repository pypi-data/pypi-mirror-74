...
class PlanetaryGearSetLoadCase(_6115.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1142.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1142.LoadCaseOverrideOption'):
