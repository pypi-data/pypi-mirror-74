...
from mastapy.system_model.analyses_and_results.static_loads import _6112, _6138
...
class CylindricalGearLoadCase(_6138.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6112.CylindricalGearManufactureError':
    ...
    @property
    def overridden_micro_geometry(self) -> '_849.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_849.CylindricalGearMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry else None
