...
from mastapy.system_model.analyses_and_results.load_case_groups import _5252, _5253, _5249
...
class DesignState(_5249.AbstractDesignStateLoadCaseGroup):
    '''DesignState
    ...
    @property
    def clutches(self) -> 'List[_5252.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Clutches, constructor.new(_5252.ClutchEngagementStatus))
        return value

    @property
    def concept_synchro_mounted_gears(self) -> 'List[_5253.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptSynchroMountedGears, constructor.new(_5253.ConceptSynchroGearEngagementStatus))
        return value

    def clutch_engagement_status_for(self, clutch_connection: '_1909.ClutchConnection') -> '_5252.ClutchEngagementStatus':
        ...
        return constructor.new(_5252.ClutchEngagementStatus)(method_result) if method_result else None

    def concept_synchro_gear_engagement_status_for(self, gear: '_2081.CylindricalGear') -> '_5253.ConceptSynchroGearEngagementStatus':
        ...
        return constructor.new(_5253.ConceptSynchroGearEngagementStatus)(method_result) if method_result else None
    ...
    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_6204.StaticLoadCase':
        ...
        return constructor.new(_6204.StaticLoadCase)(method_result) if method_result else None
