...
class SteadyStateSynchronousResponseOnAShaft(_6517.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3082.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3082.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
