...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3445
from mastapy.system_model.imported_fes import _1981
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2378
...
class RootAssemblyCompoundSystemDeflection(_2378.AssemblyCompoundSystemDeflection):
    '''RootAssemblyCompoundSystemDeflection
    ...
    @property
    def root_assembly_compound_power_flow(self) -> '_3445.RootAssemblyCompoundPowerFlow':
        ...
        return constructor.new(_3445.RootAssemblyCompoundPowerFlow)(self.wrapped.RootAssemblyCompoundPowerFlow) if self.wrapped.RootAssemblyCompoundPowerFlow else None

    @property
    def bearing_race_fes(self) -> 'List[_1981.RaceBearingFESystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingRaceFEs, constructor.new(_1981.RaceBearingFESystemDeflection))
        return value
