...
from mastapy.system_model.analyses_and_results import _2199
...
class RigidlyConnectedComponentGroupSystemDeflection(_2199.DesignEntityGroupAnalysis):
    '''RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def mass_properties(self) -> '_1083.MassProperties':
        ...
        return constructor.new(_1083.MassProperties)(self.wrapped.MassProperties) if self.wrapped.MassProperties else None

    @property
    def components(self) -> 'List[_2248.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Components, constructor.new(_2248.ComponentSystemDeflection))
        return value
