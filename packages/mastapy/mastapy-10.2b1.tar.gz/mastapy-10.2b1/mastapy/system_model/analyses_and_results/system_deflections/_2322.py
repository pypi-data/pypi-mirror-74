...
from mastapy.system_model.analyses_and_results.system_deflections import _2347, _2249, _2230
...
class RootAssemblySystemDeflection(_2230.AssemblySystemDeflection):
    '''RootAssemblySystemDeflection
    ...
    @property
    def system_deflection_inputs(self) -> '_2347.SystemDeflection':
        ...
        return constructor.new(_2347.SystemDeflection)(self.wrapped.SystemDeflectionInputs) if self.wrapped.SystemDeflectionInputs else None

    @property
    def power_flow_results(self) -> '_3323.RootAssemblyPowerFlow':
    ...
    @property
    def shaft_deflection_results(self) -> 'List[_2249.ConcentricPartGroupCombinationSystemDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDeflectionResults, constructor.new(_2249.ConcentricPartGroupCombinationSystemDeflectionResults))
        return value
