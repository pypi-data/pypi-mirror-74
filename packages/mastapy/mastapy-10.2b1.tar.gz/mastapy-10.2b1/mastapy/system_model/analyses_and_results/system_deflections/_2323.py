...
from mastapy.detailed_rigid_connectors.rating import _1022
from mastapy.detailed_rigid_connectors.splines.ratings import (
    _1010, _1012, _1014, _1016,
    _1018
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1028
from mastapy.detailed_rigid_connectors.interference_fits.rating import _1035
...
class ShaftHubConnectionSystemDeflection(_2261.ConnectorSystemDeflection):
    '''ShaftHubConnectionSystemDeflection
    ...
    @property
    def component_design(self) -> '_2149.ShaftHubConnection':
    ...
    @property
    def component_load_case(self) -> '_6193.ShaftHubConnectionLoadCase':
        ...
        return constructor.new(_6193.ShaftHubConnectionLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def power_flow_results(self) -> '_3324.ShaftHubConnectionPowerFlow':
    ...
    @property
    def component_detailed_analysis(self) -> '_1022.ShaftHubConnectionRating':
        ...
        return constructor.new(_1022.ShaftHubConnectionRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_detailed_analysis_of_type_agma6123_spline_joint_rating(self) -> '_1010.AGMA6123SplineJointRating':
        ...
        if _1010.AGMA6123SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
        ...
        return constructor.new(_1010.AGMA6123SplineJointRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_detailed_analysis_of_type_din5466_spline_rating(self) -> '_1012.DIN5466SplineRating':
        ...
        if _1012.DIN5466SplineRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
        ...
        return constructor.new(_1012.DIN5466SplineRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_detailed_analysis_of_type_gbt17855_spline_joint_rating(self) -> '_1014.GBT17855SplineJointRating':
        ...
        if _1014.GBT17855SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
        ...
        return constructor.new(_1014.GBT17855SplineJointRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_detailed_analysis_of_type_sae_spline_joint_rating(self) -> '_1016.SAESplineJointRating':
        ...
        if _1016.SAESplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
        ...
        return constructor.new(_1016.SAESplineJointRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_detailed_analysis_of_type_spline_joint_rating(self) -> '_1018.SplineJointRating':
        ...
        if _1018.SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
        ...
        return constructor.new(_1018.SplineJointRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_detailed_analysis_of_type_keyway_rating(self) -> '_1028.KeywayRating':
        ...
        if _1028.KeywayRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
        ...
        return constructor.new(_1028.KeywayRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_detailed_analysis_of_type_interference_fit_rating(self) -> '_1035.InterferenceFitRating':
        ...
        if _1035.InterferenceFitRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
        ...
        return constructor.new(_1035.InterferenceFitRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
    ...
    @property
    def left_flank_contacts(self) -> 'List[_2372.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeftFlankContacts, constructor.new(_2372.SplineFlankContactReporting))
        return value

    @property
    def right_flank_contacts(self) -> 'List[_2372.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RightFlankContacts, constructor.new(_2372.SplineFlankContactReporting))
        return value

    @property
    def tip_contacts(self) -> 'List[_2372.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TipContacts, constructor.new(_2372.SplineFlankContactReporting))
        return value
