...
class PartToPartShearCouplingHalfSystemDeflection(_2263.CouplingHalfSystemDeflection):
    '''PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3310.PartToPartShearCouplingHalfPowerFlow':
