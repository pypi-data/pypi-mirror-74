...
class CylindricalGearSystemDeflectionWithLTCAResults(_2274.CylindricalGearSystemDeflection):
    '''CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_630.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_630.CylindricalGearLoadDistributionAnalysis)(self.wrapped.CylindricalGearLTCAResults) if self.wrapped.CylindricalGearLTCAResults else None
