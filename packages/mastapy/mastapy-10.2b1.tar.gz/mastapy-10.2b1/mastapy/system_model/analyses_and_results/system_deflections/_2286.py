...
from mastapy.system_model.analyses_and_results.power_flows import (
    _3288, _3238, _3245, _3250,
    _3263, _3266, _3278, _3284,
    _3292, _3297, _3300, _3303,
    _3313, _3330, _3336, _3339,
    _3355, _3358
)
from mastapy.gears.analysis import _965, _962
...
class GearSetSystemDeflection(_2328.SpecialisedAssemblySystemDeflection):
    '''GearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3288.GearSetPowerFlow':
    ...
    def analysis_for(self, gear_set_imp_detail: '_965.GearSetImplementationDetail', gear_set_mode: '_131.GearSetModes') -> '_962.GearSetImplementationAnalysis':
        ...
        return constructor.new(_962.GearSetImplementationAnalysis)(method_result) if method_result else None

    def implementation_detail_results_failed_for(self, gear_set_imp_detail: '_965.GearSetImplementationDetail', gear_set_mode: '_131.GearSetModes') -> 'bool':
    ...
    def perform_implementation_detail_analysis_with_progress(self, imp_detail: '_965.GearSetImplementationDetail', gear_set_mode: '_131.GearSetModes', progress: '_6522.TaskProgress', run_all_planetary_meshes: Optional['bool'] = True):
        ...
        self.wrapped.PerformImplementationDetailAnalysis(imp_detail.wrapped if imp_detail else None, gear_set_mode, progress.wrapped if progress else None, run_all_planetary_meshes if run_all_planetary_meshes else False)

    def perform_implementation_detail_analysis(self, imp_detail: '_965.GearSetImplementationDetail', gear_set_mode: '_131.GearSetModes', run_all_planetary_meshes: Optional['bool'] = True):
        ''' 'PerformImplementationDetailAnalysis' is the original name of this method.
        ...
        gear_set_mode = conversion.mp_to_pn_enum(gear_set_mode)
        run_all_planetary_meshes = bool(run_all_planetary_meshes)
        self.wrapped.PerformImplementationDetailAnalysis(imp_detail.wrapped if imp_detail else None, gear_set_mode, run_all_planetary_meshes if run_all_planetary_meshes else False)
