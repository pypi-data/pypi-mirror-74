...
class ShaftSectionSystemDeflection(_1430.Bar):
    '''ShaftSectionSystemDeflection
    ...
    @property
    def left_end(self) -> '_2324.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2324.ShaftSectionEndResultsSystemDeflection)(self.wrapped.LeftEnd) if self.wrapped.LeftEnd else None

    @property
    def right_end(self) -> '_2324.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2324.ShaftSectionEndResultsSystemDeflection)(self.wrapped.RightEnd) if self.wrapped.RightEnd else None
