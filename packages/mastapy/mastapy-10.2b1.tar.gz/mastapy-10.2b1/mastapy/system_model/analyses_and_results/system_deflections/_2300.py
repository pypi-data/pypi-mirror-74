...
class KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection(_2294.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3301.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow':
