...
from mastapy.system_model.analyses_and_results.system_deflections import _2324, _2325, _2226
from mastapy.shafts import _19
from mastapy.math_utility.measured_vectors import _1120
...
class ShaftSystemDeflection(_2226.AbstractShaftOrHousingSystemDeflection):
    '''ShaftSystemDeflection
    ...
    @property
    def twod_drawing_showing_axial_forces_with_mounted_components(self) -> '_6525.SMTBitmap':
        ...
        return constructor.new(_6525.SMTBitmap)(self.wrapped.TwoDDrawingShowingAxialForcesWithMountedComponents) if self.wrapped.TwoDDrawingShowingAxialForcesWithMountedComponents else None
    ...
    @property
    def component_load_case(self) -> '_6194.ShaftLoadCase':
        ...
        return constructor.new(_6194.ShaftLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def power_flow_results(self) -> '_3325.ShaftPowerFlow':
    ...
    @property
    def shaft_section_end_with_worst_static_safety_factor(self) -> '_2324.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2324.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor(self) -> '_2324.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2324.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor_for_infinite_life(self) -> '_2324.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2324.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife else None
    ...
    @property
    def shaft_section_results(self) -> 'List[_2325.ShaftSectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionResults, constructor.new(_2325.ShaftSectionSystemDeflection))
        return value

    @property
    def shaft_section_end_results_by_offset_with_worst_safety_factor(self) -> 'List[_2324.ShaftSectionEndResultsSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionEndResultsByOffsetWithWorstSafetyFactor, constructor.new(_2324.ShaftSectionEndResultsSystemDeflection))
        return value

    @property
    def mounted_components_applying_torque(self) -> 'List[_1120.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MountedComponentsApplyingTorque, constructor.new(_1120.ForceResults))
        return value
