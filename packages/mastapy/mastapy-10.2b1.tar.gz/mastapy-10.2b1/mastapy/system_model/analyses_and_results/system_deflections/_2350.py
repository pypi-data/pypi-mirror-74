...
class TorqueConverterConnectionSystemDeflection(_2262.CouplingConnectionSystemDeflection):
    '''TorqueConverterConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3347.TorqueConverterConnectionPowerFlow':
