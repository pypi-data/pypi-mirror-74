...
from mastapy.system_model.analyses_and_results.system_deflections import _2244, _2264
...
class ClutchSystemDeflection(_2264.CouplingSystemDeflection):
    '''ClutchSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3255.ClutchPowerFlow':
