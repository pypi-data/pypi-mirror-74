...
class StraightBevelDiffGearMeshSystemDeflection(_2239.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3334.StraightBevelDiffGearMeshPowerFlow':
    ...
    @property
    def rating(self) -> '_197.StraightBevelDiffGearMeshRating':
