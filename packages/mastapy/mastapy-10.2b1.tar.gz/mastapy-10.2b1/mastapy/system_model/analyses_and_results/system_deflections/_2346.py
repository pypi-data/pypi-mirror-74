...
from mastapy.system_model.analyses_and_results.system_deflections import _2343, _2328
...
class SynchroniserSystemDeflection(_2328.SpecialisedAssemblySystemDeflection):
    '''SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3344.SynchroniserPowerFlow':
    ...
    @property
    def cones(self) -> 'List[_2343.SynchroniserHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2343.SynchroniserHalfSystemDeflection))
        return value
