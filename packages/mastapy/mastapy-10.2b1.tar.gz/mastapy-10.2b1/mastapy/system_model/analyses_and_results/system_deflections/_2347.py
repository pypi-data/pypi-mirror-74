...
class SystemDeflection(_6511.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def analysis_options(self) -> '_2349.SystemDeflectionOptions':
        ...
        return constructor.new(_2349.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
