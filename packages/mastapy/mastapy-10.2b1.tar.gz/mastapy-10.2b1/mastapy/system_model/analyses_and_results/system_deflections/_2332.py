...
class SpringDamperConnectionSystemDeflection(_2262.CouplingConnectionSystemDeflection):
    '''SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3331.SpringDamperConnectionPowerFlow':
