...
BevelGearMeshModalAnalysesAtStiffnesses
'''
...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3740
from mastapy._internal.python_net import python_net_import

_BEVEL_GEAR_MESH_MODAL_ANALYSES_AT_STIFFNESSES = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtStiffnessesNS', 'BevelGearMeshModalAnalysesAtStiffnesses')


__docformat__ = 'restructuredtext en'
__all__ = ('BevelGearMeshModalAnalysesAtStiffnesses',)


class BevelGearMeshModalAnalysesAtStiffnesses(_3740.AGMAGleasonConicalGearMeshModalAnalysesAtStiffnesses):
    '''BevelGearMeshModalAnalysesAtStiffnesses

    This is a mastapy class.
    '''

    TYPE = _BEVEL_GEAR_MESH_MODAL_ANALYSES_AT_STIFFNESSES

    __hash__ = None

    def __init__(self, instance_to_wrap: 'BevelGearMeshModalAnalysesAtStiffnesses.TYPE'):
