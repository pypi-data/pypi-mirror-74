...
ConicalGearMeshModalAnalysesAtStiffnesses
'''
...
_CONICAL_GEAR_MESH_MODAL_ANALYSES_AT_STIFFNESSES = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtStiffnessesNS', 'ConicalGearMeshModalAnalysesAtStiffnesses')


__docformat__ = 'restructuredtext en'
__all__ = ('ConicalGearMeshModalAnalysesAtStiffnesses',)


class ConicalGearMeshModalAnalysesAtStiffnesses(_3790.GearMeshModalAnalysesAtStiffnesses):
    '''ConicalGearMeshModalAnalysesAtStiffnesses

    This is a mastapy class.
    '''

    TYPE = _CONICAL_GEAR_MESH_MODAL_ANALYSES_AT_STIFFNESSES

    __hash__ = None

    def __init__(self, instance_to_wrap: 'ConicalGearMeshModalAnalysesAtStiffnesses.TYPE'):
    ...
    @property
    def planetaries(self) -> 'List[ConicalGearMeshModalAnalysesAtStiffnesses]':
        '''List[ConicalGearMeshModalAnalysesAtStiffnesses]: 'Planetaries' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearMeshModalAnalysesAtStiffnesses))
        return value
