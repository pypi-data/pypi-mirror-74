...
ConnectionModalAnalysesAtStiffnesses
'''
...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3776
from mastapy.system_model.analyses_and_results.analysis_cases import _6508
from mastapy._internal.python_net import python_net_import

_CONNECTION_MODAL_ANALYSES_AT_STIFFNESSES = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtStiffnessesNS', 'ConnectionModalAnalysesAtStiffnesses')


__docformat__ = 'restructuredtext en'
__all__ = ('ConnectionModalAnalysesAtStiffnesses',)


class ConnectionModalAnalysesAtStiffnesses(_6508.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysesAtStiffnesses

    This is a mastapy class.
    '''

    TYPE = _CONNECTION_MODAL_ANALYSES_AT_STIFFNESSES

    __hash__ = None

    def __init__(self, instance_to_wrap: 'ConnectionModalAnalysesAtStiffnesses.TYPE'):
    ...
    @property
    def modal_analyses_at_stiffnesses(self) -> '_3776.CriticalSpeedAnalysis':
        ...
        return constructor.new(_3776.CriticalSpeedAnalysis)(self.wrapped.ModalAnalysesAtStiffnesses) if self.wrapped.ModalAnalysesAtStiffnesses else None
