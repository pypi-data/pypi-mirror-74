...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5819
...
class BevelGearSetDynamicAnalysis(_5819.AGMAGleasonConicalGearSetDynamicAnalysis):
    '''BevelGearSetDynamicAnalysis
