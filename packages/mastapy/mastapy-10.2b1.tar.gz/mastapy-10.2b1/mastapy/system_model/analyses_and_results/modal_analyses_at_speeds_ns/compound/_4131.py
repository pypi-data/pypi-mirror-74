...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _4181
...
class ComponentCompoundModalAnalysesAtSpeeds(_4181.PartCompoundModalAnalysesAtSpeeds):
    '''ComponentCompoundModalAnalysesAtSpeeds
