...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _4116
...
class CVTCompoundModalAnalysesAtSpeeds(_4116.BeltDriveCompoundModalAnalysesAtSpeeds):
    '''CVTCompoundModalAnalysesAtSpeeds
