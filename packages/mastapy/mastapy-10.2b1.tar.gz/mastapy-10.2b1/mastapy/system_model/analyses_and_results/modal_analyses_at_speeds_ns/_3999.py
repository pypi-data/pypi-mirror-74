...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3987
...
class BevelGearSetModalAnalysesAtSpeeds(_3987.AGMAGleasonConicalGearSetModalAnalysesAtSpeeds):
    '''BevelGearSetModalAnalysesAtSpeeds
