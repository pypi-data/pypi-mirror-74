...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3100
...
class MassDiscSteadyStateSynchronousResponse(_3100.VirtualComponentSteadyStateSynchronousResponse):
    '''MassDiscSteadyStateSynchronousResponse
