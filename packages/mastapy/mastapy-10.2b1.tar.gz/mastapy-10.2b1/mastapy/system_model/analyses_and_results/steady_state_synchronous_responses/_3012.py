...
class ConicalGearMeshSteadyStateSynchronousResponse(_3034.GearMeshSteadyStateSynchronousResponse):
    '''ConicalGearMeshSteadyStateSynchronousResponse
    ...
    def planetaries(self) -> 'List[ConicalGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearMeshSteadyStateSynchronousResponse))
        return value
