...
TMeasurement = TypeVar('TMeasurement', bound='_1155.MeasurementBase')


class WhineWaterfallReferenceValues(_4842.WhineWaterfallReferenceValuesBase, Generic[TMeasurement]):
    '''WhineWaterfallReferenceValues
