...
class FaceGearMesh(_1889.GearMesh):
    '''FaceGearMesh
    ...
    @property
    def face_gear_mesh_design(self) -> '_757.FaceGearMeshDesign':
        ...
        return constructor.new(_757.FaceGearMeshDesign)(self.wrapped.FaceGearMeshDesign) if self.wrapped.FaceGearMeshDesign else None
