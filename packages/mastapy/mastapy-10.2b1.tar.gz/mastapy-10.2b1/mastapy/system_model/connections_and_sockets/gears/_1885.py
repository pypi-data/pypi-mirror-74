...
class CylindricalGearMesh(_1889.GearMesh):
    '''CylindricalGearMesh
    ...
    @property
    def cylindrical_gear_set(self) -> '_2082.CylindricalGearSet':
        ...
        return constructor.new(_2082.CylindricalGearSet)(self.wrapped.CylindricalGearSet) if self.wrapped.CylindricalGearSet else None

    @property
    def centre_distance_range(self) -> '_1125.ShortLengthRange':
        ...
        return constructor.new(_1125.ShortLengthRange)(self.wrapped.CentreDistanceRange) if self.wrapped.CentreDistanceRange else None
