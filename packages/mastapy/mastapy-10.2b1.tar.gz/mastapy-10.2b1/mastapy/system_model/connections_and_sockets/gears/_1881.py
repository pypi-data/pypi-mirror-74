...
class ConceptGearMesh(_1889.GearMesh):
    '''ConceptGearMesh
    ...
    @property
    def concept_gear_mesh_design(self) -> '_914.ConceptGearMeshDesign':
        ...
        return constructor.new(_914.ConceptGearMeshDesign)(self.wrapped.ConceptGearMeshDesign) if self.wrapped.ConceptGearMeshDesign else None
