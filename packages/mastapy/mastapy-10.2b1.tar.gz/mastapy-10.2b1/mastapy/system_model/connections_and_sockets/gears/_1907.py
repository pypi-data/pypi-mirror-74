...
class ZerolBevelGearMesh(_1879.BevelGearMesh):
    '''ZerolBevelGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_719.ZerolBevelGearMeshDesign':
    ...
    @property
    def zerol_bevel_gear_mesh_design(self) -> '_719.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_719.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMeshDesign) if self.wrapped.ZerolBevelGearMeshDesign else None
