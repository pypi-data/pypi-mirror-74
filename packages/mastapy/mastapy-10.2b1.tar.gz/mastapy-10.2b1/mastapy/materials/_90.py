...
from mastapy.materials import _43
...
class StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial(_43.AbstractStressCyclesDataForAnSNCurveOfAPlasticMaterial):
    '''StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial
