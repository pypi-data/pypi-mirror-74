...
from mastapy.materials import _45
...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    @property
    def input_type(self) -> '_45.AcousticRadiationEfficiencyInputType':
        ...
        return constructor.new(_45.AcousticRadiationEfficiencyInputType)(value) if value else None

    @input_type.setter
    def input_type(self, value: '_45.AcousticRadiationEfficiencyInputType'):
