...
class OilPumpDetail(_1139.IndependentReportablePropertiesBase['OilPumpDetail']):
    '''OilPumpDetail
    ...
    @property
    def oil_pump_drive_type(self) -> '_104.OilPumpDriveType':
        ...
        return constructor.new(_104.OilPumpDriveType)(value) if value else None

    @oil_pump_drive_type.setter
    def oil_pump_drive_type(self, value: '_104.OilPumpDriveType'):
