...
from mastapy.detailed_rigid_connectors.splines import (
    _980, _991, _1003, _995,
    _992, _999, _1000, _975,
    _978, _982, _985, _993,
    _1005
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors import _973
...
class SplineJointDesign(_973.DetailedRigidConnectorDesign):
    '''SplineJointDesign
    ...
    @property
    def root_type(self) -> '_991.RootTypes':
        '''RootTypes: 'RootType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.RootType)
        return constructor.new(_991.RootTypes)(value) if value else None

    @root_type.setter
    def root_type(self, value: '_991.RootTypes'):
    ...
    @property
    def torque_cycles(self) -> '_995.SAETorqueCycles':
        ...
        return constructor.new(_995.SAETorqueCycles)(value) if value else None

    @torque_cycles.setter
    def torque_cycles(self, value: '_995.SAETorqueCycles'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TorqueCycles = value

    @property
    def fatigue_life_factor_type(self) -> '_992.SAEFatigueLifeFactorTypes':
        ...
        return constructor.new(_992.SAEFatigueLifeFactorTypes)(value) if value else None

    @fatigue_life_factor_type.setter
    def fatigue_life_factor_type(self, value: '_992.SAEFatigueLifeFactorTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FatigueLifeFactorType = value

    @property
    def spline_fixture_type(self) -> '_999.SplineFixtureTypes':
        ...
        return constructor.new(_999.SplineFixtureTypes)(value) if value else None

    @spline_fixture_type.setter
    def spline_fixture_type(self, value: '_999.SplineFixtureTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def external_half(self) -> '_1000.SplineHalfDesign':
        ...
        return constructor.new(_1000.SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_custom_spline_half_design(self) -> '_975.CustomSplineHalfDesign':
        ...
        if _975.CustomSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_975.CustomSplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_din5480_spline_half_design(self) -> '_978.DIN5480SplineHalfDesign':
        ...
        if _978.DIN5480SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_978.DIN5480SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_gbt3478_spline_half_design(self) -> '_982.GBT3478SplineHalfDesign':
        ...
        if _982.GBT3478SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_982.GBT3478SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_iso4156_spline_half_design(self) -> '_985.ISO4156SplineHalfDesign':
        ...
        if _985.ISO4156SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_985.ISO4156SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_sae_spline_half_design(self) -> '_993.SAESplineHalfDesign':
        ...
        if _993.SAESplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_993.SAESplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_standard_spline_half_design(self) -> '_1005.StandardSplineHalfDesign':
        ...
        if _1005.StandardSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_1005.StandardSplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def internal_half(self) -> '_1000.SplineHalfDesign':
        ...
        return constructor.new(_1000.SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_custom_spline_half_design(self) -> '_975.CustomSplineHalfDesign':
        ...
        if _975.CustomSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_975.CustomSplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_din5480_spline_half_design(self) -> '_978.DIN5480SplineHalfDesign':
        ...
        if _978.DIN5480SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_978.DIN5480SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_gbt3478_spline_half_design(self) -> '_982.GBT3478SplineHalfDesign':
        ...
        if _982.GBT3478SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_982.GBT3478SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_iso4156_spline_half_design(self) -> '_985.ISO4156SplineHalfDesign':
        ...
        if _985.ISO4156SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_985.ISO4156SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_sae_spline_half_design(self) -> '_993.SAESplineHalfDesign':
        ...
        if _993.SAESplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_993.SAESplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_standard_spline_half_design(self) -> '_1005.StandardSplineHalfDesign':
        ...
        if _1005.StandardSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_1005.StandardSplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None
