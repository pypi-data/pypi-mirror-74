...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1008
from mastapy.detailed_rigid_connectors.splines import _1005
...
class SAESplineHalfDesign(_1005.StandardSplineHalfDesign):
    '''SAESplineHalfDesign
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_1008.SAESplineTolerances':
        ...
        return constructor.new(_1008.SAESplineTolerances)(self.wrapped.SAEAccuracyAndTolerance) if self.wrapped.SAEAccuracyAndTolerance else None
