...
from mastapy.detailed_rigid_connectors.splines import _984
...
class SplineMaterial(_76.Material):
    '''SplineMaterial
    ...
    @property
    def heat_treatment_type(self) -> '_984.HeatTreatmentTypes':
    ...
    def heat_treatment_type(self, value: '_984.HeatTreatmentTypes'):
