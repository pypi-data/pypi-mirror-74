...
from mastapy.detailed_rigid_connectors.interference_fits import _1030, _1029, _1034
...
class InterferenceFitDesign(_973.DetailedRigidConnectorDesign):
    '''InterferenceFitDesign
    ...
    @property
    def calculation_method(self) -> '_1030.CalculationMethods':
        ...
        return constructor.new(_1030.CalculationMethods)(value) if value else None

    @calculation_method.setter
    def calculation_method(self, value: '_1030.CalculationMethods'):
    ...
    @property
    def assembly_method(self) -> '_1029.AssemblyMethods':
        ...
        return constructor.new(_1029.AssemblyMethods)(value) if value else None

    @assembly_method.setter
    def assembly_method(self, value: '_1029.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
