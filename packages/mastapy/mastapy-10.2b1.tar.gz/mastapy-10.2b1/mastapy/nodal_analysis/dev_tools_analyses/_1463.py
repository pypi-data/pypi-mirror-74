...
class FEModel(_0.APIBase):
    ...
    @property
    def contact_pairs(self) -> 'List[_1480.ContactPairReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactPairs, constructor.new(_1480.ContactPairReporting))
        return value
