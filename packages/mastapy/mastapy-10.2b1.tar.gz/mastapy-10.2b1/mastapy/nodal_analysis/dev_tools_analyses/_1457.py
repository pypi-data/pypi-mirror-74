...
from mastapy.nodal_analysis import _1374
...
class DrawStyleForImportedFE(_0.APIBase):
    ...
    @property
    def line_option(self) -> '_1374.FEMeshElementEntityOption':
        ...
        return constructor.new(_1374.FEMeshElementEntityOption)(value) if value else None

    @line_option.setter
    def line_option(self, value: '_1374.FEMeshElementEntityOption'):
