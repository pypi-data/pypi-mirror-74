...
from mastapy.nodal_analysis import _1398
from mastapy.nodal_analysis.system_solvers import _1412
...
class TransientSolver(_1412.DynamicSolver):
    '''TransientSolver
    ...
    @property
    def solver_status(self) -> '_1398.TransientSolverStatus':
        ...
        return constructor.new(_1398.TransientSolverStatus)(value) if value else None

    @solver_status.setter
    def solver_status(self, value: '_1398.TransientSolverStatus'):
