...
from mastapy.bearings.bearing_results.rolling import _1602
from mastapy._internal import constructor
from mastapy.bearings import _1519, _1531
from mastapy.bolts import _1041, _1043, _1048
...
from mastapy.nodal_analysis import _1365, _1380
from mastapy.shafts import _25, _37
from mastapy.system_model.analyses_and_results.static_loads import _6122
from mastapy.system_model.optimization import _1830, _1839
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2120
from mastapy.system_model.part_model import _2028
from mastapy.utility.cad_export import _1351
from mastapy.utility.databases import _1346
from mastapy.utility import _1146, _1147
from mastapy.utility.scripting import _1269
...
class MastaSettings:
    ...
    @property
    def iso14179_settings_database(self) -> '_1602.ISO14179SettingsDatabase':
        ...
        return constructor.new(_1602.ISO14179SettingsDatabase)(self.wrapped.ISO14179SettingsDatabase) if self.wrapped.ISO14179SettingsDatabase else None

    @property
    def bearing_settings(self) -> '_1519.BearingSettings':
        ...
        return constructor.new(_1519.BearingSettings)(self.wrapped.BearingSettings) if self.wrapped.BearingSettings else None

    @property
    def rolling_bearing_database(self) -> '_1531.RollingBearingDatabase':
        ...
        return constructor.new(_1531.RollingBearingDatabase)(self.wrapped.RollingBearingDatabase) if self.wrapped.RollingBearingDatabase else None

    @property
    def bolt_geometry_database(self) -> '_1041.BoltGeometryDatabase':
        ...
        return constructor.new(_1041.BoltGeometryDatabase)(self.wrapped.BoltGeometryDatabase) if self.wrapped.BoltGeometryDatabase else None

    @property
    def bolt_material_database(self) -> '_1043.BoltMaterialDatabase':
        ...
        return constructor.new(_1043.BoltMaterialDatabase)(self.wrapped.BoltMaterialDatabase) if self.wrapped.BoltMaterialDatabase else None

    @property
    def clamped_section_material_database(self) -> '_1048.ClampedSectionMaterialDatabase':
        ...
        return constructor.new(_1048.ClampedSectionMaterialDatabase)(self.wrapped.ClampedSectionMaterialDatabase) if self.wrapped.ClampedSectionMaterialDatabase else None
    ...
    @property
    def fe_user_settings(self) -> '_1380.FEUserSettings':
        ...
        return constructor.new(_1380.FEUserSettings)(self.wrapped.FEUserSettings) if self.wrapped.FEUserSettings else None
    ...
    @property
    def electric_machine_detail_database(self) -> '_6122.ElectricMachineDetailDatabase':
        ...
        return constructor.new(_6122.ElectricMachineDetailDatabase)(self.wrapped.ElectricMachineDetailDatabase) if self.wrapped.ElectricMachineDetailDatabase else None

    @property
    def conical_gear_optimization_strategy_database(self) -> '_1830.ConicalGearOptimizationStrategyDatabase':
        ...
        return constructor.new(_1830.ConicalGearOptimizationStrategyDatabase)(self.wrapped.ConicalGearOptimizationStrategyDatabase) if self.wrapped.ConicalGearOptimizationStrategyDatabase else None

    @property
    def optimization_strategy_database(self) -> '_1839.OptimizationStrategyDatabase':
        ...
        return constructor.new(_1839.OptimizationStrategyDatabase)(self.wrapped.OptimizationStrategyDatabase) if self.wrapped.OptimizationStrategyDatabase else None

    @property
    def supercharger_rotor_set_database(self) -> '_2120.SuperchargerRotorSetDatabase':
        ...
        return constructor.new(_2120.SuperchargerRotorSetDatabase)(self.wrapped.SuperchargerRotorSetDatabase) if self.wrapped.SuperchargerRotorSetDatabase else None

    @property
    def planet_carrier_settings(self) -> '_2028.PlanetCarrierSettings':
        ...
        return constructor.new(_2028.PlanetCarrierSettings)(self.wrapped.PlanetCarrierSettings) if self.wrapped.PlanetCarrierSettings else None

    @property
    def cad_export_settings(self) -> '_1351.CADExportSettings':
        ...
        return constructor.new(_1351.CADExportSettings)(self.wrapped.CADExportSettings) if self.wrapped.CADExportSettings else None

    @property
    def database_settings(self) -> '_1346.DatabaseSettings':
        ...
        return constructor.new(_1346.DatabaseSettings)(self.wrapped.DatabaseSettings) if self.wrapped.DatabaseSettings else None

    @property
    def program_settings(self) -> '_1146.ProgramSettings':
        ...
        return constructor.new(_1146.ProgramSettings)(self.wrapped.ProgramSettings) if self.wrapped.ProgramSettings else None

    @property
    def pushbullet_settings(self) -> '_1147.PushbulletSettings':
        ...
        return constructor.new(_1147.PushbulletSettings)(self.wrapped.PushbulletSettings) if self.wrapped.PushbulletSettings else None

    @property
    def scripting_setup(self) -> '_1269.ScriptingSetup':
        ...
        return constructor.new(_1269.ScriptingSetup)(self.wrapped.ScriptingSetup) if self.wrapped.ScriptingSetup else None

    @property
    def measurement_settings(self) -> '_1156.MeasurementSettings':
        ...
        return constructor.new(_1156.MeasurementSettings)(self.wrapped.MeasurementSettings) if self.wrapped.MeasurementSettings else None
