...
import mastapy._internal.scalar as scalar
...
class Vector3D(Vector2D):
    ...
    def __matmul__(self, other: Union[NUM, Iterable[NUM]]) -> 'Vector3D':
        return Vector3D.cross(self, other)

    def __rmatmul__(self, other: Union[NUM, Iterable[NUM]]) -> 'Vector3D':
        return Vector3D.cross(other, self)
    ...
    def _make_vec(cls, v: Union[NUM, Iterable[NUM]]) -> 'Vector3D':
        return Vector3D.from_tuple(cls._force_dim(v))
