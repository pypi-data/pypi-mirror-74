...
from mastapy.system_model.optimization import _1824, _1833
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2112
...
class Databases(_0.APIBase):
    ...
    @property
    def rolling_bearing_database(self) -> '_1529.RollingBearingDatabase':
        ...
        return constructor.new(_1529.RollingBearingDatabase)(self.wrapped.RollingBearingDatabase) if self.wrapped.RollingBearingDatabase else None
    ...
    @property
    def conical_gear_optimization_strategy_database(self) -> '_1824.ConicalGearOptimizationStrategyDatabase':
        ...
        return constructor.new(_1824.ConicalGearOptimizationStrategyDatabase)(self.wrapped.ConicalGearOptimizationStrategyDatabase) if self.wrapped.ConicalGearOptimizationStrategyDatabase else None

    @property
    def optimization_strategy_database(self) -> '_1833.OptimizationStrategyDatabase':
        ...
        return constructor.new(_1833.OptimizationStrategyDatabase)(self.wrapped.OptimizationStrategyDatabase) if self.wrapped.OptimizationStrategyDatabase else None

    @property
    def supercharger_rotor_set_database(self) -> '_2112.SuperchargerRotorSetDatabase':
        ...
        return constructor.new(_2112.SuperchargerRotorSetDatabase)(self.wrapped.SuperchargerRotorSetDatabase) if self.wrapped.SuperchargerRotorSetDatabase else None
