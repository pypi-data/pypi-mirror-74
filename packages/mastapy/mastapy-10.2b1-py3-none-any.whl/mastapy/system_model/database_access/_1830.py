...
from mastapy.system_model.optimization import _1814, _1823
...
class Databases(_0.APIBase):
    ...
    @property
    def conical_gear_optimization_strategy_database(self) -> '_1814.ConicalGearOptimizationStrategyDatabase':
        ...
        return constructor.new(_1814.ConicalGearOptimizationStrategyDatabase)(self.wrapped.ConicalGearOptimizationStrategyDatabase) if self.wrapped.ConicalGearOptimizationStrategyDatabase else None

    @property
    def optimization_strategy_database(self) -> '_1823.OptimizationStrategyDatabase':
        ...
        return constructor.new(_1823.OptimizationStrategyDatabase)(self.wrapped.OptimizationStrategyDatabase) if self.wrapped.OptimizationStrategyDatabase else None

    @property
    def supercharger_rotor_set_database(self) -> '_2102.SuperchargerRotorSetDatabase':
        ...
        return constructor.new(_2102.SuperchargerRotorSetDatabase)(self.wrapped.SuperchargerRotorSetDatabase) if self.wrapped.SuperchargerRotorSetDatabase else None
