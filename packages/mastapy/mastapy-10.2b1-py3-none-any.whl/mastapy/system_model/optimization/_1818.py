...
from mastapy.system_model.optimization import _1819
...
class CylindricalGearSetOptimizer(_0.APIBase):
    '''CylindricalGearSetOptimizer
    ...
    @property
    def constraints(self) -> 'List[_1819.MeasuredAndFactorViewModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Constraints, constructor.new(_1819.MeasuredAndFactorViewModel))
        return value
