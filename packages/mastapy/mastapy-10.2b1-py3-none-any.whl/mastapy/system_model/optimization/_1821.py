...
from mastapy.system_model.optimization import _1820
...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self) -> '_1820.MicroGeometryOptimisationTarget':
        ...
        return constructor.new(_1820.MicroGeometryOptimisationTarget)(value) if value else None

    @optimisation_target.setter
    def optimisation_target(self, value: '_1820.MicroGeometryOptimisationTarget'):
