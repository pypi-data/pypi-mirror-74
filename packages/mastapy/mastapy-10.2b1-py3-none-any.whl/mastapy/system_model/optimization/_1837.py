...
from mastapy.system_model.optimization import _1838, _1836
...
TStep = TypeVar('TStep', bound='_1836.OptimizationStep')


class OptimizationStrategy(_1838.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
