...
from mastapy.system_model.optimization import _1823, _1821
...
TStep = TypeVar('TStep', bound='_1821.OptimizationStep')


class OptimizationStrategy(_1823.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
