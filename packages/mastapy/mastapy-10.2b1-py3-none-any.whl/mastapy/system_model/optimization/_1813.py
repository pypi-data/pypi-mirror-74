...
from mastapy.system_model.optimization import _1822, _1814
...
class ConicalGearOptimisationStrategy(_1822.OptimizationStrategy['_1814.ConicalGearOptimizationStep']):
    '''ConicalGearOptimisationStrategy
