...
from mastapy.system_model.optimization import _1751, _1749
...
TStep = TypeVar('TStep', bound='_1749.OptimizationStep')


class OptimizationStrategy(_1751.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
