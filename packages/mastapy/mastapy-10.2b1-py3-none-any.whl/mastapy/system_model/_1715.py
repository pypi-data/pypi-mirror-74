...
from mastapy import _4, _325, _1
...
from mastapy.gears import _294, _305
...
from mastapy.system_model.part_model.configurations import _1965, _1966, _1967
from mastapy.system_model.analyses_and_results.load_case_groups import _1968, _1970
from mastapy.system_model.analyses_and_results.static_loads import _1969
from mastapy.utility.model_validation import _1387
from mastapy.system_model.database_access import _1759
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _1972
from mastapy.system_model.part_model.couplings import (
    _1974, _1975, _1976, _1977,
    _1995, _1996, _1997, _1998,
    _1999, _2001, _2002, _2024,
...
from mastapy.nodal_analysis import _110
from mastapy.bearings.bearing_designs.rolling import _1698
...
class Design(_1.APIBase):
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_external_external_meshes(self) -> '_598.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_598.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes else None

    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_internal_external_meshes(self) -> '_598.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_598.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes else None
    ...
    @property
    def shafts(self) -> '_61.ShaftSafetyFactorSettings':
        ...
        return constructor.new(_61.ShaftSafetyFactorSettings)(self.wrapped.Shafts) if self.wrapped.Shafts else None
    ...
    @property
    def gear_set_design_group(self) -> '_305.GearSetDesignGroup':
        ...
        return constructor.new(_305.GearSetDesignGroup)(self.wrapped.GearSetDesignGroup) if self.wrapped.GearSetDesignGroup else None

    @property
    def selected_gear_set_selection_group(self) -> '_1964.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_1964.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None
    ...
    @property
    def gear_set_configurations(self) -> 'List[_1964.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_1964.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_1965.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_1965.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def imported_fe_configurations(self) -> 'List[_1966.ActiveImportedFESelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEConfigurations, constructor.new(_1966.ActiveImportedFESelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_1967.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_1967.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_1968.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_1968.DesignState))
        return value
    ...
    @property
    def duty_cycles(self) -> 'List[_1970.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_1970.DutyCycle))
        return value
    ...
    @property
    def gear_set_config(self) -> '_1971.GearSetConfiguration':
        ...
        return constructor.new(_1971.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig else None

    @property
    def status(self) -> '_1387.Status':
        ...
        return constructor.new(_1387.Status)(self.wrapped.Status) if self.wrapped.Status else None
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_1972.SynchroniserShift':
        ...
        return constructor.new(_1972.SynchroniserShift)(method_result) if method_result else None

    def add_synchroniser_shift_empty(self) -> '_1972.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_1968.DesignState':
        ...
        return constructor.new(_1968.DesignState)(method_result) if method_result else None

    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_1970.DutyCycle':
        ...
        return constructor.new(_1970.DutyCycle)(method_result) if method_result else None

    def design_state_named(self, name: 'str') -> '_1968.DesignState':
    ...
    def duty_cycle_named(self, name: 'str') -> '_1970.DutyCycle':
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.1, pulley_b_diameter: Optional['float'] = 0.1, name: Optional['str'] = 'Belt Drive') -> '_2035.BeltCreationOptions':
        ...
        return constructor.new(_2035.BeltCreationOptions)(method_result) if method_result else None

    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.1) -> '_2036.PlanetCarrierCreationOptions':
        ...
        return constructor.new(_2036.PlanetCarrierCreationOptions)(method_result) if method_result else None

    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.0, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2037.ShaftCreationOptions':
        ...
        return constructor.new(_2037.ShaftCreationOptions)(method_result) if method_result else None
    ...
    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2038.CylindricalGearLinearTrainCreationOptions':
        ...
        return constructor.new(_2038.CylindricalGearLinearTrainCreationOptions)(method_result) if method_result else None

    def new_nodal_matrix(self, dense_matrix: 'List[List[float]]') -> '_110.NodalMatrix':
        ...
        return constructor.new(_110.NodalMatrix)(method_result) if method_result else None
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_1698.RollingBearing'):
    ...
    def save(self, file_name: 'str', save_results: 'bool') -> '_1387.Status':
        ...
        return constructor.new(_1387.Status)(method_result) if method_result else None

    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_325.TaskProgress') -> '_1387.Status':
        ''' 'Save' is the original name of this method.
    ...
    def remove_synchroniser_shift(self, shift: '_1972.SynchroniserShift'):
