...
from mastapy.system_model.part_model.part_groups import _2037, _2035
...
class ConcentricPartGroup(_2035.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2037.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2037.ConcentricPartGroupParallelToThis))
        return value
