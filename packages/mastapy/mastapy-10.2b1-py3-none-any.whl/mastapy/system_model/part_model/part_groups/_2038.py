...
from mastapy.system_model.connections_and_sockets import _1844
...
class DesignMeasurements(_0.APIBase):
    '''DesignMeasurements
    ...
    @property
    def component_connections(self) -> 'List[_1844.ComponentMeasurer]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1844.ComponentMeasurer))
        return value
