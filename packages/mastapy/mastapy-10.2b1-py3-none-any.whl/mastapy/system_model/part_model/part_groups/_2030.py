...
from mastapy.system_model.part_model.part_groups import _2027, _2029, _2026
...
class ParallelPartGroup(_2026.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2027.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2027.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2029.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2029.DesignMeasurements))
        return value
