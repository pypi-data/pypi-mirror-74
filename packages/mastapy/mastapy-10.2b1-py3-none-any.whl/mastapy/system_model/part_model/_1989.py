...
from mastapy.math_utility import _1063, _1064
from mastapy.system_model.connections_and_sockets import _1834, _1851
...
class Component(_2009.Part):
    ...
    @property
    def twod_drawing_full_model(self) -> '_6503.SMTBitmap':
        ...
        return constructor.new(_6503.SMTBitmap)(self.wrapped.TwoDDrawingFullModel) if self.wrapped.TwoDDrawingFullModel else None
    ...
    @property
    def component_connections(self) -> 'List[_1834.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1834.ComponentConnection))
        return value
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1063.CoordinateSystem3D') -> '_1851.RealignmentResult':
        ...
        return constructor.new(_1851.RealignmentResult)(method_result) if method_result else None

    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_1851.RealignmentResult':
    ...
    def create_coordinate_system_editor(self) -> '_1064.CoordinateSystemEditor':
        ...
        return constructor.new(_1064.CoordinateSystemEditor)(method_result) if method_result else None
