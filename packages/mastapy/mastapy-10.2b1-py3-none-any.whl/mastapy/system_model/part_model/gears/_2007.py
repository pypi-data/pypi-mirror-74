...
class ZerolBevelGear(_2001.BevelGear):
    '''ZerolBevelGear
    ...
    @property
    def bevel_gear_design(self) -> '_437.ZerolBevelGearDesign':
    ...
    @property
    def zerol_bevel_gear_design(self) -> '_437.ZerolBevelGearDesign':
        ...
        return constructor.new(_437.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGearDesign) if self.wrapped.ZerolBevelGearDesign else None
