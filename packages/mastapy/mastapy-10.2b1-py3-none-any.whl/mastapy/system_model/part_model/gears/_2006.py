...
class StraightBevelGear(_2001.BevelGear):
    '''StraightBevelGear
    ...
    @property
    def bevel_gear_design(self) -> '_435.StraightBevelGearDesign':
    ...
    @property
    def straight_bevel_gear_design(self) -> '_435.StraightBevelGearDesign':
        ...
        return constructor.new(_435.StraightBevelGearDesign)(self.wrapped.StraightBevelGearDesign) if self.wrapped.StraightBevelGearDesign else None
