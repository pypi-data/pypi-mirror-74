...
class ConceptGear(_2069.Gear):
    ...
    @property
    def active_gear_design(self) -> '_910.ConceptGearDesign':
        ...
        return constructor.new(_910.ConceptGearDesign)(self.wrapped.ActiveGearDesign) if self.wrapped.ActiveGearDesign else None

    @property
    def concept_gear_design(self) -> '_910.ConceptGearDesign':
        ...
        return constructor.new(_910.ConceptGearDesign)(self.wrapped.ConceptGearDesign) if self.wrapped.ConceptGearDesign else None
