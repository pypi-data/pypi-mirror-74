...
class BevelGear(_2052.AGMAGleasonConicalGear):
    '''BevelGear
    ...
    @property
    def conical_gear_design(self) -> '_914.BevelGearDesign':
    ...
    @property
    def bevel_gear_design(self) -> '_914.BevelGearDesign':
        ...
        return constructor.new(_914.BevelGearDesign)(self.wrapped.BevelGearDesign) if self.wrapped.BevelGearDesign else None
