...
from mastapy.system_model.part_model.gears import _2075, _2076
...
class BevelDifferentialGearSet(_2076.BevelGearSet):
    '''BevelDifferentialGearSet
    ...
    def bevel_gear_set_design(self) -> '_919.BevelGearSetDesign':
        ...
        return constructor.new(_919.BevelGearSetDesign)(self.wrapped.BevelGearSetDesign) if self.wrapped.BevelGearSetDesign else None
    ...
    def bevel_gear_set_design_of_type_zerol_bevel_gear_set_design(self) -> '_720.ZerolBevelGearSetDesign':
        ...
        return constructor.new(_720.ZerolBevelGearSetDesign)(self.wrapped.BevelGearSetDesign) if self.wrapped.BevelGearSetDesign else None
    ...
    def bevel_gear_set_design_of_type_straight_bevel_diff_gear_set_design(self) -> '_729.StraightBevelDiffGearSetDesign':
        ...
        return constructor.new(_729.StraightBevelDiffGearSetDesign)(self.wrapped.BevelGearSetDesign) if self.wrapped.BevelGearSetDesign else None
    ...
    def bevel_gear_set_design_of_type_straight_bevel_gear_set_design(self) -> '_733.StraightBevelGearSetDesign':
        ...
        return constructor.new(_733.StraightBevelGearSetDesign)(self.wrapped.BevelGearSetDesign) if self.wrapped.BevelGearSetDesign else None
    ...
    def bevel_gear_set_design_of_type_spiral_bevel_gear_set_design(self) -> '_737.SpiralBevelGearSetDesign':
        ...
        return constructor.new(_737.SpiralBevelGearSetDesign)(self.wrapped.BevelGearSetDesign) if self.wrapped.BevelGearSetDesign else None

    @property
    def bevel_gears(self) -> 'List[_2075.BevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelGears, constructor.new(_2075.BevelGear))
        return value

    @property
    def bevel_meshes(self) -> 'List[_1879.BevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelMeshes, constructor.new(_1879.BevelGearMesh))
        return value
