...
class CylindricalGear(_2069.Gear):
    '''CylindricalGear
    ...
    @property
    def active_gear_design(self) -> '_775.CylindricalGearDesign':
        ...
        return constructor.new(_775.CylindricalGearDesign)(self.wrapped.ActiveGearDesign) if self.wrapped.ActiveGearDesign else None

    @property
    def cylindrical_gear_design(self) -> '_775.CylindricalGearDesign':
        ...
        return constructor.new(_775.CylindricalGearDesign)(self.wrapped.CylindricalGearDesign) if self.wrapped.CylindricalGearDesign else None
