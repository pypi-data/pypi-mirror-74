...
from mastapy.system_model.part_model.gears import _2077, _2088
...
class ConceptGearSet(_2088.GearSet):
    '''ConceptGearSet
    ...
    @property
    def concept_gears(self) -> 'List[_2077.ConceptGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_2077.ConceptGear))
        return value

    @property
    def concept_meshes(self) -> 'List[_1881.ConceptGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_1881.ConceptGearMesh))
        return value
