...
from mastapy.system_model.part_model.gears import _2081, _2083, _2082
...
class PlanetaryGearSet(_2082.CylindricalGearSet):
    '''PlanetaryGearSet
    ...
    @property
    def suns(self) -> 'List[_2081.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Suns, constructor.new(_2081.CylindricalGear))
        return value

    @property
    def planets(self) -> 'List[_2083.CylindricalPlanetGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planets, constructor.new(_2083.CylindricalPlanetGear))
        return value

    @property
    def annuluses(self) -> 'List[_2081.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Annuluses, constructor.new(_2081.CylindricalGear))
        return value

    def add_sun(self) -> '_2081.CylindricalGear':
    ...
    def add_planet(self) -> '_2081.CylindricalGear':
