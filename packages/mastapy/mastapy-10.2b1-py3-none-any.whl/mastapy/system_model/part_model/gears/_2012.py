...
class KlingelnbergCycloPalloidHypoidGear(_2000.KlingelnbergCycloPalloidConicalGear):
    '''KlingelnbergCycloPalloidHypoidGear
    ...
    @property
    def conical_gear_design(self) -> '_440.KlingelnbergCycloPalloidHypoidGearDesign':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_design(self) -> '_440.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        return constructor.new(_440.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGearDesign) if self.wrapped.KlingelnbergCycloPalloidHypoidGearDesign else None
