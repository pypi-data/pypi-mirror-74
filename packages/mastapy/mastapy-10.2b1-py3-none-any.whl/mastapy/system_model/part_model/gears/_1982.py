...
from mastapy.system_model.part_model.gears import _2005, _1980
...
class StraightBevelDiffGearSet(_1980.BevelGearSet):
    '''StraightBevelDiffGearSet
    ...
    @property
    def conical_gear_set_design(self) -> '_393.StraightBevelDiffGearSetDesign':
    ...
    @property
    def straight_bevel_diff_gear_set_design(self) -> '_393.StraightBevelDiffGearSetDesign':
        ...
        return constructor.new(_393.StraightBevelDiffGearSetDesign)(self.wrapped.StraightBevelDiffGearSetDesign) if self.wrapped.StraightBevelDiffGearSetDesign else None

    @property
    def straight_bevel_diff_gears(self) -> 'List[_2005.StraightBevelDiffGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGears, constructor.new(_2005.StraightBevelDiffGear))
        return value
