...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2048
from mastapy.system_model.part_model.gears import _1996, _1972
...
class CylindricalGearSet(_1972.GearSet):
    '''CylindricalGearSet
    ...
    def axial_contact_ratio_requirement(self) -> 'overridable.Overridable_ContactRatioRequirements':
        ...
        return constructor.new(overridable.Overridable_ContactRatioRequirements)(self.wrapped.AxialContactRatioRequirement) if self.wrapped.AxialContactRatioRequirement else None
    ...
    def axial_contact_ratio_requirement(self, value: 'overridable.Overridable_ContactRatioRequirements.implicit_type()'):
        wrapper_type = overridable.Overridable_ContactRatioRequirements.TYPE
    ...
    def transverse_contact_ratio_requirement(self) -> 'overridable.Overridable_ContactRatioRequirements':
        ...
        return constructor.new(overridable.Overridable_ContactRatioRequirements)(self.wrapped.TransverseContactRatioRequirement) if self.wrapped.TransverseContactRatioRequirement else None
    ...
    @property
    def safety_factor_of_maximum_axial_contact_ratio(self) -> 'overridable.Overridable_float':
        '''overridable.Overridable_float: 'SafetyFactorOfMaximumAxialContactRatio' is the original name of this property.'''

        return constructor.new(overridable.Overridable_float)(self.wrapped.SafetyFactorOfMaximumAxialContactRatio) if self.wrapped.SafetyFactorOfMaximumAxialContactRatio else None

    @safety_factor_of_maximum_axial_contact_ratio.setter
    def safety_factor_of_maximum_axial_contact_ratio(self, value: 'overridable.Overridable_float.implicit_type()'):
        wrapper_type = overridable.Overridable_float.TYPE
        enclosed_type = overridable.Overridable_float.implicit_type()
        value = wrapper_type[enclosed_type](enclosed_type(value) if value else 0.0)
        self.wrapped.SafetyFactorOfMaximumAxialContactRatio = value

    @property
    def safety_factor_of_maximum_transverse_contact_ratio(self) -> 'overridable.Overridable_float':
        '''overridable.Overridable_float: 'SafetyFactorOfMaximumTransverseContactRatio' is the original name of this property.'''

        return constructor.new(overridable.Overridable_float)(self.wrapped.SafetyFactorOfMaximumTransverseContactRatio) if self.wrapped.SafetyFactorOfMaximumTransverseContactRatio else None

    @safety_factor_of_maximum_transverse_contact_ratio.setter
    def safety_factor_of_maximum_transverse_contact_ratio(self, value: 'overridable.Overridable_float.implicit_type()'):
        wrapper_type = overridable.Overridable_float.TYPE
        enclosed_type = overridable.Overridable_float.implicit_type()
        value = wrapper_type[enclosed_type](enclosed_type(value) if value else 0.0)
        self.wrapped.SafetyFactorOfMaximumTransverseContactRatio = value
    ...
    @property
    def active_gear_set_design(self) -> '_386.CylindricalGearSetDesign':
    ...
    @property
    def supercharger_rotor_set(self) -> '_2048.SuperchargerRotorSet':
        ...
        return constructor.new(_2048.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_1996.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_1996.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1798.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1798.CylindricalGearMesh))
        return value

    @property
    def gear_set_designs(self) -> 'List[_386.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_386.CylindricalGearSetDesign))
        return value
