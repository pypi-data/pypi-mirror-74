...
class BevelGear(_2069.AGMAGleasonConicalGear):
    '''BevelGear
    ...
    def bevel_gear_design(self) -> '_917.BevelGearDesign':
        ...
        return constructor.new(_917.BevelGearDesign)(self.wrapped.BevelGearDesign) if self.wrapped.BevelGearDesign else None
    ...
    def bevel_gear_design_of_type_zerol_bevel_gear_design(self) -> '_718.ZerolBevelGearDesign':
        ...
        return constructor.new(_718.ZerolBevelGearDesign)(self.wrapped.BevelGearDesign) if self.wrapped.BevelGearDesign else None
    ...
    def bevel_gear_design_of_type_straight_bevel_diff_gear_design(self) -> '_727.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_727.StraightBevelDiffGearDesign)(self.wrapped.BevelGearDesign) if self.wrapped.BevelGearDesign else None
    ...
    def bevel_gear_design_of_type_spiral_bevel_gear_design(self) -> '_735.SpiralBevelGearDesign':
        ...
        return constructor.new(_735.SpiralBevelGearDesign)(self.wrapped.BevelGearDesign) if self.wrapped.BevelGearDesign else None
