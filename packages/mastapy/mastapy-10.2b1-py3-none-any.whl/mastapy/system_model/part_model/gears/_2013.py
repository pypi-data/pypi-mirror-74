...
class KlingelnbergCycloPalloidSpiralBevelGear(_2000.KlingelnbergCycloPalloidConicalGear):
    '''KlingelnbergCycloPalloidSpiralBevelGear
    ...
    @property
    def conical_gear_design(self) -> '_506.KlingelnbergCycloPalloidSpiralBevelGearDesign':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_design(self) -> '_506.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        return constructor.new(_506.KlingelnbergCycloPalloidSpiralBevelGearDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearDesign) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearDesign else None
