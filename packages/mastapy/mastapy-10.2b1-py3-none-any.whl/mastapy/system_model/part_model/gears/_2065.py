...
from mastapy.system_model.part_model.gears import _2064, _2071
...
class CylindricalGearSet(_2071.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_786.CylindricalGearSetDesign':
        ...
        return constructor.new(_786.CylindricalGearSetDesign)(self.wrapped.ActiveGearSetDesign) if self.wrapped.ActiveGearSetDesign else None
    ...
    @property
    def supercharger_rotor_set(self) -> '_2102.SuperchargerRotorSet':
        ...
        return constructor.new(_2102.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_2064.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2064.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1870.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1870.CylindricalGearMesh))
        return value

    @property
    def gear_set_designs(self) -> 'List[_786.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_786.CylindricalGearSetDesign))
        return value
