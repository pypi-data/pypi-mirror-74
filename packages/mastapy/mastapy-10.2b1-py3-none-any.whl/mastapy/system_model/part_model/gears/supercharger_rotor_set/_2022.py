...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import (
    _2024, _2017, _2019, _2014,
    _2016, _2015, _2018
)
from mastapy.utility.databases import _74
...
class SuperchargerRotorSet(_74.NamedDatabaseItem):
    '''SuperchargerRotorSet
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2024.YVariableForImportedData':
        ...
        return constructor.new(_2024.YVariableForImportedData)(value) if value else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2024.YVariableForImportedData'):
    ...
    @property
    def file(self) -> '_2017.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2017.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File else None

    @property
    def rotor_speed(self) -> '_2019.RotorSpeedInputOptions':
        ...
        return constructor.new(_2019.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed else None

    @property
    def boost_pressure(self) -> '_2014.BoostPressureInputOptions':
        ...
        return constructor.new(_2014.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure else None

    @property
    def pressure_ratio(self) -> '_2016.PressureRatioInputOptions':
        ...
        return constructor.new(_2016.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio else None

    @property
    def input_power(self) -> '_2015.InputPowerInputOptions':
        ...
        return constructor.new(_2015.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower else None

    @property
    def measured_points(self) -> 'List[_2018.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2018.RotorSetMeasuredPoint))
        return value
