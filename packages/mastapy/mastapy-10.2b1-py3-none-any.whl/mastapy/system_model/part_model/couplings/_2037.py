...
from mastapy.system_model.part_model.couplings import _2045, _2046, _2030
...
class TorqueConverter(_2030.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2045.TorqueConverterPump':
        ...
        return constructor.new(_2045.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2046.TorqueConverterTurbine':
        ...
        return constructor.new(_2046.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
