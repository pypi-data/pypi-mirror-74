...
from mastapy.system_model.part_model.couplings import _2001
...
class RollingRing(_2001.CouplingHalf):
    '''RollingRing
    ...
    @property
    def largest_end(self) -> '_310.Hand':
    ...
    @largest_end.setter
    def largest_end(self, value: '_310.Hand'):
