...
from mastapy.system_model.part_model.couplings import _2111, _2123
...
class BeltDrive(_2016.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2111.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2111.BeltDriveType)(value) if value else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2111.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2123.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2123.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_1831.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_1831.BeltConnection))
        return value
