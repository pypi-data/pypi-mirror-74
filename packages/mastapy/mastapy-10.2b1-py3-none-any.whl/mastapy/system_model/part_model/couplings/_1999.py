...
from mastapy.system_model.part_model.couplings import _2030, _2031, _1975
...
class TorqueConverter(_1975.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2030.TorqueConverterPump':
        ...
        return constructor.new(_2030.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2031.TorqueConverterTurbine':
        ...
        return constructor.new(_2031.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
