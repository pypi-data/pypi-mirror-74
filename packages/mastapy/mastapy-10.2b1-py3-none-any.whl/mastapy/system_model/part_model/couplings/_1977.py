...
from mastapy.system_model.part_model.couplings import _2034, _2033
...
class Synchroniser(_1937.SpecialisedAssembly):
    ...
    @property
    def hub_and_sleeve(self) -> '_2034.SynchroniserSleeve':
        ...
        return constructor.new(_2034.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve else None

    @property
    def left_cone(self) -> '_2033.SynchroniserHalf':
        ...
        return constructor.new(_2033.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone else None

    @property
    def right_cone(self) -> '_2033.SynchroniserHalf':
        ...
        return constructor.new(_2033.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone else None
