...
from mastapy.system_model.part_model.couplings import _2075, _2029
...
class SynchroniserHalf(_2029.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2075.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2075.SynchroniserCone))
        return value
