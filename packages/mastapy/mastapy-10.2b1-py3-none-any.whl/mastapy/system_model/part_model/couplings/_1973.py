...
from mastapy.system_model.part_model.couplings import _2068, _2017
...
class BeltDrive(_1937.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2068.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2068.BeltDriveType)(value) if value else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2068.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2017.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2017.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_1760.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_1760.BeltConnection))
        return value
