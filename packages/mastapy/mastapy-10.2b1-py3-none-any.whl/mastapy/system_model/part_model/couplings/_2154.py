...
from mastapy.system_model.part_model.couplings import _2153, _2155
...
class SynchroniserHalf(_2155.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2153.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2153.SynchroniserCone))
        return value
