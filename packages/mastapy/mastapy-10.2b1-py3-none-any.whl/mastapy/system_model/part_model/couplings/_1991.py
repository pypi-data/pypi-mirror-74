...
from mastapy.system_model.part_model.couplings import _2021, _2022, _1974
...
class TorqueConverter(_1974.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2021.TorqueConverterPump':
        ...
        return constructor.new(_2021.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2022.TorqueConverterTurbine':
        ...
        return constructor.new(_2022.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
