...
from mastapy.system_model.part_model.couplings import _2002, _2026
...
class CVTPulley(_2026.Pulley):
    ...
    def sliding_connection(self, value: 'list_with_selected_item.ListWithSelectedItem_ShaftHubConnection.implicit_type()'):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_ShaftHubConnection.TYPE
