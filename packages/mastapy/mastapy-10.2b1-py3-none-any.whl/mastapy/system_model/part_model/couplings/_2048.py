...
from mastapy.system_model.part_model.couplings import _2073, _2044
...
class SynchroniserHalf(_2044.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2073.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2073.SynchroniserCone))
        return value
