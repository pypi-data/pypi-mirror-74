...
class ShaftHubConnection(_1915.Connector):
    ...
    @property
    def nonlinear_stiffness(self) -> '_83.DiagonalNonlinearStiffness':
        ...
        return constructor.new(_83.DiagonalNonlinearStiffness)(self.wrapped.NonlinearStiffness) if self.wrapped.NonlinearStiffness else None
