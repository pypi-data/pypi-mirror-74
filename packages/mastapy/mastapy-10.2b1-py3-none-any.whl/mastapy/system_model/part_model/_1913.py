...
class ComponentsConnectedResult(_1.APIBase):
    '''ComponentsConnectedResult
    ...
    @property
    def created_socket_connection(self) -> '_1914.ConnectedSockets':
        ...
        return constructor.new(_1914.ConnectedSockets)(self.wrapped.CreatedSocketConnection) if self.wrapped.CreatedSocketConnection else None
