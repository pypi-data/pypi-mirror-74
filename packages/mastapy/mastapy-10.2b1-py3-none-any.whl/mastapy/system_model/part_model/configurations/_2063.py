...
TPart = TypeVar('TPart', bound='_1931.Part')
TSelectableItem = TypeVar('TSelectableItem')


class PartDetailSelection(_1.APIBase, Generic[TPart, TSelectableItem]):
    '''PartDetailSelection
    ...
    def selection(self, value: 'list_with_selected_item.ListWithSelectedItem_TSelectableItem.implicit_type()'):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_TSelectableItem.TYPE
