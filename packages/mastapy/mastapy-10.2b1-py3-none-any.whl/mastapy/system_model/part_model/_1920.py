...
class FlexiblePinAssembly(_1937.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_1996.CylindricalGear':
        ...
        return constructor.new(_1996.CylindricalGear)(self.wrapped.PlanetGear) if self.wrapped.PlanetGear else None
