...
class Shaft(_1906.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def cad_guide_alignment(self) -> 'Callable[[], None]':
        '''Callable[[], None]: 'CADGuideAlignment' is the original name of this property.'''

        return self.wrapped.CADGuideAlignment

    @cad_guide_alignment.setter
    def cad_guide_alignment(self, value: 'Callable[[], None]'):
        value = value if value else None
        self.wrapped.CADGuideAlignment = value
    ...
    def cad_model(self, value: 'list_with_selected_item.ListWithSelectedItem_GuideDxfModel.implicit_type()'):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_GuideDxfModel.TYPE
    ...
    @property
    def import_shaft(self) -> 'Callable[[], None]':
        '''Callable[[], None]: 'ImportShaft' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.ImportShaft
    ...
    @property
    def guide_image(self) -> '_1922.GuideImage':
        ...
        return constructor.new(_1922.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None

    @property
    def active_definition(self) -> '_68.SimpleShaftDefinition':
        ...
        return constructor.new(_68.SimpleShaftDefinition)(self.wrapped.ActiveDefinition) if self.wrapped.ActiveDefinition else None
    ...
    def mount_component(self, component: '_1928.MountableComponent', offset: 'float'):
