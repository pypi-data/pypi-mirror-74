...
from mastapy.math_utility import _1088
...
class ShaftBow(_0.APIBase):
    ...
    @property
    def linear_displacement(self) -> 'List[_1088.Vector4D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LinearDisplacement, constructor.new(_1088.Vector4D))
        return value
