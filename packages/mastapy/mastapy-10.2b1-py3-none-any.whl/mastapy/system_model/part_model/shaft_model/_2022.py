...
class Shaft(_1982.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_1999.GuideImage':
        ...
        return constructor.new(_1999.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_2006.MountableComponent', offset: 'float'):
