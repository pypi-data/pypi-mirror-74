...
class Shaft(_1981.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_1998.GuideImage':
        ...
        return constructor.new(_1998.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_2005.MountableComponent', offset: 'float'):
