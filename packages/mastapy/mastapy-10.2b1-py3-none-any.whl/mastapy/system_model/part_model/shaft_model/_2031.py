...
class Shaft(_1991.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2008.GuideImage':
        ...
        return constructor.new(_2008.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_2015.MountableComponent', offset: 'float'):
