...
class WindTurbineSingleBladeDetails(_1.APIBase):
    '''WindTurbineSingleBladeDetails
    ...
    @property
    def edgewise_modes(self) -> '_1940.WindTurbineBladeModeDetails':
        ...
        return constructor.new(_1940.WindTurbineBladeModeDetails)(self.wrapped.EdgewiseModes) if self.wrapped.EdgewiseModes else None

    @property
    def flapwise_modes(self) -> '_1940.WindTurbineBladeModeDetails':
        ...
        return constructor.new(_1940.WindTurbineBladeModeDetails)(self.wrapped.FlapwiseModes) if self.wrapped.FlapwiseModes else None
