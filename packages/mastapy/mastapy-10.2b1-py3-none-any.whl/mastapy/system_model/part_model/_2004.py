...
from mastapy.system_model.connections_and_sockets import _1849, _1866
...
class Component(_2026.Part):
    ...
    @property
    def twod_drawing_full_model(self) -> '_6525.SMTBitmap':
        ...
        return constructor.new(_6525.SMTBitmap)(self.wrapped.TwoDDrawingFullModel) if self.wrapped.TwoDDrawingFullModel else None
    ...
    @property
    def component_connections(self) -> 'List[_1849.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1849.ComponentConnection))
        return value
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1067.CoordinateSystem3D') -> '_1866.RealignmentResult':
        ...
        return constructor.new(_1866.RealignmentResult)(method_result) if method_result else None

    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_1866.RealignmentResult':
