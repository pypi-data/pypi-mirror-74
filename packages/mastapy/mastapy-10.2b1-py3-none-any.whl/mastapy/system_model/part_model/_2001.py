...
from mastapy.bearings.bearing_results import _1593, _1592
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    @property
    def mounting_sleeve_material(self) -> '_52.BearingMaterial':
        ...
        return constructor.new(_52.BearingMaterial)(self.wrapped.MountingSleeveMaterial) if self.wrapped.MountingSleeveMaterial else None
