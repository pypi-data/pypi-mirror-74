...
from mastapy.geometry import _113
from mastapy.system_model.part_model.projections import _2042
from mastapy.system_model.part_model.part_groups import _2047
...
class RootAssembly(_1995.Assembly):
    '''RootAssembly
    ...
    @property
    def packaging_limits(self) -> '_113.PackagingLimits':
        ...
        return constructor.new(_113.PackagingLimits)(self.wrapped.PackagingLimits) if self.wrapped.PackagingLimits else None

    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_2042.SpecifiedParallelPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroupsDrawingOrder, constructor.new(_2042.SpecifiedParallelPartGroupDrawingOrder))
        return value

    @property
    def parallel_part_groups(self) -> 'List[_2047.ParallelPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroups, constructor.new(_2047.ParallelPartGroup))
        return value
