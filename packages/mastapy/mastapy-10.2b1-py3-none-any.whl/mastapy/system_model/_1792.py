...
from mastapy.utility_gui import _1497
from mastapy import _3, _6500, _0
...
from mastapy.system_model.part_model import (
    _2016, _2013, _2015, _2009,
    _1980, _1981, _1982, _1985,
    _1987, _1988, _1989, _1992,
    _1993, _1996, _1997, _1998,
    _2001, _2004, _2005, _2006,
    _2008, _2010, _2012, _2017,
    _2018, _2019
)
from mastapy.gears import _124, _130
from mastapy.gears.materials import _382
from mastapy.utility import _1132, _1131, _1130
from mastapy.system_model import _1811, _1810
from mastapy.shafts import _34
from mastapy.detailed_rigid_connectors.splines import _974
from mastapy._math.vector_3d import Vector3D
from mastapy.system_model.part_model.gears import (
    _2051, _2072, _2052, _2053,
...
from mastapy.system_model.imported_fes import _1914
from mastapy.bearings.bearing_results.rolling import _1594
from mastapy.system_model.part_model.configurations import _2147, _2145, _2148
from mastapy.system_model.analyses_and_results.load_case_groups import _5236, _5237
...
from mastapy.system_model.database_access import _1831
from mastapy.bearings.bearing_designs.rolling import _1758
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2477
...
from mastapy.gears.gear_designs.creation_options import _880, _883, _882
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self) -> '_1497.MASTAGUI':
        ...
        return constructor.new(_1497.MASTAGUI)(self.wrapped.MastaGUI) if self.wrapped.MastaGUI else None
    ...
    @property
    def efficiency_rating_method_for_bearings(self) -> '_97.BearingEfficiencyRatingMethod':
        ...
        return constructor.new(_97.BearingEfficiencyRatingMethod)(value) if value else None

    @efficiency_rating_method_for_bearings.setter
    def efficiency_rating_method_for_bearings(self, value: '_97.BearingEfficiencyRatingMethod'):
    ...
    @property
    def transverse_contact_ratio_requirement(self) -> '_124.ContactRatioRequirements':
        ...
        return constructor.new(_124.ContactRatioRequirements)(value) if value else None

    @transverse_contact_ratio_requirement.setter
    def transverse_contact_ratio_requirement(self, value: '_124.ContactRatioRequirements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TransverseContactRatioRequirement = value

    @property
    def axial_contact_ratio_requirement(self) -> '_124.ContactRatioRequirements':
    ...
    def axial_contact_ratio_requirement(self, value: '_124.ContactRatioRequirements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_external_external_meshes(self) -> '_382.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_382.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes else None

    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_internal_external_meshes(self) -> '_382.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_382.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes else None

    @property
    def file_save_details_most_recent(self) -> '_1132.FileHistoryItem':
        ...
        return constructor.new(_1132.FileHistoryItem)(self.wrapped.FileSaveDetailsMostRecent) if self.wrapped.FileSaveDetailsMostRecent else None

    @property
    def default_system_temperatures(self) -> '_1811.TransmissionTemperatureSet':
        ...
        return constructor.new(_1811.TransmissionTemperatureSet)(self.wrapped.DefaultSystemTemperatures) if self.wrapped.DefaultSystemTemperatures else None
    ...
    @property
    def detailed_spline_settings(self) -> '_974.DetailedSplineJointSettings':
        ...
        return constructor.new(_974.DetailedSplineJointSettings)(self.wrapped.DetailedSplineSettings) if self.wrapped.DetailedSplineSettings else None
    ...
    @property
    def file_save_details_all(self) -> '_1131.FileHistory':
        ...
        return constructor.new(_1131.FileHistory)(self.wrapped.FileSaveDetailsAll) if self.wrapped.FileSaveDetailsAll else None

    @property
    def gear_set_design_group(self) -> '_130.GearSetDesignGroup':
        ...
        return constructor.new(_130.GearSetDesignGroup)(self.wrapped.GearSetDesignGroup) if self.wrapped.GearSetDesignGroup else None

    @property
    def selected_gear_set_selection_group(self) -> '_2051.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_2051.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None

    @property
    def system(self) -> '_1810.SystemReporting':
        ...
        return constructor.new(_1810.SystemReporting)(self.wrapped.System) if self.wrapped.System else None

    @property
    def fe_batch_operations(self) -> '_1914.BatchOperations':
        ...
        return constructor.new(_1914.BatchOperations)(self.wrapped.FEBatchOperations) if self.wrapped.FEBatchOperations else None

    @property
    def iso14179_settings_per_bearing_type(self) -> 'List[_1594.ISO14179SettingsPerBearingType]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISO14179SettingsPerBearingType, constructor.new(_1594.ISO14179SettingsPerBearingType))
        return value

    @property
    def gear_set_configurations(self) -> 'List[_2051.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_2051.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_2147.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2147.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def imported_fe_configurations(self) -> 'List[_2145.ActiveImportedFESelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEConfigurations, constructor.new(_2145.ActiveImportedFESelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2148.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2148.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_5236.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5236.DesignState))
        return value
    ...
    @property
    def duty_cycles(self) -> 'List[_5237.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_5237.DutyCycle))
        return value

    @property
    def root_assembly(self) -> '_2015.RootAssembly':
        ...
        return constructor.new(_2015.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly else None

    @property
    def gear_set_config(self) -> '_2072.GearSetConfiguration':
        '''GearSetConfiguration: 'GearSetConfig' is the original name of this property.'''

        return constructor.new(_2072.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig else None

    @gear_set_config.setter
    def gear_set_config(self, value: '_2072.GearSetConfiguration'):
    ...
    @property
    def databases(self) -> '_1831.Databases':
        ...
        return constructor.new(_1831.Databases)(self.wrapped.Databases) if self.wrapped.Databases else None
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_1758.RollingBearing'):
    ...
    def design_state_named(self, name: 'str') -> '_5236.DesignState':
        ...
        return constructor.new(_5236.DesignState)(method_result) if method_result else None

    def duty_cycle_named(self, name: 'str') -> '_5237.DutyCycle':
        ...
        return constructor.new(_5237.DutyCycle)(method_result) if method_result else None
    ...
    def save(self, file_name: 'str', save_results: 'bool') -> '_1311.Status':
        ...
        return constructor.new(_1311.Status)(method_result) if method_result else None

    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_6500.TaskProgress') -> '_1311.Status':
        ''' 'Save' is the original name of this method.
    ...
    def remove_synchroniser_shift(self, shift: '_2477.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2477.SynchroniserShift':
        ...
        return constructor.new(_2477.SynchroniserShift)(method_result) if method_result else None

    def add_synchroniser_shift_empty(self) -> '_2477.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5236.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5237.DutyCycle':
    ...
    def all_parts_of_type_assembly(self) -> 'List[_1980.Assembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1980.Assembly.TYPE](), constructor.new(_1980.Assembly))
    ...
    @staticmethod
    def load(file_path: 'str', load_full_fe_option: Optional['_1130.ExternalFullFEFileOption'] = _1130.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS) -> 'Design':
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.1, pulley_b_diameter: Optional['float'] = 0.1, name: Optional['str'] = 'Belt Drive') -> '_2107.BeltCreationOptions':
        ...
        return constructor.new(_2107.BeltCreationOptions)(method_result) if method_result else None

    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.1) -> '_2109.PlanetCarrierCreationOptions':
        ...
        return constructor.new(_2109.PlanetCarrierCreationOptions)(method_result) if method_result else None

    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.0, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2110.ShaftCreationOptions':
        ...
        return constructor.new(_2110.ShaftCreationOptions)(method_result) if method_result else None

    def new_cylindrical_gear_pair_creation_options(self) -> '_880.CylindricalGearPairCreationOptions':
        ...
        return constructor.new(_880.CylindricalGearPairCreationOptions)(method_result) if method_result else None

    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2108.CylindricalGearLinearTrainCreationOptions':
        ...
        return constructor.new(_2108.CylindricalGearLinearTrainCreationOptions)(method_result) if method_result else None

    def new_spiral_bevel_gear_set_creation_options(self) -> '_883.SpiralBevelGearSetCreationOptions':
        ...
        return constructor.new(_883.SpiralBevelGearSetCreationOptions)(method_result) if method_result else None

    def new_hypoid_gear_set_creation_options(self) -> '_882.HypoidGearSetCreationOptions':
        ...
        return constructor.new(_882.HypoidGearSetCreationOptions)(method_result) if method_result else None

    def new_nodal_matrix(self, dense_matrix: 'List[List[float]]') -> '_1384.NodalMatrix':
        ...
        return constructor.new(_1384.NodalMatrix)(method_result) if method_result else None
