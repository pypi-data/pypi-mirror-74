...
from mastapy.system_model.connections_and_sockets import _1874
...
class SocketConnectionOptions(_0.APIBase):
    '''SocketConnectionOptions
    ...
    @property
    def sockets(self) -> 'List[_1874.SocketConnectionSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Sockets, constructor.new(_1874.SocketConnectionSelection))
        return value
