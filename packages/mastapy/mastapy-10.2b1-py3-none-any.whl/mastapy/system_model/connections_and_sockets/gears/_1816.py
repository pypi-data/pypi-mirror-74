...
class StraightBevelGearMesh(_1792.BevelGearMesh):
    '''StraightBevelGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_425.StraightBevelGearMeshDesign':
    ...
    @property
    def straight_bevel_gear_mesh_design(self) -> '_425.StraightBevelGearMeshDesign':
        ...
        return constructor.new(_425.StraightBevelGearMeshDesign)(self.wrapped.StraightBevelGearMeshDesign) if self.wrapped.StraightBevelGearMeshDesign else None
