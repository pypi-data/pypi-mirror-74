...
class ConceptGearMesh(_1874.GearMesh):
    '''ConceptGearMesh
    ...
    @property
    def concept_gear_mesh_design(self) -> '_911.ConceptGearMeshDesign':
        ...
        return constructor.new(_911.ConceptGearMeshDesign)(self.wrapped.ConceptGearMeshDesign) if self.wrapped.ConceptGearMeshDesign else None
