...
class WormGearMesh(_1802.GearMesh):
    '''WormGearMesh
    ...
    @property
    def worm_gear_mesh_design(self) -> '_445.WormGearMeshDesign':
        ...
        return constructor.new(_445.WormGearMeshDesign)(self.wrapped.WormGearMeshDesign) if self.wrapped.WormGearMeshDesign else None
