...
class WormGearMesh(_1889.GearMesh):
    '''WormGearMesh
    ...
    @property
    def worm_gear_mesh_design(self) -> '_724.WormGearMeshDesign':
        ...
        return constructor.new(_724.WormGearMeshDesign)(self.wrapped.WormGearMeshDesign) if self.wrapped.WormGearMeshDesign else None
