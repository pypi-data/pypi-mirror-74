...
class ConceptGearMesh(_1802.GearMesh):
    '''ConceptGearMesh
    ...
    @property
    def concept_gear_mesh_design(self) -> '_561.ConceptGearMeshDesign':
        ...
        return constructor.new(_561.ConceptGearMeshDesign)(self.wrapped.ConceptGearMeshDesign) if self.wrapped.ConceptGearMeshDesign else None
