...
class StraightBevelGearMesh(_1879.BevelGearMesh):
    '''StraightBevelGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_732.StraightBevelGearMeshDesign':
    ...
    @property
    def straight_bevel_gear_mesh_design(self) -> '_732.StraightBevelGearMeshDesign':
        ...
        return constructor.new(_732.StraightBevelGearMeshDesign)(self.wrapped.StraightBevelGearMeshDesign) if self.wrapped.StraightBevelGearMeshDesign else None
