...
from mastapy.system_model.connections_and_sockets.gears import _1860
...
class BevelGearMesh(_1860.AGMAGleasonConicalGearMesh):
    '''BevelGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_915.BevelGearMeshDesign':
        ...
        return constructor.new(_915.BevelGearMeshDesign)(self.wrapped.BevelGearMeshDesign) if self.wrapped.BevelGearMeshDesign else None
