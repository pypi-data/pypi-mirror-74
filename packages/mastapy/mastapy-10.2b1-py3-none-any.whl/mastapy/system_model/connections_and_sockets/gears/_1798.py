...
class CylindricalGearMesh(_1802.GearMesh):
    '''CylindricalGearMesh
    ...
    @property
    def cylindrical_gear_set(self) -> '_1968.CylindricalGearSet':
        ...
        return constructor.new(_1968.CylindricalGearSet)(self.wrapped.CylindricalGearSet) if self.wrapped.CylindricalGearSet else None

    @property
    def centre_distance_range(self) -> '_1109.ShortLengthRange':
        ...
        return constructor.new(_1109.ShortLengthRange)(self.wrapped.CentreDistanceRange) if self.wrapped.CentreDistanceRange else None

    @property
    def cylindrical_gear_mesh_design(self) -> '_528.CylindricalGearMeshDesign':
        ...
        return constructor.new(_528.CylindricalGearMeshDesign)(self.wrapped.CylindricalGearMeshDesign) if self.wrapped.CylindricalGearMeshDesign else None
