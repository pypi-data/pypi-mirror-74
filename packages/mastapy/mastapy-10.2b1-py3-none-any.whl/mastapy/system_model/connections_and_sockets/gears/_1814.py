...
class StraightBevelDiffGearMesh(_1792.BevelGearMesh):
    '''StraightBevelDiffGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_443.StraightBevelDiffGearMeshDesign':
    ...
    @property
    def straight_bevel_diff_gear_mesh_design(self) -> '_443.StraightBevelDiffGearMeshDesign':
        ...
        return constructor.new(_443.StraightBevelDiffGearMeshDesign)(self.wrapped.StraightBevelDiffGearMeshDesign) if self.wrapped.StraightBevelDiffGearMeshDesign else None
