...
class FaceGearMesh(_1802.GearMesh):
    '''FaceGearMesh
    ...
    @property
    def face_gear_mesh_design(self) -> '_559.FaceGearMeshDesign':
        ...
        return constructor.new(_559.FaceGearMeshDesign)(self.wrapped.FaceGearMeshDesign) if self.wrapped.FaceGearMeshDesign else None
