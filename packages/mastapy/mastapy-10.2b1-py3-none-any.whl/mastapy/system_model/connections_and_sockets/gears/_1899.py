...
class SpiralBevelGearMesh(_1879.BevelGearMesh):
    '''SpiralBevelGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_736.SpiralBevelGearMeshDesign':
    ...
    @property
    def spiral_bevel_gear_mesh_design(self) -> '_736.SpiralBevelGearMeshDesign':
        ...
        return constructor.new(_736.SpiralBevelGearMeshDesign)(self.wrapped.SpiralBevelGearMeshDesign) if self.wrapped.SpiralBevelGearMeshDesign else None
