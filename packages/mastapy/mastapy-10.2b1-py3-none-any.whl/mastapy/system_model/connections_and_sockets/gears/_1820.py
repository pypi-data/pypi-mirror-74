...
class ZerolBevelGearMesh(_1792.BevelGearMesh):
    '''ZerolBevelGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_427.ZerolBevelGearMeshDesign':
    ...
    @property
    def zerol_bevel_gear_mesh_design(self) -> '_427.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_427.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMeshDesign) if self.wrapped.ZerolBevelGearMeshDesign else None
