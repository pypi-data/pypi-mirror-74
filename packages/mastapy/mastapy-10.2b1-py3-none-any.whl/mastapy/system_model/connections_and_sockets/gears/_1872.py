...
class FaceGearMesh(_1874.GearMesh):
    '''FaceGearMesh
    ...
    @property
    def face_gear_mesh_design(self) -> '_756.FaceGearMeshDesign':
        ...
        return constructor.new(_756.FaceGearMeshDesign)(self.wrapped.FaceGearMeshDesign) if self.wrapped.FaceGearMeshDesign else None
