...
from mastapy.nodal_analysis.dev_tools_analyses import _1465
...
class ImportedFEWithSelectionForHarmonicAnalysis(_1964.ImportedFEWithSelection):
    '''ImportedFEWithSelectionForHarmonicAnalysis
    ...
    @property
    def harmonic_draw_style(self) -> '_1465.FEModelHarmonicAnalysisDrawStyle':
        ...
        return constructor.new(_1465.FEModelHarmonicAnalysisDrawStyle)(self.wrapped.HarmonicDrawStyle) if self.wrapped.HarmonicDrawStyle else None
