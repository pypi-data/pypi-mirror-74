...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _195
...
class MaterialPropertiesWithSelection(_1.APIBase):
    '''MaterialPropertiesWithSelection
    ...
    @property
    def material_properties(self) -> '_195.MaterialPropertiesReporting':
        ...
        return constructor.new(_195.MaterialPropertiesReporting)(self.wrapped.MaterialProperties) if self.wrapped.MaterialProperties else None
