...
from mastapy.nodal_analysis.component_mode_synthesis import _216
...
class ImportedFE(_91.FEStiffness):
    ...
    @property
    def cms_model(self) -> '_216.FullFEModel':
        ...
        return constructor.new(_216.FullFEModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None
    ...
    @property
    def thermal_expansion_forces(self) -> 'List[_1253.VectorWithLinearAndAngularComponents[_1306.ForcePerUnitTemperature, _1370.TorquePerUnitTemperature]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1253.VectorWithLinearAndAngularComponents)[_1306.ForcePerUnitTemperature, _1370.TorquePerUnitTemperature])
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1253.VectorWithLinearAndAngularComponents[_1324.LengthPerUnitTemperature, _1283.AnglePerUnitTemperature]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1253.VectorWithLinearAndAngularComponents)[_1324.LengthPerUnitTemperature, _1283.AnglePerUnitTemperature])
        return value
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_312.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
