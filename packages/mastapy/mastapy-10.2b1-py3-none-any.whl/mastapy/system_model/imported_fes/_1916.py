...
from mastapy.system_model.imported_fes import _1917
...
class BearingRaceNodeLink(_0.APIBase):
    ...
    @property
    def race_position(self) -> '_1917.BearingRacePosition':
        ...
        return constructor.new(_1917.BearingRacePosition)(value) if value else None
