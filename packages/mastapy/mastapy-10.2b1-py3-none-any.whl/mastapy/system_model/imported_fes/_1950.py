...
from mastapy.utility.units_and_measurements import _1160
from mastapy.system_model.imported_fes import (
    _1930, _1963, _1987, _1924,
    _1926, _1988, _1983, _1962,
    _1922, _1946, _1949, _1969,
    _1968, _1965, _1966, _1967
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2008, _2004, _2016
from mastapy.nodal_analysis import _1382, _1375, _1378
from mastapy.nodal_analysis.component_mode_synthesis import _1498
from mastapy.system_model import _1823
from mastapy.math_utility import _1067
from mastapy.materials import _44, _88
...
class ImportedFE(_1378.FEStiffness):
    '''ImportedFE
    ...
    @property
    def bearing_node_alignment(self) -> '_1930.BearingNodeAlignmentOption':
        ...
        return constructor.new(_1930.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_1930.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_1924.AlignmentMethod':
        ...
        return constructor.new(_1924.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1924.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def gravity_force_source(self) -> '_1382.GravityForceSource':
        ...
        return constructor.new(_1382.GravityForceSource)(value) if value else None
    ...
    @property
    def fe_meshing_options(self) -> '_1375.FEMeshingOptions':
        ...
        return constructor.new(_1375.FEMeshingOptions)(self.wrapped.FEMeshingOptions) if self.wrapped.FEMeshingOptions else None

    @property
    def cms_model(self) -> '_1498.FullFEModel':
        ...
        return constructor.new(_1498.FullFEModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None

    @property
    def alignment_to_component(self) -> '_1823.RelativeComponentAlignment[_2004.Component]':
        ...
        return constructor.new(_1823.RelativeComponentAlignment)[_2004.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_1926.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_1926.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None

    @property
    def coordinate_system(self) -> '_1067.CoordinateSystem3D':
        ...
        return constructor.new(_1067.CoordinateSystem3D)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None

    @property
    def export(self) -> '_1988.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile':
        ...
        return constructor.new(_1988.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile)(self.wrapped.Export) if self.wrapped.Export else None

    @property
    def acoustic_radiation_efficiency(self) -> '_44.AcousticRadiationEfficiency':
        ...
        return constructor.new(_44.AcousticRadiationEfficiency)(self.wrapped.AcousticRadiationEfficiency) if self.wrapped.AcousticRadiationEfficiency else None

    @property
    def sound_pressure_enclosure(self) -> '_88.SoundPressureEnclosure':
        ...
        return constructor.new(_88.SoundPressureEnclosure)(self.wrapped.SoundPressureEnclosure) if self.wrapped.SoundPressureEnclosure else None

    @property
    def shafts_that_can_be_replaced(self) -> 'List[_1983.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_1983.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_2039.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2039.Shaft))
        return value

    @property
    def links(self) -> 'List[_1922.ImportedFELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1922.ImportedFELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1124.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1124.VectorWithLinearAndAngularComponents))
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1124.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1124.VectorWithLinearAndAngularComponents))
        return value

    @property
    def geometries(self) -> 'List[_1946.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_1946.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_1949.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_1949.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_1969.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_1969.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def imported_fe_component(self) -> '_2016.ImportedFEComponent':
        ...
        return constructor.new(_2016.ImportedFEComponent)(self.wrapped.ImportedFEComponent) if self.wrapped.ImportedFEComponent else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_6522.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_imported_fe_with_selection_static_analysis(self) -> '_1968.ImportedFEWithSelectionStaticAnalysis':
        ...
        return constructor.new(_1968.ImportedFEWithSelectionStaticAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_components(self) -> '_1965.ImportedFEWithSelectionComponents':
        ...
        return constructor.new(_1965.ImportedFEWithSelectionComponents)(method_result) if method_result else None

    def create_imported_fe_with_selection_for_harmonic_analysis(self) -> '_1966.ImportedFEWithSelectionForHarmonicAnalysis':
        ...
        return constructor.new(_1966.ImportedFEWithSelectionForHarmonicAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_modal_analysis(self) -> '_1967.ImportedFEWithSelectionModalAnalysis':
        ...
        return constructor.new(_1967.ImportedFEWithSelectionModalAnalysis)(method_result) if method_result else None

    def links_for(self, node: '_1962.ImportedFEStiffnessNode') -> 'List[_1922.ImportedFELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_1922.ImportedFELink))
