...
from mastapy.system_model.imported_fes import (
    _1841, _1872, _1896, _1835,
    _1837, _1897, _1892, _1871,
    _1833, _1857, _1859, _1878,
    _1877, _1874, _1875, _1876
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _1916, _1912, _1924
from mastapy.nodal_analysis import _87, _91
from mastapy.nodal_analysis.component_mode_synthesis import _217
from mastapy.system_model import _1736
from mastapy.math_utility import _1215
from mastapy.materials import _223
...
class ImportedFE(_91.FEStiffness):
    ...
    @property
    def bearing_node_alignment(self) -> '_1841.BearingNodeAlignmentOption':
        ...
        return constructor.new(_1841.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_1841.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_1835.AlignmentMethod':
        ...
        return constructor.new(_1835.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1835.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def fe_meshing_options(self) -> '_87.FEMeshingOptions':
        ...
        return constructor.new(_87.FEMeshingOptions)(self.wrapped.FEMeshingOptions) if self.wrapped.FEMeshingOptions else None

    @property
    def cms_model(self) -> '_217.FullFEModel':
        ...
        return constructor.new(_217.FullFEModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None

    @property
    def alignment_to_component(self) -> '_1736.RelativeComponentAlignment[_1912.Component]':
        ...
        return constructor.new(_1736.RelativeComponentAlignment)[_1912.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_1837.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_1837.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None

    @property
    def coordinate_system(self) -> '_1215.CoordinateSystem3D':
        ...
        return constructor.new(_1215.CoordinateSystem3D)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None

    @property
    def export(self) -> '_1897.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile':
        ...
        return constructor.new(_1897.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile)(self.wrapped.Export) if self.wrapped.Export else None

    @property
    def acoustic_radiation_efficiency(self) -> '_223.AcousticRadiationEfficiency':
        ...
        return constructor.new(_223.AcousticRadiationEfficiency)(self.wrapped.AcousticRadiationEfficiency) if self.wrapped.AcousticRadiationEfficiency else None

    @property
    def shafts_that_can_be_replaced(self) -> 'List[_1892.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_1892.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_1942.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_1942.Shaft))
        return value

    @property
    def links(self) -> 'List[_1833.ImportedFELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1833.ImportedFELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1253.VectorWithLinearAndAngularComponents[_1305.ForcePerUnitTemperature, _1369.TorquePerUnitTemperature]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1253.VectorWithLinearAndAngularComponents)[_1305.ForcePerUnitTemperature, _1369.TorquePerUnitTemperature])
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1253.VectorWithLinearAndAngularComponents[_1323.LengthPerUnitTemperature, _1282.AnglePerUnitTemperature]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1253.VectorWithLinearAndAngularComponents)[_1323.LengthPerUnitTemperature, _1282.AnglePerUnitTemperature])
        return value

    @property
    def geometries(self) -> 'List[_1857.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_1857.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_1859.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_1859.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_1878.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_1878.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def imported_fe_component(self) -> '_1924.ImportedFEComponent':
        ...
        return constructor.new(_1924.ImportedFEComponent)(self.wrapped.ImportedFEComponent) if self.wrapped.ImportedFEComponent else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_320.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_imported_fe_with_selection_static_analysis(self) -> '_1877.ImportedFEWithSelectionStaticAnalysis':
        ...
        return constructor.new(_1877.ImportedFEWithSelectionStaticAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_components(self) -> '_1874.ImportedFEWithSelectionComponents':
        ...
        return constructor.new(_1874.ImportedFEWithSelectionComponents)(method_result) if method_result else None

    def create_imported_fe_with_selection_for_harmonic_analysis(self) -> '_1875.ImportedFEWithSelectionForHarmonicAnalysis':
        ...
        return constructor.new(_1875.ImportedFEWithSelectionForHarmonicAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_modal_analysis(self) -> '_1876.ImportedFEWithSelectionModalAnalysis':
        ...
        return constructor.new(_1876.ImportedFEWithSelectionModalAnalysis)(method_result) if method_result else None

    def links_for(self, node: '_1871.ImportedFEStiffnessNode') -> 'List[_1833.ImportedFELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_1833.ImportedFELink))
