...
from mastapy.utility.enums import _1443
...
from mastapy.system_model.imported_fes import _1883, _1873
from mastapy.math_utility.measured_vectors import _1253
from mastapy.utility.units_and_measurements.measurements import (
    _1302, _1366, _1326, _1283
)
...
class ImportedFEWithSelectionStaticAnalysis(_1873.ImportedFEWithSelection):
    '''ImportedFEWithSelectionStaticAnalysis
    ...
    def contour_option(self) -> 'enum_with_selected_value.EnumWithSelectedValue_ThreeDViewContourOption':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_ThreeDViewContourOption)(self.wrapped.ContourOption) if self.wrapped.ContourOption else None
    ...
    def contour_option(self, value: 'enum_with_selected_value.EnumWithSelectedValue_ThreeDViewContourOption.implicit_type()'):
        wrapper_type = enum_with_selected_value.EnumWithSelectedValue_ThreeDViewContourOption.TYPE
    ...
    @property
    def full_fe_results(self) -> '_221.StaticCMSResults':
        ...
        return constructor.new(_221.StaticCMSResults)(self.wrapped.FullFEResults) if self.wrapped.FullFEResults else None

    @property
    def static_draw_style(self) -> '_197.FEModelStaticAnalysisDrawStyle':
        ...
        return constructor.new(_197.FEModelStaticAnalysisDrawStyle)(self.wrapped.StaticDrawStyle) if self.wrapped.StaticDrawStyle else None

    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_1883.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsSelectedNodes, constructor.new(_1883.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def boundary_conditions_all_nodes(self) -> 'List[_1883.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAllNodes, constructor.new(_1883.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def force_results(self) -> 'List[_1253.VectorWithLinearAndAngularComponents[_1302.Force, _1366.Torque]]':
        '''List[VectorWithLinearAndAngularComponents[Force, Torque]]: 'ForceResults' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceResults, constructor.new(_1253.VectorWithLinearAndAngularComponents)[_1302.Force, _1366.Torque])
        return value

    @property
    def displacement_results(self) -> 'List[_1253.VectorWithLinearAndAngularComponents[_1326.LengthVeryShort, _1283.AngleSmall]]':
        '''List[VectorWithLinearAndAngularComponents[LengthVeryShort, AngleSmall]]: 'DisplacementResults' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DisplacementResults, constructor.new(_1253.VectorWithLinearAndAngularComponents)[_1326.LengthVeryShort, _1283.AngleSmall])
        return value
