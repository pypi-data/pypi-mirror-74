...
from mastapy.system_model.imported_fes import _1925, _1931
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_1925.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_1925.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1925.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_1931.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1931.BearingRaceNodeLink))
        return value
