...
from mastapy.system_model.imported_fes.version_comparer import _1979
...
class ImportedFEResults(_0.APIBase):
    '''ImportedFEResults
    ...
    @property
    def node_results(self) -> 'List[_1979.NodeComparisonResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_1979.NodeComparisonResult))
        return value
