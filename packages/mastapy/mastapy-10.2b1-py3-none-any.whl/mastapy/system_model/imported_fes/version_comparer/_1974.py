...
from mastapy.system_model.imported_fes.version_comparer import _1977
...
class DesignResults(_0.APIBase):
    '''DesignResults
    ...
    @property
    def load_cases(self) -> 'List[_1977.LoadCaseResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCases, constructor.new(_1977.LoadCaseResults))
        return value
