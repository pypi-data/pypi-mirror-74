...
class ImportedFE(_91.FEStiffness):
    ...
    @property
    def cms_model(self) -> '_221.FullFEModel':
        ...
        return constructor.new(_221.FullFEModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None
    ...
    @property
    def acoustic_radiation_efficiency(self) -> '_227.AcousticRadiationEfficiency':
        ...
        return constructor.new(_227.AcousticRadiationEfficiency)(self.wrapped.AcousticRadiationEfficiency) if self.wrapped.AcousticRadiationEfficiency else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_325.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
