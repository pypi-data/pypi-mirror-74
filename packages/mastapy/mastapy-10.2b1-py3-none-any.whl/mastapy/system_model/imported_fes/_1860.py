...
from mastapy.system_model.imported_fes import _1851, _1865
...
class ImportedFEElectricMachineStatorLink(_1865.ImportedFEMultiNodeLink):
    '''ImportedFEElectricMachineStatorLink
    ...
    @property
    def electric_machine_dynamic_load_data(self) -> '_1851.ElectricMachineDynamicLoadData':
        ...
        return constructor.new(_1851.ElectricMachineDynamicLoadData)(self.wrapped.ElectricMachineDynamicLoadData) if self.wrapped.ElectricMachineDynamicLoadData else None
