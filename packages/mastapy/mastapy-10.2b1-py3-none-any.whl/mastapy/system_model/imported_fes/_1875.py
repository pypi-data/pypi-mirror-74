...
class ImportedFEWithSelectionForHarmonicAnalysis(_1873.ImportedFEWithSelection):
    '''ImportedFEWithSelectionForHarmonicAnalysis
    ...
    @property
    def harmonic_draw_style(self) -> '_183.FEModelHarmonicAnalysisDrawStyle':
        ...
        return constructor.new(_183.FEModelHarmonicAnalysisDrawStyle)(self.wrapped.HarmonicDrawStyle) if self.wrapped.HarmonicDrawStyle else None
