...
from mastapy.bearings.bearing_results.rolling import _1593
from mastapy.system_model.part_model.configurations import _2146, _2144, _2147
...
from mastapy.system_model.database_access import _1830
from mastapy.bearings.bearing_designs.rolling import _1757
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2476
...
class Design(_0.APIBase):
    ...
    @property
    def transverse_contact_ratio_requirement(self) -> '_125.ContactRatioRequirements':
        ...
        return constructor.new(_125.ContactRatioRequirements)(value) if value else None

    @transverse_contact_ratio_requirement.setter
    def transverse_contact_ratio_requirement(self, value: '_125.ContactRatioRequirements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TransverseContactRatioRequirement = value

    @property
    def axial_contact_ratio_requirement(self) -> '_125.ContactRatioRequirements':
    ...
    def axial_contact_ratio_requirement(self, value: '_125.ContactRatioRequirements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_external_external_meshes(self) -> '_383.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_383.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes else None

    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_internal_external_meshes(self) -> '_383.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_383.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes else None
    ...
    @property
    def default_system_temperatures(self) -> '_1810.TransmissionTemperatureSet':
        ...
        return constructor.new(_1810.TransmissionTemperatureSet)(self.wrapped.DefaultSystemTemperatures) if self.wrapped.DefaultSystemTemperatures else None
    ...
    @property
    def gear_set_design_group(self) -> '_131.GearSetDesignGroup':
        ...
        return constructor.new(_131.GearSetDesignGroup)(self.wrapped.GearSetDesignGroup) if self.wrapped.GearSetDesignGroup else None

    @property
    def selected_gear_set_selection_group(self) -> '_2050.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_2050.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None

    @property
    def system(self) -> '_1809.SystemReporting':
        ...
        return constructor.new(_1809.SystemReporting)(self.wrapped.System) if self.wrapped.System else None

    @property
    def fe_batch_operations(self) -> '_1913.BatchOperations':
        ...
        return constructor.new(_1913.BatchOperations)(self.wrapped.FEBatchOperations) if self.wrapped.FEBatchOperations else None

    @property
    def iso14179_settings_per_bearing_type(self) -> 'List[_1593.ISO14179SettingsPerBearingType]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISO14179SettingsPerBearingType, constructor.new(_1593.ISO14179SettingsPerBearingType))
        return value

    @property
    def gear_set_configurations(self) -> 'List[_2050.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_2050.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_2146.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2146.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def imported_fe_configurations(self) -> 'List[_2144.ActiveImportedFESelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEConfigurations, constructor.new(_2144.ActiveImportedFESelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2147.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2147.BearingDetailConfiguration))
        return value
    ...
    @property
    def root_assembly(self) -> '_2014.RootAssembly':
        ...
        return constructor.new(_2014.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly else None

    @property
    def gear_set_config(self) -> '_2071.GearSetConfiguration':
        ...
        return constructor.new(_2071.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig else None
    ...
    @property
    def databases(self) -> '_1830.Databases':
        ...
        return constructor.new(_1830.Databases)(self.wrapped.Databases) if self.wrapped.Databases else None
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_1757.RollingBearing'):
    ...
    def remove_synchroniser_shift(self, shift: '_2476.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2476.SynchroniserShift':
        ...
        return constructor.new(_2476.SynchroniserShift)(method_result) if method_result else None

    def add_synchroniser_shift_empty(self) -> '_2476.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def all_parts_of_type_assembly(self) -> 'List[_1979.Assembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1979.Assembly.TYPE](), constructor.new(_1979.Assembly))
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.1, pulley_b_diameter: Optional['float'] = 0.1, name: Optional['str'] = 'Belt Drive') -> '_2106.BeltCreationOptions':
        ...
        return constructor.new(_2106.BeltCreationOptions)(method_result) if method_result else None

    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.1) -> '_2108.PlanetCarrierCreationOptions':
        ...
        return constructor.new(_2108.PlanetCarrierCreationOptions)(method_result) if method_result else None

    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.0, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2109.ShaftCreationOptions':
        ...
        return constructor.new(_2109.ShaftCreationOptions)(method_result) if method_result else None
    ...
    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2107.CylindricalGearLinearTrainCreationOptions':
        ...
        return constructor.new(_2107.CylindricalGearLinearTrainCreationOptions)(method_result) if method_result else None
