...
from mastapy.system_model.part_model.couplings import _2136, _2138
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2136.SynchroniserHalf':
        ...
        return constructor.new(_2136.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2138.SynchroniserSleeve':
        ...
        return constructor.new(_2138.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
