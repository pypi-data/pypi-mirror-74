...
from mastapy.system_model.part_model.couplings import _2154, _2156
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2154.SynchroniserHalf':
        ...
        return constructor.new(_2154.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2156.SynchroniserSleeve':
        ...
        return constructor.new(_2156.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
