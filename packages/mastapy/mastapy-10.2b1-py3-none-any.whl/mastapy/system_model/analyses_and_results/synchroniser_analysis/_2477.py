...
from mastapy.system_model.part_model.couplings import _2137, _2139
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2137.SynchroniserHalf':
        ...
        return constructor.new(_2137.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2139.SynchroniserSleeve':
        ...
        return constructor.new(_2139.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
