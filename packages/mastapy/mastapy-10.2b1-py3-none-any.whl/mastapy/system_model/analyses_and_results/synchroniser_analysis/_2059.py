...
from mastapy.system_model.part_model.couplings import _2024, _2025
...
class SynchroniserShift(_1.APIBase):
    ...
    @property
    def cone(self) -> '_2024.SynchroniserHalf':
        ...
        return constructor.new(_2024.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2025.SynchroniserSleeve':
        ...
        return constructor.new(_2025.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
