...
from mastapy.system_model.analyses_and_results.load_case_groups import _1968
from mastapy.system_model.part_model.couplings import _2033, _2034
...
class SynchroniserShift(_1.APIBase):
    '''SynchroniserShift
    ...
    def initial_design_state(self, value: 'list_with_selected_item.ListWithSelectedItem_DesignState.implicit_type()'):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_DesignState.TYPE
    ...
    @property
    def cone(self) -> '_2033.SynchroniserHalf':
        ...
        return constructor.new(_2033.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2034.SynchroniserSleeve':
        ...
        return constructor.new(_2034.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
