...
from mastapy.system_model.analyses_and_results.load_case_groups import _5247
from mastapy.system_model.part_model.couplings import _2146, _2148
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2146.SynchroniserHalf':
        ...
        return constructor.new(_2146.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2148.SynchroniserSleeve':
        ...
        return constructor.new(_2148.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
