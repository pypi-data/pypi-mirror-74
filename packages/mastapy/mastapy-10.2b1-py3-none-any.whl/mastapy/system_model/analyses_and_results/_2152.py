...
from mastapy.system_model import _1795
from mastapy.system_model.analyses_and_results.analysis_cases import _6488
...
class CompoundAnalysis:
    ...
    def perform_analysis_with_progress(self, progress: '_6500.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
        ...
        self.wrapped.PerformAnalysis(progress.wrapped if progress else None)

    def results_for(self, design_entity: '_1795.DesignEntity') -> 'Iterable[_6488.DesignEntityCompoundAnalysis]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.ResultsFor(design_entity.wrapped if design_entity else None), constructor.new(_6488.DesignEntityCompoundAnalysis))
