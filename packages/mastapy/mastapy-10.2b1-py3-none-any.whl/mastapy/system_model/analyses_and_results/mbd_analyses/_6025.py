...
_SYNCHRONISER_PART_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'SynchroniserPartMultiBodyDynamicsAnalysis')
...
class SynchroniserPartMultiBodyDynamicsAnalysis(_5945.CouplingHalfMultiBodyDynamicsAnalysis):
    '''SynchroniserPartMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _SYNCHRONISER_PART_MULTI_BODY_DYNAMICS_ANALYSIS
    __hash__ = None
