...
_CONNECTION_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'ConnectionMultiBodyDynamicsAnalysis')
...
class ConnectionMultiBodyDynamicsAnalysis(_6509.ConnectionTimeSeriesLoadAnalysisCase):
    '''ConnectionMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _CONNECTION_MULTI_BODY_DYNAMICS_ANALYSIS
    ...
    @property
    def multi_body_dynamics_analysis(self) -> '_5066.MultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5066.MultiBodyDynamicsAnalysis)(self.wrapped.MultiBodyDynamicsAnalysis) if self.wrapped.MultiBodyDynamicsAnalysis else None
