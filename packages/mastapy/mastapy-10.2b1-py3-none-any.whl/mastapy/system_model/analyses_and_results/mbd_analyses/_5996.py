...
_POWER_LOAD_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'PowerLoadMultiBodyDynamicsAnalysis')
...
class PowerLoadMultiBodyDynamicsAnalysis(_6034.VirtualComponentMultiBodyDynamicsAnalysis):
    '''PowerLoadMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _POWER_LOAD_MULTI_BODY_DYNAMICS_ANALYSIS
    __hash__ = None
