...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5989, _5913
from mastapy._internal.python_net import python_net_import

_ROOT_ASSEMBLY_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'RootAssemblyMultiBodyDynamicsAnalysis')
...
class RootAssemblyMultiBodyDynamicsAnalysis(_5913.AssemblyMultiBodyDynamicsAnalysis):
    '''RootAssemblyMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _ROOT_ASSEMBLY_MULTI_BODY_DYNAMICS_ANALYSIS
    __hash__ = None
    ...
    @property
    def multi_body_dynamics_analysis_inputs(self) -> '_5989.MultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5989.MultiBodyDynamicsAnalysis)(self.wrapped.MultiBodyDynamicsAnalysisInputs) if self.wrapped.MultiBodyDynamicsAnalysisInputs else None
