...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5911
from mastapy._internal.python_net import python_net_import

_BEVEL_GEAR_SET_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'BevelGearSetMultiBodyDynamicsAnalysis')
...
class BevelGearSetMultiBodyDynamicsAnalysis(_5911.AGMAGleasonConicalGearSetMultiBodyDynamicsAnalysis):
    '''BevelGearSetMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _BEVEL_GEAR_SET_MULTI_BODY_DYNAMICS_ANALYSIS
    __hash__ = None
