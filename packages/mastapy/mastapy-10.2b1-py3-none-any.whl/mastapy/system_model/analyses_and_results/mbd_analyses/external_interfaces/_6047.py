...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5971
...
class DynamicExternalInterfaceOptions(_1.APIBase):
    '''DynamicExternalInterfaceOptions
    ...
    @property
    def input_signal_filter_level(self) -> '_5971.InputSignalFilterLevel':
        ...
        return constructor.new(_5971.InputSignalFilterLevel)(value) if value else None

    @input_signal_filter_level.setter
    def input_signal_filter_level(self, value: '_5971.InputSignalFilterLevel'):
