...
from mastapy.system_model.analyses_and_results.mbd_analyses import _6036
...
class WormGearMeshCompoundMultiBodyDynamicsAnalysis(_6100.GearMeshCompoundMultiBodyDynamicsAnalysis):
    '''WormGearMeshCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_6036.WormGearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_6036.WormGearMeshMultiBodyDynamicsAnalysis))
        return value

    @property
    def connection_multi_body_dynamics_analysis_load_cases(self) -> 'List[_6036.WormGearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionMultiBodyDynamicsAnalysisLoadCases, constructor.new(_6036.WormGearMeshMultiBodyDynamicsAnalysis))
        return value
