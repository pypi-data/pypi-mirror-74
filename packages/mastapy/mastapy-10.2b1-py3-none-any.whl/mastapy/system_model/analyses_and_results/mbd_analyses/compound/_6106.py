...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5968
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _6049
...
class ImportedFEComponentCompoundMultiBodyDynamicsAnalysis(_6049.AbstractShaftOrHousingCompoundMultiBodyDynamicsAnalysis):
    '''ImportedFEComponentCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5968.ImportedFEComponentMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5968.ImportedFEComponentMultiBodyDynamicsAnalysis))
        return value

    @property
    def component_multi_body_dynamics_analysis_load_cases(self) -> 'List[_5968.ImportedFEComponentMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentMultiBodyDynamicsAnalysisLoadCases, constructor.new(_5968.ImportedFEComponentMultiBodyDynamicsAnalysis))
        return value
