...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _6101
...
class ConicalGearSetCompoundMultiBodyDynamicsAnalysis(_6101.GearSetCompoundMultiBodyDynamicsAnalysis):
    '''ConicalGearSetCompoundMultiBodyDynamicsAnalysis
