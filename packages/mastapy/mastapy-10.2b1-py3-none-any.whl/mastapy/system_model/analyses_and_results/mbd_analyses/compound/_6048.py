...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _6121
...
class AbstractAssemblyCompoundMultiBodyDynamicsAnalysis(_6121.PartCompoundMultiBodyDynamicsAnalysis):
    '''AbstractAssemblyCompoundMultiBodyDynamicsAnalysis
