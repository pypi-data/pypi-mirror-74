...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5115
...
class DynamicTorqueResultAtTime(_5115.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
