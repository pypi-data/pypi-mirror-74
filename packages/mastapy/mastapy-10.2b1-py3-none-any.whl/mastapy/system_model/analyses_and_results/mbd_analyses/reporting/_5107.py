...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5104
...
class DynamicTorqueResultAtTime(_5104.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
