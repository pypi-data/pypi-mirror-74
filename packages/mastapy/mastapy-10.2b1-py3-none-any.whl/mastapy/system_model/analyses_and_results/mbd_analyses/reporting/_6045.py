...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _6042
...
class DynamicTorqueResultAtTime(_6042.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
