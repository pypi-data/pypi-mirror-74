...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5939
from mastapy._internal.python_net import python_net_import

_AGMA_GLEASON_CONICAL_GEAR_MESH_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'AGMAGleasonConicalGearMeshMultiBodyDynamicsAnalysis')
...
class AGMAGleasonConicalGearMeshMultiBodyDynamicsAnalysis(_5939.ConicalGearMeshMultiBodyDynamicsAnalysis):
    '''AGMAGleasonConicalGearMeshMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _AGMA_GLEASON_CONICAL_GEAR_MESH_MULTI_BODY_DYNAMICS_ANALYSIS
    __hash__ = None
