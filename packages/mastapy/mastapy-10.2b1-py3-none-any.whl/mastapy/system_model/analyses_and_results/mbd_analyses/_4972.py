...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5106
...
class BearingMultiBodyDynamicsAnalysis(_5002.ConnectorMultiBodyDynamicsAnalysis):
    '''BearingMultiBodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5106.DynamicForceVector3DResult':
        ...
        return constructor.new(_5106.DynamicForceVector3DResult)(self.wrapped.PeakDynamicForce) if self.wrapped.PeakDynamicForce else None
