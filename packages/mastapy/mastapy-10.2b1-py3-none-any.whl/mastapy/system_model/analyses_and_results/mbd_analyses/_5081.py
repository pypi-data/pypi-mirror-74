...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5066, _4989
...
class RootAssemblyMultiBodyDynamicsAnalysis(_4989.AssemblyMultiBodyDynamicsAnalysis):
    '''RootAssemblyMultiBodyDynamicsAnalysis
    ...
    @property
    def multi_body_dynamics_analysis_inputs(self) -> '_5066.MultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5066.MultiBodyDynamicsAnalysis)(self.wrapped.MultiBodyDynamicsAnalysisInputs) if self.wrapped.MultiBodyDynamicsAnalysisInputs else None
