...
_CONICAL_GEAR_MESH_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'ConicalGearMeshMultiBodyDynamicsAnalysis')
...
class ConicalGearMeshMultiBodyDynamicsAnalysis(_5037.GearMeshMultiBodyDynamicsAnalysis):
    '''ConicalGearMeshMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _CONICAL_GEAR_MESH_MULTI_BODY_DYNAMICS_ANALYSIS
    ...
    def planetaries(self) -> 'List[ConicalGearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearMeshMultiBodyDynamicsAnalysis))
        return value
