...
from mastapy.system_model.analyses_and_results.mbd_analyses import (
    _4991, _5038, _4988, _5083,
    _5046, _5047, _5063
)
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.system_model.part_model import _2030
from mastapy.nodal_analysis import _1397
from mastapy.system_model.analyses_and_results.mbd_analyses.external_interfaces import _5127
...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_4988.AnalysisTypes':
        '''AnalysisTypes: 'AnalysisType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.AnalysisType)
        return constructor.new(_4988.AnalysisTypes)(value) if value else None

    @analysis_type.setter
    def analysis_type(self, value: '_4988.AnalysisTypes'):
    ...
    @property
    def method_to_define_period(self) -> '_5046.InertiaAdjustedLoadCasePeriodMethod':
        ...
        return constructor.new(_5046.InertiaAdjustedLoadCasePeriodMethod)(value) if value else None

    @method_to_define_period.setter
    def method_to_define_period(self, value: '_5046.InertiaAdjustedLoadCasePeriodMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def static_load_cases_to_create(self) -> '_5047.InertiaAdjustedLoadCaseResultsToCreate':
        ...
        return constructor.new(_5047.InertiaAdjustedLoadCaseResultsToCreate)(value) if value else None

    @static_load_cases_to_create.setter
    def static_load_cases_to_create(self, value: '_5047.InertiaAdjustedLoadCaseResultsToCreate'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def transient_solver_options(self) -> '_1397.TransientSolverOptions':
        ...
        return constructor.new(_1397.TransientSolverOptions)(self.wrapped.TransientSolverOptions) if self.wrapped.TransientSolverOptions else None

    @property
    def external_interface_options(self) -> '_5127.DynamicExternalInterfaceOptions':
        ...
        return constructor.new(_5127.DynamicExternalInterfaceOptions)(self.wrapped.ExternalInterfaceOptions) if self.wrapped.ExternalInterfaceOptions else None

    @property
    def run_up_analysis_options(self) -> '_5063.MBDRunUpAnalysisOptions':
        ...
        return constructor.new(_5063.MBDRunUpAnalysisOptions)(self.wrapped.RunUpAnalysisOptions) if self.wrapped.RunUpAnalysisOptions else None

    @property
    def frequency_response_options(self) -> '_4768.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_4768.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptions) if self.wrapped.FrequencyResponseOptions else None
