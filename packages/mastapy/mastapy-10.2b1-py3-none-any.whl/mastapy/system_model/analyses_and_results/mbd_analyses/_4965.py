...
_ABSTRACT_ASSEMBLY_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'AbstractAssemblyMultiBodyDynamicsAnalysis')
...
class AbstractAssemblyMultiBodyDynamicsAnalysis(_5050.PartMultiBodyDynamicsAnalysis):
    '''AbstractAssemblyMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _ABSTRACT_ASSEMBLY_MULTI_BODY_DYNAMICS_ANALYSIS
