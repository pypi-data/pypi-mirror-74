...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5989
from mastapy.system_model.analyses_and_results.analysis_cases import _6182
...
class ConnectionMultiBodyDynamicsAnalysis(_6182.ConnectionTimeSeriesLoadAnalysisCase):
    '''ConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def multi_body_dynamics_analysis(self) -> '_5989.MultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5989.MultiBodyDynamicsAnalysis)(self.wrapped.MultiBodyDynamicsAnalysis) if self.wrapped.MultiBodyDynamicsAnalysis else None
