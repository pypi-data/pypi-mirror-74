...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5039, _5037, _5088
from mastapy._internal.python_net import python_net_import

_GEAR_SET_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'GearSetMultiBodyDynamicsAnalysis')
...
class GearSetMultiBodyDynamicsAnalysis(_5088.SpecialisedAssemblyMultiBodyDynamicsAnalysis):
    '''GearSetMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _GEAR_SET_MULTI_BODY_DYNAMICS_ANALYSIS
    ...
    @property
    def gears(self) -> 'List[_5039.GearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5039.GearMultiBodyDynamicsAnalysis))
        return value

    @property
    def meshes(self) -> 'List[_5037.GearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_5037.GearMeshMultiBodyDynamicsAnalysis))
        return value
