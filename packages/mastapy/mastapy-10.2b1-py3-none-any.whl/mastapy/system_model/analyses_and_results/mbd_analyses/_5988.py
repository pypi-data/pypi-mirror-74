...
_MOUNTABLE_COMPONENT_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'MountableComponentMultiBodyDynamicsAnalysis')
...
class MountableComponentMultiBodyDynamicsAnalysis(_5932.ComponentMultiBodyDynamicsAnalysis):
    '''MountableComponentMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _MOUNTABLE_COMPONENT_MULTI_BODY_DYNAMICS_ANALYSIS
    __hash__ = None
