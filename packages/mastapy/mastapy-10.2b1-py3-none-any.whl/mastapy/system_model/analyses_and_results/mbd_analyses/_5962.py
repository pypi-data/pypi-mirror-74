...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5988
from mastapy._internal.python_net import python_net_import

_GEAR_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'GearMultiBodyDynamicsAnalysis')
...
class GearMultiBodyDynamicsAnalysis(_5988.MountableComponentMultiBodyDynamicsAnalysis):
    '''GearMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _GEAR_MULTI_BODY_DYNAMICS_ANALYSIS
    __hash__ = None
    ...
    def gear_mesh_torque(self) -> 'List[float]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshTorque, float)
        return value
    ...
    @property
    def peak_gear_torque(self) -> 'List[_6045.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakGearTorque, constructor.new(_6045.DynamicTorqueResultAtTime))
        return value
