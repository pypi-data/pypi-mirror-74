...
_CONICAL_GEAR_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'ConicalGearMultiBodyDynamicsAnalysis')
...
class ConicalGearMultiBodyDynamicsAnalysis(_5962.GearMultiBodyDynamicsAnalysis):
    '''ConicalGearMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _CONICAL_GEAR_MULTI_BODY_DYNAMICS_ANALYSIS
    __hash__ = None
    ...
    def planetaries(self) -> 'List[ConicalGearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearMultiBodyDynamicsAnalysis))
        return value
