...
from mastapy.system_model.analyses_and_results.analysis_cases import _6518
...
class MultiBodyDynamicsAnalysis(_6518.TimeSeriesLoadAnalysisCase):
    '''MultiBodyDynamicsAnalysis
    ...
    @property
    def mbd_options(self) -> '_5062.MBDAnalysisOptions':
        ...
        return constructor.new(_5062.MBDAnalysisOptions)(self.wrapped.MBDOptions) if self.wrapped.MBDOptions else None
