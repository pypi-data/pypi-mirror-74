...
from mastapy.system_model.analyses_and_results.analysis_cases import _6221
from mastapy._internal.python_net import python_net_import

_PART_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'PartMultiBodyDynamicsAnalysis')
...
class PartMultiBodyDynamicsAnalysis(_6221.PartTimeSeriesLoadAnalysisCase):
    '''PartMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _PART_MULTI_BODY_DYNAMICS_ANALYSIS
    __hash__ = None
