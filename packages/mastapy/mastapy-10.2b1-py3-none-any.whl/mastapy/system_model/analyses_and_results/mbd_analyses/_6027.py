...
from mastapy.system_model.analyses_and_results.mbd_analyses import _6031, _5944
...
class TorqueConverterConnectionMultiBodyDynamicsAnalysis(_5944.CouplingConnectionMultiBodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_6031.TorqueConverterStatus':
        ...
        return constructor.new(_6031.TorqueConverterStatus)(value) if value else None
