...
class ImportedFEComponentMultiBodyDynamicsAnalysis(_5908.AbstractShaftOrHousingMultiBodyDynamicsAnalysis):
    '''ImportedFEComponentMultiBodyDynamicsAnalysis
    ...
    def elastic_deflections_total_magnitude(self) -> 'List[float]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElasticDeflectionsTotalMagnitude, float)
        return value
    ...
    def elastic_local_x_velocities(self) -> 'List[float]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElasticLocalXVelocities, float)
        return value
    ...
    def elastic_local_y_velocities(self) -> 'List[float]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElasticLocalYVelocities, float)
        return value
    ...
    def elastic_local_z_velocities(self) -> 'List[float]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElasticLocalZVelocities, float)
        return value
    ...
    def elastic_local_x_accelerations(self) -> 'List[float]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElasticLocalXAccelerations, float)
        return value
    ...
    def elastic_local_y_accelerations(self) -> 'List[float]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElasticLocalYAccelerations, float)
        return value
    ...
    def elastic_local_z_accelerations(self) -> 'List[float]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElasticLocalZAccelerations, float)
        return value
    ...
    def nodal_force_x(self) -> 'List[float]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodalForceX, float)
        return value
    ...
    def nodal_force_y(self) -> 'List[float]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodalForceY, float)
        return value
    ...
    def nodal_force_z(self) -> 'List[float]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodalForceZ, float)
        return value
