...
_VIRTUAL_COMPONENT_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'VirtualComponentMultiBodyDynamicsAnalysis')
...
class VirtualComponentMultiBodyDynamicsAnalysis(_5988.MountableComponentMultiBodyDynamicsAnalysis):
    '''VirtualComponentMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _VIRTUAL_COMPONENT_MULTI_BODY_DYNAMICS_ANALYSIS
    __hash__ = None
