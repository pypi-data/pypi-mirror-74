...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5124
...
class BearingMultiBodyDynamicsAnalysis(_5020.ConnectorMultiBodyDynamicsAnalysis):
    '''BearingMultiBodyDynamicsAnalysis
