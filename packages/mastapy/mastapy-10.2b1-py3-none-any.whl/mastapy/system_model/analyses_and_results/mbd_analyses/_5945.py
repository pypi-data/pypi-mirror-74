...
_COUPLING_HALF_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'CouplingHalfMultiBodyDynamicsAnalysis')
...
class CouplingHalfMultiBodyDynamicsAnalysis(_5988.MountableComponentMultiBodyDynamicsAnalysis):
    '''CouplingHalfMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _COUPLING_HALF_MULTI_BODY_DYNAMICS_ANALYSIS
    __hash__ = None
