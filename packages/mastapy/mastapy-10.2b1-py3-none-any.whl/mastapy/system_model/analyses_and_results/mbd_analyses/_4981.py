...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4967
...
class BevelGearMeshMultiBodyDynamicsAnalysis(_4967.AGMAGleasonConicalGearMeshMultiBodyDynamicsAnalysis):
    '''BevelGearMeshMultiBodyDynamicsAnalysis
