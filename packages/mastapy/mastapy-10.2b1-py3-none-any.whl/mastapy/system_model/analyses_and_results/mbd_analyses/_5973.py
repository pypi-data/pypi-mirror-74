...
_INTER_MOUNTABLE_COMPONENT_CONNECTION_MULTI_BODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'InterMountableComponentConnectionMultiBodyDynamicsAnalysis')
...
class InterMountableComponentConnectionMultiBodyDynamicsAnalysis(_5942.ConnectionMultiBodyDynamicsAnalysis):
    '''InterMountableComponentConnectionMultiBodyDynamicsAnalysis

    This is a mastapy class.
    '''

    TYPE = _INTER_MOUNTABLE_COMPONENT_CONNECTION_MULTI_BODY_DYNAMICS_ANALYSIS
    __hash__ = None
