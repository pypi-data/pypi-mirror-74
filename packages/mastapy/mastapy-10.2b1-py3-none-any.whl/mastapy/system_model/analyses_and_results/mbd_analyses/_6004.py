...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _6044, _6046
from mastapy.system_model.analyses_and_results.mbd_analyses import _5943
...
class ShaftHubConnectionMultiBodyDynamicsAnalysis(_5943.ConnectorMultiBodyDynamicsAnalysis):
    '''ShaftHubConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_6044.DynamicForceVector3DResult':
        ...
        return constructor.new(_6044.DynamicForceVector3DResult)(self.wrapped.PeakDynamicForce) if self.wrapped.PeakDynamicForce else None

    @property
    def peak_dynamic_force_angular(self) -> '_6046.DynamicTorqueVector3DResult':
        ...
        return constructor.new(_6046.DynamicTorqueVector3DResult)(self.wrapped.PeakDynamicForceAngular) if self.wrapped.PeakDynamicForceAngular else None
