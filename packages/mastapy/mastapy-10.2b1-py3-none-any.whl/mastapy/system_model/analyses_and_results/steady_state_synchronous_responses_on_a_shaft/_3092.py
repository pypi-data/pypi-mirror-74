...
class StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft(_3087.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft):
    '''StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_2020.StraightBevelSunGear':
