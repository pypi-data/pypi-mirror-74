...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _2805
...
class ConicalGearSteadyStateSynchronousResponseOnAShaft(_2805.GearSteadyStateSynchronousResponseOnAShaft):
    '''ConicalGearSteadyStateSynchronousResponseOnAShaft
    ...
    def planetaries(self) -> 'List[ConicalGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearSteadyStateSynchronousResponseOnAShaft))
        return value
