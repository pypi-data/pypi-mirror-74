...
class PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft(_2913.CylindricalGearSetSteadyStateSynchronousResponseOnAShaft):
    '''PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_design(self) -> '_1994.PlanetaryGearSet':
