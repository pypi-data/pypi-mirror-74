...
from mastapy.system_model.analyses_and_results.analysis_cases import _3378
...
class ConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3378.ConnectionCompoundAnalysis):
    '''ConnectionCompoundSteadyStateSynchronousResponseOnAShaft
