...
from mastapy.system_model.analyses_and_results.analysis_cases import _4584
...
class PartCompoundSteadyStateSynchronousResponseOnAShaft(_4584.PartCompoundAnalysis):
    '''PartCompoundSteadyStateSynchronousResponseOnAShaft
