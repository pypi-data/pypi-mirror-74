...
class ConicalGearSteadyStateSynchronousResponseOnAShaft(_2924.GearSteadyStateSynchronousResponseOnAShaft):
    '''ConicalGearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_2004.ConicalGear':
        ...
        return constructor.new(_2004.ConicalGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
