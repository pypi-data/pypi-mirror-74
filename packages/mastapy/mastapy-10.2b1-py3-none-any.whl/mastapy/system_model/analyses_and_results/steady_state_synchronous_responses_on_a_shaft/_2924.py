...
class GearSteadyStateSynchronousResponseOnAShaft(_2942.MountableComponentSteadyStateSynchronousResponseOnAShaft):
    '''GearSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_2000.Gear':
        ...
        return constructor.new(_2000.Gear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
