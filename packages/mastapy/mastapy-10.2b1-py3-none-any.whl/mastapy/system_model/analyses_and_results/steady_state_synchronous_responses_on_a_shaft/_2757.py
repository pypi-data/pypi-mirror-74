...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _2901
from mastapy._internal.python_net import python_net_import

_AGMA_GLEASON_CONICAL_GEAR_MESH_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.SteadyStateSynchronousResponsesOnAShaft', 'AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseOnAShaft')
...
class AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseOnAShaft(_2901.ConicalGearMeshSteadyStateSynchronousResponseOnAShaft):
    '''AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    def __init__(self, instance_to_wrap: 'AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseOnAShaft.TYPE'):
