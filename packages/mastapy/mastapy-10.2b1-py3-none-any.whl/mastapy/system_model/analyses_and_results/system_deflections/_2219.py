...
class BevelDifferentialPlanetGearSystemDeflection(_2218.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3228.BevelDifferentialPlanetGearPowerFlow':
