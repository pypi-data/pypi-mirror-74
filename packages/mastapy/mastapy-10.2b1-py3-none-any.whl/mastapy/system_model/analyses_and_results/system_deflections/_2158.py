...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2394
from mastapy.math_utility.measured_vectors import _1250, _1249
...
class ComponentSystemDeflection(_2290.PartSystemDeflection):
    '''ComponentSystemDeflection
    ...
    @property
    def rigidly_connected_components(self) -> '_2394.RigidlyConnectedComponentGroupSystemDeflection':
        ...
        return constructor.new(_2394.RigidlyConnectedComponentGroupSystemDeflection)(self.wrapped.RigidlyConnectedComponents) if self.wrapped.RigidlyConnectedComponents else None

    @property
    def node_results(self) -> 'List[_1250.NodeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_1250.NodeResults))
        return value

    @property
    def connected_components_forces_in_lcs(self) -> 'List[_1249.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectedComponentsForcesInLCS, constructor.new(_1249.ForceResults))
        return value

    @property
    def connected_components_forces_in_wcs(self) -> 'List[_1249.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectedComponentsForcesInWCS, constructor.new(_1249.ForceResults))
        return value
