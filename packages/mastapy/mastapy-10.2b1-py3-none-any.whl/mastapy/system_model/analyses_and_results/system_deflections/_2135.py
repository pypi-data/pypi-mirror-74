...
from mastapy.system_model.analyses_and_results.system_deflections import _2158, _2290
...
class AbstractAssemblySystemDeflection(_2290.PartSystemDeflection):
    '''AbstractAssemblySystemDeflection
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_2394.RigidlyConnectedComponentGroupSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_2394.RigidlyConnectedComponentGroupSystemDeflection))
        return value

    @property
    def components_with_unknown_mass_properties(self) -> 'List[_2158.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentsWithUnknownMassProperties, constructor.new(_2158.ComponentSystemDeflection))
        return value

    @property
    def components_with_zero_mass_properties(self) -> 'List[_2158.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentsWithZeroMassProperties, constructor.new(_2158.ComponentSystemDeflection))
        return value
