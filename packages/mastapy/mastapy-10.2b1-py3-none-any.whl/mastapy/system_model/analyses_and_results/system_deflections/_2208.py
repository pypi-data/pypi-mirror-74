...
from mastapy.system_model.analyses_and_results.power_flows import _3217, _3275, _3307
...
class AbstractShaftOrHousingSystemDeflection(_2230.ComponentSystemDeflection):
    '''AbstractShaftOrHousingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3217.AbstractShaftOrHousingPowerFlow':
        ...
        return constructor.new(_3217.AbstractShaftOrHousingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def power_flow_results_of_type_imported_fe_component_power_flow(self) -> '_3275.ImportedFEComponentPowerFlow':
        ...
        if _3275.ImportedFEComponentPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
        ...
        return constructor.new(_3275.ImportedFEComponentPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def power_flow_results_of_type_shaft_power_flow(self) -> '_3307.ShaftPowerFlow':
        ...
        if _3307.ShaftPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
