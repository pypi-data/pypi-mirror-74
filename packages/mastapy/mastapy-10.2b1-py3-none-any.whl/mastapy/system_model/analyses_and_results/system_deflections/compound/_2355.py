...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2428
...
class AbstractAssemblyCompoundSystemDeflection(_2428.PartCompoundSystemDeflection):
    '''AbstractAssemblyCompoundSystemDeflection
