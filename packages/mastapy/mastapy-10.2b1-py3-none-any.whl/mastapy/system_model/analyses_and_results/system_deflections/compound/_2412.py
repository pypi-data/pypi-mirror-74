...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2381
...
class CVTCompoundSystemDeflection(_2381.BeltDriveCompoundSystemDeflection):
    '''CVTCompoundSystemDeflection
