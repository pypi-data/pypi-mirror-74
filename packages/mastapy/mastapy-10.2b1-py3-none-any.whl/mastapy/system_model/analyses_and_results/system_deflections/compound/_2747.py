...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2685
...
class WormGearCompoundSystemDeflection(_2685.GearCompoundSystemDeflection):
    '''WormGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_348.WormGearDutyCycleRating':
    ...
    @property
    def worm_duty_cycle_rating(self) -> '_348.WormGearDutyCycleRating':
        ...
        return constructor.new(_348.WormGearDutyCycleRating)(self.wrapped.WormDutyCycleRating) if self.wrapped.WormDutyCycleRating else None

    @property
    def component_design(self) -> '_2007.WormGear':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2368.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2368.WormGearSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2368.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2368.WormGearSystemDeflection))
        return value
