...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2687
...
class ConicalGearSetCompoundSystemDeflection(_2687.GearSetCompoundSystemDeflection):
    '''ConicalGearSetCompoundSystemDeflection
    ...
    @property
    def conical_gear_set_duty_cycle_rating(self) -> '_399.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_399.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearSetDutyCycleRating) if self.wrapped.ConicalGearSetDutyCycleRating else None
