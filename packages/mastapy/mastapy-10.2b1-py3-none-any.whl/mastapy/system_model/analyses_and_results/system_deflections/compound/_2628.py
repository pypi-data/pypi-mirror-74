...
class WormGearCompoundSystemDeflection(_2566.GearCompoundSystemDeflection):
    '''WormGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_351.WormGearDutyCycleRating':
    ...
    @property
    def worm_duty_cycle_rating(self) -> '_351.WormGearDutyCycleRating':
        ...
        return constructor.new(_351.WormGearDutyCycleRating)(self.wrapped.WormDutyCycleRating) if self.wrapped.WormDutyCycleRating else None
