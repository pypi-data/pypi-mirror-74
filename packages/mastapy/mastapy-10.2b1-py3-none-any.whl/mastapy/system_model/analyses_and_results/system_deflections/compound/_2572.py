...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2570, _2571, _2401
...
class HypoidGearSetCompoundSystemDeflection(_2401.AGMAGleasonConicalGearSetCompoundSystemDeflection):
    ...
    @property
    def hypoid_gears_compound_system_deflection(self) -> 'List[_2570.HypoidGearCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsCompoundSystemDeflection, constructor.new(_2570.HypoidGearCompoundSystemDeflection))
        return value

    @property
    def hypoid_meshes_compound_system_deflection(self) -> 'List[_2571.HypoidGearMeshCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesCompoundSystemDeflection, constructor.new(_2571.HypoidGearMeshCompoundSystemDeflection))
        return value
