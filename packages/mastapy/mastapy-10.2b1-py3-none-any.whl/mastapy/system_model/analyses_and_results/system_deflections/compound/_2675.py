...
class CylindricalGearCompoundSystemDeflection(_2685.GearCompoundSystemDeflection):
    '''CylindricalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_464.CylindricalGearDutyCycleRating':
    ...
    @property
    def cylindrical_duty_cycle_rating(self) -> '_464.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_464.CylindricalGearDutyCycleRating)(self.wrapped.CylindricalDutyCycleRating) if self.wrapped.CylindricalDutyCycleRating else None
