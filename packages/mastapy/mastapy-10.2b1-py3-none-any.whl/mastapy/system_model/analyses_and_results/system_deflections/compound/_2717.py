...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3076
...
class RootAssemblyCompoundSystemDeflection(_2402.AssemblyCompoundSystemDeflection):
    ...
    @property
    def root_assembly_compound_power_flow(self) -> '_3076.RootAssemblyCompoundPowerFlow':
        ...
        return constructor.new(_3076.RootAssemblyCompoundPowerFlow)(self.wrapped.RootAssemblyCompoundPowerFlow) if self.wrapped.RootAssemblyCompoundPowerFlow else None
