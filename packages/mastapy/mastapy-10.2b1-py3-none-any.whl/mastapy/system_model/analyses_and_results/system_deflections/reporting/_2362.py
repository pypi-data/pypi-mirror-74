...
from mastapy.system_model.analyses_and_results import _2191
...
class RigidlyConnectedComponentGroupSystemDeflection(_2191.DesignEntityGroupAnalysis):
    '''RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def components(self) -> 'List[_2240.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Components, constructor.new(_2240.ComponentSystemDeflection))
        return value
