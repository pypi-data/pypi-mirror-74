...
from mastapy.utility.enums import _1336
...
class ShaftSystemDeflectionSectionsReport(_1278.CustomReportChart):
    '''ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self) -> '_1336.TableAndChartOptions':
        '''TableAndChartOptions: 'Display' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Display)
        return constructor.new(_1336.TableAndChartOptions)(value) if value else None

    @display.setter
    def display(self, value: '_1336.TableAndChartOptions'):
