...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2390
...
class MeshDeflectionResults(_1.APIBase):
    '''MeshDeflectionResults
    ...
    @property
    def gears(self) -> 'List[_2390.GearInMeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_2390.GearInMeshDeflectionResults))
        return value
