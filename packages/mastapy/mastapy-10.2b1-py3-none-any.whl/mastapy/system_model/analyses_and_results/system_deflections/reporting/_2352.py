...
from mastapy.system_model.analyses_and_results import _2182
...
class RigidlyConnectedComponentGroupSystemDeflection(_2182.DesignEntityGroupAnalysis):
    '''RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def mass_properties(self) -> '_1077.MassProperties':
        ...
        return constructor.new(_1077.MassProperties)(self.wrapped.MassProperties) if self.wrapped.MassProperties else None

    @property
    def components(self) -> 'List[_2230.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Components, constructor.new(_2230.ComponentSystemDeflection))
        return value
