...
class PlanetCarrierWindup(_1.APIBase):
    '''PlanetCarrierWindup
    ...
    @property
    def pin_wind_ups(self) -> 'List[_2393.PlanetPinWindup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PinWindUps, constructor.new(_2393.PlanetPinWindup))
        return value
