...
from mastapy.system_model.analyses_and_results.system_deflections import _2340, _2338, _2240
...
class StraightBevelGearSetSystemDeflection(_2240.BevelGearSetSystemDeflection):
    '''StraightBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3339.StraightBevelGearSetPowerFlow':
    ...
    @property
    def straight_bevel_gears_system_deflection(self) -> 'List[_2340.StraightBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsSystemDeflection, constructor.new(_2340.StraightBevelGearSystemDeflection))
        return value

    @property
    def straight_bevel_meshes_system_deflection(self) -> 'List[_2338.StraightBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesSystemDeflection, constructor.new(_2338.StraightBevelGearMeshSystemDeflection))
        return value
