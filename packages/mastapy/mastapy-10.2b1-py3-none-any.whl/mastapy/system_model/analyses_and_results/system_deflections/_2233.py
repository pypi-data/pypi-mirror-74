...
from mastapy.system_model.analyses_and_results.system_deflections import _2232, _2328
...
class BeltDriveSystemDeflection(_2328.SpecialisedAssemblySystemDeflection):
    '''BeltDriveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3242.BeltDrivePowerFlow':
    ...
    @property
    def belts(self) -> 'List[_2232.BeltConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Belts, constructor.new(_2232.BeltConnectionSystemDeflection))
        return value
