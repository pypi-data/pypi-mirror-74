...
from mastapy.system_model.drawing import _1843, _1841
...
class SystemDeflectionDrawStyle(_1841.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1843.ScalingDrawStyle':
        ...
        return constructor.new(_1843.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
