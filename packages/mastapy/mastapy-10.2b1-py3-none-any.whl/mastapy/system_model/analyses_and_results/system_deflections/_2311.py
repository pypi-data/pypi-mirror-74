...
class PartToPartShearCouplingConnectionSystemDeflection(_2262.CouplingConnectionSystemDeflection):
    '''PartToPartShearCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3309.PartToPartShearCouplingConnectionPowerFlow':
