...
class PlanetaryConnectionSystemDeflection(_2327.ShaftToMountableComponentConnectionSystemDeflection):
    '''PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3312.PlanetaryConnectionPowerFlow':
