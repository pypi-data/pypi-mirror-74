...
from mastapy.system_model.drawing import _1756, _1754
...
class SystemDeflectionDrawStyle(_1754.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1756.ScalingDrawStyle':
        ...
        return constructor.new(_1756.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
