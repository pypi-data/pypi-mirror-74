...
class FaceGearMeshSystemDeflection(_2285.GearMeshSystemDeflection):
    '''FaceGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3282.FaceGearMeshPowerFlow':
    ...
    @property
    def rating(self) -> '_249.FaceGearMeshRating':
