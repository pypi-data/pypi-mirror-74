...
class AGMAGleasonConicalGearMeshSystemDeflection(_2239.ConicalGearMeshSystemDeflection):
    '''AGMAGleasonConicalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3218.AGMAGleasonConicalGearMeshPowerFlow':
