...
from mastapy.system_model.analyses_and_results.system_deflections import _2168, _2259, _2150
...
class ZerolBevelGearSetSystemDeflection(_2150.BevelGearSetSystemDeflection):
    '''ZerolBevelGearSetSystemDeflection
    ...
    @property
    def zerol_bevel_gears_system_deflection(self) -> 'List[_2168.ZerolBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsSystemDeflection, constructor.new(_2168.ZerolBevelGearSystemDeflection))
        return value

    @property
    def zerol_bevel_meshes_system_deflection(self) -> 'List[_2259.ZerolBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesSystemDeflection, constructor.new(_2259.ZerolBevelGearMeshSystemDeflection))
        return value
