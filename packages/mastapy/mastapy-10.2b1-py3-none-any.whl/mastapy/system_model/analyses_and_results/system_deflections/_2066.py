...
from mastapy.system_model.analyses_and_results.system_deflections import _2382, _2067, _2136
...
class ShaftSystemDeflection(_2136.AbstractShaftOrHousingSystemDeflection):
    '''ShaftSystemDeflection
    ...
    @property
    def twod_drawing_showing_axial_forces_with_mounted_components(self) -> '_712.SMTBitmap':
        ...
        return constructor.new(_712.SMTBitmap)(self.wrapped.TwoDDrawingShowingAxialForcesWithMountedComponents) if self.wrapped.TwoDDrawingShowingAxialForcesWithMountedComponents else None
    ...
    @property
    def shaft_section_results(self) -> 'List[_2067.ShaftSectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionResults, constructor.new(_2067.ShaftSectionSystemDeflection))
        return value
