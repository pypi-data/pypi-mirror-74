...
class KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection(_2294.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3298.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow':
    ...
    @property
    def rating(self) -> '_210.KlingelnbergCycloPalloidHypoidGearMeshRating':
