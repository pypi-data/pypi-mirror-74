...
from mastapy.math_utility.measured_vectors import _127
...
class GearSystemDeflection(_2218.MountableComponentSystemDeflection):
    '''GearSystemDeflection
    ...
    @property
    def component_design(self) -> '_1989.Gear':
        ...
        return constructor.new(_1989.Gear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def mesh_point_results_in_wcs(self) -> 'List[_127.ForceAndDisplacementResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshPointResultsInWCS, constructor.new(_127.ForceAndDisplacementResults))
        return value
