...
class BevelDifferentialGearSystemDeflection(_2223.BevelGearSystemDeflection):
    '''BevelDifferentialGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3226.BevelDifferentialGearPowerFlow':
    ...
    @property
    def component_detailed_analysis(self) -> '_340.BevelGearRating':
        ...
        return constructor.new(_340.BevelGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
