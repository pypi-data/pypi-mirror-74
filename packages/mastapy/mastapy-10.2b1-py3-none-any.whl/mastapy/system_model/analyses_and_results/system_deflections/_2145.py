...
from mastapy.system_model.analyses_and_results.system_deflections import _2146, _2144, _2150
...
class BevelDifferentialGearSetSystemDeflection(_2150.BevelGearSetSystemDeflection):
    '''BevelDifferentialGearSetSystemDeflection
    ...
    @property
    def bevel_differential_gears_system_deflection(self) -> 'List[_2146.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsSystemDeflection, constructor.new(_2146.BevelDifferentialGearSystemDeflection))
        return value

    @property
    def bevel_differential_meshes_system_deflection(self) -> 'List[_2144.BevelDifferentialGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesSystemDeflection, constructor.new(_2144.BevelDifferentialGearMeshSystemDeflection))
        return value
