...
class ModalCMSResultsForModeAndFE(_1.APIBase):
    '''ModalCMSResultsForModeAndFE
    ...
    @property
    def modal_full_fe_results(self) -> '_219.ModalCMSResults':
        ...
        return constructor.new(_219.ModalCMSResults)(self.wrapped.ModalFullFEResults) if self.wrapped.ModalFullFEResults else None
