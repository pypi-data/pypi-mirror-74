...
class PerModeResultsReport(_1284.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1342.TableAndChartOptions':
    ...
    def display_option(self, value: '_1342.TableAndChartOptions'):
