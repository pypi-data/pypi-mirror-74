...
from mastapy.utility.modal_analysis import _1429
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2110.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1429.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1429.DesignEntityExcitationDescription))
        return value
