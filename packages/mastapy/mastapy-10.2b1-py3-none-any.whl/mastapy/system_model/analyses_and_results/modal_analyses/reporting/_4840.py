...
from mastapy.utility.modal_analysis import _1314
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2182.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1314.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1314.DesignEntityExcitationDescription))
        return value
