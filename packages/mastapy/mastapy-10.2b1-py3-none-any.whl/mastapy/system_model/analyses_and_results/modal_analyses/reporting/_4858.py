...
from mastapy.utility.modal_analysis import _1320
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2199.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1320.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1320.DesignEntityExcitationDescription))
        return value
