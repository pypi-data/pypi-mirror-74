...
from mastapy.nodal_analysis.component_mode_synthesis import _1494
...
class ModalCMSResultsForModeAndFE(_0.APIBase):
    ...
    @property
    def modal_full_fe_results(self) -> '_1494.ModalCMSResults':
        ...
        return constructor.new(_1494.ModalCMSResults)(self.wrapped.ModalFullFEResults) if self.wrapped.ModalFullFEResults else None
