...
class PerModeResultsReport(_60.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_59.TableAndChartOptions':
    ...
    def display_option(self, value: '_59.TableAndChartOptions'):
