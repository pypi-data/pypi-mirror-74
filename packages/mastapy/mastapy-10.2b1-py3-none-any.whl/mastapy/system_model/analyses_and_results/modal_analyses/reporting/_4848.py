...
class PerModeResultsReport(_1282.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1340.TableAndChartOptions':
    ...
    def display_option(self, value: '_1340.TableAndChartOptions'):
