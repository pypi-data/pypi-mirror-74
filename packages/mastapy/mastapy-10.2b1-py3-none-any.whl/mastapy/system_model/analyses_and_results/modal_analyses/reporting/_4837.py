...
class PerModeResultsReport(_1278.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1336.TableAndChartOptions':
    ...
    def display_option(self, value: '_1336.TableAndChartOptions'):
