...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _5898
...
class RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis(_1.APIBase):
    '''RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis
    ...
    @property
    def component_results(self) -> 'List[_5898.ComponentPerModeResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentResults, constructor.new(_5898.ComponentPerModeResult))
        return value
