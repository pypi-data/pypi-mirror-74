...
from mastapy.math_utility import (
    _1075, _1093, _1066, _1085,
    _1074, _1063, _1073, _1088
)
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4751, _4840, _4839, _4795,
    _4841
)
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import (
    _5418, _5421, _5426, _5427
)
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5334, _5385
from mastapy.utility.units_and_measurements.measurements import (
    _1211, _1165, _1263, _1171,
    _1162, _1167, _1185, _1258,
    _1179, _1229, _1230, _1233
)
from mastapy.utility.property import _1359
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    def translation_or_rotation(self) -> '_1093.TranslationRotation':
        ...
        return constructor.new(_1093.TranslationRotation)(value) if value else None

    @translation_or_rotation.setter
    def translation_or_rotation(self, value: '_1093.TranslationRotation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TranslationOrRotation = value

    @property
    def coordinate_system(self) -> '_4751.CoordinateSystemForWhine':
        ...
        return constructor.new(_4751.CoordinateSystemForWhine)(value) if value else None

    @coordinate_system.setter
    def coordinate_system(self, value: '_4751.CoordinateSystemForWhine'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CoordinateSystem = value

    @property
    def complex_component(self) -> '_1066.ComplexPartDisplayOption':
        ...
        return constructor.new(_1066.ComplexPartDisplayOption)(value) if value else None

    @complex_component.setter
    def complex_component(self, value: '_1066.ComplexPartDisplayOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ComplexComponent = value

    @property
    def magnitude_method_for_complex_vectors(self) -> '_1085.ComplexMagnitudeMethod':
        ...
        return constructor.new(_1085.ComplexMagnitudeMethod)(value) if value else None

    @magnitude_method_for_complex_vectors.setter
    def magnitude_method_for_complex_vectors(self, value: '_1085.ComplexMagnitudeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def weighting(self) -> '_1063.AcousticWeighting':
        '''AcousticWeighting: 'Weighting' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Weighting)
        return constructor.new(_1063.AcousticWeighting)(value) if value else None

    @weighting.setter
    def weighting(self, value: '_1063.AcousticWeighting'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def chart_type(self) -> '_1073.DynamicsResponse3DChartType':
        ...
        return constructor.new(_1073.DynamicsResponse3DChartType)(value) if value else None

    @chart_type.setter
    def chart_type(self, value: '_1073.DynamicsResponse3DChartType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def connected_component_type(self) -> '_5418.ConnectedComponentType':
        ...
        return constructor.new(_5418.ConnectedComponentType)(value) if value else None

    @connected_component_type.setter
    def connected_component_type(self, value: '_5418.ConnectedComponentType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ConnectedComponentType = value

    @property
    def whine_waterfall_export_option(self) -> '_4840.WhineWaterfallExportOption':
        ...
        return constructor.new(_4840.WhineWaterfallExportOption)(value) if value else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_4840.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def selected_excitations(self) -> '_5421.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5421.ExcitationSourceSelectionGroup)(self.wrapped.SelectedExcitations) if self.wrapped.SelectedExcitations else None

    @property
    def waterfall_chart_settings(self) -> '_4839.WaterfallChartSettings':
        ...
        return constructor.new(_4839.WaterfallChartSettings)(self.wrapped.WaterfallChartSettings) if self.wrapped.WaterfallChartSettings else None

    @property
    def order_cuts_chart_settings(self) -> '_4795.OrderCutsChartSettings':
        ...
        return constructor.new(_4795.OrderCutsChartSettings)(self.wrapped.OrderCutsChartSettings) if self.wrapped.OrderCutsChartSettings else None

    @property
    def frequency_options(self) -> '_5334.FrequencyOptionsForGearWhineAnalysisResults':
        ...
        return constructor.new(_5334.FrequencyOptionsForGearWhineAnalysisResults)(self.wrapped.FrequencyOptions) if self.wrapped.FrequencyOptions else None

    @property
    def reference_speed_options(self) -> '_5385.SpeedOptionsForGearWhineAnalysisResults':
        ...
        return constructor.new(_5385.SpeedOptionsForGearWhineAnalysisResults)(self.wrapped.ReferenceSpeedOptions) if self.wrapped.ReferenceSpeedOptions else None

    @property
    def very_short_length_reference_values(self) -> '_4841.WhineWaterfallReferenceValues[_1211.LengthVeryShort]':
        ...
        return constructor.new(_4841.WhineWaterfallReferenceValues)[_1211.LengthVeryShort](self.wrapped.VeryShortLengthReferenceValues) if self.wrapped.VeryShortLengthReferenceValues else None

    @property
    def small_angle_reference_values(self) -> '_4841.WhineWaterfallReferenceValues[_1165.AngleSmall]':
        ...
        return constructor.new(_4841.WhineWaterfallReferenceValues)[_1165.AngleSmall](self.wrapped.SmallAngleReferenceValues) if self.wrapped.SmallAngleReferenceValues else None

    @property
    def small_velocity_reference_values(self) -> '_4841.WhineWaterfallReferenceValues[_1263.VelocitySmall]':
        ...
        return constructor.new(_4841.WhineWaterfallReferenceValues)[_1263.VelocitySmall](self.wrapped.SmallVelocityReferenceValues) if self.wrapped.SmallVelocityReferenceValues else None

    @property
    def angular_velocity_reference_values(self) -> '_4841.WhineWaterfallReferenceValues[_1171.AngularVelocity]':
        ...
        return constructor.new(_4841.WhineWaterfallReferenceValues)[_1171.AngularVelocity](self.wrapped.AngularVelocityReferenceValues) if self.wrapped.AngularVelocityReferenceValues else None

    @property
    def acceleration_reference_values(self) -> '_4841.WhineWaterfallReferenceValues[_1162.Acceleration]':
        ...
        return constructor.new(_4841.WhineWaterfallReferenceValues)[_1162.Acceleration](self.wrapped.AccelerationReferenceValues) if self.wrapped.AccelerationReferenceValues else None

    @property
    def angular_acceleration_reference_values(self) -> '_4841.WhineWaterfallReferenceValues[_1167.AngularAcceleration]':
        ...
        return constructor.new(_4841.WhineWaterfallReferenceValues)[_1167.AngularAcceleration](self.wrapped.AngularAccelerationReferenceValues) if self.wrapped.AngularAccelerationReferenceValues else None

    @property
    def force_reference_values(self) -> '_4841.WhineWaterfallReferenceValues[_1185.Force]':
        ...
        return constructor.new(_4841.WhineWaterfallReferenceValues)[_1185.Force](self.wrapped.ForceReferenceValues) if self.wrapped.ForceReferenceValues else None

    @property
    def torque_reference_values(self) -> '_4841.WhineWaterfallReferenceValues[_1258.Torque]':
        ...
        return constructor.new(_4841.WhineWaterfallReferenceValues)[_1258.Torque](self.wrapped.TorqueReferenceValues) if self.wrapped.TorqueReferenceValues else None

    @property
    def energy_reference_values(self) -> '_4841.WhineWaterfallReferenceValues[_1179.Energy]':
        ...
        return constructor.new(_4841.WhineWaterfallReferenceValues)[_1179.Energy](self.wrapped.EnergyReferenceValues) if self.wrapped.EnergyReferenceValues else None

    @property
    def power_small_reference_values(self) -> '_4841.WhineWaterfallReferenceValues[_1229.PowerSmall]':
        ...
        return constructor.new(_4841.WhineWaterfallReferenceValues)[_1229.PowerSmall](self.wrapped.PowerSmallReferenceValues) if self.wrapped.PowerSmallReferenceValues else None

    @property
    def power_small_per_unit_area_reference_values(self) -> '_4841.WhineWaterfallReferenceValues[_1230.PowerSmallPerArea]':
        ...
        return constructor.new(_4841.WhineWaterfallReferenceValues)[_1230.PowerSmallPerArea](self.wrapped.PowerSmallPerUnitAreaReferenceValues) if self.wrapped.PowerSmallPerUnitAreaReferenceValues else None

    @property
    def pressure_reference_values(self) -> '_4841.WhineWaterfallReferenceValues[_1233.Pressure]':
        ...
        return constructor.new(_4841.WhineWaterfallReferenceValues)[_1233.Pressure](self.wrapped.PressureReferenceValues) if self.wrapped.PressureReferenceValues else None

    @property
    def result_location_selection_groups(self) -> '_5426.ResultLocationSelectionGroups':
        ...
        return constructor.new(_5426.ResultLocationSelectionGroups)(self.wrapped.ResultLocationSelectionGroups) if self.wrapped.ResultLocationSelectionGroups else None

    @property
    def active_result_locations(self) -> 'List[_5427.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ActiveResultLocations, constructor.new(_5427.ResultNodeSelection))
        return value

    @property
    def degrees_of_freedom(self) -> 'List[_1359.EnumWithBool[_1088.ResultOptionsFor3DVector]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedom, constructor.new(_1359.EnumWithBool)[_1088.ResultOptionsFor3DVector])
        return value
