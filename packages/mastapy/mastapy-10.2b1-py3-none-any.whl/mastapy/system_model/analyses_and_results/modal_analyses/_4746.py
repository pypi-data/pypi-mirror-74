...
class ConicalGearMeshModalAnalysis(_4769.GearMeshModalAnalysis):
    '''ConicalGearMeshModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2257.ConicalGearMeshSystemDeflection':
