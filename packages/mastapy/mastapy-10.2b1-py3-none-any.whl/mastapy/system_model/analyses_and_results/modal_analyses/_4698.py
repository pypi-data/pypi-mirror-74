...
from mastapy.system_model.analyses_and_results.modal_analyses import _4721, _4751, _4778
...
class AbstractAssemblyModalAnalysis(_4778.PartModalAnalysis):
    '''AbstractAssemblyModalAnalysis
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4721.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4721.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_4751.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4751.GearMeshModalAnalysis))
        return value
