...
from mastapy.nodal_analysis import _1368, _1367
...
class ModalAnalysisBarModelFEExportOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_1367.BarModelAnalysisType':
        ...
        return constructor.new(_1367.BarModelAnalysisType)(value) if value else None

    @analysis_type.setter
    def analysis_type(self, value: '_1367.BarModelAnalysisType'):
    ...
    def fe_component(self, value: 'list_with_selected_item.ListWithSelectedItem_ImportedFEComponent.implicit_type()'):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_ImportedFEComponent.wrapper_type()
    ...
    @property
    def mode_options(self) -> '_1458.EigenvalueOptions':
        ...
        return constructor.new(_1458.EigenvalueOptions)(self.wrapped.ModeOptions) if self.wrapped.ModeOptions else None
