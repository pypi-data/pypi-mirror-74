...
from mastapy.system_model.analyses_and_results.modal_analyses import _5885
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _5906, _5904, _5891
...
class PartModalAnalysis(_4455.PartStaticLoadAnalysisCase):
    '''PartModalAnalysis
    ...
    @property
    def modal_analysis(self) -> '_5885.ModalAnalysis':
        ...
        return constructor.new(_5885.ModalAnalysis)(self.wrapped.ModalAnalysis) if self.wrapped.ModalAnalysis else None

    @property
    def results_for_modes(self) -> 'List[_5906.SingleModeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsForModes, constructor.new(_5906.SingleModeResults))
        return value

    @property
    def shaft_excitation_details(self) -> 'List[_5904.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftExcitationDetails, constructor.new(_5904.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def gear_mesh_excitation_details(self) -> 'List[_5904.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshExcitationDetails, constructor.new(_5904.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def excited_modes_summary(self) -> 'List[_5891.SingleExcitationResultsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitedModesSummary, constructor.new(_5891.SingleExcitationResultsModalAnalysis))
        return value
