...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3269
...
class RootAssemblyCompoundModalAnalysis(_3269.AssemblyCompoundModalAnalysis):
    '''RootAssemblyCompoundModalAnalysis
