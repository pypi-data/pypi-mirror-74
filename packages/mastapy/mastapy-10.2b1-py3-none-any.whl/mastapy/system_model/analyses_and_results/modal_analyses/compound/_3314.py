...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3313, _3372, _3296
...
class SpiralBevelGearSetCompoundModalAnalysis(_3296.BevelGearSetCompoundModalAnalysis):
    '''SpiralBevelGearSetCompoundModalAnalysis
    ...
    @property
    def spiral_bevel_gears_compound_modal_analysis(self) -> 'List[_3313.SpiralBevelGearCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsCompoundModalAnalysis, constructor.new(_3313.SpiralBevelGearCompoundModalAnalysis))
        return value

    @property
    def spiral_bevel_meshes_compound_modal_analysis(self) -> 'List[_3372.SpiralBevelGearMeshCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesCompoundModalAnalysis, constructor.new(_3372.SpiralBevelGearMeshCompoundModalAnalysis))
        return value
