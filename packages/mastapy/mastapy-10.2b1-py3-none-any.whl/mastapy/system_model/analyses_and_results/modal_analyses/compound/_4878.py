...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4866
...
class BevelGearSetCompoundModalAnalysis(_4866.AGMAGleasonConicalGearSetCompoundModalAnalysis):
    '''BevelGearSetCompoundModalAnalysis
