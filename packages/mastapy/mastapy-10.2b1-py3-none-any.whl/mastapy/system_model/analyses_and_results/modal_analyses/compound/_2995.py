...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2989
...
class BevelGearSetCompoundModalAnalysis(_2989.AGMAGleasonConicalGearSetCompoundModalAnalysis):
    '''BevelGearSetCompoundModalAnalysis
