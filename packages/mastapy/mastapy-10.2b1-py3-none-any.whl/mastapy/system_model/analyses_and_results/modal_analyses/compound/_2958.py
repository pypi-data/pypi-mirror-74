...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2975
...
class AbstractAssemblyCompoundModalAnalysis(_2975.PartCompoundModalAnalysis):
    '''AbstractAssemblyCompoundModalAnalysis
