...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3111
...
class CVTBeltConnectionCompoundModalAnalysis(_3111.BeltConnectionCompoundModalAnalysis):
    '''CVTBeltConnectionCompoundModalAnalysis
