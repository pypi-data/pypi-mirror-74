...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3315, _3363, _3296
...
class StraightBevelDiffGearSetCompoundModalAnalysis(_3296.BevelGearSetCompoundModalAnalysis):
    '''StraightBevelDiffGearSetCompoundModalAnalysis
    ...
    @property
    def straight_bevel_diff_gears_compound_modal_analysis(self) -> 'List[_3315.StraightBevelDiffGearCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsCompoundModalAnalysis, constructor.new(_3315.StraightBevelDiffGearCompoundModalAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_compound_modal_analysis(self) -> 'List[_3363.StraightBevelDiffGearMeshCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesCompoundModalAnalysis, constructor.new(_3363.StraightBevelDiffGearMeshCompoundModalAnalysis))
        return value
