...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4870
...
class CVTCompoundModalAnalysis(_4870.BeltDriveCompoundModalAnalysis):
    '''CVTCompoundModalAnalysis
