...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3002
...
class ConicalGearSetCompoundModalAnalysis(_3002.GearSetCompoundModalAnalysis):
    '''ConicalGearSetCompoundModalAnalysis
