...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3066
...
class ConicalGearSetCompoundModalAnalysis(_3066.GearSetCompoundModalAnalysis):
    '''ConicalGearSetCompoundModalAnalysis
