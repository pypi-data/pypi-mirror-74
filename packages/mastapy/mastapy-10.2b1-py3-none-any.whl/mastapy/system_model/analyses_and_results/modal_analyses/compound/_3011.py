...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2999
...
class PlanetaryGearSetCompoundModalAnalysis(_2999.CylindricalGearSetCompoundModalAnalysis):
    '''PlanetaryGearSetCompoundModalAnalysis
