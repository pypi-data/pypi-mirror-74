...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2958
...
class SpecialisedAssemblyCompoundModalAnalysis(_2958.AbstractAssemblyCompoundModalAnalysis):
    '''SpecialisedAssemblyCompoundModalAnalysis
