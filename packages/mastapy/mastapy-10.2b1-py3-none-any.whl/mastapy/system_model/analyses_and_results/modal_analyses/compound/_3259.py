...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3276
...
class AbstractAssemblyCompoundModalAnalysis(_3276.PartCompoundModalAnalysis):
    '''AbstractAssemblyCompoundModalAnalysis
