...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4863
...
class ImportedFEComponentCompoundModalAnalysis(_4863.AbstractShaftOrHousingCompoundModalAnalysis):
    '''ImportedFEComponentCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4776.ImportedFEComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4776.ImportedFEComponentModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4776.ImportedFEComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4776.ImportedFEComponentModalAnalysis))
        return value
