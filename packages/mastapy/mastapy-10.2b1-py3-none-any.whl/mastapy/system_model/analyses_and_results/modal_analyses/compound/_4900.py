...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4869
...
class CVTBeltConnectionCompoundModalAnalysis(_4869.BeltConnectionCompoundModalAnalysis):
    '''CVTBeltConnectionCompoundModalAnalysis
