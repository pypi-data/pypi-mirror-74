...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3299, _3367, _3303
...
class CylindricalGearSetCompoundModalAnalysis(_3303.GearSetCompoundModalAnalysis):
    '''CylindricalGearSetCompoundModalAnalysis
    ...
    @property
    def cylindrical_gears_compound_modal_analysis(self) -> 'List[_3299.CylindricalGearCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsCompoundModalAnalysis, constructor.new(_3299.CylindricalGearCompoundModalAnalysis))
        return value

    @property
    def cylindrical_meshes_compound_modal_analysis(self) -> 'List[_3367.CylindricalGearMeshCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesCompoundModalAnalysis, constructor.new(_3367.CylindricalGearMeshCompoundModalAnalysis))
        return value
