...
from mastapy.system_model.analyses_and_results.modal_analyses import _3885
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3117
...
class PlanetaryConnectionCompoundModalAnalysis(_3117.ShaftToMountableComponentConnectionCompoundModalAnalysis):
    '''PlanetaryConnectionCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3885.PlanetaryConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3885.PlanetaryConnectionModalAnalysis))
        return value

    @property
    def connection_modal_analysis_load_cases(self) -> 'List[_3885.PlanetaryConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysisLoadCases, constructor.new(_3885.PlanetaryConnectionModalAnalysis))
        return value
