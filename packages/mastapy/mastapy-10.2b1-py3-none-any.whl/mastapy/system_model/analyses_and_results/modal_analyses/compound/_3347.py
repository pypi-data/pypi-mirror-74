...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3348
...
class CVTBeltConnectionCompoundModalAnalysis(_3348.BeltConnectionCompoundModalAnalysis):
    '''CVTBeltConnectionCompoundModalAnalysis
