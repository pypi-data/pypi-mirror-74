...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _2986, _3061, _3002
...
class FaceGearSetCompoundModalAnalysis(_3002.GearSetCompoundModalAnalysis):
    '''FaceGearSetCompoundModalAnalysis
    ...
    @property
    def face_gears_compound_modal_analysis(self) -> 'List[_2986.FaceGearCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsCompoundModalAnalysis, constructor.new(_2986.FaceGearCompoundModalAnalysis))
        return value

    @property
    def face_meshes_compound_modal_analysis(self) -> 'List[_3061.FaceGearMeshCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesCompoundModalAnalysis, constructor.new(_3061.FaceGearMeshCompoundModalAnalysis))
        return value
