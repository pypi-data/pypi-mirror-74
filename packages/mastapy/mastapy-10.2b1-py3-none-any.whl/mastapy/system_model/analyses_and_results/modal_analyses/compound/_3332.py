...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _3325
...
class CVTCompoundModalAnalysis(_3325.BeltDriveCompoundModalAnalysis):
    '''CVTCompoundModalAnalysis
