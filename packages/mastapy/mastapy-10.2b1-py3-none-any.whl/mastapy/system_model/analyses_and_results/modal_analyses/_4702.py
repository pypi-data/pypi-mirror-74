...
class AGMAGleasonConicalGearSetModalAnalysis(_4730.ConicalGearSetModalAnalysis):
    '''AGMAGleasonConicalGearSetModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2210.AGMAGleasonConicalGearSetSystemDeflection':
