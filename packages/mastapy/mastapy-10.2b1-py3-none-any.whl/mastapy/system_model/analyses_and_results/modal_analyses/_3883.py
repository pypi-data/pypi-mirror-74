...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _5891
...
class ConnectionModalAnalysis(_3375.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysis
