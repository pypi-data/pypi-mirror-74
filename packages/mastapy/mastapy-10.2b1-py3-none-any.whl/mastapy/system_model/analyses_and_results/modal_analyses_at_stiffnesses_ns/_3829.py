...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3739
...
class ShaftModalAnalysesAtStiffnesses(_3739.AbstractShaftOrHousingModalAnalysesAtStiffnesses):
    '''ShaftModalAnalysesAtStiffnesses
