...
AGMAGleasonConicalGearSetModalAnalysesAtStiffnesses
'''
...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _4956
from mastapy._internal.python_net import python_net_import

_AGMA_GLEASON_CONICAL_GEAR_SET_MODAL_ANALYSES_AT_STIFFNESSES = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtStiffnessesNS', 'AGMAGleasonConicalGearSetModalAnalysesAtStiffnesses')


__docformat__ = 'restructuredtext en'
__all__ = ('AGMAGleasonConicalGearSetModalAnalysesAtStiffnesses',)


class AGMAGleasonConicalGearSetModalAnalysesAtStiffnesses(_4956.ConicalGearSetModalAnalysesAtStiffnesses):
    '''AGMAGleasonConicalGearSetModalAnalysesAtStiffnesses

    This is a mastapy class.
    '''

    TYPE = _AGMA_GLEASON_CONICAL_GEAR_SET_MODAL_ANALYSES_AT_STIFFNESSES
    __hash__ = None

    def __init__(self, instance_to_wrap: 'AGMAGleasonConicalGearSetModalAnalysesAtStiffnesses.TYPE'):
