...
ConicalGearModalAnalysesAtStiffnesses
'''
...
from mastapy.system_model.part_model.gears import (
    _2079, _2069, _2071, _2073,
    _2074, _2075, _2090, _2092,
    _2094, _2096, _2099, _2101,
    _2103, _2105, _2106, _2109
)
from mastapy._internal import constructor, conversion
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3791
from mastapy._internal.python_net import python_net_import

_CONICAL_GEAR_MODAL_ANALYSES_AT_STIFFNESSES = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtStiffnessesNS', 'ConicalGearModalAnalysesAtStiffnesses')


__docformat__ = 'restructuredtext en'
__all__ = ('ConicalGearModalAnalysesAtStiffnesses',)


class ConicalGearModalAnalysesAtStiffnesses(_3791.GearModalAnalysesAtStiffnesses):
    '''ConicalGearModalAnalysesAtStiffnesses

    This is a mastapy class.
    '''

    TYPE = _CONICAL_GEAR_MODAL_ANALYSES_AT_STIFFNESSES

    __hash__ = None

    def __init__(self, instance_to_wrap: 'ConicalGearModalAnalysesAtStiffnesses.TYPE'):
        super().__init__(instance_to_wrap)

    @property
    def component_design(self) -> '_2079.ConicalGear':
    ...
    @property
    def planetaries(self) -> 'List[ConicalGearModalAnalysesAtStiffnesses]':
        '''List[ConicalGearModalAnalysesAtStiffnesses]: 'Planetaries' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearModalAnalysesAtStiffnesses))
        return value
