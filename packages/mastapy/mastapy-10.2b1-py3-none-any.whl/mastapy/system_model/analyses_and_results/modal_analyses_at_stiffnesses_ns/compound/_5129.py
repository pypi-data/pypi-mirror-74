...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _5008
...
class RollingRingConnectionCompoundModalAnalysesAtStiffnesses(_5106.InterMountableComponentConnectionCompoundModalAnalysesAtStiffnesses):
    '''RollingRingConnectionCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5008.RollingRingConnectionModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5008.RollingRingConnectionModalAnalysesAtStiffnesses))
        return value

    @property
    def connection_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_5008.RollingRingConnectionModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtStiffnessesLoadCases, constructor.new(_5008.RollingRingConnectionModalAnalysesAtStiffnesses))
        return value
