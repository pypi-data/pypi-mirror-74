...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns.compound import _5055
...
class CVTCompoundModalAnalysesAtStiffnesses(_5055.BeltDriveCompoundModalAnalysesAtStiffnesses):
    '''CVTCompoundModalAnalysesAtStiffnesses
