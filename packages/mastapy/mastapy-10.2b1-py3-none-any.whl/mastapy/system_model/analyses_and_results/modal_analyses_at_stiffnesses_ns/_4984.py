...
InterMountableComponentConnectionModalAnalysesAtStiffnesses
'''
...
_INTER_MOUNTABLE_COMPONENT_CONNECTION_MODAL_ANALYSES_AT_STIFFNESSES = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtStiffnessesNS', 'InterMountableComponentConnectionModalAnalysesAtStiffnesses')


__docformat__ = 'restructuredtext en'
__all__ = ('InterMountableComponentConnectionModalAnalysesAtStiffnesses',)


class InterMountableComponentConnectionModalAnalysesAtStiffnesses(_4957.ConnectionModalAnalysesAtStiffnesses):
    '''InterMountableComponentConnectionModalAnalysesAtStiffnesses

    This is a mastapy class.
    '''

    TYPE = _INTER_MOUNTABLE_COMPONENT_CONNECTION_MODAL_ANALYSES_AT_STIFFNESSES
    __hash__ = None

    def __init__(self, instance_to_wrap: 'InterMountableComponentConnectionModalAnalysesAtStiffnesses.TYPE'):
