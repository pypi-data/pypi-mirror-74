...
ComponentModalAnalysesAtStiffnesses
'''
...
_COMPONENT_MODAL_ANALYSES_AT_STIFFNESSES = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtStiffnessesNS', 'ComponentModalAnalysesAtStiffnesses')


__docformat__ = 'restructuredtext en'
__all__ = ('ComponentModalAnalysesAtStiffnesses',)


class ComponentModalAnalysesAtStiffnesses(_5000.PartModalAnalysesAtStiffnesses):
    '''ComponentModalAnalysesAtStiffnesses

    This is a mastapy class.
    '''

    TYPE = _COMPONENT_MODAL_ANALYSES_AT_STIFFNESSES
    __hash__ = None

    def __init__(self, instance_to_wrap: 'ComponentModalAnalysesAtStiffnesses.TYPE'):
