...
GearModalAnalysesAtStiffnesses
'''
...
_GEAR_MODAL_ANALYSES_AT_STIFFNESSES = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtStiffnessesNS', 'GearModalAnalysesAtStiffnesses')


__docformat__ = 'restructuredtext en'
__all__ = ('GearModalAnalysesAtStiffnesses',)


class GearModalAnalysesAtStiffnesses(_4998.MountableComponentModalAnalysesAtStiffnesses):
    '''GearModalAnalysesAtStiffnesses

    This is a mastapy class.
    '''

    TYPE = _GEAR_MODAL_ANALYSES_AT_STIFFNESSES
    __hash__ = None

    def __init__(self, instance_to_wrap: 'GearModalAnalysesAtStiffnesses.TYPE'):
