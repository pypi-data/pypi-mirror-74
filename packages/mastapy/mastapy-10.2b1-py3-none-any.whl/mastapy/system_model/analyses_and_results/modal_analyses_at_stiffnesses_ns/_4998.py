...
MountableComponentModalAnalysesAtStiffnesses
'''
...
_MOUNTABLE_COMPONENT_MODAL_ANALYSES_AT_STIFFNESSES = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtStiffnessesNS', 'MountableComponentModalAnalysesAtStiffnesses')


__docformat__ = 'restructuredtext en'
__all__ = ('MountableComponentModalAnalysesAtStiffnesses',)


class MountableComponentModalAnalysesAtStiffnesses(_4947.ComponentModalAnalysesAtStiffnesses):
    '''MountableComponentModalAnalysesAtStiffnesses

    This is a mastapy class.
    '''

    TYPE = _MOUNTABLE_COMPONENT_MODAL_ANALYSES_AT_STIFFNESSES
    __hash__ = None

    def __init__(self, instance_to_wrap: 'MountableComponentModalAnalysesAtStiffnesses.TYPE'):
