...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _5000
...
class AbstractAssemblyModalAnalysesAtStiffnesses(_5000.PartModalAnalysesAtStiffnesses):
    '''AbstractAssemblyModalAnalysesAtStiffnesses
