...
SpecialisedAssemblyModalAnalysesAtStiffnesses
'''
...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _4924
from mastapy._internal.python_net import python_net_import

_SPECIALISED_ASSEMBLY_MODAL_ANALYSES_AT_STIFFNESSES = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtStiffnessesNS', 'SpecialisedAssemblyModalAnalysesAtStiffnesses')


__docformat__ = 'restructuredtext en'
__all__ = ('SpecialisedAssemblyModalAnalysesAtStiffnesses',)


class SpecialisedAssemblyModalAnalysesAtStiffnesses(_4924.AbstractAssemblyModalAnalysesAtStiffnesses):
    '''SpecialisedAssemblyModalAnalysesAtStiffnesses

    This is a mastapy class.
    '''

    TYPE = _SPECIALISED_ASSEMBLY_MODAL_ANALYSES_AT_STIFFNESSES
    __hash__ = None

    def __init__(self, instance_to_wrap: 'SpecialisedAssemblyModalAnalysesAtStiffnesses.TYPE'):
