...
GearMeshModalAnalysesAtStiffnesses
'''
...
_GEAR_MESH_MODAL_ANALYSES_AT_STIFFNESSES = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtStiffnessesNS', 'GearMeshModalAnalysesAtStiffnesses')


__docformat__ = 'restructuredtext en'
__all__ = ('GearMeshModalAnalysesAtStiffnesses',)


class GearMeshModalAnalysesAtStiffnesses(_4984.InterMountableComponentConnectionModalAnalysesAtStiffnesses):
    '''GearMeshModalAnalysesAtStiffnesses

    This is a mastapy class.
    '''

    TYPE = _GEAR_MESH_MODAL_ANALYSES_AT_STIFFNESSES
    __hash__ = None

    def __init__(self, instance_to_wrap: 'GearMeshModalAnalysesAtStiffnesses.TYPE'):
