...
AGMAGleasonConicalGearModalAnalysesAtStiffnesses
'''
...
_AGMA_GLEASON_CONICAL_GEAR_MODAL_ANALYSES_AT_STIFFNESSES = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtStiffnessesNS', 'AGMAGleasonConicalGearModalAnalysesAtStiffnesses')


__docformat__ = 'restructuredtext en'
__all__ = ('AGMAGleasonConicalGearModalAnalysesAtStiffnesses',)


class AGMAGleasonConicalGearModalAnalysesAtStiffnesses(_4955.ConicalGearModalAnalysesAtStiffnesses):
    '''AGMAGleasonConicalGearModalAnalysesAtStiffnesses

    This is a mastapy class.
    '''

    TYPE = _AGMA_GLEASON_CONICAL_GEAR_MODAL_ANALYSES_AT_STIFFNESSES
    __hash__ = None

    def __init__(self, instance_to_wrap: 'AGMAGleasonConicalGearModalAnalysesAtStiffnesses.TYPE'):
