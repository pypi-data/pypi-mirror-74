...
GearSetModalAnalysesAtStiffnesses
'''
...
_GEAR_SET_MODAL_ANALYSES_AT_STIFFNESSES = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtStiffnessesNS', 'GearSetModalAnalysesAtStiffnesses')


__docformat__ = 'restructuredtext en'
__all__ = ('GearSetModalAnalysesAtStiffnesses',)


class GearSetModalAnalysesAtStiffnesses(_3831.SpecialisedAssemblyModalAnalysesAtStiffnesses):
    '''GearSetModalAnalysesAtStiffnesses

    This is a mastapy class.
    '''

    TYPE = _GEAR_SET_MODAL_ANALYSES_AT_STIFFNESSES

    __hash__ = None

    def __init__(self, instance_to_wrap: 'GearSetModalAnalysesAtStiffnesses.TYPE'):
