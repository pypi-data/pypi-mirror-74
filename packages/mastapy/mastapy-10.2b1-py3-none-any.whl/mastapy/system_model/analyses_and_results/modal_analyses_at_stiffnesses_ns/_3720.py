...
AbstractAssemblyModalAnalysesAtStiffnesses
'''
...
_ABSTRACT_ASSEMBLY_MODAL_ANALYSES_AT_STIFFNESSES = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtStiffnessesNS', 'AbstractAssemblyModalAnalysesAtStiffnesses')


__docformat__ = 'restructuredtext en'
__all__ = ('AbstractAssemblyModalAnalysesAtStiffnesses',)


class AbstractAssemblyModalAnalysesAtStiffnesses(_3796.PartModalAnalysesAtStiffnesses):
    '''AbstractAssemblyModalAnalysesAtStiffnesses

    This is a mastapy class.
    '''

    TYPE = _ABSTRACT_ASSEMBLY_MODAL_ANALYSES_AT_STIFFNESSES

    __hash__ = None

    def __init__(self, instance_to_wrap: 'AbstractAssemblyModalAnalysesAtStiffnesses.TYPE'):
