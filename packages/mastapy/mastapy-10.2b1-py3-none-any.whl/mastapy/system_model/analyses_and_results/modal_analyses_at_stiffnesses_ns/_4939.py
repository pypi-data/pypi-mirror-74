...
BevelGearModalAnalysesAtStiffnesses
'''
...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _4927
from mastapy._internal.python_net import python_net_import

_BEVEL_GEAR_MODAL_ANALYSES_AT_STIFFNESSES = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtStiffnessesNS', 'BevelGearModalAnalysesAtStiffnesses')


__docformat__ = 'restructuredtext en'
__all__ = ('BevelGearModalAnalysesAtStiffnesses',)


class BevelGearModalAnalysesAtStiffnesses(_4927.AGMAGleasonConicalGearModalAnalysesAtStiffnesses):
    '''BevelGearModalAnalysesAtStiffnesses

    This is a mastapy class.
    '''

    TYPE = _BEVEL_GEAR_MODAL_ANALYSES_AT_STIFFNESSES
    __hash__ = None

    def __init__(self, instance_to_wrap: 'BevelGearModalAnalysesAtStiffnesses.TYPE'):
        super().__init__(instance_to_wrap)

    @property
    def component_design(self) -> '_2001.BevelGear':
        ...
        return constructor.new(_2001.BevelGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
