...
_BEVEL_GEAR_MODAL_ANALYSIS_AT_A_STIFFNESS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtAStiffness', 'BevelGearModalAnalysisAtAStiffness')
...
class BevelGearModalAnalysisAtAStiffness(_5410.AGMAGleasonConicalGearModalAnalysisAtAStiffness):
    '''BevelGearModalAnalysisAtAStiffness
    ...
    def __init__(self, instance_to_wrap: 'BevelGearModalAnalysisAtAStiffness.TYPE'):
