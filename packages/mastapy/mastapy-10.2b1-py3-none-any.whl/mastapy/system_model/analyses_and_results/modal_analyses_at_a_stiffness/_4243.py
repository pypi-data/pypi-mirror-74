...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4231
from mastapy._internal.python_net import python_net_import

_BEVEL_GEAR_MESH_MODAL_ANALYSIS_AT_A_STIFFNESS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtAStiffness', 'BevelGearMeshModalAnalysisAtAStiffness')
...
class BevelGearMeshModalAnalysisAtAStiffness(_4231.AGMAGleasonConicalGearMeshModalAnalysisAtAStiffness):
    '''BevelGearMeshModalAnalysisAtAStiffness
    ...
    def __init__(self, instance_to_wrap: 'BevelGearMeshModalAnalysisAtAStiffness.TYPE'):
