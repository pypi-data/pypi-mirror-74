...
class ConicalGearModalAnalysisAtAStiffness(_5460.GearModalAnalysisAtAStiffness):
    '''ConicalGearModalAnalysisAtAStiffness
    ...
    def planetaries(self) -> 'List[ConicalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearModalAnalysisAtAStiffness))
        return value
