...
class FlexiblePinAnalysisManufactureLevel(_5786.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_3503.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_3503.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
