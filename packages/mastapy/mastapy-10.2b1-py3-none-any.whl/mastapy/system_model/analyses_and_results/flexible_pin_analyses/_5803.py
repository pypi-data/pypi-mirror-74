...
class FlexiblePinAnalysisManufactureLevel(_5799.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_3514.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_3514.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
