...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2416, _2379
...
class FlexiblePinAnalysisGearAndBearingRating(_5807.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisGearAndBearingRating
    ...
    @property
    def gear_set_analysis(self) -> '_2416.CylindricalGearSetCompoundSystemDeflection':
        ...
        return constructor.new(_2416.CylindricalGearSetCompoundSystemDeflection)(self.wrapped.GearSetAnalysis) if self.wrapped.GearSetAnalysis else None

    @property
    def bearing_analyses(self) -> 'List[_2379.BearingCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingAnalyses, constructor.new(_2379.BearingCompoundSystemDeflection))
        return value
