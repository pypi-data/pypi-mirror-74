...
class BeltConnectionGearWhineAnalysis(_5351.InterMountableComponentConnectionGearWhineAnalysis):
    '''BeltConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2232.BeltConnectionSystemDeflection':
