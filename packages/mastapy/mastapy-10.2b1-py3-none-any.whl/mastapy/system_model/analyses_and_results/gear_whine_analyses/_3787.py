...
class StraightBevelGearMeshGearWhineAnalysis(_3778.BevelGearMeshGearWhineAnalysis):
    '''StraightBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2255.StraightBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2255.StraightBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
