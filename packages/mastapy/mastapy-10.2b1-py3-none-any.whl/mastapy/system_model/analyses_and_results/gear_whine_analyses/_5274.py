...
AGMAGleasonConicalGearSetGearWhineAnalysis
'''
...
from mastapy.system_model.analyses_and_results.system_deflections import (
    _2228, _2235, _2240, _2290,
    _2330, _2336, _2339, _2362
)
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5303
from mastapy._internal.python_net import python_net_import

_AGMA_GLEASON_CONICAL_GEAR_SET_GEAR_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses', 'AGMAGleasonConicalGearSetGearWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('AGMAGleasonConicalGearSetGearWhineAnalysis',)


class AGMAGleasonConicalGearSetGearWhineAnalysis(_5303.ConicalGearSetGearWhineAnalysis):
    '''AGMAGleasonConicalGearSetGearWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _AGMA_GLEASON_CONICAL_GEAR_SET_GEAR_WHINE_ANALYSIS

    __hash__ = None

    def __init__(self, instance_to_wrap: 'AGMAGleasonConicalGearSetGearWhineAnalysis.TYPE'):
    ...
    @property
    def system_deflection_results(self) -> '_2228.AGMAGleasonConicalGearSetSystemDeflection':
