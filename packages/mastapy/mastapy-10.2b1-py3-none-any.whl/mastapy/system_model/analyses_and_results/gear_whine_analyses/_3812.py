...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _6204, _3801
...
class RootAssemblyGearWhineAnalysis(_3801.AssemblyGearWhineAnalysis):
    '''RootAssemblyGearWhineAnalysis
    ...
    @property
    def gear_whine_analysis_inputs(self) -> '_6204.GearWhineAnalysis':
        ...
        return constructor.new(_6204.GearWhineAnalysis)(self.wrapped.GearWhineAnalysisInputs) if self.wrapped.GearWhineAnalysisInputs else None
