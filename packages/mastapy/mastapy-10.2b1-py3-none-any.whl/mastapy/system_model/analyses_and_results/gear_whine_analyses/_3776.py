...
class FaceGearMeshGearWhineAnalysis(_3790.GearMeshGearWhineAnalysis):
    '''FaceGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2235.FaceGearMeshSystemDeflection':
        ...
        return constructor.new(_2235.FaceGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
