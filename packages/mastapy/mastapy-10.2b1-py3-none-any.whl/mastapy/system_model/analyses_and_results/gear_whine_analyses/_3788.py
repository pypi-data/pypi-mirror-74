...
class WormGearMeshGearWhineAnalysis(_3790.GearMeshGearWhineAnalysis):
    '''WormGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2257.WormGearMeshSystemDeflection':
        ...
        return constructor.new(_2257.WormGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
