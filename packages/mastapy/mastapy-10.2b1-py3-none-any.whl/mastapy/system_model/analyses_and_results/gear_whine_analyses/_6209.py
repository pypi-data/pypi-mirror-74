...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _6180
...
class PeriodicExcitationWithReferenceShaft(_6180.AbstractPeriodicExcitationDetail):
    '''PeriodicExcitationWithReferenceShaft
