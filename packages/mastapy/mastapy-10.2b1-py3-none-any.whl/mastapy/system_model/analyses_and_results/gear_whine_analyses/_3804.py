...
class MassDiscGearWhineAnalysis(_3815.VirtualComponentGearWhineAnalysis):
    '''MassDiscGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2282.MassDiscSystemDeflection':
        ...
        return constructor.new(_2282.MassDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
