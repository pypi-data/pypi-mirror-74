...
class MeasurementComponentGearWhineAnalysis(_3815.VirtualComponentGearWhineAnalysis):
    '''MeasurementComponentGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2284.MeasurementComponentSystemDeflection':
