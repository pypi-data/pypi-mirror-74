...
class StraightBevelSunGearGearWhineAnalysis(_5392.StraightBevelDiffGearGearWhineAnalysis):
    '''StraightBevelSunGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2342.StraightBevelSunGearSystemDeflection':
