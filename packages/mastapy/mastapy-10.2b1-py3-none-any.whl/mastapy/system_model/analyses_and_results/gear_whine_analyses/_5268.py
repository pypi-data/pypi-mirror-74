...
class BevelGearSetGearWhineAnalysis(_5256.AGMAGleasonConicalGearSetGearWhineAnalysis):
    '''BevelGearSetGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2222.BevelGearSetSystemDeflection':
