...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _6204
...
class ConnectionGearWhineAnalysis(_3375.ConnectionStaticLoadAnalysisCase):
    '''ConnectionGearWhineAnalysis
    ...
    @property
    def single_excitation_analyses(self) -> 'List[_6222.SingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SingleExcitationAnalyses, constructor.new(_6222.SingleMeshWhineAnalysis))
        return value
