...
MountableComponentSingleMeshWhineAnalysis
'''


from mastapy.system_model.part_model import (
    _1928, _1932, _1908, _1929,
...
from mastapy.system_model.part_model.gears import (
    _2003, _2005, _2006, _2007,
    _2011, _2012, _2013, _2014,
    _2015, _2016, _2017, _2018,
    _2019, _2020, _2021, _2022,
    _2023
)
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _4268
from mastapy._internal.python_net import python_net_import

_MOUNTABLE_COMPONENT_SINGLE_MESH_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses.SingleMeshWhineAnalyses', 'MountableComponentSingleMeshWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('MountableComponentSingleMeshWhineAnalysis',)


class MountableComponentSingleMeshWhineAnalysis(_4268.ComponentSingleMeshWhineAnalysis):
    '''MountableComponentSingleMeshWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _MOUNTABLE_COMPONENT_SINGLE_MESH_WHINE_ANALYSIS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'MountableComponentSingleMeshWhineAnalysis.TYPE'):
        super().__init__(instance_to_wrap)

    @property
    def component_design(self) -> '_1928.MountableComponent':
        ...
        return constructor.new(_1928.MountableComponent)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
