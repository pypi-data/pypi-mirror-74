...
InterMountableComponentConnectionSingleMeshWhineAnalysis
'''
...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _4236
from mastapy._internal.python_net import python_net_import

_INTER_MOUNTABLE_COMPONENT_CONNECTION_SINGLE_MESH_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses.SingleMeshWhineAnalyses', 'InterMountableComponentConnectionSingleMeshWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('InterMountableComponentConnectionSingleMeshWhineAnalysis',)


class InterMountableComponentConnectionSingleMeshWhineAnalysis(_4236.ConnectionSingleMeshWhineAnalysis):
    '''InterMountableComponentConnectionSingleMeshWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _INTER_MOUNTABLE_COMPONENT_CONNECTION_SINGLE_MESH_WHINE_ANALYSIS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'InterMountableComponentConnectionSingleMeshWhineAnalysis.TYPE'):
