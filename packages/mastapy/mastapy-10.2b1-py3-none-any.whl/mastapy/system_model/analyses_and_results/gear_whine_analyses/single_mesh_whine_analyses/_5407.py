...
AbstractAssemblySingleMeshWhineAnalysis
'''
...
_ABSTRACT_ASSEMBLY_SINGLE_MESH_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses.SingleMeshWhineAnalyses', 'AbstractAssemblySingleMeshWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('AbstractAssemblySingleMeshWhineAnalysis',)


class AbstractAssemblySingleMeshWhineAnalysis(_5481.PartSingleMeshWhineAnalysis):
    '''AbstractAssemblySingleMeshWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _ABSTRACT_ASSEMBLY_SINGLE_MESH_WHINE_ANALYSIS

    __hash__ = None

    def __init__(self, instance_to_wrap: 'AbstractAssemblySingleMeshWhineAnalysis.TYPE'):
