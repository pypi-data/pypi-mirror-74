...
BevelGearMeshSingleMeshWhineAnalysis
'''
...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _4323
from mastapy._internal.python_net import python_net_import

_BEVEL_GEAR_MESH_SINGLE_MESH_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses.SingleMeshWhineAnalyses', 'BevelGearMeshSingleMeshWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('BevelGearMeshSingleMeshWhineAnalysis',)


class BevelGearMeshSingleMeshWhineAnalysis(_4323.AGMAGleasonConicalGearMeshSingleMeshWhineAnalysis):
    '''BevelGearMeshSingleMeshWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _BEVEL_GEAR_MESH_SINGLE_MESH_WHINE_ANALYSIS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'BevelGearMeshSingleMeshWhineAnalysis.TYPE'):
