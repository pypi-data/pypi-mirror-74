...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _4278
...
class CouplingHalfSingleMeshWhineAnalysis(_4278.MountableComponentSingleMeshWhineAnalysis):
    '''CouplingHalfSingleMeshWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2001.CouplingHalf':
        ...
        return constructor.new(_2001.CouplingHalf)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
