...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses.compound import _3680
...
class CVTCompoundSingleMeshWhineAnalysis(_3680.BeltDriveCompoundSingleMeshWhineAnalysis):
    '''CVTCompoundSingleMeshWhineAnalysis
