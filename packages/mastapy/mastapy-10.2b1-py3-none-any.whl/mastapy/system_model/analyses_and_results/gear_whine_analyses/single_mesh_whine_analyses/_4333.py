...
GearMeshSingleMeshWhineAnalysis
'''
...
_GEAR_MESH_SINGLE_MESH_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses.SingleMeshWhineAnalyses', 'GearMeshSingleMeshWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('GearMeshSingleMeshWhineAnalysis',)


class GearMeshSingleMeshWhineAnalysis(_4308.InterMountableComponentConnectionSingleMeshWhineAnalysis):
    '''GearMeshSingleMeshWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _GEAR_MESH_SINGLE_MESH_WHINE_ANALYSIS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'GearMeshSingleMeshWhineAnalysis.TYPE'):
