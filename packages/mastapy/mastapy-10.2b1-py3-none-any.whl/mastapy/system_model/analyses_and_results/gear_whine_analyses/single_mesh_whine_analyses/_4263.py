...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _4280
...
class AbstractAssemblySingleMeshWhineAnalysis(_4280.PartSingleMeshWhineAnalysis):
    '''AbstractAssemblySingleMeshWhineAnalysis
