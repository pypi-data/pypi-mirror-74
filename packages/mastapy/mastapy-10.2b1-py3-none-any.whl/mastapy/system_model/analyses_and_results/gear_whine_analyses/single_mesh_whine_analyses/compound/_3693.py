...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _4224
...
class SpringDamperCompoundSingleMeshWhineAnalysis(_3685.CouplingCompoundSingleMeshWhineAnalysis):
    '''SpringDamperCompoundSingleMeshWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2036.SpringDamper':
    ...
    @property
    def assembly_design(self) -> '_2036.SpringDamper':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4224.SpringDamperSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4224.SpringDamperSingleMeshWhineAnalysis))
        return value

    @property
    def assembly_single_mesh_whine_analysis_load_cases(self) -> 'List[_4224.SpringDamperSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySingleMeshWhineAnalysisLoadCases, constructor.new(_4224.SpringDamperSingleMeshWhineAnalysis))
        return value
