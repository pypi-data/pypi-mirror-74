...
CouplingHalfSingleMeshWhineAnalysis
'''
...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _4349
from mastapy._internal.python_net import python_net_import

_COUPLING_HALF_SINGLE_MESH_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses.SingleMeshWhineAnalyses', 'CouplingHalfSingleMeshWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('CouplingHalfSingleMeshWhineAnalysis',)


class CouplingHalfSingleMeshWhineAnalysis(_4349.MountableComponentSingleMeshWhineAnalysis):
    '''CouplingHalfSingleMeshWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _COUPLING_HALF_SINGLE_MESH_WHINE_ANALYSIS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'CouplingHalfSingleMeshWhineAnalysis.TYPE'):
        super().__init__(instance_to_wrap)

    @property
    def component_design(self) -> '_1993.CouplingHalf':
        ...
        return constructor.new(_1993.CouplingHalf)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
