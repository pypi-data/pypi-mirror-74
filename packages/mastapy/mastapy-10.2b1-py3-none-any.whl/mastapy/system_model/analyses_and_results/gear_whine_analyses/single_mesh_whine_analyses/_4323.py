...
AGMAGleasonConicalGearMeshSingleMeshWhineAnalysis
'''
...
_AGMA_GLEASON_CONICAL_GEAR_MESH_SINGLE_MESH_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses.SingleMeshWhineAnalyses', 'AGMAGleasonConicalGearMeshSingleMeshWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('AGMAGleasonConicalGearMeshSingleMeshWhineAnalysis',)


class AGMAGleasonConicalGearMeshSingleMeshWhineAnalysis(_4322.ConicalGearMeshSingleMeshWhineAnalysis):
    '''AGMAGleasonConicalGearMeshSingleMeshWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _AGMA_GLEASON_CONICAL_GEAR_MESH_SINGLE_MESH_WHINE_ANALYSIS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'AGMAGleasonConicalGearMeshSingleMeshWhineAnalysis.TYPE'):
