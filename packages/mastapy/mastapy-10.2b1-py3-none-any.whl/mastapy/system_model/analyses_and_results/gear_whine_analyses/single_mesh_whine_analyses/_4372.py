...
ConicalGearSingleMeshWhineAnalysis
'''
...
_CONICAL_GEAR_SINGLE_MESH_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses.SingleMeshWhineAnalyses', 'ConicalGearSingleMeshWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('ConicalGearSingleMeshWhineAnalysis',)


class ConicalGearSingleMeshWhineAnalysis(_4377.GearSingleMeshWhineAnalysis):
    '''ConicalGearSingleMeshWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _CONICAL_GEAR_SINGLE_MESH_WHINE_ANALYSIS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'ConicalGearSingleMeshWhineAnalysis.TYPE'):
    ...
    @property
    def planetaries(self) -> 'List[ConicalGearSingleMeshWhineAnalysis]':
        '''List[ConicalGearSingleMeshWhineAnalysis]: 'Planetaries' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearSingleMeshWhineAnalysis))
        return value
