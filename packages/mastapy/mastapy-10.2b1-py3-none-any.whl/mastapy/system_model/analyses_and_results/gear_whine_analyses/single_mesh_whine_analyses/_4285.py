...
SpecialisedAssemblySingleMeshWhineAnalysis
'''
...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _4263
from mastapy._internal.python_net import python_net_import

_SPECIALISED_ASSEMBLY_SINGLE_MESH_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses.SingleMeshWhineAnalyses', 'SpecialisedAssemblySingleMeshWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('SpecialisedAssemblySingleMeshWhineAnalysis',)


class SpecialisedAssemblySingleMeshWhineAnalysis(_4263.AbstractAssemblySingleMeshWhineAnalysis):
    '''SpecialisedAssemblySingleMeshWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _SPECIALISED_ASSEMBLY_SINGLE_MESH_WHINE_ANALYSIS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'SpecialisedAssemblySingleMeshWhineAnalysis.TYPE'):
    ...
    @property
    def assembly_design_of_type_belt_drive(self) -> '_1974.BeltDrive':
        ...
        return constructor.new(_1974.BeltDrive)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None

    @property
    def assembly_design_of_type_rolling_ring_assembly(self) -> '_1976.RollingRingAssembly':
    ...
    @property
    def assembly_design_of_type_synchroniser(self) -> '_1977.Synchroniser':
        ...
        return constructor.new(_1977.Synchroniser)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
    ...
    @property
    def assembly_design_of_type_cvt(self) -> '_1995.CVT':
