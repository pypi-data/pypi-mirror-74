...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _5429
...
class ShaftSingleMeshWhineAnalysis(_5429.AbstractShaftOrHousingSingleMeshWhineAnalysis):
    '''ShaftSingleMeshWhineAnalysis
