...
ConceptGearSingleMeshWhineAnalysis
'''
...
_CONCEPT_GEAR_SINGLE_MESH_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses.SingleMeshWhineAnalyses', 'ConceptGearSingleMeshWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('ConceptGearSingleMeshWhineAnalysis',)


class ConceptGearSingleMeshWhineAnalysis(_4377.GearSingleMeshWhineAnalysis):
    '''ConceptGearSingleMeshWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _CONCEPT_GEAR_SINGLE_MESH_WHINE_ANALYSIS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'ConceptGearSingleMeshWhineAnalysis.TYPE'):
