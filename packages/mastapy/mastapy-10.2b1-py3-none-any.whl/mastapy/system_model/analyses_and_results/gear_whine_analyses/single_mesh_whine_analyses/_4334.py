...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _4351
...
class AbstractAssemblySingleMeshWhineAnalysis(_4351.PartSingleMeshWhineAnalysis):
    '''AbstractAssemblySingleMeshWhineAnalysis
