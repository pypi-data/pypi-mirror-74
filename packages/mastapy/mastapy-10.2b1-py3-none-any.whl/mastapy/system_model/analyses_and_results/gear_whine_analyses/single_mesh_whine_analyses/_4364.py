...
AGMAGleasonConicalGearSingleMeshWhineAnalysis
'''


from mastapy.system_model.part_model.gears import (
    _1999, _2002, _2003, _2004,
    _2005, _2006, _2007, _2008,
    _2009, _2010, _2011
)
from mastapy._internal import constructor
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _4372
from mastapy._internal.python_net import python_net_import

_AGMA_GLEASON_CONICAL_GEAR_SINGLE_MESH_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses.SingleMeshWhineAnalyses', 'AGMAGleasonConicalGearSingleMeshWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('AGMAGleasonConicalGearSingleMeshWhineAnalysis',)


class AGMAGleasonConicalGearSingleMeshWhineAnalysis(_4372.ConicalGearSingleMeshWhineAnalysis):
    '''AGMAGleasonConicalGearSingleMeshWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _AGMA_GLEASON_CONICAL_GEAR_SINGLE_MESH_WHINE_ANALYSIS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'AGMAGleasonConicalGearSingleMeshWhineAnalysis.TYPE'):
        super().__init__(instance_to_wrap)

    @property
    def component_design(self) -> '_1999.AGMAGleasonConicalGear':
        ...
        return constructor.new(_1999.AGMAGleasonConicalGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
