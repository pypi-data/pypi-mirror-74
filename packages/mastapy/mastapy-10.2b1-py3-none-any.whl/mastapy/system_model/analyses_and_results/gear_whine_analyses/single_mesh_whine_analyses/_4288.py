...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _4264
...
class ShaftSingleMeshWhineAnalysis(_4264.AbstractShaftOrHousingSingleMeshWhineAnalysis):
    '''ShaftSingleMeshWhineAnalysis
