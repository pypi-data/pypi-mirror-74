...
class BeltConnectionGearWhineAnalysis(_5331.InterMountableComponentConnectionGearWhineAnalysis):
    '''BeltConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2214.BeltConnectionSystemDeflection':
