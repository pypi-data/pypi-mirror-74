...
class PartToPartShearCouplingHalfGearWhineAnalysis(_5308.CouplingHalfGearWhineAnalysis):
    '''PartToPartShearCouplingHalfGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2312.PartToPartShearCouplingHalfSystemDeflection':
