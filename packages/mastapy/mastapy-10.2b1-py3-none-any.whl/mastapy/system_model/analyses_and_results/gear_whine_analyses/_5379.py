...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5341, _5275
...
class RootAssemblyGearWhineAnalysis(_5275.AssemblyGearWhineAnalysis):
    '''RootAssemblyGearWhineAnalysis
    ...
    @property
    def gear_whine_analysis_inputs(self) -> '_5341.GearWhineAnalysis':
        ...
        return constructor.new(_5341.GearWhineAnalysis)(self.wrapped.GearWhineAnalysisInputs) if self.wrapped.GearWhineAnalysisInputs else None
