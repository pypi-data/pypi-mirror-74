...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _5421
from mastapy.system_model.analyses_and_results.modal_analyses import _4792
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5385, _5334
...
class GearWhineAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5421.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5421.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection else None

    @property
    def modal_analysis_options(self) -> '_4792.ModalAnalysisOptions':
        ...
        return constructor.new(_4792.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
