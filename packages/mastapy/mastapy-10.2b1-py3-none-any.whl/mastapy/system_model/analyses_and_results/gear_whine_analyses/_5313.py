...
from mastapy.system_model.analyses_and_results.system_deflections import _2268, _2269, _2270
...
class CylindricalGearMeshGearWhineAnalysis(_5337.GearMeshGearWhineAnalysis):
    '''CylindricalGearMeshGearWhineAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_6298.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_6298.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionResults) if self.wrapped.AdvancedSystemDeflectionResults else None
    ...
    @property
    def system_deflection_results(self) -> '_2268.CylindricalGearMeshSystemDeflection':
