...
class AGMAGleasonConicalGearMeshGearWhineAnalysis(_5284.ConicalGearMeshGearWhineAnalysis):
    '''AGMAGleasonConicalGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2209.AGMAGleasonConicalGearMeshSystemDeflection':
