...
class SynchroniserSleeveGearWhineAnalysis(_5402.SynchroniserPartGearWhineAnalysis):
    '''SynchroniserSleeveGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2345.SynchroniserSleeveSystemDeflection':
