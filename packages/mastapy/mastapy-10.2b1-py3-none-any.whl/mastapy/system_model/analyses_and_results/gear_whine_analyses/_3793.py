...
class BearingGearWhineAnalysis(_3797.ConnectorGearWhineAnalysis):
    '''BearingGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2141.BearingSystemDeflection':
        ...
        return constructor.new(_2141.BearingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
