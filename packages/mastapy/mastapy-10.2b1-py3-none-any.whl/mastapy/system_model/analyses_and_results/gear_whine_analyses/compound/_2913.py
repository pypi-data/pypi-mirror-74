...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2906
...
class CVTCompoundGearWhineAnalysis(_2906.BeltDriveCompoundGearWhineAnalysis):
    '''CVTCompoundGearWhineAnalysis
