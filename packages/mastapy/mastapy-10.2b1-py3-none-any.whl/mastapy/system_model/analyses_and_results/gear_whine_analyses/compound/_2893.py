...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2881
...
class PlanetaryGearSetCompoundGearWhineAnalysis(_2881.CylindricalGearSetCompoundGearWhineAnalysis):
    '''PlanetaryGearSetCompoundGearWhineAnalysis
