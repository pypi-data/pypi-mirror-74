...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2902, _2955, _2884
...
class WormGearSetCompoundGearWhineAnalysis(_2884.GearSetCompoundGearWhineAnalysis):
    '''WormGearSetCompoundGearWhineAnalysis
    ...
    @property
    def worm_gears_compound_gear_whine_analysis(self) -> 'List[_2902.WormGearCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsCompoundGearWhineAnalysis, constructor.new(_2902.WormGearCompoundGearWhineAnalysis))
        return value

    @property
    def worm_meshes_compound_gear_whine_analysis(self) -> 'List[_2955.WormGearMeshCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesCompoundGearWhineAnalysis, constructor.new(_2955.WormGearMeshCompoundGearWhineAnalysis))
        return value
