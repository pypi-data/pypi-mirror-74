...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _3777
...
class StraightBevelDiffGearMeshCompoundGearWhineAnalysis(_2945.BevelGearMeshCompoundGearWhineAnalysis):
    '''StraightBevelDiffGearMeshCompoundGearWhineAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3777.StraightBevelDiffGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3777.StraightBevelDiffGearMeshGearWhineAnalysis))
        return value

    @property
    def connection_gear_whine_analysis_load_cases(self) -> 'List[_3777.StraightBevelDiffGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionGearWhineAnalysisLoadCases, constructor.new(_3777.StraightBevelDiffGearMeshGearWhineAnalysis))
        return value
