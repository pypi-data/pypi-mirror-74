...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2915
...
class CVTPulleyCompoundGearWhineAnalysis(_2915.PulleyCompoundGearWhineAnalysis):
    '''CVTPulleyCompoundGearWhineAnalysis
