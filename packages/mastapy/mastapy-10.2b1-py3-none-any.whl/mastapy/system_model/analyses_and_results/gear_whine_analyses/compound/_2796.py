...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2785
...
class RootAssemblyCompoundGearWhineAnalysis(_2785.AssemblyCompoundGearWhineAnalysis):
    '''RootAssemblyCompoundGearWhineAnalysis
