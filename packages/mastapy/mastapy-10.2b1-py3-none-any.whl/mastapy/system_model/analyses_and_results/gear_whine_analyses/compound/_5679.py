...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5667
...
class BevelGearMeshCompoundGearWhineAnalysis(_5667.AGMAGleasonConicalGearMeshCompoundGearWhineAnalysis):
    '''BevelGearMeshCompoundGearWhineAnalysis
