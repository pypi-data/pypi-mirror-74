...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2829, _2888, _2812
...
class SpiralBevelGearSetCompoundGearWhineAnalysis(_2812.BevelGearSetCompoundGearWhineAnalysis):
    '''SpiralBevelGearSetCompoundGearWhineAnalysis
    ...
    @property
    def spiral_bevel_gears_compound_gear_whine_analysis(self) -> 'List[_2829.SpiralBevelGearCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsCompoundGearWhineAnalysis, constructor.new(_2829.SpiralBevelGearCompoundGearWhineAnalysis))
        return value

    @property
    def spiral_bevel_meshes_compound_gear_whine_analysis(self) -> 'List[_2888.SpiralBevelGearMeshCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesCompoundGearWhineAnalysis, constructor.new(_2888.SpiralBevelGearMeshCompoundGearWhineAnalysis))
        return value
