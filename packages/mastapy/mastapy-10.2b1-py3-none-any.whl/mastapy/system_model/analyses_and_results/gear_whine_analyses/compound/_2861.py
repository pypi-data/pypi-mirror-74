...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2850
...
class RootAssemblyCompoundGearWhineAnalysis(_2850.AssemblyCompoundGearWhineAnalysis):
    '''RootAssemblyCompoundGearWhineAnalysis
