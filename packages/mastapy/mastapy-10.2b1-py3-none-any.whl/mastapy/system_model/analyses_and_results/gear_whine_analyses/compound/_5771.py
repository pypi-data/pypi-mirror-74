...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5690
...
class RootAssemblyCompoundGearWhineAnalysis(_5690.AssemblyCompoundGearWhineAnalysis):
    '''RootAssemblyCompoundGearWhineAnalysis
