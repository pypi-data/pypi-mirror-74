...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2819
...
class ConicalGearSetCompoundGearWhineAnalysis(_2819.GearSetCompoundGearWhineAnalysis):
    '''ConicalGearSetCompoundGearWhineAnalysis
