...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2807, _2876, _2812
...
class BevelDifferentialGearSetCompoundGearWhineAnalysis(_2812.BevelGearSetCompoundGearWhineAnalysis):
    '''BevelDifferentialGearSetCompoundGearWhineAnalysis
    ...
    @property
    def bevel_differential_gears_compound_gear_whine_analysis(self) -> 'List[_2807.BevelDifferentialGearCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsCompoundGearWhineAnalysis, constructor.new(_2807.BevelDifferentialGearCompoundGearWhineAnalysis))
        return value

    @property
    def bevel_differential_meshes_compound_gear_whine_analysis(self) -> 'List[_2876.BevelDifferentialGearMeshCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesCompoundGearWhineAnalysis, constructor.new(_2876.BevelDifferentialGearMeshCompoundGearWhineAnalysis))
        return value
