...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2884
...
class ConicalGearSetCompoundGearWhineAnalysis(_2884.GearSetCompoundGearWhineAnalysis):
    '''ConicalGearSetCompoundGearWhineAnalysis
