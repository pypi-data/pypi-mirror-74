...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2857
...
class AbstractAssemblyCompoundGearWhineAnalysis(_2857.PartCompoundGearWhineAnalysis):
    '''AbstractAssemblyCompoundGearWhineAnalysis
