...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2792
...
class AbstractAssemblyCompoundGearWhineAnalysis(_2792.PartCompoundGearWhineAnalysis):
    '''AbstractAssemblyCompoundGearWhineAnalysis
