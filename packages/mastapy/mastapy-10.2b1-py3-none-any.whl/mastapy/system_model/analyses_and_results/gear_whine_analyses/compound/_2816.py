...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2815, _2883, _2819
...
class CylindricalGearSetCompoundGearWhineAnalysis(_2819.GearSetCompoundGearWhineAnalysis):
    '''CylindricalGearSetCompoundGearWhineAnalysis
    ...
    @property
    def cylindrical_gears_compound_gear_whine_analysis(self) -> 'List[_2815.CylindricalGearCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsCompoundGearWhineAnalysis, constructor.new(_2815.CylindricalGearCompoundGearWhineAnalysis))
        return value

    @property
    def cylindrical_meshes_compound_gear_whine_analysis(self) -> 'List[_2883.CylindricalGearMeshCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesCompoundGearWhineAnalysis, constructor.new(_2883.CylindricalGearMeshCompoundGearWhineAnalysis))
        return value
