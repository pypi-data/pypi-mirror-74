...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _2801, _2877, _2819
...
class ConceptGearSetCompoundGearWhineAnalysis(_2819.GearSetCompoundGearWhineAnalysis):
    '''ConceptGearSetCompoundGearWhineAnalysis
    ...
    @property
    def concept_gears_compound_gear_whine_analysis(self) -> 'List[_2801.ConceptGearCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCompoundGearWhineAnalysis, constructor.new(_2801.ConceptGearCompoundGearWhineAnalysis))
        return value

    @property
    def concept_meshes_compound_gear_whine_analysis(self) -> 'List[_2877.ConceptGearMeshCompoundGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCompoundGearWhineAnalysis, constructor.new(_2877.ConceptGearMeshCompoundGearWhineAnalysis))
        return value
