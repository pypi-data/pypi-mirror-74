...
class StraightBevelPlanetGearGearWhineAnalysis(_5392.StraightBevelDiffGearGearWhineAnalysis):
    '''StraightBevelPlanetGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2341.StraightBevelPlanetGearSystemDeflection':
