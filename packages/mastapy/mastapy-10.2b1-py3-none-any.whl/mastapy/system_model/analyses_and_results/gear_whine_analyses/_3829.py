...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _3834
from mastapy._internal.python_net import python_net_import

_CONICAL_GEAR_GEAR_WHINE_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.GearWhineAnalyses', 'ConicalGearGearWhineAnalysis')


__docformat__ = 'restructuredtext en'
__all__ = ('ConicalGearGearWhineAnalysis',)


class ConicalGearGearWhineAnalysis(_3834.GearGearWhineAnalysis):
    '''ConicalGearGearWhineAnalysis

    This is a mastapy class.
    '''

    TYPE = _CONICAL_GEAR_GEAR_WHINE_ANALYSIS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'ConicalGearGearWhineAnalysis.TYPE'):
    ...
    @property
    def planetaries(self) -> 'List[ConicalGearGearWhineAnalysis]':
        '''List[ConicalGearGearWhineAnalysis]: 'Planetaries' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearGearWhineAnalysis))
        return value
