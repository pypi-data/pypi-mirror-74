...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _6209
...
class SingleNodePeriodicExcitationWithReferenceShaft(_6209.PeriodicExcitationWithReferenceShaft):
    '''SingleNodePeriodicExcitationWithReferenceShaft
