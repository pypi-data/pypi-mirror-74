...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _3790
...
class CylindricalGearMeshGearWhineAnalysis(_3790.GearMeshGearWhineAnalysis):
    '''CylindricalGearMeshGearWhineAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_3427.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_3427.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionResults) if self.wrapped.AdvancedSystemDeflectionResults else None
