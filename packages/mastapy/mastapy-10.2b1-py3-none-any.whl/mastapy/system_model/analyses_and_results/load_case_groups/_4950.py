...
from mastapy.system_model import _1715
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4916
from mastapy.system_model.analyses_and_results.static_loads import _2299, _6125, _4919
...
class AbstractLoadCaseGroup(_1.APIBase):
    ...
    def model(self) -> '_1715.Design':
        ...
        return constructor.new(_1715.Design)(self.wrapped.Model) if self.wrapped.Model else None
    ...
    def create_load_cases(self, number_of_load_cases: 'int', token: '_325.TaskProgress') -> 'List[_6125.LoadCase]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.CreateLoadCases(number_of_load_cases if number_of_load_cases else 0, token.wrapped if token else None), constructor.new(_6125.LoadCase))
