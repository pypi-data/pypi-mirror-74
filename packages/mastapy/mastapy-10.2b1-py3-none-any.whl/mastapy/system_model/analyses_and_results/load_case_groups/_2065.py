...
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _6173, _6172, _6166, _6171,
    _5014
)
from mastapy.system_model.analyses_and_results.static_loads import (
    _2057, _2265, _2297, _2295,
    _2326, _2244, _2328, _2281
)
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _6175, _6178, _6179
from mastapy.system_model.part_model import (
    _1908, _1934, _1933, _1924
)
from mastapy.system_model.part_model.gears import _1968, _1996
...
class AbstractStaticLoadCaseGroup(_5014.AbstractLoadCaseGroup):
    '''AbstractStaticLoadCaseGroup
    ...
    @property
    def optimum_tooth_numbers_target(self) -> '_6173.SystemOptimiserTargets':
        ...
        return constructor.new(_6173.SystemOptimiserTargets)(value) if value else None

    @optimum_tooth_numbers_target.setter
    def optimum_tooth_numbers_target(self, value: '_6173.SystemOptimiserTargets'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OptimumToothNumbersTarget = value

    @property
    def gear_set_optimisation(self) -> '_6172.SystemOptimiserGearSetOptimisation':
        ...
        return constructor.new(_6172.SystemOptimiserGearSetOptimisation)(value) if value else None

    @gear_set_optimisation.setter
    def gear_set_optimisation(self, value: '_6172.SystemOptimiserGearSetOptimisation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def static_loads_limited_by_max_number_of_load_cases_to_display(self) -> 'List[_2057.StaticLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StaticLoadsLimitedByMaxNumberOfLoadCasesToDisplay, constructor.new(_2057.StaticLoadCase))
        return value

    @property
    def bearings(self) -> 'List[_6175.ComponentStaticLoadCaseGroup[_1908.Bearing, _2265.BearingLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bearings, constructor.new(_6175.ComponentStaticLoadCaseGroup)[_1908.Bearing, _2265.BearingLoadCase])
        return value

    @property
    def power_loads(self) -> 'List[_6175.ComponentStaticLoadCaseGroup[_1934.PowerLoad, _2297.PowerLoadLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PowerLoads, constructor.new(_6175.ComponentStaticLoadCaseGroup)[_1934.PowerLoad, _2297.PowerLoadLoadCase])
        return value

    @property
    def point_loads(self) -> 'List[_6175.ComponentStaticLoadCaseGroup[_1933.PointLoad, _2295.PointLoadLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointLoads, constructor.new(_6175.ComponentStaticLoadCaseGroup)[_1933.PointLoad, _2295.PointLoadLoadCase])
        return value

    @property
    def cylindrical_gear_sets(self) -> 'List[_6178.GearSetStaticLoadCaseGroup[_1968.CylindricalGearSet, _1996.CylindricalGear, _2326.CylindricalGearLoadCase, _1798.CylindricalGearMesh, _2244.CylindricalGearMeshLoadCase, _2328.CylindricalGearSetLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearSets, constructor.new(_6178.GearSetStaticLoadCaseGroup)[_1968.CylindricalGearSet, _1996.CylindricalGear, _2326.CylindricalGearLoadCase, _1798.CylindricalGearMesh, _2244.CylindricalGearMeshLoadCase, _2328.CylindricalGearSetLoadCase])
        return value

    @property
    def parts_with_excitations(self) -> 'List[_6179.PartStaticLoadCaseGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PartsWithExcitations, constructor.new(_6179.PartStaticLoadCaseGroup))
        return value

    @property
    def fe_components(self) -> 'List[_6175.ComponentStaticLoadCaseGroup[_1924.ImportedFEComponent, _2281.ImportedFEComponentLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEComponents, constructor.new(_6175.ComponentStaticLoadCaseGroup)[_1924.ImportedFEComponent, _2281.ImportedFEComponentLoadCase])
        return value

    @property
    def design_states(self) -> 'List[_6166.AbstractDesignStateLoadCaseGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_6166.AbstractDesignStateLoadCaseGroup))
        return value
    ...
    @property
    def system_optimisation_gear_sets(self) -> 'List[_6171.SystemOptimisationGearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SystemOptimisationGearSets, constructor.new(_6171.SystemOptimisationGearSet))
        return value
