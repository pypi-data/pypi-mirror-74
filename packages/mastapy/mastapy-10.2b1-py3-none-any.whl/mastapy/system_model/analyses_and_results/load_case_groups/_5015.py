...
from mastapy.system_model.analyses_and_results.load_case_groups import _5014
...
class GroupOfTimeSeriesLoadCases(_5014.AbstractLoadCaseGroup):
    '''GroupOfTimeSeriesLoadCases
    ...
    @property
    def load_cases(self) -> 'List[_5147.TimeSeriesLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCases, constructor.new(_5147.TimeSeriesLoadCase))
        return value
