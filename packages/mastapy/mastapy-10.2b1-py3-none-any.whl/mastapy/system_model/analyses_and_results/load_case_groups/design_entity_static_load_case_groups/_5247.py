...
TConnection = TypeVar('TConnection', bound='_1836.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6082.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5248.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
