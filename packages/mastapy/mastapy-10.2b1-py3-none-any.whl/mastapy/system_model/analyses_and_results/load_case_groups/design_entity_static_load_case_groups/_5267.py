...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5264, _5265, _5268
from mastapy.system_model.part_model.gears import _2088, _2086
from mastapy.system_model.analyses_and_results.static_loads import _6138, _6140, _6143
...
TGearSet = TypeVar('TGearSet', bound='_2088.GearSet')
TGear = TypeVar('TGear', bound='_2086.Gear')
TGearStaticLoad = TypeVar('TGearStaticLoad', bound='_6138.GearLoadCase')
TGearMesh = TypeVar('TGearMesh', bound='_1889.GearMesh')
TGearMeshStaticLoad = TypeVar('TGearMeshStaticLoad', bound='_6140.GearMeshLoadCase')
TGearSetStaticLoad = TypeVar('TGearSetStaticLoad', bound='_6143.GearSetLoadCase')


class GearSetStaticLoadCaseGroup(_5268.PartStaticLoadCaseGroup, Generic[TGearSet, TGear, TGearStaticLoad, TGearMesh, TGearMeshStaticLoad, TGearSetStaticLoad]):
    '''GearSetStaticLoadCaseGroup
    ...
    @property
    def gears_load_cases(self) -> 'List[_5264.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsLoadCases, constructor.new(_5264.ComponentStaticLoadCaseGroup)[TGear, TGearStaticLoad])
        return value

    @property
    def meshes_load_cases(self) -> 'List[_5265.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesLoadCases, constructor.new(_5265.ConnectionStaticLoadCaseGroup)[TGearMesh, TGearMeshStaticLoad])
        return value
