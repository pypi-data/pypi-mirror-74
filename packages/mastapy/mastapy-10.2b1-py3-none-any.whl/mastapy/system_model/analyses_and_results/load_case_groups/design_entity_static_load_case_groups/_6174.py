...
from mastapy.system_model.analyses_and_results.static_loads import _2263
...
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_2263.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_6177.DesignEntityStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
