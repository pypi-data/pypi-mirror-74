...
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_2272.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_6184.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
