...
TReal = TypeVar('TReal', bound='_1998.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6083.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5259.DesignEntityStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
