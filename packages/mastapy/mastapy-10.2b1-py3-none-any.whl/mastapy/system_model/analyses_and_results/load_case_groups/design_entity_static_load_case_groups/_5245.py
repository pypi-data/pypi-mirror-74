...
TAssembly = TypeVar('TAssembly', bound='_1981.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6045.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5248.DesignEntityStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
