...
TAssembly = TypeVar('TAssembly', bound='_1990.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6058.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5259.DesignEntityStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
