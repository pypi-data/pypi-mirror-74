...
from mastapy.system_model.connections_and_sockets import _1845
...
TConnection = TypeVar('TConnection', bound='_1845.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6095.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5259.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
