...
from mastapy.system_model.analyses_and_results.static_loads import _2216
...
TConnection = TypeVar('TConnection', bound='_1764.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_2216.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_6177.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
