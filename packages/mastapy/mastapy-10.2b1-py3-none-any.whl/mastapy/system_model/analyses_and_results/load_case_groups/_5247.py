...
from mastapy.system_model.analyses_and_results.load_case_groups import _5245, _5246, _5242
...
class DesignState(_5242.AbstractDesignStateLoadCaseGroup):
    '''DesignState
    ...
    @property
    def clutches(self) -> 'List[_5245.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Clutches, constructor.new(_5245.ClutchEngagementStatus))
        return value

    @property
    def concept_synchro_mounted_gears(self) -> 'List[_5246.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptSynchroMountedGears, constructor.new(_5246.ConceptSynchroGearEngagementStatus))
        return value

    def clutch_engagement_status_for(self, clutch_connection: '_1903.ClutchConnection') -> '_5245.ClutchEngagementStatus':
        ...
        return constructor.new(_5245.ClutchEngagementStatus)(method_result) if method_result else None

    def concept_synchro_gear_engagement_status_for(self, gear: '_2073.CylindricalGear') -> '_5246.ConceptSynchroGearEngagementStatus':
        ...
        return constructor.new(_5246.ConceptSynchroGearEngagementStatus)(method_result) if method_result else None
    ...
    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_6196.StaticLoadCase':
        ...
        return constructor.new(_6196.StaticLoadCase)(method_result) if method_result else None
