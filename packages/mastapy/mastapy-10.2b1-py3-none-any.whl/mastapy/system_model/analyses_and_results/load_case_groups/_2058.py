...
from mastapy.system_model.analyses_and_results.load_case_groups import _4922, _2065
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6202
...
class DutyCycle(_2065.AbstractStaticLoadCaseGroup):
    '''DutyCycle
    ...
    @property
    def duty_cycle_design_states(self) -> 'List[_4922.SubGroupInSingleDesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycleDesignStates, constructor.new(_4922.SubGroupInSingleDesignState))
        return value

    @property
    def time_series_importer(self) -> '_6202.TimeSeriesImporter':
        ...
        return constructor.new(_6202.TimeSeriesImporter)(self.wrapped.TimeSeriesImporter) if self.wrapped.TimeSeriesImporter else None

    def add_static_load(self, static_load: '_2057.StaticLoadCase'):
    ...
    def remove_static_load(self, static_load: '_2057.StaticLoadCase'):
    ...
    def remove_design_state_sub_group(self, sub_group: '_4922.SubGroupInSingleDesignState'):
