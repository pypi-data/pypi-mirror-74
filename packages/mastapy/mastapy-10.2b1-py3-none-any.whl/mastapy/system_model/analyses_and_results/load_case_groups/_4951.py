...
from mastapy.system_model.analyses_and_results.static_loads import _5144
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.load_case_groups import _4950
...
class GroupOfTimeSeriesLoadCases(_4950.AbstractLoadCaseGroup):
    '''GroupOfTimeSeriesLoadCases
    ...
    @property
    def load_cases(self) -> 'List[_5144.TimeSeriesLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCases, constructor.new(_5144.TimeSeriesLoadCase))
        return value
