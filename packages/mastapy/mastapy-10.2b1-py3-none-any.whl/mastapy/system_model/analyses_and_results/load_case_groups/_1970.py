...
from mastapy.system_model.analyses_and_results.load_case_groups import _4922, _2066
...
class DutyCycle(_2066.AbstractStaticLoadCaseGroup):
    '''DutyCycle
    ...
    def add_static_load(self, static_load: '_1969.StaticLoadCase'):
    ...
    def remove_static_load(self, static_load: '_1969.StaticLoadCase'):
