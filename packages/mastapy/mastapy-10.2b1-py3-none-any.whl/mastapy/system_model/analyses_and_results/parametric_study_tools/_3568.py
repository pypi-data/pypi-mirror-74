...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3560, _3557
...
class ParametricStudyVariable(_2195.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_3560.ParametricStudyDimension':
        ...
        return constructor.new(_3560.ParametricStudyDimension)(value) if value else None

    @dimension.setter
    def dimension(self, value: '_3560.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_3557.MonteCarloDistribution':
        ...
        return constructor.new(_3557.MonteCarloDistribution)(value) if value else None

    @distribution.setter
    def distribution(self, value: '_3557.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
