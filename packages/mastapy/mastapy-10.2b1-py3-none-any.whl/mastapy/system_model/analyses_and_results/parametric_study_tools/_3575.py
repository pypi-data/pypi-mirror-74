...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3558
...
class PlanetCarrierParametricStudyTool(_3558.MountableComponentParametricStudyTool):
    '''PlanetCarrierParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2315.PlanetCarrierSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2315.PlanetCarrierSystemDeflection))
        return value
