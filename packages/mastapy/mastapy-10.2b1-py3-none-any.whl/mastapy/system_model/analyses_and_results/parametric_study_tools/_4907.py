...
class DutyCycleResultsForAllGearSets(_1.APIBase):
    ...
    @property
    def duty_cycle_results(self) -> '_1123.GearSetGroupDutyCycle':
        ...
        return constructor.new(_1123.GearSetGroupDutyCycle)(self.wrapped.DutyCycleResults) if self.wrapped.DutyCycleResults else None
