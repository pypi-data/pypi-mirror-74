...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3539
...
class ConicalGearSetParametricStudyTool(_3539.GearSetParametricStudyTool):
    '''ConicalGearSetParametricStudyTool
