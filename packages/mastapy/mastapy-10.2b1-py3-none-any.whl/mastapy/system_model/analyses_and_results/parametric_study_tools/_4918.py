...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4911, _4910
from mastapy._internal.implicit import list_with_selected_item
from mastapy.system_model.analyses_and_results import _2106
...
class ParametricStudyVariable(_2106.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_4911.ParametricStudyDimension':
        ...
        return constructor.new(_4911.ParametricStudyDimension)(value) if value else None

    @dimension.setter
    def dimension(self, value: '_4911.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_4910.MonteCarloDistribution':
        ...
        return constructor.new(_4910.MonteCarloDistribution)(value) if value else None

    @distribution.setter
    def distribution(self, value: '_4910.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
