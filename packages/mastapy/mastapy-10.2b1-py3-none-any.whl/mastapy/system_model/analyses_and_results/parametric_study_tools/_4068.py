...
class ConicalGearParametricStudyTool(_4073.GearParametricStudyTool):
    '''ConicalGearParametricStudyTool
    ...
    def planetaries(self) -> 'List[ConicalGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearParametricStudyTool))
        return value
