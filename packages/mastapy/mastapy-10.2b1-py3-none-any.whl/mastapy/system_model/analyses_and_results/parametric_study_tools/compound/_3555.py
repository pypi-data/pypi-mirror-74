...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3572
...
class AbstractAssemblyCompoundParametricStudyTool(_3572.PartCompoundParametricStudyTool):
    '''AbstractAssemblyCompoundParametricStudyTool
