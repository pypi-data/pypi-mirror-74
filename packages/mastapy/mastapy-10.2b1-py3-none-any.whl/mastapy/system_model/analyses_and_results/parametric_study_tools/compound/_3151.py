...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3144
...
class CVTCompoundParametricStudyTool(_3144.BeltDriveCompoundParametricStudyTool):
    '''CVTCompoundParametricStudyTool
