...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3512
...
class CVTPulleyCompoundParametricStudyTool(_3512.PulleyCompoundParametricStudyTool):
    '''CVTPulleyCompoundParametricStudyTool
