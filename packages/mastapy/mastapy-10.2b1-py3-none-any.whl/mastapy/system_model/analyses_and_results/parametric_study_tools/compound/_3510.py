...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3503
...
class CVTCompoundParametricStudyTool(_3503.BeltDriveCompoundParametricStudyTool):
    '''CVTCompoundParametricStudyTool
