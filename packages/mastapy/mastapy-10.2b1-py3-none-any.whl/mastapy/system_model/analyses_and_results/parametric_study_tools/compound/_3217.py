...
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _4950, _4951, _2058, _2056,
    _4922
)
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3206
...
class RootAssemblyCompoundParametricStudyTool(_3206.AssemblyCompoundParametricStudyTool):
    '''RootAssemblyCompoundParametricStudyTool
    ...
    @property
    def compound_load_case(self) -> '_4950.AbstractLoadCaseGroup':
        ...
        return constructor.new(_4950.AbstractLoadCaseGroup)(self.wrapped.CompoundLoadCase) if self.wrapped.CompoundLoadCase else None

    @property
    def compound_load_case_of_type_group_of_time_series_load_cases(self) -> '_4951.GroupOfTimeSeriesLoadCases':
        ...
        return constructor.new(_4951.GroupOfTimeSeriesLoadCases)(self.wrapped.CompoundLoadCase) if self.wrapped.CompoundLoadCase else None
