...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3153
...
class CVTPulleyCompoundParametricStudyTool(_3153.PulleyCompoundParametricStudyTool):
    '''CVTPulleyCompoundParametricStudyTool
