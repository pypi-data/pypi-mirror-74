...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3213
...
class AbstractAssemblyCompoundParametricStudyTool(_3213.PartCompoundParametricStudyTool):
    '''AbstractAssemblyCompoundParametricStudyTool
