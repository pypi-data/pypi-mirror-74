...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3625
...
class CVTCompoundParametricStudyTool(_3625.BeltDriveCompoundParametricStudyTool):
    '''CVTCompoundParametricStudyTool
