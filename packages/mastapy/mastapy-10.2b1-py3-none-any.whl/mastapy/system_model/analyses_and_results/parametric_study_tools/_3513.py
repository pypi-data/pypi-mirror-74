...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3565
...
class ConnectionParametricStudyTool(_6505.ConnectionAnalysisCase):
    '''ConnectionParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_3565.ParametricStudyTool':
        ...
        return constructor.new(_3565.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None
