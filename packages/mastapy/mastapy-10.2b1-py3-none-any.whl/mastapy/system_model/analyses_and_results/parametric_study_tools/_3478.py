...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3466
...
class BevelGearSetParametricStudyTool(_3466.AGMAGleasonConicalGearSetParametricStudyTool):
    '''BevelGearSetParametricStudyTool
