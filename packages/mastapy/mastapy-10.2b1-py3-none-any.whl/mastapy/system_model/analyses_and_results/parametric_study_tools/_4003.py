...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4915
from mastapy.system_model.analyses_and_results.analysis_cases import _4923
...
class ConnectionParametricStudyTool(_4923.ConnectionAnalysisCase):
    '''ConnectionParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_4915.ParametricStudyTool':
        ...
        return constructor.new(_4915.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None
