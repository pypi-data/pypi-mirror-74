...
class ParametricStudyDOEResultVariable(_1112.ParetoOptimisationVariableBase):
    '''ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1114.PropertyTargetForDominantCandidateSearch':
    ...
    @target.setter
    def target(self, value: '_1114.PropertyTargetForDominantCandidateSearch'):
