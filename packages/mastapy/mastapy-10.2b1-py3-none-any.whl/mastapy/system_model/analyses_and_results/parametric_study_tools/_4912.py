...
class ParametricStudyDOEResultVariable(_1241.ParetoOptimisationVariableBase):
    '''ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1243.PropertyTargetForDominantCandidateSearch':
    ...
    @target.setter
    def target(self, value: '_1243.PropertyTargetForDominantCandidateSearch'):
