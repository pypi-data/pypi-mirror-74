...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3481
...
class ShaftParametricStudyTool(_3481.AbstractShaftOrHousingParametricStudyTool):
    '''ShaftParametricStudyTool
