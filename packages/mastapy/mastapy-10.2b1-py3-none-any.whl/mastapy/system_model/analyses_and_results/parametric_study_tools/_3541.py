...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3482
...
class HypoidGearMeshParametricStudyTool(_3482.AGMAGleasonConicalGearMeshParametricStudyTool):
    '''HypoidGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2289.HypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2289.HypoidGearMeshSystemDeflection))
        return value
