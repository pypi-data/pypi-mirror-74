...
class TimeSeriesLoadAnalysisCase(_6480.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6197.TimeSeriesLoadCase':
        ...
        return constructor.new(_6197.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
