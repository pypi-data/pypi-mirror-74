...
from mastapy.system_model.analyses_and_results.analysis_cases import _5145
...
class TimeSeriesLoadAnalysisCase(_5145.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_5144.TimeSeriesLoadCase':
        ...
        return constructor.new(_5144.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
