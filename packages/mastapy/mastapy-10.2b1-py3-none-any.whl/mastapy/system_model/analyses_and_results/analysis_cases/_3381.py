...
from mastapy.system_model.analyses_and_results import _2111, _2109
...
class DesignEntityCompoundAnalysis(_2109.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2111.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2111.DesignEntitySingleContextAnalysis))
        return value
