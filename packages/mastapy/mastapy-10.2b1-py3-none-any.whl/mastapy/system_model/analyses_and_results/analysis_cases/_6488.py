...
from mastapy.system_model.analyses_and_results import _2183, _2181
...
class DesignEntityCompoundAnalysis(_2181.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2183.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2183.DesignEntitySingleContextAnalysis))
        return value
