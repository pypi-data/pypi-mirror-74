...
class TimeSeriesLoadAnalysisCase(_5154.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_5147.TimeSeriesLoadCase':
        ...
        return constructor.new(_5147.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
