...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6238
...
class BevelGearSetAdvancedSystemDeflection(_6238.AGMAGleasonConicalGearSetAdvancedSystemDeflection):
    '''BevelGearSetAdvancedSystemDeflection
