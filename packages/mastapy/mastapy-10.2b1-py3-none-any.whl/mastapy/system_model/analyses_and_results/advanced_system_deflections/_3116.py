...
_CONICAL_GEAR_ADVANCED_SYSTEM_DEFLECTION = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.AdvancedSystemDeflections', 'ConicalGearAdvancedSystemDeflection')
...
class ConicalGearAdvancedSystemDeflection(_3121.GearAdvancedSystemDeflection):
    '''ConicalGearAdvancedSystemDeflection
    ...
    def __init__(self, instance_to_wrap: 'ConicalGearAdvancedSystemDeflection.TYPE'):
        super().__init__(instance_to_wrap)

    @property
    def component_design(self) -> '_1982.ConicalGear':
        ...
        return constructor.new(_1982.ConicalGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def planetaries(self) -> 'List[ConicalGearAdvancedSystemDeflection]':
        '''List[ConicalGearAdvancedSystemDeflection]: 'Planetaries' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearAdvancedSystemDeflection))
        return value
