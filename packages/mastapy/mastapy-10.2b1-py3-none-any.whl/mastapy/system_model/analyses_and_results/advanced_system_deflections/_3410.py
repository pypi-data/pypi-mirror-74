...
class ConnectionAdvancedSystemDeflection(_3375.ConnectionStaticLoadAnalysisCase):
    '''ConnectionAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection(self) -> '_6306.AdvancedSystemDeflection':
        ...
        return constructor.new(_6306.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflection) if self.wrapped.AdvancedSystemDeflection else None
