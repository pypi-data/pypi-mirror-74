...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6297, _6298, _6310
...
class CylindricalGearSetAdvancedSystemDeflection(_6310.GearSetAdvancedSystemDeflection):
    '''CylindricalGearSetAdvancedSystemDeflection
    ...
    @property
    def cylindrical_gears_advanced_system_deflection(self) -> 'List[_6297.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsAdvancedSystemDeflection, constructor.new(_6297.CylindricalGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshes_advanced_system_deflection(self) -> 'List[_6298.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesAdvancedSystemDeflection, constructor.new(_6298.CylindricalGearMeshAdvancedSystemDeflection))
        return value
