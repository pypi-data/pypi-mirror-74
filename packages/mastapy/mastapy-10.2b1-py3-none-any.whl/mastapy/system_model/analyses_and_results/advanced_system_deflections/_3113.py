...
class BevelDifferentialSunGearAdvancedSystemDeflection(_3110.BevelDifferentialGearAdvancedSystemDeflection):
    '''BevelDifferentialSunGearAdvancedSystemDeflection
    ...
    @property
    def component_design(self) -> '_1977.BevelDifferentialSunGear':
