...
class MeasurementComponentAdvancedSystemDeflection(_3102.VirtualComponentAdvancedSystemDeflection):
    '''MeasurementComponentAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2321.MeasurementComponentLoadCase':
        ...
        return constructor.new(_2321.MeasurementComponentLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2216.MeasurementComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2216.MeasurementComponentSystemDeflection))
        return value
