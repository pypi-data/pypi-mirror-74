...
class KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection(_3125.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2361.KlingelnbergCycloPalloidSpiralBevelGearLoadCase':
        ...
        return constructor.new(_2361.KlingelnbergCycloPalloidSpiralBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2213.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2213.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection))
        return value
