...
from mastapy.system_model.analyses_and_results.system_deflections import _2100
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3079
...
class ShaftAdvancedSystemDeflection(_3079.AbstractShaftOrHousingAdvancedSystemDeflection):
    '''ShaftAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2100.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2100.ShaftSystemDeflection))
        return value
