...
from mastapy.gears.ltca import _623
...
class AdvancedSystemDeflectionOptions(_0.APIBase):
    ...
    @property
    def use_advanced_ltca(self) -> '_623.UseAdvancedLTCAOptions':
        ...
        return constructor.new(_623.UseAdvancedLTCAOptions)(value) if value else None

    @use_advanced_ltca.setter
    def use_advanced_ltca(self, value: '_623.UseAdvancedLTCAOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.UseAdvancedLTCA = value

    @property
    def use_variable_bearing_stiffness(self) -> '_6351.UseVariableBearingStiffnessOptions':
        '''UseVariableBearingStiffnessOptions: 'UseVariableBearingStiffness' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.UseVariableBearingStiffness)
        return constructor.new(_6351.UseVariableBearingStiffnessOptions)(value) if value else None

    @use_variable_bearing_stiffness.setter
    def use_variable_bearing_stiffness(self, value: '_6351.UseVariableBearingStiffnessOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.UseVariableBearingStiffness = value
