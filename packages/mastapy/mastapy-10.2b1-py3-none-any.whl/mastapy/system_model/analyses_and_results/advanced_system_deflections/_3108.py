...
class AGMAGleasonConicalGearAdvancedSystemDeflection(_3116.ConicalGearAdvancedSystemDeflection):
    '''AGMAGleasonConicalGearAdvancedSystemDeflection
    ...
    @property
    def component_design(self) -> '_1972.AGMAGleasonConicalGear':
        ...
        return constructor.new(_1972.AGMAGleasonConicalGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
