...
from mastapy.system_model.analyses_and_results.static_loads import _2314
...
class DatumAdvancedSystemDeflection(_3083.ComponentAdvancedSystemDeflection):
    '''DatumAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2314.DatumLoadCase':
        ...
        return constructor.new(_2314.DatumLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2189.DatumSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2189.DatumSystemDeflection))
        return value
