...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6349, _6350, _6271
...
class SpiralBevelGearSetAdvancedSystemDeflection(_6271.BevelGearSetAdvancedSystemDeflection):
    '''SpiralBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def rating(self) -> '_206.SpiralBevelGearSetRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_206.SpiralBevelGearSetRating':
    ...
    @property
    def spiral_bevel_gears_advanced_system_deflection(self) -> 'List[_6349.SpiralBevelGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsAdvancedSystemDeflection, constructor.new(_6349.SpiralBevelGearAdvancedSystemDeflection))
        return value

    @property
    def spiral_bevel_meshes_advanced_system_deflection(self) -> 'List[_6350.SpiralBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesAdvancedSystemDeflection, constructor.new(_6350.SpiralBevelGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2330.SpiralBevelGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2330.SpiralBevelGearSetSystemDeflection))
        return value
