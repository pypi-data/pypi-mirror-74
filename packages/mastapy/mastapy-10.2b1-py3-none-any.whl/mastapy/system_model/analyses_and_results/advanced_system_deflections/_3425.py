...
from mastapy.gears.gear_designs.conical import _986
...
class ConicalGearMeshAdvancedSystemDeflection(_3436.GearMeshAdvancedSystemDeflection):
    '''ConicalGearMeshAdvancedSystemDeflection
    ...
    @property
    def inactive_flank(self) -> '_986.ActiveConicalFlank':
