...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3109
...
class BevelGearSetAdvancedSystemDeflection(_3109.AGMAGleasonConicalGearSetAdvancedSystemDeflection):
    '''BevelGearSetAdvancedSystemDeflection
