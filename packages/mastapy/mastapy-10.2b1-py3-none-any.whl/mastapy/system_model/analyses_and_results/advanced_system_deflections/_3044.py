...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3043
...
class SynchroniserSleeveAdvancedSystemDeflection(_3043.SynchroniserPartAdvancedSystemDeflection):
    '''SynchroniserSleeveAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2262.SynchroniserSleeveLoadCase':
        ...
        return constructor.new(_2262.SynchroniserSleeveLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2261.SynchroniserSleeveSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2261.SynchroniserSleeveSystemDeflection))
        return value
