...
class FaceGearMeshAdvancedSystemDeflection(_3077.GearMeshAdvancedSystemDeflection):
    '''FaceGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_2287.FaceGearMeshLoadCase':
        ...
        return constructor.new(_2287.FaceGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2192.FaceGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2192.FaceGearMeshSystemDeflection))
        return value
