...
class ConicalGearSetCompoundAdvancedSystemDeflection(_6434.GearSetCompoundAdvancedSystemDeflection):
    '''ConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_327.ConicalGearSetDutyCycleRating':
    ...
    @property
    def conical_gear_duty_cycle_rating(self) -> '_327.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_327.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearDutyCycleRating) if self.wrapped.ConicalGearDutyCycleRating else None
