...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _2605
...
class CVTCompoundAdvancedSystemDeflection(_2605.BeltDriveCompoundAdvancedSystemDeflection):
    '''CVTCompoundAdvancedSystemDeflection
