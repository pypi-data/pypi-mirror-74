...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _2583
...
class ConicalGearSetCompoundAdvancedSystemDeflection(_2583.GearSetCompoundAdvancedSystemDeflection):
    '''ConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_369.ConicalGearSetDutyCycleRating':
    ...
    @property
    def conical_gear_duty_cycle_rating(self) -> '_369.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_369.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearDutyCycleRating) if self.wrapped.ConicalGearDutyCycleRating else None
