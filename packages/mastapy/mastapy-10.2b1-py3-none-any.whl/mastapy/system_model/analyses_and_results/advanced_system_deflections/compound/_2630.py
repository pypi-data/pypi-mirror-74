...
from mastapy.system_model.analyses_and_results.analysis_cases import _3613
...
class ConnectionCompoundAdvancedSystemDeflection(_3613.ConnectionCompoundAnalysis):
    '''ConnectionCompoundAdvancedSystemDeflection
