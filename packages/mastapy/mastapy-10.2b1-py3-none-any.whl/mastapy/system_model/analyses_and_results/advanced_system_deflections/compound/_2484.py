...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _2477
...
class CVTCompoundAdvancedSystemDeflection(_2477.BeltDriveCompoundAdvancedSystemDeflection):
    '''CVTCompoundAdvancedSystemDeflection
