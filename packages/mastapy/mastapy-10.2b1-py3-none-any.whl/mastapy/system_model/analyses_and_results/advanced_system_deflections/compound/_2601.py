...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3140
...
class WormGearCompoundAdvancedSystemDeflection(_2582.GearCompoundAdvancedSystemDeflection):
    '''WormGearCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_387.WormGearDutyCycleRating':
    ...
    @property
    def worm_gear_duty_cycle_rating(self) -> '_387.WormGearDutyCycleRating':
        ...
        return constructor.new(_387.WormGearDutyCycleRating)(self.wrapped.WormGearDutyCycleRating) if self.wrapped.WormGearDutyCycleRating else None
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3140.WormGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3140.WormGearAdvancedSystemDeflection))
        return value

    @property
    def component_advanced_system_deflection_load_cases(self) -> 'List[_3140.WormGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAdvancedSystemDeflectionLoadCases, constructor.new(_3140.WormGearAdvancedSystemDeflection))
        return value
