...
class ConicalGearCompoundAdvancedSystemDeflection(_2582.GearCompoundAdvancedSystemDeflection):
    '''ConicalGearCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_541.ConicalGearDutyCycleRating':
    ...
    @property
    def conical_gear_duty_cycle_rating(self) -> '_541.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_541.ConicalGearDutyCycleRating)(self.wrapped.ConicalGearDutyCycleRating) if self.wrapped.ConicalGearDutyCycleRating else None
