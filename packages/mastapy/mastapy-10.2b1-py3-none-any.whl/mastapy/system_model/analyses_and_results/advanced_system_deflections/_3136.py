...
class StraightBevelGearAdvancedSystemDeflection(_3114.BevelGearAdvancedSystemDeflection):
    '''StraightBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2372.StraightBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2372.StraightBevelGearSystemDeflection))
        return value
