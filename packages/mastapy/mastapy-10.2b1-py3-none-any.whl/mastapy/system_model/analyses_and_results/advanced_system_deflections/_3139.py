...
class StraightBevelSunGearAdvancedSystemDeflection(_3134.StraightBevelDiffGearAdvancedSystemDeflection):
    '''StraightBevelSunGearAdvancedSystemDeflection
    ...
    @property
    def component_design(self) -> '_2009.StraightBevelSunGear':
