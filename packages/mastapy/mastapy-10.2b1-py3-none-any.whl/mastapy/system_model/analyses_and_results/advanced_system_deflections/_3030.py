...
class ConceptCouplingHalfAdvancedSystemDeflection(_3032.CouplingHalfAdvancedSystemDeflection):
    '''ConceptCouplingHalfAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2241.ConceptCouplingHalfLoadCase':
        ...
        return constructor.new(_2241.ConceptCouplingHalfLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2162.ConceptCouplingHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2162.ConceptCouplingHalfSystemDeflection))
        return value
