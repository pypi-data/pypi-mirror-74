...
class WormGearMeshAdvancedSystemDeflection(_3436.GearMeshAdvancedSystemDeflection):
    '''WormGearMeshAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_352.WormGearMeshRating':
        ...
        return constructor.new(_352.WormGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2257.WormGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2257.WormGearMeshSystemDeflection))
        return value
