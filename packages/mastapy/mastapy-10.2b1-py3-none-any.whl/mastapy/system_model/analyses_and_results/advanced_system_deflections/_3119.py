...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3118, _3068, _3122
...
class CylindricalGearSetAdvancedSystemDeflection(_3122.GearSetAdvancedSystemDeflection):
    '''CylindricalGearSetAdvancedSystemDeflection
    ...
    @property
    def gear_set_design(self) -> '_356.CylindricalGearSetDesign':
        ...
        return constructor.new(_356.CylindricalGearSetDesign)(self.wrapped.GearSetDesign) if self.wrapped.GearSetDesign else None
    ...
    @property
    def rating(self) -> '_373.CylindricalGearSetRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_373.CylindricalGearSetRating':
        ...
        return constructor.new(_373.CylindricalGearSetRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def cylindrical_gears_advanced_system_deflection(self) -> 'List[_3118.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsAdvancedSystemDeflection, constructor.new(_3118.CylindricalGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshes_advanced_system_deflection(self) -> 'List[_3068.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesAdvancedSystemDeflection, constructor.new(_3068.CylindricalGearMeshAdvancedSystemDeflection))
        return value
