...
class KlingelnbergCycloPalloidSpiralBevelGearMeshAdvancedSystemDeflection(_3429.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_417.KlingelnbergCycloPalloidSpiralBevelGearMeshRating':
        ...
        return constructor.new(_417.KlingelnbergCycloPalloidSpiralBevelGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2251.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2251.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection))
        return value
