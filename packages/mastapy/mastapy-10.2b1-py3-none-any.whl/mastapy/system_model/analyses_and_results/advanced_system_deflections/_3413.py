...
from mastapy.system_model.analyses_and_results.static_loads import _2222
from mastapy.system_model.analyses_and_results.system_deflections import _2221
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3411
...
class RollingRingConnectionAdvancedSystemDeflection(_3411.InterMountableComponentConnectionAdvancedSystemDeflection):
    '''RollingRingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_2222.RollingRingConnectionLoadCase':
        ...
        return constructor.new(_2222.RollingRingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2221.RollingRingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2221.RollingRingConnectionSystemDeflection))
        return value
