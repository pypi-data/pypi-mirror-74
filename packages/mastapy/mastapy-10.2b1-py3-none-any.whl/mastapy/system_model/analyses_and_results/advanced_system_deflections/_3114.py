...
from mastapy.system_model.part_model.gears import (
    _1978, _1974, _2002, _2004,
    _2006, _2012, _1976, _1977,
    _2008, _2009
)
from mastapy._internal import constructor
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3108
from mastapy._internal.python_net import python_net_import

_BEVEL_GEAR_ADVANCED_SYSTEM_DEFLECTION = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.AdvancedSystemDeflections', 'BevelGearAdvancedSystemDeflection')
...
class BevelGearAdvancedSystemDeflection(_3108.AGMAGleasonConicalGearAdvancedSystemDeflection):
    '''BevelGearAdvancedSystemDeflection
    ...
    def __init__(self, instance_to_wrap: 'BevelGearAdvancedSystemDeflection.TYPE'):
        super().__init__(instance_to_wrap)

    @property
    def component_design(self) -> '_1978.BevelGear':
        ...
        return constructor.new(_1978.BevelGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
