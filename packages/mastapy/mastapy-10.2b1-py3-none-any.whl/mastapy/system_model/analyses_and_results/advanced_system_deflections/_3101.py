...
from mastapy.system_model.analyses_and_results.static_loads import _2332
from mastapy.system_model.analyses_and_results.system_deflections import _2331
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _3102
...
class UnbalancedMassAdvancedSystemDeflection(_3102.VirtualComponentAdvancedSystemDeflection):
    '''UnbalancedMassAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_2332.UnbalancedMassLoadCase':
        ...
        return constructor.new(_2332.UnbalancedMassLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2331.UnbalancedMassSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2331.UnbalancedMassSystemDeflection))
        return value
