...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6234
...
class AdvancedSystemDeflection(_6495.StaticLoadAnalysisCase):
    '''AdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_options(self) -> '_6234.AdvancedSystemDeflectionOptions':
        ...
        return constructor.new(_6234.AdvancedSystemDeflectionOptions)(self.wrapped.AdvancedSystemDeflectionOptions) if self.wrapped.AdvancedSystemDeflectionOptions else None
