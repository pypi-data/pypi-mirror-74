...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6326, _6348
...
class GearSetAdvancedSystemDeflection(_6348.SpecialisedAssemblyAdvancedSystemDeflection):
    '''GearSetAdvancedSystemDeflection
    ...
    @property
    def use_ltca_in_advanced_system_deflection(self) -> '_6326.UseLtcaInAsdOption':
        ...
        return constructor.new(_6326.UseLtcaInAsdOption)(value) if value else None

    @use_ltca_in_advanced_system_deflection.setter
    def use_ltca_in_advanced_system_deflection(self, value: '_6326.UseLtcaInAsdOption'):
