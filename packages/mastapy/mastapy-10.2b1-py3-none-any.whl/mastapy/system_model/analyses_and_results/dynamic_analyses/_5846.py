...
class ConicalGearMeshDynamicAnalysis(_5869.GearMeshDynamicAnalysis):
    '''ConicalGearMeshDynamicAnalysis
    ...
    def planetaries(self) -> 'List[ConicalGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearMeshDynamicAnalysis))
        return value
