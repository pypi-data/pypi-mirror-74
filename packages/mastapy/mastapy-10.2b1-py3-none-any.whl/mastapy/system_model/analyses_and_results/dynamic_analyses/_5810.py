...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5798
...
class BevelGearSetDynamicAnalysis(_5798.AGMAGleasonConicalGearSetDynamicAnalysis):
    '''BevelGearSetDynamicAnalysis
