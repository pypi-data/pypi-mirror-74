...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2745
...
class CVTBeltConnectionCompoundDynamicAnalysis(_2745.BeltConnectionCompoundDynamicAnalysis):
    '''CVTBeltConnectionCompoundDynamicAnalysis
