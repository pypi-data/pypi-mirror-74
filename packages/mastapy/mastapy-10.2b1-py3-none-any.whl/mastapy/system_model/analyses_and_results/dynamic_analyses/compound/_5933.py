...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5921
...
class BevelGearSetCompoundDynamicAnalysis(_5921.AGMAGleasonConicalGearSetCompoundDynamicAnalysis):
    '''BevelGearSetCompoundDynamicAnalysis
