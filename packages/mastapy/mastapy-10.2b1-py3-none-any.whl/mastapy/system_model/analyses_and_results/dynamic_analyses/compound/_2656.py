...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2673
...
class AbstractAssemblyCompoundDynamicAnalysis(_2673.PartCompoundDynamicAnalysis):
    '''AbstractAssemblyCompoundDynamicAnalysis
