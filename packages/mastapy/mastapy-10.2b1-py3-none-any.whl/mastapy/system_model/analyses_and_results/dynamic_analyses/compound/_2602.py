...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2595
...
class CVTCompoundDynamicAnalysis(_2595.BeltDriveCompoundDynamicAnalysis):
    '''CVTCompoundDynamicAnalysis
