...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2573
...
class ConicalGearSetCompoundDynamicAnalysis(_2573.GearSetCompoundDynamicAnalysis):
    '''ConicalGearSetCompoundDynamicAnalysis
