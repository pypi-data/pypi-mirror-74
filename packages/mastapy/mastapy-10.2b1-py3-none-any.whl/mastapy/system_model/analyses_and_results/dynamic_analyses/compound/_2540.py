...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _3684
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2534
...
class GuideDxfModelCompoundDynamicAnalysis(_2534.ComponentCompoundDynamicAnalysis):
    '''GuideDxfModelCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3684.GuideDxfModelDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3684.GuideDxfModelDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_3684.GuideDxfModelDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_3684.GuideDxfModelDynamicAnalysis))
        return value
