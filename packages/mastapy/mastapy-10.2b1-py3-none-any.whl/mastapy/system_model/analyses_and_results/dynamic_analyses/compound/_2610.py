...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2551
...
class SynchroniserCompoundDynamicAnalysis(_2551.SpecialisedAssemblyCompoundDynamicAnalysis):
    '''SynchroniserCompoundDynamicAnalysis
    ...
    @property
    def component_design(self) -> '_1977.Synchroniser':
    ...
    @property
    def assembly_design(self) -> '_1977.Synchroniser':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3636.SynchroniserDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3636.SynchroniserDynamicAnalysis))
        return value

    @property
    def assembly_dynamic_analysis_load_cases(self) -> 'List[_3636.SynchroniserDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyDynamicAnalysisLoadCases, constructor.new(_3636.SynchroniserDynamicAnalysis))
        return value
