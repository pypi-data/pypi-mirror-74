...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2684, _2759, _2700
...
class FaceGearSetCompoundDynamicAnalysis(_2700.GearSetCompoundDynamicAnalysis):
    '''FaceGearSetCompoundDynamicAnalysis
    ...
    @property
    def face_gears_compound_dynamic_analysis(self) -> 'List[_2684.FaceGearCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsCompoundDynamicAnalysis, constructor.new(_2684.FaceGearCompoundDynamicAnalysis))
        return value

    @property
    def face_meshes_compound_dynamic_analysis(self) -> 'List[_2759.FaceGearMeshCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesCompoundDynamicAnalysis, constructor.new(_2759.FaceGearMeshCompoundDynamicAnalysis))
        return value
