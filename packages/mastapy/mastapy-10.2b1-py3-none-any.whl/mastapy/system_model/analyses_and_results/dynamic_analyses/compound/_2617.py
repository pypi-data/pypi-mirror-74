...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2618
...
class CVTBeltConnectionCompoundDynamicAnalysis(_2618.BeltConnectionCompoundDynamicAnalysis):
    '''CVTBeltConnectionCompoundDynamicAnalysis
