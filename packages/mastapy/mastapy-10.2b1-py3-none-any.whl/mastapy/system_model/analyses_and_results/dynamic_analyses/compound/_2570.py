...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _2569, _2637, _2573
...
class CylindricalGearSetCompoundDynamicAnalysis(_2573.GearSetCompoundDynamicAnalysis):
    '''CylindricalGearSetCompoundDynamicAnalysis
    ...
    @property
    def cylindrical_gears_compound_dynamic_analysis(self) -> 'List[_2569.CylindricalGearCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsCompoundDynamicAnalysis, constructor.new(_2569.CylindricalGearCompoundDynamicAnalysis))
        return value

    @property
    def cylindrical_meshes_compound_dynamic_analysis(self) -> 'List[_2637.CylindricalGearMeshCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesCompoundDynamicAnalysis, constructor.new(_2637.CylindricalGearMeshCompoundDynamicAnalysis))
        return value
