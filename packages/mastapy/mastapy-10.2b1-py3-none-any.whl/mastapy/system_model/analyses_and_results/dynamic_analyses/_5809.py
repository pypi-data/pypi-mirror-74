...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5797
...
class BevelGearMeshDynamicAnalysis(_5797.AGMAGleasonConicalGearMeshDynamicAnalysis):
    '''BevelGearMeshDynamicAnalysis
