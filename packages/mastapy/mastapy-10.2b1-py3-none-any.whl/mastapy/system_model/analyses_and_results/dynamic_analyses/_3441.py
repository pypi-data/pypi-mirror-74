...
class FlexiblePinAssemblyDynamicAnalysis(_3454.SpecialisedAssemblyDynamicAnalysis):
    '''FlexiblePinAssemblyDynamicAnalysis
    ...
    @property
    def assembly_load_case(self) -> '_2316.FlexiblePinAssemblyLoadCase':
        ...
        return constructor.new(_2316.FlexiblePinAssemblyLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None
