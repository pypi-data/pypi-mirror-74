...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _3403
...
class CVTBeltConnectionDynamicAnalysis(_3403.BeltConnectionDynamicAnalysis):
    '''CVTBeltConnectionDynamicAnalysis
