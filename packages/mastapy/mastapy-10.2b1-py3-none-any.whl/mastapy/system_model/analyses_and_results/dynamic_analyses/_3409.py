...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _3405
...
class ShaftToMountableComponentConnectionDynamicAnalysis(_3405.ConnectionDynamicAnalysis):
    '''ShaftToMountableComponentConnectionDynamicAnalysis
