...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5796
...
class BevelGearDynamicAnalysis(_5796.AGMAGleasonConicalGearDynamicAnalysis):
    '''BevelGearDynamicAnalysis
