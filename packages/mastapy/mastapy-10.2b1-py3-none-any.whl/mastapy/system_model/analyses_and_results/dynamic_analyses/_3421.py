...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _3420
from mastapy._internal.python_net import python_net_import

_AGMA_GLEASON_CONICAL_GEAR_MESH_DYNAMIC_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.DynamicAnalyses', 'AGMAGleasonConicalGearMeshDynamicAnalysis')
...
class AGMAGleasonConicalGearMeshDynamicAnalysis(_3420.ConicalGearMeshDynamicAnalysis):
    '''AGMAGleasonConicalGearMeshDynamicAnalysis
    ...
    def __init__(self, instance_to_wrap: 'AGMAGleasonConicalGearMeshDynamicAnalysis.TYPE'):
