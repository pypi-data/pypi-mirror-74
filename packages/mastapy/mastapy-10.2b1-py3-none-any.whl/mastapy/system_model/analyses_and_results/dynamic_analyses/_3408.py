...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _3406
...
class RollingRingConnectionDynamicAnalysis(_3406.InterMountableComponentConnectionDynamicAnalysis):
    '''RollingRingConnectionDynamicAnalysis
