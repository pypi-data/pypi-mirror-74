...
class ConnectionDynamicAnalysis(_6507.ConnectionFEAnalysis):
    '''ConnectionDynamicAnalysis
    ...
    @property
    def dynamic_analysis(self) -> '_5861.DynamicAnalysis':
        ...
        return constructor.new(_5861.DynamicAnalysis)(self.wrapped.DynamicAnalysis) if self.wrapped.DynamicAnalysis else None
