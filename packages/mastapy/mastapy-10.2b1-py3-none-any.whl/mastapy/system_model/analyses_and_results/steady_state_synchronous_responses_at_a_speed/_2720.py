...
class AbstractAssemblySteadyStateSynchronousResponseAtASpeed(_2793.PartSteadyStateSynchronousResponseAtASpeed):
    '''AbstractAssemblySteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_design(self) -> '_1980.AbstractAssembly':
    ...
    @property
    def assembly_design(self) -> '_1980.AbstractAssembly':
        ...
        return constructor.new(_1980.AbstractAssembly)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None

    @property
    def assembly_design_of_type_assembly(self) -> '_1979.Assembly':
        ...
        if _1979.Assembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_root_assembly(self) -> '_2014.RootAssembly':
        ...
        if _2014.RootAssembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_specialised_assembly(self) -> '_2016.SpecialisedAssembly':
        ...
        if _2016.SpecialisedAssembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
