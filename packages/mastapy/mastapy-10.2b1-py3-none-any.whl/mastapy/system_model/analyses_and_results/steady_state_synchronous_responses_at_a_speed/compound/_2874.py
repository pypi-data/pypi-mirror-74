...
class BevelDifferentialSunGearCompoundSteadyStateSynchronousResponseAtASpeed(_2870.BevelDifferentialGearCompoundSteadyStateSynchronousResponseAtASpeed):
    '''BevelDifferentialSunGearCompoundSteadyStateSynchronousResponseAtASpeed
