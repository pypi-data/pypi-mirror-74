...
class BevelDifferentialSunGearCompoundSteadyStateSynchronousResponseAtASpeed(_2852.BevelDifferentialGearCompoundSteadyStateSynchronousResponseAtASpeed):
    '''BevelDifferentialSunGearCompoundSteadyStateSynchronousResponseAtASpeed
