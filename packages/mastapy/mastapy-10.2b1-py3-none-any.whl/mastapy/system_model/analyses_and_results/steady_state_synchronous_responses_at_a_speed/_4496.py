...
class RollingRingConnectionSteadyStateSynchronousResponseAtASpeed(_4474.InterMountableComponentConnectionSteadyStateSynchronousResponseAtASpeed):
    '''RollingRingConnectionSteadyStateSynchronousResponseAtASpeed
    ...
    def planetaries(self) -> 'List[RollingRingConnectionSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(RollingRingConnectionSteadyStateSynchronousResponseAtASpeed))
        return value
