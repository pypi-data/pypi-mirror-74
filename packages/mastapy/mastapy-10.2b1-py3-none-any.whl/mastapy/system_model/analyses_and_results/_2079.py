...
class SingleAnalysis:
    ...
    def perform_analysis_with_progress(self, task_progress: '_312.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_1723.DesignEntity') -> '_2110.DesignEntityAnalysis':
        ...
        return constructor.new(_2110.DesignEntityAnalysis)(method_result) if method_result else None

    def results_for_design_entity_analysis(self, design_entity_analysis: '_2110.DesignEntityAnalysis') -> '_2110.DesignEntityAnalysis':
        ''' 'ResultsFor' is the original name of this method.
