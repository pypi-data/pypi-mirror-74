...
class GearSetHarmonicLoadData(_6146.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6141.GearMeshTEOrderType':
        ...
        return constructor.new(_6141.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6141.GearMeshTEOrderType'):
