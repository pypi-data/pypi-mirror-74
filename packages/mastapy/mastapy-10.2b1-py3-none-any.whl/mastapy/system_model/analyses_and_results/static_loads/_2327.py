...
from mastapy.system_model import _1732, _1733, _1734
from mastapy.system_model.analyses_and_results.mbd_analyses import _6037
from mastapy.system_model.analyses_and_results.static_loads import _6289, _6264, _2334
...
from mastapy.nodal_analysis.varying_input_components import _117
...
class PowerLoadLoadCase(_2334.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1732.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1732.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1732.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_6037.WheelSlipType':
        ...
        return constructor.new(_6037.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_6037.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def input_torque_specification_method(self) -> 'enum_with_selected_value.EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod)(self.wrapped.InputTorqueSpecificationMethod) if self.wrapped.InputTorqueSpecificationMethod else None
    ...
    def input_torque_specification_method(self, value: 'enum_with_selected_value.EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod.implicit_type()'):
        wrapper_type = enum_with_selected_value.EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod.TYPE
    ...
    @property
    def target_speed_input_type(self) -> '_1734.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1734.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1734.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def torque_specification_method(self) -> 'enum_with_selected_value.EnumWithSelectedValue_TorqueSpecificationForSystemDeflection':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_TorqueSpecificationForSystemDeflection)(self.wrapped.TorqueSpecificationMethod) if self.wrapped.TorqueSpecificationMethod else None
    ...
    def torque_specification_method(self, value: 'enum_with_selected_value.EnumWithSelectedValue_TorqueSpecificationForSystemDeflection.implicit_type()'):
        wrapper_type = enum_with_selected_value.EnumWithSelectedValue_TorqueSpecificationForSystemDeflection.TYPE
    ...
    def electric_machine_data_set_selector(self, value: 'list_with_selected_item.ListWithSelectedItem_ElectricMachineDataSet.implicit_type()'):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_ElectricMachineDataSet.TYPE
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1258.PIDControlSettings':
        ...
        return constructor.new(_1258.PIDControlSettings)(self.wrapped.EngineIdleSpeedControlPIDSettings) if self.wrapped.EngineIdleSpeedControlPIDSettings else None

    @property
    def coefficient_of_friction_with_ground(self) -> '_117.NonDimensionalInputComponent':
        ...
        return constructor.new(_117.NonDimensionalInputComponent)(self.wrapped.CoefficientOfFrictionWithGround) if self.wrapped.CoefficientOfFrictionWithGround else None

    @property
    def pid_control_settings(self) -> '_1258.PIDControlSettings':
        ...
        return constructor.new(_1258.PIDControlSettings)(self.wrapped.PIDControlSettings) if self.wrapped.PIDControlSettings else None

    def get_harmonic_load_data_for_import(self) -> '_6264.ElectricMachineHarmonicLoadData':
        ...
        return constructor.new(_6264.ElectricMachineHarmonicLoadData)(method_result) if method_result else None
