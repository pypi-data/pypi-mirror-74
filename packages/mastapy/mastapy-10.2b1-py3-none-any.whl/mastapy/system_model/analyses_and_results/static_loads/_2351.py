...
class PlanetaryGearSetLoadCase(_2328.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1269.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1269.LoadCaseOverrideOption'):
