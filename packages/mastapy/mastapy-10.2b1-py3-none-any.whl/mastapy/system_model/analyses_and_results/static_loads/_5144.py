...
class TimeSeriesLoadCase(_6125.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5985.MBDAnalysisOptions':
        ...
        return constructor.new(_5985.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
