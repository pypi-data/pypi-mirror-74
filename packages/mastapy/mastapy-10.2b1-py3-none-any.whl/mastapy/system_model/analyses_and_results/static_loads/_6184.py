...
from mastapy.math_utility import _1072, _1079
...
class PointLoadHarmonicLoadData(_6197.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1072.DegreesOfFreedom':
        ...
        return constructor.new(_1072.DegreesOfFreedom)(value) if value else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1072.DegreesOfFreedom'):
