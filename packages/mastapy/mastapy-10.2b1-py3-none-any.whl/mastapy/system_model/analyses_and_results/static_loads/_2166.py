...
from mastapy.system_model.analyses_and_results.static_loads import _2369, _2258, _2334
...
class WormGearSetLoadCase(_2334.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_2369.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_2369.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_2258.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_2258.WormGearMeshLoadCase))
        return value
