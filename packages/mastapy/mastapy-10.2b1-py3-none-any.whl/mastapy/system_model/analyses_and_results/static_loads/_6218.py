...
class TimeSeriesLoadCase(_6065.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5062.MBDAnalysisOptions':
        ...
        return constructor.new(_5062.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
