...
from mastapy.system_model.analyses_and_results.static_loads import _6172, _6148, _6128
...
class HarmonicLoadDataExcelImport(_6148.HarmonicLoadDataImportBase['_6128.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6172.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6172.NamedSpeed))
        return value
