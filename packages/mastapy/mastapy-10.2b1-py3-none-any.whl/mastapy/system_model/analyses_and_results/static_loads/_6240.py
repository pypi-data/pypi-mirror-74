...
class PointLoadHarmonicLoadData(_6288.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1218.DegreesOfFreedom':
        ...
        return constructor.new(_1218.DegreesOfFreedom)(value) if value else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1218.DegreesOfFreedom'):
