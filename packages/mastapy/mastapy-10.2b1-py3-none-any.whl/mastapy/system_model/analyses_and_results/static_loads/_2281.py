...
from mastapy.system_model.imported_fes import _1838
from mastapy._internal import constructor, conversion
from mastapy._internal.implicit import list_with_selected_item
from mastapy.system_model.analyses_and_results.static_loads import _6282, _2264
...
class ImportedFEComponentLoadCase(_2264.AbstractShaftOrHousingLoadCase):
    '''ImportedFEComponentLoadCase
    ...
    @property
    def angle_source(self) -> '_1838.AngleSource':
        ...
        return constructor.new(_1838.AngleSource)(value) if value else None
    ...
    @property
    def active_imported_fe(self) -> 'list_with_selected_item.ListWithSelectedItem_ImportedFEWrapper':
        '''list_with_selected_item.ListWithSelectedItem_ImportedFEWrapper: 'ActiveImportedFE' is the original name of this property.'''

        return constructor.new(list_with_selected_item.ListWithSelectedItem_ImportedFEWrapper)(self.wrapped.ActiveImportedFE) if self.wrapped.ActiveImportedFE else None

    @active_imported_fe.setter
    def active_imported_fe(self, value: 'list_with_selected_item.ListWithSelectedItem_ImportedFEWrapper.implicit_type()'):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_ImportedFEWrapper.TYPE
        enclosed_type = list_with_selected_item.ListWithSelectedItem_ImportedFEWrapper.implicit_type()
