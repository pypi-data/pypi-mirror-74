...
from mastapy.system_model.analyses_and_results.load_case_groups import _6168, _6169
...
class StaticLoadCase(_6125.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def planetary_rating_load_sharing_method(self) -> '_318.PlanetaryRatingLoadSharingOption':
        ...
        return constructor.new(_318.PlanetaryRatingLoadSharingOption)(value) if value else None

    @planetary_rating_load_sharing_method.setter
    def planetary_rating_load_sharing_method(self, value: '_318.PlanetaryRatingLoadSharingOption'):
    ...
    @property
    def clutch_engagements(self) -> 'List[_6168.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_6168.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_6169.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_6169.ConceptSynchroGearEngagementStatus))
        return value
