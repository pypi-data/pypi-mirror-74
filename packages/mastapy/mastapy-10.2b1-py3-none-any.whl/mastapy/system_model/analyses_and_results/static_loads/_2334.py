...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5961
...
class GearSetLoadCase(_2301.SpecialisedAssemblyLoadCase):
    '''GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self) -> '_5961.GearMeshStiffnessModel':
        ...
        return constructor.new(_5961.GearMeshStiffnessModel)(value) if value else None

    @gear_mesh_stiffness_model.setter
    def gear_mesh_stiffness_model(self, value: '_5961.GearMeshStiffnessModel'):
