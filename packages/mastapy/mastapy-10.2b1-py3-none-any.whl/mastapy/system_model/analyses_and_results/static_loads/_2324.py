...
from mastapy.system_model.analyses_and_results.static_loads import _6238, _2334
...
class ConicalGearSetLoadCase(_2334.GearSetLoadCase):
    '''ConicalGearSetLoadCase
    ...
    def get_harmonic_load_data_for_import(self) -> '_6238.ConicalGearSetHarmonicLoadData':
        ...
        return constructor.new(_6238.ConicalGearSetHarmonicLoadData)(method_result) if method_result else None
