...
class BearingLoadCase(_2270.ConnectorLoadCase):
    '''BearingLoadCase
    ...
    @property
    def bearing_stiffness_model(self) -> '_5915.BearingStiffnessModel':
        ...
        return constructor.new(_5915.BearingStiffnessModel)(value) if value else None

    @bearing_stiffness_model.setter
    def bearing_stiffness_model(self, value: '_5915.BearingStiffnessModel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BearingStiffnessModel = value

    @property
    def bearing_stiffness_model_used_in_analysis(self) -> '_5915.BearingStiffnessModel':
