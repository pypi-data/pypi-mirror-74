...
from mastapy.system_model.analyses_and_results.static_loads import _6284, _6278, _6268
...
class HarmonicLoadDataExcelImport(_6278.HarmonicLoadDataImportBase['_6268.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6284.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6284.NamedSpeed))
        return value
