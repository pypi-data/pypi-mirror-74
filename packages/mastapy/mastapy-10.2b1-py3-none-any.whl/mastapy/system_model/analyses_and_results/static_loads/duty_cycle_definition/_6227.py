...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6217, _6228, _6219, _6216,
    _6220, _6222, _6229, _6226,
    _6218, _6221, _6215
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6136.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6136.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6136.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6228.TimeStepInputOptions':
        ...
        return constructor.new(_6228.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6219.GearRatioInputOptions':
        ...
        return constructor.new(_6219.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6216.DesignStateOptions':
        ...
        return constructor.new(_6216.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6220.LoadCaseNameOptions':
        ...
        return constructor.new(_6220.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6222.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6222.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6229.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6229.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6226.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6226.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6218.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6218.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6221.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6221.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6215.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6215.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1333.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1333.ColumnTitle))
        return value
