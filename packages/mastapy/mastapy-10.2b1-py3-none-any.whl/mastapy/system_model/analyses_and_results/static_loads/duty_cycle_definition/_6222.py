...
from mastapy.utility.file_access_helpers import _1334
from mastapy.utility_gui import _1499
...
class MultiTimeSeriesDataInputFileOptions(_1499.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1334.TextFileDelimiterOptions':
        ...
        return constructor.new(_1334.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
