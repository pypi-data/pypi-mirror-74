...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6230, _6224
...
class TorqueInputOptions(_6224.PowerLoadInputOptions):
    '''TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6230.TorqueValuesObtainedFrom':
        ...
        return constructor.new(_6230.TorqueValuesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6230.TorqueValuesObtainedFrom'):
