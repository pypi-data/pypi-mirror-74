...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6305, _6300
...
class TorqueInputOptions(_6300.PowerLoadInputOptions):
    '''TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6305.TorqueValuesObtainedFrom':
        ...
        return constructor.new(_6305.TorqueValuesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6305.TorqueValuesObtainedFrom'):
