...
from mastapy.utility.file_access_helpers import _1442
from mastapy.utility_gui import _1457
...
class MultiTimeSeriesDataInputFileOptions(_1457.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1442.TextFileDelimiterOptions':
        ...
        return constructor.new(_1442.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
