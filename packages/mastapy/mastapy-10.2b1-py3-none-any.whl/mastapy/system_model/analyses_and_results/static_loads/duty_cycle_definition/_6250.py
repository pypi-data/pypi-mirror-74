...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6251, _6245
...
class TorqueInputOptions(_6245.PowerLoadInputOptions):
    '''TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6251.TorqueValuesObtainedFrom':
        ...
        return constructor.new(_6251.TorqueValuesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6251.TorqueValuesObtainedFrom'):
