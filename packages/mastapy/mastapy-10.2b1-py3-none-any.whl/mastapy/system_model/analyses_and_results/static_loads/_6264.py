...
from mastapy.system_model.analyses_and_results.static_loads import _2060, _2061, _6288
...
class ElectricMachineHarmonicLoadData(_6288.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    def torque_ripple_input_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_TorqueRippleInputType':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_TorqueRippleInputType)(self.wrapped.TorqueRippleInputType) if self.wrapped.TorqueRippleInputType else None
    ...
    def torque_ripple_input_type(self, value: 'enum_with_selected_value.EnumWithSelectedValue_TorqueRippleInputType.implicit_type()'):
        wrapper_type = enum_with_selected_value.EnumWithSelectedValue_TorqueRippleInputType.TYPE
    ...
    def data_type_for_scaling(self) -> 'enum_with_selected_value.EnumWithSelectedValue_HarmonicLoadDataType':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_HarmonicLoadDataType)(self.wrapped.DataTypeForScaling) if self.wrapped.DataTypeForScaling else None
    ...
    def data_type_for_force_distribution_and_temporal_spatial_harmonics_charts(self) -> 'enum_with_selected_value.EnumWithSelectedValue_HarmonicLoadDataType':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_HarmonicLoadDataType)(self.wrapped.DataTypeForForceDistributionAndTemporalSpatialHarmonicsCharts) if self.wrapped.DataTypeForForceDistributionAndTemporalSpatialHarmonicsCharts else None
    ...
    @property
    def force_distribution(self) -> '_712.SMTBitmap':
        ...
        return constructor.new(_712.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
