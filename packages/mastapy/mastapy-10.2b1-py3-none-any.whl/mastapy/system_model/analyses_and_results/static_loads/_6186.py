...
from mastapy.system_model import _1819, _1820, _1821
from mastapy.system_model.analyses_and_results.mbd_analyses import _5115
from mastapy.system_model.analyses_and_results.static_loads import _6224, _6123, _6228
from mastapy.system_model.imported_fes import _1939
from mastapy.system_model.part_model import _2030
from mastapy.math_utility.control import _1130
from mastapy.nodal_analysis.varying_input_components import _1406
...
class PowerLoadLoadCase(_6228.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1819.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1819.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1819.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_5115.WheelSlipType':
        ...
        return constructor.new(_5115.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5115.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1821.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1821.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1821.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1130.PIDControlSettings':
        ...
        return constructor.new(_1130.PIDControlSettings)(self.wrapped.EngineIdleSpeedControlPIDSettings) if self.wrapped.EngineIdleSpeedControlPIDSettings else None

    @property
    def coefficient_of_friction_with_ground(self) -> '_1406.NonDimensionalInputComponent':
        ...
        return constructor.new(_1406.NonDimensionalInputComponent)(self.wrapped.CoefficientOfFrictionWithGround) if self.wrapped.CoefficientOfFrictionWithGround else None

    @property
    def pid_control_settings(self) -> '_1130.PIDControlSettings':
        ...
        return constructor.new(_1130.PIDControlSettings)(self.wrapped.PIDControlSettings) if self.wrapped.PIDControlSettings else None

    def get_harmonic_load_data_for_import(self) -> '_6123.ElectricMachineHarmonicLoadData':
        ...
        return constructor.new(_6123.ElectricMachineHarmonicLoadData)(method_result) if method_result else None
