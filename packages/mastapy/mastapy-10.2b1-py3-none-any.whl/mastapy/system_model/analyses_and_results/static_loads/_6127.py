...
from mastapy.system_model.analyses_and_results.static_loads import _6123, _6129
...
T = TypeVar('T', bound='_6129.ElectricMachineHarmonicLoadImportOptionsBase')


class ElectricMachineHarmonicLoadDataFromMotorPackages(_6123.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
