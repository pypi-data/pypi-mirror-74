...
from mastapy.system_model.analyses_and_results.static_loads import _6204, _6218
...
class ConnectionLoadCase(_2196.ConnectionAnalysis):
    '''ConnectionLoadCase
    ...
    @property
    def static_load_case(self) -> '_6204.StaticLoadCase':
        ...
        return constructor.new(_6204.StaticLoadCase)(self.wrapped.StaticLoadCase) if self.wrapped.StaticLoadCase else None

    @property
    def time_series_load_case(self) -> '_6218.TimeSeriesLoadCase':
        ...
        return constructor.new(_6218.TimeSeriesLoadCase)(self.wrapped.TimeSeriesLoadCase) if self.wrapped.TimeSeriesLoadCase else None
