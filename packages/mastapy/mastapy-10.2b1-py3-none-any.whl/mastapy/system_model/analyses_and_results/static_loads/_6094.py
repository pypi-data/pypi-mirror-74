...
from mastapy.system_model import _1809
...
class ConceptCouplingLoadCase(_6107.CouplingLoadCase):
    '''ConceptCouplingLoadCase
    ...
    @property
    def speed_ratio_specification_method(self) -> '_1809.ConceptCouplingSpeedRatioSpecificationMethod':
        ...
        return constructor.new(_1809.ConceptCouplingSpeedRatioSpecificationMethod)(value) if value else None

    @speed_ratio_specification_method.setter
    def speed_ratio_specification_method(self, value: '_1809.ConceptCouplingSpeedRatioSpecificationMethod'):
    ...
    @property
    def speed_ratio_pid_control(self) -> '_1130.PIDControlSettings':
        ...
        return constructor.new(_1130.PIDControlSettings)(self.wrapped.SpeedRatioPIDControl) if self.wrapped.SpeedRatioPIDControl else None
