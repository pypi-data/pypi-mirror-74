...
class ElectricMachineDetail(_1348.NamedDatabaseItem):
    '''ElectricMachineDetail
    ...
    @property
    def flow_rate_specification_method(self) -> '_1341.PropertySpecificationMethod':
        ...
        return constructor.new(_1341.PropertySpecificationMethod)(value) if value else None

    @flow_rate_specification_method.setter
    def flow_rate_specification_method(self, value: '_1341.PropertySpecificationMethod'):
