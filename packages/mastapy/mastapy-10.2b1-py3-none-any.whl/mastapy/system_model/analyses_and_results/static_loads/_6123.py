...
from mastapy.system_model.analyses_and_results.static_loads import _6223, _6152, _6197
...
class ElectricMachineHarmonicLoadData(_6197.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    @property
    def force_distribution(self) -> '_6525.SMTBitmap':
        ...
        return constructor.new(_6525.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
