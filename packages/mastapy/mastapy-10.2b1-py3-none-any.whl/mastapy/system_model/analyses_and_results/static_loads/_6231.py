...
from mastapy.system_model.analyses_and_results.static_loads import _6229, _6230, _6143
...
class WormGearSetLoadCase(_6143.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_6229.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_6229.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_6230.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_6230.WormGearMeshLoadCase))
        return value
