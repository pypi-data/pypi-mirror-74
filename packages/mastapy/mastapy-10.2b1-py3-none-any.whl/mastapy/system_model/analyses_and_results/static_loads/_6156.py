...
from mastapy.system_model.imported_fes import _1927, _1950
...
class ImportedFEComponentLoadCase(_6067.AbstractShaftOrHousingLoadCase):
    '''ImportedFEComponentLoadCase
    ...
    @property
    def angle_source(self) -> '_1927.AngleSource':
        ...
        return constructor.new(_1927.AngleSource)(value) if value else None
