...
from mastapy.system_model.analyses_and_results.static_loads import _6204, _6115, _6073
...
class RootAssemblyLoadCase(_6073.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6115.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6115.CylindricalGearSetLoadCase))
        return value
