...
from mastapy.system_model.analyses_and_results.mbd_analyses import _6035
from mastapy.system_model.analyses_and_results.static_loads import _6289, _6264, _2305
...
from mastapy.nodal_analysis.varying_input_components import _123
...
class PowerLoadLoadCase(_2305.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def wheel_slip_model(self) -> '_6035.WheelSlipType':
        ...
        return constructor.new(_6035.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_6035.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def coefficient_of_friction_with_ground(self) -> '_123.NonDimensionalInputComponent':
        ...
        return constructor.new(_123.NonDimensionalInputComponent)(self.wrapped.CoefficientOfFrictionWithGround) if self.wrapped.CoefficientOfFrictionWithGround else None
