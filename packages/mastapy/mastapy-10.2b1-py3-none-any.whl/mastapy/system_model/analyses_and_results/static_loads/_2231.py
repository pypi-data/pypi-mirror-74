...
from mastapy.system_model.analyses_and_results.static_loads import _2381, _2303, _2354
...
class WormGearSetLoadCase(_2354.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_2381.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_2381.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_2303.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_2303.WormGearMeshLoadCase))
        return value
