...
class PartLoadCase(_2112.PartAnalysis):
    '''PartLoadCase
    ...
    @property
    def load_case_for_harmonic_excitation_type_advanced_system_deflection_current_load_case_set_up(self) -> 'list_with_selected_item.ListWithSelectedItem_str':
        '''list_with_selected_item.ListWithSelectedItem_str: 'LoadCaseForHarmonicExcitationTypeAdvancedSystemDeflectionCurrentLoadCaseSetUp' is the original name of this property.'''

        return constructor.new(list_with_selected_item.ListWithSelectedItem_str)(self.wrapped.LoadCaseForHarmonicExcitationTypeAdvancedSystemDeflectionCurrentLoadCaseSetUp) if self.wrapped.LoadCaseForHarmonicExcitationTypeAdvancedSystemDeflectionCurrentLoadCaseSetUp else None

    @load_case_for_harmonic_excitation_type_advanced_system_deflection_current_load_case_set_up.setter
    def load_case_for_harmonic_excitation_type_advanced_system_deflection_current_load_case_set_up(self, value: 'list_with_selected_item.ListWithSelectedItem_str.implicit_type()'):
    ...
    def harmonic_excitation_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_HarmonicExcitationType':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_HarmonicExcitationType)(self.wrapped.HarmonicExcitationType) if self.wrapped.HarmonicExcitationType else None
    ...
    def harmonic_excitation_type(self, value: 'enum_with_selected_value.EnumWithSelectedValue_HarmonicExcitationType.implicit_type()'):
        wrapper_type = enum_with_selected_value.EnumWithSelectedValue_HarmonicExcitationType.TYPE
    ...
    @property
    def clear_user_specified_excitation_data_for_this_load_case(self) -> 'Callable[[], None]':
        '''Callable[[], None]: 'ClearUserSpecifiedExcitationDataForThisLoadCase' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.ClearUserSpecifiedExcitationDataForThisLoadCase
    ...
    @property
    def static_load_case(self) -> '_2057.StaticLoadCase':
        ...
        return constructor.new(_2057.StaticLoadCase)(self.wrapped.StaticLoadCase) if self.wrapped.StaticLoadCase else None
    ...
    def get_harmonic_load_data_for_import(self) -> '_6237.HarmonicLoadDataBase':
        ''' 'GetHarmonicLoadDataForImport' is the original name of this method.

        Returns:
            mastapy.system_model.analyses_and_results.static_loads.HarmonicLoadDataBase
        '''

        method_result = self.wrapped.GetHarmonicLoadDataForImport()
        return constructor.new(_6237.HarmonicLoadDataBase)(method_result) if method_result else None
