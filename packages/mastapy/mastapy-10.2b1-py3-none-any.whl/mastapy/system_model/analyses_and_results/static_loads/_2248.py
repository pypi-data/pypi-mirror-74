...
class KlingelnbergCycloPalloidConicalGearMeshLoadCase(_2241.ConicalGearMeshLoadCase):
    '''KlingelnbergCycloPalloidConicalGearMeshLoadCase

    This is a mastapy class.
    '''

    TYPE = _KLINGELNBERG_CYCLO_PALLOID_CONICAL_GEAR_MESH_LOAD_CASE
    __hash__ = None

    def __init__(self, instance_to_wrap: 'KlingelnbergCycloPalloidConicalGearMeshLoadCase.TYPE'):
