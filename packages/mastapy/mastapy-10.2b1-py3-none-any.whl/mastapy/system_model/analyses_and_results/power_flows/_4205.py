...
from mastapy.system_model.analyses_and_results.power_flows import _4213
from mastapy._internal.python_net import python_net_import

_AGMA_GLEASON_CONICAL_GEAR_SET_POWER_FLOW = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.PowerFlows', 'AGMAGleasonConicalGearSetPowerFlow')
...
class AGMAGleasonConicalGearSetPowerFlow(_4213.ConicalGearSetPowerFlow):
    '''AGMAGleasonConicalGearSetPowerFlow
    ...
    def __init__(self, instance_to_wrap: 'AGMAGleasonConicalGearSetPowerFlow.TYPE'):
