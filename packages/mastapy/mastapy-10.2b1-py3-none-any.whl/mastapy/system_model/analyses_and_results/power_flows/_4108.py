...
from mastapy.system_model.analyses_and_results.power_flows import _4109, _4167
...
class SynchroniserPowerFlow(_4167.SpecialisedAssemblyPowerFlow):
    '''SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_4109.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_4109.SynchroniserHalfPowerFlow))
        return value
