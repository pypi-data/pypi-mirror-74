...
_CONICAL_GEAR_POWER_FLOW = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.PowerFlows', 'ConicalGearPowerFlow')
...
class ConicalGearPowerFlow(_4217.GearPowerFlow):
    '''ConicalGearPowerFlow
    ...
    def __init__(self, instance_to_wrap: 'ConicalGearPowerFlow.TYPE'):
