...
from mastapy.system_model.analyses_and_results.power_flows import _4221
...
class KlingelnbergCycloPalloidHypoidGearPowerFlow(_4221.KlingelnbergCycloPalloidConicalGearPowerFlow):
    '''KlingelnbergCycloPalloidHypoidGearPowerFlow
    ...
    @property
    def component_detailed_analysis(self) -> '_420.KlingelnbergCycloPalloidHypoidGearRating':
        ...
        return constructor.new(_420.KlingelnbergCycloPalloidHypoidGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
