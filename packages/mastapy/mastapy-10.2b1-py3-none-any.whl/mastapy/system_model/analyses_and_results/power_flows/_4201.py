...
from mastapy.system_model.analyses_and_results.power_flows import _4200, _4158, _4218
...
class ConceptGearSetPowerFlow(_4218.GearSetPowerFlow):
    '''ConceptGearSetPowerFlow
    ...
    @property
    def concept_gears_power_flow(self) -> 'List[_4200.ConceptGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsPowerFlow, constructor.new(_4200.ConceptGearPowerFlow))
        return value

    @property
    def concept_meshes_power_flow(self) -> 'List[_4158.ConceptGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesPowerFlow, constructor.new(_4158.ConceptGearMeshPowerFlow))
        return value
