...
from mastapy.system_model.analyses_and_results.power_flows import _4236, _4171, _4218
...
class WormGearSetPowerFlow(_4218.GearSetPowerFlow):
    '''WormGearSetPowerFlow
    ...
    @property
    def worm_gears_power_flow(self) -> 'List[_4236.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsPowerFlow, constructor.new(_4236.WormGearPowerFlow))
        return value

    @property
    def worm_meshes_power_flow(self) -> 'List[_4171.WormGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesPowerFlow, constructor.new(_4171.WormGearMeshPowerFlow))
        return value
