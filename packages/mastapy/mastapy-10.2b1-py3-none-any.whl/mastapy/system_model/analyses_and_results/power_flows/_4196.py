...
_SPECIALISED_ASSEMBLY_POWER_FLOW = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.PowerFlows', 'SpecialisedAssemblyPowerFlow')
...
class SpecialisedAssemblyPowerFlow(_4174.AbstractAssemblyPowerFlow):
    '''SpecialisedAssemblyPowerFlow
    ...
    def __init__(self, instance_to_wrap: 'SpecialisedAssemblyPowerFlow.TYPE'):
