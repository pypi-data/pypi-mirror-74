...
from mastapy.system_model.analyses_and_results.power_flows import _4230, _4160, _4211
...
class StraightBevelDiffGearSetPowerFlow(_4211.BevelGearSetPowerFlow):
    '''StraightBevelDiffGearSetPowerFlow
    ...
    @property
    def straight_bevel_diff_gears_power_flow(self) -> 'List[_4230.StraightBevelDiffGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsPowerFlow, constructor.new(_4230.StraightBevelDiffGearPowerFlow))
        return value

    @property
    def straight_bevel_diff_meshes_power_flow(self) -> 'List[_4160.StraightBevelDiffGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesPowerFlow, constructor.new(_4160.StraightBevelDiffGearMeshPowerFlow))
        return value
