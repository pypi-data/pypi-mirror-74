...
from mastapy.system_model.analyses_and_results.power_flows import _3286, _3287, _3327
...
class GearSetPowerFlow(_3327.SpecialisedAssemblyPowerFlow):
    '''GearSetPowerFlow
    ...
    @property
    def rating(self) -> '_165.GearSetRating':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3286.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3286.GearMeshPowerFlow))
        return value

    @property
    def gears_power_flow(self) -> 'List[_3287.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3287.GearPowerFlow))
        return value
