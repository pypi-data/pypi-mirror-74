...
class PartPowerFlow(_4455.PartStaticLoadAnalysisCase):
    '''PartPowerFlow
    ...
    @property
    def twod_drawing_showing_power_flow(self) -> '_712.SMTBitmap':
        ...
        return constructor.new(_712.SMTBitmap)(self.wrapped.TwoDDrawingShowingPowerFlow) if self.wrapped.TwoDDrawingShowingPowerFlow else None
