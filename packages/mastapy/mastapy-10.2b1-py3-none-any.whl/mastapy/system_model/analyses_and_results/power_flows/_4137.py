...
from mastapy.system_model.analyses_and_results.power_flows import _4138, _4196
...
class SynchroniserPowerFlow(_4196.SpecialisedAssemblyPowerFlow):
    '''SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_4138.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_4138.SynchroniserHalfPowerFlow))
        return value
