...
from mastapy.system_model.analyses_and_results.power_flows import _4232, _4170, _4211
...
class StraightBevelGearSetPowerFlow(_4211.BevelGearSetPowerFlow):
    '''StraightBevelGearSetPowerFlow
    ...
    @property
    def straight_bevel_gears_power_flow(self) -> 'List[_4232.StraightBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsPowerFlow, constructor.new(_4232.StraightBevelGearPowerFlow))
        return value

    @property
    def straight_bevel_meshes_power_flow(self) -> 'List[_4170.StraightBevelGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesPowerFlow, constructor.new(_4170.StraightBevelGearMeshPowerFlow))
        return value
