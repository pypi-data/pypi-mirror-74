...
class KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow(_4166.KlingelnbergCycloPalloidConicalGearMeshPowerFlow):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow
    ...
    @property
    def rating(self) -> '_417.KlingelnbergCycloPalloidSpiralBevelGearMeshRating':
