...
class WormGearMeshPowerFlow(_4173.GearMeshPowerFlow):
    '''WormGearMeshPowerFlow
    ...
    @property
    def rating(self) -> '_352.WormGearMeshRating':
        ...
        return constructor.new(_352.WormGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None
