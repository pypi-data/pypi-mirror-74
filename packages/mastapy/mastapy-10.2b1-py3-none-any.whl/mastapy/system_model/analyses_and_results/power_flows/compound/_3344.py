...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3372
...
class AGMAGleasonConicalGearMeshCompoundPowerFlow(_3372.ConicalGearMeshCompoundPowerFlow):
    '''AGMAGleasonConicalGearMeshCompoundPowerFlow
