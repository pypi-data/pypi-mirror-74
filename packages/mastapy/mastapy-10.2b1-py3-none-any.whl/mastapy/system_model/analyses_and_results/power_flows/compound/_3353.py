...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3350
...
class BevelDifferentialPlanetGearCompoundPowerFlow(_3350.BevelDifferentialGearCompoundPowerFlow):
    '''BevelDifferentialPlanetGearCompoundPowerFlow
