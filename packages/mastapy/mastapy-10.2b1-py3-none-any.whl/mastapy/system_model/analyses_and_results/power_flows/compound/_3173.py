...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3171
...
class BevelDifferentialPlanetGearCompoundPowerFlow(_3171.BevelDifferentialGearCompoundPowerFlow):
    '''BevelDifferentialPlanetGearCompoundPowerFlow
