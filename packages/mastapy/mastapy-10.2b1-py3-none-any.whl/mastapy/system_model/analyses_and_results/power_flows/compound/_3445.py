...
class RootAssemblyCompoundPowerFlow(_3364.AssemblyCompoundPowerFlow):
    '''RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load(self) -> '_5251.AbstractStaticLoadCaseGroup':
        ...
        return constructor.new(_5251.AbstractStaticLoadCaseGroup)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None

    @property
    def compound_static_load_of_type_abstract_design_state_load_case_group(self) -> '_5249.AbstractDesignStateLoadCaseGroup':
        ...
        if _5249.AbstractDesignStateLoadCaseGroup.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
        ...
        return constructor.new(_5249.AbstractDesignStateLoadCaseGroup)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None

    @property
    def compound_static_load_of_type_design_state(self) -> '_5254.DesignState':
        ...
        if _5254.DesignState.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
        ...
        return constructor.new(_5254.DesignState)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None

    @property
    def compound_static_load_of_type_duty_cycle(self) -> '_5255.DutyCycle':
        ...
        if _5255.DutyCycle.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
        ...
        return constructor.new(_5255.DutyCycle)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None

    @property
    def compound_static_load_of_type_sub_group_in_single_design_state(self) -> '_5259.SubGroupInSingleDesignState':
        ...
        if _5259.SubGroupInSingleDesignState.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
        ...
        return constructor.new(_5259.SubGroupInSingleDesignState)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None
