...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3179
...
class CylindricalPlanetGearCompoundPowerFlow(_3179.CylindricalGearCompoundPowerFlow):
    '''CylindricalPlanetGearCompoundPowerFlow
