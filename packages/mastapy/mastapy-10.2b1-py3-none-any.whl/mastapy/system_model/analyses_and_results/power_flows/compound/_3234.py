...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3230
...
class ShaftToMountableComponentConnectionCompoundPowerFlow(_3230.ConnectionCompoundPowerFlow):
    '''ShaftToMountableComponentConnectionCompoundPowerFlow
