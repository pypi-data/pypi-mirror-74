...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3526
...
class BevelDifferentialPlanetGearCompoundPowerFlow(_3526.BevelDifferentialGearCompoundPowerFlow):
    '''BevelDifferentialPlanetGearCompoundPowerFlow
