...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3532
...
class KlingelnbergCycloPalloidConicalGearCompoundPowerFlow(_3532.ConicalGearCompoundPowerFlow):
    '''KlingelnbergCycloPalloidConicalGearCompoundPowerFlow
