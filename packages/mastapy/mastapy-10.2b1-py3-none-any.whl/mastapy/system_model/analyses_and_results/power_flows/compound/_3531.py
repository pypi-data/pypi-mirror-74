...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3525
...
class BevelGearSetCompoundPowerFlow(_3525.AGMAGleasonConicalGearSetCompoundPowerFlow):
    '''BevelGearSetCompoundPowerFlow
