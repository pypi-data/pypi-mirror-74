...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3359
...
class SpecialisedAssemblyCompoundPowerFlow(_3359.AbstractAssemblyCompoundPowerFlow):
    '''SpecialisedAssemblyCompoundPowerFlow
