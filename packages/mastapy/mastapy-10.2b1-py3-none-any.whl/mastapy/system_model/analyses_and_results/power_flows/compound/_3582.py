...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3583
...
class CVTBeltConnectionCompoundPowerFlow(_3583.BeltConnectionCompoundPowerFlow):
    '''CVTBeltConnectionCompoundPowerFlow
