...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3538
...
class ConicalGearSetCompoundPowerFlow(_3538.GearSetCompoundPowerFlow):
    '''ConicalGearSetCompoundPowerFlow
    ...
    @property
    def gear_set_duty_cycle_rating(self) -> '_369.ConicalGearSetDutyCycleRating':
    ...
    @property
    def conical_gear_set_duty_cycle_rating(self) -> '_369.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_369.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearSetDutyCycleRating) if self.wrapped.ConicalGearSetDutyCycleRating else None
