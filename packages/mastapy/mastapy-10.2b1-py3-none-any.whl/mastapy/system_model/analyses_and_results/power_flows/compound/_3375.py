...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3363
...
class BevelGearSetCompoundPowerFlow(_3363.AGMAGleasonConicalGearSetCompoundPowerFlow):
    '''BevelGearSetCompoundPowerFlow
