...
class ConicalGearCompoundPowerFlow(_3182.GearCompoundPowerFlow):
    '''ConicalGearCompoundPowerFlow
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_543.ConicalGearDutyCycleRating':
    ...
    @property
    def conical_gear_duty_cycle_rating(self) -> '_543.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_543.ConicalGearDutyCycleRating)(self.wrapped.ConicalGearDutyCycleRating) if self.wrapped.ConicalGearDutyCycleRating else None
