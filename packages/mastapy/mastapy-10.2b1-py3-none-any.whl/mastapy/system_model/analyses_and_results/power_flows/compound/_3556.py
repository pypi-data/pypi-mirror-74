...
class WormGearCompoundPowerFlow(_3537.GearCompoundPowerFlow):
    '''WormGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4207.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4207.WormGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_4207.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_4207.WormGearPowerFlow))
        return value
