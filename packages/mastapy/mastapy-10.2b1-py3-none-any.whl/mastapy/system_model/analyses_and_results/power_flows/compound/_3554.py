...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3550
...
class StraightBevelPlanetGearCompoundPowerFlow(_3550.StraightBevelDiffGearCompoundPowerFlow):
    '''StraightBevelPlanetGearCompoundPowerFlow
