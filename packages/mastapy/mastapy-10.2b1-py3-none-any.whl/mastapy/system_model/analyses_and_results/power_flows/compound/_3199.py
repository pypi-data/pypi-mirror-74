...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3195
...
class StraightBevelPlanetGearCompoundPowerFlow(_3195.StraightBevelDiffGearCompoundPowerFlow):
    '''StraightBevelPlanetGearCompoundPowerFlow
