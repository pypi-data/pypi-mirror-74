...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3177
...
class KlingelnbergCycloPalloidConicalGearCompoundPowerFlow(_3177.ConicalGearCompoundPowerFlow):
    '''KlingelnbergCycloPalloidConicalGearCompoundPowerFlow
