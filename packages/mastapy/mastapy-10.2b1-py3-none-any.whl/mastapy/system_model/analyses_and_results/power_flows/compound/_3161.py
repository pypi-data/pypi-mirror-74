...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3140
...
class SpecialisedAssemblyCompoundPowerFlow(_3140.AbstractAssemblyCompoundPowerFlow):
    '''SpecialisedAssemblyCompoundPowerFlow
