...
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _2065, _2058, _2056, _4922
)
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.power_flows.compound import _3505
...
class RootAssemblyCompoundPowerFlow(_3505.AssemblyCompoundPowerFlow):
    '''RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load(self) -> '_2065.AbstractStaticLoadCaseGroup':
        ...
        return constructor.new(_2065.AbstractStaticLoadCaseGroup)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None

    @property
    def compound_static_load_of_type_duty_cycle(self) -> '_2058.DutyCycle':
        ...
        return constructor.new(_2058.DutyCycle)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None

    @property
    def compound_static_load_of_type_design_state(self) -> '_2056.DesignState':
        ...
        return constructor.new(_2056.DesignState)(self.wrapped.CompoundStaticLoad) if self.wrapped.CompoundStaticLoad else None
