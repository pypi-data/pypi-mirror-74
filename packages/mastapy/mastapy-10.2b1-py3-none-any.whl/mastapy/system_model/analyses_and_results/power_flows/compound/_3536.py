...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3534
...
class CylindricalPlanetGearCompoundPowerFlow(_3534.CylindricalGearCompoundPowerFlow):
    '''CylindricalPlanetGearCompoundPowerFlow
