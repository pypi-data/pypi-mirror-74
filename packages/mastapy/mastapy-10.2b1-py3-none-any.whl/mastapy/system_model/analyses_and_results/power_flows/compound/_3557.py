...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3556, _3609, _3538
...
class WormGearSetCompoundPowerFlow(_3538.GearSetCompoundPowerFlow):
    '''WormGearSetCompoundPowerFlow
    ...
    def worm_gear_set_duty_cycle_rating(self) -> '_366.WormGearSetDutyCycleRating':
        ...
        return constructor.new(_366.WormGearSetDutyCycleRating)(self.wrapped.WormGearSetDutyCycleRating) if self.wrapped.WormGearSetDutyCycleRating else None
    ...
    @property
    def worm_gears_compound_power_flow(self) -> 'List[_3556.WormGearCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsCompoundPowerFlow, constructor.new(_3556.WormGearCompoundPowerFlow))
        return value

    @property
    def worm_meshes_compound_power_flow(self) -> 'List[_3609.WormGearMeshCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesCompoundPowerFlow, constructor.new(_3609.WormGearMeshCompoundPowerFlow))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_4090.WormGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4090.WormGearSetPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_4090.WormGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_4090.WormGearSetPowerFlow))
        return value
