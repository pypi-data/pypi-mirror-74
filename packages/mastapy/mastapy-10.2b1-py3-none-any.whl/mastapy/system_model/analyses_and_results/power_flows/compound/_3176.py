...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3170
...
class BevelGearSetCompoundPowerFlow(_3170.AGMAGleasonConicalGearSetCompoundPowerFlow):
    '''BevelGearSetCompoundPowerFlow
