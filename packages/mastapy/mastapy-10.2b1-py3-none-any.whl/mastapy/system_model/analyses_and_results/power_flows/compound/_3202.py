...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3201, _3254, _3183
...
class WormGearSetCompoundPowerFlow(_3183.GearSetCompoundPowerFlow):
    '''WormGearSetCompoundPowerFlow
    ...
    @property
    def gear_set_duty_cycle_rating(self) -> '_356.WormGearSetDutyCycleRating':
    ...
    @property
    def worm_gear_set_duty_cycle_rating(self) -> '_356.WormGearSetDutyCycleRating':
        ...
        return constructor.new(_356.WormGearSetDutyCycleRating)(self.wrapped.WormGearSetDutyCycleRating) if self.wrapped.WormGearSetDutyCycleRating else None
    ...
    @property
    def worm_gears_compound_power_flow(self) -> 'List[_3201.WormGearCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsCompoundPowerFlow, constructor.new(_3201.WormGearCompoundPowerFlow))
        return value

    @property
    def worm_meshes_compound_power_flow(self) -> 'List[_3254.WormGearMeshCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesCompoundPowerFlow, constructor.new(_3254.WormGearMeshCompoundPowerFlow))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_4119.WormGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4119.WormGearSetPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_4119.WormGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_4119.WormGearSetPowerFlow))
        return value
