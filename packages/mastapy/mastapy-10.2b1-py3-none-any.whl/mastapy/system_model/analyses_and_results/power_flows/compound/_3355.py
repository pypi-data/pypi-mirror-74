...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3343
...
class BevelGearCompoundPowerFlow(_3343.AGMAGleasonConicalGearCompoundPowerFlow):
    '''BevelGearCompoundPowerFlow
