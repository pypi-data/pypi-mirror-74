...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3183
...
class ConicalGearSetCompoundPowerFlow(_3183.GearSetCompoundPowerFlow):
    '''ConicalGearSetCompoundPowerFlow
    ...
    @property
    def gear_set_duty_cycle_rating(self) -> '_359.ConicalGearSetDutyCycleRating':
    ...
    @property
    def conical_gear_set_duty_cycle_rating(self) -> '_359.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_359.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearSetDutyCycleRating) if self.wrapped.ConicalGearSetDutyCycleRating else None
