...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3535
...
class PlanetaryGearSetCompoundPowerFlow(_3535.CylindricalGearSetCompoundPowerFlow):
    '''PlanetaryGearSetCompoundPowerFlow
