...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3228
...
class CVTBeltConnectionCompoundPowerFlow(_3228.BeltConnectionCompoundPowerFlow):
    '''CVTBeltConnectionCompoundPowerFlow
