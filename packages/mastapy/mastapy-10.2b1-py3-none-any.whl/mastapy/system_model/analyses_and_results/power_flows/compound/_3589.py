...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3585
...
class ShaftToMountableComponentConnectionCompoundPowerFlow(_3585.ConnectionCompoundPowerFlow):
    '''ShaftToMountableComponentConnectionCompoundPowerFlow
