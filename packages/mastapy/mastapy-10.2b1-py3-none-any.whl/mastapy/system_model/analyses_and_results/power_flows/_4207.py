...
from mastapy.system_model.analyses_and_results.power_flows import _4206, _4157, _4211
...
class BevelDifferentialGearSetPowerFlow(_4211.BevelGearSetPowerFlow):
    '''BevelDifferentialGearSetPowerFlow
    ...
    @property
    def bevel_differential_gears_power_flow(self) -> 'List[_4206.BevelDifferentialGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsPowerFlow, constructor.new(_4206.BevelDifferentialGearPowerFlow))
        return value

    @property
    def bevel_differential_meshes_power_flow(self) -> 'List[_4157.BevelDifferentialGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesPowerFlow, constructor.new(_4157.BevelDifferentialGearMeshPowerFlow))
        return value
