...
class PartPowerFlow(_6515.PartStaticLoadAnalysisCase):
    '''PartPowerFlow
    ...
    @property
    def twod_drawing_showing_power_flow(self) -> '_6525.SMTBitmap':
        ...
        return constructor.new(_6525.SMTBitmap)(self.wrapped.TwoDDrawingShowingPowerFlow) if self.wrapped.TwoDDrawingShowingPowerFlow else None
    ...
    @property
    def power_flow(self) -> '_3316.PowerFlow':
        ...
        return constructor.new(_3316.PowerFlow)(self.wrapped.PowerFlow) if self.wrapped.PowerFlow else None
