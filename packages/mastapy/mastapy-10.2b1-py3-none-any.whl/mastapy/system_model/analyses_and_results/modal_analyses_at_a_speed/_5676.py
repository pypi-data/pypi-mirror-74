...
_CONICAL_GEAR_MODAL_ANALYSIS_AT_A_SPEED = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtASpeed', 'ConicalGearModalAnalysisAtASpeed')
...
class ConicalGearModalAnalysisAtASpeed(_5697.GearModalAnalysisAtASpeed):
    '''ConicalGearModalAnalysisAtASpeed
    ...
    def __init__(self, instance_to_wrap: 'ConicalGearModalAnalysisAtASpeed.TYPE'):
    ...
    @property
    def planetaries(self) -> 'List[ConicalGearModalAnalysisAtASpeed]':
        '''List[ConicalGearModalAnalysisAtASpeed]: 'Planetaries' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearModalAnalysisAtASpeed))
        return value
