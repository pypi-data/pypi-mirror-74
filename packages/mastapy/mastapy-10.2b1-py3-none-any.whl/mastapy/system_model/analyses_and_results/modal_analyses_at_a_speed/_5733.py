...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5645
from mastapy._internal.python_net import python_net_import

_SPECIALISED_ASSEMBLY_MODAL_ANALYSIS_AT_A_SPEED = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtASpeed', 'SpecialisedAssemblyModalAnalysisAtASpeed')
...
class SpecialisedAssemblyModalAnalysisAtASpeed(_5645.AbstractAssemblyModalAnalysisAtASpeed):
    '''SpecialisedAssemblyModalAnalysisAtASpeed
    ...
    def __init__(self, instance_to_wrap: 'SpecialisedAssemblyModalAnalysisAtASpeed.TYPE'):
