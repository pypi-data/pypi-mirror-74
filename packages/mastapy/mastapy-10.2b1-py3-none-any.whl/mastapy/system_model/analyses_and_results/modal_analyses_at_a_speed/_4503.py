...
_CONICAL_GEAR_MESH_MODAL_ANALYSIS_AT_A_SPEED = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtASpeed', 'ConicalGearMeshModalAnalysisAtASpeed')
...
class ConicalGearMeshModalAnalysisAtASpeed(_4524.GearMeshModalAnalysisAtASpeed):
    '''ConicalGearMeshModalAnalysisAtASpeed
    ...
    def __init__(self, instance_to_wrap: 'ConicalGearMeshModalAnalysisAtASpeed.TYPE'):
    ...
    @property
    def planetaries(self) -> 'List[ConicalGearMeshModalAnalysisAtASpeed]':
        '''List[ConicalGearMeshModalAnalysisAtASpeed]: 'Planetaries' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearMeshModalAnalysisAtASpeed))
        return value
