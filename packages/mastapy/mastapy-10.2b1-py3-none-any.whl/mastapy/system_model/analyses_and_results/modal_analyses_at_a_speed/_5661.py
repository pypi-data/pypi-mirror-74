...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5649
from mastapy._internal.python_net import python_net_import

_BEVEL_GEAR_SET_MODAL_ANALYSIS_AT_A_SPEED = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtASpeed', 'BevelGearSetModalAnalysisAtASpeed')
...
class BevelGearSetModalAnalysisAtASpeed(_5649.AGMAGleasonConicalGearSetModalAnalysisAtASpeed):
    '''BevelGearSetModalAnalysisAtASpeed
    ...
    def __init__(self, instance_to_wrap: 'BevelGearSetModalAnalysisAtASpeed.TYPE'):
