...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4677
...
class CVTPulleyCompoundModalAnalysisAtASpeed(_4677.PulleyCompoundModalAnalysisAtASpeed):
    '''CVTPulleyCompoundModalAnalysisAtASpeed
