...
_AGMA_GLEASON_CONICAL_GEAR_MESH_MODAL_ANALYSIS_AT_A_SPEED = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtASpeed', 'AGMAGleasonConicalGearMeshModalAnalysisAtASpeed')
...
class AGMAGleasonConicalGearMeshModalAnalysisAtASpeed(_5675.ConicalGearMeshModalAnalysisAtASpeed):
    '''AGMAGleasonConicalGearMeshModalAnalysisAtASpeed
    ...
    def __init__(self, instance_to_wrap: 'AGMAGleasonConicalGearMeshModalAnalysisAtASpeed.TYPE'):
