...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6039
...
class ExcelBatchDutyCycleCreator(_0.APIBase):
    '''ExcelBatchDutyCycleCreator
    ...
    @property
    def batch_details(self) -> '_6039.ExcelBatchDutyCycleSpectraCreatorDetails':
        ...
        return constructor.new(_6039.ExcelBatchDutyCycleSpectraCreatorDetails)(self.wrapped.BatchDetails) if self.wrapped.BatchDetails else None
