...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3984
...
class ShaftModalAnalysesAtSpeeds(_3984.AbstractShaftOrHousingModalAnalysesAtSpeeds):
    '''ShaftModalAnalysesAtSpeeds
