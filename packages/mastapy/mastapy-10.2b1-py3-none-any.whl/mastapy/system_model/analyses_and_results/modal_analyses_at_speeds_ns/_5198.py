...
ConicalGearModalAnalysesAtSpeeds
'''
...
_CONICAL_GEAR_MODAL_ANALYSES_AT_SPEEDS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtSpeedsNS', 'ConicalGearModalAnalysesAtSpeeds')


__docformat__ = 'restructuredtext en'
__all__ = ('ConicalGearModalAnalysesAtSpeeds',)


class ConicalGearModalAnalysesAtSpeeds(_5220.GearModalAnalysesAtSpeeds):
    '''ConicalGearModalAnalysesAtSpeeds

    This is a mastapy class.
    '''

    TYPE = _CONICAL_GEAR_MODAL_ANALYSES_AT_SPEEDS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'ConicalGearModalAnalysesAtSpeeds.TYPE'):
    ...
    @property
    def planetaries(self) -> 'List[ConicalGearModalAnalysesAtSpeeds]':
        '''List[ConicalGearModalAnalysesAtSpeeds]: 'Planetaries' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearModalAnalysesAtSpeeds))
        return value
