...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _5368
...
class CVTPulleyCompoundModalAnalysesAtSpeeds(_5368.PulleyCompoundModalAnalysesAtSpeeds):
    '''CVTPulleyCompoundModalAnalysesAtSpeeds
