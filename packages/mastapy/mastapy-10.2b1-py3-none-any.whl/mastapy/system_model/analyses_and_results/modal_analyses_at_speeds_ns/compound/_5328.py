...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _5297
...
class CVTCompoundModalAnalysesAtSpeeds(_5297.BeltDriveCompoundModalAnalysesAtSpeeds):
    '''CVTCompoundModalAnalysesAtSpeeds
