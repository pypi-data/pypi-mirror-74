...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _5294
...
class RootAssemblyCompoundModalAnalysesAtSpeeds(_5294.AssemblyCompoundModalAnalysesAtSpeeds):
    '''RootAssemblyCompoundModalAnalysesAtSpeeds
