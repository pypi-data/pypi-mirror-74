...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5174
...
class BeltConnectionCompoundModalAnalysesAtSpeeds(_5348.InterMountableComponentConnectionCompoundModalAnalysesAtSpeeds):
    '''BeltConnectionCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5174.BeltConnectionModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5174.BeltConnectionModalAnalysesAtSpeeds))
        return value

    @property
    def connection_modal_analyses_at_speeds_load_cases(self) -> 'List[_5174.BeltConnectionModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtSpeedsLoadCases, constructor.new(_5174.BeltConnectionModalAnalysesAtSpeeds))
        return value
