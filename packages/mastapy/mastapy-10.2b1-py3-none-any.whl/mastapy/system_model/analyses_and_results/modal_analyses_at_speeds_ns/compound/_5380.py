...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5263
...
class SpringDamperCompoundModalAnalysesAtSpeeds(_5324.CouplingCompoundModalAnalysesAtSpeeds):
    '''SpringDamperCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5263.SpringDamperModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5263.SpringDamperModalAnalysesAtSpeeds))
        return value

    @property
    def assembly_modal_analyses_at_speeds_load_cases(self) -> 'List[_5263.SpringDamperModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysesAtSpeedsLoadCases, constructor.new(_5263.SpringDamperModalAnalysesAtSpeeds))
        return value
