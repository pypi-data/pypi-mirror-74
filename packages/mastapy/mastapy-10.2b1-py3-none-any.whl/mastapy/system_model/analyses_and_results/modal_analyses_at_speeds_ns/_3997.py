...
BevelGearMeshModalAnalysesAtSpeeds
'''
...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3985
from mastapy._internal.python_net import python_net_import

_BEVEL_GEAR_MESH_MODAL_ANALYSES_AT_SPEEDS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtSpeedsNS', 'BevelGearMeshModalAnalysesAtSpeeds')


__docformat__ = 'restructuredtext en'
__all__ = ('BevelGearMeshModalAnalysesAtSpeeds',)


class BevelGearMeshModalAnalysesAtSpeeds(_3985.AGMAGleasonConicalGearMeshModalAnalysesAtSpeeds):
    '''BevelGearMeshModalAnalysesAtSpeeds

    This is a mastapy class.
    '''

    TYPE = _BEVEL_GEAR_MESH_MODAL_ANALYSES_AT_SPEEDS

    __hash__ = None

    def __init__(self, instance_to_wrap: 'BevelGearMeshModalAnalysesAtSpeeds.TYPE'):
