...
_PART_MODAL_ANALYSES_AT_SPEEDS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtSpeedsNS', 'PartModalAnalysesAtSpeeds')


__docformat__ = 'restructuredtext en'
__all__ = ('PartModalAnalysesAtSpeeds',)


class PartModalAnalysesAtSpeeds(_4455.PartStaticLoadAnalysisCase):
    '''PartModalAnalysesAtSpeeds

    This is a mastapy class.
    '''

    TYPE = _PART_MODAL_ANALYSES_AT_SPEEDS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'PartModalAnalysesAtSpeeds.TYPE'):
