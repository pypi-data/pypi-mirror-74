...
_GEAR_MESH_MODAL_ANALYSES_AT_SPEEDS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtSpeedsNS', 'GearMeshModalAnalysesAtSpeeds')


__docformat__ = 'restructuredtext en'
__all__ = ('GearMeshModalAnalysesAtSpeeds',)


class GearMeshModalAnalysesAtSpeeds(_5227.InterMountableComponentConnectionModalAnalysesAtSpeeds):
    '''GearMeshModalAnalysesAtSpeeds

    This is a mastapy class.
    '''

    TYPE = _GEAR_MESH_MODAL_ANALYSES_AT_SPEEDS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'GearMeshModalAnalysesAtSpeeds.TYPE'):
