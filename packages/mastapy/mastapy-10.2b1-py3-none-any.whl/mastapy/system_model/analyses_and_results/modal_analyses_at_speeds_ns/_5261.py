...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5202
...
class SpringDamperConnectionModalAnalysesAtSpeeds(_5202.CouplingConnectionModalAnalysesAtSpeeds):
    '''SpringDamperConnectionModalAnalysesAtSpeeds
