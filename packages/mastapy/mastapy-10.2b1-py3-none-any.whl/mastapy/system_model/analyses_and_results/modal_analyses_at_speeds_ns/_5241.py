...
MountableComponentModalAnalysesAtSpeeds
'''
...
_MOUNTABLE_COMPONENT_MODAL_ANALYSES_AT_SPEEDS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtSpeedsNS', 'MountableComponentModalAnalysesAtSpeeds')


__docformat__ = 'restructuredtext en'
__all__ = ('MountableComponentModalAnalysesAtSpeeds',)


class MountableComponentModalAnalysesAtSpeeds(_5190.ComponentModalAnalysesAtSpeeds):
    '''MountableComponentModalAnalysesAtSpeeds

    This is a mastapy class.
    '''

    TYPE = _MOUNTABLE_COMPONENT_MODAL_ANALYSES_AT_SPEEDS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'MountableComponentModalAnalysesAtSpeeds.TYPE'):
