...
ConnectorModalAnalysesAtSpeeds
'''
...
_CONNECTOR_MODAL_ANALYSES_AT_SPEEDS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtSpeedsNS', 'ConnectorModalAnalysesAtSpeeds')


__docformat__ = 'restructuredtext en'
__all__ = ('ConnectorModalAnalysesAtSpeeds',)


class ConnectorModalAnalysesAtSpeeds(_5241.MountableComponentModalAnalysesAtSpeeds):
    '''ConnectorModalAnalysesAtSpeeds

    This is a mastapy class.
    '''

    TYPE = _CONNECTOR_MODAL_ANALYSES_AT_SPEEDS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'ConnectorModalAnalysesAtSpeeds.TYPE'):
