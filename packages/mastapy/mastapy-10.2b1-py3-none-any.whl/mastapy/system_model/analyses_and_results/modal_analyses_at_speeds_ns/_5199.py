...
ConicalGearSetModalAnalysesAtSpeeds
'''
...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5221
from mastapy._internal.python_net import python_net_import

_CONICAL_GEAR_SET_MODAL_ANALYSES_AT_SPEEDS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtSpeedsNS', 'ConicalGearSetModalAnalysesAtSpeeds')


__docformat__ = 'restructuredtext en'
__all__ = ('ConicalGearSetModalAnalysesAtSpeeds',)


class ConicalGearSetModalAnalysesAtSpeeds(_5221.GearSetModalAnalysesAtSpeeds):
    '''ConicalGearSetModalAnalysesAtSpeeds

    This is a mastapy class.
    '''

    TYPE = _CONICAL_GEAR_SET_MODAL_ANALYSES_AT_SPEEDS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'ConicalGearSetModalAnalysesAtSpeeds.TYPE'):
