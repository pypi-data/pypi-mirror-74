...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4088, _4087, _3999
...
class StraightBevelGearSetModalAnalysesAtSpeeds(_3999.BevelGearSetModalAnalysesAtSpeeds):
    '''StraightBevelGearSetModalAnalysesAtSpeeds
    ...
    @property
    def straight_bevel_gears_modal_analyses_at_speeds(self) -> 'List[_4088.StraightBevelGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysesAtSpeeds, constructor.new(_4088.StraightBevelGearModalAnalysesAtSpeeds))
        return value

    @property
    def straight_bevel_meshes_modal_analyses_at_speeds(self) -> 'List[_4087.StraightBevelGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysesAtSpeeds, constructor.new(_4087.StraightBevelGearMeshModalAnalysesAtSpeeds))
        return value
