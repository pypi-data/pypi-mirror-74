...
BevelGearSetModalAnalysesAtSpeeds
'''
...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5171
from mastapy._internal.python_net import python_net_import

_BEVEL_GEAR_SET_MODAL_ANALYSES_AT_SPEEDS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtSpeedsNS', 'BevelGearSetModalAnalysesAtSpeeds')


__docformat__ = 'restructuredtext en'
__all__ = ('BevelGearSetModalAnalysesAtSpeeds',)


class BevelGearSetModalAnalysesAtSpeeds(_5171.AGMAGleasonConicalGearSetModalAnalysesAtSpeeds):
    '''BevelGearSetModalAnalysesAtSpeeds

    This is a mastapy class.
    '''

    TYPE = _BEVEL_GEAR_SET_MODAL_ANALYSES_AT_SPEEDS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'BevelGearSetModalAnalysesAtSpeeds.TYPE'):
