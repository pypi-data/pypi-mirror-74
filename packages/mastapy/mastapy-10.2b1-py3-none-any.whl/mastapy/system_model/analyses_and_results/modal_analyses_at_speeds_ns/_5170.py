...
AGMAGleasonConicalGearModalAnalysesAtSpeeds
'''
...
_AGMA_GLEASON_CONICAL_GEAR_MODAL_ANALYSES_AT_SPEEDS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtSpeedsNS', 'AGMAGleasonConicalGearModalAnalysesAtSpeeds')


__docformat__ = 'restructuredtext en'
__all__ = ('AGMAGleasonConicalGearModalAnalysesAtSpeeds',)


class AGMAGleasonConicalGearModalAnalysesAtSpeeds(_5198.ConicalGearModalAnalysesAtSpeeds):
    '''AGMAGleasonConicalGearModalAnalysesAtSpeeds

    This is a mastapy class.
    '''

    TYPE = _AGMA_GLEASON_CONICAL_GEAR_MODAL_ANALYSES_AT_SPEEDS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'AGMAGleasonConicalGearModalAnalysesAtSpeeds.TYPE'):
