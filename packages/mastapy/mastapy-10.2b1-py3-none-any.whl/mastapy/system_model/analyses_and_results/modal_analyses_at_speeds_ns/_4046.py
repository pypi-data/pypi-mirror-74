...
KlingelnbergCycloPalloidConicalGearSetModalAnalysesAtSpeeds
'''
...
_KLINGELNBERG_CYCLO_PALLOID_CONICAL_GEAR_SET_MODAL_ANALYSES_AT_SPEEDS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtSpeedsNS', 'KlingelnbergCycloPalloidConicalGearSetModalAnalysesAtSpeeds')


__docformat__ = 'restructuredtext en'
__all__ = ('KlingelnbergCycloPalloidConicalGearSetModalAnalysesAtSpeeds',)


class KlingelnbergCycloPalloidConicalGearSetModalAnalysesAtSpeeds(_4015.ConicalGearSetModalAnalysesAtSpeeds):
    '''KlingelnbergCycloPalloidConicalGearSetModalAnalysesAtSpeeds

    This is a mastapy class.
    '''

    TYPE = _KLINGELNBERG_CYCLO_PALLOID_CONICAL_GEAR_SET_MODAL_ANALYSES_AT_SPEEDS

    __hash__ = None

    def __init__(self, instance_to_wrap: 'KlingelnbergCycloPalloidConicalGearSetModalAnalysesAtSpeeds.TYPE'):
