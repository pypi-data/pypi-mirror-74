...
ConnectionModalAnalysesAtSpeeds
'''
...
_CONNECTION_MODAL_ANALYSES_AT_SPEEDS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtSpeedsNS', 'ConnectionModalAnalysesAtSpeeds')


__docformat__ = 'restructuredtext en'
__all__ = ('ConnectionModalAnalysesAtSpeeds',)


class ConnectionModalAnalysesAtSpeeds(_6508.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysesAtSpeeds

    This is a mastapy class.
    '''

    TYPE = _CONNECTION_MODAL_ANALYSES_AT_SPEEDS

    __hash__ = None

    def __init__(self, instance_to_wrap: 'ConnectionModalAnalysesAtSpeeds.TYPE'):
    ...
    @property
    def modal_analyses_at_speeds(self) -> '_4083.StabilityAnalysis':
        '''StabilityAnalysis: 'ModalAnalysesAtSpeeds' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return constructor.new(_4083.StabilityAnalysis)(self.wrapped.ModalAnalysesAtSpeeds) if self.wrapped.ModalAnalysesAtSpeeds else None
