...
BevelGearModalAnalysesAtSpeeds
'''
...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5170
from mastapy._internal.python_net import python_net_import

_BEVEL_GEAR_MODAL_ANALYSES_AT_SPEEDS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtSpeedsNS', 'BevelGearModalAnalysesAtSpeeds')


__docformat__ = 'restructuredtext en'
__all__ = ('BevelGearModalAnalysesAtSpeeds',)


class BevelGearModalAnalysesAtSpeeds(_5170.AGMAGleasonConicalGearModalAnalysesAtSpeeds):
    '''BevelGearModalAnalysesAtSpeeds

    This is a mastapy class.
    '''

    TYPE = _BEVEL_GEAR_MODAL_ANALYSES_AT_SPEEDS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'BevelGearModalAnalysesAtSpeeds.TYPE'):
