...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5168
...
class ImportedFEComponentModalAnalysesAtSpeeds(_5168.AbstractShaftOrHousingModalAnalysesAtSpeeds):
    '''ImportedFEComponentModalAnalysesAtSpeeds
