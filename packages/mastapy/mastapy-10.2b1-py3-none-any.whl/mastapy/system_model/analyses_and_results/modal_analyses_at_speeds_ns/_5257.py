...
SpecialisedAssemblyModalAnalysesAtSpeeds
'''
...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5167
from mastapy._internal.python_net import python_net_import

_SPECIALISED_ASSEMBLY_MODAL_ANALYSES_AT_SPEEDS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtSpeedsNS', 'SpecialisedAssemblyModalAnalysesAtSpeeds')


__docformat__ = 'restructuredtext en'
__all__ = ('SpecialisedAssemblyModalAnalysesAtSpeeds',)


class SpecialisedAssemblyModalAnalysesAtSpeeds(_5167.AbstractAssemblyModalAnalysesAtSpeeds):
    '''SpecialisedAssemblyModalAnalysesAtSpeeds

    This is a mastapy class.
    '''

    TYPE = _SPECIALISED_ASSEMBLY_MODAL_ANALYSES_AT_SPEEDS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'SpecialisedAssemblyModalAnalysesAtSpeeds.TYPE'):
