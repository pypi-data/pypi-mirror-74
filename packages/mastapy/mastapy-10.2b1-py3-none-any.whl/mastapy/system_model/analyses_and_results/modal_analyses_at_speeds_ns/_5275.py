...
SynchroniserPartModalAnalysesAtSpeeds
'''
...
_SYNCHRONISER_PART_MODAL_ANALYSES_AT_SPEEDS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtSpeedsNS', 'SynchroniserPartModalAnalysesAtSpeeds')


__docformat__ = 'restructuredtext en'
__all__ = ('SynchroniserPartModalAnalysesAtSpeeds',)


class SynchroniserPartModalAnalysesAtSpeeds(_5203.CouplingHalfModalAnalysesAtSpeeds):
    '''SynchroniserPartModalAnalysesAtSpeeds

    This is a mastapy class.
    '''

    TYPE = _SYNCHRONISER_PART_MODAL_ANALYSES_AT_SPEEDS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'SynchroniserPartModalAnalysesAtSpeeds.TYPE'):
