...
CouplingHalfModalAnalysesAtSpeeds
'''
...
_COUPLING_HALF_MODAL_ANALYSES_AT_SPEEDS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtSpeedsNS', 'CouplingHalfModalAnalysesAtSpeeds')


__docformat__ = 'restructuredtext en'
__all__ = ('CouplingHalfModalAnalysesAtSpeeds',)


class CouplingHalfModalAnalysesAtSpeeds(_5241.MountableComponentModalAnalysesAtSpeeds):
    '''CouplingHalfModalAnalysesAtSpeeds

    This is a mastapy class.
    '''

    TYPE = _COUPLING_HALF_MODAL_ANALYSES_AT_SPEEDS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'CouplingHalfModalAnalysesAtSpeeds.TYPE'):
