...
_GEAR_MODAL_ANALYSES_AT_SPEEDS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtSpeedsNS', 'GearModalAnalysesAtSpeeds')


__docformat__ = 'restructuredtext en'
__all__ = ('GearModalAnalysesAtSpeeds',)


class GearModalAnalysesAtSpeeds(_5241.MountableComponentModalAnalysesAtSpeeds):
    '''GearModalAnalysesAtSpeeds

    This is a mastapy class.
    '''

    TYPE = _GEAR_MODAL_ANALYSES_AT_SPEEDS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'GearModalAnalysesAtSpeeds.TYPE'):
