...
AGMAGleasonConicalGearSetModalAnalysesAtSpeeds
'''
...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _5199
from mastapy._internal.python_net import python_net_import

_AGMA_GLEASON_CONICAL_GEAR_SET_MODAL_ANALYSES_AT_SPEEDS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalysesAtSpeedsNS', 'AGMAGleasonConicalGearSetModalAnalysesAtSpeeds')


__docformat__ = 'restructuredtext en'
__all__ = ('AGMAGleasonConicalGearSetModalAnalysesAtSpeeds',)


class AGMAGleasonConicalGearSetModalAnalysesAtSpeeds(_5199.ConicalGearSetModalAnalysesAtSpeeds):
    '''AGMAGleasonConicalGearSetModalAnalysesAtSpeeds

    This is a mastapy class.
    '''

    TYPE = _AGMA_GLEASON_CONICAL_GEAR_SET_MODAL_ANALYSES_AT_SPEEDS
    __hash__ = None

    def __init__(self, instance_to_wrap: 'AGMAGleasonConicalGearSetModalAnalysesAtSpeeds.TYPE'):
