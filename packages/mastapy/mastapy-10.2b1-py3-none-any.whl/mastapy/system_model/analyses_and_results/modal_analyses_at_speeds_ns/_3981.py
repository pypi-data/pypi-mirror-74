...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3969
...
class BevelGearSetModalAnalysesAtSpeeds(_3969.AGMAGleasonConicalGearSetModalAnalysesAtSpeeds):
    '''BevelGearSetModalAnalysesAtSpeeds
