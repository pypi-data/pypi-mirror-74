...
class SteadyStateSynchronousResponseOptions(_1.APIBase):
    '''SteadyStateSynchronousResponseOptions
    ...
    def include_unbalanced_effects(self) -> 'bool':
        ...
        return self.wrapped.IncludeUnbalancedEffects
    ...
    def include_disk_skew_effects(self) -> 'bool':
        ...
        return self.wrapped.IncludeDiskSkewEffects
    ...
    def include_shaft_bow_effects(self) -> 'bool':
        ...
        return self.wrapped.IncludeShaftBowEffects
