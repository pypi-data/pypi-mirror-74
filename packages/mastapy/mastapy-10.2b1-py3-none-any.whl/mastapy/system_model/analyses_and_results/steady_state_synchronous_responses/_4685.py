...
class ConicalGearSteadyStateSynchronousResponse(_4707.GearSteadyStateSynchronousResponse):
    '''ConicalGearSteadyStateSynchronousResponse
    ...
    def planetaries(self) -> 'List[ConicalGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearSteadyStateSynchronousResponse))
        return value
