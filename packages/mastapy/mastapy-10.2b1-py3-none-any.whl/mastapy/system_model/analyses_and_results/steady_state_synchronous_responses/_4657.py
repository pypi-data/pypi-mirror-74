...
_AGMA_GLEASON_CONICAL_GEAR_STEADY_STATE_SYNCHRONOUS_RESPONSE = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.SteadyStateSynchronousResponses', 'AGMAGleasonConicalGearSteadyStateSynchronousResponse')
...
class AGMAGleasonConicalGearSteadyStateSynchronousResponse(_4685.ConicalGearSteadyStateSynchronousResponse):
    '''AGMAGleasonConicalGearSteadyStateSynchronousResponse
    ...
    def __init__(self, instance_to_wrap: 'AGMAGleasonConicalGearSteadyStateSynchronousResponse.TYPE'):
