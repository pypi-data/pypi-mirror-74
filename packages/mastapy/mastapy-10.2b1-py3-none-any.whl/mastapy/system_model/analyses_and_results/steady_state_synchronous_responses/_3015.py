...
class ConnectionSteadyStateSynchronousResponse(_6508.ConnectionStaticLoadAnalysisCase):
    '''ConnectionSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_3080.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3080.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponse) if self.wrapped.SteadyStateSynchronousResponse else None
