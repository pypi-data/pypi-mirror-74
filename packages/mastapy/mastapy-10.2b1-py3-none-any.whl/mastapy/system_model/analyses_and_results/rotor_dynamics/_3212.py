...
from mastapy.utility.units_and_measurements.measurements import _1206, _1160
...
class ShaftForcedComplexShape(_3211.ShaftComplexShape['_1206.LengthVeryShort', '_1160.AngleSmall']):
    '''ShaftForcedComplexShape
