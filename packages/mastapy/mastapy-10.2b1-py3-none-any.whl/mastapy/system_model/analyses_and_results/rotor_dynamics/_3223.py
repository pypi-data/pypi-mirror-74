...
from mastapy.system_model.analyses_and_results.rotor_dynamics import _3221
...
class ShaftModalComplexShape(_3221.ShaftComplexShape['_1223.Number', 'SMT.MastaAPI.Utility.UnitsAndMeasurements.Measurements.Number']):
    '''ShaftModalComplexShape
