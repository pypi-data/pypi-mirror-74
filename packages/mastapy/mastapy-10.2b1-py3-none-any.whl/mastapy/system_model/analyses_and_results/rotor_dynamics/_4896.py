...
from mastapy.utility.units_and_measurements.measurements import _1072
...
class ShaftModalComplexShape(_4894.ShaftComplexShape['_1072.Number', 'SMT.MastaAPI.Utility.UnitsAndMeasurements.Measurements.Number']):
    '''ShaftModalComplexShape
