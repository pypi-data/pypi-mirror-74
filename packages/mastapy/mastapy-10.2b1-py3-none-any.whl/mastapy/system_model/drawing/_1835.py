...
from mastapy.system_model.drawing import _1837, _1836
...
class ContourDrawStyle(_112.DrawStyleBase):
    ...
    def deflection_scaling(self) -> '_1837.ScalingDrawStyle':
        ...
        return constructor.new(_1837.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1836.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1836.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
