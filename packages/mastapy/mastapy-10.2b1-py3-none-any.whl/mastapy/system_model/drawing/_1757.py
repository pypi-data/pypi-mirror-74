...
from mastapy.system_model.analyses_and_results.system_deflections import _2067
...
class ShaftDeflectionDrawingNodeItem(_1.APIBase):
    '''ShaftDeflectionDrawingNodeItem
    ...
    @property
    def node_detail(self) -> '_106.ForceAndDisplacementResults':
        ...
        return constructor.new(_106.ForceAndDisplacementResults)(self.wrapped.NodeDetail) if self.wrapped.NodeDetail else None

    @property
    def section_to_the_left_side(self) -> '_2067.ShaftSectionSystemDeflection':
        ...
        return constructor.new(_2067.ShaftSectionSystemDeflection)(self.wrapped.SectionToTheLeftSide) if self.wrapped.SectionToTheLeftSide else None

    @property
    def section_to_the_right_side(self) -> '_2067.ShaftSectionSystemDeflection':
        ...
        return constructor.new(_2067.ShaftSectionSystemDeflection)(self.wrapped.SectionToTheRightSide) if self.wrapped.SectionToTheRightSide else None
