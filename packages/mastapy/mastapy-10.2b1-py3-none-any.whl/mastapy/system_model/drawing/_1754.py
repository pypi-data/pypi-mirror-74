...
from mastapy.system_model.drawing import _1756, _1755
from mastapy.geometry import _282
...
class ContourDrawStyle(_282.DrawStyleBase):
    '''ContourDrawStyle
    ...
    @property
    def contour(self) -> '_1443.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1443.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1443.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1756.ScalingDrawStyle':
        ...
        return constructor.new(_1756.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1755.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1755.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
