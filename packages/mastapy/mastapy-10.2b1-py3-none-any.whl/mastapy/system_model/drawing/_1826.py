...
from mastapy.system_model.drawing import _1828, _1827
from mastapy.geometry import _112
...
class ContourDrawStyle(_112.DrawStyleBase):
    '''ContourDrawStyle
    ...
    @property
    def contour(self) -> '_1337.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1337.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1337.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1828.ScalingDrawStyle':
        ...
        return constructor.new(_1828.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1827.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1827.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
