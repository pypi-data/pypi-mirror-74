...
from mastapy.utility_gui import _1503
from mastapy import _3, _6522, _0
...
from mastapy.system_model.part_model import (
    _2033, _2030, _2032, _2026,
    _1995, _1996, _1997, _2000,
    _2002, _2003, _2004, _2007,
    _2008, _2011, _2012, _2013,
    _2016, _2020, _2021, _2022,
    _2024, _2027, _2029, _2034,
    _2035, _2036
)
from mastapy.gears import _124, _130
from mastapy.gears.materials import _383
from mastapy.utility import _1137, _1136, _1135
from mastapy.system_model import _1826, _1825
from mastapy.shafts import _34
from mastapy.detailed_rigid_connectors.splines import _977
from mastapy._math.vector_3d import Vector3D
from mastapy.system_model.part_model.gears import (
    _2068, _2089, _2069, _2070,
...
from mastapy.bearings.bearing_results.rolling import _1603
from mastapy.system_model.part_model.configurations import _2164, _2162, _2165
...
from mastapy.system_model.database_access import _1846
from mastapy.bearings.bearing_designs.rolling import _1773
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2495
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self) -> '_1503.MASTAGUI':
        ...
        return constructor.new(_1503.MASTAGUI)(self.wrapped.MastaGUI) if self.wrapped.MastaGUI else None
    ...
    @property
    def file_save_details_most_recent(self) -> '_1137.FileHistoryItem':
        ...
        return constructor.new(_1137.FileHistoryItem)(self.wrapped.FileSaveDetailsMostRecent) if self.wrapped.FileSaveDetailsMostRecent else None

    @property
    def default_system_temperatures(self) -> '_1826.TransmissionTemperatureSet':
        ...
        return constructor.new(_1826.TransmissionTemperatureSet)(self.wrapped.DefaultSystemTemperatures) if self.wrapped.DefaultSystemTemperatures else None
    ...
    @property
    def detailed_spline_settings(self) -> '_977.DetailedSplineJointSettings':
        ...
        return constructor.new(_977.DetailedSplineJointSettings)(self.wrapped.DetailedSplineSettings) if self.wrapped.DetailedSplineSettings else None
    ...
    @property
    def file_save_details_all(self) -> '_1136.FileHistory':
        ...
        return constructor.new(_1136.FileHistory)(self.wrapped.FileSaveDetailsAll) if self.wrapped.FileSaveDetailsAll else None
    ...
    @property
    def selected_gear_set_selection_group(self) -> '_2068.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_2068.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None

    @property
    def system(self) -> '_1825.SystemReporting':
        ...
        return constructor.new(_1825.SystemReporting)(self.wrapped.System) if self.wrapped.System else None

    @property
    def fe_batch_operations(self) -> '_1929.BatchOperations':
        ...
        return constructor.new(_1929.BatchOperations)(self.wrapped.FEBatchOperations) if self.wrapped.FEBatchOperations else None

    @property
    def iso14179_settings_per_bearing_type(self) -> 'List[_1603.ISO14179SettingsPerBearingType]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISO14179SettingsPerBearingType, constructor.new(_1603.ISO14179SettingsPerBearingType))
        return value

    @property
    def gear_set_configurations(self) -> 'List[_2068.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_2068.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_2164.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2164.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def imported_fe_configurations(self) -> 'List[_2162.ActiveImportedFESelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEConfigurations, constructor.new(_2162.ActiveImportedFESelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2165.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2165.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_5254.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5254.DesignState))
        return value
    ...
    @property
    def duty_cycles(self) -> 'List[_5255.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_5255.DutyCycle))
        return value

    @property
    def root_assembly(self) -> '_2032.RootAssembly':
        ...
        return constructor.new(_2032.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly else None

    @property
    def gear_set_config(self) -> '_2089.GearSetConfiguration':
        '''GearSetConfiguration: 'GearSetConfig' is the original name of this property.'''

        return constructor.new(_2089.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig else None

    @gear_set_config.setter
    def gear_set_config(self, value: '_2089.GearSetConfiguration'):
    ...
    @property
    def databases(self) -> '_1846.Databases':
        ...
        return constructor.new(_1846.Databases)(self.wrapped.Databases) if self.wrapped.Databases else None
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_1773.RollingBearing'):
    ...
    def design_state_named(self, name: 'str') -> '_5254.DesignState':
        ...
        return constructor.new(_5254.DesignState)(method_result) if method_result else None

    def duty_cycle_named(self, name: 'str') -> '_5255.DutyCycle':
        ...
        return constructor.new(_5255.DutyCycle)(method_result) if method_result else None
    ...
    def save(self, file_name: 'str', save_results: 'bool') -> '_1317.Status':
        ...
        return constructor.new(_1317.Status)(method_result) if method_result else None

    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_6522.TaskProgress') -> '_1317.Status':
        ''' 'Save' is the original name of this method.
    ...
    def remove_synchroniser_shift(self, shift: '_2495.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2495.SynchroniserShift':
        ...
        return constructor.new(_2495.SynchroniserShift)(method_result) if method_result else None

    def add_synchroniser_shift_empty(self) -> '_2495.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5254.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5255.DutyCycle':
    ...
    def all_parts_of_type_assembly(self) -> 'List[_1995.Assembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1995.Assembly.TYPE](), constructor.new(_1995.Assembly))
    ...
    @staticmethod
    def load(file_path: 'str', load_full_fe_option: Optional['_1135.ExternalFullFEFileOption'] = _1135.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS) -> 'Design':
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.1, pulley_b_diameter: Optional['float'] = 0.1, name: Optional['str'] = 'Belt Drive') -> '_2124.BeltCreationOptions':
        ...
        return constructor.new(_2124.BeltCreationOptions)(method_result) if method_result else None

    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.1) -> '_2126.PlanetCarrierCreationOptions':
        ...
        return constructor.new(_2126.PlanetCarrierCreationOptions)(method_result) if method_result else None

    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.0, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2127.ShaftCreationOptions':
        ...
        return constructor.new(_2127.ShaftCreationOptions)(method_result) if method_result else None
    ...
    def new_cylindrical_gear_pair_creation_options(self) -> '_883.CylindricalGearPairCreationOptions':
        ...
        return constructor.new(_883.CylindricalGearPairCreationOptions)(method_result) if method_result else None

    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2125.CylindricalGearLinearTrainCreationOptions':
        ...
        return constructor.new(_2125.CylindricalGearLinearTrainCreationOptions)(method_result) if method_result else None
    ...
    def new_spiral_bevel_gear_set_creation_options(self) -> '_886.SpiralBevelGearSetCreationOptions':
        ...
        return constructor.new(_886.SpiralBevelGearSetCreationOptions)(method_result) if method_result else None
    ...
    def new_hypoid_gear_set_creation_options(self) -> '_885.HypoidGearSetCreationOptions':
        ...
        return constructor.new(_885.HypoidGearSetCreationOptions)(method_result) if method_result else None

    def new_nodal_matrix(self, dense_matrix: 'List[List[float]]') -> '_1390.NodalMatrix':
        ...
        return constructor.new(_1390.NodalMatrix)(method_result) if method_result else None
