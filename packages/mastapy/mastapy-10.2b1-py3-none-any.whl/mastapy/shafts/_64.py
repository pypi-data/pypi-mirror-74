...
from mastapy.shafts import _63, _44
...
class ShaftSurfaceFinishSection(_44.ShaftFeature):
    '''ShaftSurfaceFinishSection
    ...
    @property
    def surface_roughness(self) -> '_63.ShaftSurfaceRoughness':
        ...
        return constructor.new(_63.ShaftSurfaceRoughness)(self.wrapped.SurfaceRoughness) if self.wrapped.SurfaceRoughness else None
