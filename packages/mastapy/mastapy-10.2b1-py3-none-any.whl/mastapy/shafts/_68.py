...
class SimpleShaftDefinition(_89.NamedDatabaseItem):
    '''SimpleShaftDefinition
    ...
    @property
    def shaft_material(self) -> '_50.ShaftMaterial':
        ...
        return constructor.new(_50.ShaftMaterial)(self.wrapped.ShaftMaterial) if self.wrapped.ShaftMaterial else None

    @property
    def default_surface_roughness(self) -> '_67.ShaftSurfaceRoughness':
        ...
        return constructor.new(_67.ShaftSurfaceRoughness)(self.wrapped.DefaultSurfaceRoughness) if self.wrapped.DefaultSurfaceRoughness else None

    @property
    def outer_profile(self) -> '_55.ShaftProfile':
        ...
        return constructor.new(_55.ShaftProfile)(self.wrapped.OuterProfile) if self.wrapped.OuterProfile else None

    @property
    def inner_profile(self) -> '_55.ShaftProfile':
        ...
        return constructor.new(_55.ShaftProfile)(self.wrapped.InnerProfile) if self.wrapped.InnerProfile else None

    @property
    def design_shaft_sections(self) -> 'List[_11.DesignShaftSection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignShaftSections, constructor.new(_11.DesignShaftSection))
        return value

    @property
    def radial_holes(self) -> 'List[_58.ShaftRadialHole]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RadialHoles, constructor.new(_58.ShaftRadialHole))
        return value

    @property
    def grooves(self) -> 'List[_48.ShaftGroove]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Grooves, constructor.new(_48.ShaftGroove))
        return value

    @property
    def surface_finish_sections(self) -> 'List[_66.ShaftSurfaceFinishSection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SurfaceFinishSections, constructor.new(_66.ShaftSurfaceFinishSection))
        return value

    @property
    def generic_stress_concentration_factors(self) -> 'List[_37.GenericStressConcentrationFactor]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GenericStressConcentrationFactors, constructor.new(_37.GenericStressConcentrationFactor))
        return value
