...
class ShaftMaterial(_64.Material):
    '''ShaftMaterial
    ...
    @property
    def hardening_type_for_agma60016101e08(self) -> '_7.AGMAHardeningType':
        ...
        return constructor.new(_7.AGMAHardeningType)(value) if value else None

    @hardening_type_for_agma60016101e08.setter
    def hardening_type_for_agma60016101e08(self, value: '_7.AGMAHardeningType'):
    ...
    @property
    def curve_model(self) -> '_35.FkmSnCurveModel':
        '''FkmSnCurveModel: 'CurveModel' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.CurveModel)
        return constructor.new(_35.FkmSnCurveModel)(value) if value else None

    @curve_model.setter
    def curve_model(self, value: '_35.FkmSnCurveModel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def material_group(self) -> '_34.FkmMaterialGroup':
        ...
        return constructor.new(_34.FkmMaterialGroup)(value) if value else None

    @material_group.setter
    def material_group(self, value: '_34.FkmMaterialGroup'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def constant_rsubpmaxsub(self) -> 'overridable.Overridable_float':
        '''overridable.Overridable_float: 'ConstantRsubpmaxsub' is the original name of this property.'''

        return constructor.new(overridable.Overridable_float)(self.wrapped.ConstantRsubpmaxsub) if self.wrapped.ConstantRsubpmaxsub else None

    @constant_rsubpmaxsub.setter
    def constant_rsubpmaxsub(self, value: 'overridable.Overridable_float.implicit_type()'):
        wrapper_type = overridable.Overridable_float.TYPE
        enclosed_type = overridable.Overridable_float.implicit_type()
        value = wrapper_type[enclosed_type](enclosed_type(value) if value else 0.0)
        self.wrapped.ConstantRsubpmaxsub = value
    ...
    @property
    def consequence_of_failure(self) -> '_10.ConsequenceOfFailure':
        ...
        return constructor.new(_10.ConsequenceOfFailure)(value) if value else None

    @consequence_of_failure.setter
    def consequence_of_failure(self, value: '_10.ConsequenceOfFailure'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def casting_factor_condition(self) -> '_9.CastingFactorCondition':
        ...
        return constructor.new(_9.CastingFactorCondition)(value) if value else None

    @casting_factor_condition.setter
    def casting_factor_condition(self, value: '_9.CastingFactorCondition'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
