...
from mastapy.shafts import _65, _47
...
class ShaftKey(_47.ShaftFeature):
    '''ShaftKey
    ...
    @property
    def surface_finish(self) -> '_65.SurfaceFinishes':
        ...
        return constructor.new(_65.SurfaceFinishes)(value) if value else None

    @surface_finish.setter
    def surface_finish(self, value: '_65.SurfaceFinishes'):
