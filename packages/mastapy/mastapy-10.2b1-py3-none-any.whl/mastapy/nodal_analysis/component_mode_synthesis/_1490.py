...
from mastapy.nodal_analysis.dev_tools_analyses import _1452
...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_1067.DataPrecision':
        ...
        return constructor.new(_1067.DataPrecision)(value) if value else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_1067.DataPrecision'):
    ...
    @property
    def internal_mode_options(self) -> '_1452.EigenvalueOptions':
        ...
        return constructor.new(_1452.EigenvalueOptions)(self.wrapped.InternalModeOptions) if self.wrapped.InternalModeOptions else None
