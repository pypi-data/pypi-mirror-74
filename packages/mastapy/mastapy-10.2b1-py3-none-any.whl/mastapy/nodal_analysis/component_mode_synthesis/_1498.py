...
from mastapy.nodal_analysis.dev_tools_analyses import _1463
from mastapy.nodal_analysis.component_mode_synthesis import _1496, _1493
...
class FullFEModel(_0.APIBase):
    ...
    @property
    def fe_model(self) -> '_1463.FEModel':
        ...
        return constructor.new(_1463.FEModel)(self.wrapped.FEModel) if self.wrapped.FEModel else None

    @property
    def reduction_options(self) -> '_1496.CMSOptions':
        ...
        return constructor.new(_1496.CMSOptions)(self.wrapped.ReductionOptions) if self.wrapped.ReductionOptions else None

    @property
    def element_face_groups(self) -> 'List[_1493.CMSElementFaceGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1493.CMSElementFaceGroup))
        return value
