...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _265
...
class ElementPropertiesShell(_210.ElementPropertiesWithMaterial):
    '''ElementPropertiesShell
    ...
    @property
    def wall_type(self) -> '_265.ElementPropertiesShellWallType':
        ...
        return constructor.new(_265.ElementPropertiesShellWallType)(value) if value else None
