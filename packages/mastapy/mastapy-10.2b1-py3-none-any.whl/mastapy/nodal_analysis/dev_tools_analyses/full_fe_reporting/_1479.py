...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1476
...
class ElementPropertiesMass(_1476.ElementPropertiesBase):
    '''ElementPropertiesMass
    ...
    @property
    def inertia(self) -> '_1076.InertiaTensor':
        ...
        return constructor.new(_1076.InertiaTensor)(self.wrapped.Inertia) if self.wrapped.Inertia else None
