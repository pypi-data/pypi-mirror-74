...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1481
...
class RigidElementNodeDegreesOfFreedom(_0.APIBase):
    ...
    @property
    def type_(self) -> '_1481.DegreeOfFreedomType':
        ...
        return constructor.new(_1481.DegreeOfFreedomType)(value) if value else None
