...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _268, _269
...
class ContactPairReporting(_1.APIBase):
    ...
    @property
    def master_type(self) -> '_268.ContactPairMasterType':
        ...
        return constructor.new(_268.ContactPairMasterType)(value) if value else None

    @property
    def slave_type(self) -> '_269.ContactPairSlaveType':
        ...
        return constructor.new(_269.ContactPairSlaveType)(value) if value else None
