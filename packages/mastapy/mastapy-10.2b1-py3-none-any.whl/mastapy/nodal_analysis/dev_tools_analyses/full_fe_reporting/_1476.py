...
from mastapy.fe_tools.enums import _968
...
class ElementPropertiesBase(_0.APIBase):
    ...
    @property
    def class_(self) -> '_968.ElementPropertyClass':
        ...
        return constructor.new(_968.ElementPropertyClass)(value) if value else None
