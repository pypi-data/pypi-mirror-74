...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1492, _1482
...
class ElementPropertiesRigid(_1482.ElementPropertiesBase):
    ...
    @property
    def degrees_of_freedom_list(self) -> 'List[_1492.RigidElementNodeDegreesOfFreedom]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedomList, constructor.new(_1492.RigidElementNodeDegreesOfFreedom))
        return value
