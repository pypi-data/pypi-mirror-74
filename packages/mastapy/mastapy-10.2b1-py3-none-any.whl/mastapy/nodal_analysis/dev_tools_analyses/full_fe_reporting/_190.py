...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _225
...
class ElementPropertiesBeam(_210.ElementPropertiesWithMaterial):
    '''ElementPropertiesBeam
    ...
    @property
    def section_type(self) -> '_225.BeamSectionType':
        ...
        return constructor.new(_225.BeamSectionType)(value) if value else None
