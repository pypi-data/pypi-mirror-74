...
from mastapy.fe_tools.enums import _218
...
class MaterialPropertiesReporting(_1.APIBase):
    ...
    @property
    def class_(self) -> '_218.MaterialPropertyClass':
        ...
        return constructor.new(_218.MaterialPropertyClass)(value) if value else None
