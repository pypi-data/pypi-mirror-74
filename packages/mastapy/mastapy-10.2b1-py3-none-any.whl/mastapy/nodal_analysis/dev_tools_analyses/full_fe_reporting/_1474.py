...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _966, _965
...
class ContactPairReporting(_0.APIBase):
    ...
    @property
    def reference_surface_type(self) -> '_966.ContactPairReferenceSurfaceType':
        ...
        return constructor.new(_966.ContactPairReferenceSurfaceType)(value) if value else None

    @property
    def constrained_surface_type(self) -> '_965.ContactPairConstrainedSurfaceType':
        ...
        return constructor.new(_965.ContactPairConstrainedSurfaceType)(value) if value else None
