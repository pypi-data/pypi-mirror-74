...
class RigidElementNodeDegreesOfFreedom(_1.APIBase):
    '''RigidElementNodeDegreesOfFreedom
    ...
    @property
    def type_(self) -> '_208.DegreeOfFreedomType':
        ...
        return constructor.new(_208.DegreeOfFreedomType)(value) if value else None
