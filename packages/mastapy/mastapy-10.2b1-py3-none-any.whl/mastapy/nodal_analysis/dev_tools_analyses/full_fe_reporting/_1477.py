...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _964
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1484
...
class ElementPropertiesBeam(_1484.ElementPropertiesWithMaterial):
    '''ElementPropertiesBeam
    ...
    @property
    def section_type(self) -> '_964.BeamSectionType':
        ...
        return constructor.new(_964.BeamSectionType)(value) if value else None
