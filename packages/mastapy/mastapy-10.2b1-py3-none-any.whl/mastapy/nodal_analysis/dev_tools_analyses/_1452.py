...
from mastapy.nodal_analysis.dev_tools_analyses import _1470
...
class EigenvalueOptions(_0.APIBase):
    ...
    @property
    def mass_matrix_type(self) -> '_1470.MassMatrixType':
        ...
        return constructor.new(_1470.MassMatrixType)(value) if value else None

    @mass_matrix_type.setter
    def mass_matrix_type(self, value: '_1470.MassMatrixType'):
