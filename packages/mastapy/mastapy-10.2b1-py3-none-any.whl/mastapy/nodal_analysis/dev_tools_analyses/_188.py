...
class FEModelTabDrawStyle(_1.APIBase):
    ...
    @property
    def draw_style(self) -> '_175.DrawStyleForImportedFE':
        ...
        return constructor.new(_175.DrawStyleForImportedFE)(self.wrapped.DrawStyle) if self.wrapped.DrawStyle else None
