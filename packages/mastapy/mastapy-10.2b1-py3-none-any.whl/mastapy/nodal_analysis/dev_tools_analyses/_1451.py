...
from mastapy.nodal_analysis import _1368
...
class DrawStyleForImportedFE(_0.APIBase):
    '''DrawStyleForImportedFE
    ...
    @property
    def line_option(self) -> '_1368.FEMeshElementEntityOption':
        ...
        return constructor.new(_1368.FEMeshElementEntityOption)(value) if value else None

    @line_option.setter
    def line_option(self, value: '_1368.FEMeshElementEntityOption'):
