...
from mastapy.nodal_analysis import _1366
...
class Bar(_1445.NodalComponent):
    '''Bar
    ...
    @property
    def bar_geometry(self) -> '_1366.BarGeometry':
        ...
        return constructor.new(_1366.BarGeometry)(self.wrapped.BarGeometry) if self.wrapped.BarGeometry else None
