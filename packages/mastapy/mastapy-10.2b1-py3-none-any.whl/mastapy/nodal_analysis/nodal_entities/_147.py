...
from mastapy.nodal_analysis.nodal_entities import _163
...
class Bar(_163.NodalComponent):
    ...
    @property
    def bar_geometry(self) -> '_73.BarGeometry':
        ...
        return constructor.new(_73.BarGeometry)(self.wrapped.BarGeometry) if self.wrapped.BarGeometry else None
