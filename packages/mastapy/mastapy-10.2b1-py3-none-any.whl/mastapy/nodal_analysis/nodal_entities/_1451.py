...
from mastapy.math_utility.stiffness_calculators import _1096
from mastapy._internal import constructor
from mastapy.nodal_analysis.nodal_entities import _1429
...
class SurfaceToSurfaceContactStiffnessEntity(_1429.ArbitraryNodalComponent):
    '''SurfaceToSurfaceContactStiffnessEntity
    ...
    @property
    def contact(self) -> '_1096.SurfaceToSurfaceContact':
        ...
        return constructor.new(_1096.SurfaceToSurfaceContact)(self.wrapped.Contact) if self.wrapped.Contact else None
