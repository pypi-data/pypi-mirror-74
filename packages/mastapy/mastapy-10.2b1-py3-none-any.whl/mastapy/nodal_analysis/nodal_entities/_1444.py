...
class LineContactStiffnessEntity(_1429.ArbitraryNodalComponent):
    '''LineContactStiffnessEntity
    ...
    @property
    def stiffness_in_local_coordinate_system(self) -> '_1390.NodalMatrix':
        ...
        return constructor.new(_1390.NodalMatrix)(self.wrapped.StiffnessInLocalCoordinateSystem) if self.wrapped.StiffnessInLocalCoordinateSystem else None
