...
from mastapy.nodal_analysis.system_solvers import _141
...
class SingularValuesAnalysis(_1.APIBase):
    '''SingularValuesAnalysis
    ...
    @property
    def smallest_singular_vectors(self) -> 'List[_141.SingularVectorAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SmallestSingularVectors, constructor.new(_141.SingularVectorAnalysis))
        return value

    @property
    def largest_singular_vectors(self) -> 'List[_141.SingularVectorAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LargestSingularVectors, constructor.new(_141.SingularVectorAnalysis))
        return value
