...
from mastapy.nodal_analysis.system_solvers import _139
...
class SingularVectorAnalysis(_1.APIBase):
    '''SingularVectorAnalysis
    ...
    @property
    def largest_singular_vector_components(self) -> 'List[_139.SingularDegreeOfFreedomAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LargestSingularVectorComponents, constructor.new(_139.SingularDegreeOfFreedomAnalysis))
        return value
