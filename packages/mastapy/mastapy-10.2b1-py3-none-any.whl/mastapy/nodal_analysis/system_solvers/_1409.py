...
from mastapy.nodal_analysis.system_solvers import _1419
...
class BackwardEulerAccelerationStepHalvingTransientSolver(_1419.SimpleAccelerationBasedStepHalvingTransientSolver):
    '''BackwardEulerAccelerationStepHalvingTransientSolver
