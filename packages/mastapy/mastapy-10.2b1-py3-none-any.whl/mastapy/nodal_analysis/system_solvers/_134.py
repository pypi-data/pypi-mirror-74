...
from mastapy.nodal_analysis import _116
from mastapy.nodal_analysis.system_solvers import _129
...
class TransientSolver(_129.DynamicSolver):
    '''TransientSolver
    ...
    @property
    def solver_status(self) -> '_116.TransientSolverStatus':
        ...
        return constructor.new(_116.TransientSolverStatus)(value) if value else None

    @solver_status.setter
    def solver_status(self, value: '_116.TransientSolverStatus'):
