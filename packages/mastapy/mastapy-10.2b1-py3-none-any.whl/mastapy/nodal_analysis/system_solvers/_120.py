...
from mastapy.nodal_analysis.system_solvers import _136
...
class BackwardEulerAccelerationStepHalvingTransientSolver(_136.SimpleAccelerationBasedStepHalvingTransientSolver):
    '''BackwardEulerAccelerationStepHalvingTransientSolver
