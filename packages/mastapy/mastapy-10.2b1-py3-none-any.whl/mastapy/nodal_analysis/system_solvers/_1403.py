...
from mastapy.nodal_analysis.system_solvers import _1413
...
class BackwardEulerAccelerationStepHalvingTransientSolver(_1413.SimpleAccelerationBasedStepHalvingTransientSolver):
    '''BackwardEulerAccelerationStepHalvingTransientSolver
