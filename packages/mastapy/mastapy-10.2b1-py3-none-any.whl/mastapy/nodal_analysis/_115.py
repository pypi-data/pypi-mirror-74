...
class TransientSolverOptions(_1.APIBase):
    '''TransientSolverOptions
    ...
    def integration_method(self) -> 'enum_with_selected_value.EnumWithSelectedValue_IntegrationMethod':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_IntegrationMethod)(self.wrapped.IntegrationMethod) if self.wrapped.IntegrationMethod else None

    @integration_method.setter
    def integration_method(self, value: 'enum_with_selected_value.EnumWithSelectedValue_IntegrationMethod.implicit_type()'):
        wrapper_type = enum_with_selected_value.EnumWithSelectedValue_IntegrationMethod.TYPE
    ...
    @property
    def solver_tolerance_input_method(self) -> '_117.TransientSolverToleranceInputMethod':
        ...
        return constructor.new(_117.TransientSolverToleranceInputMethod)(value) if value else None

    @solver_tolerance_input_method.setter
    def solver_tolerance_input_method(self, value: '_117.TransientSolverToleranceInputMethod'):
    ...
    @property
    def damping_scaling_for_initial_transients(self) -> '_81.DampingScalingTypeForInitialTransients':
        ...
        return constructor.new(_81.DampingScalingTypeForInitialTransients)(value) if value else None

    @damping_scaling_for_initial_transients.setter
    def damping_scaling_for_initial_transients(self, value: '_81.DampingScalingTypeForInitialTransients'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def result_logging_frequency(self) -> '_112.ResultLoggingFrequency':
        ...
        return constructor.new(_112.ResultLoggingFrequency)(value) if value else None

    @result_logging_frequency.setter
    def result_logging_frequency(self, value: '_112.ResultLoggingFrequency'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
