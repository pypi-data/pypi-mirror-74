...
class CylindricalMisalignmentCalculator(_1.APIBase):
    '''CylindricalMisalignmentCalculator
    ...
    def gear_a_transverse_separations(self) -> 'List[float]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearATransverseSeparations, float)
        return value
    ...
    def gear_b_transverse_separations(self) -> 'List[float]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearBTransverseSeparations, float)
        return value
