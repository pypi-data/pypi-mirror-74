...
from mastapy.nodal_analysis import _86, _87
...
class AnalysisSettings(_78.PerMachineSettings):
    '''AnalysisSettings
    ...
    @property
    def rating_type_for_bearing_reliability(self) -> '_86.RatingTypeForBearingReliability':
        ...
        return constructor.new(_86.RatingTypeForBearingReliability)(value) if value else None

    @rating_type_for_bearing_reliability.setter
    def rating_type_for_bearing_reliability(self, value: '_86.RatingTypeForBearingReliability'):
