...
from mastapy.gears.rating.cylindrical import _275, _261
from mastapy.gears.gear_designs.cylindrical import _834, _780
from mastapy.materials import _74, _63
...
class GearSetDesignGroup(_0.APIBase):
    ...
    @property
    def misalignment_contact_pattern_enhancement(self) -> '_275.MisalignmentContactPatternEnhancements':
        ...
        return constructor.new(_275.MisalignmentContactPatternEnhancements)(value) if value else None

    @misalignment_contact_pattern_enhancement.setter
    def misalignment_contact_pattern_enhancement(self, value: '_275.MisalignmentContactPatternEnhancements'):
    ...
    @property
    def default_rough_toleranced_metal_measurement(self) -> '_834.TolerancedMetalMeasurements':
        ...
        return constructor.new(_834.TolerancedMetalMeasurements)(value) if value else None

    @default_rough_toleranced_metal_measurement.setter
    def default_rough_toleranced_metal_measurement(self, value: '_834.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def general_transmission_properties(self) -> '_63.GeneralTransmissionProperties':
        ...
        return constructor.new(_63.GeneralTransmissionProperties)(self.wrapped.GeneralTransmissionProperties) if self.wrapped.GeneralTransmissionProperties else None

    @property
    def settings(self) -> '_261.CylindricalGearRatingSettings':
        ...
        return constructor.new(_261.CylindricalGearRatingSettings)(self.wrapped.Settings) if self.wrapped.Settings else None
