...
from mastapy.gears.analysis import _1076, _351
from mastapy._internal import constructor
from mastapy.gears.gear_twod_fe_analysis import _909
from mastapy._internal.cast_exception import CastException
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1025, _1024
from mastapy.gears.load_case.worm import _889
from mastapy.gears.load_case.face import _891
from mastapy.gears.load_case.cylindrical import _893
from mastapy.gears.load_case.conical import _900
from mastapy.gears.load_case.concept import _903
from mastapy.gears.load_case.bevel import _905
from mastapy.gears.manufacturing.cylindrical import _621, _620, _616
from mastapy.gears.manufacturing.bevel import (
    _794, _796, _807, _815,
    _808
)
from mastapy.gears.ltca.cylindrical import _872
from mastapy.gears.ltca.conical import _881
...
class GearMeshDesignAnalysis(_351.AbstractGearMeshAnalysis):
    ...
    @property
    def gear_a(self) -> '_1076.GearDesignAnalysis':
    ...
    @property
    def gear_a_of_type_cylindrical_gear_tiff_analysis(self) -> '_909.CylindricalGearTIFFAnalysis':
        ...
        return constructor.new(_909.CylindricalGearTIFFAnalysis)(self.wrapped.GearA) if self.wrapped.GearA else None
    ...
    @property
    def gear_a_of_type_worm_gear_load_case(self) -> '_889.WormGearLoadCase':
        ...
        return constructor.new(_889.WormGearLoadCase)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_face_gear_load_case(self) -> '_891.FaceGearLoadCase':
        ...
        return constructor.new(_891.FaceGearLoadCase)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_cylindrical_gear_load_case(self) -> '_893.CylindricalGearLoadCase':
        ...
        return constructor.new(_893.CylindricalGearLoadCase)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_conical_gear_load_case(self) -> '_900.ConicalGearLoadCase':
        ...
        return constructor.new(_900.ConicalGearLoadCase)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_concept_gear_load_case(self) -> '_903.ConceptGearLoadCase':
        ...
        return constructor.new(_903.ConceptGearLoadCase)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_bevel_load_case(self) -> '_905.BevelLoadCase':
        ...
        return constructor.new(_905.BevelLoadCase)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_cylindrical_manufactured_gear_load_case(self) -> '_621.CylindricalManufacturedGearLoadCase':
        ...
        return constructor.new(_621.CylindricalManufacturedGearLoadCase)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_conical_gear_manufacturing_analysis(self) -> '_794.ConicalGearManufacturingAnalysis':
        ...
        return constructor.new(_794.ConicalGearManufacturingAnalysis)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_cylindrical_gear_load_distribution_analysis(self) -> '_872.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_872.CylindricalGearLoadDistributionAnalysis)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_conical_gear_load_distribution_analysis(self) -> '_881.ConicalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_881.ConicalGearLoadDistributionAnalysis)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_cylindrical_manufactured_gear_duty_cycle(self) -> '_620.CylindricalManufacturedGearDutyCycle':
        ...
        return constructor.new(_620.CylindricalManufacturedGearDutyCycle)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_cylindrical_gear_manufacturing_config(self) -> '_616.CylindricalGearManufacturingConfig':
        ...
        return constructor.new(_616.CylindricalGearManufacturingConfig)(self.wrapped.GearA) if self.wrapped.GearA else None
    ...
    @property
    def gear_a_of_type_conical_gear_micro_geometry_config(self) -> '_796.ConicalGearMicroGeometryConfig':
        ...
        return constructor.new(_796.ConicalGearMicroGeometryConfig)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_conical_pinion_manufacturing_config(self) -> '_807.ConicalPinionManufacturingConfig':
        ...
        return constructor.new(_807.ConicalPinionManufacturingConfig)(self.wrapped.GearA) if self.wrapped.GearA else None
    ...
    @property
    def gear_a_of_type_conical_pinion_micro_geometry_config(self) -> '_808.ConicalPinionMicroGeometryConfig':
        ...
        return constructor.new(_808.ConicalPinionMicroGeometryConfig)(self.wrapped.GearA) if self.wrapped.GearA else None
    ...
    @property
    def gear_b(self) -> '_1076.GearDesignAnalysis':
    ...
    @property
    def gear_b_of_type_cylindrical_gear_tiff_analysis(self) -> '_909.CylindricalGearTIFFAnalysis':
        ...
        return constructor.new(_909.CylindricalGearTIFFAnalysis)(self.wrapped.GearB) if self.wrapped.GearB else None
    ...
    @property
    def gear_b_of_type_worm_gear_load_case(self) -> '_889.WormGearLoadCase':
        ...
        return constructor.new(_889.WormGearLoadCase)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_face_gear_load_case(self) -> '_891.FaceGearLoadCase':
        ...
        return constructor.new(_891.FaceGearLoadCase)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_cylindrical_gear_load_case(self) -> '_893.CylindricalGearLoadCase':
        ...
        return constructor.new(_893.CylindricalGearLoadCase)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_conical_gear_load_case(self) -> '_900.ConicalGearLoadCase':
        ...
        return constructor.new(_900.ConicalGearLoadCase)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_concept_gear_load_case(self) -> '_903.ConceptGearLoadCase':
        ...
        return constructor.new(_903.ConceptGearLoadCase)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_bevel_load_case(self) -> '_905.BevelLoadCase':
        ...
        return constructor.new(_905.BevelLoadCase)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_cylindrical_manufactured_gear_load_case(self) -> '_621.CylindricalManufacturedGearLoadCase':
        ...
        return constructor.new(_621.CylindricalManufacturedGearLoadCase)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_conical_gear_manufacturing_analysis(self) -> '_794.ConicalGearManufacturingAnalysis':
        ...
        return constructor.new(_794.ConicalGearManufacturingAnalysis)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_cylindrical_gear_load_distribution_analysis(self) -> '_872.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_872.CylindricalGearLoadDistributionAnalysis)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_conical_gear_load_distribution_analysis(self) -> '_881.ConicalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_881.ConicalGearLoadDistributionAnalysis)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_cylindrical_manufactured_gear_duty_cycle(self) -> '_620.CylindricalManufacturedGearDutyCycle':
        ...
        return constructor.new(_620.CylindricalManufacturedGearDutyCycle)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_cylindrical_gear_manufacturing_config(self) -> '_616.CylindricalGearManufacturingConfig':
        ...
        return constructor.new(_616.CylindricalGearManufacturingConfig)(self.wrapped.GearB) if self.wrapped.GearB else None
    ...
    @property
    def gear_b_of_type_conical_gear_micro_geometry_config(self) -> '_796.ConicalGearMicroGeometryConfig':
        ...
        return constructor.new(_796.ConicalGearMicroGeometryConfig)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_conical_pinion_manufacturing_config(self) -> '_807.ConicalPinionManufacturingConfig':
        ...
        return constructor.new(_807.ConicalPinionManufacturingConfig)(self.wrapped.GearB) if self.wrapped.GearB else None
    ...
    @property
    def gear_b_of_type_conical_pinion_micro_geometry_config(self) -> '_808.ConicalPinionMicroGeometryConfig':
        ...
        return constructor.new(_808.ConicalPinionMicroGeometryConfig)(self.wrapped.GearB) if self.wrapped.GearB else None
