...
class AbstractGearMeshAnalysis(_0.APIBase):
    ...
    @property
    def gear_a(self) -> '_949.AbstractGearAnalysis':
        ...
        return constructor.new(_949.AbstractGearAnalysis)(self.wrapped.GearA) if self.wrapped.GearA else None
    ...
    @property
    def gear_a_of_type_gear_design_analysis(self) -> '_952.GearDesignAnalysis':
    ...
    @property
    def gear_b(self) -> '_949.AbstractGearAnalysis':
        ...
        return constructor.new(_949.AbstractGearAnalysis)(self.wrapped.GearB) if self.wrapped.GearB else None
    ...
    @property
    def gear_b_of_type_gear_design_analysis(self) -> '_952.GearDesignAnalysis':
