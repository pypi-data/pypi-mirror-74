...
class PlanetaryDetail(_1.APIBase):
    '''PlanetaryDetail
    ...
    @property
    def planet_delta_angles(self) -> 'List[_311.NamedPlanetAngle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetDeltaAngles, constructor.new(_311.NamedPlanetAngle))
        return value
