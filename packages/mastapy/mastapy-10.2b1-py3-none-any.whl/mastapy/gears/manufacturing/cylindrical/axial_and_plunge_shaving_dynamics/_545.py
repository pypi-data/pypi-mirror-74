...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _541, _555, _540
...
class PlungeShavingDynamicsViewModel(_555.ShavingDynamicsViewModel['_540.PlungeShaverDynamics']):
    '''PlungeShavingDynamicsViewModel
    ...
    @property
    def settings(self) -> '_541.PlungeShaverDynamicSettings':
        ...
        return constructor.new(_541.PlungeShaverDynamicSettings)(self.wrapped.Settings) if self.wrapped.Settings else None
