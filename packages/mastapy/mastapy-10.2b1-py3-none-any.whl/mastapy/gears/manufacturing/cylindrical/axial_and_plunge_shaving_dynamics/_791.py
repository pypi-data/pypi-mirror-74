...
from mastapy.gears.gear_designs.cylindrical import _867, _733
...
class ShavingDynamicsViewModel(_792.ShavingDynamicsViewModelBase, Generic[T]):
    '''ShavingDynamicsViewModel
    ...
    def selected_measurement_method(self) -> 'enum_with_selected_value.EnumWithSelectedValue_ThicknessType':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_ThicknessType)(self.wrapped.SelectedMeasurementMethod) if self.wrapped.SelectedMeasurementMethod else None
    ...
    def selected_measurement_method(self, value: 'enum_with_selected_value.EnumWithSelectedValue_ThicknessType.implicit_type()'):
        wrapper_type = enum_with_selected_value.EnumWithSelectedValue_ThicknessType.TYPE
    ...
    @property
    def chart_display_method(self) -> '_733.CylindricalGearProfileMeasurementType':
    ...
    def chart_display_method(self, value: '_733.CylindricalGearProfileMeasurementType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ChartDisplayMethod = value

    @property
    def active_profile_range_calculation_source(self) -> '_770.ActiveProfileRangeCalculationSource':
        ...
        return constructor.new(_770.ActiveProfileRangeCalculationSource)(value) if value else None

    @active_profile_range_calculation_source.setter
    def active_profile_range_calculation_source(self, value: '_770.ActiveProfileRangeCalculationSource'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def calculation(self) -> '_787.ShavingDynamicsCalculation[T]':
        ...
        return constructor.new(_787.ShavingDynamicsCalculation)[T](self.wrapped.Calculation) if self.wrapped.Calculation else None
