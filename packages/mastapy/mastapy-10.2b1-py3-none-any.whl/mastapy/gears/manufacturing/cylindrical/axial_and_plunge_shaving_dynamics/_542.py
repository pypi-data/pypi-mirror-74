...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _549, _540
...
class PlungeShaverRedressing(_549.ShaverRedressing['_540.PlungeShaverDynamics']):
    '''PlungeShaverRedressing
