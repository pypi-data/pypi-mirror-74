...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _547, _546, _550
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _489
...
class ShavingDynamicsCalculation(_0.APIBase, Generic[T]):
    ...
    @property
    def accuracy_level_iso6(self) -> '_547.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_547.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO6) if self.wrapped.AccuracyLevelISO6 else None

    @property
    def accuracy_level_iso7(self) -> '_547.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_547.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO7) if self.wrapped.AccuracyLevelISO7 else None

    @property
    def designed_gear(self) -> '_489.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_489.CylindricalCutterSimulatableGear)(self.wrapped.DesignedGear) if self.wrapped.DesignedGear else None
    ...
    @property
    def life_shaver(self) -> '_518.CylindricalGearShaver':
        ...
        return constructor.new(_518.CylindricalGearShaver)(self.wrapped.LifeShaver) if self.wrapped.LifeShaver else None

    @property
    def new_cutter_start_of_shaving(self) -> '_784.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_784.CylindricalGearProfileMeasurement)(self.wrapped.NewCutterStartOfShaving) if self.wrapped.NewCutterStartOfShaving else None

    @property
    def life_cutter_start_of_shaving(self) -> '_784.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_784.CylindricalGearProfileMeasurement)(self.wrapped.LifeCutterStartOfShaving) if self.wrapped.LifeCutterStartOfShaving else None
