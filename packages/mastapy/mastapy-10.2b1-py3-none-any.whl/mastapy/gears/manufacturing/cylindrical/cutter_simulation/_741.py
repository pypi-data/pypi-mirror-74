...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _765
...
class ShaperSimulationCalculator(_720.CutterSimulationCalc):
    '''ShaperSimulationCalculator
    ...
    @property
    def shaper(self) -> '_765.CylindricalGearShaperTangible':
        ...
        return constructor.new(_765.CylindricalGearShaperTangible)(self.wrapped.Shaper) if self.wrapped.Shaper else None
