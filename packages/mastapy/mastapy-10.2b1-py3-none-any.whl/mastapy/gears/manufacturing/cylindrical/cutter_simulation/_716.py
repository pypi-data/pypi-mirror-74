...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _670, _731
...
class CutterSimulationCalc(_1.APIBase):
    ...
    @property
    def gear(self) -> '_670.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_670.CylindricalCutterSimulatableGear)(self.wrapped.Gear) if self.wrapped.Gear else None
