...
class CylindricalGearSpecification(_1.APIBase):
    ...
    @property
    def tooth_thickness_specification(self) -> '_682.ToothThicknessSpecificationBase':
        ...
        return constructor.new(_682.ToothThicknessSpecificationBase)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None

    @property
    def tooth_thickness_specification_of_type_finish_tooth_thickness_design_specification(self) -> '_683.FinishToothThicknessDesignSpecification':
        ...
        if self.wrapped.ToothThicknessSpecification.__class__.__qualname__ != 'FinishToothThicknessDesignSpecification':
        ...
        return constructor.new(_683.FinishToothThicknessDesignSpecification)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None

    @property
    def tooth_thickness_specification_of_type_tooth_thickness_specification(self) -> '_684.ToothThicknessSpecification':
        ...
        if self.wrapped.ToothThicknessSpecification.__class__.__qualname__ != 'ToothThicknessSpecification':
        ...
        return constructor.new(_684.ToothThicknessSpecification)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None
