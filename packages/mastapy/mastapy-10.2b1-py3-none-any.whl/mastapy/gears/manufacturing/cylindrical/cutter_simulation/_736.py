...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _754
...
class HobSimulationCalculator(_737.RackSimulationCalculator):
    '''HobSimulationCalculator
    ...
    @property
    def hob(self) -> '_754.CylindricalGearHobShape':
        ...
        return constructor.new(_754.CylindricalGearHobShape)(self.wrapped.Hob) if self.wrapped.Hob else None
