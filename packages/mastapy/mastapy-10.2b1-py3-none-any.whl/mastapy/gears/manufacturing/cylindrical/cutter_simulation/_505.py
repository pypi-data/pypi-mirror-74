...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _500
...
class WormGrinderSimulationCalculator(_500.RackSimulationCalculator):
    '''WormGrinderSimulationCalculator
    ...
    @property
    def worm_grinder(self) -> '_531.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_531.CylindricalGearWormGrinderShape)(self.wrapped.WormGrinder) if self.wrapped.WormGrinder else None
