...
from mastapy.gears.manufacturing.cylindrical.cutters import _646
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _769
...
class CylindricalGearHobShape(_769.RackShape):
    '''CylindricalGearHobShape
    ...
    @property
    def design(self) -> '_646.CylindricalGearHobDesign':
        ...
        return constructor.new(_646.CylindricalGearHobDesign)(self.wrapped.Design) if self.wrapped.Design else None
