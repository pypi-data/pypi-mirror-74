...
from mastapy.geometry.twod.curves import _286
...
class MutatableCurve(_759.MutatableCommon):
    '''MutatableCurve
    ...
    def curve_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_BasicCurveTypes':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_BasicCurveTypes)(self.wrapped.CurveType) if self.wrapped.CurveType else None

    @curve_type.setter
    def curve_type(self, value: 'enum_with_selected_value.EnumWithSelectedValue_BasicCurveTypes.implicit_type()'):
        wrapper_type = enum_with_selected_value.EnumWithSelectedValue_BasicCurveTypes.TYPE
