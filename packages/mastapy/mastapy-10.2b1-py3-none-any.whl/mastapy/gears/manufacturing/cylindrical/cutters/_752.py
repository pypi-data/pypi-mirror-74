...
from mastapy.gears import _305, _326
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _767, _750, _766
from mastapy._internal.cast_exception import CastException
from mastapy.gears.manufacturing.cylindrical.cutters import _753
...
class CylindricalGearRackDesign(_753.CylindricalGearRealCutterDesign):
    '''CylindricalGearRackDesign
    ...
    @property
    def worm_type(self) -> '_326.WormType':
        '''WormType: 'WormType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.WormType)
        return constructor.new(_326.WormType)(value) if value else None

    @worm_type.setter
    def worm_type(self, value: '_326.WormType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
