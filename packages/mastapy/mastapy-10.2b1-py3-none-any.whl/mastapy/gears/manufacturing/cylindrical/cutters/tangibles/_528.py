...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _533
...
class CylindricalGearHobShape(_533.RackShape):
    '''CylindricalGearHobShape
    ...
    @property
    def design(self) -> '_512.CylindricalGearHobDesign':
