...
from mastapy.gears.manufacturing.cylindrical.cutters import _745
...
class MutatableCommon(_745.CurveInLinkedList):
    '''MutatableCommon
    ...
    def section(self) -> 'enum_with_selected_value.EnumWithSelectedValue_CutterFlankSections':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_CutterFlankSections)(self.wrapped.Section) if self.wrapped.Section else None

    @section.setter
    def section(self, value: 'enum_with_selected_value.EnumWithSelectedValue_CutterFlankSections.implicit_type()'):
        wrapper_type = enum_with_selected_value.EnumWithSelectedValue_CutterFlankSections.TYPE
