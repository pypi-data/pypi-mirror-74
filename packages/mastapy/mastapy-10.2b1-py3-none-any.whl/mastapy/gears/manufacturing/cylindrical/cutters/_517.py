...
from mastapy.gears.manufacturing.cylindrical.cutters import _521
...
class CylindricalGearShaper(_521.InvoluteCutterDesign):
    '''CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self) -> '_827.ShaperEdgeTypes':
        ...
        return constructor.new(_827.ShaperEdgeTypes)(value) if value else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_827.ShaperEdgeTypes'):
