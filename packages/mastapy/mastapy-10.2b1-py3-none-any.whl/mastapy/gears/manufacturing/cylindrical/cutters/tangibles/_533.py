...
from mastapy.gears.manufacturing.cylindrical.cutters import _515, _511, _512
...
class RackShape(_526.CutterShapeDefinition):
    '''RackShape
    ...
    @property
    def design(self) -> '_515.CylindricalGearRackDesign':
