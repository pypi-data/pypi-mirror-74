...
class CylindricalGearPlungeShaver(_751.CylindricalGearShaver):
    '''CylindricalGearPlungeShaver
    ...
    def right_flank_micro_geometry(self) -> '_610.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_610.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.RightFlankMicroGeometry) if self.wrapped.RightFlankMicroGeometry else None
    ...
    def left_flank_micro_geometry(self) -> '_610.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_610.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.LeftFlankMicroGeometry) if self.wrapped.LeftFlankMicroGeometry else None
    ...
    def micro_geometry(self) -> 'List[_610.CylindricalGearSpecifiedMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometry, constructor.new(_610.CylindricalGearSpecifiedMicroGeometry))
        return value
