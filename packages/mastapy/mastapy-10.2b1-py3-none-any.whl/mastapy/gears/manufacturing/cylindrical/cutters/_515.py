...
from mastapy.gears import _135, _153
from mastapy._internal.implicit import overridable
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _533, _528, _531
...
class CylindricalGearRackDesign(_516.CylindricalGearRealCutterDesign):
    '''CylindricalGearRackDesign
    ...
    @property
    def worm_type(self) -> '_153.WormType':
        '''WormType: 'WormType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.WormType)
        return constructor.new(_153.WormType)(value) if value else None

    @worm_type.setter
    def worm_type(self, value: '_153.WormType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
