...
from mastapy.gears.manufacturing.cylindrical.cutters import _755, _750, _663
...
class RackShape(_762.CutterShapeDefinition):
    '''RackShape
    ...
    @property
    def design(self) -> '_755.CylindricalGearRackDesign':
        ...
        return constructor.new(_755.CylindricalGearRackDesign)(self.wrapped.Design) if self.wrapped.Design else None
