...
from mastapy.gears.manufacturing.cylindrical import _416
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _528, _533, _531
...
class CylindricalGearHobDesign(_515.CylindricalGearRackDesign):
    '''CylindricalGearHobDesign
    ...
    @property
    def hob_edge_type(self) -> '_416.HobEdgeTypes':
        '''HobEdgeTypes: 'HobEdgeType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HobEdgeType)
        return constructor.new(_416.HobEdgeTypes)(value) if value else None

    @hob_edge_type.setter
    def hob_edge_type(self, value: '_416.HobEdgeTypes'):
    ...
    @property
    def nominal_hob_shape(self) -> '_528.CylindricalGearHobShape':
        ...
        return constructor.new(_528.CylindricalGearHobShape)(self.wrapped.NominalHobShape) if self.wrapped.NominalHobShape else None
    ...
    @property
    def maximum_hob_material_shape(self) -> '_528.CylindricalGearHobShape':
        ...
        return constructor.new(_528.CylindricalGearHobShape)(self.wrapped.MaximumHobMaterialShape) if self.wrapped.MaximumHobMaterialShape else None

    @property
    def minimum_hob_material_shape(self) -> '_528.CylindricalGearHobShape':
        ...
        return constructor.new(_528.CylindricalGearHobShape)(self.wrapped.MinimumHobMaterialShape) if self.wrapped.MinimumHobMaterialShape else None
