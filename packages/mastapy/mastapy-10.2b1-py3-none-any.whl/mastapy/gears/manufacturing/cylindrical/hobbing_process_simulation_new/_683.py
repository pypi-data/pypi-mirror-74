...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _661, _679
...
class HobbingProcessPitchCalculation(_679.HobbingProcessCalculation):
    '''HobbingProcessPitchCalculation
