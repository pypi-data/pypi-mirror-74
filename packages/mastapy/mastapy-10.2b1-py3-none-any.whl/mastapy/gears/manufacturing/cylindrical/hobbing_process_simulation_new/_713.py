...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _702
...
class WormGrindingProcessMarkOnShaft(_702.WormGrindingProcessCalculation):
    '''WormGrindingProcessMarkOnShaft
