...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _661, _701
...
class WormGrindingProcessPitchCalculation(_701.WormGrindingProcessCalculation):
    '''WormGrindingProcessPitchCalculation
    ...
    @property
    def right_flank(self) -> '_661.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_661.CalculatePitchDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_661.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_661.CalculatePitchDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
