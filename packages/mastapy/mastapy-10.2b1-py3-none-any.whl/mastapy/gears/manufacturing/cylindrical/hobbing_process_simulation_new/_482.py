...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _446, _479
...
class WormGrindingProcessPitchCalculation(_479.WormGrindingProcessCalculation):
    '''WormGrindingProcessPitchCalculation
    ...
    @property
    def right_flank(self) -> '_446.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_446.CalculatePitchDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_446.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_446.CalculatePitchDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
