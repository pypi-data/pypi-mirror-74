...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _710
...
class WormGrindingCutterCalculation(_710.WormGrindingProcessCalculation):
    '''WormGrindingCutterCalculation
