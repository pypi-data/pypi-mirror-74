...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _660, _679
...
class HobbingProcessLeadCalculation(_679.HobbingProcessCalculation):
    '''HobbingProcessLeadCalculation
