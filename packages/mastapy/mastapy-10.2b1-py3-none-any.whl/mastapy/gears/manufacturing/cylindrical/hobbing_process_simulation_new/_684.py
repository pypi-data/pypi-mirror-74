...
from mastapy.gears.gear_designs.cylindrical import _749
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _662, _679
...
class HobbingProcessProfileCalculation(_679.HobbingProcessCalculation):
    '''HobbingProcessProfileCalculation
    ...
    @property
    def chart_display_method(self) -> '_749.CylindricalGearProfileMeasurementType':
    ...
    def chart_display_method(self, value: '_749.CylindricalGearProfileMeasurementType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ChartDisplayMethod = value

    @property
    def right_flank(self) -> '_662.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_662.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_662.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_662.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
