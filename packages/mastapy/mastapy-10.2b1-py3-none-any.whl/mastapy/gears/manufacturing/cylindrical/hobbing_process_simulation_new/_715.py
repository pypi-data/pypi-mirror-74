...
from mastapy.gears.gear_designs.cylindrical import _729
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _669, _702
...
class WormGrindingProcessProfileCalculation(_702.WormGrindingProcessCalculation):
    '''WormGrindingProcessProfileCalculation
    ...
    @property
    def chart_display_method(self) -> '_729.CylindricalGearProfileMeasurementType':
        ...
        return constructor.new(_729.CylindricalGearProfileMeasurementType)(value) if value else None

    @chart_display_method.setter
    def chart_display_method(self, value: '_729.CylindricalGearProfileMeasurementType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ChartDisplayMethod = value

    @property
    def right_flank(self) -> '_669.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_669.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_669.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_669.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
