...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _668, _702
...
class WormGrindingProcessPitchCalculation(_702.WormGrindingProcessCalculation):
    '''WormGrindingProcessPitchCalculation
    ...
    @property
    def right_flank(self) -> '_668.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_668.CalculatePitchDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_668.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_668.CalculatePitchDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
