...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _447, _451
...
class HobbingProcessProfileCalculation(_451.HobbingProcessCalculation):
    '''HobbingProcessProfileCalculation
