...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _661, _667
...
class HobbingProcessPitchCalculation(_667.HobbingProcessCalculation):
    '''HobbingProcessPitchCalculation
