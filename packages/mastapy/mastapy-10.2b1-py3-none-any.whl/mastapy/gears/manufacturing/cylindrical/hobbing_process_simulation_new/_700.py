...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _660, _701
...
class WormGrindingLeadCalculation(_701.WormGrindingProcessCalculation):
    '''WormGrindingLeadCalculation
