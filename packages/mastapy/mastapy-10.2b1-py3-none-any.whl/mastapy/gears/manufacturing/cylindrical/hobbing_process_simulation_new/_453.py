...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _445, _451
...
class HobbingProcessLeadCalculation(_451.HobbingProcessCalculation):
    '''HobbingProcessLeadCalculation
