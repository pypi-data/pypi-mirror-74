...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _662, _667
...
class HobbingProcessProfileCalculation(_667.HobbingProcessCalculation):
    '''HobbingProcessProfileCalculation
