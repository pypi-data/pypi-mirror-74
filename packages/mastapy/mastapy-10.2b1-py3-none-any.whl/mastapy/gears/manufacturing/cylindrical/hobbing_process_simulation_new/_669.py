...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _660, _667
...
class HobbingProcessLeadCalculation(_667.HobbingProcessCalculation):
    '''HobbingProcessLeadCalculation
