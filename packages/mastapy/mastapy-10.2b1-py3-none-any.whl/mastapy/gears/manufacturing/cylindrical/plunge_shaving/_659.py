...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _652
...
class PlungeShaverSettings(_1.APIBase):
    ...
    @property
    def lead_display_method(self) -> '_652.MicroGeometryDefinitionMethod':
    ...
    def lead_display_method(self, value: '_652.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LeadDisplayMethod = value

    @property
    def profile_display_method(self) -> '_652.MicroGeometryDefinitionMethod':
    ...
    def profile_display_method(self, value: '_652.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
