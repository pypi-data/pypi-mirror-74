...
from mastapy.gears.manufacturing.bevel import _819, _833
...
class ManufacturingMachine(_89.NamedDatabaseItem):
    '''ManufacturingMachine
    ...
    @property
    def machine_type(self) -> '_819.MachineTypes':
        '''MachineTypes: 'MachineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.MachineType)
        return constructor.new(_819.MachineTypes)(value) if value else None

    @machine_type.setter
    def machine_type(self, value: '_819.MachineTypes'):
    ...
    @property
    def wheel_formate_machine_type(self) -> '_833.WheelFormatMachineTypes':
        ...
        return constructor.new(_833.WheelFormatMachineTypes)(value) if value else None

    @wheel_formate_machine_type.setter
    def wheel_formate_machine_type(self, value: '_833.WheelFormatMachineTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
