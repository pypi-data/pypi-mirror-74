...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _843
...
class BasicConicalGearMachineSettingsGenerated(_843.BasicConicalGearMachineSettings):
    '''BasicConicalGearMachineSettingsGenerated
