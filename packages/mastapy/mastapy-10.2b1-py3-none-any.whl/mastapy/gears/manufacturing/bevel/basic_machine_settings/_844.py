...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _842
...
class BasicConicalGearMachineSettingsGenerated(_842.BasicConicalGearMachineSettings):
    '''BasicConicalGearMachineSettingsGenerated
