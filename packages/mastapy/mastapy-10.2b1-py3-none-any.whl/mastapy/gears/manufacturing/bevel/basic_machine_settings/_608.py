...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _606
...
class BasicConicalGearMachineSettingsGenerated(_606.BasicConicalGearMachineSettings):
    '''BasicConicalGearMachineSettingsGenerated
