...
from mastapy.gears.gear_designs.conical import _894
...
class AbstractTCA(_0.APIBase):
    ...
    @property
    def conical_mesh_misalignments(self) -> '_894.ConicalMeshMisalignments':
        ...
        return constructor.new(_894.ConicalMeshMisalignments)(self.wrapped.ConicalMeshMisalignments) if self.wrapped.ConicalMeshMisalignments else None
