...
from mastapy.gears.manufacturing.bevel import _816, _800
...
class ConicalMeshManufacturingAnalysis(_711.GearMeshImplementationAnalysis):
    '''ConicalMeshManufacturingAnalysis
    ...
    @property
    def tca(self) -> '_816.EaseOffBasedTCA':
        ...
        return constructor.new(_816.EaseOffBasedTCA)(self.wrapped.TCA) if self.wrapped.TCA else None

    @property
    def meshed_gears(self) -> 'List[_800.ConicalMeshedGearManufacturingAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_800.ConicalMeshedGearManufacturingAnalysis))
        return value
