...
from mastapy.gears.manufacturing.bevel import _580, _564
...
class ConicalMeshManufacturingAnalysis(_957.GearMeshImplementationAnalysis):
    '''ConicalMeshManufacturingAnalysis
    ...
    @property
    def tca(self) -> '_580.EaseOffBasedTCA':
        ...
        return constructor.new(_580.EaseOffBasedTCA)(self.wrapped.TCA) if self.wrapped.TCA else None

    @property
    def meshed_gears(self) -> 'List[_564.ConicalMeshedGearManufacturingAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_564.ConicalMeshedGearManufacturingAnalysis))
        return value
