...
class ConicalSetMicroGeometryConfigBase(_735.GearSetImplementationDetail):
    '''ConicalSetMicroGeometryConfigBase
    ...
    @property
    def deflection_from_bending_option(self) -> '_297.DeflectionFromBendingOption':
        ...
        return constructor.new(_297.DeflectionFromBendingOption)(value) if value else None

    @deflection_from_bending_option.setter
    def deflection_from_bending_option(self, value: '_297.DeflectionFromBendingOption'):
