...
class ConicalSetMicroGeometryConfigBase(_965.GearSetImplementationDetail):
    '''ConicalSetMicroGeometryConfigBase
    ...
    @property
    def deflection_from_bending_option(self) -> '_127.DeflectionFromBendingOption':
        ...
        return constructor.new(_127.DeflectionFromBendingOption)(value) if value else None

    @deflection_from_bending_option.setter
    def deflection_from_bending_option(self, value: '_127.DeflectionFromBendingOption'):
