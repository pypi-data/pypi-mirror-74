...
from mastapy.gears.gear_designs.conical.micro_geometry import _849
...
class ConicalMeshFlankMicroGeometryConfig(_1.APIBase):
    '''ConicalMeshFlankMicroGeometryConfig
    ...
    @property
    def specified_ease_off_surface(self) -> '_849.ConicalGearFlankMicroGeometry':
        ...
        return constructor.new(_849.ConicalGearFlankMicroGeometry)(self.wrapped.SpecifiedEaseOffSurface) if self.wrapped.SpecifiedEaseOffSurface else None
