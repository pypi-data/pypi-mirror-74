...
class CylindricalGearSetFEModel(_1102.GearSetFEModel):
    '''CylindricalGearSetFEModel
    ...
    @property
    def manufacturing_configuration_selection(self) -> '_977.CylindricalGearSetManufacturingConfigurationSelection':
        ...
        return constructor.new(_977.CylindricalGearSetManufacturingConfigurationSelection)(self.wrapped.ManufacturingConfigurationSelection) if self.wrapped.ManufacturingConfigurationSelection else None
