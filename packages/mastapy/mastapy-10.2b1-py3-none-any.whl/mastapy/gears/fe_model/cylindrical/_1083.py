...
class CylindricalGearSetFEModel(_1082.GearSetFEModel):
    '''CylindricalGearSetFEModel
    ...
    @property
    def manufacturing_configuration_selection(self) -> '_984.CylindricalGearSetManufacturingConfigurationSelection':
        ...
        return constructor.new(_984.CylindricalGearSetManufacturingConfigurationSelection)(self.wrapped.ManufacturingConfigurationSelection) if self.wrapped.ManufacturingConfigurationSelection else None
