...
class CylindricalGearMeshFEModel(_935.GearMeshFEModel):
    ...
    def stiffness_wrt_contacts_for(self, gear: '_934.GearFEModel', flank: '_128.GearFlanks') -> 'List[_614.GearContactStiffness]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.StiffnessWrtContactsFor(gear.wrapped if gear else None, flank), constructor.new(_614.GearContactStiffness))

    def stiffness_wrt_contacts_for_with_progress(self, gear: '_934.GearFEModel', flank: '_128.GearFlanks', progress: '_6522.TaskProgress') -> 'List[_614.GearContactStiffness]':
        ''' 'StiffnessWrtContactsFor' is the original name of this method.
        ...
        flank = conversion.mp_to_pn_enum(flank)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.StiffnessWrtContactsFor(gear.wrapped if gear else None, flank, progress.wrapped if progress else None), constructor.new(_614.GearContactStiffness))
