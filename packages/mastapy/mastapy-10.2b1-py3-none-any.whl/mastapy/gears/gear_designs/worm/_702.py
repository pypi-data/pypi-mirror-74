...
class WormDesign(_475.WormGearDesign):
    '''WormDesign
    ...
    @property
    def addendum_factor(self) -> '_319.WormAddendumFactor':
        ...
        return constructor.new(_319.WormAddendumFactor)(value) if value else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_319.WormAddendumFactor'):
