...
class WormGearMeshDesign(_947.GearMeshDesign):
    '''WormGearMeshDesign
    ...
    @property
    def worm_gear_set(self) -> '_354.WormGearSetDesign':
        ...
        return constructor.new(_354.WormGearSetDesign)(self.wrapped.WormGearSet) if self.wrapped.WormGearSet else None

    @property
    def worm(self) -> '_600.WormDesign':
        ...
        return constructor.new(_600.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm else None

    @property
    def wheel(self) -> '_601.WormWheelDesign':
        ...
        return constructor.new(_601.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel else None
