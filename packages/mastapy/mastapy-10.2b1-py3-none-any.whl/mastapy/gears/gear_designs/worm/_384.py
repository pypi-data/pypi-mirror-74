...
from mastapy.gears.gear_designs.worm import _475, _445
...
class WormGearSetDesign(_375.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def worm_type(self) -> '_321.WormType':
        '''WormType: 'WormType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.WormType)
        return constructor.new(_321.WormType)(value) if value else None

    @worm_type.setter
    def worm_type(self, value: '_321.WormType'):
    ...
    @property
    def gears(self) -> 'List[_475.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_475.WormGearDesign))
        return value

    @property
    def worm_gears(self) -> 'List[_475.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_475.WormGearDesign))
        return value

    @property
    def worm_meshes(self) -> 'List[_445.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_445.WormGearMeshDesign))
        return value
