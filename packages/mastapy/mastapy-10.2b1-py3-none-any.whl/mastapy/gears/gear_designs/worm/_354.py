...
from mastapy.gears.gear_designs.worm import _455, _450
...
class WormGearSetDesign(_353.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_455.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_455.WormGearDesign))
        return value

    @property
    def worm_gears(self) -> 'List[_455.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_455.WormGearDesign))
        return value

    @property
    def worm_meshes(self) -> 'List[_450.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_450.WormGearMeshDesign))
        return value
