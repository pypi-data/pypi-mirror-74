...
class WormDesign(_419.WormGearDesign):
    '''WormDesign
    ...
    @property
    def addendum_factor(self) -> '_324.WormAddendumFactor':
        ...
        return constructor.new(_324.WormAddendumFactor)(value) if value else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_324.WormAddendumFactor'):
