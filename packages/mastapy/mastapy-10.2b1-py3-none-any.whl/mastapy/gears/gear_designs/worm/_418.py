...
class WormGearMeshDesign(_943.GearMeshDesign):
    '''WormGearMeshDesign
    ...
    @property
    def worm_gear_set(self) -> '_381.WormGearSetDesign':
        ...
        return constructor.new(_381.WormGearSetDesign)(self.wrapped.WormGearSet) if self.wrapped.WormGearSet else None

    @property
    def worm(self) -> '_664.WormDesign':
        ...
        return constructor.new(_664.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm else None

    @property
    def wheel(self) -> '_665.WormWheelDesign':
        ...
        return constructor.new(_665.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel else None
