...
from mastapy.gears.fe_model.cylindrical import _1103
from mastapy._internal.cast_exception import CastException
from mastapy.gears.fe_model.conical import _1104
...
class GearSetDesign(_946.GearDesignComponent):
    '''GearSetDesign
    ...
    @property
    def gear_set_drawing(self) -> '_732.SMTBitmap':
        ...
        return constructor.new(_732.SMTBitmap)(self.wrapped.GearSetDrawing) if self.wrapped.GearSetDrawing else None
    ...
    def transmission_properties_gears(self) -> '_300.GearSetDesignGroup':
        ...
        return constructor.new(_300.GearSetDesignGroup)(self.wrapped.TransmissionPropertiesGears) if self.wrapped.TransmissionPropertiesGears else None

    @property
    def ltcafe_model(self) -> '_1102.GearSetFEModel':
        ...
        return constructor.new(_1102.GearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1103.CylindricalGearSetFEModel':
        ...
        return constructor.new(_1103.CylindricalGearSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def ltcafe_model_of_type_conical_set_fe_model(self) -> '_1104.ConicalSetFEModel':
        ...
        return constructor.new(_1104.ConicalSetFEModel)(self.wrapped.LTCAFEModel) if self.wrapped.LTCAFEModel else None

    @property
    def gears(self) -> 'List[_599.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_599.GearDesign))
        return value
