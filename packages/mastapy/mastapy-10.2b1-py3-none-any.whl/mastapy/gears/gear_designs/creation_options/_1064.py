...
from mastapy.gears.gear_designs.creation_options import _1065
...
class CylindricalGearPairCreationOptions(_1065.GearSetCreationOptions['_387.CylindricalGearSetDesign']):
    '''CylindricalGearPairCreationOptions
    ...
    def derived_parameter(self) -> 'enum_with_selected_value.EnumWithSelectedValue_CylindricalGearPairCreationOptions_DerivedParameterOption':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_CylindricalGearPairCreationOptions_DerivedParameterOption)(self.wrapped.DerivedParameter) if self.wrapped.DerivedParameter else None
    ...
    def derived_parameter(self, value: 'enum_with_selected_value.EnumWithSelectedValue_CylindricalGearPairCreationOptions_DerivedParameterOption.implicit_type()'):
        wrapper_type = enum_with_selected_value.EnumWithSelectedValue_CylindricalGearPairCreationOptions_DerivedParameterOption.TYPE
