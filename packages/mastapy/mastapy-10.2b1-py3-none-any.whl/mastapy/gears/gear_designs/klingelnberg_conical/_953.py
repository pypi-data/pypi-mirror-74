...
from mastapy.gears.gear_designs.conical import _1085, _847
...
class KlingelnbergConicalGearSetDesign(_847.ConicalGearSetDesign):
    ...
    @property
    def gear_finish(self) -> '_1085.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_1085.KlingelnbergFinishingMethods)(value) if value else None

    @gear_finish.setter
    def gear_finish(self, value: '_1085.KlingelnbergFinishingMethods'):
    ...
    @property
    def conical_meshes(self) -> 'List[_952.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_952.KlingelnbergConicalGearMeshDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_952.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_952.KlingelnbergConicalGearMeshDesign))
        return value
