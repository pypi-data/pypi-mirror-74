...
class KlingelnbergConicalGearDesign(_1081.ConicalGearDesign):
    ...
    @property
    def klingelnberg_cyclo_palloid_gear_material(self) -> '_602.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_602.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.KlingelnbergCycloPalloidGearMaterial) if self.wrapped.KlingelnbergCycloPalloidGearMaterial else None
