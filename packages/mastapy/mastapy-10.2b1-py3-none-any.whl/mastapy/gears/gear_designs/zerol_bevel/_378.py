...
from mastapy.gears.gear_designs.zerol_bevel import _393, _383, _944
...
class ZerolBevelGearMeshDesign(_961.BevelGearMeshDesign):
    '''ZerolBevelGearMeshDesign
    ...
    @property
    def zerol_bevel_meshed_gears(self) -> 'List[_944.ZerolBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshedGears, constructor.new(_944.ZerolBevelMeshedGearDesign))
        return value
