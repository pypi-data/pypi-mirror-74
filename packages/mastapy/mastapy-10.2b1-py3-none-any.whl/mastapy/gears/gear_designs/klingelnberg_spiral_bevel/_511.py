...
from mastapy.gears.gear_designs.klingelnberg_conical import _951
...
class KlingelnbergCycloPalloidSpiralBevelGearDesign(_951.KlingelnbergConicalGearDesign):
    '''KlingelnbergCycloPalloidSpiralBevelGearDesign
