...
from mastapy.gears.gear_designs.klingelnberg_conical import _958
...
class KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign(_958.KlingelnbergConicalMeshedGearDesign):
    '''KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign
