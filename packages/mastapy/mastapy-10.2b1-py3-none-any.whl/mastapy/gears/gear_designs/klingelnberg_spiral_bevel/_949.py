...
from mastapy.gears.gear_designs.klingelnberg_conical import _954
...
class KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign(_954.KlingelnbergConicalMeshedGearDesign):
    '''KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign
