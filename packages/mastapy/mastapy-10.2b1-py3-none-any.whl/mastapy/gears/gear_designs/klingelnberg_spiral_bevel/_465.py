...
from mastapy.gears.gear_designs.klingelnberg_spiral_bevel import _389, _506, _953
...
class KlingelnbergCycloPalloidSpiralBevelGearMeshDesign(_956.KlingelnbergConicalGearMeshDesign):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshDesign
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshed_gears(self) -> 'List[_953.KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshedGears, constructor.new(_953.KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign))
        return value
