...
from mastapy.gears.gear_designs.conical.micro_geometry import _1098, _1097, _1096
...
class ConicalGearFlankMicroGeometry(_571.FlankMicroGeometry):
    ...
    @property
    def profile_relief(self) -> '_1098.ConicalGearProfileModification':
        ...
        return constructor.new(_1098.ConicalGearProfileModification)(self.wrapped.ProfileRelief) if self.wrapped.ProfileRelief else None

    @property
    def lead_relief(self) -> '_1097.ConicalGearLeadModification':
        ...
        return constructor.new(_1097.ConicalGearLeadModification)(self.wrapped.LeadRelief) if self.wrapped.LeadRelief else None

    @property
    def bias(self) -> '_1096.ConicalGearBiasModification':
        ...
        return constructor.new(_1096.ConicalGearBiasModification)(self.wrapped.Bias) if self.wrapped.Bias else None
