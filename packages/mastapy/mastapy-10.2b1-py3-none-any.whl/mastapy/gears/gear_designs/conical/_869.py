...
class ConicalGearCutter(_1.APIBase):
    ...
    @property
    def cutter_gauge_length(self) -> '_1087.CutterGaugeLengths':
        ...
        return constructor.new(_1087.CutterGaugeLengths)(value) if value else None

    @cutter_gauge_length.setter
    def cutter_gauge_length(self, value: '_1087.CutterGaugeLengths'):
    ...
    @property
    def cutter_blade_type(self) -> '_1086.CutterBladeType':
        ...
        return constructor.new(_1086.CutterBladeType)(value) if value else None

    @cutter_blade_type.setter
    def cutter_blade_type(self, value: '_1086.CutterBladeType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CutterBladeType = value

    @property
    def input_toprem_as(self) -> '_1094.TopremEntryType':
        ...
        return constructor.new(_1094.TopremEntryType)(value) if value else None

    @input_toprem_as.setter
    def input_toprem_as(self, value: '_1094.TopremEntryType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.InputTopremAs = value

    @property
    def outer_toprem_letter_concave(self) -> '_902.TopremLetter':
        ...
        return constructor.new(_902.TopremLetter)(value) if value else None

    @outer_toprem_letter_concave.setter
    def outer_toprem_letter_concave(self, value: '_902.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OuterTopremLetterConcave = value

    @property
    def inner_toprem_letter_convex(self) -> '_902.TopremLetter':
    ...
    def inner_toprem_letter_convex(self, value: '_902.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
