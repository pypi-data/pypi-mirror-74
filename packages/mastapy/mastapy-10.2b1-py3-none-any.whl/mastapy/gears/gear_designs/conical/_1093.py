...
from mastapy.gears.gear_designs.conical import _1094
...
class KimosBevelHypoidSingleLoadCaseResultsData(_1.APIBase):
    ...
    @property
    def single_rotation_angle_results(self) -> 'List[_1094.KimosBevelHypoidSingleRotationAngleResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SingleRotationAngleResults, constructor.new(_1094.KimosBevelHypoidSingleRotationAngleResult))
        return value
