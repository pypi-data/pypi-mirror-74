...
from mastapy.gears.gear_designs.bevel import _1104
from mastapy._internal import constructor, conversion
from mastapy.gears import _322, _320
from mastapy.gears.gear_designs.conical import _1097, _847
from mastapy.gleason_smt_link import _280
from mastapy.gears.gear_designs.agma_gleason_conical import _1090
...
class AGMAGleasonConicalGearSetDesign(_847.ConicalGearSetDesign):
    ...
    @property
    def tooth_taper(self) -> '_322.SpiralBevelToothTaper':
        ...
        return constructor.new(_322.SpiralBevelToothTaper)(value) if value else None

    @tooth_taper.setter
    def tooth_taper(self, value: '_322.SpiralBevelToothTaper'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ToothTaper = value

    @property
    def reliability_requirement_gleason(self) -> '_1097.GleasonSafetyRequirements':
        ...
        return constructor.new(_1097.GleasonSafetyRequirements)(value) if value else None

    @reliability_requirement_gleason.setter
    def reliability_requirement_gleason(self, value: '_1097.GleasonSafetyRequirements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ReliabilityRequirementGleason = value

    @property
    def reliability_requirement_agma(self) -> '_320.SafetyRequirementsAGMA':
        ...
        return constructor.new(_320.SafetyRequirementsAGMA)(value) if value else None

    @reliability_requirement_agma.setter
    def reliability_requirement_agma(self, value: '_320.SafetyRequirementsAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def manufacturing_method(self) -> '_280.CutterMethod':
        ...
        return constructor.new(_280.CutterMethod)(value) if value else None

    @manufacturing_method.setter
    def manufacturing_method(self, value: '_280.CutterMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def conical_meshes(self) -> 'List[_1090.AGMAGleasonConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_1090.AGMAGleasonConicalGearMeshDesign))
        return value

    @property
    def meshes(self) -> 'List[_1090.AGMAGleasonConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_1090.AGMAGleasonConicalGearMeshDesign))
        return value
