...
class AGMAGleasonConicalGearDesign(_1083.ConicalGearDesign):
    '''AGMAGleasonConicalGearDesign
    ...
    @property
    def front_end_type(self) -> '_1089.FrontEndTypes':
        '''FrontEndTypes: 'FrontEndType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FrontEndType)
        return constructor.new(_1089.FrontEndTypes)(value) if value else None

    @front_end_type.setter
    def front_end_type(self, value: '_1089.FrontEndTypes'):
    ...
    @property
    def cutter(self) -> '_869.ConicalGearCutter':
        ...
        return constructor.new(_869.ConicalGearCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None
    ...
    @property
    def cutter_of_type_dummy_conical_gear_cutter(self) -> '_1088.DummyConicalGearCutter':
        ...
        return constructor.new(_1088.DummyConicalGearCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None
    ...
    @property
    def accuracy_grades_of_type_agma_gleason_conical_accuracy_grades(self) -> '_1080.AGMAGleasonConicalAccuracyGrades':
        ...
        return constructor.new(_1080.AGMAGleasonConicalAccuracyGrades)(self.wrapped.AccuracyGrades) if self.wrapped.AccuracyGrades else None
    ...
    @property
    def bevel_gear_material(self) -> '_597.GearMaterial':
        ...
        return constructor.new(_597.GearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_bevel_gear_material(self) -> '_591.BevelGearMaterial':
        ...
        return constructor.new(_591.BevelGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
    ...
    @property
    def bevel_gear_material_of_type_bevel_gear_iso_material(self) -> '_589.BevelGearISOMaterial':
        ...
        return constructor.new(_589.BevelGearISOMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_agma_cylindrical_gear_material(self) -> '_588.AGMACylindricalGearMaterial':
        ...
        return constructor.new(_588.AGMACylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_iso_cylindrical_gear_material(self) -> '_598.ISOCylindricalGearMaterial':
        ...
        return constructor.new(_598.ISOCylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
