...
from mastapy.gears.gear_designs.conical import _903, _889
...
class AGMAGleasonConicalGearMeshDesign(_889.ConicalGearMeshDesign):
    '''AGMAGleasonConicalGearMeshDesign
    ...
    @property
    def profile_crowning_setting(self) -> '_238.ProfileCrowningSetting':
        ...
        return constructor.new(_238.ProfileCrowningSetting)(value) if value else None

    @profile_crowning_setting.setter
    def profile_crowning_setting(self, value: '_238.ProfileCrowningSetting'):
    ...
    @property
    def mounting_conditions_of_pinion_and_wheel(self) -> '_236.MountingConditionsOfPinionAndWheel':
        ...
        return constructor.new(_236.MountingConditionsOfPinionAndWheel)(value) if value else None

    @mounting_conditions_of_pinion_and_wheel.setter
    def mounting_conditions_of_pinion_and_wheel(self, value: '_236.MountingConditionsOfPinionAndWheel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MountingConditionsOfPinionAndWheel = value

    @property
    def verification_of_contact_pattern(self) -> '_239.VerificationOfContactPattern':
        ...
        return constructor.new(_239.VerificationOfContactPattern)(value) if value else None

    @verification_of_contact_pattern.setter
    def verification_of_contact_pattern(self, value: '_239.VerificationOfContactPattern'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.VerificationOfContactPattern = value

    @property
    def iso10300_gear_set_finishing_methods(self) -> '_223.Iso10300FinishingMethods':
        ...
        return constructor.new(_223.Iso10300FinishingMethods)(value) if value else None

    @iso10300_gear_set_finishing_methods.setter
    def iso10300_gear_set_finishing_methods(self, value: '_223.Iso10300FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
