...
from mastapy.gears.gear_designs.spiral_bevel import _442, _441
...
class SpiralBevelGearSetDesign(_1036.BevelGearSetDesign):
    '''SpiralBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_442.SpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_442.SpiralBevelGearDesign))
        return value
    ...
    @property
    def spiral_bevel_meshes(self) -> 'List[_441.SpiralBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshes, constructor.new(_441.SpiralBevelGearMeshDesign))
        return value
