...
from mastapy.gears.gear_designs.spiral_bevel import _737, _735, _738
...
class SpiralBevelGearMeshDesign(_918.BevelGearMeshDesign):
    '''SpiralBevelGearMeshDesign
    ...
    @property
    def spiral_bevel_meshed_gears(self) -> 'List[_738.SpiralBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshedGears, constructor.new(_738.SpiralBevelMeshedGearDesign))
        return value
