...
from mastapy.gears.gear_designs.spiral_bevel import _396, _480, _948
...
class SpiralBevelGearMeshDesign(_961.BevelGearMeshDesign):
    '''SpiralBevelGearMeshDesign
    ...
    @property
    def spiral_bevel_meshed_gears(self) -> 'List[_948.SpiralBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshedGears, constructor.new(_948.SpiralBevelMeshedGearDesign))
        return value
