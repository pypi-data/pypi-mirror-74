...
class BevelGearDesign(_1088.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_1109.FinishingMethods':
        ...
        return constructor.new(_1109.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1109.FinishingMethods'):
