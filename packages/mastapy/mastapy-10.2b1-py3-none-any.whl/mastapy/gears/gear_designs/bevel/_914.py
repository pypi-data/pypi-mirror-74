...
class BevelGearDesign(_927.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_920.FinishingMethods':
        ...
        return constructor.new(_920.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_920.FinishingMethods'):
