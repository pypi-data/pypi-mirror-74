...
from mastapy.gears.gear_designs.bevel import _923
...
class BevelGearDesign(_930.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_923.FinishingMethods':
        ...
        return constructor.new(_923.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_923.FinishingMethods'):
