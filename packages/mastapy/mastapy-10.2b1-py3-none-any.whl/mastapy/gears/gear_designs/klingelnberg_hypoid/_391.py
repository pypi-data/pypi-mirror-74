...
from mastapy.gears.gear_designs.klingelnberg_hypoid import _468, _462
...
class KlingelnbergCycloPalloidHypoidGearSetDesign(_953.KlingelnbergConicalGearSetDesign):
    '''KlingelnbergCycloPalloidHypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_468.KlingelnbergCycloPalloidHypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_468.KlingelnbergCycloPalloidHypoidGearDesign))
        return value
    ...
    @property
    def klingelnberg_conical_meshes(self) -> 'List[_462.KlingelnbergCycloPalloidHypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_462.KlingelnbergCycloPalloidHypoidGearMeshDesign))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes(self) -> 'List[_462.KlingelnbergCycloPalloidHypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshes, constructor.new(_462.KlingelnbergCycloPalloidHypoidGearMeshDesign))
        return value
