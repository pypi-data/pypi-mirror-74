...
from mastapy.gears.gear_designs.straight_bevel import _733, _731, _734
...
class StraightBevelGearMeshDesign(_918.BevelGearMeshDesign):
    '''StraightBevelGearMeshDesign
    ...
    @property
    def straight_bevel_meshed_gears(self) -> 'List[_734.StraightBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshedGears, constructor.new(_734.StraightBevelMeshedGearDesign))
        return value
