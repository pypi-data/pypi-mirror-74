...
from mastapy.gears.gear_designs.concept import _573, _572
...
class ConceptGearSetDesign(_353.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_573.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_573.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_573.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_573.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_572.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_572.ConceptGearMeshDesign))
        return value
