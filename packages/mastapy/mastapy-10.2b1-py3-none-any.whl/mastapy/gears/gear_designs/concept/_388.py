...
from mastapy.gears.gear_designs.concept import _580, _579
...
class ConceptGearSetDesign(_385.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_580.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_580.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_580.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_580.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_579.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_579.ConceptGearMeshDesign))
        return value
