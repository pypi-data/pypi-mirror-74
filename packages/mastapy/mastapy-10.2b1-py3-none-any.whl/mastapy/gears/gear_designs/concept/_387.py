...
from mastapy.gears.gear_designs.concept import _563, _561
...
class ConceptGearSetDesign(_375.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_563.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_563.ConceptGearDesign))
        return value
    ...
    @property
    def concept_meshes(self) -> 'List[_561.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_561.ConceptGearMeshDesign))
        return value
