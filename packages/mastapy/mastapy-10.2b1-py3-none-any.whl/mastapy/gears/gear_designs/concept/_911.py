...
from mastapy.gears.gear_designs.concept import _912, _910
...
class ConceptGearMeshDesign(_714.GearMeshDesign):
    ...
    @property
    def concept_gear_set(self) -> '_912.ConceptGearSetDesign':
        ...
        return constructor.new(_912.ConceptGearSetDesign)(self.wrapped.ConceptGearSet) if self.wrapped.ConceptGearSet else None
