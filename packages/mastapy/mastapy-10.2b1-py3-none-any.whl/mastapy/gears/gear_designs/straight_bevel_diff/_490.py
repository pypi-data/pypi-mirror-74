...
from mastapy.gears.gear_designs.bevel import _1101, _1040
...
class StraightBevelDiffGearDesign(_1040.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1101.EdgeRadiusType':
        ...
        return constructor.new(_1101.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1101.EdgeRadiusType'):
