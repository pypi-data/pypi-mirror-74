...
from mastapy.gears.gear_designs.bevel import _1100, _1039
...
class StraightBevelDiffGearDesign(_1039.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1100.EdgeRadiusType':
        ...
        return constructor.new(_1100.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1100.EdgeRadiusType'):
