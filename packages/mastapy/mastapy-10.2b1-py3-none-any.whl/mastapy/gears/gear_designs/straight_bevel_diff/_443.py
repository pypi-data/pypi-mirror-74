...
from mastapy.gears.gear_designs.straight_bevel_diff import _393, _490, _950
...
class StraightBevelDiffGearMeshDesign(_1034.BevelGearMeshDesign):
    '''StraightBevelDiffGearMeshDesign
    ...
    @property
    def straight_bevel_diff_meshed_gears(self) -> 'List[_950.StraightBevelDiffMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshedGears, constructor.new(_950.StraightBevelDiffMeshedGearDesign))
        return value
