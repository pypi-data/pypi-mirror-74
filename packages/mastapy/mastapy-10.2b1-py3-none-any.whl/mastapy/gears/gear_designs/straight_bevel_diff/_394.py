...
from mastapy.gears.gear_designs.straight_bevel_diff import _506, _478
...
class StraightBevelDiffGearSetDesign(_963.BevelGearSetDesign):
    '''StraightBevelDiffGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_506.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_506.StraightBevelDiffGearDesign))
        return value

    @property
    def straight_bevel_diff_gears(self) -> 'List[_506.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGears, constructor.new(_506.StraightBevelDiffGearDesign))
        return value

    @property
    def straight_bevel_diff_meshes(self) -> 'List[_478.StraightBevelDiffGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshes, constructor.new(_478.StraightBevelDiffGearMeshDesign))
        return value
