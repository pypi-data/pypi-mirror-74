...
from mastapy.gears.gear_designs.straight_bevel_diff import _394, _506, _946
...
class StraightBevelDiffGearMeshDesign(_961.BevelGearMeshDesign):
    '''StraightBevelDiffGearMeshDesign
    ...
    @property
    def straight_bevel_diff_meshed_gears(self) -> 'List[_946.StraightBevelDiffMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshedGears, constructor.new(_946.StraightBevelDiffMeshedGearDesign))
        return value
