...
from mastapy.gears.gear_designs.bevel import _919, _914
...
class StraightBevelDiffGearDesign(_914.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_919.EdgeRadiusType':
        ...
        return constructor.new(_919.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_919.EdgeRadiusType'):
