...
from mastapy.gears.gear_designs.bevel import _1107, _968
...
class StraightBevelDiffGearDesign(_968.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1107.EdgeRadiusType':
        ...
        return constructor.new(_1107.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1107.EdgeRadiusType'):
