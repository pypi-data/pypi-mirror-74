...
from mastapy.gears.gear_designs.hypoid import _391, _504, _959
...
class HypoidGearMeshDesign(_1106.AGMAGleasonConicalGearMeshDesign):
    '''HypoidGearMeshDesign
    ...
    @property
    def hypoid_meshed_gears(self) -> 'List[_959.HypoidMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshedGears, constructor.new(_959.HypoidMeshedGearDesign))
        return value
