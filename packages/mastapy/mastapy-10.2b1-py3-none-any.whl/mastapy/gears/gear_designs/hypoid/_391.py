...
from mastapy.gears.gear_designs.hypoid import _504, _581
...
class HypoidGearSetDesign(_1108.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_504.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_504.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_504.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_504.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_581.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_581.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_581.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_581.HypoidGearMeshDesign))
        return value
