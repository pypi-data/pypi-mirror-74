...
from mastapy.gears.gear_designs.hypoid import _580, _578
...
class HypoidGearSetDesign(_1109.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_580.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_580.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_580.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_580.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_578.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_578.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_578.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_578.HypoidGearMeshDesign))
        return value
