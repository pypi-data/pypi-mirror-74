...
from mastapy.gears.gear_designs.hypoid import _469, _547
...
class HypoidGearSetDesign(_1091.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_469.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_469.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_469.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_469.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_547.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_547.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_547.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_547.HypoidGearMeshDesign))
        return value
