...
class FaceGearSetDesign(_385.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_666.FaceGearPinionDesign':
        ...
        return constructor.new(_666.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_667.FaceGearWheelDesign':
        ...
        return constructor.new(_667.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_969.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_969.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def gears(self) -> 'List[_563.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_563.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_563.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_563.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_562.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_562.FaceGearMeshDesign))
        return value
