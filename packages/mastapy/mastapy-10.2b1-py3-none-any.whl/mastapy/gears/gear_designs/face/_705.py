...
from mastapy.gears.gear_designs.face import _960, _562
...
class FaceGearWheelDesign(_562.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_960.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_960.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_960.FaceGearDiameterFaceWidthSpecificationMethod'):
