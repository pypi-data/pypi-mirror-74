...
from mastapy.gears.gear_designs.face import _959, _553
...
class FaceGearWheelDesign(_553.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_959.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_959.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_959.FaceGearDiameterFaceWidthSpecificationMethod'):
