...
from mastapy.gears.gear_designs.face import _385, _962, _961
...
class FaceGearSetMicroGeometry(_735.GearSetImplementationDetail):
    '''FaceGearSetMicroGeometry
    ...
    @property
    def face_mesh_micro_geometries(self) -> 'List[_961.FaceGearMeshMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshMicroGeometries, constructor.new(_961.FaceGearMeshMicroGeometry))
        return value
