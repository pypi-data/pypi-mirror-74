...
from mastapy.gears.gear_designs.face import _956, _563
...
class FaceGearWheelDesign(_563.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_956.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_956.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_956.FaceGearDiameterFaceWidthSpecificationMethod'):
