...
class DesignConstraintsCollection(_1348.NamedDatabaseItem):
    '''DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1353.DeletableCollectionMember[_710.DesignConstraint]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_1353.DeletableCollectionMember)[_710.DesignConstraint])
        return value
