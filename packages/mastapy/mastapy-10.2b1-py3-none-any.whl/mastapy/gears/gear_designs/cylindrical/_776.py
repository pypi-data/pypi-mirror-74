...
from mastapy.geometry.twod import _114
from mastapy.gears import _135, _116
...
from mastapy.gears.manufacturing.cylindrical import _397
...
class CylindricalGearDesign(_713.GearDesign):
    '''CylindricalGearDesign
    ...
    @property
    def internal_external(self) -> '_114.InternalExternalType':
        ...
        return constructor.new(_114.InternalExternalType)(value) if value else None

    @internal_external.setter
    def internal_external(self, value: '_114.InternalExternalType'):
    ...
    @property
    def hand(self) -> '_135.Hand':
        '''Hand: 'Hand' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Hand)
        return constructor.new(_135.Hand)(value) if value else None

    @hand.setter
    def hand(self, value: '_135.Hand'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def iso6336_geometry(self) -> '_811.ISO6336GeometryBase':
        ...
        return constructor.new(_811.ISO6336GeometryBase)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry(self) -> '_810.ISO6336Geometry':
        ...
        if _810.ISO6336Geometry.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
        ...
        return constructor.new(_810.ISO6336Geometry)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry_for_shaped_gears(self) -> '_812.ISO6336GeometryForShapedGears':
        ...
        if _812.ISO6336GeometryForShapedGears.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
        ...
        return constructor.new(_812.ISO6336GeometryForShapedGears)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry_manufactured(self) -> '_813.ISO6336GeometryManufactured':
        ...
        if _813.ISO6336GeometryManufactured.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
        ...
        return constructor.new(_813.ISO6336GeometryManufactured)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def surface_roughness(self) -> '_830.SurfaceRoughness':
        ...
        return constructor.new(_830.SurfaceRoughness)(self.wrapped.SurfaceRoughness) if self.wrapped.SurfaceRoughness else None

    @property
    def tip_diameter_reporting(self) -> '_784.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_784.CylindricalGearProfileMeasurement)(self.wrapped.TipDiameterReporting) if self.wrapped.TipDiameterReporting else None

    @property
    def root_diameter_reporting(self) -> '_784.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_784.CylindricalGearProfileMeasurement)(self.wrapped.RootDiameterReporting) if self.wrapped.RootDiameterReporting else None
    ...
    @property
    def cylindrical_gear_micro_geometry(self) -> '_849.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_849.CylindricalGearMicroGeometry)(self.wrapped.CylindricalGearMicroGeometry) if self.wrapped.CylindricalGearMicroGeometry else None

    @property
    def cylindrical_gear_manufacturing_configuration(self) -> '_397.CylindricalGearManufacturingConfig':
        ...
        return constructor.new(_397.CylindricalGearManufacturingConfig)(self.wrapped.CylindricalGearManufacturingConfiguration) if self.wrapped.CylindricalGearManufacturingConfiguration else None

    @property
    def lowest_start_of_active_profile(self) -> '_784.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_784.CylindricalGearProfileMeasurement)(self.wrapped.LowestStartOfActiveProfile) if self.wrapped.LowestStartOfActiveProfile else None

    @property
    def material(self) -> '_379.GearMaterial':
        ...
        return constructor.new(_379.GearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_agma_cylindrical_gear_material(self) -> '_368.AGMACylindricalGearMaterial':
        ...
        if _368.AGMACylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_368.AGMACylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_bevel_gear_iso_material(self) -> '_370.BevelGearISOMaterial':
        ...
        if _370.BevelGearISOMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_370.BevelGearISOMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_bevel_gear_material(self) -> '_372.BevelGearMaterial':
        ...
        if _372.BevelGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_372.BevelGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_cylindrical_gear_material(self) -> '_376.CylindricalGearMaterial':
        ...
        if _376.CylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_376.CylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_iso_cylindrical_gear_material(self) -> '_382.ISOCylindricalGearMaterial':
        ...
        if _382.ISOCylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_382.ISOCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_klingelnberg_cyclo_palloid_conical_gear_material(self) -> '_386.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        if _386.KlingelnbergCycloPalloidConicalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_386.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_plastic_cylindrical_gear_material(self) -> '_388.PlasticCylindricalGearMaterial':
        ...
        if _388.PlasticCylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
        ...
        return constructor.new(_388.PlasticCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def system_of_gear_fits(self) -> '_879.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_879.DIN3967SystemOfGearFits)(self.wrapped.SystemOfGearFits) if self.wrapped.SystemOfGearFits else None

    @property
    def iso_accuracy_grade(self) -> '_882.ISO1328AccuracyGrades':
        ...
        return constructor.new(_882.ISO1328AccuracyGrades)(self.wrapped.ISOAccuracyGrade) if self.wrapped.ISOAccuracyGrade else None

    @property
    def agma_accuracy_grade(self) -> '_874.AGMA20151AccuracyGrades':
        ...
        return constructor.new(_874.AGMA20151AccuracyGrades)(self.wrapped.AGMAAccuracyGrade) if self.wrapped.AGMAAccuracyGrade else None

    @property
    def accuracy_grade_allowances_and_tolerances(self) -> '_876.CylindricalAccuracyGrader':
        ...
        return constructor.new(_876.CylindricalAccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agma2000_accuracy_grader(self) -> '_872.AGMA2000AccuracyGrader':
        ...
        if _872.AGMA2000AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_872.AGMA2000AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agma20151_accuracy_grader(self) -> '_873.AGMA20151AccuracyGrader':
        ...
        if _873.AGMA20151AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_873.AGMA20151AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agmaiso13282013_accuracy_grader(self) -> '_875.AGMAISO13282013AccuracyGrader':
        ...
        if _875.AGMAISO13282013AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_875.AGMAISO13282013AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_cylindrical_accuracy_grader_with_profile_form_and_slope(self) -> '_877.CylindricalAccuracyGraderWithProfileFormAndSlope':
        ...
        if _877.CylindricalAccuracyGraderWithProfileFormAndSlope.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_877.CylindricalAccuracyGraderWithProfileFormAndSlope)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_iso13282013_accuracy_grader(self) -> '_880.ISO13282013AccuracyGrader':
        ...
        if _880.ISO13282013AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_880.ISO13282013AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_iso1328_accuracy_grader(self) -> '_881.ISO1328AccuracyGrader':
        ...
        if _881.ISO1328AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_881.ISO1328AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grades_specified_accuracy(self) -> '_116.AccuracyGrades':
        ...
        return constructor.new(_116.AccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def accuracy_grades_specified_accuracy_of_type_agma20151_accuracy_grades(self) -> '_874.AGMA20151AccuracyGrades':
        ...
        if _874.AGMA20151AccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
        ...
        return constructor.new(_874.AGMA20151AccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def accuracy_grades_specified_accuracy_of_type_cylindrical_accuracy_grades(self) -> '_878.CylindricalAccuracyGrades':
        ...
        if _878.CylindricalAccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
        ...
        return constructor.new(_878.CylindricalAccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def accuracy_grades_specified_accuracy_of_type_iso1328_accuracy_grades(self) -> '_882.ISO1328AccuracyGrades':
        ...
        if _882.ISO1328AccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
        ...
        return constructor.new(_882.ISO1328AccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def accuracy_grades_specified_accuracy_of_type_agma_gleason_conical_accuracy_grades(self) -> '_929.AGMAGleasonConicalAccuracyGrades':
        ...
        if _929.AGMAGleasonConicalAccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
        ...
        return constructor.new(_929.AGMAGleasonConicalAccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def tip_form(self) -> '_784.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_784.CylindricalGearProfileMeasurement)(self.wrapped.TipForm) if self.wrapped.TipForm else None

    @property
    def root_form(self) -> '_784.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_784.CylindricalGearProfileMeasurement)(self.wrapped.RootForm) if self.wrapped.RootForm else None

    @property
    def case_hardening_properties(self) -> '_767.CaseHardeningProperties':
        ...
        return constructor.new(_767.CaseHardeningProperties)(self.wrapped.CaseHardeningProperties) if self.wrapped.CaseHardeningProperties else None

    @property
    def tiff_analysis_settings(self) -> '_832.TiffAnalysisSettings':
        ...
        return constructor.new(_832.TiffAnalysisSettings)(self.wrapped.TIFFAnalysisSettings) if self.wrapped.TIFFAnalysisSettings else None

    @property
    def finished_tooth_thickness_specification(self) -> '_801.FinishToothThicknessDesignSpecification':
        ...
        return constructor.new(_801.FinishToothThicknessDesignSpecification)(self.wrapped.FinishedToothThicknessSpecification) if self.wrapped.FinishedToothThicknessSpecification else None

    @property
    def rough_tooth_thickness_specification(self) -> '_836.ToothThicknessSpecification':
        ...
        return constructor.new(_836.ToothThicknessSpecification)(self.wrapped.RoughToothThicknessSpecification) if self.wrapped.RoughToothThicknessSpecification else None
    ...
    @property
    def cylindrical_gear_cutting_options(self) -> '_774.CylindricalGearCuttingOptions':
        ...
        return constructor.new(_774.CylindricalGearCuttingOptions)(self.wrapped.CylindricalGearCuttingOptions) if self.wrapped.CylindricalGearCuttingOptions else None

    @property
    def lowest_point_of_fewest_tooth_contacts(self) -> '_784.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_784.CylindricalGearProfileMeasurement)(self.wrapped.LowestPointOfFewestToothContacts) if self.wrapped.LowestPointOfFewestToothContacts else None

    @property
    def highest_point_of_fewest_tooth_contacts(self) -> '_784.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_784.CylindricalGearProfileMeasurement)(self.wrapped.HighestPointOfFewestToothContacts) if self.wrapped.HighestPointOfFewestToothContacts else None

    @property
    def cylindrical_meshes(self) -> 'List[_782.CylindricalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_782.CylindricalGearMeshDesign))
        return value
