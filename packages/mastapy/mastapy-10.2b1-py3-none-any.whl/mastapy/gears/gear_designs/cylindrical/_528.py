...
from mastapy.gears import _307, _290
from mastapy.math_utility.measured_ranges import _1109
...
class CylindricalGearMeshDesign(_946.GearMeshDesign):
    '''CylindricalGearMeshDesign
    ...
    @property
    def profile_modification(self) -> '_605.CylindricalGearProfileModifications':
        ...
        return constructor.new(_605.CylindricalGearProfileModifications)(value) if value else None

    @profile_modification.setter
    def profile_modification(self, value: '_605.CylindricalGearProfileModifications'):
    ...
    @property
    def type_of_mechanism_housing(self) -> '_597.TypeOfMechanismHousing':
        ...
        return constructor.new(_597.TypeOfMechanismHousing)(value) if value else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_597.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def backlash_specification(self) -> '_965.BacklashSpecification':
        ...
        return constructor.new(_965.BacklashSpecification)(self.wrapped.BacklashSpecification) if self.wrapped.BacklashSpecification else None

    @property
    def valid_normal_module_range(self) -> '_1109.ShortLengthRange':
        ...
        return constructor.new(_1109.ShortLengthRange)(self.wrapped.ValidNormalModuleRange) if self.wrapped.ValidNormalModuleRange else None
    ...
    @property
    def cylindrical_meshed_gear(self) -> 'List[_984.CylindricalMeshedGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGear, constructor.new(_984.CylindricalMeshedGear))
        return value

    @property
    def gear_a(self) -> '_546.CylindricalGearDesign':
    ...
    @property
    def gear_b(self) -> '_546.CylindricalGearDesign':
