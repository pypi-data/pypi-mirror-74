...
class CylindricalGearDesignConstraintSettings(_80.PerMachineSettings):
    '''CylindricalGearDesignConstraintSettings
    ...
    @property
    def cylindrical_gear_design_constraints(self) -> '_974.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_974.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints else None
