...
class CylindricalGearTableWithMGCharts(_1308.CustomTable):
    '''CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self) -> '_790.CylindricalGearTableMGItemDetail':
        ...
        return constructor.new(_790.CylindricalGearTableMGItemDetail)(value) if value else None

    @item_detail.setter
    def item_detail(self, value: '_790.CylindricalGearTableMGItemDetail'):
