...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import (
    _1062, _1065, _1057, _1059,
    _1055, _1056, _1063, _1064,
    _1058
)
...
class CylindricalGearDesign(_690.GearDesign):
    '''CylindricalGearDesign
    ...
    @property
    def iso6336_geometry(self) -> '_996.ISO6336GeometryBase':
        ...
        return constructor.new(_996.ISO6336GeometryBase)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry(self) -> '_995.ISO6336Geometry':
        ...
        return constructor.new(_995.ISO6336Geometry)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry_for_shaped_gears(self) -> '_997.ISO6336GeometryForShapedGears':
        ...
        return constructor.new(_997.ISO6336GeometryForShapedGears)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry_manufactured(self) -> '_998.ISO6336GeometryManufactured':
        ...
        return constructor.new(_998.ISO6336GeometryManufactured)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None
    ...
    @property
    def tip_diameter_reporting(self) -> '_560.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_560.CylindricalGearProfileMeasurement)(self.wrapped.TipDiameterReporting) if self.wrapped.TipDiameterReporting else None

    @property
    def root_diameter_reporting(self) -> '_560.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_560.CylindricalGearProfileMeasurement)(self.wrapped.RootDiameterReporting) if self.wrapped.RootDiameterReporting else None
    ...
    @property
    def cylindrical_gear_manufacturing_configuration(self) -> '_611.CylindricalGearManufacturingConfig':
        ...
        return constructor.new(_611.CylindricalGearManufacturingConfig)(self.wrapped.CylindricalGearManufacturingConfiguration) if self.wrapped.CylindricalGearManufacturingConfiguration else None

    @property
    def lowest_start_of_active_profile(self) -> '_560.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_560.CylindricalGearProfileMeasurement)(self.wrapped.LowestStartOfActiveProfile) if self.wrapped.LowestStartOfActiveProfile else None

    @property
    def material(self) -> '_595.GearMaterial':
        ...
        return constructor.new(_595.GearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_bevel_gear_material(self) -> '_589.BevelGearMaterial':
        ...
        return constructor.new(_589.BevelGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_klingelnberg_cyclo_palloid_conical_gear_material(self) -> '_602.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_602.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_bevel_gear_iso_material(self) -> '_587.BevelGearISOMaterial':
        ...
        return constructor.new(_587.BevelGearISOMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_agma_cylindrical_gear_material(self) -> '_586.AGMACylindricalGearMaterial':
        ...
        return constructor.new(_586.AGMACylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_iso_cylindrical_gear_material(self) -> '_596.ISOCylindricalGearMaterial':
        ...
        return constructor.new(_596.ISOCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_plastic_cylindrical_gear_material(self) -> '_604.PlasticCylindricalGearMaterial':
        ...
        return constructor.new(_604.PlasticCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def system_of_gear_fits(self) -> '_1062.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_1062.DIN3967SystemOfGearFits)(self.wrapped.SystemOfGearFits) if self.wrapped.SystemOfGearFits else None

    @property
    def iso_accuracy_grade(self) -> '_1065.ISO1328AccuracyGrades':
        ...
        return constructor.new(_1065.ISO1328AccuracyGrades)(self.wrapped.ISOAccuracyGrade) if self.wrapped.ISOAccuracyGrade else None

    @property
    def agma_accuracy_grade(self) -> '_1057.AGMA20151AccuracyGrades':
        ...
        return constructor.new(_1057.AGMA20151AccuracyGrades)(self.wrapped.AGMAAccuracyGrade) if self.wrapped.AGMAAccuracyGrade else None

    @property
    def accuracy_grade_allowances_and_tolerances(self) -> '_1059.CylindricalAccuracyGrader':
        ...
        return constructor.new(_1059.CylindricalAccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agma2000_accuracy_grader(self) -> '_1055.AGMA2000AccuracyGrader':
        ...
        return constructor.new(_1055.AGMA2000AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agma20151_accuracy_grader(self) -> '_1056.AGMA20151AccuracyGrader':
        ...
        return constructor.new(_1056.AGMA20151AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_iso13282013_accuracy_grader(self) -> '_1063.ISO13282013AccuracyGrader':
        ...
        return constructor.new(_1063.ISO13282013AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_iso1328_accuracy_grader(self) -> '_1064.ISO1328AccuracyGrader':
        ...
        return constructor.new(_1064.ISO1328AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agmaiso13282013_accuracy_grader(self) -> '_1058.AGMAISO13282013AccuracyGrader':
        ...
        return constructor.new(_1058.AGMAISO13282013AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None
    ...
    @property
    def accuracy_grades_specified_accuracy_of_type_agma_gleason_conical_accuracy_grades(self) -> '_1082.AGMAGleasonConicalAccuracyGrades':
        ...
        return constructor.new(_1082.AGMAGleasonConicalAccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def accuracy_grades_specified_accuracy_of_type_agma20151_accuracy_grades(self) -> '_1057.AGMA20151AccuracyGrades':
        ...
        return constructor.new(_1057.AGMA20151AccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def accuracy_grades_specified_accuracy_of_type_iso1328_accuracy_grades(self) -> '_1065.ISO1328AccuracyGrades':
        ...
        return constructor.new(_1065.ISO1328AccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def tip_form(self) -> '_560.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_560.CylindricalGearProfileMeasurement)(self.wrapped.TipForm) if self.wrapped.TipForm else None

    @property
    def root_form(self) -> '_560.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_560.CylindricalGearProfileMeasurement)(self.wrapped.RootForm) if self.wrapped.RootForm else None
    ...
    @property
    def finished_tooth_thickness_specification(self) -> '_683.FinishToothThicknessDesignSpecification':
        ...
        return constructor.new(_683.FinishToothThicknessDesignSpecification)(self.wrapped.FinishedToothThicknessSpecification) if self.wrapped.FinishedToothThicknessSpecification else None

    @property
    def rough_tooth_thickness_specification(self) -> '_684.ToothThicknessSpecification':
        ...
        return constructor.new(_684.ToothThicknessSpecification)(self.wrapped.RoughToothThicknessSpecification) if self.wrapped.RoughToothThicknessSpecification else None
    ...
    @property
    def cylindrical_gear_cutting_options(self) -> '_972.CylindricalGearCuttingOptions':
        ...
        return constructor.new(_972.CylindricalGearCuttingOptions)(self.wrapped.CylindricalGearCuttingOptions) if self.wrapped.CylindricalGearCuttingOptions else None
