...
from mastapy.gears import _142
...
class CylindricalPlanetGearDesign(_776.CylindricalGearDesign):
    ...
    @property
    def planetary_details(self) -> '_142.PlanetaryDetail':
        ...
        return constructor.new(_142.PlanetaryDetail)(self.wrapped.PlanetaryDetails) if self.wrapped.PlanetaryDetails else None
