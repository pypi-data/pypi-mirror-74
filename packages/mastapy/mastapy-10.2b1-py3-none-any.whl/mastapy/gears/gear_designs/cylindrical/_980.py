...
from mastapy.gears.gear_designs.cylindrical import _979
from mastapy.utility.report import _1229
...
class CylindricalGearTableWithMGCharts(_1229.CustomTable):
    '''CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self) -> '_979.CylindricalGearTableMGItemDetail':
        ...
        return constructor.new(_979.CylindricalGearTableMGItemDetail)(value) if value else None

    @item_detail.setter
    def item_detail(self, value: '_979.CylindricalGearTableMGItemDetail'):
