...
from mastapy.gears import _310, _287
from mastapy._internal.python_net import python_net_import
from mastapy.gears.gear_designs.cylindrical import (
    _1000, _999, _1001, _1002,
    _1014, _622, _387, _1015,
    _672, _673, _752, _978,
    _491
)
...
class CylindricalGearDesign(_663.GearDesign):
    '''CylindricalGearDesign
    ...
    @property
    def iso6336_geometry(self) -> '_1000.ISO6336GeometryBase':
        ...
        return constructor.new(_1000.ISO6336GeometryBase)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry(self) -> '_999.ISO6336Geometry':
        ...
        return constructor.new(_999.ISO6336Geometry)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry_for_shaped_gears(self) -> '_1001.ISO6336GeometryForShapedGears':
        ...
        return constructor.new(_1001.ISO6336GeometryForShapedGears)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry_manufactured(self) -> '_1002.ISO6336GeometryManufactured':
        ...
        return constructor.new(_1002.ISO6336GeometryManufactured)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def surface_roughness(self) -> '_1014.SurfaceRoughness':
        ...
        return constructor.new(_1014.SurfaceRoughness)(self.wrapped.SurfaceRoughness) if self.wrapped.SurfaceRoughness else None

    @property
    def tip_diameter_reporting(self) -> '_622.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_622.CylindricalGearProfileMeasurement)(self.wrapped.TipDiameterReporting) if self.wrapped.TipDiameterReporting else None

    @property
    def root_diameter_reporting(self) -> '_622.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_622.CylindricalGearProfileMeasurement)(self.wrapped.RootDiameterReporting) if self.wrapped.RootDiameterReporting else None
    ...
    @property
    def cylindrical_gear_micro_geometry(self) -> '_1028.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_1028.CylindricalGearMicroGeometry)(self.wrapped.CylindricalGearMicroGeometry) if self.wrapped.CylindricalGearMicroGeometry else None

    @property
    def cylindrical_gear_manufacturing_configuration(self) -> '_609.CylindricalGearManufacturingConfig':
        ...
        return constructor.new(_609.CylindricalGearManufacturingConfig)(self.wrapped.CylindricalGearManufacturingConfiguration) if self.wrapped.CylindricalGearManufacturingConfiguration else None

    @property
    def lowest_start_of_active_profile(self) -> '_622.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_622.CylindricalGearProfileMeasurement)(self.wrapped.LowestStartOfActiveProfile) if self.wrapped.LowestStartOfActiveProfile else None

    @property
    def material(self) -> '_596.GearMaterial':
        ...
        return constructor.new(_596.GearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_bevel_gear_material(self) -> '_590.BevelGearMaterial':
        ...
        return constructor.new(_590.BevelGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_klingelnberg_cyclo_palloid_conical_gear_material(self) -> '_601.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_601.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None
    ...
    @property
    def material_of_type_iso_cylindrical_gear_material(self) -> '_597.ISOCylindricalGearMaterial':
        ...
        return constructor.new(_597.ISOCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def material_of_type_plastic_cylindrical_gear_material(self) -> '_603.PlasticCylindricalGearMaterial':
        ...
        return constructor.new(_603.PlasticCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None
    ...
    @property
    def accuracy_grades_specified_accuracy_of_type_agma_gleason_conical_accuracy_grades(self) -> '_1087.AGMAGleasonConicalAccuracyGrades':
        ...
        return constructor.new(_1087.AGMAGleasonConicalAccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None
    ...
    @property
    def tip_form(self) -> '_622.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_622.CylindricalGearProfileMeasurement)(self.wrapped.TipForm) if self.wrapped.TipForm else None

    @property
    def root_form(self) -> '_622.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_622.CylindricalGearProfileMeasurement)(self.wrapped.RootForm) if self.wrapped.RootForm else None

    @property
    def tiff_analysis_settings(self) -> '_1015.TiffAnalysisSettings':
        ...
        return constructor.new(_1015.TiffAnalysisSettings)(self.wrapped.TIFFAnalysisSettings) if self.wrapped.TIFFAnalysisSettings else None

    @property
    def finished_tooth_thickness_specification(self) -> '_672.FinishToothThicknessDesignSpecification':
        ...
        return constructor.new(_672.FinishToothThicknessDesignSpecification)(self.wrapped.FinishedToothThicknessSpecification) if self.wrapped.FinishedToothThicknessSpecification else None

    @property
    def rough_tooth_thickness_specification(self) -> '_673.ToothThicknessSpecification':
        ...
        return constructor.new(_673.ToothThicknessSpecification)(self.wrapped.RoughToothThicknessSpecification) if self.wrapped.RoughToothThicknessSpecification else None
    ...
    @property
    def cylindrical_gear_cutting_options(self) -> '_978.CylindricalGearCuttingOptions':
        ...
        return constructor.new(_978.CylindricalGearCuttingOptions)(self.wrapped.CylindricalGearCuttingOptions) if self.wrapped.CylindricalGearCuttingOptions else None
