...
class CylindricalGearDesignConstraintSettings(_78.PerMachineSettings):
    '''CylindricalGearDesignConstraintSettings
    ...
    @property
    def cylindrical_gear_design_constraints(self) -> '_980.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_980.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints else None
