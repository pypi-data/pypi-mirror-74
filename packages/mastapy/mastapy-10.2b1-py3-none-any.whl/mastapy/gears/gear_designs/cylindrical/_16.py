...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1062
...
class CylindricalGearDefaults(_80.PerMachineSettings):
    '''CylindricalGearDefaults
    ...
    @property
    def system_of_fits_defaults(self) -> '_1062.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_1062.DIN3967SystemOfGearFits)(self.wrapped.SystemOfFitsDefaults) if self.wrapped.SystemOfFitsDefaults else None
