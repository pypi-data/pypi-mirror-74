...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _863
...
class MeshedCylindricalGearMicroGeometry(_0.APIBase):
    ...
    @property
    def flanks(self) -> 'List[_863.MeshedCylindricalGearFlankMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_863.MeshedCylindricalGearFlankMicroGeometry))
        return value
