...
class ProfileReliefWithDeviation(_1052.ReliefWithDeviation):
    '''ProfileReliefWithDeviation
    ...
    @property
    def position_on_profile(self) -> '_560.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_560.CylindricalGearProfileMeasurement)(self.wrapped.PositionOnProfile) if self.wrapped.PositionOnProfile else None
