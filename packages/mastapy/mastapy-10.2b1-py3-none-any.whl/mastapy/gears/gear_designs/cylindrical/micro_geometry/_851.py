...
class CylindricalGearMicroGeometryMap(_0.APIBase):
    ...
    @property
    def measured_map_data_type(self) -> '_861.MeasuredMapDataTypes':
        ...
        return constructor.new(_861.MeasuredMapDataTypes)(value) if value else None

    @measured_map_data_type.setter
    def measured_map_data_type(self, value: '_861.MeasuredMapDataTypes'):
    ...
    @property
    def zero_bias_relief(self) -> '_784.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_784.CylindricalGearProfileMeasurement)(self.wrapped.ZeroBiasRelief) if self.wrapped.ZeroBiasRelief else None
