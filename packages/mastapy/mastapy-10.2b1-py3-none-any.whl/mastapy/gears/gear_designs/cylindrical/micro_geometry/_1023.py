...
from mastapy.gears.analysis import _1041
...
class CylindricalGearMeshMicroGeometryDutyCycle(_1041.GearMeshDesignAnalysis):
    '''CylindricalGearMeshMicroGeometryDutyCycle
    ...
    @property
    def meshes_analysis(self) -> 'List[_871.CylindricalGearMeshLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesAnalysis, constructor.new(_871.CylindricalGearMeshLoadDistributionAnalysis))
        return value
