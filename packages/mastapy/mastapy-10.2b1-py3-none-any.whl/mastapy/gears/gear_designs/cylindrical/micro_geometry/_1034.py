...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1027
...
class CylindricalGearSetMicroGeometryDutyCycle(_711.GearSetImplementationAnalysisDutyCycle):
    '''CylindricalGearSetMicroGeometryDutyCycle
    ...
    @property
    def rating(self) -> '_398.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_398.CylindricalGearSetDutyCycleRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def meshes(self) -> 'List[_1027.CylindricalGearMeshMicroGeometryDutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_1027.CylindricalGearMeshMicroGeometryDutyCycle))
        return value
