...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _869
...
class ProfileReliefWithDeviation(_869.ReliefWithDeviation):
    '''ProfileReliefWithDeviation
    ...
    @property
    def position_on_profile(self) -> '_784.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_784.CylindricalGearProfileMeasurement)(self.wrapped.PositionOnProfile) if self.wrapped.PositionOnProfile else None
