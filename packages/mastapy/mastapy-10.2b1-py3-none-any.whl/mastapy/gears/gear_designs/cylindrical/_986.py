...
from mastapy.utility.report import _1203
...
class CylindricalGearTableWithMGCharts(_1203.CustomTable):
    '''CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self) -> '_985.CylindricalGearTableMGItemDetail':
        ...
        return constructor.new(_985.CylindricalGearTableMGItemDetail)(value) if value else None

    @item_detail.setter
    def item_detail(self, value: '_985.CylindricalGearTableMGItemDetail'):
