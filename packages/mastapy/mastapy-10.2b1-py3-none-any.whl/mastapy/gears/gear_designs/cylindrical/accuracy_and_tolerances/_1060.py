...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1059
...
class CylindricalAccuracyGraderWithProfileFormAndSlope(_1059.CylindricalAccuracyGrader):
    '''CylindricalAccuracyGraderWithProfileFormAndSlope
