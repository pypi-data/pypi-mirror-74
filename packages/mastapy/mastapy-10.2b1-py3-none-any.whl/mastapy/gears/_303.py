...
class GearSetOptimisationResults(_1.APIBase):
    '''GearSetOptimisationResults
    ...
    @property
    def results(self) -> 'List[_302.GearSetOptimisationResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Results, constructor.new(_302.GearSetOptimisationResult))
        return value
