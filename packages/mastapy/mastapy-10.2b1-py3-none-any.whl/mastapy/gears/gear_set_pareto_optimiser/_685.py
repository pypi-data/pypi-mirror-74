...
from mastapy.gears.ltca.cylindrical import _631, _630, _634
from mastapy._internal import constructor, conversion
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _854
from mastapy.gears.gear_set_pareto_optimiser import _675, _686
...
class MicroGeometryDesignSpaceSearch(_675.DesignSpaceSearchBase['_634.CylindricalGearSetLoadDistributionAnalysis', '_686.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearch
    ...
    @property
    def load_case_duty_cycle(self) -> '_634.CylindricalGearSetLoadDistributionAnalysis':
        ...
        return constructor.new(_634.CylindricalGearSetLoadDistributionAnalysis)(self.wrapped.LoadCaseDutyCycle) if self.wrapped.LoadCaseDutyCycle else None

    @property
    def selected_candidate_micro_geometry(self) -> '_854.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_854.CylindricalGearSetMicroGeometry)(self.wrapped.SelectedCandidateMicroGeometry) if self.wrapped.SelectedCandidateMicroGeometry else None

    @property
    def candidate_gear_sets(self) -> 'List[_854.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_854.CylindricalGearSetMicroGeometry))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_854.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_854.CylindricalGearSetMicroGeometry))
        return value
