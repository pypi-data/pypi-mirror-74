...
from mastapy.gears.gear_set_pareto_optimiser import _679
...
class GearNameMapper(_0.APIBase):
    '''GearNameMapper
    ...
    @property
    def gear_name_pickers(self) -> 'List[_679.GearNamePicker]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearNamePickers, constructor.new(_679.GearNamePicker))
        return value
