...
from mastapy.gears.ltca.cylindrical import _871, _870, _874
from mastapy._internal import constructor, conversion
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1029
from mastapy.gears.gear_set_pareto_optimiser import _911, _922
...
class MicroGeometryDesignSpaceSearch(_911.DesignSpaceSearchBase['_874.CylindricalGearSetLoadDistributionAnalysis', '_922.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearch
    ...
    def select_mesh(self, value: 'list_with_selected_item.ListWithSelectedItem_CylindricalGearMeshLoadDistributionAnalysis.implicit_type()'):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_CylindricalGearMeshLoadDistributionAnalysis.TYPE
    ...
    def select_gear(self, value: 'list_with_selected_item.ListWithSelectedItem_CylindricalGearLoadDistributionAnalysis.implicit_type()'):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_CylindricalGearLoadDistributionAnalysis.TYPE
    ...
    @property
    def load_case_duty_cycle(self) -> '_874.CylindricalGearSetLoadDistributionAnalysis':
        ...
        return constructor.new(_874.CylindricalGearSetLoadDistributionAnalysis)(self.wrapped.LoadCaseDutyCycle) if self.wrapped.LoadCaseDutyCycle else None

    @property
    def selected_candidate_micro_geometry(self) -> '_1029.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1029.CylindricalGearSetMicroGeometry)(self.wrapped.SelectedCandidateMicroGeometry) if self.wrapped.SelectedCandidateMicroGeometry else None

    @property
    def candidate_gear_sets(self) -> 'List[_1029.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_1029.CylindricalGearSetMicroGeometry))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_1029.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_1029.CylindricalGearSetMicroGeometry))
        return value
