...
class FaceGearSetParetoOptimiser(_917.GearSetParetoOptimiser):
    '''FaceGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_385.FaceGearSetDesign':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_385.FaceGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_385.FaceGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_385.FaceGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_385.FaceGearSetDesign))
        return value
