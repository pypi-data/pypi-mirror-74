...
class MicroGeometryDesignSpaceSearchChartInformation(_909.ChartInfoBase['_874.CylindricalGearSetLoadDistributionAnalysis', '_922.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearchChartInformation
    ...
    @property
    def optimiser(self) -> '_921.MicroGeometryDesignSpaceSearch':
        ...
        return constructor.new(_921.MicroGeometryDesignSpaceSearch)(self.wrapped.Optimiser) if self.wrapped.Optimiser else None

    @property
    def optimiser_of_type_micro_geometry_gear_set_design_space_search(self) -> '_924.MicroGeometryGearSetDesignSpaceSearch':
        ...
        return constructor.new(_924.MicroGeometryGearSetDesignSpaceSearch)(self.wrapped.Optimiser) if self.wrapped.Optimiser else None
