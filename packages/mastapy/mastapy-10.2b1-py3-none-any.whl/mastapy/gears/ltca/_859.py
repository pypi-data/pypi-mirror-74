...
from mastapy.gears.ltca import _860, _858
from mastapy.gears import _298
from mastapy.nodal_analysis import _114
from mastapy.gears.analysis import _711
...
class GearMeshLoadDistributionAnalysis(_711.GearMeshImplementationAnalysis):
    '''GearMeshLoadDistributionAnalysis
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1006.FourierSeries':
        ...
        return constructor.new(_1006.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries else None

    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_860.GearMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_860.GearMeshLoadDistributionAtRotation))
        return value

    def maximum_root_stress_with_flanks(self, gear: '_858.GearLoadDistributionAnalysis', flank: '_298.GearFlanks', stress_type: '_114.StressResultsType') -> 'float':
    ...
    def maximum_root_stress(self, gear: '_858.GearLoadDistributionAnalysis', stress_type: '_114.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
