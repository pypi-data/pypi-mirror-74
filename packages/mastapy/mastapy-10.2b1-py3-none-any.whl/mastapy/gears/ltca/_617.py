...
from mastapy.gears.ltca import _618, _616
...
class GearMeshLoadDistributionAnalysis(_957.GearMeshImplementationAnalysis):
    '''GearMeshLoadDistributionAnalysis
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1079.FourierSeries':
        ...
        return constructor.new(_1079.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries else None

    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_618.GearMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_618.GearMeshLoadDistributionAtRotation))
        return value

    def maximum_root_stress_with_flanks(self, gear: '_616.GearLoadDistributionAnalysis', flank: '_128.GearFlanks', stress_type: '_1396.StressResultsType') -> 'float':
    ...
    def maximum_root_stress(self, gear: '_616.GearLoadDistributionAnalysis', stress_type: '_1396.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
