...
from mastapy.gears.cylindrical import _948, _947
...
class ConicalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def contact_charts(self) -> '_948.GearLTCAContactCharts':
        ...
        return constructor.new(_948.GearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_947.GearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_947.GearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None
