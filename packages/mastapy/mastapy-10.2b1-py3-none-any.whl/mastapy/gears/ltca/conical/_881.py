...
from mastapy.gears.cylindrical import _1075, _1076
...
class ConicalMeshedGearLoadDistributionAnalysis(_1.APIBase):
    '''ConicalMeshedGearLoadDistributionAnalysis
    ...
    @property
    def contact_charts(self) -> '_1075.GearLTCAContactCharts':
        ...
        return constructor.new(_1075.GearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_1076.GearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_1076.GearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None
