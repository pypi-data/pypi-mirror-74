...
from mastapy.gears.ltca import _858
...
class CylindricalGearLoadDistributionAnalysis(_858.GearLoadDistributionAnalysis):
    '''CylindricalGearLoadDistributionAnalysis
    ...
    @property
    def rating(self) -> '_478.CylindricalGearRating':
        ...
        return constructor.new(_478.CylindricalGearRating)(self.wrapped.Rating) if self.wrapped.Rating else None
