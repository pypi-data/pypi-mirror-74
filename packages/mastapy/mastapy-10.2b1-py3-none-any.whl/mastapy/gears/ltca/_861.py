...
class GearMeshLoadedContactLine(_1.APIBase):
    '''GearMeshLoadedContactLine
    ...
    @property
    def loaded_contact_strip_end_points(self) -> 'List[_862.GearMeshLoadedContactPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactStripEndPoints, constructor.new(_862.GearMeshLoadedContactPoint))
        return value
