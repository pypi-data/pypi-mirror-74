...
from mastapy.gears.load_case.worm import _371
from mastapy._internal.cast_exception import CastException
from mastapy.gears.load_case.face import _372
from mastapy.gears.load_case.cylindrical import _373
from mastapy.gears.load_case.conical import _374
from mastapy.gears.load_case.concept import _375
from mastapy.gears.load_case.bevel import _376
...
class GearMeshRating(_329.AbstractGearMeshRating):
    '''GearMeshRating
    ...
    @property
    def mesh_load_case(self) -> '_370.MeshLoadCase':
        ...
        return constructor.new(_370.MeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None

    @property
    def mesh_load_case_of_type_worm_mesh_load_case(self) -> '_371.WormMeshLoadCase':
        ...
        return constructor.new(_371.WormMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None

    @property
    def mesh_load_case_of_type_face_mesh_load_case(self) -> '_372.FaceMeshLoadCase':
    ...
    @property
    def mesh_load_case_of_type_cylindrical_mesh_load_case(self) -> '_373.CylindricalMeshLoadCase':
        ...
        return constructor.new(_373.CylindricalMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None

    @property
    def mesh_load_case_of_type_conical_mesh_load_case(self) -> '_374.ConicalMeshLoadCase':
        ...
        return constructor.new(_374.ConicalMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None

    @property
    def mesh_load_case_of_type_concept_mesh_load_case(self) -> '_375.ConceptMeshLoadCase':
        ...
        return constructor.new(_375.ConceptMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None

    @property
    def mesh_load_case_of_type_bevel_mesh_load_case(self) -> '_376.BevelMeshLoadCase':
        ...
        return constructor.new(_376.BevelMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None
