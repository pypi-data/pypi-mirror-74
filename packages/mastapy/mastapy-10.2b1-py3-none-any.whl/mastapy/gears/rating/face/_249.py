...
from mastapy.gears.rating.face import _252, _250
from mastapy.gears.rating.cylindrical.iso6336 import _307
from mastapy.gears.gear_designs.face import _757
...
class FaceGearMeshRating(_162.GearMeshRating):
    '''FaceGearMeshRating
    ...
    @property
    def active_flank(self) -> '_128.GearFlanks':
        ...
        return constructor.new(_128.GearFlanks)(value) if value else None

    @property
    def mesh_load_case(self) -> '_655.FaceMeshLoadCase':
    ...
    @property
    def gear_set_rating(self) -> '_252.FaceGearSetRating':
        ...
        return constructor.new(_252.FaceGearSetRating)(self.wrapped.GearSetRating) if self.wrapped.GearSetRating else None

    @property
    def mesh_single_flank_rating(self) -> '_307.ISO63362006MeshSingleFlankRating':
    ...
    @property
    def face_gear_mesh(self) -> '_757.FaceGearMeshDesign':
        ...
        return constructor.new(_757.FaceGearMeshDesign)(self.wrapped.FaceGearMesh) if self.wrapped.FaceGearMesh else None
