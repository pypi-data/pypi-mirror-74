...
from mastapy.gears.rating.face import _250, _251
...
class FaceGearSetRating(_166.GearSetRating):
    '''FaceGearSetRating
    ...
    @property
    def face_mesh_ratings(self) -> 'List[_250.FaceGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshRatings, constructor.new(_250.FaceGearMeshRating))
        return value

    @property
    def gear_ratings(self) -> 'List[_251.FaceGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_251.FaceGearRating))
        return value

    @property
    def face_gear_ratings(self) -> 'List[_251.FaceGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearRatings, constructor.new(_251.FaceGearRating))
        return value
