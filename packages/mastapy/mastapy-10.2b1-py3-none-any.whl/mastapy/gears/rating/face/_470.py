...
class FaceGearRating(_339.GearRating):
    '''FaceGearRating
    ...
    @property
    def face_gear(self) -> '_562.FaceGearDesign':
        ...
        return constructor.new(_562.FaceGearDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None
