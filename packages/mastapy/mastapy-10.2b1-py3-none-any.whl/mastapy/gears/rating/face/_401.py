...
from mastapy.gears.rating.face import _460, _461
...
class FaceGearSetRating(_339.GearSetRating):
    '''FaceGearSetRating
    ...
    @property
    def face_gear_set(self) -> '_386.FaceGearSetDesign':
        ...
        return constructor.new(_386.FaceGearSetDesign)(self.wrapped.FaceGearSet) if self.wrapped.FaceGearSet else None

    @property
    def face_mesh_ratings(self) -> 'List[_460.FaceGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshRatings, constructor.new(_460.FaceGearMeshRating))
        return value

    @property
    def gear_ratings(self) -> 'List[_461.FaceGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_461.FaceGearRating))
        return value
