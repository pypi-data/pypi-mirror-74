...
from mastapy.gears.gear_designs.straight_bevel_diff import _478
from mastapy.gears.rating.straight_bevel_diff import _417, _416
from mastapy.gears.rating.conical import _479
...
class StraightBevelDiffGearMeshRating(_479.ConicalGearMeshRating):
    '''StraightBevelDiffGearMeshRating
    ...
    @property
    def straight_bevel_diff_gear_mesh(self) -> '_478.StraightBevelDiffGearMeshDesign':
        ...
        return constructor.new(_478.StraightBevelDiffGearMeshDesign)(self.wrapped.StraightBevelDiffGearMesh) if self.wrapped.StraightBevelDiffGearMesh else None

    @property
    def meshed_gears(self) -> 'List[_417.StraightBevelDiffMeshedGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_417.StraightBevelDiffMeshedGearRating))
        return value

    @property
    def gears_in_mesh(self) -> 'List[_417.StraightBevelDiffMeshedGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsInMesh, constructor.new(_417.StraightBevelDiffMeshedGearRating))
        return value
