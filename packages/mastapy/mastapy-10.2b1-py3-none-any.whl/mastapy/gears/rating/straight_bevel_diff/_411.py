...
from mastapy.gears.rating.conical import _446
...
class StraightBevelDiffGearRating(_446.ConicalGearRating):
    '''StraightBevelDiffGearRating
    ...
    @property
    def straight_bevel_diff_gear(self) -> '_490.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_490.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGear) if self.wrapped.StraightBevelDiffGear else None
