...
from mastapy.gears.rating.hypoid import _453, _454
from mastapy.gears.rating.agma_gleason_conical import _472
...
class HypoidGearSetRating(_472.AGMAGleasonConicalGearSetRating):
    '''HypoidGearSetRating
    ...
    @property
    def hypoid_mesh_ratings(self) -> 'List[_453.HypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshRatings, constructor.new(_453.HypoidGearMeshRating))
        return value
