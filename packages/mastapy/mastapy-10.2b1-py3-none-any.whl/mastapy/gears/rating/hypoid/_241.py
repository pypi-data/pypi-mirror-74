...
class HypoidGearRating(_352.AGMAGleasonConicalGearRating):
    '''HypoidGearRating
    ...
    @property
    def hypoid_gear(self) -> '_751.HypoidGearDesign':
        ...
        return constructor.new(_751.HypoidGearDesign)(self.wrapped.HypoidGear) if self.wrapped.HypoidGear else None
