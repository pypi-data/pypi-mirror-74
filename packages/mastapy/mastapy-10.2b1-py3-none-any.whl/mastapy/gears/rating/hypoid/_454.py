...
from mastapy.gears.rating.agma_gleason_conical import _470
...
class HypoidGearRating(_470.AGMAGleasonConicalGearRating):
    '''HypoidGearRating
    ...
    @property
    def hypoid_gear(self) -> '_469.HypoidGearDesign':
        ...
        return constructor.new(_469.HypoidGearDesign)(self.wrapped.HypoidGear) if self.wrapped.HypoidGear else None
