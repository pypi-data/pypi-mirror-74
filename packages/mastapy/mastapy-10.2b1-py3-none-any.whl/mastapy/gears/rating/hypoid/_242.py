...
from mastapy.gears.rating.hypoid import _240, _241
...
class HypoidGearSetRating(_353.AGMAGleasonConicalGearSetRating):
    '''HypoidGearSetRating
    ...
    @property
    def hypoid_mesh_ratings(self) -> 'List[_240.HypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshRatings, constructor.new(_240.HypoidGearMeshRating))
        return value
