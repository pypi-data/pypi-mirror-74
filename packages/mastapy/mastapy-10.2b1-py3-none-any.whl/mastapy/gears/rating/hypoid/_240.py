...
from mastapy.gears.rating.iso_10300 import _227, _226
from mastapy._internal import constructor, conversion
from mastapy.gears.rating.hypoid.standards import _245
...
class HypoidGearMeshRating(_351.AGMAGleasonConicalGearMeshRating):
    '''HypoidGearMeshRating
    ...
    @property
    def iso10300_hypoid_mesh_single_flank_rating_method_b1(self) -> '_227.ISO10300MeshSingleFlankRatingMethodB1':
        ...
        return constructor.new(_227.ISO10300MeshSingleFlankRatingMethodB1)(self.wrapped.ISO10300HypoidMeshSingleFlankRatingMethodB1) if self.wrapped.ISO10300HypoidMeshSingleFlankRatingMethodB1 else None

    @property
    def iso10300_hypoid_mesh_single_flank_rating_method_b2(self) -> '_226.Iso10300MeshSingleFlankRatingHypoidMethodB2':
        ...
        return constructor.new(_226.Iso10300MeshSingleFlankRatingHypoidMethodB2)(self.wrapped.ISO10300HypoidMeshSingleFlankRatingMethodB2) if self.wrapped.ISO10300HypoidMeshSingleFlankRatingMethodB2 else None

    @property
    def gleason_hypoid_mesh_single_flank_rating(self) -> '_245.GleasonHypoidMeshSingleFlankRating':
        ...
        return constructor.new(_245.GleasonHypoidMeshSingleFlankRating)(self.wrapped.GleasonHypoidMeshSingleFlankRating) if self.wrapped.GleasonHypoidMeshSingleFlankRating else None
    ...
    @property
    def hypoid_gear_ratings(self) -> 'List[_241.HypoidGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearRatings, constructor.new(_241.HypoidGearRating))
        return value
