...
from mastapy.gears.gear_designs.zerol_bevel import _419
...
class ZerolBevelGearMeshRating(_420.BevelGearMeshRating):
    '''ZerolBevelGearMeshRating
    ...
    @property
    def zerol_bevel_gear_mesh(self) -> '_419.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_419.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMesh) if self.wrapped.ZerolBevelGearMesh else None
