...
class ZerolBevelGearMeshRating(_426.BevelGearMeshRating):
    '''ZerolBevelGearMeshRating
    ...
    @property
    def zerol_bevel_gear_mesh(self) -> '_427.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_427.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMesh) if self.wrapped.ZerolBevelGearMesh else None
