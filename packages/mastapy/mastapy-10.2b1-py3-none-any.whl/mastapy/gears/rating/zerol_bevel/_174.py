...
from mastapy.gears.rating.zerol_bevel import _172, _173
...
class ZerolBevelGearSetRating(_342.BevelGearSetRating):
    '''ZerolBevelGearSetRating
    ...
    @property
    def zerol_bevel_mesh_ratings(self) -> 'List[_172.ZerolBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshRatings, constructor.new(_172.ZerolBevelGearMeshRating))
        return value

    @property
    def zerol_bevel_gear_ratings(self) -> 'List[_173.ZerolBevelGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearRatings, constructor.new(_173.ZerolBevelGearRating))
        return value
