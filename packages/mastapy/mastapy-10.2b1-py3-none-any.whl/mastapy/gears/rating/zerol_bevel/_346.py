...
class ZerolBevelGearRating(_384.BevelGearRating):
    '''ZerolBevelGearRating
    ...
    @property
    def zerol_bevel_gear(self) -> '_383.ZerolBevelGearDesign':
        ...
        return constructor.new(_383.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGear) if self.wrapped.ZerolBevelGear else None
