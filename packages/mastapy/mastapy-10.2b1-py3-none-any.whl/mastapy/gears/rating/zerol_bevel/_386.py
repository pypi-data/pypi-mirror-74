...
class ZerolBevelGearRating(_428.BevelGearRating):
    '''ZerolBevelGearRating
    ...
    @property
    def zerol_bevel_gear(self) -> '_427.ZerolBevelGearDesign':
        ...
        return constructor.new(_427.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGear) if self.wrapped.ZerolBevelGear else None
