...
class CylindricalGearSingleFlankRating(_166.GearSingleFlankRating):
    '''CylindricalGearSingleFlankRating
    ...
    @property
    def metal_plastic(self) -> '_80.MetalPlasticType':
        ...
        return constructor.new(_80.MetalPlasticType)(value) if value else None
    ...
    @property
    def geometry_data_source_for_rating(self) -> '_260.CylindricalGearRatingGeometryDataSource':
        ...
        return constructor.new(_260.CylindricalGearRatingGeometryDataSource)(value) if value else None
