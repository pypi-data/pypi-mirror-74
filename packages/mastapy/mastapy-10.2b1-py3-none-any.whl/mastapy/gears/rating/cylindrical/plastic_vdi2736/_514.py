...
from mastapy.gears.rating.cylindrical.plastic_vdi2736 import _517
from mastapy.materials import _275, _276
from mastapy.gears.rating.cylindrical.iso6336 import _534
...
class PlasticGearVDI2736AbstractGearSingleFlankRating(_534.ISO6336AbstractGearSingleFlankRating):
    '''PlasticGearVDI2736AbstractGearSingleFlankRating
    ...
    @property
    def is_gear_driving_or_driven(self) -> '_333.FlankLoadingState':
        ...
        return constructor.new(_333.FlankLoadingState)(value) if value else None
    ...
    @property
    def standard_plastic_sn_curve_for_the_specified_operating_conditions(self) -> '_517.PlasticSNCurveForTheSpecifiedOperatingConditions':
        ...
        return constructor.new(_517.PlasticSNCurveForTheSpecifiedOperatingConditions)(self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions) if self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions else None
