...
from mastapy.gears.gear_designs.cylindrical import _838
from mastapy.gears.rating.cylindrical.plastic_vdi2736 import _285
from mastapy.gears.rating.cylindrical.iso6336 import _311
...
class PlasticGearVDI2736AbstractMeshSingleFlankRating(_311.ISO6336AbstractMeshSingleFlankRating):
    '''PlasticGearVDI2736AbstractMeshSingleFlankRating
    ...
    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_285.PlasticGearVDI2736AbstractGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_285.PlasticGearVDI2736AbstractGearSingleFlankRating))
        return value

    @property
    def plastic_vdi2736_cylindrical_gear_single_flank_ratings(self) -> 'List[_285.PlasticGearVDI2736AbstractGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlasticVDI2736CylindricalGearSingleFlankRatings, constructor.new(_285.PlasticGearVDI2736AbstractGearSingleFlankRating))
        return value
