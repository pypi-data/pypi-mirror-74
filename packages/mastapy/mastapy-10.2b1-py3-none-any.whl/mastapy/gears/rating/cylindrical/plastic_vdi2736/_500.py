...
from mastapy.materials import _270, _271
...
class PlasticGearVDI2736AbstractGearSingleFlankRating(_531.ISO6336AbstractGearSingleFlankRating):
    '''PlasticGearVDI2736AbstractGearSingleFlankRating
    ...
    @property
    def is_gear_driving_or_driven(self) -> '_328.FlankLoadingState':
        ...
        return constructor.new(_328.FlankLoadingState)(value) if value else None
    ...
    @property
    def standard_plastic_sn_curve_for_the_specified_operating_conditions(self) -> '_507.PlasticSNCurveForTheSpecifiedOperatingConditions':
        ...
        return constructor.new(_507.PlasticSNCurveForTheSpecifiedOperatingConditions)(self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions) if self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions else None
