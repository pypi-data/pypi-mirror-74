...
from mastapy.gears.gear_designs.cylindrical import _597
...
class PlasticGearVDI2736AbstractMeshSingleFlankRating(_532.ISO6336AbstractMeshSingleFlankRating):
    '''PlasticGearVDI2736AbstractMeshSingleFlankRating
    ...
    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_500.PlasticGearVDI2736AbstractGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_500.PlasticGearVDI2736AbstractGearSingleFlankRating))
        return value

    @property
    def plastic_vdi2736_cylindrical_gear_single_flank_ratings(self) -> 'List[_500.PlasticGearVDI2736AbstractGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlasticVDI2736CylindricalGearSingleFlankRatings, constructor.new(_500.PlasticGearVDI2736AbstractGearSingleFlankRating))
        return value
