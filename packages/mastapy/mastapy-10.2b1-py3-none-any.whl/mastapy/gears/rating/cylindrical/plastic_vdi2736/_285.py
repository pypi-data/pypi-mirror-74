...
from mastapy.gears.rating.cylindrical.plastic_vdi2736 import _289
from mastapy.materials import _90, _91
...
class PlasticGearVDI2736AbstractGearSingleFlankRating(_310.ISO6336AbstractGearSingleFlankRating):
    '''PlasticGearVDI2736AbstractGearSingleFlankRating
    ...
    @property
    def is_gear_driving_or_driven(self) -> '_159.FlankLoadingState':
        ...
        return constructor.new(_159.FlankLoadingState)(value) if value else None
    ...
    @property
    def standard_plastic_sn_curve_for_the_specified_operating_conditions(self) -> '_289.PlasticSNCurveForTheSpecifiedOperatingConditions':
        ...
        return constructor.new(_289.PlasticSNCurveForTheSpecifiedOperatingConditions)(self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions) if self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions else None
