...
from mastapy.gears.rating.cylindrical import _368, _494
...
class ISO6336RateableMesh(_494.CylindricalRateableMesh):
    '''ISO6336RateableMesh
    ...
    @property
    def misalignment_contact_pattern_enhancement(self) -> '_368.MisalignmentContactPatternEnhancements':
        ...
        return constructor.new(_368.MisalignmentContactPatternEnhancements)(value) if value else None

    @misalignment_contact_pattern_enhancement.setter
    def misalignment_contact_pattern_enhancement(self, value: '_368.MisalignmentContactPatternEnhancements'):
