...
from mastapy.gears.gear_designs.cylindrical import _564
from mastapy.gears.rating.cylindrical import _477
from mastapy.gears.rating.cylindrical.iso6336 import _524, _533, _532
...
class ISO6336AbstractMetalMeshSingleFlankRating(_532.ISO6336AbstractMeshSingleFlankRating):
    '''ISO6336AbstractMetalMeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_564.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_564.ScuffingTemperatureMethodsISO)(value) if value else None
    ...
    @property
    def sorted_micro_pitting_results(self) -> '_477.CylindricalGearMicroPittingResults':
        ...
        return constructor.new(_477.CylindricalGearMicroPittingResults)(self.wrapped.SortedMicroPittingResults) if self.wrapped.SortedMicroPittingResults else None

    @property
    def single_flank_rating_of_test_gears_for_micropitting(self) -> '_524.ISO63362006MeshSingleFlankRating':
        ...
        return constructor.new(_524.ISO63362006MeshSingleFlankRating)(self.wrapped.SingleFlankRatingOfTestGearsForMicropitting) if self.wrapped.SingleFlankRatingOfTestGearsForMicropitting else None

    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_533.ISO6336AbstractMetalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_533.ISO6336AbstractMetalGearSingleFlankRating))
        return value
