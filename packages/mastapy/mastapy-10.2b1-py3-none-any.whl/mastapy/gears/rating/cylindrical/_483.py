...
from mastapy.gears.gear_designs.cylindrical import _579, _580
from mastapy.materials import _259
from mastapy.gears.rating.cylindrical import _480, _21, _481
...
class CylindricalMeshSingleFlankRating(_344.MeshSingleFlankRating):
    '''CylindricalMeshSingleFlankRating
    ...
    @property
    def contact_ratio_source(self) -> '_293.ContactRatioDataSource':
        ...
        return constructor.new(_293.ContactRatioDataSource)(value) if value else None
    ...
    @property
    def coefficient_of_friction_method_flash_temperature_method(self) -> '_579.ScuffingCoefficientOfFrictionMethods':
        ...
        return constructor.new(_579.ScuffingCoefficientOfFrictionMethods)(value) if value else None
    ...
    @property
    def sorted_scuffing_results(self) -> '_480.CylindricalGearScuffingResults':
        ...
        return constructor.new(_480.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResults) if self.wrapped.SortedScuffingResults else None

    @property
    def sorted_scuffing_results_without_special_values(self) -> '_480.CylindricalGearScuffingResults':
        ...
        return constructor.new(_480.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResultsWithoutSpecialValues) if self.wrapped.SortedScuffingResultsWithoutSpecialValues else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_481.CylindricalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_481.CylindricalGearSingleFlankRating))
        return value
