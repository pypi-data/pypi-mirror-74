...
class CylindricalGearScuffingResults(_1.APIBase):
    '''CylindricalGearScuffingResults
    ...
    @property
    def scuffing_results_row(self) -> 'List[_493.ScuffingResultsRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ScuffingResultsRow, constructor.new(_493.ScuffingResultsRow))
        return value
