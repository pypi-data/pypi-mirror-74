...
from mastapy.gears.rating.cylindrical.optimisation import _526
...
class SafetyFactorOptimisationStepResultShortLength(_526.SafetyFactorOptimisationStepResult):
    '''SafetyFactorOptimisationStepResultShortLength
