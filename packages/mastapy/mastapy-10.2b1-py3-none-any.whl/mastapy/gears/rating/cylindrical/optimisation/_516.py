...
class SafetyFactorOptimisationStepResult(_1.APIBase):
    '''SafetyFactorOptimisationStepResult
    ...
    @property
    def safety_factors(self) -> '_347.SafetyFactorResults':
        ...
        return constructor.new(_347.SafetyFactorResults)(self.wrapped.SafetyFactors) if self.wrapped.SafetyFactors else None

    @property
    def normalised_safety_factors(self) -> '_347.SafetyFactorResults':
        ...
        return constructor.new(_347.SafetyFactorResults)(self.wrapped.NormalisedSafetyFactors) if self.wrapped.NormalisedSafetyFactors else None
