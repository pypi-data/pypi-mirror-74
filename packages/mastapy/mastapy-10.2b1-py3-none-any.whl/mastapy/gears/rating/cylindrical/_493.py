...
from mastapy.gears.rating.cylindrical import _494
...
class ScuffingResultsRow(_1.APIBase):
    ...
    @property
    def pinion(self) -> '_494.ScuffingResultsRowGear':
        ...
        return constructor.new(_494.ScuffingResultsRowGear)(self.wrapped.Pinion) if self.wrapped.Pinion else None
