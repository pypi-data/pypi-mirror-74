...
class CylindricalGearRatingSettings(_77.PerMachineSettings):
    '''CylindricalGearRatingSettings
    ...
    @property
    def tip_relief_in_scuffing_calculation(self) -> '_496.TipReliefScuffingOptions':
        ...
        return constructor.new(_496.TipReliefScuffingOptions)(value) if value else None

    @tip_relief_in_scuffing_calculation.setter
    def tip_relief_in_scuffing_calculation(self, value: '_496.TipReliefScuffingOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TipReliefInScuffingCalculation = value

    @property
    def dynamic_factor_method(self) -> '_487.DynamicFactorMethods':
        ...
        return constructor.new(_487.DynamicFactorMethods)(value) if value else None

    @dynamic_factor_method.setter
    def dynamic_factor_method(self, value: '_487.DynamicFactorMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def gear_blank_factor_calculation_option(self) -> '_488.GearBlankFactorCalculationOptions':
        ...
        return constructor.new(_488.GearBlankFactorCalculationOptions)(value) if value else None

    @gear_blank_factor_calculation_option.setter
    def gear_blank_factor_calculation_option(self, value: '_488.GearBlankFactorCalculationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def film_thickness_equation_for_scuffing(self) -> '_493.ScuffingMethods':
        ...
        return constructor.new(_493.ScuffingMethods)(value) if value else None

    @film_thickness_equation_for_scuffing.setter
    def film_thickness_equation_for_scuffing(self, value: '_493.ScuffingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def rating_method(self) -> 'enum_with_selected_value.EnumWithSelectedValue_CylindricalGearRatingMethods':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_CylindricalGearRatingMethods)(self.wrapped.RatingMethod) if self.wrapped.RatingMethod else None
    ...
    def rating_method(self, value: 'enum_with_selected_value.EnumWithSelectedValue_CylindricalGearRatingMethods.implicit_type()'):
        wrapper_type = enum_with_selected_value.EnumWithSelectedValue_CylindricalGearRatingMethods.TYPE
    ...
    @property
    def permissible_bending_stress_method(self) -> '_492.RatingMethod':
        ...
        return constructor.new(_492.RatingMethod)(value) if value else None

    @permissible_bending_stress_method.setter
    def permissible_bending_stress_method(self, value: '_492.RatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def chosen_tooth_thickness_for_bending_strength(self) -> '_499.ToothThicknesses':
        ...
        return constructor.new(_499.ToothThicknesses)(value) if value else None

    @chosen_tooth_thickness_for_bending_strength.setter
    def chosen_tooth_thickness_for_bending_strength(self, value: '_499.ToothThicknesses'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def vdi_rating_geometry_calculation_method(self) -> 'overridable.Overridable_CylindricalGearRatingMethods':
        ...
        return constructor.new(overridable.Overridable_CylindricalGearRatingMethods)(self.wrapped.VDIRatingGeometryCalculationMethod) if self.wrapped.VDIRatingGeometryCalculationMethod else None
    ...
    def vdi_rating_geometry_calculation_method(self, value: 'overridable.Overridable_CylindricalGearRatingMethods.implicit_type()'):
        wrapper_type = overridable.Overridable_CylindricalGearRatingMethods.TYPE
