...
from mastapy.gears.gear_designs.cylindrical import _564, _565
...
class AGMA2101MeshSingleFlankRating(_481.CylindricalMeshSingleFlankRating):
    '''AGMA2101MeshSingleFlankRating
    ...
    @property
    def gearing_type(self) -> '_245.GearingTypes':
        ...
        return constructor.new(_245.GearingTypes)(value) if value else None

    @property
    def scuffing_temperature_method(self) -> '_565.ScuffingTemperatureMethodsAGMA':
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_543.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_543.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_543.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_543.AGMA2101GearSingleFlankRating))
        return value
