...
class MeshRatingForReports(_0.APIBase):
    '''MeshRatingForReports
    ...
    @property
    def cylindrical_gear_mesh_rating(self) -> '_257.CylindricalGearMeshRating':
        ...
        return constructor.new(_257.CylindricalGearMeshRating)(self.wrapped.CylindricalGearMeshRating) if self.wrapped.CylindricalGearMeshRating else None
