...
from mastapy.gears.gear_designs.cylindrical import _622
...
class ScuffingResultsRowGear(_1.APIBase):
    '''ScuffingResultsRowGear
    ...
    @property
    def profile_measurement(self) -> '_622.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_622.CylindricalGearProfileMeasurement)(self.wrapped.ProfileMeasurement) if self.wrapped.ProfileMeasurement else None
