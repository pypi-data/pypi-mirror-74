...
from mastapy.gears.rating.cylindrical import _513
from mastapy.gears.gear_designs.cylindrical import _537
...
class CylindricalGearRating(_337.GearRating):
    '''CylindricalGearRating
    ...
    @property
    def vdi2737_safety_factor(self) -> '_513.VDI2737SafetyFactorReportingObject':
        ...
        return constructor.new(_513.VDI2737SafetyFactorReportingObject)(self.wrapped.VDI2737SafetyFactor) if self.wrapped.VDI2737SafetyFactor else None

    @property
    def cylindrical_gear(self) -> '_537.CylindricalGearDesign':
        ...
        return constructor.new(_537.CylindricalGearDesign)(self.wrapped.CylindricalGear) if self.wrapped.CylindricalGear else None
