...
class MeshRatingForReports(_1.APIBase):
    ...
    @property
    def cylindrical_gear_mesh_rating(self) -> '_476.CylindricalGearMeshRating':
        ...
        return constructor.new(_476.CylindricalGearMeshRating)(self.wrapped.CylindricalGearMeshRating) if self.wrapped.CylindricalGearMeshRating else None
