...
from mastapy.gears.rating.cylindrical.din3990 import _319
...
class VDI2737InternalGearSingleFlankRating(_0.APIBase):
    ...
    @property
    def iso_gear_rating(self) -> '_312.ISO6336AbstractMetalGearSingleFlankRating':
        ...
        return constructor.new(_312.ISO6336AbstractMetalGearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None

    @property
    def iso_gear_rating_of_type_iso63361996_gear_single_flank_rating(self) -> '_304.ISO63361996GearSingleFlankRating':
        ...
        if _304.ISO63361996GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
        ...
        return constructor.new(_304.ISO63361996GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None

    @property
    def iso_gear_rating_of_type_iso63362006_gear_single_flank_rating(self) -> '_306.ISO63362006GearSingleFlankRating':
        ...
        if _306.ISO63362006GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
        ...
        return constructor.new(_306.ISO63362006GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None

    @property
    def iso_gear_rating_of_type_iso63362019_gear_single_flank_rating(self) -> '_308.ISO63362019GearSingleFlankRating':
        ...
        if _308.ISO63362019GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
        ...
        return constructor.new(_308.ISO63362019GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None

    @property
    def iso_gear_rating_of_type_din3990_gear_single_flank_rating(self) -> '_319.DIN3990GearSingleFlankRating':
        ...
        if _319.DIN3990GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
        ...
        return constructor.new(_319.DIN3990GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None
