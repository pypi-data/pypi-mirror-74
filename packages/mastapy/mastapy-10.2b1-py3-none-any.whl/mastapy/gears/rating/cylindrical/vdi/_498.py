...
from mastapy.gears.rating.cylindrical.din3990 import _537
...
class VDI2737InternalGearSingleFlankRating(_1.APIBase):
    '''VDI2737InternalGearSingleFlankRating
    ...
    @property
    def iso_gear_rating(self) -> '_533.ISO6336AbstractMetalGearSingleFlankRating':
        ...
        return constructor.new(_533.ISO6336AbstractMetalGearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None

    @property
    def iso_gear_rating_of_type_iso63361996_gear_single_flank_rating(self) -> '_521.ISO63361996GearSingleFlankRating':
        ...
        if self.wrapped.ISOGearRating.__class__.__qualname__ != 'ISO63361996GearSingleFlankRating':
        ...
        return constructor.new(_521.ISO63361996GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None

    @property
    def iso_gear_rating_of_type_iso63362006_gear_single_flank_rating(self) -> '_529.ISO63362006GearSingleFlankRating':
        ...
        if self.wrapped.ISOGearRating.__class__.__qualname__ != 'ISO63362006GearSingleFlankRating':
        ...
        return constructor.new(_529.ISO63362006GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None

    @property
    def iso_gear_rating_of_type_din3990_gear_single_flank_rating(self) -> '_537.DIN3990GearSingleFlankRating':
        ...
        if self.wrapped.ISOGearRating.__class__.__qualname__ != 'DIN3990GearSingleFlankRating':
        ...
        return constructor.new(_537.DIN3990GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None

    @property
    def iso_gear_rating_of_type_iso63362019_gear_single_flank_rating(self) -> '_530.ISO63362019GearSingleFlankRating':
        ...
        if self.wrapped.ISOGearRating.__class__.__qualname__ != 'ISO63362019GearSingleFlankRating':
        ...
        return constructor.new(_530.ISO63362019GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None
