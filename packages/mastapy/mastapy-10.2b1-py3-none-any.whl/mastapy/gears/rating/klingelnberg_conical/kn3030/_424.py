...
class KlingelnbergConicalMeshSingleFlankRating(_344.MeshSingleFlankRating):
    '''KlingelnbergConicalMeshSingleFlankRating
    ...
    @property
    def virtual_cylindrical_gear_set(self) -> '_380.KlingelnbergVirtualCylindricalGearSet':
        ...
        return constructor.new(_380.KlingelnbergVirtualCylindricalGearSet)(self.wrapped.VirtualCylindricalGearSet) if self.wrapped.VirtualCylindricalGearSet else None
