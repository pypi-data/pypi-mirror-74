...
from mastapy.gears.rating.virtual_cylindrical_gears import _402
...
class KlingelnbergConicalMeshSingleFlankRating(_341.MeshSingleFlankRating):
    '''KlingelnbergConicalMeshSingleFlankRating
    ...
    @property
    def virtual_cylindrical_gear_set(self) -> '_402.KlingelnbergVirtualCylindricalGearSet':
        ...
        return constructor.new(_402.KlingelnbergVirtualCylindricalGearSet)(self.wrapped.VirtualCylindricalGearSet) if self.wrapped.VirtualCylindricalGearSet else None
