...
class AbstractGearSetRating(_345.AbstractGearSetAnalysis):
    '''AbstractGearSetRating
    ...
    @property
    def gear_ratings(self) -> 'List[_325.AbstractGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_325.AbstractGearRating))
        return value

    @property
    def gear_mesh_ratings(self) -> 'List[_324.AbstractGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshRatings, constructor.new(_324.AbstractGearMeshRating))
        return value
