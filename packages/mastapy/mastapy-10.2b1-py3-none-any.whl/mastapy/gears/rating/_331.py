...
from mastapy.gears.rating import _330, _329
from mastapy.gears.analysis import _382
...
class AbstractGearSetRating(_382.AbstractGearSetAnalysis):
    '''AbstractGearSetRating
    ...
    @property
    def gear_ratings(self) -> 'List[_330.AbstractGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_330.AbstractGearRating))
        return value

    @property
    def gear_mesh_ratings(self) -> 'List[_329.AbstractGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshRatings, constructor.new(_329.AbstractGearMeshRating))
        return value
