...
from mastapy.gears.rating.virtual_cylindrical_gears import _404
...
T = TypeVar('T', bound='_404.VirtualCylindricalGearBasic')


class ISO10300MeshSingleFlankRating(_543.ConicalMeshSingleFlankRating, Generic[T]):
    '''ISO10300MeshSingleFlankRating
