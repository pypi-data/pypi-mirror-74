...
from mastapy.gears.rating.iso_10300 import _450
...
class Iso10300MeshSingleFlankRatingBevelMethodB2(_450.ISO10300MeshSingleFlankRatingMethodB2):
    '''Iso10300MeshSingleFlankRatingBevelMethodB2
    ...
    @property
    def gsub_jsub(self) -> 'float':
        '''float: 'GsubJsub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.GsubJsub
