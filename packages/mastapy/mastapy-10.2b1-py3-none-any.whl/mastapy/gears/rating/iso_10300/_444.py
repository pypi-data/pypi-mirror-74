...
class ISO10300SingleFlankRating(_505.ConicalGearSingleFlankRating, Generic[T]):
    '''ISO10300SingleFlankRating
    ...
    @property
    def constant_lubricant_film_factor_csub_z_lsub_method_b(self) -> 'float':
        '''float: 'ConstantLubricantFilmFactorCsubZLsubMethodB' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.ConstantLubricantFilmFactorCsubZLsubMethodB
    ...
    @property
    def constant_speed_factor_csub_z_vsub_method_b(self) -> 'float':
        '''float: 'ConstantSpeedFactorCsubZVsubMethodB' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.ConstantSpeedFactorCsubZVsubMethodB
    ...
    @property
    def constant_roughness_factor_csub_z_rsub_method_b(self) -> 'float':
        '''float: 'ConstantRoughnessFactorCsubZRsubMethodB' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.ConstantRoughnessFactorCsubZRsubMethodB
