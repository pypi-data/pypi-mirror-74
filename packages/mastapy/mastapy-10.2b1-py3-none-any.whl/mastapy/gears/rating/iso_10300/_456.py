...
from mastapy.gears.rating.virtual_cylindrical_gears import _406
...
class ISO10300SingleFlankRatingMethodB2(_452.ISO10300SingleFlankRating['_406.VirtualCylindricalGearISO10300MethodB2']):
    '''ISO10300SingleFlankRatingMethodB2
    ...
    @property
    def toe_increment_bsubisub(self) -> 'float':
        '''float: 'ToeIncrementBsubisub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.ToeIncrementBsubisub

    @property
    def heel_increment_bsubesub(self) -> 'float':
        '''float: 'HeelIncrementBsubesub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.HeelIncrementBsubesub
