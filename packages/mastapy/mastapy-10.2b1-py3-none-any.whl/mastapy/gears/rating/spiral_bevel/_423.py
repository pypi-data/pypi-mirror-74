...
class SpiralBevelGearRating(_384.BevelGearRating):
    '''SpiralBevelGearRating
    ...
    @property
    def spiral_bevel_gear(self) -> '_480.SpiralBevelGearDesign':
        ...
        return constructor.new(_480.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear else None
