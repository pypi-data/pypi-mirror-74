...
from mastapy.gears.gear_designs.spiral_bevel import _471
...
class SpiralBevelGearMeshRating(_379.BevelGearMeshRating):
    '''SpiralBevelGearMeshRating
    ...
    @property
    def spiral_bevel_gear_mesh(self) -> '_471.SpiralBevelGearMeshDesign':
        ...
        return constructor.new(_471.SpiralBevelGearMeshDesign)(self.wrapped.SpiralBevelGearMesh) if self.wrapped.SpiralBevelGearMesh else None
