...
from mastapy.gears.rating.spiral_bevel import _415, _416
...
class SpiralBevelGearSetRating(_443.BevelGearSetRating):
    '''SpiralBevelGearSetRating
    ...
    @property
    def spiral_bevel_mesh_ratings(self) -> 'List[_415.SpiralBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshRatings, constructor.new(_415.SpiralBevelGearMeshRating))
        return value
