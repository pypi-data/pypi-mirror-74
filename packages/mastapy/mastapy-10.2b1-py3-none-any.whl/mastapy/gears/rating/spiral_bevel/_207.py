...
from mastapy.gears.rating.spiral_bevel import _205, _206
...
class SpiralBevelGearSetRating(_342.BevelGearSetRating):
    ...
    @property
    def spiral_bevel_mesh_ratings(self) -> 'List[_205.SpiralBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshRatings, constructor.new(_205.SpiralBevelGearMeshRating))
        return value

    @property
    def spiral_bevel_gear_ratings(self) -> 'List[_206.SpiralBevelGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearRatings, constructor.new(_206.SpiralBevelGearRating))
        return value
