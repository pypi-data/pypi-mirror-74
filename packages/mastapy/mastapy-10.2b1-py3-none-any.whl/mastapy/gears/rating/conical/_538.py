...
from mastapy.gears.gear_designs.conical import _675
...
class ConicalMeshedGearRating(_1.APIBase):
    ...
    @property
    def active_flank(self) -> '_675.ConicalFlanks':
        ...
        return constructor.new(_675.ConicalFlanks)(value) if value else None
