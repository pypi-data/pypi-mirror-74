...
from mastapy.gears.gear_designs.conical import _565
...
class ConicalMeshedGearRating(_1.APIBase):
    ...
    @property
    def active_flank(self) -> '_565.ConicalFlanks':
        ...
        return constructor.new(_565.ConicalFlanks)(value) if value else None
