...
from mastapy.gears.gear_designs.conical import _649
...
class ConicalMeshedGearRating(_1.APIBase):
    '''ConicalMeshedGearRating
    ...
    @property
    def active_flank(self) -> '_649.ConicalFlanks':
        ...
        return constructor.new(_649.ConicalFlanks)(value) if value else None
