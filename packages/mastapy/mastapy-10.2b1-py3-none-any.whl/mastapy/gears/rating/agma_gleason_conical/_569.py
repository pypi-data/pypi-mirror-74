...
from mastapy.gears.gear_designs.conical import _598
...
class AGMAGleasonConicalGearMeshRating(_444.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_598.LoadDistributionFactorMethods':
        ...
        return constructor.new(_598.LoadDistributionFactorMethods)(value) if value else None
