...
class AGMAGleasonConicalGearMeshRating(_324.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_903.LoadDistributionFactorMethods':
        ...
        return constructor.new(_903.LoadDistributionFactorMethods)(value) if value else None
