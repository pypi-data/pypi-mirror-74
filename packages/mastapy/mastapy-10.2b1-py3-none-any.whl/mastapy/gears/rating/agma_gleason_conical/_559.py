...
from mastapy.gears.gear_designs.conical import _577
...
class AGMAGleasonConicalGearMeshRating(_448.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_577.LoadDistributionFactorMethods':
        ...
        return constructor.new(_577.LoadDistributionFactorMethods)(value) if value else None
