...
from mastapy.gears.gear_designs.straight_bevel import _446
...
class StraightBevelGearMeshRating(_379.BevelGearMeshRating):
    '''StraightBevelGearMeshRating
    ...
    @property
    def straight_bevel_gear_mesh(self) -> '_446.StraightBevelGearMeshDesign':
        ...
        return constructor.new(_446.StraightBevelGearMeshDesign)(self.wrapped.StraightBevelGearMesh) if self.wrapped.StraightBevelGearMesh else None

    @property
    def straight_bevel_gear_ratings(self) -> 'List[_421.StraightBevelGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearRatings, constructor.new(_421.StraightBevelGearRating))
        return value
