...
class WormMeshDutyCycleRating(_341.MeshDutyCycleRating):
    '''WormMeshDutyCycleRating
    ...
    @property
    def worm_mesh_ratings(self) -> 'List[_349.WormGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshRatings, constructor.new(_349.WormGearMeshRating))
        return value
