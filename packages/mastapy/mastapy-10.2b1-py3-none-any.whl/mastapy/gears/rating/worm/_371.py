...
from mastapy.gears.gear_designs.worm import _354
from mastapy.gears.rating.worm import _388, _389
...
class WormGearSetRating(_338.GearSetRating):
    '''WormGearSetRating
    ...
    @property
    def worm_mesh_ratings(self) -> 'List[_388.WormGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshRatings, constructor.new(_388.WormGearMeshRating))
        return value
