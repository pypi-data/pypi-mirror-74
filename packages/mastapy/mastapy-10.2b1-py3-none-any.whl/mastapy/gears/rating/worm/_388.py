...
from mastapy.gears.gear_designs.worm import _450
...
class WormGearMeshRating(_335.GearMeshRating):
    '''WormGearMeshRating
    ...
    @property
    def worm_gear_mesh(self) -> '_450.WormGearMeshDesign':
        ...
        return constructor.new(_450.WormGearMeshDesign)(self.wrapped.WormGearMesh) if self.wrapped.WormGearMesh else None
