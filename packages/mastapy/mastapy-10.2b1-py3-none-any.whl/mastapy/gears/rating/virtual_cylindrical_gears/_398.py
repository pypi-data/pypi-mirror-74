...
from mastapy.gears.rating.virtual_cylindrical_gears import _409
...
class HypoidVirtualCylindricalGearSetISO10300MethodB2(_409.VirtualCylindricalGearSetISO10300MethodB2):
    '''HypoidVirtualCylindricalGearSetISO10300MethodB2
    ...
    @property
    def rsub_1sub(self) -> 'float':
        '''float: 'Rsub1sub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.Rsub1sub

    @property
    def hsub_1sub(self) -> 'float':
        '''float: 'Hsub1sub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.Hsub1sub

    @property
    def hsub_1osub(self) -> 'float':
        '''float: 'Hsub1osub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.Hsub1osub
    ...
    @property
    def r(self) -> 'float':
        '''float: 'R' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.R
    ...
    @property
    def rsub_2sub(self) -> 'float':
        '''float: 'Rsub2sub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.Rsub2sub

    @property
    def hsub_2sub(self) -> 'float':
        '''float: 'Hsub2sub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.Hsub2sub

    @property
    def hsub_2osub(self) -> 'float':
        '''float: 'Hsub2osub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.Hsub2osub
