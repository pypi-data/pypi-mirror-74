...
from mastapy.gears.rating.virtual_cylindrical_gears import _401
...
class KlingelnbergSpiralBevelVirtualCylindricalGear(_401.KlingelnbergVirtualCylindricalGear):
    '''KlingelnbergSpiralBevelVirtualCylindricalGear
