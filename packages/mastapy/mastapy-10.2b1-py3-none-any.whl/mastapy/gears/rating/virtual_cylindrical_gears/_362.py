...
from mastapy.gears.rating.virtual_cylindrical_gears import _363
...
class KlingelnbergSpiralBevelVirtualCylindricalGear(_363.KlingelnbergVirtualCylindricalGear):
    '''KlingelnbergSpiralBevelVirtualCylindricalGear
