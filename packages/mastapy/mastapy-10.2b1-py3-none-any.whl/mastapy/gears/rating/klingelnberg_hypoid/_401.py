...
from mastapy.gears.rating.klingelnberg_hypoid import _419, _420
...
class KlingelnbergCycloPalloidHypoidGearSetRating(_423.KlingelnbergCycloPalloidConicalGearSetRating):
    '''KlingelnbergCycloPalloidHypoidGearSetRating
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_mesh_ratings(self) -> 'List[_419.KlingelnbergCycloPalloidHypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshRatings, constructor.new(_419.KlingelnbergCycloPalloidHypoidGearMeshRating))
        return value
