...
from mastapy.gears.rating.klingelnberg_conical import _424
...
class KlingelnbergCycloPalloidHypoidGearRating(_424.KlingelnbergCycloPalloidConicalGearRating):
    '''KlingelnbergCycloPalloidHypoidGearRating
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear(self) -> '_451.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        return constructor.new(_451.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGear) if self.wrapped.KlingelnbergCycloPalloidHypoidGear else None
