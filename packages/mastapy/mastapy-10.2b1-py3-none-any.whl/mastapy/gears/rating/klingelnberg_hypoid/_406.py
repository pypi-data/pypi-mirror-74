...
from mastapy.gears.rating.klingelnberg_hypoid import _426, _427
...
class KlingelnbergCycloPalloidHypoidGearSetRating(_430.KlingelnbergCycloPalloidConicalGearSetRating):
    '''KlingelnbergCycloPalloidHypoidGearSetRating
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_mesh_ratings(self) -> 'List[_426.KlingelnbergCycloPalloidHypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshRatings, constructor.new(_426.KlingelnbergCycloPalloidHypoidGearMeshRating))
        return value
