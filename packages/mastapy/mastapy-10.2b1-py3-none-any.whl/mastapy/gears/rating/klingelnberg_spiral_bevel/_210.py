...
from mastapy.gears.rating.klingelnberg_spiral_bevel import _208, _209
...
class KlingelnbergCycloPalloidSpiralBevelGearSetRating(_216.KlingelnbergCycloPalloidConicalGearSetRating):
    '''KlingelnbergCycloPalloidSpiralBevelGearSetRating
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_mesh_ratings(self) -> 'List[_208.KlingelnbergCycloPalloidSpiralBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshRatings, constructor.new(_208.KlingelnbergCycloPalloidSpiralBevelGearMeshRating))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_ratings(self) -> 'List[_209.KlingelnbergCycloPalloidSpiralBevelGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearRatings, constructor.new(_209.KlingelnbergCycloPalloidSpiralBevelGearRating))
        return value
