...
from mastapy.gears.rating.klingelnberg_conical import _429
...
class KlingelnbergCycloPalloidSpiralBevelGearRating(_429.KlingelnbergCycloPalloidConicalGearRating):
    '''KlingelnbergCycloPalloidSpiralBevelGearRating
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear(self) -> '_511.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        return constructor.new(_511.KlingelnbergCycloPalloidSpiralBevelGearDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGear) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGear else None
