...
from mastapy.gears.rating.klingelnberg_spiral_bevel import _207, _208
...
class KlingelnbergCycloPalloidSpiralBevelGearSetRating(_215.KlingelnbergCycloPalloidConicalGearSetRating):
    '''KlingelnbergCycloPalloidSpiralBevelGearSetRating
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_mesh_ratings(self) -> 'List[_207.KlingelnbergCycloPalloidSpiralBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshRatings, constructor.new(_207.KlingelnbergCycloPalloidSpiralBevelGearMeshRating))
        return value
