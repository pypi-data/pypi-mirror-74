...
class ConceptGearMeshRating(_336.GearMeshRating):
    '''ConceptGearMeshRating
    ...
    @property
    def concept_gear_mesh(self) -> '_579.ConceptGearMeshDesign':
        ...
        return constructor.new(_579.ConceptGearMeshDesign)(self.wrapped.ConceptGearMesh) if self.wrapped.ConceptGearMesh else None
