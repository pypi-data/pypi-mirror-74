...
from mastapy.gears.rating.concept import _551, _552
...
class ConceptGearSetRating(_341.GearSetRating):
    '''ConceptGearSetRating
    ...
    @property
    def concept_mesh_ratings(self) -> 'List[_551.ConceptGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshRatings, constructor.new(_551.ConceptGearMeshRating))
        return value

    @property
    def gear_ratings(self) -> 'List[_552.ConceptGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_552.ConceptGearRating))
        return value

    @property
    def concept_gear_ratings(self) -> 'List[_552.ConceptGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearRatings, constructor.new(_552.ConceptGearRating))
        return value
