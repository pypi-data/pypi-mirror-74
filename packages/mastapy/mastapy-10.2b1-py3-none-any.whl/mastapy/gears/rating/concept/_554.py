...
from mastapy.gears.gear_designs.concept import _580
...
class ConceptGearRating(_337.GearRating):
    '''ConceptGearRating
    ...
    @property
    def concept_gear(self) -> '_580.ConceptGearDesign':
        ...
        return constructor.new(_580.ConceptGearDesign)(self.wrapped.ConceptGear) if self.wrapped.ConceptGear else None
