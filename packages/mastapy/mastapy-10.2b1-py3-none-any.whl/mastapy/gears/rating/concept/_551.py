...
from mastapy.gears.gear_designs.concept import _561
...
class ConceptGearMeshRating(_338.GearMeshRating):
    '''ConceptGearMeshRating
    ...
    @property
    def concept_gear_mesh(self) -> '_561.ConceptGearMeshDesign':
        ...
        return constructor.new(_561.ConceptGearMeshDesign)(self.wrapped.ConceptGearMesh) if self.wrapped.ConceptGearMesh else None
