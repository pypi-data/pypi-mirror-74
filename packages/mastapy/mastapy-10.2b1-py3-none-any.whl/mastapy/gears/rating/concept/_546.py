...
from mastapy.gears.gear_designs.concept import _572
...
class ConceptGearMeshRating(_335.GearMeshRating):
    '''ConceptGearMeshRating
    ...
    @property
    def concept_gear_mesh(self) -> '_572.ConceptGearMeshDesign':
        ...
        return constructor.new(_572.ConceptGearMeshDesign)(self.wrapped.ConceptGearMesh) if self.wrapped.ConceptGearMesh else None
