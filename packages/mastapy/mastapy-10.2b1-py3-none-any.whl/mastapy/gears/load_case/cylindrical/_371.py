...
from mastapy.gears import _296, _295
...
class CylindricalMeshLoadCase(_368.MeshLoadCase):
    '''CylindricalMeshLoadCase
    ...
    @property
    def load_case_modifiable_settings(self) -> '_925.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_925.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
