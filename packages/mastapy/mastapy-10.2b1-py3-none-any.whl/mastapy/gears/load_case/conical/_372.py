...
from mastapy.gears.gear_designs.conical import _986, _896
...
class ConicalMeshLoadCase(_368.MeshLoadCase):
    '''ConicalMeshLoadCase
    ...
    @property
    def active_flank(self) -> '_986.ActiveConicalFlank':
        ...
        return constructor.new(_986.ActiveConicalFlank)(value) if value else None
