...
from mastapy.gears.gear_designs.conical import _1040, _896
...
class ConicalMeshLoadCase(_344.MeshLoadCase):
    '''ConicalMeshLoadCase
    ...
    @property
    def active_flank(self) -> '_1040.ActiveConicalFlank':
        ...
        return constructor.new(_1040.ActiveConicalFlank)(value) if value else None
    ...
    @property
    def misalignments_with_respect_to_cross_point_using_reference_imported_fe_node_total(self) -> '_896.ConicalMeshMisalignments':
        ...
        return constructor.new(_896.ConicalMeshMisalignments)(self.wrapped.MisalignmentsWithRespectToCrossPointUsingReferenceImportedFENodeTotal) if self.wrapped.MisalignmentsWithRespectToCrossPointUsingReferenceImportedFENodeTotal else None

    @property
    def misalignments_with_respect_to_cross_point_using_reference_imported_fe_node_pinion(self) -> '_896.ConicalMeshMisalignments':
        ...
        return constructor.new(_896.ConicalMeshMisalignments)(self.wrapped.MisalignmentsWithRespectToCrossPointUsingReferenceImportedFENodePinion) if self.wrapped.MisalignmentsWithRespectToCrossPointUsingReferenceImportedFENodePinion else None

    @property
    def misalignments_with_respect_to_cross_point_using_reference_imported_fe_node_wheel(self) -> '_896.ConicalMeshMisalignments':
        ...
        return constructor.new(_896.ConicalMeshMisalignments)(self.wrapped.MisalignmentsWithRespectToCrossPointUsingReferenceImportedFENodeWheel) if self.wrapped.MisalignmentsWithRespectToCrossPointUsingReferenceImportedFENodeWheel else None

    @property
    def mesh_node_misalignments_total(self) -> '_896.ConicalMeshMisalignments':
        ...
        return constructor.new(_896.ConicalMeshMisalignments)(self.wrapped.MeshNodeMisalignmentsTotal) if self.wrapped.MeshNodeMisalignmentsTotal else None

    @property
    def mesh_node_misalignments_pinion(self) -> '_896.ConicalMeshMisalignments':
        ...
        return constructor.new(_896.ConicalMeshMisalignments)(self.wrapped.MeshNodeMisalignmentsPinion) if self.wrapped.MeshNodeMisalignmentsPinion else None

    @property
    def mesh_node_misalignments_wheel(self) -> '_896.ConicalMeshMisalignments':
        ...
        return constructor.new(_896.ConicalMeshMisalignments)(self.wrapped.MeshNodeMisalignmentsWheel) if self.wrapped.MeshNodeMisalignmentsWheel else None
