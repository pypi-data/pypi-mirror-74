...
class ProfileModification(_582.Modification):
    ...
    def location_of_tip_relief_start(self) -> 'enum_with_selected_value.EnumWithSelectedValue_LocationOfTipReliefEvaluation':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_LocationOfTipReliefEvaluation)(self.wrapped.LocationOfTipReliefStart) if self.wrapped.LocationOfTipReliefStart else None
    ...
    @property
    def main_profile_modification_ends_at_the_start_of_tip_relief(self) -> '_578.MainProfileReliefEndsAtTheStartOfTipReliefOption':
    ...
    def main_profile_modification_ends_at_the_start_of_tip_relief(self, value: '_578.MainProfileReliefEndsAtTheStartOfTipReliefOption'):
    ...
    def location_of_tip_relief_evaluation(self) -> 'enum_with_selected_value.EnumWithSelectedValue_LocationOfTipReliefEvaluation':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_LocationOfTipReliefEvaluation)(self.wrapped.LocationOfTipReliefEvaluation) if self.wrapped.LocationOfTipReliefEvaluation else None
    ...
    @property
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief(self) -> '_584.ParabolicTipReliefStartsTangentToMainProfileRelief':
    ...
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief(self, value: '_584.ParabolicTipReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def location_of_root_modification_start(self) -> 'enum_with_selected_value.EnumWithSelectedValue_LocationOfRootReliefEvaluation':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_LocationOfRootReliefEvaluation)(self.wrapped.LocationOfRootModificationStart) if self.wrapped.LocationOfRootModificationStart else None
    ...
    @property
    def main_profile_modification_ends_at_the_start_of_root_relief(self) -> '_577.MainProfileReliefEndsAtTheStartOfRootReliefOption':
    ...
    def main_profile_modification_ends_at_the_start_of_root_relief(self, value: '_577.MainProfileReliefEndsAtTheStartOfRootReliefOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def location_of_root_relief_evaluation(self) -> 'enum_with_selected_value.EnumWithSelectedValue_LocationOfRootReliefEvaluation':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_LocationOfRootReliefEvaluation)(self.wrapped.LocationOfRootReliefEvaluation) if self.wrapped.LocationOfRootReliefEvaluation else None
    ...
    @property
    def parabolic_root_relief_starts_tangent_to_main_profile_relief(self) -> '_583.ParabolicRootReliefStartsTangentToMainProfileRelief':
    ...
    def parabolic_root_relief_starts_tangent_to_main_profile_relief(self, value: '_583.ParabolicRootReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def location_of_evaluation_upper_limit_for_zero_tip_relief(self) -> 'enum_with_selected_value.EnumWithSelectedValue_LocationOfEvaluationUpperLimit':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_LocationOfEvaluationUpperLimit)(self.wrapped.LocationOfEvaluationUpperLimitForZeroTipRelief) if self.wrapped.LocationOfEvaluationUpperLimitForZeroTipRelief else None
    ...
    def location_of_evaluation_upper_limit(self) -> 'enum_with_selected_value.EnumWithSelectedValue_LocationOfEvaluationUpperLimit':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_LocationOfEvaluationUpperLimit)(self.wrapped.LocationOfEvaluationUpperLimit) if self.wrapped.LocationOfEvaluationUpperLimit else None
    ...
    def location_of_evaluation_lower_limit_for_zero_root_relief(self) -> 'enum_with_selected_value.EnumWithSelectedValue_LocationOfEvaluationLowerLimit':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_LocationOfEvaluationLowerLimit)(self.wrapped.LocationOfEvaluationLowerLimitForZeroRootRelief) if self.wrapped.LocationOfEvaluationLowerLimitForZeroRootRelief else None
    ...
    def location_of_evaluation_lower_limit(self) -> 'enum_with_selected_value.EnumWithSelectedValue_LocationOfEvaluationLowerLimit':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_LocationOfEvaluationLowerLimit)(self.wrapped.LocationOfEvaluationLowerLimit) if self.wrapped.LocationOfEvaluationLowerLimit else None
