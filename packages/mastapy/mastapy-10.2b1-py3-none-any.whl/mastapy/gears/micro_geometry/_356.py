...
from mastapy.utility.scripting import _1271
...
class FlankMicroGeometry(_0.APIBase):
    ...
    @property
    def micro_geometry_input_type(self) -> '_138.MicroGeometryInputTypes':
        ...
        return constructor.new(_138.MicroGeometryInputTypes)(value) if value else None

    @micro_geometry_input_type.setter
    def micro_geometry_input_type(self, value: '_138.MicroGeometryInputTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MicroGeometryInputType = value

    @property
    def user_specified_data(self) -> '_1271.UserSpecifiedData':
        ...
        return constructor.new(_1271.UserSpecifiedData)(self.wrapped.UserSpecifiedData) if self.wrapped.UserSpecifiedData else None

    @property
    def gear_design(self) -> '_713.GearDesign':
        ...
        return constructor.new(_713.GearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None
    ...
    def gear_design_of_type_zerol_bevel_gear_design(self) -> '_718.ZerolBevelGearDesign':
        ...
        return constructor.new(_718.ZerolBevelGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_worm_design(self) -> '_722.WormDesign':
        ...
        if _722.WormDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_722.WormDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_worm_gear_design(self) -> '_723.WormGearDesign':
        ...
        if _723.WormGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_723.WormGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_worm_wheel_design(self) -> '_726.WormWheelDesign':
        ...
        if _726.WormWheelDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_726.WormWheelDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None
    ...
    def gear_design_of_type_straight_bevel_diff_gear_design(self) -> '_727.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_727.StraightBevelDiffGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None
    ...
    def gear_design_of_type_straight_bevel_gear_design(self) -> '_731.StraightBevelGearDesign':
        ...
        return constructor.new(_731.StraightBevelGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None
    ...
    def gear_design_of_type_spiral_bevel_gear_design(self) -> '_735.SpiralBevelGearDesign':
        ...
        return constructor.new(_735.SpiralBevelGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None
    ...
    def gear_design_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_design(self) -> '_739.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        return constructor.new(_739.KlingelnbergCycloPalloidSpiralBevelGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None
    ...
    def gear_design_of_type_klingelnberg_cyclo_palloid_hypoid_gear_design(self) -> '_743.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        return constructor.new(_743.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None
    ...
    def gear_design_of_type_klingelnberg_conical_gear_design(self) -> '_747.KlingelnbergConicalGearDesign':
        ...
        return constructor.new(_747.KlingelnbergConicalGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None
    ...
    def gear_design_of_type_hypoid_gear_design(self) -> '_751.HypoidGearDesign':
        ...
        return constructor.new(_751.HypoidGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_face_gear_design(self) -> '_755.FaceGearDesign':
        ...
        if _755.FaceGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_755.FaceGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_face_gear_pinion_design(self) -> '_760.FaceGearPinionDesign':
        ...
        if _760.FaceGearPinionDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_760.FaceGearPinionDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_face_gear_wheel_design(self) -> '_763.FaceGearWheelDesign':
        ...
        if _763.FaceGearWheelDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_763.FaceGearWheelDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_cylindrical_gear_design(self) -> '_776.CylindricalGearDesign':
        ...
        return constructor.new(_776.CylindricalGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_cylindrical_planet_gear_design(self) -> '_797.CylindricalPlanetGearDesign':
        ...
        if _797.CylindricalPlanetGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_797.CylindricalPlanetGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_conical_gear_design(self) -> '_891.ConicalGearDesign':
        ...
        return constructor.new(_891.ConicalGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None

    @property
    def gear_design_of_type_concept_gear_design(self) -> '_913.ConceptGearDesign':
        ...
        if _913.ConceptGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
        ...
        return constructor.new(_913.ConceptGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None
    ...
    def gear_design_of_type_bevel_gear_design(self) -> '_917.BevelGearDesign':
        ...
        return constructor.new(_917.BevelGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None
    ...
    def gear_design_of_type_agma_gleason_conical_gear_design(self) -> '_930.AGMAGleasonConicalGearDesign':
        ...
        return constructor.new(_930.AGMAGleasonConicalGearDesign)(self.wrapped.GearDesign) if self.wrapped.GearDesign else None
