...
class ISOCylindricalGearMaterial(_594.CylindricalGearMaterial):
    ...
    @property
    def quality_grade(self) -> '_271.QualityGrade':
        '''QualityGrade: 'QualityGrade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.QualityGrade)
        return constructor.new(_271.QualityGrade)(value) if value else None

    @quality_grade.setter
    def quality_grade(self, value: '_271.QualityGrade'):
