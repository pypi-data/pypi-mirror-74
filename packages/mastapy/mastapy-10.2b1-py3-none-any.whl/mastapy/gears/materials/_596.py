...
class ISOCylindricalGearMaterial(_593.CylindricalGearMaterial):
    '''ISOCylindricalGearMaterial
    ...
    @property
    def quality_grade(self) -> '_267.QualityGrade':
        '''QualityGrade: 'QualityGrade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.QualityGrade)
        return constructor.new(_267.QualityGrade)(value) if value else None

    @quality_grade.setter
    def quality_grade(self, value: '_267.QualityGrade'):
