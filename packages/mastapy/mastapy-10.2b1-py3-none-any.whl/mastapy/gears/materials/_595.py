...
from mastapy.materials import _74, _64
...
class GearMaterial(_64.Material):
    '''GearMaterial
    ...
    @property
    def sn_curve_contact(self) -> '_74.SNCurve':
        ...
        return constructor.new(_74.SNCurve)(self.wrapped.SNCurveContact) if self.wrapped.SNCurveContact else None

    @property
    def sn_curve_bending(self) -> '_74.SNCurve':
        ...
        return constructor.new(_74.SNCurve)(self.wrapped.SNCurveBending) if self.wrapped.SNCurveBending else None
