...
from mastapy.materials import _86, _76
...
class GearMaterial(_76.Material):
    '''GearMaterial
    ...
    @property
    def sn_curve_contact(self) -> '_86.SNCurve':
        ...
        return constructor.new(_86.SNCurve)(self.wrapped.SNCurveContact) if self.wrapped.SNCurveContact else None

    @property
    def sn_curve_bending(self) -> '_86.SNCurve':
        ...
        return constructor.new(_86.SNCurve)(self.wrapped.SNCurveBending) if self.wrapped.SNCurveBending else None
