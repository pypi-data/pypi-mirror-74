...
from mastapy.gears.materials import _608, _595
...
class BevelGearMaterial(_595.GearMaterial):
    '''BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self) -> '_608.SNCurveDefinition':
        ...
        return constructor.new(_608.SNCurveDefinition)(value) if value else None

    @sn_curve_definition.setter
    def sn_curve_definition(self, value: '_608.SNCurveDefinition'):
