...
from mastapy.gears.materials import _393, _379
...
class BevelGearMaterial(_379.GearMaterial):
    '''BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self) -> '_393.SNCurveDefinition':
        ...
        return constructor.new(_393.SNCurveDefinition)(value) if value else None

    @sn_curve_definition.setter
    def sn_curve_definition(self, value: '_393.SNCurveDefinition'):
