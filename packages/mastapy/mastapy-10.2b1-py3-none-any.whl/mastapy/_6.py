...
class UtilityMethods:
    ...
    def release_version_string() -> 'str':
        '''str: 'ReleaseVersionString' is the original name of this method.'''

        return UtilityMethods.TYPE.ReleaseVersionString

    T_is_read_only = TypeVar('T_is_read_only', bound='_1.APIBase')
    ...
    T_is_invalidated = TypeVar('T_is_invalidated', bound='_1.APIBase')
