...
from mastapy.math_utility import _234
...
class MassProperties(_1.APIBase):
    '''MassProperties
    ...
    @property
    def inertia_tensor_about_origin(self) -> '_234.InertiaTensor':
        ...
        return constructor.new(_234.InertiaTensor)(self.wrapped.InertiaTensorAboutOrigin) if self.wrapped.InertiaTensorAboutOrigin else None

    @property
    def inertia_tensor_about_centre_of_mass(self) -> '_234.InertiaTensor':
        ...
        return constructor.new(_234.InertiaTensor)(self.wrapped.InertiaTensorAboutCentreOfMass) if self.wrapped.InertiaTensorAboutCentreOfMass else None
