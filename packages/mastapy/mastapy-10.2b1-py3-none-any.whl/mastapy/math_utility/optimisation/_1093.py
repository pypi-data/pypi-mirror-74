...
from mastapy.math_utility.optimisation import _1100
...
class InputSetter(_0.APIBase, Generic[T]):
    ...
    @property
    def optimiser_input(self) -> '_1100.ParetoOptimisationInput':
        ...
        return constructor.new(_1100.ParetoOptimisationInput)(self.wrapped.OptimiserInput) if self.wrapped.OptimiserInput else None
