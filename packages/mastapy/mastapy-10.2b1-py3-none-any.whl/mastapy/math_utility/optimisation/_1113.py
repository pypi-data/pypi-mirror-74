...
from mastapy.math_utility.optimisation import _1114, _1112
...
class ParetoOptimistaionVariable(_1112.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1114.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1114.PropertyTargetForDominantCandidateSearch)(value) if value else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1114.PropertyTargetForDominantCandidateSearch'):
