...
from mastapy.math_utility import _1228
...
class PIDControlSettings(_1.APIBase):
    '''PIDControlSettings
    ...
    @property
    def update_method(self) -> '_1228.PIDControlUpdateMethod':
        ...
        return constructor.new(_1228.PIDControlUpdateMethod)(value) if value else None

    @update_method.setter
    def update_method(self, value: '_1228.PIDControlUpdateMethod'):
