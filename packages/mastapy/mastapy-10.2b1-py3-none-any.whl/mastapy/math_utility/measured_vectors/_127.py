...
from mastapy.utility.units_and_measurements.measurements import _1327, _1284
...
class ForceAndDisplacementResults(_1247.AbstractForceAndDisplacementResults):
    ...
    @property
    def displacement(self) -> '_1253.VectorWithLinearAndAngularComponents[_1327.LengthVeryShort, _1284.AngleSmall]':
        ...
        return constructor.new(_1253.VectorWithLinearAndAngularComponents)[_1327.LengthVeryShort, _1284.AngleSmall](self.wrapped.Displacement) if self.wrapped.Displacement else None
