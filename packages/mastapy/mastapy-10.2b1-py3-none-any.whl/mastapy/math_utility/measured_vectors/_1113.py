...
from mastapy.math_utility.measured_vectors import _1118, _1112
...
class ForceAndDisplacementResults(_1112.AbstractForceAndDisplacementResults):
    '''ForceAndDisplacementResults
    ...
    @property
    def displacement(self) -> '_1118.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1118.VectorWithLinearAndAngularComponents)(self.wrapped.Displacement) if self.wrapped.Displacement else None
