...
class MultipleFourierSeriesInterpolator(_1.APIBase):
    '''MultipleFourierSeriesInterpolator
    ...
    def fourier_series_for(self, x_value: 'float') -> '_1006.FourierSeries':
        ...
        return constructor.new(_1006.FourierSeries)(method_result) if method_result else None
