...
from mastapy.units_and_measurements import _6515
...
class MeasurementTypeExtensions:
    ...
    @staticmethod
    def is_unmeasurable(measurement_type: '_6515.MeasurementType') -> 'bool':
    ...
    @staticmethod
    def is_valid(measurement_type: '_6515.MeasurementType') -> 'bool':
