...
class LinearBearing(_1738.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1518.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1518.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1518.BearingStiffnessMatrixOption'):
