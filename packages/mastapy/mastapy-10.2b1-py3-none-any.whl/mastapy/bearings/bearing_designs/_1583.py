...
from mastapy.bearings import _1470
...
class LinearBearing(_1581.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1470.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1470.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1470.BearingStiffnessMatrixOption'):
