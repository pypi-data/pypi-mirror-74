...
from mastapy.bearings import _1514
from mastapy.bearings.bearing_designs import _1730
...
class LinearBearing(_1730.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1514.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1514.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1514.BearingStiffnessMatrixOption'):
