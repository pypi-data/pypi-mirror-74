...
from mastapy.bearings.bearing_results import _1518
...
class PlainJournalHousing(_1.APIBase):
    '''PlainJournalHousing
    ...
    @property
    def heat_emitting_area_method(self) -> '_1518.DefaultOrUserInput':
        ...
        return constructor.new(_1518.DefaultOrUserInput)(value) if value else None

    @heat_emitting_area_method.setter
    def heat_emitting_area_method(self, value: '_1518.DefaultOrUserInput'):
