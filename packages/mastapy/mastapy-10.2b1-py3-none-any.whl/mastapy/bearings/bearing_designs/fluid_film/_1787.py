...
from mastapy.bearings.bearing_designs.fluid_film import _1779
...
class TiltingPadThrustBearing(_1779.PadFluidFilmBearing):
    '''TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1530.TiltingPadTypes':
        ...
        return constructor.new(_1530.TiltingPadTypes)(value) if value else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1530.TiltingPadTypes'):
