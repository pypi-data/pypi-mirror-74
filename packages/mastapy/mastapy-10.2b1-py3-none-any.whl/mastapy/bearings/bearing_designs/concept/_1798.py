...
from mastapy.bearings.bearing_designs.concept import _1797, _1799
...
class ConceptAxialClearanceBearing(_1799.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1797.BearingNodePosition':
        ...
        return constructor.new(_1797.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1797.BearingNodePosition'):
