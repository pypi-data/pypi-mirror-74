...
from mastapy.bearings.bearing_designs.concept import _1718, _1720
...
class ConceptAxialClearanceBearing(_1720.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1718.BearingNodePosition':
        ...
        return constructor.new(_1718.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1718.BearingNodePosition'):
