...
from mastapy.bearings.bearing_designs.concept import _1788, _1790
...
class ConceptAxialClearanceBearing(_1790.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1788.BearingNodePosition':
        ...
        return constructor.new(_1788.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1788.BearingNodePosition'):
