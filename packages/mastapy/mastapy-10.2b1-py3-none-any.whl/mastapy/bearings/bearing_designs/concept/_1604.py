...
from mastapy.bearings.bearing_designs.concept import _1719, _1720
...
class ConceptAxialClearanceBearing(_1720.ConceptClearanceBearing):
    ...
    @property
    def node_position(self) -> '_1719.BearingNodePosition':
        ...
        return constructor.new(_1719.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1719.BearingNodePosition'):
