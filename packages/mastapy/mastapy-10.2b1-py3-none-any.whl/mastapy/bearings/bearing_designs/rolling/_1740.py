...
from mastapy.bearings.bearing_designs.rolling import _1741, _1758
...
class BallBearing(_1758.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1741.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1741.BallBearingShoulderDefinition))
        return value
