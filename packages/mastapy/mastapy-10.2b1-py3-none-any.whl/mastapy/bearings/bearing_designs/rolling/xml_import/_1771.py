...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1769, _1768
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1769.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1769.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1768.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1768.AbstractXmlVariableAssignment))
        return value
