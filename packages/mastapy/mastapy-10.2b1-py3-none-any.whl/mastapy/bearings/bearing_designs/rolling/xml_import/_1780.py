...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1778, _1777
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1778.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1778.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1777.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1777.AbstractXmlVariableAssignment))
        return value
