...
from mastapy.bearings.bearing_designs.rolling import _1697, _1694
...
class TaperRollerBearing(_1694.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def major_rib_detail(self) -> '_1697.RollerRibDetail':
        ...
        return constructor.new(_1697.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail else None
