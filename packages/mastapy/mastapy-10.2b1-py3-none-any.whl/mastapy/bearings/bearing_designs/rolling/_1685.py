...
from mastapy.bearings.bearing_designs.rolling import _1686, _1699
...
class BallBearing(_1699.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1686.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1686.BallBearingShoulderDefinition))
        return value
