...
from mastapy.bearings import (
    _1530, _1533, _1509, _1510,
    _1511, _1512
)
from mastapy.bearings.bearing_designs.rolling import (
    _1782, _1766, _1764, _1760,
    _1775, _1757
)
from mastapy._internal.python_net import python_net_import
from mastapy.utility import _1136
from mastapy.materials import _52
from mastapy.bearings.bearing_designs import _1745
...
class RollingBearing(_1745.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def catalogue(self) -> '_1509.BearingCatalog':
        ...
        return constructor.new(_1509.BearingCatalog)(value) if value else None
    ...
    @property
    def type_information(self) -> '_1760.BearingTypeExtraInformation':
        ...
        return constructor.new(_1760.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1512.BearingCageMaterial':
        ...
        return constructor.new(_1512.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1512.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1775.SleeveType':
        ...
        return constructor.new(_1775.SleeveType)(value) if value else None
    ...
    @property
    def history(self) -> '_1136.FileHistory':
        ...
        return constructor.new(_1136.FileHistory)(self.wrapped.History) if self.wrapped.History else None

    @property
    def protection(self) -> '_1757.BearingProtection':
        ...
        return constructor.new(_1757.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None

    @property
    def element_material(self) -> '_52.BearingMaterial':
        ...
        return constructor.new(_52.BearingMaterial)(self.wrapped.ElementMaterial) if self.wrapped.ElementMaterial else None

    @property
    def inner_ring_material(self) -> '_52.BearingMaterial':
        ...
        return constructor.new(_52.BearingMaterial)(self.wrapped.InnerRingMaterial) if self.wrapped.InnerRingMaterial else None

    @property
    def outer_ring_material(self) -> '_52.BearingMaterial':
        ...
        return constructor.new(_52.BearingMaterial)(self.wrapped.OuterRingMaterial) if self.wrapped.OuterRingMaterial else None
    ...
    def __copy__(self) -> 'RollingBearing':
        ...
        return constructor.new(RollingBearing)(method_result) if method_result else None
