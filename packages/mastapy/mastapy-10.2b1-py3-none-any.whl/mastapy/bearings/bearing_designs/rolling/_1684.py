...
from mastapy.bearings.bearing_designs.rolling import _1685, _1698
...
class BallBearing(_1698.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1685.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1685.BallBearingShoulderDefinition))
        return value
