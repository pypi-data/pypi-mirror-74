...
class RollingBearing(_1685.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def type_information(self) -> '_1693.BearingTypeExtraInformation':
        ...
        return constructor.new(_1693.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def sleeve_type(self) -> '_1701.SleeveType':
        ...
        return constructor.new(_1701.SleeveType)(value) if value else None
    ...
    @property
    def protection(self) -> '_1690.BearingProtection':
        ...
        return constructor.new(_1690.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None

    @property
    def element_material(self) -> '_231.BearingMaterial':
        ...
        return constructor.new(_231.BearingMaterial)(self.wrapped.ElementMaterial) if self.wrapped.ElementMaterial else None

    @property
    def inner_ring_material(self) -> '_231.BearingMaterial':
        ...
        return constructor.new(_231.BearingMaterial)(self.wrapped.InnerRingMaterial) if self.wrapped.InnerRingMaterial else None

    @property
    def outer_ring_material(self) -> '_231.BearingMaterial':
        ...
        return constructor.new(_231.BearingMaterial)(self.wrapped.OuterRingMaterial) if self.wrapped.OuterRingMaterial else None
