...
from mastapy.bearings.tolerances import _1490, _1488
from mastapy._internal import constructor, conversion
from mastapy._internal.implicit import overridable
from mastapy.bearings import _1477
...
class InterferenceTolerance(_1488.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1490.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1490.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1477.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1477.MountingPointSurfaceFinishes)(value) if value else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1477.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
