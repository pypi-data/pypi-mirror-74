...
from mastapy.bearings.tolerances import _1540, _1537
...
class InterferenceTolerance(_1537.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1540.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1540.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1526.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1526.MountingPointSurfaceFinishes)(value) if value else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1526.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
