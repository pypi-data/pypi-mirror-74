...
from mastapy.bearings.bearing_results.fluid_film import _1731
...
class LoadedPlainJournalBearingResults(_1579.LoadedDetailedBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1731.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1731.LoadedPlainJournalBearingRow))
        return value
