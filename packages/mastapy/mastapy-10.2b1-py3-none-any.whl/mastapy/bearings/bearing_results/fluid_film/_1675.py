...
from mastapy.bearings.bearing_results.fluid_film import _1676
from mastapy.bearings.bearing_results import _1527
...
class LoadedPlainJournalBearingResults(_1527.LoadedDetailedBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1676.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1676.LoadedPlainJournalBearingRow))
        return value
