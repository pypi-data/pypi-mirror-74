...
from mastapy.scripting import _6517
...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    def row(self) -> '_1516.BearingRow':
        ...
        return constructor.new(_1516.BearingRow)(value) if value else None
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_6517.SMTBitmap':
        ...
        return constructor.new(_6517.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
