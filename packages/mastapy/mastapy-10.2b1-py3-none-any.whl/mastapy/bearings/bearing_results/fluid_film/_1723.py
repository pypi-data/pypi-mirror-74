...
from mastapy.bearings import _1512
...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    def row(self) -> '_1512.BearingRow':
        ...
        return constructor.new(_1512.BearingRow)(value) if value else None
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_6503.SMTBitmap':
        ...
        return constructor.new(_6503.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
