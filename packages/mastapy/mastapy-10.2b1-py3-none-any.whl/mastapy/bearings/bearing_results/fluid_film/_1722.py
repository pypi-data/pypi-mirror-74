...
from mastapy.bearings.bearing_results.fluid_film import _1723
...
class LoadedPlainJournalBearingResults(_1575.LoadedDetailedBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1723.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1723.LoadedPlainJournalBearingRow))
        return value
