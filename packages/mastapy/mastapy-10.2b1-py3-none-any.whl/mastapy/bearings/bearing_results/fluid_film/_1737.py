...
from mastapy.bearings import _1518
...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    def row(self) -> '_1518.BearingRow':
        ...
        return constructor.new(_1518.BearingRow)(value) if value else None
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_6525.SMTBitmap':
        ...
        return constructor.new(_6525.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
