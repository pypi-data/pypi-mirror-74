...
from mastapy.utility.property import (
    _1451, _1450, _1448, _1449
)
from mastapy.bearings.bearing_results.rolling import _1596, _1625
from mastapy.bearings import _1465
from mastapy.bearings.bearing_results import _1529
...
class LoadedRollingBearingDutyCycle(_1529.LoadedNonLinearBearingDutyCycleResults):
    '''LoadedRollingBearingDutyCycle
    ...
    @property
    def maximum_element_normal_stress_inner_summary(self) -> '_1451.DutyCyclePropertySummaryStress[_1596.LoadedRollingBearingResults]':
        '''DutyCyclePropertySummaryStress[LoadedRollingBearingResults]: 'MaximumElementNormalStressInnerSummary' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return constructor.new(_1451.DutyCyclePropertySummaryStress)[_1596.LoadedRollingBearingResults](self.wrapped.MaximumElementNormalStressInnerSummary) if self.wrapped.MaximumElementNormalStressInnerSummary else None

    @property
    def maximum_element_normal_stress_outer_summary(self) -> '_1451.DutyCyclePropertySummaryStress[_1596.LoadedRollingBearingResults]':
        '''DutyCyclePropertySummaryStress[LoadedRollingBearingResults]: 'MaximumElementNormalStressOuterSummary' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return constructor.new(_1451.DutyCyclePropertySummaryStress)[_1596.LoadedRollingBearingResults](self.wrapped.MaximumElementNormalStressOuterSummary) if self.wrapped.MaximumElementNormalStressOuterSummary else None

    @property
    def maximum_element_normal_stress_summary(self) -> '_1451.DutyCyclePropertySummaryStress[_1465.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1451.DutyCyclePropertySummaryStress)[_1465.BearingLoadCaseResultsLightweight](self.wrapped.MaximumElementNormalStressSummary) if self.wrapped.MaximumElementNormalStressSummary else None

    @property
    def misalignment_summary(self) -> '_1450.DutyCyclePropertySummarySmallAngle[_1465.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1450.DutyCyclePropertySummarySmallAngle)[_1465.BearingLoadCaseResultsLightweight](self.wrapped.MisalignmentSummary) if self.wrapped.MisalignmentSummary else None

    @property
    def iso2812007_dynamic_equivalent_load_summary(self) -> '_1448.DutyCyclePropertySummaryForce[_1465.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1448.DutyCyclePropertySummaryForce)[_1465.BearingLoadCaseResultsLightweight](self.wrapped.ISO2812007DynamicEquivalentLoadSummary) if self.wrapped.ISO2812007DynamicEquivalentLoadSummary else None

    @property
    def isots162812008_dynamic_equivalent_load_summary(self) -> '_1448.DutyCyclePropertySummaryForce[_1465.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1448.DutyCyclePropertySummaryForce)[_1465.BearingLoadCaseResultsLightweight](self.wrapped.ISOTS162812008DynamicEquivalentLoadSummary) if self.wrapped.ISOTS162812008DynamicEquivalentLoadSummary else None

    @property
    def maximum_truncation_summary(self) -> '_1449.DutyCyclePropertySummaryPercentage[_1465.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1449.DutyCyclePropertySummaryPercentage)[_1465.BearingLoadCaseResultsLightweight](self.wrapped.MaximumTruncationSummary) if self.wrapped.MaximumTruncationSummary else None

    @property
    def maximum_static_contact_stress_duty_cycle(self) -> '_1625.MaximumStaticContactStressDutyCycle':
        ...
        return constructor.new(_1625.MaximumStaticContactStressDutyCycle)(self.wrapped.MaximumStaticContactStressDutyCycle) if self.wrapped.MaximumStaticContactStressDutyCycle else None
