...
from mastapy.bearings.bearing_results.rolling import _1606, _1626
...
class LoadedAngularContactBallBearingRow(_1626.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1606.LoadedAngularContactBallBearingResults':
