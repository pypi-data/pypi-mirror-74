...
from mastapy.bearings.bearing_results.rolling import _1609, _1607
...
class LoadedAngularContactThrustBallBearingRow(_1607.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1609.LoadedAngularContactThrustBallBearingResults':
