...
from mastapy.bearings.bearing_results.rolling import _1582
...
class LoadedFourPointContactBallBearingElement(_1582.LoadedMultiPointContactBallBearingElement):
    '''LoadedFourPointContactBallBearingElement
