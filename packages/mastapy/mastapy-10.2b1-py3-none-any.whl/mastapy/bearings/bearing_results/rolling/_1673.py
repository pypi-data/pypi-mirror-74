...
from mastapy.bearings.bearing_results.rolling import _1672, _1648
...
class LoadedTaperRollerBearingRow(_1648.LoadedNonBarrelRollerBearingRow):
    '''LoadedTaperRollerBearingRow
    ...
    @property
    def major_rib_normal_contact_stress(self) -> '_6525.SMTBitmap':
        ...
        return constructor.new(_6525.SMTBitmap)(self.wrapped.MajorRibNormalContactStress) if self.wrapped.MajorRibNormalContactStress else None

    @property
    def loaded_bearing(self) -> '_1672.LoadedTaperRollerBearingResults':
