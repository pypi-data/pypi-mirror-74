...
from mastapy.bearings.bearing_results.rolling import _1560
...
class LoadedAxialThrustNeedleRollerBearingResults(_1560.LoadedAxialThrustCylindricalRollerBearingResults):
    '''LoadedAxialThrustNeedleRollerBearingResults
