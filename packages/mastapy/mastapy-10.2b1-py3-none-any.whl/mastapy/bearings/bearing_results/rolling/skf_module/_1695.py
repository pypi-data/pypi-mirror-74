...
class FrictionalMoment(_0.APIBase):
    ...
    @property
    def at_start_2030c_and_zero_speed(self) -> 'float':
        '''float: 'AtStart2030CAndZeroSpeed' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.AtStart2030CAndZeroSpeed
