...
from mastapy.bearings.bearing_results.rolling.skf_module import _1701, _1705
...
class BearingRatingLife(_1705.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1701.LifeModel':
        ...
        return constructor.new(_1701.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
