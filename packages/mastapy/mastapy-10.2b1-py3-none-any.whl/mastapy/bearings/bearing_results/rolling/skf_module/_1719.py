...
from mastapy.bearings.bearing_results.rolling.skf_module import _1713, _1715
...
class Viscosities(_1715.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1713.OperatingViscosity':
        ...
        return constructor.new(_1713.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
