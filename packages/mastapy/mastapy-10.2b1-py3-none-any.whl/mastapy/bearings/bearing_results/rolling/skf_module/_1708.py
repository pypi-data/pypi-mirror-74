...
class GreaseLifeAndRelubricationInterval(_1715.SKFCalculationResult):
    '''GreaseLifeAndRelubricationInterval
    ...
    def grease(self) -> '_1707.Grease':
        ...
        return constructor.new(_1707.Grease)(self.wrapped.Grease) if self.wrapped.Grease else None

    @property
    def initial_fill(self) -> '_1710.InitialFill':
        ...
        return constructor.new(_1710.InitialFill)(self.wrapped.InitialFill) if self.wrapped.InitialFill else None

    @property
    def grease_quantity(self) -> '_1709.GreaseQuantity':
        ...
        return constructor.new(_1709.GreaseQuantity)(self.wrapped.GreaseQuantity) if self.wrapped.GreaseQuantity else None
