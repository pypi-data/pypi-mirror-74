...
from mastapy.bearings.bearing_results.rolling.skf_module import _1688, _1704
...
class AdjustedSpeed(_1704.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1688.AdjustmentFactors':
        ...
        return constructor.new(_1688.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors else None
