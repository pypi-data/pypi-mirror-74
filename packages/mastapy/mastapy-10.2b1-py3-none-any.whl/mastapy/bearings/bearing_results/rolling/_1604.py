...
from mastapy.bearings.bearing_results.rolling import _1654
...
class LoadedAbstractSphericalRollerBearingStripLoadResults(_1654.LoadedRollerStripLoadResults):
    '''LoadedAbstractSphericalRollerBearingStripLoadResults
