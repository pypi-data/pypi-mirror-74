...
from mastapy.bearings.bearing_results.rolling import _1646
...
class LoadedAxialThrustCylindricalRollerBearingDutyCycle(_1646.LoadedNonBarrelRollerBearingDutyCycle):
    '''LoadedAxialThrustCylindricalRollerBearingDutyCycle
