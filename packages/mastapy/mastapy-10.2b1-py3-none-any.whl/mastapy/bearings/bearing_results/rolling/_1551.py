...
from mastapy.bearings.bearing_results.rolling import _1548
...
class LoadedAngularContactThrustBallBearingElement(_1548.LoadedAngularContactBallBearingElement):
    '''LoadedAngularContactThrustBallBearingElement
