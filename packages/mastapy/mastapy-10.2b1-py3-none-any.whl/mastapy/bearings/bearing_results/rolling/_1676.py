...
from mastapy.bearings.bearing_results.rolling import _1675, _1626
...
class LoadedThreePointContactBallBearingRow(_1626.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1675.LoadedThreePointContactBallBearingResults':
