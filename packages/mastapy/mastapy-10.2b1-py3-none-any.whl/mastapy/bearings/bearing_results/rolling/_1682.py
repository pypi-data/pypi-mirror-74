...
from mastapy.bearings.bearing_results.rolling import _1681, _1653
...
class LoadedToroidalRollerBearingRow(_1653.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1681.LoadedToroidalRollerBearingResults':
