...
from mastapy.bearings.bearing_results.rolling import _1634, _1587
...
class LoadedCylindricalRollerBearingResults(_1587.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def skf_maximal_constantly_acting_axial_load(self) -> '_1634.SKFMaximalConstantlyActingAxialLoadResults':
        ...
        return constructor.new(_1634.SKFMaximalConstantlyActingAxialLoadResults)(self.wrapped.SKFMaximalConstantlyActingAxialLoad) if self.wrapped.SKFMaximalConstantlyActingAxialLoad else None
