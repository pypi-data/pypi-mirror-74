...
from mastapy.bearings.bearing_results.rolling import _1559
...
class LoadedAxialThrustNeedleRollerBearingElement(_1559.LoadedAxialThrustCylindricalRollerBearingElement):
    '''LoadedAxialThrustNeedleRollerBearingElement
