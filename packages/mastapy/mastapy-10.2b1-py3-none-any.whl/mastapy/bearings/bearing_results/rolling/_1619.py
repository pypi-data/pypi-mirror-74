...
from mastapy.bearings.bearing_results.rolling import _1616
...
class LoadedAxialThrustNeedleRollerBearingElement(_1616.LoadedAxialThrustCylindricalRollerBearingElement):
    '''LoadedAxialThrustNeedleRollerBearingElement
