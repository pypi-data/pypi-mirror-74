...
from mastapy.bearings.bearing_results.rolling import _1665
...
class LoadedToroidalRollerBearingStripLoadResults(_1665.LoadedSphericalRollerRadialBearingStripLoadResults):
    '''LoadedToroidalRollerBearingStripLoadResults
