...
from mastapy.bearings.bearing_results.rolling import _1690, _1637
...
class LoadedRollerBearingElement(_1637.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1690.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1690.ResultsAtRollerOffset))
        return value
