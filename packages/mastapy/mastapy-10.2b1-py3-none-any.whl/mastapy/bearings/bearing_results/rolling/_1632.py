...
from mastapy.bearings.bearing_results.rolling import _1694, _1647
...
class LoadedCylindricalRollerBearingResults(_1647.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def skf_maximal_constantly_acting_axial_load(self) -> '_1694.SKFMaximalConstantlyActingAxialLoadResults':
        ...
        return constructor.new(_1694.SKFMaximalConstantlyActingAxialLoadResults)(self.wrapped.SKFMaximalConstantlyActingAxialLoad) if self.wrapped.SKFMaximalConstantlyActingAxialLoad else None
