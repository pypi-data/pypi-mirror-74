...
from mastapy.bearings.bearing_results.rolling import _1617
...
class LoadedAxialThrustNeedleRollerBearingResults(_1617.LoadedAxialThrustCylindricalRollerBearingResults):
    '''LoadedAxialThrustNeedleRollerBearingResults
