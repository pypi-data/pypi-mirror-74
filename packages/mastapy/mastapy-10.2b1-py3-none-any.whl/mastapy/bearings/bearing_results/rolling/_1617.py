...
from mastapy.bearings.bearing_results.rolling import _1647
...
class LoadedAxialThrustCylindricalRollerBearingResults(_1647.LoadedNonBarrelRollerBearingResults):
    '''LoadedAxialThrustCylindricalRollerBearingResults
