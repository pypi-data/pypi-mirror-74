...
from mastapy.bearings.bearing_results.rolling import _1563, _1561
...
class LoadedAxialThrustNeedleRollerBearingRow(_1561.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1563.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        return constructor.new(_1563.LoadedAxialThrustNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
