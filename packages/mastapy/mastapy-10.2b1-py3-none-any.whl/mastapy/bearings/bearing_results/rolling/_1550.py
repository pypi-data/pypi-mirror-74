...
from mastapy.bearings.bearing_results.rolling import _1549, _1569
...
class LoadedAngularContactBallBearingRow(_1569.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1549.LoadedAngularContactBallBearingResults':
