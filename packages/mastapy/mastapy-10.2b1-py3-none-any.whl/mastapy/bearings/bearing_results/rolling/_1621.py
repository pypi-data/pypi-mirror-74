...
from mastapy.bearings.bearing_results.rolling import _1620, _1618
...
class LoadedAxialThrustNeedleRollerBearingRow(_1618.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1620.LoadedAxialThrustNeedleRollerBearingResults':
