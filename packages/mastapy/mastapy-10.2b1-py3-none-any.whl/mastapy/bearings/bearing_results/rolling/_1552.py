...
from mastapy.bearings.bearing_results.rolling import _1549
...
class LoadedAngularContactThrustBallBearingResults(_1549.LoadedAngularContactBallBearingResults):
    '''LoadedAngularContactThrustBallBearingResults
