...
from mastapy.bearings import _1522
from mastapy.bearings.bearing_results.rolling.fitting import _1731, _1729, _1732
from mastapy.bearings.bearing_results.rolling import (
    _1600, _1597, _1684, _1657
)
from mastapy.bearings.bearing_results.rolling.iso_rating_results import (
    _1722, _1720, _1726, _1725,
    _1721, _1727, _1723
)
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling.skf_module import _1717
...
class LoadedRollingBearingResults(_1584.LoadedDetailedBearingResults):
    '''LoadedRollingBearingResults
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1522.FluidFilmTemperatureOptions':
        ...
        return constructor.new(_1522.FluidFilmTemperatureOptions)(value) if value else None
    ...
    @property
    def outer_ring_fitting_at_assembly(self) -> '_1731.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1731.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtAssembly) if self.wrapped.OuterRingFittingAtAssembly else None

    @property
    def outer_ring_fitting_at_operating_conditions(self) -> '_1731.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1731.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtOperatingConditions) if self.wrapped.OuterRingFittingAtOperatingConditions else None

    @property
    def inner_ring_fitting_at_assembly(self) -> '_1729.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1729.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtAssembly) if self.wrapped.InnerRingFittingAtAssembly else None

    @property
    def inner_ring_fitting_at_operating_conditions(self) -> '_1729.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1729.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtOperatingConditions) if self.wrapped.InnerRingFittingAtOperatingConditions else None

    @property
    def maximum_operating_internal_clearance(self) -> '_1600.InternalClearance':
        ...
        return constructor.new(_1600.InternalClearance)(self.wrapped.MaximumOperatingInternalClearance) if self.wrapped.MaximumOperatingInternalClearance else None

    @property
    def minimum_operating_internal_clearance(self) -> '_1600.InternalClearance':
        ...
        return constructor.new(_1600.InternalClearance)(self.wrapped.MinimumOperatingInternalClearance) if self.wrapped.MinimumOperatingInternalClearance else None

    @property
    def din732(self) -> '_1597.DIN732Results':
        ...
        return constructor.new(_1597.DIN732Results)(self.wrapped.DIN732) if self.wrapped.DIN732 else None

    @property
    def iso2812007(self) -> '_1722.ISO2812007Results':
        ...
        return constructor.new(_1722.ISO2812007Results)(self.wrapped.ISO2812007) if self.wrapped.ISO2812007 else None

    @property
    def iso2812007_of_type_ball_iso2812007_results(self) -> '_1720.BallISO2812007Results':
        ...
        if _1720.BallISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
        ...
        return constructor.new(_1720.BallISO2812007Results)(self.wrapped.ISO2812007) if self.wrapped.ISO2812007 else None

    @property
    def iso2812007_of_type_roller_iso2812007_results(self) -> '_1726.RollerISO2812007Results':
        ...
        if _1726.RollerISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
        ...
        return constructor.new(_1726.RollerISO2812007Results)(self.wrapped.ISO2812007) if self.wrapped.ISO2812007 else None

    @property
    def isots162812008(self) -> '_1725.ISOTS162812008Results':
        ...
        return constructor.new(_1725.ISOTS162812008Results)(self.wrapped.ISOTS162812008) if self.wrapped.ISOTS162812008 else None

    @property
    def isots162812008_of_type_ball_isots162812008_results(self) -> '_1721.BallISOTS162812008Results':
        ...
        if _1721.BallISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
        ...
        return constructor.new(_1721.BallISOTS162812008Results)(self.wrapped.ISOTS162812008) if self.wrapped.ISOTS162812008 else None

    @property
    def isots162812008_of_type_roller_isots162812008_results(self) -> '_1727.RollerISOTS162812008Results':
        ...
        if _1727.RollerISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
        ...
        return constructor.new(_1727.RollerISOTS162812008Results)(self.wrapped.ISOTS162812008) if self.wrapped.ISOTS162812008 else None

    @property
    def iso762006(self) -> '_1723.ISO762006Results':
        ...
        return constructor.new(_1723.ISO762006Results)(self.wrapped.ISO762006) if self.wrapped.ISO762006 else None

    @property
    def maximum_static_contact_stress(self) -> '_1684.MaximumStaticContactStress':
        ...
        return constructor.new(_1684.MaximumStaticContactStress)(self.wrapped.MaximumStaticContactStress) if self.wrapped.MaximumStaticContactStress else None

    @property
    def skf_module_results(self) -> '_1717.SKFModuleResults':
        ...
        return constructor.new(_1717.SKFModuleResults)(self.wrapped.SKFModuleResults) if self.wrapped.SKFModuleResults else None

    @property
    def rows(self) -> 'List[_1657.LoadedRollingBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1657.LoadedRollingBearingRow))
        return value

    @property
    def all_mounting_results(self) -> 'List[_1732.RingFittingThermalResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllMountingResults, constructor.new(_1732.RingFittingThermalResults))
        return value
