...
from mastapy.bearings.bearing_results.rolling import _1637, _1596
...
class LoadedBallBearingResults(_1596.LoadedRollingBearingResults):
    '''LoadedBallBearingResults
    ...
    @property
    def track_truncation(self) -> '_1637.TrackTruncationSafetyFactorResults':
        ...
        return constructor.new(_1637.TrackTruncationSafetyFactorResults)(self.wrapped.TrackTruncation) if self.wrapped.TrackTruncation else None
