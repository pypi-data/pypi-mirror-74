...
class LoadedNonBarrelRollerBearingRow(_1653.LoadedRollerBearingRow):
    '''LoadedNonBarrelRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1647.LoadedNonBarrelRollerBearingResults':
