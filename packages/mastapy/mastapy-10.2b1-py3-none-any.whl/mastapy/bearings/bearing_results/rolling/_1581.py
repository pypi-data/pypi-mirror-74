...
from mastapy.bearings.bearing_results.rolling import _1580, _1579, _1569
...
class LoadedFourPointContactBallBearingRow(_1569.LoadedBallBearingRow):
    '''LoadedFourPointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1580.LoadedFourPointContactBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1579.LoadedFourPointContactBallBearingRaceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RaceResults, constructor.new(_1579.LoadedFourPointContactBallBearingRaceResults))
        return value
