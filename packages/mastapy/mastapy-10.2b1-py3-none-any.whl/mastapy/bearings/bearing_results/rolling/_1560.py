...
from mastapy.bearings.bearing_results.rolling import _1587
...
class LoadedAxialThrustCylindricalRollerBearingResults(_1587.LoadedNonBarrelRollerBearingResults):
    '''LoadedAxialThrustCylindricalRollerBearingResults
