...
from mastapy.bearings.bearing_results.rolling import _1555, _1593
...
class LoadedAsymmetricSphericalRollerBearingRow(_1593.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1555.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        return constructor.new(_1555.LoadedAsymmetricSphericalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
