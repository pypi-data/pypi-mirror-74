...
from mastapy.bearings.bearing_results import _1590
...
from mastapy.bearings.bearing_results.rolling import _1691
...
class LoadedBearingResults(_1515.BearingLoadCaseResultsLightweight):
    '''LoadedBearingResults
    ...
    @property
    def force_on_inner_race(self) -> '_1124.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1124.VectorWithLinearAndAngularComponents)(self.wrapped.ForceOnInnerRace) if self.wrapped.ForceOnInnerRace else None

    @property
    def bearing(self) -> '_1744.BearingDesign':
        ...
        return constructor.new(_1744.BearingDesign)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_detailed_bearing(self) -> '_1745.DetailedBearing':
        ...
        if _1745.DetailedBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1745.DetailedBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_dummy_rolling_bearing(self) -> '_1746.DummyRollingBearing':
        ...
        if _1746.DummyRollingBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1746.DummyRollingBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_linear_bearing(self) -> '_1747.LinearBearing':
        ...
        if _1747.LinearBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
            raise CastException('Failed to cast bearing to LinearBearing. Expected: {}.'.format(self.wrapped.Bearing.__class__.__qualname__))

        return constructor.new(_1747.LinearBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_non_linear_bearing(self) -> '_1748.NonLinearBearing':
        ...
        if _1748.NonLinearBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1748.NonLinearBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_angular_contact_ball_bearing(self) -> '_1749.AngularContactBallBearing':
        ...
        if _1749.AngularContactBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1749.AngularContactBallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_angular_contact_thrust_ball_bearing(self) -> '_1750.AngularContactThrustBallBearing':
        ...
        if _1750.AngularContactThrustBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1750.AngularContactThrustBallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_asymmetric_spherical_roller_bearing(self) -> '_1751.AsymmetricSphericalRollerBearing':
        ...
        if _1751.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1751.AsymmetricSphericalRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1752.AxialThrustCylindricalRollerBearing':
        ...
        if _1752.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1752.AxialThrustCylindricalRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_axial_thrust_needle_roller_bearing(self) -> '_1753.AxialThrustNeedleRollerBearing':
        ...
        if _1753.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1753.AxialThrustNeedleRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_ball_bearing(self) -> '_1754.BallBearing':
        ...
        if _1754.BallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
            raise CastException('Failed to cast bearing to BallBearing. Expected: {}.'.format(self.wrapped.Bearing.__class__.__qualname__))

        return constructor.new(_1754.BallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_barrel_roller_bearing(self) -> '_1756.BarrelRollerBearing':
        ...
        if _1756.BarrelRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1756.BarrelRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_crossed_roller_bearing(self) -> '_1761.CrossedRollerBearing':
        ...
        if _1761.CrossedRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1761.CrossedRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_cylindrical_roller_bearing(self) -> '_1762.CylindricalRollerBearing':
        ...
        if _1762.CylindricalRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1762.CylindricalRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_deep_groove_ball_bearing(self) -> '_1763.DeepGrooveBallBearing':
        ...
        if _1763.DeepGrooveBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1763.DeepGrooveBallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_four_point_contact_ball_bearing(self) -> '_1765.FourPointContactBallBearing':
        ...
        if _1765.FourPointContactBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1765.FourPointContactBallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_multi_point_contact_ball_bearing(self) -> '_1767.MultiPointContactBallBearing':
        ...
        if _1767.MultiPointContactBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1767.MultiPointContactBallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_needle_roller_bearing(self) -> '_1768.NeedleRollerBearing':
        ...
        if _1768.NeedleRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1768.NeedleRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_non_barrel_roller_bearing(self) -> '_1769.NonBarrelRollerBearing':
        ...
        if _1769.NonBarrelRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1769.NonBarrelRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_roller_bearing(self) -> '_1770.RollerBearing':
        ...
        if _1770.RollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
            raise CastException('Failed to cast bearing to RollerBearing. Expected: {}.'.format(self.wrapped.Bearing.__class__.__qualname__))

        return constructor.new(_1770.RollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_rolling_bearing(self) -> '_1773.RollingBearing':
        ...
        if _1773.RollingBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
            raise CastException('Failed to cast bearing to RollingBearing. Expected: {}.'.format(self.wrapped.Bearing.__class__.__qualname__))

        return constructor.new(_1773.RollingBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_self_aligning_ball_bearing(self) -> '_1774.SelfAligningBallBearing':
        ...
        if _1774.SelfAligningBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1774.SelfAligningBallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_spherical_roller_bearing(self) -> '_1776.SphericalRollerBearing':
        ...
        if _1776.SphericalRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1776.SphericalRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_spherical_roller_thrust_bearing(self) -> '_1777.SphericalRollerThrustBearing':
        ...
        if _1777.SphericalRollerThrustBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1777.SphericalRollerThrustBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_taper_roller_bearing(self) -> '_1778.TaperRollerBearing':
        ...
        if _1778.TaperRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1778.TaperRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_three_point_contact_ball_bearing(self) -> '_1779.ThreePointContactBallBearing':
        ...
        if _1779.ThreePointContactBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1779.ThreePointContactBallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_thrust_ball_bearing(self) -> '_1780.ThrustBallBearing':
        ...
        if _1780.ThrustBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1780.ThrustBallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_toroidal_roller_bearing(self) -> '_1781.ToroidalRollerBearing':
        ...
        if _1781.ToroidalRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1781.ToroidalRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_pad_fluid_film_bearing(self) -> '_1794.PadFluidFilmBearing':
        ...
        if _1794.PadFluidFilmBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1794.PadFluidFilmBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_plain_grease_filled_journal_bearing(self) -> '_1796.PlainGreaseFilledJournalBearing':
        ...
        if _1796.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1796.PlainGreaseFilledJournalBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_plain_journal_bearing(self) -> '_1798.PlainJournalBearing':
        ...
        if _1798.PlainJournalBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1798.PlainJournalBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_plain_oil_fed_journal_bearing(self) -> '_1800.PlainOilFedJournalBearing':
        ...
        if _1800.PlainOilFedJournalBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1800.PlainOilFedJournalBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_tilting_pad_journal_bearing(self) -> '_1801.TiltingPadJournalBearing':
        ...
        if _1801.TiltingPadJournalBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1801.TiltingPadJournalBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_tilting_pad_thrust_bearing(self) -> '_1802.TiltingPadThrustBearing':
        ...
        if _1802.TiltingPadThrustBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1802.TiltingPadThrustBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_concept_axial_clearance_bearing(self) -> '_1804.ConceptAxialClearanceBearing':
        ...
        if _1804.ConceptAxialClearanceBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1804.ConceptAxialClearanceBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_concept_clearance_bearing(self) -> '_1805.ConceptClearanceBearing':
        ...
        if _1805.ConceptClearanceBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1805.ConceptClearanceBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_concept_radial_clearance_bearing(self) -> '_1806.ConceptRadialClearanceBearing':
        ...
        if _1806.ConceptRadialClearanceBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1806.ConceptRadialClearanceBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def ring_results(self) -> 'List[_1691.RingForceAndDisplacement]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingResults, constructor.new(_1691.RingForceAndDisplacement))
        return value
