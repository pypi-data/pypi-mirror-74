...
from mastapy.bearings.bearing_results import _1538
...
class BearingStiffnessMatrixReporter(_1.APIBase):
    '''BearingStiffnessMatrixReporter
    ...
    @property
    def rows(self) -> 'List[_1538.StiffnessRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1538.StiffnessRow))
        return value
