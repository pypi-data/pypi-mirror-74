...
from mastapy.bearings.bearing_results import _1530
...
class LoadedDetailedBearingResults(_1530.LoadedNonLinearBearingResults):
    '''LoadedDetailedBearingResults
    ...
    @property
    def lubrication(self) -> '_259.LubricationDetail':
        ...
        return constructor.new(_259.LubricationDetail)(self.wrapped.Lubrication) if self.wrapped.Lubrication else None
