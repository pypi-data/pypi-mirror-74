...
class SafetyFactorGroup(_1.APIBase):
    '''SafetyFactorGroup
    ...
    @property
    def items(self) -> 'List[_266.SafetyFactorItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Items, constructor.new(_266.SafetyFactorItem))
        return value
