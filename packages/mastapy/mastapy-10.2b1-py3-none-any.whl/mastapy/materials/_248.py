...
class GeneralTransmissionProperties(_1.APIBase):
    '''GeneralTransmissionProperties
    ...
    @property
    def transmission_application(self) -> '_272.TransmissionApplications':
        ...
        return constructor.new(_272.TransmissionApplications)(value) if value else None

    @transmission_application.setter
    def transmission_application(self, value: '_272.TransmissionApplications'):
    ...
    @property
    def bearing_iso762006_static_safety_factor_limit(self) -> '_251.ISO76StaticSafetyFactorLimits':
        ...
        return constructor.new(_251.ISO76StaticSafetyFactorLimits)(value) if value else None

    @bearing_iso762006_static_safety_factor_limit.setter
    def bearing_iso762006_static_safety_factor_limit(self, value: '_251.ISO76StaticSafetyFactorLimits'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def wind_turbine_standard(self) -> '_275.WindTurbineStandards':
        ...
        return constructor.new(_275.WindTurbineStandards)(value) if value else None

    @wind_turbine_standard.setter
    def wind_turbine_standard(self, value: '_275.WindTurbineStandards'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def driving_machine_characteristics(self) -> '_276.WorkingCharacteristics':
        ...
        return constructor.new(_276.WorkingCharacteristics)(value) if value else None

    @driving_machine_characteristics.setter
    def driving_machine_characteristics(self, value: '_276.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivingMachineCharacteristics = value

    @property
    def driven_machine_characteristics(self) -> '_276.WorkingCharacteristics':
    ...
    def driven_machine_characteristics(self, value: '_276.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivenMachineCharacteristics = value

    @property
    def gearing_type(self) -> '_247.GearingTypes':
        '''GearingTypes: 'GearingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.GearingType)
        return constructor.new(_247.GearingTypes)(value) if value else None

    @gearing_type.setter
    def gearing_type(self, value: '_247.GearingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def vehicle_dynamics(self) -> '_274.VehicleDynamicsProperties':
        ...
        return constructor.new(_274.VehicleDynamicsProperties)(self.wrapped.VehicleDynamics) if self.wrapped.VehicleDynamics else None

    @property
    def air_properties(self) -> '_231.AirProperties':
        ...
        return constructor.new(_231.AirProperties)(self.wrapped.AirProperties) if self.wrapped.AirProperties else None
