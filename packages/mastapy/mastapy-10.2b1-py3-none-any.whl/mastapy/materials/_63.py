...
class GeneralTransmissionProperties(_0.APIBase):
    ...
    @property
    def transmission_application(self) -> '_92.TransmissionApplications':
        ...
        return constructor.new(_92.TransmissionApplications)(value) if value else None

    @transmission_application.setter
    def transmission_application(self, value: '_92.TransmissionApplications'):
    ...
    @property
    def bearing_iso762006_static_safety_factor_limit(self) -> '_66.ISO76StaticSafetyFactorLimits':
        ...
        return constructor.new(_66.ISO76StaticSafetyFactorLimits)(value) if value else None

    @bearing_iso762006_static_safety_factor_limit.setter
    def bearing_iso762006_static_safety_factor_limit(self, value: '_66.ISO76StaticSafetyFactorLimits'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def wind_turbine_standard(self) -> '_95.WindTurbineStandards':
        ...
        return constructor.new(_95.WindTurbineStandards)(value) if value else None

    @wind_turbine_standard.setter
    def wind_turbine_standard(self, value: '_95.WindTurbineStandards'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def driving_machine_characteristics(self) -> '_96.WorkingCharacteristics':
        ...
        return constructor.new(_96.WorkingCharacteristics)(value) if value else None

    @driving_machine_characteristics.setter
    def driving_machine_characteristics(self, value: '_96.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivingMachineCharacteristics = value

    @property
    def driven_machine_characteristics(self) -> '_96.WorkingCharacteristics':
    ...
    def driven_machine_characteristics(self, value: '_96.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @gearing_type.setter
    def gearing_type(self, value: '_62.GearingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def vehicle_dynamics(self) -> '_94.VehicleDynamicsProperties':
        ...
        return constructor.new(_94.VehicleDynamicsProperties)(self.wrapped.VehicleDynamics) if self.wrapped.VehicleDynamics else None

    @property
    def air_properties(self) -> '_50.AirProperties':
        ...
        return constructor.new(_50.AirProperties)(self.wrapped.AirProperties) if self.wrapped.AirProperties else None
