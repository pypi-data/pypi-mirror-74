...
from mastapy.bolts import _1057, _1038
...
class BoltMaterial(_1038.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1057.StrengthGrades':
        ...
        return constructor.new(_1057.StrengthGrades)(value) if value else None

    @strength_grade.setter
    def strength_grade(self, value: '_1057.StrengthGrades'):
