...
class LoadedBolt(_1.APIBase):
    ...
    @property
    def axial_load_type(self) -> '_1189.AxialLoadType':
        ...
        return constructor.new(_1189.AxialLoadType)(value) if value else None

    @axial_load_type.setter
    def axial_load_type(self, value: '_1189.AxialLoadType'):
    ...
    @property
    def joint_type(self) -> '_1204.JointTypes':
        '''JointTypes: 'JointType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.JointType)
        return constructor.new(_1204.JointTypes)(value) if value else None

    @joint_type.setter
    def joint_type(self, value: '_1204.JointTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def number_of_steps_for_fsub_mminsub_table_a7(self) -> 'int':
        '''int: 'NumberOfStepsForFsubMminsubTableA7' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.NumberOfStepsForFsubMminsubTableA7

    @property
    def number_of_steps_for_fsub_mmaxsub_table_a7(self) -> 'int':
        '''int: 'NumberOfStepsForFsubMmaxsubTableA7' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.NumberOfStepsForFsubMmaxsubTableA7

    @property
    def joint_is_to_be_designed_with_fsub_qmaxsub(self) -> 'bool':
        '''bool: 'JointIsToBeDesignedWithFsubQmaxsub' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.JointIsToBeDesignedWithFsubQmaxsub
    ...
    @property
    def tightening_technique(self) -> '_1210.TighteningTechniques':
        ...
        return constructor.new(_1210.TighteningTechniques)(value) if value else None

    @tightening_technique.setter
    def tightening_technique(self, value: '_1210.TighteningTechniques'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TighteningTechnique = value

    @property
    def bolt(self) -> '_1200.DetailedBoltDesign':
        ...
        return constructor.new(_1200.DetailedBoltDesign)(self.wrapped.Bolt) if self.wrapped.Bolt else None
