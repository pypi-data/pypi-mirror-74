...
from mastapy.detailed_rigid_connectors.splines import (
    _1136, _1153, _1128, _1131,
    _1138, _1146, _1135, _1139
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1159
...
class SplineHalfDesign(_1126.DetailedRigidConnectorHalfDesign):
    '''SplineHalfDesign
    ...
    @property
    def heat_treatment(self) -> '_1136.HeatTreatmentTypes':
        ...
        return constructor.new(_1136.HeatTreatmentTypes)(value) if value else None

    @heat_treatment.setter
    def heat_treatment(self, value: '_1136.HeatTreatmentTypes'):
    ...
    @property
    def fit_and_tolerance(self) -> '_1159.FitAndTolerance':
        ...
        return constructor.new(_1159.FitAndTolerance)(self.wrapped.FitAndTolerance) if self.wrapped.FitAndTolerance else None
