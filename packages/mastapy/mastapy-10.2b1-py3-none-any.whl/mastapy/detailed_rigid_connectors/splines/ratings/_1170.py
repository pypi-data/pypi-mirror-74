...
from mastapy.detailed_rigid_connectors.splines.ratings import _1169
...
class SplineJointRating(_1174.ShaftHubConnectionRating):
    '''SplineJointRating
    ...
    @property
    def spline_half_ratings(self) -> 'List[_1169.SplineHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SplineHalfRatings, constructor.new(_1169.SplineHalfRating))
        return value
