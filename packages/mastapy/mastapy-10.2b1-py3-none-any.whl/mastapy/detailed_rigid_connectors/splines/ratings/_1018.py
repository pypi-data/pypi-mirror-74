...
from mastapy.detailed_rigid_connectors.splines.ratings import _1017
...
class SplineJointRating(_1022.ShaftHubConnectionRating):
    '''SplineJointRating
    ...
    @property
    def spline_half_ratings(self) -> 'List[_1017.SplineHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SplineHalfRatings, constructor.new(_1017.SplineHalfRating))
        return value
