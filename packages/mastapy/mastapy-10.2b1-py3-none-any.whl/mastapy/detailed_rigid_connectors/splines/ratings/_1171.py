...
from mastapy.detailed_rigid_connectors.splines.ratings import _1170
from mastapy.detailed_rigid_connectors.rating import _1175
...
class SplineJointRating(_1175.ShaftHubConnectionRating):
    '''SplineJointRating
    ...
    @property
    def spline_half_ratings(self) -> 'List[_1170.SplineHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SplineHalfRatings, constructor.new(_1170.SplineHalfRating))
        return value
