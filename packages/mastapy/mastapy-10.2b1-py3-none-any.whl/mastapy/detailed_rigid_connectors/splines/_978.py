...
from mastapy.detailed_rigid_connectors.splines import _988, _997, _1005
...
class DIN5480SplineHalfDesign(_1005.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_988.ManufacturingTypes':
        ...
        return constructor.new(_988.ManufacturingTypes)(value) if value else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_988.ManufacturingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ManufacturingType = value

    @property
    def finishing_method(self) -> '_997.FinishingMethods':
        ...
        return constructor.new(_997.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_997.FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
