...
from mastapy.detailed_rigid_connectors.splines import (
    _1132, _1143, _1155, _1147,
    _1144, _1151, _1152, _1127,
    _1130, _1137, _1145, _1134
)
...
class SplineJointDesign(_1125.DetailedRigidConnectorDesign):
    '''SplineJointDesign
    ...
    def dudley_maximum_effective_length_option(self) -> 'enum_with_selected_value.EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption)(self.wrapped.DudleyMaximumEffectiveLengthOption) if self.wrapped.DudleyMaximumEffectiveLengthOption else None
    ...
    def dudley_maximum_effective_length_option(self, value: 'enum_with_selected_value.EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption.implicit_type()'):
        wrapper_type = enum_with_selected_value.EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption.TYPE
    ...
    @property
    def root_type(self) -> '_1143.RootTypes':
        '''RootTypes: 'RootType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.RootType)
        return constructor.new(_1143.RootTypes)(value) if value else None

    @root_type.setter
    def root_type(self, value: '_1143.RootTypes'):
    ...
    def spline_rating_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_SplineRatingTypes':
        ...
        return constructor.new(enum_with_selected_value.EnumWithSelectedValue_SplineRatingTypes)(self.wrapped.SplineRatingType) if self.wrapped.SplineRatingType else None
    ...
    def spline_rating_type(self, value: 'enum_with_selected_value.EnumWithSelectedValue_SplineRatingTypes.implicit_type()'):
        wrapper_type = enum_with_selected_value.EnumWithSelectedValue_SplineRatingTypes.TYPE
    ...
    @property
    def torque_cycles(self) -> '_1147.SAETorqueCycles':
        ...
        return constructor.new(_1147.SAETorqueCycles)(value) if value else None

    @torque_cycles.setter
    def torque_cycles(self, value: '_1147.SAETorqueCycles'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TorqueCycles = value

    @property
    def fatigue_life_factor_type(self) -> '_1144.SAEFatigueLifeFactorTypes':
        ...
        return constructor.new(_1144.SAEFatigueLifeFactorTypes)(value) if value else None

    @fatigue_life_factor_type.setter
    def fatigue_life_factor_type(self, value: '_1144.SAEFatigueLifeFactorTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FatigueLifeFactorType = value

    @property
    def spline_fixture_type(self) -> '_1151.SplineFixtureTypes':
        ...
        return constructor.new(_1151.SplineFixtureTypes)(value) if value else None

    @spline_fixture_type.setter
    def spline_fixture_type(self, value: '_1151.SplineFixtureTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def external_half(self) -> '_1152.SplineHalfDesign':
        ...
        return constructor.new(_1152.SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_custom_spline_half_design(self) -> '_1127.CustomSplineHalfDesign':
        ...
        if self.wrapped.ExternalHalf.__class__.__qualname__ != 'CustomSplineHalfDesign':
        ...
        return constructor.new(_1127.CustomSplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_din5480_spline_half_design(self) -> '_1130.DIN5480SplineHalfDesign':
        ...
        if self.wrapped.ExternalHalf.__class__.__qualname__ != 'DIN5480SplineHalfDesign':
        ...
        return constructor.new(_1130.DIN5480SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_iso4156_spline_half_design(self) -> '_1137.ISO4156SplineHalfDesign':
        ...
        if self.wrapped.ExternalHalf.__class__.__qualname__ != 'ISO4156SplineHalfDesign':
        ...
        return constructor.new(_1137.ISO4156SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_sae_spline_half_design(self) -> '_1145.SAESplineHalfDesign':
        ...
        if self.wrapped.ExternalHalf.__class__.__qualname__ != 'SAESplineHalfDesign':
        ...
        return constructor.new(_1145.SAESplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_gbt3478_spline_half_design(self) -> '_1134.GBT3478SplineHalfDesign':
        ...
        if self.wrapped.ExternalHalf.__class__.__qualname__ != 'GBT3478SplineHalfDesign':
        ...
        return constructor.new(_1134.GBT3478SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def internal_half(self) -> '_1152.SplineHalfDesign':
        ...
        return constructor.new(_1152.SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_custom_spline_half_design(self) -> '_1127.CustomSplineHalfDesign':
        ...
        if self.wrapped.InternalHalf.__class__.__qualname__ != 'CustomSplineHalfDesign':
        ...
        return constructor.new(_1127.CustomSplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_din5480_spline_half_design(self) -> '_1130.DIN5480SplineHalfDesign':
        ...
        if self.wrapped.InternalHalf.__class__.__qualname__ != 'DIN5480SplineHalfDesign':
        ...
        return constructor.new(_1130.DIN5480SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_iso4156_spline_half_design(self) -> '_1137.ISO4156SplineHalfDesign':
        ...
        if self.wrapped.InternalHalf.__class__.__qualname__ != 'ISO4156SplineHalfDesign':
        ...
        return constructor.new(_1137.ISO4156SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_sae_spline_half_design(self) -> '_1145.SAESplineHalfDesign':
        ...
        if self.wrapped.InternalHalf.__class__.__qualname__ != 'SAESplineHalfDesign':
        ...
        return constructor.new(_1145.SAESplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_gbt3478_spline_half_design(self) -> '_1134.GBT3478SplineHalfDesign':
        ...
        if self.wrapped.InternalHalf.__class__.__qualname__ != 'GBT3478SplineHalfDesign':
        ...
        return constructor.new(_1134.GBT3478SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None
