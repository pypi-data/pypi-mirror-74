...
from mastapy.detailed_rigid_connectors.splines import (
    _984, _1001, _976, _979,
    _983, _986, _987, _994,
    _1006
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1007
from mastapy.detailed_rigid_connectors import _974
...
class SplineHalfDesign(_974.DetailedRigidConnectorHalfDesign):
    '''SplineHalfDesign
    ...
    @property
    def heat_treatment(self) -> '_984.HeatTreatmentTypes':
        ...
        return constructor.new(_984.HeatTreatmentTypes)(value) if value else None

    @heat_treatment.setter
    def heat_treatment(self, value: '_984.HeatTreatmentTypes'):
    ...
    @property
    def fit_and_tolerance(self) -> '_1007.FitAndTolerance':
        ...
        return constructor.new(_1007.FitAndTolerance)(self.wrapped.FitAndTolerance) if self.wrapped.FitAndTolerance else None
