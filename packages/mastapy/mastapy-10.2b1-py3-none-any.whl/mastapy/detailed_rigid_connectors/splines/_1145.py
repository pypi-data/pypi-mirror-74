...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1160
from mastapy.detailed_rigid_connectors.splines import _1157
...
class SAESplineHalfDesign(_1157.StandardSplineHalfDesign):
    '''SAESplineHalfDesign
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_1160.SAESplineTolerances':
        ...
        return constructor.new(_1160.SAESplineTolerances)(self.wrapped.SAEAccuracyAndTolerance) if self.wrapped.SAEAccuracyAndTolerance else None
