...
from mastapy.detailed_rigid_connectors.splines import _981, _1006
...
class SAESplineJointDesign(_1006.StandardSplineJointDesign):
    '''SAESplineJointDesign
    ...
    @property
    def fit_type(self) -> '_981.FitTypes':
        '''FitTypes: 'FitType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FitType)
        return constructor.new(_981.FitTypes)(value) if value else None

    @fit_type.setter
    def fit_type(self, value: '_981.FitTypes'):
