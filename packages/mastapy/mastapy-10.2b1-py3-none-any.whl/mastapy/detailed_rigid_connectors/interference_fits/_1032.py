...
from mastapy.bearings.tolerances import _1556, _1543, _1549
...
class InterferenceFitHalfDesign(_974.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1033.StressRegions':
        ...
        return constructor.new(_1033.StressRegions)(value) if value else None
    ...
    @property
    def tolerance(self) -> '_1556.SupportTolerance':
        ...
        return constructor.new(_1556.SupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None

    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1543.InnerSupportTolerance':
        ...
        if _1543.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
        ...
        return constructor.new(_1543.InnerSupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None

    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1549.OuterSupportTolerance':
        ...
        if _1549.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
        ...
        return constructor.new(_1549.OuterSupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None
