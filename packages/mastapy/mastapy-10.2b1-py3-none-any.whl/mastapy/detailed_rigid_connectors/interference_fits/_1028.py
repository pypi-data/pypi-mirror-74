...
from mastapy.detailed_rigid_connectors.interference_fits import _1027, _1026, _1031
...
class InterferenceFitDesign(_970.DetailedRigidConnectorDesign):
    '''InterferenceFitDesign
    ...
    @property
    def calculation_method(self) -> '_1027.CalculationMethods':
        ...
        return constructor.new(_1027.CalculationMethods)(value) if value else None

    @calculation_method.setter
    def calculation_method(self, value: '_1027.CalculationMethods'):
    ...
    @property
    def assembly_method(self) -> '_1026.AssemblyMethods':
        ...
        return constructor.new(_1026.AssemblyMethods)(value) if value else None

    @assembly_method.setter
    def assembly_method(self, value: '_1026.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
