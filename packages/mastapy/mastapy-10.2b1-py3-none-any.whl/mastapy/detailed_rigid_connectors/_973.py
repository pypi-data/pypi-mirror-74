...
class DetailedRigidConnectorDesign(_0.APIBase):
    ...
    @property
    def halves(self) -> 'List[_974.DetailedRigidConnectorHalfDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Halves, constructor.new(_974.DetailedRigidConnectorHalfDesign))
        return value
