...
from mastapy.detailed_rigid_connectors.keyed_joints import _1026, _1024
...
class KeyedJointDesign(_1031.InterferenceFitDesign):
    '''KeyedJointDesign
