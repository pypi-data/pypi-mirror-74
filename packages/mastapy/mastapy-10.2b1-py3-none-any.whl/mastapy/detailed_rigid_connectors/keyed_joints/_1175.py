...
from mastapy.detailed_rigid_connectors.keyed_joints import _1178, _1176
...
class KeyedJointDesign(_1183.InterferenceFitDesign):
    '''KeyedJointDesign
