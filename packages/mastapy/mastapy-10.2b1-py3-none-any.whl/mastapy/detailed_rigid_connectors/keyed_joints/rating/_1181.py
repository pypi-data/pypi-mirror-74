...
from mastapy.detailed_rigid_connectors.interference_fits.rating import _1188
...
class KeywayRating(_1188.InterferenceFitRating):
    '''KeywayRating
    ...
    @property
    def keyed_joint_design(self) -> '_1176.KeyedJointDesign':
        ...
        return constructor.new(_1176.KeyedJointDesign)(self.wrapped.KeyedJointDesign) if self.wrapped.KeyedJointDesign else None

    @property
    def keyway_half_ratings(self) -> 'List[_1180.KeywayHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KeywayHalfRatings, constructor.new(_1180.KeywayHalfRating))
        return value
