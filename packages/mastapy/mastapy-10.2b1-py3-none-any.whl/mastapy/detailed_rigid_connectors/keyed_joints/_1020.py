...
from mastapy.detailed_rigid_connectors.keyed_joints import _1023, _1021
...
class KeyedJointDesign(_1028.InterferenceFitDesign):
    '''KeyedJointDesign
