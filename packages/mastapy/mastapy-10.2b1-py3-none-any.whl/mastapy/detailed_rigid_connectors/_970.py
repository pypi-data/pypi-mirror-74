...
from mastapy.detailed_rigid_connectors import _971
...
class DetailedRigidConnectorDesign(_0.APIBase):
    ...
    @property
    def twod_spline_drawing(self) -> '_6503.SMTBitmap':
        ...
        return constructor.new(_6503.SMTBitmap)(self.wrapped.TwoDSplineDrawing) if self.wrapped.TwoDSplineDrawing else None

    @property
    def halves(self) -> 'List[_971.DetailedRigidConnectorHalfDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Halves, constructor.new(_971.DetailedRigidConnectorHalfDesign))
        return value
