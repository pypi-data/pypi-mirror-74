...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1143.RoundingMethods':
        ...
        return constructor.new(_1143.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1143.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1155.Unit':
        ...
        return constructor.new(_1155.Unit)(self.wrapped.CurrentUnit) if self.wrapped.CurrentUnit else None
