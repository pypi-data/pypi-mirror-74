...
from mastapy.utility.units_and_measurements import _1038
...
class MeasurementSettings(_78.PerMachineSettings):
    '''MeasurementSettings
    ...
    @property
    def current_selected_measurement(self) -> '_1038.MeasurementBase':
        ...
        return constructor.new(_1038.MeasurementBase)(self.wrapped.CurrentSelectedMeasurement) if self.wrapped.CurrentSelectedMeasurement else None
