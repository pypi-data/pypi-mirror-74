...
from mastapy.html import _108
from mastapy._internal.implicit import overridable
from mastapy.utility.report import _1288
...
class CustomReportText(_1288.CustomReportDefinitionItem):
    '''CustomReportText
    ...
    @property
    def heading_type(self) -> '_108.HeadingType':
        '''HeadingType: 'HeadingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingType)
        return constructor.new(_108.HeadingType)(value) if value else None

    @heading_type.setter
    def heading_type(self, value: '_108.HeadingType'):
