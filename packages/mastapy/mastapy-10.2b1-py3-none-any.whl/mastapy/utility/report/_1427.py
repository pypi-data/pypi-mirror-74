...
from mastapy.utility.report import _1426, _1420
...
class UserTextRow(_1420.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1426.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1426.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1426.HeadingSize'):
