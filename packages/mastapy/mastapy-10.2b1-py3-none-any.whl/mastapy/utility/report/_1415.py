...
from mastapy.utility.report import _1425, _1424
from mastapy._internal import constructor, conversion
from mastapy.utility.reporting_property_framework import _1389
...
class CustomReportPropertyItem(_1.APIBase):
    '''CustomReportPropertyItem
    ...
    @property
    def font_weight(self) -> '_1425.FontWeight':
        '''FontWeight: 'FontWeight' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FontWeight)
        return constructor.new(_1425.FontWeight)(value) if value else None

    @font_weight.setter
    def font_weight(self, value: '_1425.FontWeight'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FontWeight = value

    @property
    def font_style(self) -> '_1424.FontStyle':
        '''FontStyle: 'FontStyle' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FontStyle)
        return constructor.new(_1424.FontStyle)(value) if value else None

    @font_style.setter
    def font_style(self, value: '_1424.FontStyle'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FontStyle = value

    @property
    def horizontal_position(self) -> '_1389.CellValuePosition':
        ...
        return constructor.new(_1389.CellValuePosition)(value) if value else None

    @horizontal_position.setter
    def horizontal_position(self, value: '_1389.CellValuePosition'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
