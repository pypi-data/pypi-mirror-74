...
from mastapy.html import _278
from mastapy._internal.implicit import overridable
from mastapy.utility.report import _1403
...
class CustomReportText(_1403.CustomReportDefinitionItem):
    '''CustomReportText
    ...
    @property
    def heading_type(self) -> '_278.HeadingType':
        '''HeadingType: 'HeadingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingType)
        return constructor.new(_278.HeadingType)(value) if value else None

    @heading_type.setter
    def heading_type(self, value: '_278.HeadingType'):
