...
from mastapy.utility_gui.charts import _1506, _1507
from mastapy.bearings.bearing_results import _1577, _1580, _1588
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2371
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3563
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4851, _4855
...
class DynamicCustomReportItem(_1299.CustomReportNameableItem):
    ...
    @property
    def inner_item_of_type_custom_line_chart(self) -> '_1506.CustomLineChart':
        ...
        if _1506.CustomLineChart.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
        ...
        return constructor.new(_1506.CustomLineChart)(self.wrapped.InnerItem) if self.wrapped.InnerItem else None

    @property
    def inner_item_of_type_custom_table_and_chart(self) -> '_1507.CustomTableAndChart':
        ...
        if _1507.CustomTableAndChart.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
        ...
        return constructor.new(_1507.CustomTableAndChart)(self.wrapped.InnerItem) if self.wrapped.InnerItem else None

    @property
    def inner_item_of_type_loaded_bearing_chart_reporter(self) -> '_1577.LoadedBearingChartReporter':
        ...
        if _1577.LoadedBearingChartReporter.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
        ...
        return constructor.new(_1577.LoadedBearingChartReporter)(self.wrapped.InnerItem) if self.wrapped.InnerItem else None

    @property
    def inner_item_of_type_loaded_bearing_temperature_chart(self) -> '_1580.LoadedBearingTemperatureChart':
        ...
        if _1580.LoadedBearingTemperatureChart.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
        ...
        return constructor.new(_1580.LoadedBearingTemperatureChart)(self.wrapped.InnerItem) if self.wrapped.InnerItem else None

    @property
    def inner_item_of_type_loaded_roller_element_chart_reporter(self) -> '_1588.LoadedRollerElementChartReporter':
        ...
        if _1588.LoadedRollerElementChartReporter.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
        ...
        return constructor.new(_1588.LoadedRollerElementChartReporter)(self.wrapped.InnerItem) if self.wrapped.InnerItem else None

    @property
    def inner_item_of_type_shaft_system_deflection_sections_report(self) -> '_2371.ShaftSystemDeflectionSectionsReport':
        ...
        if _2371.ShaftSystemDeflectionSectionsReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
        ...
        return constructor.new(_2371.ShaftSystemDeflectionSectionsReport)(self.wrapped.InnerItem) if self.wrapped.InnerItem else None

    @property
    def inner_item_of_type_parametric_study_histogram(self) -> '_3563.ParametricStudyHistogram':
        ...
        if _3563.ParametricStudyHistogram.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
        ...
        return constructor.new(_3563.ParametricStudyHistogram)(self.wrapped.InnerItem) if self.wrapped.InnerItem else None

    @property
    def inner_item_of_type_campbell_diagram_report(self) -> '_4851.CampbellDiagramReport':
        ...
        if _4851.CampbellDiagramReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
        ...
        return constructor.new(_4851.CampbellDiagramReport)(self.wrapped.InnerItem) if self.wrapped.InnerItem else None

    @property
    def inner_item_of_type_per_mode_results_report(self) -> '_4855.PerModeResultsReport':
        ...
        if _4855.PerModeResultsReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
        ...
        return constructor.new(_4855.PerModeResultsReport)(self.wrapped.InnerItem) if self.wrapped.InnerItem else None
