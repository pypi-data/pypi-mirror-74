...
from mastapy.utility.modal_analysis.gears import _1431, _1435
...
class GearMeshForTE(_1435.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1431.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1431.GearOrderForTE))
        return value
