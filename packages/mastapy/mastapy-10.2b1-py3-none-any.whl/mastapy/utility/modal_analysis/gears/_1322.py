...
from mastapy.utility.modal_analysis.gears import _1323, _1326, _1328
...
class GearOrderForTE(_1328.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1323.GearPositions':
        ...
        return constructor.new(_1323.GearPositions)(value) if value else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1326.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1326.OrderForTE))
        return value
