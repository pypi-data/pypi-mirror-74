...
from mastapy.utility.modal_analysis.gears import _1317, _1320, _1322
...
class GearOrderForTE(_1322.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1317.GearPositions':
        ...
        return constructor.new(_1317.GearPositions)(value) if value else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1320.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1320.OrderForTE))
        return value
