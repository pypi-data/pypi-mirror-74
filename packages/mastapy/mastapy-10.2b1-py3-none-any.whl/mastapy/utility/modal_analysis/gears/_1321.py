...
from mastapy.utility.modal_analysis.gears import _1322, _1326
...
class GearMeshForTE(_1326.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1322.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1322.GearOrderForTE))
        return value
