...
from mastapy.utility.units_and_measurements.measurements import _1225
...
class DutyCyclePropertySummaryPercentage(_1354.DutyCyclePropertySummary['_1225.Percentage', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryPercentage
