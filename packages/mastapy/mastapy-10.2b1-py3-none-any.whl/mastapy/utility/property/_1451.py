...
from mastapy.utility.units_and_measurements.measurements import _1355
...
class DutyCyclePropertySummaryStress(_1447.DutyCyclePropertySummary['_1355.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
