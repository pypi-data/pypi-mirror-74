...
from mastapy.utility.units_and_measurements.measurements import _1302
...
class DutyCyclePropertySummaryForce(_1447.DutyCyclePropertySummary['_1302.Force', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryForce
