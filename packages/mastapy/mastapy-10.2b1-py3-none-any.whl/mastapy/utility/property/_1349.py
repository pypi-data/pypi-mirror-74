...
from mastapy.utility.units_and_measurements.measurements import _1180
...
class DutyCyclePropertySummaryForce(_1348.DutyCyclePropertySummary['_1180.Force', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryForce
