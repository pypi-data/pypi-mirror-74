...
from mastapy.utility.units_and_measurements.measurements import _1242
...
class DutyCyclePropertySummaryStress(_1348.DutyCyclePropertySummary['_1242.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
