...
from mastapy.utility.units_and_measurements.measurements import _1220
...
class DutyCyclePropertySummaryPercentage(_1348.DutyCyclePropertySummary['_1220.Percentage', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryPercentage
