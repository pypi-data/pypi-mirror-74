...
from mastapy.utility.units_and_measurements.measurements import _1378
...
class DutyCyclePropertySummaryPercentage(_1447.DutyCyclePropertySummary['_1378.Percentage', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryPercentage
