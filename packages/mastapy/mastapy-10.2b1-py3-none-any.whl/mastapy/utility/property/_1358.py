...
from mastapy.utility.units_and_measurements.measurements import _1247
...
class DutyCyclePropertySummaryStress(_1354.DutyCyclePropertySummary['_1247.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
