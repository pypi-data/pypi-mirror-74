...
from wavespy.client import DEFAULT_NODE_ADDRESS, WavesClient, CHAIN_ID_NAMES
from wavespy.utils.crypto import sign_with_private_key
...
class WavesAddress(BaseWavesAddress):
    ...
    @sign_required
    def transfer_waves(self, recipient, amount, attachment=None, transaction_fee=DEFAULT_TRANSFER_TRANSACTION_FEE,
                       timestamp=0):
        """
    ...
    @sign_required
    def mass_transfer_waves(self, transfer_data, attachment=None, timestamp=None):
        """
        Mass transfer waves
    ...
    @sign_required
    def lease_waves(self, recipient, amount, transaction_fee=DEFAULT_LEASE_TRANSACTION_FEE, timestamp=0):
        """
    ...
    def __repr__(self):
        return "WavesAddress({})".format(self.value)
