...
from wavespy.client import DEFAULT_NODE_ADDRESS, DEFAULT_CHAIN_ID
from wavespy.utils.address import WavesAddress, DEFAULT_ADDRESS_VERSION
from wavespy.utils.async_address import WavesAsyncAddress


class WavesAddressGenerator:
    """
    ...
    def generate(self, value=None, private_key=None, public_key=None, seed=None, chain_id=DEFAULT_CHAIN_ID, nonce=0,
        ...
        :return: WavesAddress or AsyncWavesAddress object with different attributes
        :rtype: WavesAddress or WavesAsyncAddress
        """
        address_class = WavesAddress if not self.async_address else WavesAsyncAddress
