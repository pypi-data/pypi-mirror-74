...
from azureml.automl.core.shared.exceptions import DataException, InvalidArgumentException
...
try:
    ...
    from azureml.automl.core.shared import metrics as classical_metrics
    from azureml.automl.core.shared.datasets import ClientDatasets
...
def compute_metric(y_pred, y_true_forecast, horizon, scalar_only=True, logger: logging.Logger = None) \
    ...
    except (ValueError, DataException, InvalidArgumentException) as e:
