...
['micropy',
 ...
 'micropy.data',
 'micropy.lib.stubber',
 'micropy.lib.stubber.lib',
 'micropy.lib.stubber.runOnPc',
 'micropy.lib.stubber.test',
 'micropy.packages',
 'micropy.project',
 'micropy.project.modules',
 'micropy.project.template.src',
 'micropy.stubs',
 'micropy.utils']

package_data = \
{'': ['*'],
 'micropy.data': ['schemas/*'],
 'micropy.lib.stubber': ['.githooks/*', '.vscode/*', 'patches/*'],
 'micropy.project': ['template/*', 'template/.vscode/*']}
...
{':sys_platform == "win32"': ['colorama>=0.4.3,<0.5.0'],
 'create_stubs': ['rshell>=0.0.26,<0.0.27', 'pyminifier>=2.1,<3.0'],
 'docs': ['sphinx>=2.2,<3.0',
