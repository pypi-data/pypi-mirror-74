...
class TensorFlow(_FrameworkBaseEstimator):
    ...
    Supported versions: 1.10, 1.12, 1.13, 2.0, 2.1
    ...
    .. remarks::
            ...
            | Dependencies                         | TensorFlow 1.10/1.12 | TensorFlow 1.13 | TensorFlow 2.0/2.1 |
            | ------------------------------------ | -------------------- | --------------- | ------------------ |
            ...
            | OpenMpi                              | ----                 | ----            | 3.1.2              |
            | horovod                              | 0.15.2               | 0.16.1          | 0.18.1             |
            | miniconda                            | 4.5.11               | 4.5.11          | 4.5.11             |
            | tensorflow                           | 1.10.0/1.12.0        | 1.13.1          | 2.0.0/2.1.0        |
            ...
            The following example shows how to use the TensorFlow estimator to launch a TensorFlow training
            ...
            * Native `distributed TensorFlow <https://www.tensorflow.org/deploy/distributed>`_ using the
