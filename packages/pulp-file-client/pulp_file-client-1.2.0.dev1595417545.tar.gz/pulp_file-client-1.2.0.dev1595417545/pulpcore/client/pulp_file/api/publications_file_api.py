...
class PublicationsFileApi(object):
    ...
    def create(self, data, **kwargs):  # noqa: E501
        ...
        :param FileFilePublication data: (required)
    ...
    def delete(self, file_publication_href, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete(file_publication_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_with_http_info(file_publication_href, **kwargs)  # noqa: E501

    def delete_with_http_info(self, file_publication_href, **kwargs):  # noqa: E501
        """Delete a file publication  # noqa: E501

         A FilePublication contains metadata about all the File Content in a particular File Repository Version. Once a FilePublication has been created, it can be hosted using the File Distribution API.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_with_http_info(file_publication_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('file_publication_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['file_publication_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `file_publication_href` when calling `delete`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'file_publication_href' in local_var_params:
            path_params['file_publication_href'] = local_var_params['file_publication_href']  # noqa: E501
    ...
    def read(self, file_publication_href, **kwargs):  # noqa: E501
        """Inspect a file publication  # noqa: E501

         A FilePublication contains metadata about all the File Content in a particular File Repository Version. Once a FilePublication has been created, it can be hosted using the File Distribution API.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(file_publication_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(file_publication_href, **kwargs)  # noqa: E501

    def read_with_http_info(self, file_publication_href, **kwargs):  # noqa: E501
        """Inspect a file publication  # noqa: E501

         A FilePublication contains metadata about all the File Content in a particular File Repository Version. Once a FilePublication has been created, it can be hosted using the File Distribution API.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(file_publication_href, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(FileFilePublication, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('file_publication_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['file_publication_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `file_publication_href` when calling `read`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='FileFilePublication',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
