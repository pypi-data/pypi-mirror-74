...
class _ExponentialSmoothingBase(PALBase):
    ...
    def __init__(self,
        ...
        self.model_selection = self._arg('model_selection', model_selection, int)
        ...
        self.seasonal = self._arg('seasonal', seasonal, int)
        ...
        self.damped = self._arg('damped', damped, int)
        ...
        self.trend_test_method = self._arg('trend_test_method', trend_test_method, int)
...
class TripleExponentialSmoothing(_ExponentialSmoothingBase):
    ...
    seasonal : int, optional
        ...
        When ``seasonal`` is set to 1, the default value of initial_method is 1;
        When ``seasonal`` is set to 0, the default value of initial_method is 0.
...
class AutoExponentialSmoothing(_ExponentialSmoothingBase):
    ...
    model_selection : int, optional
        ...
        - 1: the algorithm will select the best model among Single/Double/Triple/
          Damped Double/Damped Triple Exponential Smoothing models.
        - 0: the algorithm will not perform the model selection.
    ...
    optimizer_time_budget : int, optional
        ...
        is second and the value should be larger than zero.
    ...
    alpha : float, optional
        ...
        Defualt value is computed automatically.
    ...
    beta : float, optional
        ...
        Defualts value is computed automatically.
    ...
    seasonality_criterion : float, optional
        ...
        regarded to be seasonal.Only valid when ``forecast_model_name`` is TESM or model_selection
        is set to 1, and seasonal_period is not defined.

        Defualts to 0.5.

    trend_test_method : int, optional
    ...
    level_start : float, optional
        The initial value for level component S. If this value is not provided,
        it will be calculated in the way as described in Triple Exponential Smoothing.
        Notice that ``level_start`` cannot be zero. If it is set to zero, 0.0000000001 will be used instead.

    trend_start : float, optional
        The initial value for trend component B. If this value is not provided,
        it will be calculated in the way as described in Triple Exponential Smoothing.
