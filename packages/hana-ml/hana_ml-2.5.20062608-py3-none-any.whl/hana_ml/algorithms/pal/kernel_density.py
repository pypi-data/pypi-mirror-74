...
class KDE(PALBase):#pylint:disable=too-few-public-methods,too-many-instance-attributes
    ...
    thread_ratio : float, optional
        ...
        at most all the currently available threads. Values outside the range will be ignored
        and this function heuristically determines the number of threads to use.
        Default to 0.0.
    leaf_size : int, optional
        Number of samples in a KD tree or Ball tree leaf node.
        Only Valid when `method` is 'kd_tree' or 'ball_tree'.
        Default to 30.
    kernel : {'gaussian', 'tophat', 'epanechnikov', 'exponential', 'linear', 'cosine'}, optional
        Kernel function type.
        Default to 'gaussian'.
    method : {'brute_force', 'kd_tree', 'ball_tree'}, optional
        Searching method.
    ...
    minkowski_power : float, optionl
        ...
        Default to 3.0.
    rtol : float, optional
        The desired relative tolerance of the result. A larger tolerance
        generally leads to faster execution.
        Default to 1e-8.
    atol : float, optional
        The desired absolute tolerance of the result. A larger tolerance
        generally leads to faster execution.
        Default to 0.
    ...
    def __init__(self,#pylint:disable=too-many-arguments, too-many-locals, too-many-branches, too-many-statements
        ...
        self.method_map = {'brute_force': 0, 'kd_tree': 1, 'ball_tree': 2}
