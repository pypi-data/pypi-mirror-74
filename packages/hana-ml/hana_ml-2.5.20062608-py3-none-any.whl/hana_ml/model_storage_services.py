...
class ModelSavingServices(object): #pylint: disable=useless-object-inheritance
    ...
    def _load_model(cls, connection_context, name, version, js_str):
        ...
        try:
            ...
            model = cls(connection_context, **hanaml_parameters)
    ...
    @staticmethod
    def _load_mem(connection_context, name, version, js_str): #pylint: disable=unused-argument
        """
        ...
        for table_name in model_table_names:
            data_manipulation(connection_context, table_name, unload=False, schema=schema)

    @staticmethod
    def _unload_mem(connection_context, name, version, js_str): #pylint: disable=unused-argument
        """
        ...
        if isinstance(model_table_names, str):
            model_table_names = [model_table_names]
        for table_name in model_table_names:
            data_manipulation(connection_context, table_name, unload=True, schema=schema)
