...
class NaiveBayes(PALBase):
    ...
    resampling_method : {"cv", "stratified_cv", "bootstrap", "stratified_bootstrap"}, optional
        ...
        Mandatory if cross_validation is expected. If no value is specified for this parameter,
        neither model evaluation nor parameter selection is activated.

        No default value.

    evaluation_metric : {'accuracy', 'f1_score', 'auc'}, optional
        Specifies the evaluation metric for model evaluation or parameter selection.
        Mandatory if cross_validation is expected, (when resampling_method is set).
    ...
    progress_indicator_id : str, optional
        Sets an ID of progress indicator for model evaluation or parameter selection. No progress
        indicator is active if no value is provided.
