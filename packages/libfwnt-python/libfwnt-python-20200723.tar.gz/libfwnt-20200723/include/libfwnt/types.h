...
#if !defined( _LIBFWNT_TYPES_H )
#define _LIBFWNT_TYPES_H
...
#define __USE_UNIX98
#define LIBFWNT_DEFINITION_UNIX98
#endif

#include <wchar.h>

#if defined( LIBFWNT_DEFINITION_UNIX98 )
#undef __USE_UNIX98
#undef LIBFWNT_DEFINITION_UNIX98
#endif
...
#endif /* !defined( _LIBFWNT_TYPES_H ) */
