...
def uploadModelFile(api_key, account_id,project_id, experiment_name, azure_id, azure_key, container_name, project_name, experiment_id, model_path):
    ...
    modelFileStep +=1
def uploadSourceCode(api_key, account_id, project_id, experiment_name, azure_id, azure_key, container_name, project_name, experiment_id):
...
def uploadImageLog(api_key, account_id,azure_id,
                                           azure_key, project_id, experiment_id, container_name, project_name, experiment_name, imageLog):
    global imageLogStep
    ...
    for key in imageLog:
        ...
        result_image_log[key] = azure_cloud_service.upload_image(full_path, image_name+'.png', azure_id,
                                         azure_key, container_name, project_name, experiment_name, experiment_id)
