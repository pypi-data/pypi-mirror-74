...
class project_config:
    ...
    def __init__(self):
        ...
        self.csvORparquet = DropDownMenu(self.label_generalsettings,'File type',['csv','parquet'],'12')
...
def main():
    #windows icon
    import ctypes
    myappid = 'Simba 1.2'  # arbitrary string
    ...
    print('\n')
    print(tabulate([['multi-Animal DeepLabCut support (>= v2.2b5)'], ['SLEAP support'], ['"Psuedo-labeling" module'], ['...many bug fixes']], headers=['June 2020 Updates/Fixes'], tablefmt='fancy_grid'))
