...
from simba.process_videos_automation import *
...
from simba.plotlyScripts.combine_to_h5 import *
...
class project_config:
    ...
    def extract_frames(self):
        try:
            ...
            print(videopath)
            extract_frames_ini(videopath, configinifile)
        except:
...
class loadprojectini:
    def __init__(self,configini):
        ...
        userPoseConfigSetting = config.get('create ensemble settings', 'pose_estimation_body_parts')
        targetlist = {}
        ...
        if userPoseConfigSetting == 'user_defined':
        ...
        plotlyInterfaceTitles = ['Sklearn results', 'Time bin analyses', 'Probabilities', 'Severaity analysis']
        toIncludeVar = []
        ...
        button_open_plotly_interface = Button(plotlyInterface, text='Open SimBA / Plotly dataset', command=lambda: self.mergeframesofplot(toIncludeVar))
        ...
        button_open_plotly_interface.grid(row=11, sticky=W)
    ...
    def generateSimBPlotlyFile(self,var):
        ...
        mergeH5file(self.projectconfigini, inputList)


    def plotdataplot(self):
        data_plot_config(self.projectconfigini, self.SelectedBp.get())
