...
class TripAction(object):
    ...
    def __init__(self, order_key=None, warehouse_key=None, order_time=None, location_time=None, local_vars_configuration=None):  # noqa: E501
    ...
    def order_key(self):
        ...
        Key of the order being fulfilled now.  # noqa: E501
    ...
    @property
    def warehouse_key(self):
        """Gets the warehouse_key of this TripAction.  # noqa: E501

        Point key (warehouse or client), where an action is being performed now. If specified, some work is going at a warehouse. If not specified, some work is going at a client.   # noqa: E501

        :return: The warehouse_key of this TripAction.  # noqa: E501
        :rtype: str
        """
        return self._warehouse_key

    @warehouse_key.setter
    def warehouse_key(self, warehouse_key):
        """Sets the warehouse_key of this TripAction.

        Point key (warehouse or client), where an action is being performed now. If specified, some work is going at a warehouse. If not specified, some work is going at a client.   # noqa: E501

        :param warehouse_key: The warehouse_key of this TripAction.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                warehouse_key is not None and len(warehouse_key) > 1024):
            raise ValueError("Invalid value for `warehouse_key`, length must be less than or equal to `1024`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                warehouse_key is not None and len(warehouse_key) < 1):
            raise ValueError("Invalid value for `warehouse_key`, length must be greater than or equal to `1`")  # noqa: E501

        self._warehouse_key = warehouse_key

    @property
    def order_time(self):
        """Gets the order_time of this TripAction.  # noqa: E501


        :return: The order_time of this TripAction.  # noqa: E501
        :rtype: TimeWindow
        """
    ...
    def order_time(self, order_time):
        """Sets the order_time of this TripAction.


        :param order_time: The order_time of this TripAction.  # noqa: E501
        :type: TimeWindow
        """
    ...
    def location_time(self):
        """Gets the location_time of this TripAction.  # noqa: E501


        :return: The location_time of this TripAction.  # noqa: E501
        :rtype: TimeWindow
        """
    ...
    def location_time(self, location_time):
        """Sets the location_time of this TripAction.


        :param location_time: The location_time of this TripAction.  # noqa: E501
        :type: TimeWindow
        """
