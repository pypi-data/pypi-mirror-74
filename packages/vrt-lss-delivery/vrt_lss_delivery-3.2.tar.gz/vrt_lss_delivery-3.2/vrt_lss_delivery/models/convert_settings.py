...
class ConvertSettings(object):
    ...
    def route_index_from(self):
        ...
        Route number to start the convertation. If not specified - the convertation starts from the 1st route.   # noqa: E501
    ...
    def route_index_to(self):
        ...
        Route number to finish the convertation. If not specified - the convertation finishes on the last route.   # noqa: E501
