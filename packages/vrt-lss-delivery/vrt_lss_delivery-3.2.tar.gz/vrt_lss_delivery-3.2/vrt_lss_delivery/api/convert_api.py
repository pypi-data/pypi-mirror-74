...
class ConvertApi(object):
    ...
    def convert_to_json(self, convert_task, **kwargs):  # noqa: E501
        """Convertation of the task and the planning result.  # noqa: E501
        ...
        :param ConvertTask convert_task: Convertation request to the JSON format. (required)
    ...
    def convert_to_xlsx(self, convert_task, **kwargs):  # noqa: E501
        """Task and planning result convertation.  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param ConvertTask convert_task: Convertation request to the XLSX format. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
