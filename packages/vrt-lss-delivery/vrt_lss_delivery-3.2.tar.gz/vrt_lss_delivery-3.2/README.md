...
with vrt_lss_delivery.ApiClient(configuration) as api_client:
    ...
    api_instance = vrt_lss_delivery.AnalyticsApi(api_client)
    analytics_task = vrt_lss_delivery.AnalyticsTask() # AnalyticsTask | Request for analytics.
...
*ConvertApi* | [**convert_to_json**](docs/ConvertApi.md#convert_to_json) | **POST** /delivery/convert/json | Convertation of the task and the planning result.
*ConvertApi* | [**convert_to_xlsx**](docs/ConvertApi.md#convert_to_xlsx) | **POST** /delivery/convert/xlsx | Task and planning result convertation.
