...
class Order(object):
    ...
    def __init__(self, key=None, type=None, warehouse_keys=None, customer=None, cargos=None, warehouse_duration=0, customer_duration=0, cost=None, restrictions=[], blacklist=[], local_vars_configuration=None):  # noqa: E501
    ...
    def blacklist(self):
        ...
        A list of requirements that the performer is not allowed to have. Used for checking the compatibility of the performer and the order (work).   # noqa: E501
