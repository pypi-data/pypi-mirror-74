...
class CapacityFactor(object):
    ...
    def __init__(self, transport_type=None, capacity=1, local_vars_configuration=None):  # noqa: E501
    ...
    def capacity(self):
        ...
        Vehicle compartment volume multiplier. Multiplies all `capacity` fields for all compartments for all vehicles.   # noqa: E501
    ...
    def capacity(self, capacity):
        ...
        if (self.local_vars_configuration.client_side_validation and
                capacity is not None and capacity > 10):  # noqa: E501
            raise ValueError("Invalid value for `capacity`, must be a value less than or equal to `10`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                capacity is not None and capacity < 0.1):  # noqa: E501
            raise ValueError("Invalid value for `capacity`, must be a value greater than or equal to `0.1`")  # noqa: E501
