...
from sitecheck.scanner.Scanner.pyppet import text
...
async def make_browser():
    ...
    """
    browser = await launch({"headless": options.headless, "ignoreHTTPSErrors": True},
...
async def scan_plan_view(parent, operator):
    ...
    :param operator: <class 'pyppet.sites.Amp_Webpage'>
