...
class Project_runner:
    ...
    def __init__(self, project):
        self.project = config.project_config(project)
    ...
    async def filter_site(self):
        ...
        """
        logger.debug(text.fileheader + self.project.name)
        logger.info('Skip: ' + self.project.skip)
        logger.info('Has Site: ' + self.project.site)
        logger.info('Plan array: ' + self.project.planarray + '\n')
