...
class AwsAuth(
    ...
    def __init__(
        self, scope: aws_cdk.core.Construct, id: str, *, cluster: "Cluster"
    ) -> None:
        """
        :param scope: -
        :param id: -
    ...
    def add_masters_role(
        self, role: aws_cdk.aws_iam.IRole, username: typing.Optional[str] = None
    ) -> None:
...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-eks.CapacityOptions",
...
class CfnCluster(
    ...
    def __init__(
        ...
        *,
        resources_vpc_config: typing.Union[
            "ResourcesVpcConfigProperty", aws_cdk.core.IResolvable
        ],
        role_arn: str,
        encryption_config: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable,
                typing.List[
                    typing.Union[aws_cdk.core.IResolvable, "EncryptionConfigProperty"]
                ],
            ]
        ] = None,
    ...
    def resources_vpc_config(
        self,
    ) -> typing.Union["ResourcesVpcConfigProperty", aws_cdk.core.IResolvable]:
    ...
    def resources_vpc_config(
        self,
        value: typing.Union["ResourcesVpcConfigProperty", aws_cdk.core.IResolvable],
    ) -> None:
        ...
        def __init__(
            ...
            *,
            provider: typing.Optional[
                typing.Union[aws_cdk.core.IResolvable, "CfnCluster.ProviderProperty"]
            ] = None,
...
class CfnClusterProps:
    def __init__(
        ...
        *,
        resources_vpc_config: typing.Union[
            "CfnCluster.ResourcesVpcConfigProperty", aws_cdk.core.IResolvable
        ],
        role_arn: str,
        encryption_config: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        aws_cdk.core.IResolvable, "CfnCluster.EncryptionConfigProperty"
                    ]
                ],
            ]
        ] = None,
...
class CfnNodegroup(
    ...
    def __init__(
        ...
        *,
        ...
        force_update_enabled: typing.Optional[
        ...
        remote_access: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "RemoteAccessProperty"]
        ] = None,
        scaling_config: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "ScalingConfigProperty"]
        ] = None,
...
class CfnNodegroupProps:
    def __init__(
        ...
        *,
        ...
        release_version: typing.Optional[str] = None,
        remote_access: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "CfnNodegroup.RemoteAccessProperty"]
        ] = None,
        scaling_config: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "CfnNodegroup.ScalingConfigProperty"]
        ] = None,
        tags: typing.Any = None,
        version: typing.Optional[str] = None,
    ) -> None:
...
class ClusterOptions:
    def __init__(
        ...
        *,
        ...
        vpc_subnets: typing.Optional[
            typing.List[aws_cdk.aws_ec2.SubnetSelection]
        ] = None,
    ) -> None:
...
class EksOptimizedImage(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-eks.EksOptimizedImage"
):
...
class KubernetesResource(
    aws_cdk.core.Construct,
    metaclass=jsii.JSIIMeta,
    jsii_type="@aws-cdk/aws-eks.KubernetesResource",
):
...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-eks.KubernetesResourceProps",
    jsii_struct_bases=[],
...
class KubernetesVersion(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-eks.KubernetesVersion"
):
...
class Nodegroup(
    ...
    def from_nodegroup_name(
        cls, scope: aws_cdk.core.Construct, id: str, nodegroup_name: str
    ) -> "INodegroup":
...
class NodegroupRemoteAccess:
    def __init__(
        ...
        *,
        ssh_key_name: str,
        source_security_groups: typing.Optional[
...
class Cluster(
    aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-eks.Cluster"
):
...
class FargateCluster(
    Cluster, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-eks.FargateCluster"
):
