...
interface Identifier extends Partial<Record<Exclude<string, '__compat'>, Identifier>> {
  /**
...
interface SupportBlock extends Partial<Record<BrowserNames, SupportStatement>> {
}
