...
try:
    ...
    import prot.prompt.eventloop.dummy_contextvars as contextvars  # type: ignore
    ...
    def _handle_exception(
        ...
        async def in_term() -> None:
            async with in_terminal():
                ...
                printMsg(formatted_tb)
                printMsg("Exception %s" % (context.get("exception"),))
...
async def _do_wait_for_enter(wait_text: AnyFormattedText) -> None:
    ...
    """
    from prot.prompt.shortcuts import PromptSession
