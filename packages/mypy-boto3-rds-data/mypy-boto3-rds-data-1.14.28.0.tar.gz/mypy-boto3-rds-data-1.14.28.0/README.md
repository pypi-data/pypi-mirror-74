...
[boto3.RDSDataService 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/rds-data.html#RDSDataService) service
...
`mypy_boto3_rds_data` and other installed services.
...
session_client = boto3.Session().client("rds-data")
```
