...
def Engine(config=None, device=None, ngpus=1, least_mem=2048,
           available_gpus=(), gpu_mem_fraction=0.9, if_conserve=True):
    if config is None:
        param = {'device': device, 'ngpus': ngpus, 'least_mem': least_mem,
