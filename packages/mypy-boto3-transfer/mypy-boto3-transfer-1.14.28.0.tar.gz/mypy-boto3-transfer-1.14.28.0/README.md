...
[boto3.Transfer 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/transfer.html#Transfer) service
...
def get_structure() -> DescribedServerTypeDef:
    return {
      ...
    }
```
