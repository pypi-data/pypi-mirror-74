...
class CodeCommitDependencyCheck(
    ...
    def __init__(
        ...
        *,
        ...
        pre_check_command: typing.Optional[str] = None,
        project_name: typing.Optional[str] = None,
        reports_bucket: typing.Optional[aws_cdk.aws_s3.Bucket] = None,
        suppressions: typing.Optional[typing.List[str]] = None,
...
class CodeCommitDependencyCheckProps:
    ...
    @builtins.property
    def enable_experimental(self) -> typing.Optional[bool]:
    ...
    def fail_on_cvss(self) -> typing.Optional[jsii.Number]:
        ...
        :default: 0
        """
        return self._values.get("fail_on_cvss")
    ...
    def reports_bucket(self) -> typing.Optional[aws_cdk.aws_s3.Bucket]:
        ...
        return self._values.get("reports_bucket")

    @builtins.property
    def suppressions(self) -> typing.Optional[typing.List[str]]:
        """The file paths to the suppression XML files;

        used to suppress false positives.
        """
        return self._values.get("suppressions")
