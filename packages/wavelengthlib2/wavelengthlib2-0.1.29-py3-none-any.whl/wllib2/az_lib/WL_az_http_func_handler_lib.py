        ...
        if self.env:
            ...
            if len(self.request_params):
                ...
                if self.func_def:
                    ...
                    n_funcdef_facets = len(f_parts)

                if n_funcdef_facets == 4:
                ...
                if self.funcdef_well_formed: 
                    ...
                    mess = f'Function definition [{self.func_def}] was empty or malformed. Number of facets={n_funcdef_facets}. Should be [Library_directory.Library_file.Class.Method].'
