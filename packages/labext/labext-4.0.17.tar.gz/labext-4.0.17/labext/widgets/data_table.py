...
class DataTable(WidgetWrapper):
    def __init__(self, df: 'DataFrame', table_class: str='display', table_id: Optional[str]=None, **kwargs):
        ...
        self.on_draw_callback = noarg_func
        self.on_redraw_callback = noarg_func
    ...
    def on_draw(self, callback = None):
        self.on_draw_callback = callback

    def on_redraw(self, callback = None):
