...
os_tool.mkdir(os.path.join(root_path,*['./', '.pytest_cache']))
content = """# Created by pytest automatically.
*"""
os_tool.mkfile(root_path,*['./', '.pytest_cache', '.gitignore'], content=content)
...
"""
os_tool.mkfile(root_path,*['./', '.pytest_cache', 'CACHEDIR.TAG'], content=content)
...
"""
os_tool.mkfile(root_path,*['./', '.pytest_cache', 'README.md'], content=content)

        
os_tool.mkdir(os.path.join(root_path,*['./', '.pytest_cache', 'v']))
os_tool.mkdir(os.path.join(root_path,*['./', '.pytest_cache', 'v', 'cache']))
content = """{
  "test_case/demo/test_baidu.py::test_demo": true,
  "test_case/demo/test_baidu.py::test_radio": true
}"""
os_tool.mkfile(root_path,*['./', '.pytest_cache', 'v', 'cache', 'lastfailed'], content=content)

        
content = """[
  "test_case/demo/test_baidu.py::test_baidu",
  "test_case/demo/test_baidu.py::test_radio",
  "test_case/demo/test_baidu.py::test_demo"
]"""
os_tool.mkfile(root_path,*['./', '.pytest_cache', 'v', 'cache', 'nodeids'], content=content)

        
content = """[]"""
os_tool.mkfile(root_path,*['./', '.pytest_cache', 'v', 'cache', 'stepwise'], content=content)

        
os_tool.mkdir(os.path.join(root_path,*['./', 'chrome_driver']))
content = """## 一、环境搭建
1. 确定chrome版本
...
"""
os_tool.mkfile(root_path,*['./', 'chrome_driver', '界面自动化驱动手册-readme.md'], content=content)
...
"""
os_tool.mkfile(root_path,*['./', 'config', 'config.py'], content=content)
...
os_tool.mkdir(os.path.join(root_path,*['./', 'test_case', '.pytest_cache']))
content = """# Created by pytest automatically.
*"""
os_tool.mkfile(root_path,*['./', 'test_case', '.pytest_cache', '.gitignore'], content=content)
...
#	http://www.bford.info/cachedir/spec.html
"""
os_tool.mkfile(root_path,*['./', 'test_case', '.pytest_cache', 'CACHEDIR.TAG'], content=content)
...
See [the docs](https://docs.pytest.org/en/latest/cache.html) for more information.
"""
os_tool.mkfile(root_path,*['./', 'test_case', '.pytest_cache', 'README.md'], content=content)

        
os_tool.mkdir(os.path.join(root_path,*['./', 'test_case', '.pytest_cache', 'v']))
os_tool.mkdir(os.path.join(root_path,*['./', 'test_case', '.pytest_cache', 'v', 'cache']))
content = """{}"""
os_tool.mkfile(root_path,*['./', 'test_case', '.pytest_cache', 'v', 'cache', 'lastfailed'], content=content)

        
content = """[
  "test_browser.py::test_element"
]"""
os_tool.mkfile(root_path,*['./', 'test_case', '.pytest_cache', 'v', 'cache', 'nodeids'], content=content)

        
content = """[]"""
os_tool.mkfile(root_path,*['./', 'test_case', '.pytest_cache', 'v', 'cache', 'stepwise'], content=content)
...
os_tool.mkdir(os.path.join(root_path,*['./', 'test_case', 'demo']))
os_tool.mkdir(os.path.join(root_path,*['./', 'test_case', 'demo', '.pytest_cache']))
content = """# Created by pytest automatically.
*"""
os_tool.mkfile(root_path,*['./', 'test_case', 'demo', '.pytest_cache', '.gitignore'], content=content)
...
#	http://www.bford.info/cachedir/spec.html
"""
os_tool.mkfile(root_path,*['./', 'test_case', 'demo', '.pytest_cache', 'CACHEDIR.TAG'], content=content)
...
See [the docs](https://docs.pytest.org/en/latest/cache.html) for more information.
"""
os_tool.mkfile(root_path,*['./', 'test_case', 'demo', '.pytest_cache', 'README.md'], content=content)

        
os_tool.mkdir(os.path.join(root_path,*['./', 'test_case', 'demo', '.pytest_cache', 'v']))
os_tool.mkdir(os.path.join(root_path,*['./', 'test_case', 'demo', '.pytest_cache', 'v', 'cache']))
content = """{}"""
os_tool.mkfile(root_path,*['./', 'test_case', 'demo', '.pytest_cache', 'v', 'cache', 'lastfailed'], content=content)

        
content = """[
  "test_baidu.py::test_demo"
]"""
os_tool.mkfile(root_path,*['./', 'test_case', 'demo', '.pytest_cache', 'v', 'cache', 'nodeids'], content=content)

        
content = """[]"""
os_tool.mkfile(root_path,*['./', 'test_case', 'demo', '.pytest_cache', 'v', 'cache', 'stepwise'], content=content)
...
"""
os_tool.mkfile(root_path,*['./', 'test_case', 'demo', 'test_baidu.py'], content=content)

        
content = """# -*- coding:utf-8 -*-
# Author : 小吴老师
# Data ：2019/7/31 15:48"""
os_tool.mkfile(root_path,*['./', 'test_case', 'demo', '__init__.py'], content=content)
...
os_tool.mkdir(os.path.join(root_path,*['./', 'tools', 'ui']))
content = """# coding=utf-8
import os
...
class BaseUI(object):
    ...
    def click(self, locator):
        ...
        ActionChains(BaseUI.driver).move_to_element(element).click(element).perform()
    ...
    def drag_and_drop_by_offset(self, locator, x, y):
        ...
        ActionChains(BaseUI.driver).drag_and_drop_by_offset(element, x, y).perform()
    ...
    def execute_script(self, script):
        ...
        BaseUI.driver.execute_script(script)
    ...
    def wait_util_frame_available(self, locator, secs=10):
        ...
        try:
            ...
            raise e"""
os_tool.mkfile(root_path,*['./', 'tools', 'ui', 'base_ui.py'], content=content)
...
# Creator: LudvikWoo
# Create time: 2019-09-20 16:23"""
os_tool.mkfile(root_path,*['./', 'tools', 'ui', '__init__.py'], content=content)
