...
def _load_optix_win():
    ...
    optix.load_texture_2d.argtypes = [c_wchar_p, c_wchar_p, c_float, c_float, c_float, c_float, c_uint, c_bool]
    optix.load_texture_2d.restype = c_bool

    optix.set_displacement.argtypes = [c_wchar_p, c_void_p, c_int, c_int, c_bool, c_bool]
    ...
    optix.load_normal_tilt.argtypes = [c_wchar_p, c_wchar_p, c_int, c_float, c_float, c_bool]
    ...
    optix.update_psurface.argtypes = [c_wchar_p, c_int, c_int, c_void_p, c_void_p, c_void_p, c_void_p]
    optix.update_psurface.restype = c_uint

    optix.setup_psurface.argtypes = [c_wchar_p, c_wchar_p, c_int, c_int, c_void_p, c_void_p, c_void_p, c_void_p, c_bool, c_bool, c_bool]
    ...
    optix.setup_camera.argtypes = [c_wchar_p, c_int, c_void_p, c_void_p, c_void_p, c_float, c_float, c_float, c_float, c_float, c_bool, c_bool]
...
class _ClrOptiX:
    ...
    def load_texture_2d(self, tex_name, file_name, prescale, baseline, exposure, gamma, tformat, refresh):
        return self._optix.load_texture_2d(tex_name, file_name, prescale, baseline, exposure, gamma, tformat, refresh)

    def set_displacement(self, obj_name, data_ptr, width, height, keep_on_host, refresh):
        return self._optix.set_displacement_ptr(obj_name,
                                                IntPtr.__overloads__[Int64](data_ptr),
                                                width, height, keep_on_host, refresh)

    def load_displacement(self, obj_name, file_name, prescale, baseline, refresh):
    ...
    def set_normal_tilt(self, mat_name, data_ptr, width, height, mapping, keep_on_host, refresh):
        return self._optix.set_normal_tilt_ptr(mat_name,
                                               IntPtr.__overloads__[Int64](data_ptr),
                                               width, height, mapping, keep_on_host, refresh)

    def load_normal_tilt(self, mat_name, file_name, mapping, prescale, baseline, refresh):
        return self._optix.load_normal_tilt(mat_name, file_name, mapping, prescale, baseline, refresh)
    ...
    def update_psurface(self, name, u_size, v_size, pos, norm, cconst, c):
    ...
    def setup_psurface(self, name, material, u_size, v_size, pos, norm, cconst, c, wrap_u, wrap_v, make_normals):
    ...
    def update_mesh(self, name, n_vtx, n_tri, n_norm, n_uv, pos, cconst, c, vidx, norm, nidx, uvmap, uvidx):
        return self._optix.update_mesh_ptr(name, n_vtx, n_tri, n_norm, n_uv,
                                           IntPtr.__overloads__[Int64](pos),
                                           IntPtr.__overloads__[Int64](const),
                                           IntPtr.__overloads__[Int64](c),
                                           IntPtr.__overloads__[Int64](vidx),
                                           IntPtr.__overloads__[Int64](norm),
                                           IntPtr.__overloads__[Int64](nidx),
    ...
    def setup_camera(self, name, camera_type, eye, target, up, aperture_r, aperture_fract, focal_scale, fov, blur, glock, make_current):
        return self._optix.setup_camera_ptr(name, camera_type,
                                            ...
                                            aperture_r, aperture_fract, focal_scale, fov, blur, glock, make_current)
