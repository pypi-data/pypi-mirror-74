...
class Analytical_Data(object):
    ...
    def setup_autosave(self, every_X=time_events.EVERY_HOUR, save_path="MkNxGn_SF_Mako/"):
...
class HTTP_Server(object):
    ...
    def build_from_config(self, path="SF_Mako_Config.json"):
    ...
    def save_config(self, path="SF_Mako_Config"):
        data = {
            "host": self.HOST,
            "ports": self.PORTS,
