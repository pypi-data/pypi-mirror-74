...
class ResultJSONKpi(object):
    ...
    def __init__(self, escalation=None, resolution=None, agentperfscore=None, satisfaction=None, propensity=None, success=None, trends=None, compliance=None):  # noqa: E501
