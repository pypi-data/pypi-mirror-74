...
def list_oauth2_clients(
    ...
    :raises InvalidArgumentException: on 412:raises ArgusException: on other status codes
    ...
    url = "{}/authentication/v1/oauth/client".format(settings["api"]["api_url"], limit=limit, customer=customer, domain=domain, keywords=keywords, sortBy=sortBy, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_oauth2_clients(
    ...
    url = "{}/authentication/v1/oauth/client/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
