...
def disable_method_for_user(
    ...
    url = "{}/authentication/v1/user/{userID}/disable/{method}".format(settings["api"]["api_url"], userID=userID, method=method)
    headers = {
...
def download_public_key(
    ...
    url = "{}/authentication/v1/user/{userID}/signature/pubkey".format(settings["api"]["api_url"], userID=userID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def enable_method_for_user(
    ...
    url = "{}/authentication/v1/user/{userID}/enable/{method}".format(settings["api"]["api_url"], userID=userID, method=method)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def evict_signature_session(
    ...
    url = "{}/authentication/v1/user/{userID}/signature/session".format(settings["api"]["api_url"], userID=userID, keyID=keyID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_user_methods(
    ...
    :raises AuthenticationFailedException: on 401
    :raises AccessDeniedException: on 403
    :raises UserNotFoundException: on 404:raises ArgusException: on other status codes
    ...
    url = "{}/authentication/v1/user/{userId}/methods".format(settings["api"]["api_url"], userId=userId)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def initiate(
    ...
    url = "{}/authentication/v1/user/{userID}/apikey".format(settings["api"]["api_url"], userID=userID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def initiate_2(
    ...
    url = "{}/authentication/v1/user/{userID}/totp".format(settings["api"]["api_url"], userID=userID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def renew(
    ...
    url = "{}/authentication/v1/user/{userID}/apikey/{prefix}".format(settings["api"]["api_url"], userID=userID, prefix=prefix)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def renew_1(
    ...
    url = "{}/authentication/v1/user/{userID}/apikey/{keyID}".format(settings["api"]["api_url"], userID=userID, keyID=keyID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def reset_and_download_private_key(
    ...
    url = "{}/authentication/v1/user/{userID}/signature/reset".format(settings["api"]["api_url"], userID=userID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    if json:
...
def retrieve_s_m_s_token(
    ...
    url = "{}/authentication/v1/user/{userID}/sms/token/{tokenSuffix}".format(settings["api"]["api_url"], userID=userID, tokenSuffix=tokenSuffix)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def setup(
    ...
    url = "{}/authentication/v1/user/{userID}/ldap".format(settings["api"]["api_url"], userID=userID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def setup_1(
    ...
    url = "{}/authentication/v1/user/{userID}/radius".format(settings["api"]["api_url"], userID=userID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
