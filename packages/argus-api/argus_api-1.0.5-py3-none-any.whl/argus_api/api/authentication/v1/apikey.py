...
def initiate_1(
    ...
    url = "{}/authentication/v1/apikey".format(settings["api"]["api_url"], )
    headers = {
...
def renew_2(
    ...
    url = "{}/authentication/v1/apikey/{prefix}".format(settings["api"]["api_url"], prefix=prefix)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def renew_3(
    ...
    url = "{}/authentication/v1/apikey/{keyID}".format(settings["api"]["api_url"], keyID=keyID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
