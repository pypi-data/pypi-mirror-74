...
def get_subject(
    ...
    url = "{}/useradmin/v2/subject/{shortNameOrId}".format(settings["api"]["api_url"], shortNameOrId=shortNameOrId, domain=domain)
    headers = {
...
def list_subjects_1(
    ...
    url = "{}/useradmin/v2/subject".format(settings["api"]["api_url"], limit=limit, keywordMatch=keywordMatch, offset=offset, domain=domain, subject=subject, customer=customer, includeDeleted=includeDeleted, excludeFlag=excludeFlag, includeFlag=includeFlag, keyword=keyword, keywordField=keywordField, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_subjects(
    ...
    url = "{}/useradmin/v2/subject/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
