...
def add_function(
    ...
    url = "{}/useradmin/v2/function".format(settings["api"]["api_url"], )
    headers = {
...
def add_function_child(
    ...
    url = "{}/useradmin/v2/function/{functionNameOrID}/children".format(settings["api"]["api_url"], functionNameOrID=functionNameOrID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_user(
    ...
    url = "{}/useradmin/v2/function/{functionNameOrID}".format(settings["api"]["api_url"], functionNameOrID=functionNameOrID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_function_parents(
    ...
    url = "{}/useradmin/v2/function/{functionNameOrID}/parents".format(settings["api"]["api_url"], functionNameOrID=functionNameOrID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_functions(
    ...
    url = "{}/useradmin/v2/function".format(settings["api"]["api_url"], limit=limit, keywordMatch=keywordMatch, offset=offset, function=function, minimumSecurityLevel=minimumSecurityLevel, includeDeleted=includeDeleted, excludeFlag=excludeFlag, includeFlag=includeFlag, ancestor=ancestor, descendant=descendant, keyword=keyword, keywordField=keywordField, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def remove_function_child(
    ...
    url = "{}/useradmin/v2/function/{functionNameOrID}/children".format(settings["api"]["api_url"], functionNameOrID=functionNameOrID, child=child)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_functions(
    ...
    url = "{}/useradmin/v2/function/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
