...
@register_command(
    extending=("useradmin", "v2", "permission"),
...
def grant_permission(
    ...
    url = "{}/useradmin/v2/permission".format(settings["api"]["api_url"], )
    headers = {
...
def list_permissions(
    ...
    url = "{}/useradmin/v2/permission".format(settings["api"]["api_url"], limit=limit, includeSubjectAscendants=includeSubjectAscendants, includeSubjectDescendants=includeSubjectDescendants, includeCustomerAscendants=includeCustomerAscendants, includeCustomerDescendants=includeCustomerDescendants, includeFunctionAscendants=includeFunctionAscendants, includeFunctionDescendants=includeFunctionDescendants, keywordMatch=keywordMatch, offset=offset, domain=domain, subject=subject, customer=customer, function=function, keywords=keywords, keywordField=keywordField, includeDeleted=includeDeleted)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def revoke_permission(
    ...
    url = "{}/useradmin/v2/permission/{permissionID}".format(settings["api"]["api_url"], permissionID=permissionID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_permissions(
    ...
    url = "{}/useradmin/v2/permission/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
