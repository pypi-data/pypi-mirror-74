...
def list_function_mappings(
    ...
    url = "{}/useradmin/v2/functionmapping".format(settings["api"]["api_url"], limit=limit, offset=offset, parent=parent, child=child, includeDeleted=includeDeleted, sortBy=sortBy)
    headers = {
...
def search_function_mappings(
    ...
    url = "{}/useradmin/v2/functionmapping/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
