...
def add_group(
    ...
    url = "{}/useradmin/v2/group".format(settings["api"]["api_url"], )
    headers = {
...
def add_group_members(
    ...
    url = "{}/useradmin/v2/group/{shortNameOrID}/members".format(settings["api"]["api_url"], shortNameOrID=shortNameOrID, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_group(
    ...
    url = "{}/useradmin/v2/group/{shortNameOrID}".format(settings["api"]["api_url"], shortNameOrID=shortNameOrID, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_groups_1(
    ...
    url = "{}/useradmin/v2/group".format(settings["api"]["api_url"], limit=limit, keywordMatch=keywordMatch, offset=offset, domain=domain, subject=subject, customer=customer, includeDeleted=includeDeleted, excludeFlag=excludeFlag, includeFlag=includeFlag, keyword=keyword, keywordField=keywordField, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_permissions_for_group(
    ...
    url = "{}/useradmin/v2/group/{shortNameOrID}/permissions".format(settings["api"]["api_url"], limit=limit, includeInherited=includeInherited, shortNameOrID=shortNameOrID, domain=domain, offset=offset, includeDeleted=includeDeleted)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def move_group(
    ...
    url = "{}/useradmin/v2/group/{shortNameOrID}/move".format(settings["api"]["api_url"], shortNameOrID=shortNameOrID, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def reenable_group(
    ...
    url = "{}/useradmin/v2/group/{shortNameOrID}/reenable".format(settings["api"]["api_url"], shortNameOrID=shortNameOrID, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def remove_subjects_from_group(
    ...
    url = "{}/useradmin/v2/group/{shortNameOrID}/members".format(settings["api"]["api_url"], shortNameOrID=shortNameOrID, domain=domain, subject=subject)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_groups(
    ...
    url = "{}/useradmin/v2/group/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
