...
def add_action(
    ...
    url = "{}/notifications/v1/rule/{id}/actions/{index}".format(settings["api"]["api_url"], id=id, index=index)
    headers = {
...
def add_destination(
    ...
    url = "{}/notifications/v1/rule/{id}/destinations".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def create(
    ...
    url = "{}/notifications/v1/rule".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_destination(
    ...
    url = "{}/notifications/v1/rule/{id}/destinations/{index}".format(settings["api"]["api_url"], id=id, index=index)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_rule(
    ...
    url = "{}/notifications/v1/rule/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def duplicate_rule(
    ...
    url = "{}/notifications/v1/rule/{id}/duplicate".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_rule_by_name(
    ...
    url = "{}/notifications/v1/rule/{name}".format(settings["api"]["api_url"], name=name)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list(
    ...
    :param bool includeGlobal: Include global rules
    ...
    url = "{}/notifications/v1/rule".format(settings["api"]["api_url"], limit=limit, includeDeleted=includeDeleted, includeFlags=includeFlags, excludeFlags=excludeFlags, customerID=customerID, includeGlobal=includeGlobal, offset=offset, events=events)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
    ...
    # Only send includeGlobal if the argument was provided, dont send null values
...
def list_1(
    ...
    url = "{}/notifications/v1/rule/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def revisions(
    ...
    url = "{}/notifications/v1/rule/{id}/revisions".format(settings["api"]["api_url"], limit=limit, id=id, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
