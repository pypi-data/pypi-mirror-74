...
def delete_data_store_entries(
    ...
    url = "{}/datastores/v1/store/{dataStore}".format(settings["api"]["api_url"], dataStore=dataStore, key=key, customerID=customerID)
    headers = {
...
def get_entries_from_store(
    ...
    url = "{}/datastores/v1/store/{dataStore}/search".format(settings["api"]["api_url"], dataStore=dataStore)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_entries_from_store_simplified(
    ...
    url = "{}/datastores/v1/store/{dataStore}".format(settings["api"]["api_url"], limit=limit, dataStore=dataStore, offset=offset, customerID=customerID, key=key, includeDeleted=includeDeleted)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_single_entry(
    ...
    url = "{}/datastores/v1/store/{dataStore}/{key}".format(settings["api"]["api_url"], dataStore=dataStore, key=key, customerID=customerID, includeDeleted=includeDeleted)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def put_data_store_entries(
    ...
    url = "{}/datastores/v1/store/{dataStore}".format(settings["api"]["api_url"], dataStore=dataStore)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def put_single_data_store_entry(
    ...
    url = "{}/datastores/v1/store/{dataStore}/{key}".format(settings["api"]["api_url"], dataStore=dataStore, key=key, customerID=customerID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def put_single_data_store_entry_1(
    ...
    url = "{}/datastores/v1/store/{dataStore}/{key}/{value}".format(settings["api"]["api_url"], dataStore=dataStore, key=key, value=value, customerID=customerID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
