...
@register_command(
    extending=("datastores", "v1", "descriptor"),
...
def add_data_store_descriptor(
    ...
    url = "{}/datastores/v1/descriptor".format(settings["api"]["api_url"], )
    headers = {
...
def delete_data_store_descriptor(
    ...
    url = "{}/datastores/v1/descriptor/{dataStore}".format(settings["api"]["api_url"], dataStore=dataStore)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_descriptors(
    ...
    url = "{}/datastores/v1/descriptor/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_descriptors_simple(
    ...
    url = "{}/datastores/v1/descriptor".format(settings["api"]["api_url"], limit=limit, keywordMatch=keywordMatch, offset=offset, keywords=keywords, keywordField=keywordField, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
