...
def find_n_i_d_s_events(
    ...
    url = "{}/events/v1/nids/search".format(settings["api"]["api_url"], )
    headers = {
...
def list_n_i_d_s_events(
    ...
    url = "{}/events/v1/nids".format(settings["api"]["api_url"], startTimestamp=startTimestamp, endTimestamp=endTimestamp, limit=limit, customerID=customerID, signature=signature, ip=ip, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    if json:
