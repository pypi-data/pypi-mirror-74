...
def get_payload(
    ...
    url = "{}/events/v1/{type}/{timestamp}/{customerID}/{eventID}/payload".format(settings["api"]["api_url"], type=type, timestamp=timestamp, customerID=customerID, eventID=eventID)
    headers = {
