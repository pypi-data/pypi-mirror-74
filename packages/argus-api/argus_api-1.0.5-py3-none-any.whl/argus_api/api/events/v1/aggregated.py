...
def find_aggregated_event_stats(
    ...
    url = "{}/events/v1/aggregated/stats".format(settings["api"]["api_url"], )
    headers = {
...
def find_aggregated_events(
    ...
    url = "{}/events/v1/aggregated/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    if json:
...
def list_aggregated_events(
    ...
    url = "{}/events/v1/aggregated".format(settings["api"]["api_url"], startTimestamp=startTimestamp, endTimestamp=endTimestamp, limit=limit, customerID=customerID, signature=signature, ip=ip, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    if json:
...
def update_events(
    ...
    url = "{}/events/v1/aggregated".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def update_events_bulk(
    ...
    url = "{}/events/v1/aggregated/bulk".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
