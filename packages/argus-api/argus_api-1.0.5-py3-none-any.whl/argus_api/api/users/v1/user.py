...
def check_permission(
    ...
    url = "{}/users/v1/user/{userId}/permission/{function}".format(settings["api"]["api_url"], userId=userId, function=function)
    headers = {
...
def find_users(
    ...
    url = "{}/users/v1/user/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_functions(
    ...
    url = "{}/users/v1/user/{userId}/functions".format(settings["api"]["api_url"], limit=limit, userId=userId, offset=offset, onlyRoles=onlyRoles, keywords=keywords)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_profile(
    ...
    url = "{}/users/v1/user/{userId}".format(settings["api"]["api_url"], userId=userId)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_user_by_username(
    ...
    url = "{}/users/v1/user/{userName}".format(settings["api"]["api_url"], userName=userName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_user_customers(
    ...
    url = "{}/users/v1/user/{userId}/customers".format(settings["api"]["api_url"], limit=limit, keywordMatch=keywordMatch, userId=userId, offset=offset, keywords=keywords, keywordField=keywordField)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_user_profile_picture(
    ...
    url = "{}/users/v1/user/{user}/picture".format(settings["api"]["api_url"], user=user, domain=domain, default=default)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def list_users(
    ...
    url = "{}/users/v1/user".format(settings["api"]["api_url"], limit=limit, subjectID=subjectID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def update_profile_picture_for_user_form(
    ...
    url = "{}/users/v1/user/{userID}/picture".format(settings["api"]["api_url"], userID=userID, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def update_user_preferences(
    ...
    url = "{}/users/v1/user/{user}/preferences".format(settings["api"]["api_url"], user=user, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
