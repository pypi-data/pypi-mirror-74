...
def find_groups(
    ...
    url = "{}/users/v1/group/search".format(settings["api"]["api_url"], )
    headers = {
...
def get_gropu_by_id(
    ...
    url = "{}/users/v1/group/{groupId}".format(settings["api"]["api_url"], groupId=groupId)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_group_by_name(
    ...
    url = "{}/users/v1/group/{groupName}".format(settings["api"]["api_url"], groupName=groupName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_groups(
    ...
    url = "{}/users/v1/group".format(settings["api"]["api_url"], limit=limit, subjectID=subjectID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
