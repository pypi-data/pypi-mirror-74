...
def find_subjects(
    ...
    url = "{}/users/v1/subject/search".format(settings["api"]["api_url"], )
    headers = {
...
def get_subject_by_id(
    ...
    url = "{}/users/v1/subject/{subjectID}".format(settings["api"]["api_url"], subjectID=subjectID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_subject_by_name(
    ...
    url = "{}/users/v1/subject/{subjectName}".format(settings["api"]["api_url"], subjectName=subjectName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_subjects(
    ...
    url = "{}/users/v1/subject".format(settings["api"]["api_url"], limit=limit, subjectID=subjectID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
