...
def get_basic_user(
    ...
    url = "{}/users/v2/user/{shortNameOrID}".format(settings["api"]["api_url"], shortNameOrID=shortNameOrID, domain=domain)
    headers = {
...
def get_user_image(
    ...
    url = "{}/users/v2/user/{shortNameOrID}/picture".format(settings["api"]["api_url"], shortNameOrID=shortNameOrID, domain=domain, width=width, height=height, default=default)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def list_basic_users(
    ...
    url = "{}/users/v2/user".format(settings["api"]["api_url"], limit=limit, keywordMatch=keywordMatch, offset=offset, domain=domain, subject=subject, customer=customer, includeDeleted=includeDeleted, excludeFlag=excludeFlag, includeFlag=includeFlag, keyword=keyword, keywordField=keywordField, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_basic_users(
    ...
    url = "{}/users/v2/user/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
