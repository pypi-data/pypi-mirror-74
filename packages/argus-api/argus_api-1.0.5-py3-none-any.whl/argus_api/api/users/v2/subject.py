...
@register_command(
    extending=("users", "v2", "subject"),
    module=argus_cli_module
)
def get_basic_subject(
    shortNameOrID: str,
    domain: str = None,
    json: bool = True,
    verify: bool = True,
    ...
    """Get a basic subject (PUBLIC)
    
    :param str shortNameOrID: Short name or ID of subject
    :param str domain: Name or ID of the domain of the subject
    ...
    url = "{}/users/v2/subject/{shortNameOrID}".format(settings["api"]["api_url"], shortNameOrID=shortNameOrID, domain=domain)
    headers = {
...
def list_basic_subjects(
    ...
    """Returns the basic subjects matching the query (PUBLIC)
    ...
    url = "{}/users/v2/subject".format(settings["api"]["api_url"], limit=limit, keywordMatch=keywordMatch, offset=offset, domain=domain, subject=subject, customer=customer, includeDeleted=includeDeleted, excludeFlag=excludeFlag, includeFlag=includeFlag, keyword=keyword, keywordField=keywordField, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_basic_subjects(
    ...
    url = "{}/users/v2/subject/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
