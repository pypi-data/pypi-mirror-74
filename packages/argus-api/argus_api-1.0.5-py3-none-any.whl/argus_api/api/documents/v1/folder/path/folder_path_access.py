...
def add_document_raw(
    ...
    url = "{}/documents/v1/folder/{folderID}/documents/{documentName}".format(settings["api"]["api_url"], accessMode=accessMode, folderID=folderID, documentName=documentName, overwriteExisting=overwriteExisting)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def add_folder_watcher_by_path(
    ...
    url = "{}/documents/v1/folder/path/watchers{path}".format(settings["api"]["api_url"], path=path, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_folder(
    ...
    :raises Document(s)LockedException: on 423:raises ArgusException: on other status codes
...
def delete_folder_by_path(
    ...
    url = "{}/documents/v1/folder/path{parentFolderPath}/{folderName}".format(settings["api"]["api_url"], mode=mode, parentFolderPath=parentFolderPath, folderName=folderName, customer=customer, cascadeDocumentID=cascadeDocumentID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_folder_watcher_by_path(
    ...
    url = "{}/documents/v1/folder/path/watchers{path}/{entryID}".format(settings["api"]["api_url"], path=path, customer=customer, entryID=entryID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_current_user_folder_watch_status_by_path(
    ...
    url = "{}/documents/v1/folder/path/watch{path}".format(settings["api"]["api_url"], path=path, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_document_watchers_1(
    ...
    url = "{}/documents/v1/folder/{folderID}/watchers".format(settings["api"]["api_url"], limit=limit, includeInherited=includeInherited, folderID=folderID, offset=offset, includeNegated=includeNegated, includeDeleted=includeDeleted)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_document_watchers_2(
    ...
    url = "{}/documents/v1/folder/path/watchers{path}".format(settings["api"]["api_url"], limit=limit, includeInherited=includeInherited, path=path, customer=customer, offset=offset, includeNegated=includeNegated, includeDeleted=includeDeleted)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def revoke_folder_access_by_path(
    ...
    url = "{}/documents/v1/folder/path/access{path}/{accessID}".format(settings["api"]["api_url"], path=path, accessID=accessID, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
