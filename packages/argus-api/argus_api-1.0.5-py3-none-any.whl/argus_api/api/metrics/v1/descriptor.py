...
def add_metric_descriptor(
    ...
    url = "{}/metrics/v1/descriptor".format(settings["api"]["api_url"], )
    headers = {
...
def delete_metric_descriptor(
    ...
    url = "{}/metrics/v1/descriptor/{descriptor}".format(settings["api"]["api_url"], descriptor=descriptor, descriptorDomain=descriptorDomain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_metric_descriptors(
    ...
    url = "{}/metrics/v1/descriptor".format(settings["api"]["api_url"], limit=limit, descriptorDomain=descriptorDomain, customer=customer, keywords=keywords, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_metric_descriptors(
    ...
    url = "{}/metrics/v1/descriptor/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
