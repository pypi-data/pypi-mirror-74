...
def aggregate_metrics(
    ...
    :param list customer: Restrict result set to records bound to specified customers. The list accepts both ID or shortname for the customers. 
    ...
    :param int resolution: Aggregation resolution period in units specified by 'resolutionUnit' property. If 0 the resolution is the entire time span given by the start and end timestamps. 
    ...
    url = "{}/metrics/v1/metric/{descriptor}/aggregate".format(settings["api"]["api_url"], descriptor=descriptor, descriptorDomain=descriptorDomain)
    headers = {
...
def search_metrics(
    ...
    url = "{}/metrics/v1/metric/{descriptor}/search".format(settings["api"]["api_url"], descriptor=descriptor, descriptorDomain=descriptorDomain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def submit_metric(
    ...
    url = "{}/metrics/v1/metric/{descriptor}".format(settings["api"]["api_url"], descriptor=descriptor, descriptorDomain=descriptorDomain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
