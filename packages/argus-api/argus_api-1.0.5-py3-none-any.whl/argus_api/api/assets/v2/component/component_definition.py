...
def add_component_definition(
    ...
    url = "{}/assets/v2/component/definition".format(settings["api"]["api_url"], )
    headers = {
...
def delete_component_definition(
    ...
    url = "{}/assets/v2/component/definition/{definition}".format(settings["api"]["api_url"], definition=definition, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_component_definitions(
    ...
    url = "{}/assets/v2/component/definition/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_component_definitions_simplified(
    ...
    url = "{}/assets/v2/component/definition".format(settings["api"]["api_url"], limit=limit, keywordMatch=keywordMatch, startTimestamp=startTimestamp, endTimestamp=endTimestamp, timeMatch=timeMatch, offset=offset, keywords=keywords, keywordField=keywordField, timeField=timeField, definition=definition, domain=domain, type=type, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
