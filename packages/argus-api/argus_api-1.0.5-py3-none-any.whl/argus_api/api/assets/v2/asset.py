...
def add_asset(
    ...
    url = "{}/assets/v2/asset".format(settings["api"]["api_url"], )
    headers = {
...
def add_asset_definition(
    ...
    url = "{}/assets/v2/asset/definition".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_asset(
    ...
    url = "{}/assets/v2/asset/{idOrShortName}".format(settings["api"]["api_url"], idOrShortName=idOrShortName, customer=customer, forceIndex=forceIndex)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_asset_definition(
    ...
    url = "{}/assets/v2/asset/definition/{definition}".format(settings["api"]["api_url"], definition=definition, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_asset(
    ...
    url = "{}/assets/v2/asset/{idOrShortName}".format(settings["api"]["api_url"], idOrShortName=idOrShortName, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_vulnerability_by_asset(
    ...
    url = "{}/assets/v2/asset/{asset}/vulnerability".format(settings["api"]["api_url"], asset=asset, customer=customer, includeRawOutput=includeRawOutput)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_vulnerability_by_asset_and_vulnerability_id(
    ...
    url = "{}/assets/v2/asset/{asset}/vulnerability/{vulnerabilityID}".format(settings["api"]["api_url"], asset=asset, vulnerabilityID=vulnerabilityID, customer=customer, includeRawOutput=includeRawOutput)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_assets(
    ...
    url = "{}/assets/v2/asset".format(settings["api"]["api_url"], limit=limit, startTimestamp=startTimestamp, endTimestamp=endTimestamp, customer=customer, asset=asset, parent=parent, keywords=keywords, offset=offset, includeDeleted=includeDeleted, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_asset_definitions(
    ...
    url = "{}/assets/v2/asset/definition/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_asset_definitions_simplified(
    ...
    url = "{}/assets/v2/asset/definition".format(settings["api"]["api_url"], limit=limit, keywordMatch=keywordMatch, startTimestamp=startTimestamp, endTimestamp=endTimestamp, timeMatch=timeMatch, offset=offset, keywords=keywords, keywordField=keywordField, timeField=timeField, definition=definition, domain=domain, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_assets(
    ...
    :param list owner: Search for Assets with these Owner IDs or short names 
    ...
    url = "{}/assets/v2/asset/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
