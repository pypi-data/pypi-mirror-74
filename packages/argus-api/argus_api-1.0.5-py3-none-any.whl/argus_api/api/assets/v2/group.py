...
def add_asset_group(
    ...
    url = "{}/assets/v2/group".format(settings["api"]["api_url"], )
    headers = {
...
def attach_assets(
    ...
    url = "{}/assets/v2/group/{idOrShortName}/assets".format(settings["api"]["api_url"], idOrShortName=idOrShortName, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def attach_children_groups(
    ...
    url = "{}/assets/v2/group/{idOrShortName}/groups".format(settings["api"]["api_url"], idOrShortName=idOrShortName, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_asset_group(
    ...
    url = "{}/assets/v2/group/{idOrShortName}".format(settings["api"]["api_url"], idOrShortName=idOrShortName, customer=customer, forceIndex=forceIndex)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def detach_assets(
    ...
    url = "{}/assets/v2/group/{idOrShortName}/assets".format(settings["api"]["api_url"], idOrShortName=idOrShortName, asset=asset, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def detach_children_groups(
    ...
    url = "{}/assets/v2/group/{idOrShortName}/groups".format(settings["api"]["api_url"], idOrShortName=idOrShortName, group=group, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def detach_single_child_asset(
    ...
    url = "{}/assets/v2/group/{idOrShortName}/assets/{assetIDOrShortName}".format(settings["api"]["api_url"], idOrShortName=idOrShortName, assetIDOrShortName=assetIDOrShortName, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def detach_single_child_group(
    ...
    url = "{}/assets/v2/group/{idOrShortName}/groups/{childGroupIDOrShortName}".format(settings["api"]["api_url"], idOrShortName=idOrShortName, childGroupIDOrShortName=childGroupIDOrShortName, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_asset_group(
    ...
    url = "{}/assets/v2/group/{idOrShortName}".format(settings["api"]["api_url"], idOrShortName=idOrShortName, customer=customer)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_asset_groups(
    ...
    url = "{}/assets/v2/group".format(settings["api"]["api_url"], limit=limit, startTimestamp=startTimestamp, endTimestamp=endTimestamp, customer=customer, group=group, keywords=keywords, offset=offset, includeDeleted=includeDeleted, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_asset_groups(
    ...
    :param list owner: Search for AssetGroups with these owner IDs or short names 
    ...
    :param list child: Search for AssetGroups with these children IDs or short namesi.e. return the groups who contain at least one of these Assets 
    ...
    url = "{}/assets/v2/group/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
