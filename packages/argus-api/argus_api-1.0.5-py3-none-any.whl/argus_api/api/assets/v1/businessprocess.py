...
@register_command(
    extending=("assets", "v1", "businessprocess"),
...
def add_business_process(
    ...
    url = "{}/assets/v1/businessprocess".format(settings["api"]["api_url"], )
    headers = {
...
def attach_services_to_business_process(
    ...
    url = "{}/assets/v1/businessprocess/{id}/attachservices".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
    ...
    body = {}
    # Only send serviceAssetIDs if the argument was provided, dont send null values
    if serviceAssetIDs is not None:
...
def delete_business_process(
    ...
    url = "{}/assets/v1/businessprocess/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def detach_services_from_business_process(
    ...
    url = "{}/assets/v1/businessprocess/{id}/detachservices".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_business_process_statistics(
    name: str = None,
    ...
    url = "{}/assets/v1/businessprocess/statistics".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_business_processes(
    ...
    url = "{}/assets/v1/businessprocess/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    if json:
...
def search_business_processes_simplified(
    ...
    url = "{}/assets/v1/businessprocess".format(settings["api"]["api_url"], limit=limit, keywordMatch=keywordMatch, offset=offset, keywords=keywords, keywordField=keywordField, name=name, hostID=hostID, serviceID=serviceID, businessProcessID=businessProcessID, customerID=customerID, ip=ip, port=port, protocol=protocol, cpe=cpe, vulnID=vulnID, vulnRef=vulnRef, includeFlag=includeFlag, excludeFlag=excludeFlag, sortBy=sortBy, countTimeout=countTimeout)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    if json:
