...
def add_host_asset(
    ...
    url = "{}/assets/v1/host".format(settings["api"]["api_url"], )
    headers = {
...
def delete_host_asset(
    ...
    url = "{}/assets/v1/host/{id}".format(settings["api"]["api_url"], source=source, id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_host_asset(
    ...
    url = "{}/assets/v1/host/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def merge_host_asset(
    ...
    url = "{}/assets/v1/host/{mergeIntoID}/merge".format(settings["api"]["api_url"], mergeIntoID=mergeIntoID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_host_asset_statistics(
    ...
    url = "{}/assets/v1/host/statistics".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_host_assets(
    ...
    url = "{}/assets/v1/host/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    if json:
...
def search_host_assets_simplified(
    ...
    url = "{}/assets/v1/host".format(settings["api"]["api_url"], limit=limit, keywordMatch=keywordMatch, offset=offset, keywords=keywords, keywordField=keywordField, name=name, hostID=hostID, serviceID=serviceID, businessProcessID=businessProcessID, customerID=customerID, ip=ip, port=port, protocol=protocol, cpe=cpe, vulnID=vulnID, vulnRef=vulnRef, includeFlag=includeFlag, excludeFlag=excludeFlag, sortBy=sortBy, countTimeout=countTimeout)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    if json:
