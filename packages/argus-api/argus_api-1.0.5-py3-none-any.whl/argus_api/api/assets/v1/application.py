...
def add_host_application(
    ...
    url = "{}/assets/v1/application".format(settings["api"]["api_url"], )
    headers = {
...
def delete_host_application(
    ...
    url = "{}/assets/v1/application/{id}".format(settings["api"]["api_url"], source=source, id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_host_application(
    ...
    url = "{}/assets/v1/application/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_host_application_statistics(
    ...
    url = "{}/assets/v1/application/statistics".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_host_applications(
    ...
    url = "{}/assets/v1/application/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    if json:
...
def search_host_applications_simplified(
    ...
    url = "{}/assets/v1/application".format(settings["api"]["api_url"], limit=limit, keywordMatch=keywordMatch, offset=offset, keywords=keywords, keywordField=keywordField, name=name, hostID=hostID, serviceID=serviceID, businessProcessID=businessProcessID, customerID=customerID, ip=ip, port=port, protocol=protocol, cpe=cpe, includeFlag=includeFlag, excludeFlag=excludeFlag, sortBy=sortBy, countTimeout=countTimeout)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    if json:
