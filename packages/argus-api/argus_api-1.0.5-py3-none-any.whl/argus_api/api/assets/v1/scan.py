...
def client_host_asset_scanned(
    ...
    url = "{}/assets/v1/scan/{customerID}/client/{hostName}".format(settings["api"]["api_url"], customerID=customerID, hostName=hostName)
    headers = {
...
def host_asset_bulk_scanned(
    ...
    url = "{}/assets/v1/scan".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def host_asset_scanned(
    ...
    url = "{}/assets/v1/scan/{customerID}/{ip}".format(settings["api"]["api_url"], customerID=customerID, ip=ip)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def host_asset_scanned_by_id(
    ...
    url = "{}/assets/v1/scan/{hostID}".format(settings["api"]["api_url"], hostID=hostID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
