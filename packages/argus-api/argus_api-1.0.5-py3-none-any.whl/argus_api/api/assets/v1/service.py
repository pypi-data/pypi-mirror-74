...
def add_service_asset(
    ...
    url = "{}/assets/v1/service".format(settings["api"]["api_url"], )
    headers = {
...
def attach_hosts_to_service(
    ...
    url = "{}/assets/v1/service/{id}/attachhosts".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_service_asset(
    ...
    url = "{}/assets/v1/service/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def detach_hosts_from_service(
    ...
    url = "{}/assets/v1/service/{id}/detachhosts".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_service_asset_statistics(
    ...
    url = "{}/assets/v1/service/statistics".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_service_assets(
    ...
    url = "{}/assets/v1/service/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    if json:
...
def search_service_assets_simplified(
    ...
    url = "{}/assets/v1/service".format(settings["api"]["api_url"], limit=limit, keywordMatch=keywordMatch, offset=offset, keywords=keywords, keywordField=keywordField, name=name, hostID=hostID, serviceID=serviceID, businessProcessID=businessProcessID, customerID=customerID, ip=ip, port=port, protocol=protocol, cpe=cpe, vulnID=vulnID, vulnRef=vulnRef, includeFlag=includeFlag, excludeFlag=excludeFlag, sortBy=sortBy, countTimeout=countTimeout)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    if json:
