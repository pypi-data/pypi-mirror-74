...
def add_customer(
    ...
    url = "{}/customers/v1/customer".format(settings["api"]["api_url"], )
    headers = {
...
def add_customer_service(
    ...
    url = "{}/customers/v1/customer/{customerID}/service".format(settings["api"]["api_url"], customerID=customerID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def disable_customer(
    ...
    url = "{}/customers/v1/customer/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_customer_by_shortname(
    ...
    url = "{}/customers/v1/customer/{shortName}".format(settings["api"]["api_url"], shortName=shortName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_customer_logo_by_id(
    ...
    url = "{}/customers/v1/customer/{id}/logo".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def get_customer_logo_by_shortname(
    shortName: str,
    json: bool = True,
    verify: bool = True,
    apiKey: str = None,
    ...
    url = "{}/customers/v1/customer/{shortName}/logo".format(settings["api"]["api_url"], shortName=shortName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def list_customers(
    ...
    url = "{}/customers/v1/customer".format(settings["api"]["api_url"], limit=limit, keywordMatch=keywordMatch, offset=offset, parentID=parentID, service=service, skipServices=skipServices, keywords=keywords, keywordField=keywordField, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def move_customer(
    ...
    url = "{}/customers/v1/customer/{customer}/move".format(settings["api"]["api_url"], customer=customer, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def reenable_customer(
    ...
    url = "{}/customers/v1/customer/{id}/reenable".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def remove_customer_service(
    ...
    url = "{}/customers/v1/customer/{customerID}/service/{service}".format(settings["api"]["api_url"], customerID=customerID, service=service)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_customers(
    ...
    url = "{}/customers/v1/customer/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
