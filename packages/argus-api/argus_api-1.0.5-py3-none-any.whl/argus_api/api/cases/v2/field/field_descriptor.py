...
def add_field_policy(
    ...
    url = "{}/cases/v2/field/policy".format(settings["api"]["api_url"], )
    headers = {
...
def add_field_to_policy(
    ...
    url = "{}/cases/v2/field/policy/{policy}/fields".format(settings["api"]["api_url"], policy=policy, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def create_field_descriptor(
    ...
    url = "{}/cases/v2/field/descriptor".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_field_descriptor(
    ...
    url = "{}/cases/v2/field/descriptor/{field}".format(settings["api"]["api_url"], field=field, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_field_policy(
    ...
    url = "{}/cases/v2/field/policy/{policy}".format(settings["api"]["api_url"], policy=policy, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_field_descriptors(
    ...
    url = "{}/cases/v2/field/descriptor".format(settings["api"]["api_url"], limit=limit, customerID=customerID, domain=domain, valueType=valueType, field=field, policy=policy, keywords=keywords, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_field_policies(
    ...
    url = "{}/cases/v2/field/policy".format(settings["api"]["api_url"], limit=limit, customerID=customerID, domain=domain, keywords=keywords, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_field_source_values(
    ...
    url = "{}/cases/v2/field/values/{field}".format(settings["api"]["api_url"], limit=limit, field=field, caseID=caseID, service=service, customer=customer, domain=domain, keywords=keywords, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def remove_field_from_policy(
    ...
    url = "{}/cases/v2/field/policy/{policy}/fields/{field}".format(settings["api"]["api_url"], policy=policy, field=field, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_field_descriptors(
    ...
    :param list userID: Restrict search to fields created or updated by specified users (selected by userFieldStrategy). 
    ...
    url = "{}/cases/v2/field/descriptor/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_field_policies(
    ...
    :param list timeFieldStrategy: Defines which timestamps will be included in the search (default lastUpdatedTimestamp). 
    :param str timeMatchStrategy: Defines how strict to match against different timestamps (all/any) using start and end timestamp (default any) 
    :param list userID: Restrict search to policies created or updated by specified users (selected by userFieldStrategy). 
    :param list userFieldStrategy: Defines which user fields will be searched (default match all user fields). 
    ...
    url = "{}/cases/v2/field/policy/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
