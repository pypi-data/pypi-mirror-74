...
def add_customer_service_subscription(
    ...
    url = "{}/cases/v2/servicesubscription".format(settings["api"]["api_url"], )
    headers = {
...
def delete_customer_service_subscription(
    ...
    url = "{}/cases/v2/servicesubscription/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_subscriptions(
    ...
    url = "{}/cases/v2/servicesubscription".format(settings["api"]["api_url"], limit=limit, customerID=customerID, customer=customer, service=service, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
