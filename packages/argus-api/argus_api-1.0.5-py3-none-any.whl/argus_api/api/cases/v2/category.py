...
def create_category(
    ...
    url = "{}/cases/v2/category".format(settings["api"]["api_url"], )
    headers = {
...
def delete_category(
    ...
    url = "{}/cases/v2/category/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_categories(
    ...
    url = "{}/cases/v2/category".format(settings["api"]["api_url"], limit=limit, id=id, shortName=shortName, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_categories(
    ...
    url = "{}/cases/v2/category/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
