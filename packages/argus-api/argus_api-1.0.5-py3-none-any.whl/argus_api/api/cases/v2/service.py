...
def bind_category(
    ...
    url = "{}/cases/v2/service/{serviceID}/categories".format(settings["api"]["api_url"], serviceID=serviceID)
    headers = {
...
def create_service(
    ...
    url = "{}/cases/v2/service".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_service(
    ...
    url = "{}/cases/v2/service/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_field_policy_by_service(
    ...
    url = "{}/cases/v2/service/{service}/fieldpolicy".format(settings["api"]["api_url"], service=service, customer=customer, domain=domain)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_categories_1(
    ...
    url = "{}/cases/v2/service/{id}/categories".format(settings["api"]["api_url"], limit=limit, id=id, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_services(
    ...
    url = "{}/cases/v2/service".format(settings["api"]["api_url"], limit=limit, id=id, shortName=shortName, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_services(
    ...
    url = "{}/cases/v2/service/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def unbind_category(
    ...
    url = "{}/cases/v2/service/{serviceID}/categories/{categoryID}".format(settings["api"]["api_url"], serviceID=serviceID, categoryID=categoryID, caseType=caseType)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
