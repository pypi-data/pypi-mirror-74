...
def search_records_simplified_c_o_f(
    ...
    url = "{}/pdns/v3/cof/{query}".format(settings["api"]["api_url"], aggregate=aggregate, includeAnonymous=includeAnonymous, limit=limit, query=query, rrClass=rrClass, rrType=rrType, customerID=customerID, tlp=tlp, offset=offset)
    headers = {
