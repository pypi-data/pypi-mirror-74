...
def search_records_simplified(
    ...
    url = "{}/pdns/v3/{query}".format(settings["api"]["api_url"], aggregate=aggregate, includeAnonymous=includeAnonymous, limit=limit, query=query, rrClass=rrClass, rrType=rrType, customerID=customerID, tlp=tlp, offset=offset)
    headers = {
