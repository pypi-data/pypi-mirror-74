...
def add_new_source(
    ...
    :param bool useForReputationCalc: 
    ...
    url = "{}/reputation/v1/source".format(settings["api"]["api_url"], )
    headers = {
...
def delete_source(
    ...
    url = "{}/reputation/v1/source/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def find_sources(
    ...
    url = "{}/reputation/v1/source/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_source_by_alias(
    ...
    url = "{}/reputation/v1/source/{alias}".format(settings["api"]["api_url"], alias=alias)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_sources(
    ...
    url = "{}/reputation/v1/source".format(settings["api"]["api_url"], limit=limit, search=search, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def transition_source(
    ...
    url = "{}/reputation/v1/source/{source}/transition".format(settings["api"]["api_url"], source=source)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
