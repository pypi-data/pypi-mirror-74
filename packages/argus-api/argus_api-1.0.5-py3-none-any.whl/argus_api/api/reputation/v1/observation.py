...
def add_observations(
    ...
    url = "{}/reputation/v1/observation".format(settings["api"]["api_url"], )
    headers = {
...
def delete_observations(
    ...
    url = "{}/reputation/v1/observation".format(settings["api"]["api_url"], sourceID=sourceID, sourceAlias=sourceAlias, address=address, fqdn=fqdn)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def fetch_observations_for_domain(
    ...
    url = "{}/reputation/v1/observation/domain/{fqdn}".format(settings["api"]["api_url"], fqdn=fqdn)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def fetch_observations_for_i_p(
    ...
    url = "{}/reputation/v1/observation/ip/{ip}".format(settings["api"]["api_url"], ip=ip)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def find_address_observations(
    ...
    url = "{}/reputation/v1/observation/ip/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def find_domain_observations(
    ...
    url = "{}/reputation/v1/observation/domain/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_address_observations(
    ...
    url = "{}/reputation/v1/observation/ip".format(settings["api"]["api_url"], limit=limit, sourceID=sourceID, minimumState=minimumState, minimumConfidence=minimumConfidence, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_domain_observations(
    ...
    url = "{}/reputation/v1/observation/domain".format(settings["api"]["api_url"], limit=limit, sourceID=sourceID, minimumState=minimumState, minimumConfidence=minimumConfidence, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
