...
def add_new_role(
    ...
    url = "{}/reputation/v1/role".format(settings["api"]["api_url"], )
    headers = {
...
def delete_role(
    ...
    url = "{}/reputation/v1/role/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_role_by_alias(
    ...
    url = "{}/reputation/v1/role/{alias}".format(settings["api"]["api_url"], alias=alias)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_roles(
    ...
    url = "{}/reputation/v1/role".format(settings["api"]["api_url"], limit=limit, search=search, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_roles(
    ...
    url = "{}/reputation/v1/role/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
