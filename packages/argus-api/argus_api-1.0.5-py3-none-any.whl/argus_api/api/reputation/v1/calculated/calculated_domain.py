...
@register_command(
    extending=("reputation", "v1", "calculated", "domain"),
...
def calculate_reputation_for_domain(
    ...
    url = "{}/reputation/v1/calculated/domain/{fqdn}".format(settings["api"]["api_url"], fqdn=fqdn)
    headers = {
...
def calculate_reputation_for_i_p(
    ...
    url = "{}/reputation/v1/calculated/ip/{ip}".format(settings["api"]["api_url"], ip=ip)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def find_address_reputation(
    ...
    url = "{}/reputation/v1/calculated/ip/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def find_domain_reputation(
    ...
    url = "{}/reputation/v1/calculated/domain/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_address_reputation(
    ...
    url = "{}/reputation/v1/calculated/ip".format(settings["api"]["api_url"], limit=limit, fromAddress=fromAddress, afterAddress=afterAddress, sourceID=sourceID, minimumValue=minimumValue, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_domain_reputation(
    ...
    url = "{}/reputation/v1/calculated/domain".format(settings["api"]["api_url"], limit=limit, fromDomain=fromDomain, afterDomain=afterDomain, sourceID=sourceID, minimumValue=minimumValue, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
