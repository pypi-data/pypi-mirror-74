...
def add_category(
    ...
    url = "{}/alarms/v1/category".format(settings["api"]["api_url"], )
    headers = {
...
def delete_category(
    ...
    url = "{}/alarms/v1/category/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_categories(
    ...
    url = "{}/alarms/v1/category".format(settings["api"]["api_url"], limit=limit, keywordMatch=keywordMatch, offset=offset, keywords=keywords, keywordField=keywordField)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_categories(
    ...
    url = "{}/alarms/v1/category/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
