...
def add_alarm(
    ...
    url = "{}/alarms/v1/alarm".format(settings["api"]["api_url"], )
    headers = {
...
def add_alarm_comment(
    ...
    url = "{}/alarms/v1/alarm/{id}/comment".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_alarm(
    ...
    url = "{}/alarms/v1/alarm/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_alarm_comment(
    ...
    url = "{}/alarms/v1/alarm/{id}/comment/{timestamp}".format(settings["api"]["api_url"], id=id, timestamp=timestamp)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_alarms(
    ...
    url = "{}/alarms/v1/alarm".format(settings["api"]["api_url"], keywordMatch=keywordMatch, limit=limit, keywords=keywords, keywordField=keywordField, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def map_to_alarm(
    ...
    url = "{}/alarms/v1/alarm/{id}/map".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_alarms(
    ...
    url = "{}/alarms/v1/alarm/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def unmap(
    ...
    url = "{}/alarms/v1/alarm/{id}/unmap".format(settings["api"]["api_url"], id=id, signature=signature)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
