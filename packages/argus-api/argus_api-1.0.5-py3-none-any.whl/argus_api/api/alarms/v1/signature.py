...
def delete_signatures(
    ...
    url = "{}/alarms/v1/signature".format(settings["api"]["api_url"], signature=signature)
    headers = {
...
def get_signatures(
    ...
    url = "{}/alarms/v1/signature".format(settings["api"]["api_url"], keywordMatch=keywordMatch, limit=limit, keywords=keywords, keywordField=keywordField, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_signatures(
    ...
    url = "{}/alarms/v1/signature/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
