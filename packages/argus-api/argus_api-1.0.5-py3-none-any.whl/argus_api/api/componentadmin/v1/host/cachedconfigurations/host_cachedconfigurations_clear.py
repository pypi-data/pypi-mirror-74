...
def clear_cached_configurations(
    ...
    url = "{}/componentadmin/v1/host/{hostID}/cachedconfigurations/clear".format(settings["api"]["api_url"], hostID=hostID)
    headers = {
...
def compact_persistence(
    ...
    url = "{}/componentadmin/v1/host/{hostID}/persistence/compact".format(settings["api"]["api_url"], hostID=hostID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def install_all(
    ...
    url = "{}/componentadmin/v1/host/{hostID}/installAll".format(settings["api"]["api_url"], hostID=hostID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_persistent_components(
    ...
    url = "{}/componentadmin/v1/host/{hostID}/persistence".format(settings["api"]["api_url"], hostID=hostID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def reboot(
    ...
    url = "{}/componentadmin/v1/host/{hostID}/reboot".format(settings["api"]["api_url"], hostID=hostID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def refresh_host_status(
    ...
    url = "{}/componentadmin/v1/host/{id}/status/refresh".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
