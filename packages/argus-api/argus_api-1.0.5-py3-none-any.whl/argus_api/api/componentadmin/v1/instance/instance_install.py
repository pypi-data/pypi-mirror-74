...
def get_container_performance(
    ...
    :raises RemoteInvocationFailedException: on 409:raises ArgusException: on other status codes
    ...
    url = "{}/componentadmin/v1/instance/{id}/performance".format(settings["api"]["api_url"], id=id)
    headers = {
...
def get_instance_status(
    ...
    :raises AuthenticationFailedException: on 401
    :raises AccessDeniedException: on 403
    :raises ObjectNotFoundException: on 404:raises ArgusException: on other status codes
    ...
    url = "{}/componentadmin/v1/instance/{id}/status".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def install(
    ...
    url = "{}/componentadmin/v1/instance/{id}/install".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def reboot_1(
    ...
    url = "{}/componentadmin/v1/instance/{id}/reboot".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def refresh_instance_status(
    ...
    url = "{}/componentadmin/v1/instance/{id}/status/refresh".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def start(
    ...
    url = "{}/componentadmin/v1/instance/{id}/start".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def stop(
    ...
    url = "{}/componentadmin/v1/instance/{id}/stop".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def uninstall(
    ...
    url = "{}/componentadmin/v1/instance/{id}/uninstall".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
