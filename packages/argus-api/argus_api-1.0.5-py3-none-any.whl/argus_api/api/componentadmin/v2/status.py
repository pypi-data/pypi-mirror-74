...
def get_component_status(
    ...
    url = "{}/componentadmin/v2/status/component/{componentID}".format(settings["api"]["api_url"], componentID=componentID)
    headers = {
...
def get_host_instances(
    ...
    url = "{}/componentadmin/v2/status/host/{host}/instances".format(settings["api"]["api_url"], limit=limit, host=host, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_host_status(
    ...
    url = "{}/componentadmin/v2/status/host/{host}".format(settings["api"]["api_url"], host=host)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_instance_status_1(
    ...
    url = "{}/componentadmin/v2/status/instance/{instanceID}".format(settings["api"]["api_url"], instanceID=instanceID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_status_overview(
    ...
    url = "{}/componentadmin/v2/status".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_component_status(
    ...
    url = "{}/componentadmin/v2/status/component".format(settings["api"]["api_url"], limit=limit, componentType=componentType, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_host_status(
    ...
    url = "{}/componentadmin/v2/status/host".format(settings["api"]["api_url"], limit=limit, instanceState=instanceState, hostState=hostState, offset=offset, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_instance_status(
    ...
    url = "{}/componentadmin/v2/status/instance".format(settings["api"]["api_url"], limit=limit, instanceState=instanceState, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_component_status(
    ...
    url = "{}/componentadmin/v2/status/component/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_host_status(
    ...
    url = "{}/componentadmin/v2/status/host/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_instance_status(
    ...
    url = "{}/componentadmin/v2/status/instance/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
