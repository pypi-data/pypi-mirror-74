...
def create_location(
    ...
    :param str name: Name of some physical location  => [a-zA-Z0-9_\-\.]*
    ...
    url = "{}/sensors/v1/location".format(settings["api"]["api_url"], )
    headers = {
...
def delete_location(
    ...
    url = "{}/sensors/v1/location/{idOrShortName}".format(settings["api"]["api_url"], idOrShortName=idOrShortName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def find_locations(
    ...
    url = "{}/sensors/v1/location/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_locations(
    ...
    url = "{}/sensors/v1/location".format(settings["api"]["api_url"], limit=limit, customerID=customerID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
