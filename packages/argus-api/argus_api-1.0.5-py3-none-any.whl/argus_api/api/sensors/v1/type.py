...
def add_sensor_type(
    ...
    url = "{}/sensors/v1/type".format(settings["api"]["api_url"], )
    headers = {
...
def delete_sensor_type(
    ...
    url = "{}/sensors/v1/type/{idOrShortName}".format(settings["api"]["api_url"], idOrShortName=idOrShortName, newType=newType)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_sensor_type(
    ...
    url = "{}/sensors/v1/type/{idOrShortName}".format(settings["api"]["api_url"], idOrShortName=idOrShortName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
