...
def find_sensors(
    ...
    url = "{}/sensors/v1/status/search".format(settings["api"]["api_url"], )
    headers = {
...
def get_sensor(
    ...
    url = "{}/sensors/v1/status/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_sensors(
    ...
    url = "{}/sensors/v1/status".format(settings["api"]["api_url"], limit=limit, customerID=customerID, applicationName=applicationName, keywords=keywords, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
