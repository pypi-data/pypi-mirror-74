...
def get_profile_picture(
    ...
    :raises ProfilePictureNotFoundException: on 404:raises ArgusException: on other status codes
    ...
    url = "{}/currentuser/v1/picture".format(settings["api"]["api_url"], default=default)
    headers = {
...
def update_profile_picture_json(
    ...
    url = "{}/currentuser/v1/picture".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
