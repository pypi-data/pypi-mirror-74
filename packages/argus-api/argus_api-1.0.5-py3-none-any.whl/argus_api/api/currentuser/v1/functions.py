...
def get_functions(
    ...
    :raises ForbiddenPermissionException: on 403:raises ArgusException: on other status codes
    ...
    url = "{}/currentuser/v1/functions".format(settings["api"]["api_url"], limit=limit, offset=offset, onlyRoles=onlyRoles, keywords=keywords)
    headers = {
