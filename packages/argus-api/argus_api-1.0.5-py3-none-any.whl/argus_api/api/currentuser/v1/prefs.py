...
def delete_properties(
    ...
    url = "{}/currentuser/v1/prefs".format(settings["api"]["api_url"], key=key)
    headers = {
...
def delete_property(
    ...
    url = "{}/currentuser/v1/prefs/{propertyKey}".format(settings["api"]["api_url"], propertyKey=propertyKey)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_property(
    ...
    :raises AuthenticationFailedException: on 401
    :raises KeyNotSetException: on 404:raises ArgusException: on other status codes
...
def list_properties(
    ...
    :raises AuthenticationFailedException: on 401:raises ArgusException: on other status codes
    ...
    url = "{}/currentuser/v1/prefs".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
