...
def add_comment_2(
    ...
    url = "{}/configurationadmin/v1/template/{id}/comment".format(settings["api"]["api_url"], id=id)
    headers = {
...
def create_4(
    ...
    url = "{}/configurationadmin/v1/template".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_3(
    ...
    url = "{}/configurationadmin/v1/template/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def duplicate_3(
    ...
    url = "{}/configurationadmin/v1/template/{id}/duplicate".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_4(
    ...
    url = "{}/configurationadmin/v1/template".format(settings["api"]["api_url"], limit=limit, orderBy=orderBy, search=search, includeComments=includeComments, includeDeleted=includeDeleted, offset=offset, orderDesc=orderDesc)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def revisions_1(
    ...
    url = "{}/configurationadmin/v1/template/{id}/revisions".format(settings["api"]["api_url"], limit=limit, id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_4(
    ...
    url = "{}/configurationadmin/v1/template/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
