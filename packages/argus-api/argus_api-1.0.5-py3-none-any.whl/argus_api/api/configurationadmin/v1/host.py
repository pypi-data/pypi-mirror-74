...
def add_comment(
    ...
    url = "{}/configurationadmin/v1/host/{id}/comment".format(settings["api"]["api_url"], id=id)
    headers = {
...
def create_2(
    ...
    url = "{}/configurationadmin/v1/host".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_1(
    ...
    url = "{}/configurationadmin/v1/host/{id}".format(settings["api"]["api_url"], id=id, deleteInstances=deleteInstances)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def disable_monitoring(
    ...
    url = "{}/configurationadmin/v1/host/{id}/monitoring/disable".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def duplicate_1(
    ...
    url = "{}/configurationadmin/v1/host/{sourceID}/duplicate".format(settings["api"]["api_url"], sourceID=sourceID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def duplicate_2(
    ...
    url = "{}/configurationadmin/v1/host/{hostID}/setupdefault".format(settings["api"]["api_url"], hostID=hostID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def enable_monitoring(
    ...
    url = "{}/configurationadmin/v1/host/{id}/monitoring/enable".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_2(
    ...
    url = "{}/configurationadmin/v1/host".format(settings["api"]["api_url"], limit=limit, orderBy=orderBy, search=search, includeComments=includeComments, includeDeleted=includeDeleted, offset=offset, orderDesc=orderDesc)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def schedule_monitoring(
    ...
    url = "{}/configurationadmin/v1/host/{id}/monitoring/schedule".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_2(
    ...
    url = "{}/configurationadmin/v1/host/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def update_1(
    ...
    url = "{}/configurationadmin/v1/host/{hostID}".format(settings["api"]["api_url"], hostID=hostID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def view(
    ...
    url = "{}/configurationadmin/v1/host/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
