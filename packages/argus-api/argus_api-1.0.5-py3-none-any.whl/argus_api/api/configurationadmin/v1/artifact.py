...
def create(
    ...
    url = "{}/configurationadmin/v1/artifact".format(settings["api"]["api_url"], )
    headers = {
...
def create_from_octet_stream(
    ...
    url = "{}/configurationadmin/v1/artifact/{groupID}/{artifactID}/{version}".format(settings["api"]["api_url"], groupID=groupID, artifactID=artifactID, version=version)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_unused(
    ...
    url = "{}/configurationadmin/v1/artifact/unused".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def download_by_g_a_v(
    ...
    url = "{}/configurationadmin/v1/artifact/{groupID}/{artifactID}/{version}/download".format(settings["api"]["api_url"], groupID=groupID, artifactID=artifactID, version=version)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def download_by_id(
    ...
    url = "{}/configurationadmin/v1/artifact/{id}/download".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def get_by_g_a_v(
    ...
    url = "{}/configurationadmin/v1/artifact/{groupID}/{artifactID}/{version}".format(settings["api"]["api_url"], groupID=groupID, artifactID=artifactID, version=version, includeData=includeData)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_by_id(
    ...
    url = "{}/configurationadmin/v1/artifact/{id}".format(settings["api"]["api_url"], id=id, includeData=includeData)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list(
    ...
    url = "{}/configurationadmin/v1/artifact".format(settings["api"]["api_url"], limit=limit, orderBy=orderBy, search=search, offset=offset, orderDesc=orderDesc)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search(
    ...
    url = "{}/configurationadmin/v1/artifact/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
