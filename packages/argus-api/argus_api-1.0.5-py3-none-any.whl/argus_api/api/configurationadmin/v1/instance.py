...
def add_comment_1(
    ...
    url = "{}/configurationadmin/v1/instance/{id}/comment".format(settings["api"]["api_url"], id=id)
    headers = {
...
def create_3(
    ...
    url = "{}/configurationadmin/v1/instance".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_2(
    ...
    url = "{}/configurationadmin/v1/instance/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def disable_monitoring_1(
    ...
    url = "{}/configurationadmin/v1/instance/{id}/monitoring/disable".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def enable_monitoring_1(
    ...
    url = "{}/configurationadmin/v1/instance/{id}/monitoring/enable".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_3(
    ...
    url = "{}/configurationadmin/v1/instance".format(settings["api"]["api_url"], limit=limit, offset=offset, search=search, includeComments=includeComments, includeDeleted=includeDeleted, templateID=templateID, hostID=hostID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def revisions(
    ...
    url = "{}/configurationadmin/v1/instance/{id}/revisions".format(settings["api"]["api_url"], limit=limit, id=id, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def schedule_monitoring_1(
    ...
    url = "{}/configurationadmin/v1/instance/{id}/monitoring/schedule".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_3(
    ...
    url = "{}/configurationadmin/v1/instance/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
