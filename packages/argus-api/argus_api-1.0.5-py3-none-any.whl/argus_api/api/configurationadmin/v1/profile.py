...
def attach(
    ...
    url = "{}/configurationadmin/v1/profile/{profileID}/artifacts/{artifactID}".format(settings["api"]["api_url"], profileID=profileID, artifactID=artifactID)
    headers = {
...
def attach_by_name(
    ...
    url = "{}/configurationadmin/v1/profile/{profileName}/artifacts/{groupID}/{artifactID}/{version}".format(settings["api"]["api_url"], profileName=profileName, groupID=groupID, artifactID=artifactID, version=version)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def attach_detach(
    ...
    url = "{}/configurationadmin/v1/profile/{profileID}/artifacts".format(settings["api"]["api_url"], profileID=profileID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def create_1(
    ...
    url = "{}/configurationadmin/v1/profile".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete(
    ...
    url = "{}/configurationadmin/v1/profile/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def detach_by_artifact_by_g_a(
    ...
    url = "{}/configurationadmin/v1/profile/{profileName}/artifacts/{groupID}/{artifactID}".format(settings["api"]["api_url"], profileName=profileName, groupID=groupID, artifactID=artifactID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def duplicate(
    ...
    url = "{}/configurationadmin/v1/profile/{id}/duplicate/{name}".format(settings["api"]["api_url"], id=id, name=name)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_by_name(
    ...
    url = "{}/configurationadmin/v1/profile/{name}".format(settings["api"]["api_url"], name=name)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_1(
    ...
    url = "{}/configurationadmin/v1/profile".format(settings["api"]["api_url"], limit=limit, orderBy=orderBy, offset=offset, orderDesc=orderDesc)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_1(
    ...
    url = "{}/configurationadmin/v1/profile/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
