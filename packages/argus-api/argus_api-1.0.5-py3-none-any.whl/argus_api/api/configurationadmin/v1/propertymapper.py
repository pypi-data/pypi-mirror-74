...
def create_property_mapper(
    ...
    url = "{}/configurationadmin/v1/propertymapper".format(settings["api"]["api_url"], )
    headers = {
...
def delete_property_mapper(
    ...
    url = "{}/configurationadmin/v1/propertymapper/{idOrShortName}".format(settings["api"]["api_url"], idOrShortName=idOrShortName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_property_mapper(
    ...
    url = "{}/configurationadmin/v1/propertymapper/{idOrShortName}".format(settings["api"]["api_url"], includeConfig=includeConfig, idOrShortName=idOrShortName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_property_mapper_revision(
    ...
    url = "{}/configurationadmin/v1/propertymapper/{idOrShortName}/revisions/{revision}".format(settings["api"]["api_url"], includeConfig=includeConfig, idOrShortName=idOrShortName, revision=revision)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_property_mapper_revisions(
    ...
    url = "{}/configurationadmin/v1/propertymapper/{idOrShortName}/revisions".format(settings["api"]["api_url"], limit=limit, idOrShortName=idOrShortName, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_property_mappers(
    ...
    url = "{}/configurationadmin/v1/propertymapper".format(settings["api"]["api_url"], limit=limit, includeConfig=includeConfig, keywordMatch=keywordMatch, timestampMatch=timestampMatch, offset=offset, includeDeleted=includeDeleted, keyword=keyword, keywordField=keywordField, timestampField=timestampField, start=start, end=end, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def restore_property_mapper(
    ...
    url = "{}/configurationadmin/v1/propertymapper/{idOrShortName}/restore".format(settings["api"]["api_url"], idOrShortName=idOrShortName)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def rollback_property_mapper(
    ...
    url = "{}/configurationadmin/v1/propertymapper/{idOrShortName}/revisions/{revision}/rollback".format(settings["api"]["api_url"], idOrShortName=idOrShortName, revision=revision)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search_property_mappers(
    ...
    url = "{}/configurationadmin/v1/propertymapper/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
