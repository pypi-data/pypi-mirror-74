...
def add_analysis(
    ...
    url = "{}/sampledb/v2/sample/{sha256}/analysis".format(settings["api"]["api_url"], sha256=sha256)
    headers = {
...
def add_evidence(
    ...
    url = "{}/sampledb/v2/sample/{sha256}/analysis/{analysisID}/evidence".format(settings["api"]["api_url"], sha256=sha256, analysisID=analysisID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def add_link(
    ...
    url = "{}/sampledb/v2/sample/{sha256}/link".format(settings["api"]["api_url"], sha256=sha256)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_analysis(
    ...
    url = "{}/sampledb/v2/sample/{sha256}/analysis/{analysisID}".format(settings["api"]["api_url"], sha256=sha256, analysisID=analysisID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_evidence(
    ...
    url = "{}/sampledb/v2/sample/{sha256}/analysis/{analysisID}/evidence/{evidenceID}".format(settings["api"]["api_url"], sha256=sha256, analysisID=analysisID, evidenceID=evidenceID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_evidence_data(
    ...
    url = "{}/sampledb/v2/sample/{sha256}/analysis/{analysisID}/evidence/{evidenceID}/download".format(settings["api"]["api_url"], sha256=sha256, analysisID=analysisID, evidenceID=evidenceID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def get_link(
    ...
    url = "{}/sampledb/v2/sample/{sha256}/link/{linkID}".format(settings["api"]["api_url"], sha256=sha256, linkID=linkID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_analysis(
    ...
    url = "{}/sampledb/v2/sample/{sha256}/analysis".format(settings["api"]["api_url"], limit=limit, sha256=sha256, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_evidence(
    ...
    url = "{}/sampledb/v2/sample/{sha256}/analysis/{analysisID}/evidence".format(settings["api"]["api_url"], limit=limit, sha256=sha256, analysisID=analysisID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_links(
    ...
    url = "{}/sampledb/v2/sample/{sha256}/link".format(settings["api"]["api_url"], limit=limit, sha256=sha256, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
