...
def get_evil_samples(
    ...
    url = "{}/sampledb/v1/sample/search/evil".format(settings["api"]["api_url"], )
    headers = {
...
def get_sample(
    ...
    url = "{}/sampledb/v1/sample/{sha256}".format(settings["api"]["api_url"], sha256=sha256)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_sample_aggregated(
    ...
    url = "{}/sampledb/v1/sample/{sha256}/aggregated".format(settings["api"]["api_url"], sha256=sha256)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_sample_children(
    ...
    url = "{}/sampledb/v1/sample/{sha256}/children".format(settings["api"]["api_url"], limit=limit, sha256=sha256, offset=offset, customerID=customerID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_sample_download(
    ...
    url = "{}/sampledb/v1/sample/{sha256}/download".format(settings["api"]["api_url"], sha256=sha256)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    if json:
...
def get_sample_tags(
    ...
    url = "{}/sampledb/v1/sample/{sha256}/tags".format(settings["api"]["api_url"], limit=limit, sha256=sha256, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_sandbox_pcap(
    ...
    url = "{}/sampledb/v1/sample/{sha256}/sandbox/pcap".format(settings["api"]["api_url"], sha256=sha256)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    if json:
...
def get_sandbox_procgraph(
    ...
    url = "{}/sampledb/v1/sample/{sha256}/sandbox/{runUUID}/procgraph".format(settings["api"]["api_url"], sha256=sha256, runUUID=runUUID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    if json:
...
def get_sandbox_runs(
    ...
    url = "{}/sampledb/v1/sample/{sha256}/sandbox".format(settings["api"]["api_url"], limit=limit, sha256=sha256, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list_submissions_by_sample_id(
    ...
    url = "{}/sampledb/v1/sample/{sha256}/submission".format(settings["api"]["api_url"], limit=limit, sha256=sha256, offset=offset, customerID=customerID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def submit(
    ...
    url = "{}/sampledb/v1/sample".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
