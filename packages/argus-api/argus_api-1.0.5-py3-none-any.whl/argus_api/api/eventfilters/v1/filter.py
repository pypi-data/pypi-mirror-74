...
def error_stats(
    ...
    url = "{}/eventfilters/v1/filter/errorstats".format(settings["api"]["api_url"], includeDetails=includeDetails)
    headers = {
...
def get(
    ...
    url = "{}/eventfilters/v1/filter/{id}".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def hit_stats(
    ...
    url = "{}/eventfilters/v1/filter/hitstats".format(settings["api"]["api_url"], period=period, includeDetails=includeDetails)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def list(
    ...
    url = "{}/eventfilters/v1/filter".format(settings["api"]["api_url"], limit=limit, offset=offset, search=search, customerID=customerID, type=type)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def move_filter(
    ...
    url = "{}/eventfilters/v1/filter/{id}/move".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def revisions(
    ...
    url = "{}/eventfilters/v1/filter/{id}/revisions".format(settings["api"]["api_url"], limit=limit, offset=offset, id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def search(
    ...
    url = "{}/eventfilters/v1/filter/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def set_log_level(
    ...
    url = "{}/eventfilters/v1/filter/{id}/logging".format(settings["api"]["api_url"], id=id)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
