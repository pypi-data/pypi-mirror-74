...
def add_customer_network(
    ...
    url = "{}/customernetworks/v1/network".format(settings["api"]["api_url"], )
    headers = {
...
def add_customer_network_comment(
    ...
    url = "{}/customernetworks/v1/network/{networkID}/comments".format(settings["api"]["api_url"], networkID=networkID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def bulk_add_customer_networks(
    ...
    url = "{}/customernetworks/v1/network/bulk".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_customer_network(
    ...
    url = "{}/customernetworks/v1/network/{networkID}".format(settings["api"]["api_url"], networkID=networkID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def delete_customer_network_comment(
    ...
    url = "{}/customernetworks/v1/network/{networkID}/comments/{commentID}".format(settings["api"]["api_url"], networkID=networkID, commentID=commentID)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_customer_network_comments(
    ...
    url = "{}/customernetworks/v1/network/{networkID}/comments".format(settings["api"]["api_url"], limit=limit, networkID=networkID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
        'content': 'application/json'
    }
...
def get_customer_networks(
    ...
    url = "{}/customernetworks/v1/network".format(settings["api"]["api_url"], limit=limit, customerID=customerID, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    if json:
...
def search_customer_network(
    ...
    url = "{}/customernetworks/v1/network/search".format(settings["api"]["api_url"], )
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
    if json:
