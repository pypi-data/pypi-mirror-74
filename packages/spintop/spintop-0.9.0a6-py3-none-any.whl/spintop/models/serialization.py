...
class Serializer(object):
    ...
    def schema(self, *args, cls=None, **kwargs):
        schema = self.base_schema_cls(*args, **kwargs)
        if cls:
            schema.context = type_dict_of(cls)
        return schema
    ...
    def serialize(self, obj, cls=None):
        master_schema = self.schema(cls=cls)
    ...
    def deserialize(self, obj, cls=None, **kwargs):
        master_schema = self.schema(cls=cls)
