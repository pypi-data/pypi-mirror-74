...
[boto3.STS 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/sts.html#STS) service
...
`mypy_boto3_sts` and other installed services.
...
session_client = boto3.Session().client("sts")
```
