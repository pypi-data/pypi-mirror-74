...
setup(
  ...
  packages = ['influence'],   # Chose the same as "name"
  ...
  long_description = 'See https://github.com/RandomKiddo/influence',
  ...
  download_url = 'https://github.com/RandomKiddo/influence/archive/v_03.tar.gz',    # I explain this later on
