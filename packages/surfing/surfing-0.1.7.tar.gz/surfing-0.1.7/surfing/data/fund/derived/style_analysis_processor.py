...
class StyleAnalysisProcessor(object):
    ...
    def process(self, start_date, end_date):
        ...
        try:
            ...
            print(e)
            traceback.print_exc()
            failed_tasks.append('style_analysis_factor_return')
        return failed_tasks
...
if __name__ == "__main__":
    ...
    StyleAnalysisProcessor(data_helper, 'csi800').process('2005-01-01', '2014-12-31')
