...
class ReportHelper:
    ...
    def asset_price_ratio(self):    
        return HybridPainter.plot_fund_alpha(self.fund_nav, self.fund_info, self.index_price, self.fund_position_history.copy(), self.get_fund_stat(), self.dts)
