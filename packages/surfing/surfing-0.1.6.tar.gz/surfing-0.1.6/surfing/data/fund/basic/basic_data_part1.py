...
class BasicDataPart1:
    ...
    @staticmethod
    def _lambda_func_index_component_1(em_id_map: Dict[str, str], x: pd.Series):
        try:
            return em_id_map[x]
        except KeyError:
            return x
    ...
    def sector_info(self):
        try:
            ...
            self._data_helper._upload_basic(df, SectorInfo.__table__.name)
            return True
        except Exception as e:
            print(e)
            traceback.print_exc()
    ...
    def sector_funds(self):
        try:
            ...
            self._data_helper._upload_basic(df, SectorFunds.__table__.name)
            return True
        except Exception as e:
            print(e)
            traceback.print_exc()
