...
class IntegrationsApi(object):
    ...
    def create(self, body, **kwargs):  # noqa: E501
        ...
        Create a new integration with Rockset.  # noqa: E501
    ...
    def delete(self, integration, **kwargs):  # noqa: E501
        """Delete Integration  # noqa: E501

        Remove an integration.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete(integration, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_with_http_info(integration, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_with_http_info(integration, **kwargs)  # noqa: E501
            return data

    def delete_with_http_info(self, integration, **kwargs):  # noqa: E501
        """Delete Integration  # noqa: E501

        Remove an integration.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_with_http_info(integration, async_req=True)
        >>> result = thread.get()
        ...
        if ('integration' not in params or
            ...
            raise ValueError("Missing the required parameter `integration` when calling `delete`")  # noqa: E501
    ...
    def get(self, integration, **kwargs):  # noqa: E501
        """Get Integration  # noqa: E501

        Get information about a single integration.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get(integration, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_with_http_info(integration, **kwargs)  # noqa: E501
        else:
            (data) = self.get_with_http_info(integration, **kwargs)  # noqa: E501
            return data

    def get_with_http_info(self, integration, **kwargs):  # noqa: E501
        """Get Integration  # noqa: E501

        Get information about a single integration.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_with_http_info(integration, async_req=True)
        >>> result = thread.get()
        ...
        if ('integration' not in params or
                params['integration'] is None):
            raise ValueError("Missing the required parameter `integration` when calling `get`")  # noqa: E501
    ...
    def list(self, **kwargs):  # noqa: E501
        ...
        List all integrations for organization.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
