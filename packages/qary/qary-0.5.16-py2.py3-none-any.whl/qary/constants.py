...
LARGE_FILES = {
    'wikipedia_titles': dict(
        ...
        path=Path(DATA_DIR, 'corpora', 'wikipedia', 'enwiki-latest-all-titles-in-ns0.gz')),
    'squad_dev': dict(
        url='https://rajpurkar.github.io/SQuAD-explorer/dataset/dev-v2.0.json',
        path=Path(DATA_DIR, 'training_sets', 'squad', 'dev-v2.0.json')),
    'squad': dict(
        url='https://rajpurkar.github.io/SQuAD-explorer/dataset/train-v2.0.json',
        path=Path(DATA_DIR, 'training_sets', 'squad', 'train-v2.0.json')),
    'floyd': dict(
    ...
    'bert-base-cased': dict(
        ...
        path=Path(DATA_DIR, 'models', 'qa', 'bert-base-cased-0.2.0.zip')),
}
tmp_large_files = {}
...
def create_django_settings_dict(settings=None):
    DATABASES = {
        'sqlite': {
    ...
    return dict(DATABASES=DATABASES, INSTALLED_APPS=['qary.orm'])
...
django_settings_dict = create_django_settings_dict()
