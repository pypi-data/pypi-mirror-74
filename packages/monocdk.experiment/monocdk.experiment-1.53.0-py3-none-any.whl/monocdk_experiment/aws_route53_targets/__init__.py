...
from ..aws_apigateway import (
    RestApi as _RestApi_efdcda3d,
    IDomainName as _IDomainName_6a85089a,
)
from ..aws_cloudfront import (
    CloudFrontWebDistribution as _CloudFrontWebDistribution_2241efd0,
)
...
class CloudFrontTarget(
    ...
    def __init__(self, distribution: _CloudFrontWebDistribution_2241efd0) -> None:
        """
        :param distribution: -
