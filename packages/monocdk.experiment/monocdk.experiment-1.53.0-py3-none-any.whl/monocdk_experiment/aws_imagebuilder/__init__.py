    ...
    def __init__(
        ...
        *,
        distributions: typing.Union[
            ...
            typing.List[typing.Union["DistributionProperty", _IResolvable_9ceae33e]],
        ],
        name: str,
        description: typing.Optional[str] = None,
        tags: typing.Optional[typing.Mapping[str, str]] = None,
...
class CfnImage(
    ...
    def __init__(
        ...
        *,
        ...
        image_tests_configuration: typing.Optional[
            typing.Union["ImageTestsConfigurationProperty", _IResolvable_9ceae33e]
        ] = None,
        tags: typing.Optional[typing.Mapping[str, str]] = None,
    ) -> None:
    ...
    class ImageTestsConfigurationProperty:
        def __init__(
            self,
            *,
            image_tests_enabled: typing.Optional[
    ...
    def __init__(
        ...
        *,
        ...
        schedule: typing.Optional[
            typing.Union["ScheduleProperty", _IResolvable_9ceae33e]
        ] = None,
...
class CfnImagePipelineProps:
    def __init__(
        ...
        *,
        ...
        schedule: typing.Optional[
            typing.Union["CfnImagePipeline.ScheduleProperty", _IResolvable_9ceae33e]
        ] = None,
        status: typing.Optional[str] = None,
        tags: typing.Optional[typing.Mapping[str, str]] = None,
    ) -> None:
    ...
    def image_tests_configuration(
        ...
        typing.Union[
            "CfnImagePipeline.ImageTestsConfigurationProperty", _IResolvable_9ceae33e
        ]
    ]:
        """``AWS::ImageBuilder::ImagePipeline.ImageTestsConfiguration``.
...
class CfnImageProps:
    def __init__(
        ...
        *,
        ...
        image_tests_configuration: typing.Optional[
            typing.Union[
                "CfnImage.ImageTestsConfigurationProperty", _IResolvable_9ceae33e
            ]
        ] = None,
        tags: typing.Optional[typing.Mapping[str, str]] = None,
    ) -> None:
    ...
    def image_tests_configuration(
        ...
        typing.Union["CfnImage.ImageTestsConfigurationProperty", _IResolvable_9ceae33e]
    ]:
        """``AWS::ImageBuilder::Image.ImageTestsConfiguration``.
    ...
    def __init__(
        ...
        *,
        components: typing.Union[
            _IResolvable_9ceae33e,
            typing.List[
                typing.Union["ComponentConfigurationProperty", _IResolvable_9ceae33e]
            ],
        ],
        name: str,
        parent_image: str,
        ...
        block_device_mappings: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "InstanceBlockDeviceMappingProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ] = None,
...
class CfnImageRecipeProps:
    ...
    def components(
        ...
        typing.List[
            typing.Union[
                "CfnImageRecipe.ComponentConfigurationProperty", _IResolvable_9ceae33e
            ]
        ],
    ]:
        """``AWS::ImageBuilder::ImageRecipe.Components``.
...
class CfnInfrastructureConfiguration(
    ...
    def __init__(
        ...
        *,
        ...
        tags: typing.Optional[typing.Mapping[str, str]] = None,
        terminate_instance_on_failure: typing.Optional[
            typing.Union[bool, _IResolvable_9ceae33e]
        ] = None,
    ) -> None:
    ...
    class LoggingProperty:
        ...
        def s3_logs(
            ...
            typing.Union[
                "CfnInfrastructureConfiguration.S3LogsProperty", _IResolvable_9ceae33e
            ]
        ]:
