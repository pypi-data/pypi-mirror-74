...
class Origin(
    ...
    jsii_type="monocdk-experiment.aws_cloudfront.Origin",
):
    ...
    @builtins.classmethod
    def from_bucket(cls, bucket: _IBucket_25bad983) -> "Origin":
...
class S3Origin(
    Origin,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudfront.S3Origin",
):
    ...
    def __init__(self, *, bucket: _IBucket_25bad983, domain_name: str) -> None:
        """
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudfront.S3OriginProps",
    jsii_struct_bases=[OriginProps],
    name_mapping={"domain_name": "domainName", "bucket": "bucket"},
)
class S3OriginProps(OriginProps):
    def __init__(self, *, domain_name: str, bucket: _IBucket_25bad983) -> None:
...
class HttpOrigin(
    Origin,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudfront.HttpOrigin",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudfront.HttpOriginProps",
    jsii_struct_bases=[OriginProps],
