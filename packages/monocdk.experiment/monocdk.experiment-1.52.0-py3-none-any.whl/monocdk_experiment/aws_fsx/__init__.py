    ...
    def __init__(
        ...
        *,
        ...
        lustre_configuration: typing.Optional[
            typing.Union["LustreConfigurationProperty", _IResolvable_9ceae33e]
        ] = None,
        ...
        windows_configuration: typing.Optional[
            typing.Union["WindowsConfigurationProperty", _IResolvable_9ceae33e]
        ] = None,
    ) -> None:
...
class CfnFileSystemProps:
    def __init__(
        ...
        *,
        ...
        lustre_configuration: typing.Optional[
            typing.Union[
                "CfnFileSystem.LustreConfigurationProperty", _IResolvable_9ceae33e
            ]
        ] = None,
        security_group_ids: typing.Optional[typing.List[str]] = None,
        storage_capacity: typing.Optional[jsii.Number] = None,
        ...
        windows_configuration: typing.Optional[
            typing.Union[
                "CfnFileSystem.WindowsConfigurationProperty", _IResolvable_9ceae33e
            ]
        ] = None,
    ) -> None:
    ...
    def lustre_configuration(
        ...
        typing.Union["CfnFileSystem.LustreConfigurationProperty", _IResolvable_9ceae33e]
    ]:
        """``AWS::FSx::FileSystem.LustreConfiguration``.
