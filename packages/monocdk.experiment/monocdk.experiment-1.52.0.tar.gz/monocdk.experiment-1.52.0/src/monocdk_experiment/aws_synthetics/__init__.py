...
class CfnCanary(
    ...
    def __init__(
        ...
        *,
        ...
        name: str,
        run_config: typing.Union["RunConfigProperty", _IResolvable_9ceae33e],
        runtime_version: str,
    ...
    def run_config(self) -> typing.Union["RunConfigProperty", _IResolvable_9ceae33e]:
    ...
    @run_config.setter
    def run_config(
        self, value: typing.Union["RunConfigProperty", _IResolvable_9ceae33e]
    ) -> None:
...
class CfnCanaryProps:
    def __init__(
        ...
        *,
        ...
        execution_role_arn: str,
        name: str,
        run_config: typing.Union["CfnCanary.RunConfigProperty", _IResolvable_9ceae33e],
        runtime_version: str,
