...
class RadicalMaker:
    ...
    def get_word_image(self, word):
        ...
        def cv2ImgAddText(img, text, left, top, textColor=(0, 255, 0), textSize=100, font="./simsun.ttc"):
        ...
        if np.sum(word_img) == 0:
            word_img = cv2ImgAddText(canvas, word, 100, 100, self.color, 50, "./mingliub.ttc")
...
if __name__ == '__main__':
    ...
    tg = TextGenerator()
    tg.generate(num=2,color=(0,0,255))