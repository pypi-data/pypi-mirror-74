...
# @Last Modified time: 2020-07-20 23:45:23
...
class HBRequest(object):
	...
	def getGitTag(self,alreadyRecord,helloBikeToken,user_agent):
		...
		git_tag = response.get("data",[])[0].get("name","")
		alreadyRecord.git_tag = git_tag
		alreadyRecord.save()
		self.get_zip_url(self,alreadyRecord,helloBikeToken,user_agent)
		return git_tag
	...
	def get_zip_url(self,alreadyRecord,helloBikeToken,user_agent):
		...
		zip_url = response.get("data",{}).get("url","")
