...
[boto3.EC2InstanceConnect 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/ec2-instance-connect.html#EC2InstanceConnect) service
...
`mypy_boto3_ec2_instance_connect` and other installed services.
...
session_client = boto3.Session().client("ec2-instance-connect")
```
