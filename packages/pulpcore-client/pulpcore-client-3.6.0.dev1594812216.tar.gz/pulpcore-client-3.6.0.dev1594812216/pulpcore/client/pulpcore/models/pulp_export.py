...
class PulpExport(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, task=None, exported_resources=None, params=None, output_file_info=None, local_vars_configuration=None):  # noqa: E501
