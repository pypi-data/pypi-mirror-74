...
class TasksApi(object):
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['ordering', 'name__contains', 'state', 'state__in', 'worker', 'worker__in', 'started_at__lt', 'started_at__lte', 'started_at__gt', 'started_at__gte', 'started_at__range', 'finished_at__lt', 'finished_at__lte', 'finished_at__gt', 'finished_at__gte', 'finished_at__range', 'parent_task', 'child_tasks', 'task_group', 'reserved_resources_record', 'created_resources', 'name', 'started_at', 'finished_at', 'limit', 'offset', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def read_with_http_info(self, task_href, **kwargs):  # noqa: E501
        ...
        all_params = ['task_href', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def tasks_cancel(self, task_href, data, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str task_href: URI of Task. e.g.: /pulp/api/v3/tasks/1/ (required)
        :param TaskCancel data: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
