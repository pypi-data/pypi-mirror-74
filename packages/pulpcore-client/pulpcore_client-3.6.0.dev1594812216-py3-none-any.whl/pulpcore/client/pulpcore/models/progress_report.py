...
class ProgressReport(object):
    ...
    def __init__(self, message=None, code=None, state=None, total=None, done=None, suffix=None, local_vars_configuration=None):  # noqa: E501
        """ProgressReport - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def code(self):
        """Gets the code of this ProgressReport.  # noqa: E501

        Identifies the type of progress report'.  # noqa: E501

        :return: The code of this ProgressReport.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this ProgressReport.

        Identifies the type of progress report'.  # noqa: E501

        :param code: The code of this ProgressReport.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
