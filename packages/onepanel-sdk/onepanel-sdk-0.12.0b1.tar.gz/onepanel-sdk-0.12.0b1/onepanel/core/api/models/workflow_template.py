...
class WorkflowTemplate(object):
    ...
    def __init__(self, created_at=None, modified_at=None, uid=None, name=None, version=None, versions=None, manifest=None, is_latest=None, is_archived=None, labels=None, stats=None, cron_stats=None, local_vars_configuration=None):  # noqa: E501
