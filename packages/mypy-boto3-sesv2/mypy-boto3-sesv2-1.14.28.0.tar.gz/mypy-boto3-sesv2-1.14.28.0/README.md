...
[boto3.SESV2 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/sesv2.html#SESV2) service
...
`mypy_boto3_sesv2` and other installed services.
...
session_client = boto3.Session().client("sesv2")
```
