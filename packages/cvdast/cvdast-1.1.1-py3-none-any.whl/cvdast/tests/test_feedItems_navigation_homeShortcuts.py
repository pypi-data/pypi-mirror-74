...
def test_feeditems_navigation_homeshortcuts():
    data = {}
    ...
    url = Template("/v1/feedItems/navigation/homeShortcuts").render(**data)
    resp = _trigger_requests("get", url,
                      header=req["headers"],
                      data=json.dumps(data))
    print(resp.status_code)
    print(resp.text)
    assertions.assert_for_feedItems_navigation_homeShortcuts(req,resp)
