...
[boto3.ManagedBlockchain 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/managedblockchain.html#ManagedBlockchain) service
...
`mypy_boto3_managedblockchain` and other installed services.
...
session_client = boto3.Session().client("managedblockchain")
```
