...
class SenSuber(object):
    ...
    def __init__(self, req_url=f"http://model.ai-open.hrtps.com/v1/models/subsen_lstmcrf_epoch1_batch32_seq512:predict"):
    ...
    def predict(self, texts: list):
        ...
        :return:
        """
        texts = [tokenize("".join(self.format_inp(text))) for text in texts]
    ...
    def seq_sen_sub(self, texts: list):
        ...
        preds, x_datas = self.predict(texts)
