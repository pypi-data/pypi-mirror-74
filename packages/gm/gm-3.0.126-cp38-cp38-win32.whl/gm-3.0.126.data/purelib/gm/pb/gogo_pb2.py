...
goproto_getters = _descriptor.FieldDescriptor(
  name='goproto_getters', full_name='gogoproto.goproto_getters', index=35,
...
goproto_stringer = _descriptor.FieldDescriptor(
  name='goproto_stringer', full_name='gogoproto.goproto_stringer', index=36,
...
verbose_equal = _descriptor.FieldDescriptor(
  name='verbose_equal', full_name='gogoproto.verbose_equal', index=37,
...
face = _descriptor.FieldDescriptor(
  name='face', full_name='gogoproto.face', index=38,
...
gostring = _descriptor.FieldDescriptor(
  name='gostring', full_name='gogoproto.gostring', index=39,
...
populate = _descriptor.FieldDescriptor(
  name='populate', full_name='gogoproto.populate', index=40,
...
stringer = _descriptor.FieldDescriptor(
  name='stringer', full_name='gogoproto.stringer', index=41,
...
onlyone = _descriptor.FieldDescriptor(
  name='onlyone', full_name='gogoproto.onlyone', index=42,
...
equal = _descriptor.FieldDescriptor(
  name='equal', full_name='gogoproto.equal', index=43,
...
description = _descriptor.FieldDescriptor(
  name='description', full_name='gogoproto.description', index=44,
...
testgen = _descriptor.FieldDescriptor(
  name='testgen', full_name='gogoproto.testgen', index=45,
...
benchgen = _descriptor.FieldDescriptor(
  name='benchgen', full_name='gogoproto.benchgen', index=46,
...
marshaler = _descriptor.FieldDescriptor(
  name='marshaler', full_name='gogoproto.marshaler', index=47,
...
unmarshaler = _descriptor.FieldDescriptor(
  name='unmarshaler', full_name='gogoproto.unmarshaler', index=48,
...
stable_marshaler = _descriptor.FieldDescriptor(
  name='stable_marshaler', full_name='gogoproto.stable_marshaler', index=49,
...
sizer = _descriptor.FieldDescriptor(
  name='sizer', full_name='gogoproto.sizer', index=50,
...
unsafe_marshaler = _descriptor.FieldDescriptor(
  name='unsafe_marshaler', full_name='gogoproto.unsafe_marshaler', index=51,
...
unsafe_unmarshaler = _descriptor.FieldDescriptor(
  name='unsafe_unmarshaler', full_name='gogoproto.unsafe_unmarshaler', index=52,
...
goproto_extensions_map = _descriptor.FieldDescriptor(
  name='goproto_extensions_map', full_name='gogoproto.goproto_extensions_map', index=53,
...
goproto_unrecognized = _descriptor.FieldDescriptor(
  name='goproto_unrecognized', full_name='gogoproto.goproto_unrecognized', index=54,
...
protosizer = _descriptor.FieldDescriptor(
  name='protosizer', full_name='gogoproto.protosizer', index=55,
...
compare = _descriptor.FieldDescriptor(
  name='compare', full_name='gogoproto.compare', index=56,
...
typedecl = _descriptor.FieldDescriptor(
  name='typedecl', full_name='gogoproto.typedecl', index=57,
...
nullable = _descriptor.FieldDescriptor(
  name='nullable', full_name='gogoproto.nullable', index=58,
...
embed = _descriptor.FieldDescriptor(
  name='embed', full_name='gogoproto.embed', index=59,
...
customtype = _descriptor.FieldDescriptor(
  name='customtype', full_name='gogoproto.customtype', index=60,
...
customname = _descriptor.FieldDescriptor(
  name='customname', full_name='gogoproto.customname', index=61,
...
jsontag = _descriptor.FieldDescriptor(
  name='jsontag', full_name='gogoproto.jsontag', index=62,
...
moretags = _descriptor.FieldDescriptor(
  name='moretags', full_name='gogoproto.moretags', index=63,
...
casttype = _descriptor.FieldDescriptor(
  name='casttype', full_name='gogoproto.casttype', index=64,
...
castkey = _descriptor.FieldDescriptor(
  name='castkey', full_name='gogoproto.castkey', index=65,
...
castvalue = _descriptor.FieldDescriptor(
  name='castvalue', full_name='gogoproto.castvalue', index=66,
...
stdtime = _descriptor.FieldDescriptor(
  name='stdtime', full_name='gogoproto.stdtime', index=67,
...
stdduration = _descriptor.FieldDescriptor(
  name='stdduration', full_name='gogoproto.stdduration', index=68,
