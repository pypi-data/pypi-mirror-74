# -*- coding: utf-8 -*-
#
# rebookmaker documentation build configuration file, created by
...
htmlhelp_basename = 'rebookmakerdoc'
...
latex_documents = [
  ('index', 'rebookmaker.tex', u'rebookmaker Documentation',
   u'Shlomi Fish', 'manual'),
]
...
man_pages = [
    ('index', 'rebookmaker', u'rebookmaker Documentation',
     [u'Shlomi Fish'], 1)
]
