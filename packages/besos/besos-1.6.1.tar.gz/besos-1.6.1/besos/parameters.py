...
class CategoryParameter(Descriptor):
    """Represents a list of possible value of the parameter."""
...
class PathSelector(Selector):
    ...
    def __init__(self, parameter_path=None):
        ...
        :param parameter_path: :param parameter_path: the path to the parameter to modify for the EnergyHub
        """
        super().__init__()
...
@deprecated(
    reason="Use a PathSelector and a Parameter instead. These have been swapped in automatically."
)
class ParameterEH:
    mode_options = {"Set", "Multiply", "Add"}
    ...
    def __new__(
        ...
        **kwargs,
        ...
        :param parameter_path: the path to the parameter to modify for the
        EnergyHub
        :param value_descriptor: a Descriptor specifying which values to use
        :param mode: the desired transformation function to use
            Set: set the sample as the value
...
class wwrSelector(Selector):
    ...
    def set(self, building, value):
        """Sets the wwr in the building to the provided value

        :param building: the building to modify
        :param value: tha value of the wwr
        """
