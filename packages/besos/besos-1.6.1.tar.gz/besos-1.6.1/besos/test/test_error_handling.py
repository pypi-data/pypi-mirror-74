...
from parameters import CategoryParameter, FieldSelector, Parameter, RangeParameter
...
@pytest.mark.parametrize(
    ...
    [
        (0, 0, None, ()),
        (1, 0, None, (float("inf"),)),
        (2, 0, None, (float("inf"), float("inf")),),
        (2, 0, (None, None), (float("inf"), float("inf")),),
    ],
)
def test_error_objectives_both_versions(
    ...
    assert error_value_tester(
        Problem(
            0, outputs, constraints, constraint_bounds=["dummy value"] * constraints,
        ),
        error_value=error_value,
    ) == list(answer)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (3, 0, (None, None), (float("inf"), float("inf"), float("inf"),),),
        (1, 0, ((1,), ()), (1,),),
        (2, 0, ((1, 2), ()), (1, 2),),
        (1, 0, ((1,), None), (1,),),
        (2, 0, ((1, 2), None), (1, 2),),
