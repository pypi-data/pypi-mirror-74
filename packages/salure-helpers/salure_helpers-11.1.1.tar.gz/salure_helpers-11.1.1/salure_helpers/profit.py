...
import requests
import asyncio
from .salure_helpers.helpers.profit_extract_async import ProfitExtractAsync
...
class GetConnectorAsync:
    ...
    def get_data(self, connector: str, fields=None, values=None, operators=None, orderbyfields=None) -> json:
        ...
        """
        profit_async = ProfitExtractAsync(environment=self.environment, base_url=self.base_url, base64token=self.base64token)
