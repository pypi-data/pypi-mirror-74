...
class GetConnectorAsync:
    def __init__(self, environment: str, base64token: str, base_url: str = 'rest.afas.online', batch_size: int = 25, take: int = 40000):
    ...
    def get_data(self, connector: str, fields=None, values=None, operators=None, orderbyfields=None) -> json:
        """
        ...
        """
        profit_async = ProfitExtractAsync(environment=self.environment, base_url=self.base_url, base64token=self.base64token, batch_size=self.batch_size, take=self.take)
        total_response_raw = asyncio.run(
            profit_async.get_data_content(connector=connector, fields=fields, values=values, operators=operators,
    ...
    def get_meta_data(self):
        ...
        """
        return self.profit.get_metadata()
