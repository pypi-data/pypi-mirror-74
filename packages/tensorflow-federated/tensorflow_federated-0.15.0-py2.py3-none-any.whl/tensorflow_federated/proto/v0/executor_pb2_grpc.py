...
class ExecutorStub(object):
  ...
  def __init__(self, channel):
    ...
    self.CreateTuple = channel.unary_unary(
        '/tensorflow_federated.v0.Executor/CreateTuple',
        request_serializer=tensorflow__federated_dot_proto_dot_v0_dot_executor__pb2.CreateTupleRequest.SerializeToString,
        response_deserializer=tensorflow__federated_dot_proto_dot_v0_dot_executor__pb2.CreateTupleResponse.FromString,
        )
...
def add_ExecutorServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'CreateTuple': grpc.unary_unary_rpc_method_handler(
          servicer.CreateTuple,
          request_deserializer=tensorflow__federated_dot_proto_dot_v0_dot_executor__pb2.CreateTupleRequest.FromString,
          response_serializer=tensorflow__federated_dot_proto_dot_v0_dot_executor__pb2.CreateTupleResponse.SerializeToString,
      ),
