...
[boto3.Detective 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/detective.html#Detective) service
...
`mypy_boto3_detective` and other installed services.
