...
from pykrete.args import BuildMode
...
class BuildManager:
    ...
    def __init__(self, version: Version, mode=BuildMode.RELEASE):
    ...
    def run(self):
        ...
        self._build()
        self._upload(self._version.revision_type == RevisionType.Release)
    ...
    @abstractmethod
    def _upload(self, is_release):
        """Uploads the package

        :param is_release: flag this package as release
        """
