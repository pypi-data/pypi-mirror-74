...
_WRITEAHEADLOGENTRY.fields_by_name['organization_id']._options = None
_WRITEAHEADLOGENTRY.fields_by_name['source']._options = None
_WRITEAHEADLONGENTRYREQUEST.fields_by_name['log_entry']._options = None
...
_WRITEAHEADLOGPROCESSOR = _descriptor.ServiceDescriptor(
  name='WriteAheadLogProcessor',
  full_name='calixa.domain.log.WriteAheadLogProcessor',
  file=DESCRIPTOR,
  index=1,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
...
_sym_db.RegisterServiceDescriptor(_WRITEAHEADLOGPROCESSOR)

DESCRIPTOR.services_by_name['WriteAheadLogProcessor'] = _WRITEAHEADLOGPROCESSOR
