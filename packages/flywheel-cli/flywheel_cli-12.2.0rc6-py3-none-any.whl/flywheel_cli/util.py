...
import subprocess
import sys
from typing import Any, Dict, List, Iterator, Iterable, Optional
...
class SDKClient:
    ...
    def safe_lookup(self, path: List[str]) -> Any:
        ...
        path_str = "/".join(path)
        resolved = self.lookup_cache.get(path_str)
        ...
        try:
            ...
            self.lookup_cache[path_str] = resolved
    ...
    def can_import_into(  # pylint: disable=R0912
        ...
        role_ids = []
        for perm in resolved_prj.permissions:
