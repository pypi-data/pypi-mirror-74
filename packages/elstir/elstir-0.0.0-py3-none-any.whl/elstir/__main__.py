...
from elstir import __version__                            # noqa: E402
from elstir import utils                                  # noqa: E402
...
class State:
    ...
    def __init__(self, log_name='elstir', level=logging.INFO):
...
def cli():
    """
    elstir - Project documentation with Markdown.
    """
