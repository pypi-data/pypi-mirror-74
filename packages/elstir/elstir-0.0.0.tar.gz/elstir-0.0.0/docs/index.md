...
Install the `elstir` package using pip:
...
There's a single configuration file named `elstir.yml`, and a folder named
...
To get help with elstir, please use the [discussion group], [GitHub issues] or
