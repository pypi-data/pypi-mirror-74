...
install_requires = \
['django>=3.0,<3.1', 'djangorestframework>=3.11,<3.12']

extras_require = \
{'docs': ['wagtail>=2.8,<2.10',
          'sphinx>=3.0,<3.1',
          'sphinx-rtd-theme>=0.4,<0.5',
          'sphinx-autobuild>=0.7,<0.8',
          'sphinxcontrib-httpdomain>=1.7,<1.8'],
 'example': ['Pygments>=2.6,<2.7', 'wagtail>=2.8,<2.10'],
 'pygments': ['Pygments>=2.6,<2.7'],
 'tests': ['Pygments>=2.6,<2.7',
           'wagtail>=2.8,<2.10',
           'pytest>=5.4,<5.5',
