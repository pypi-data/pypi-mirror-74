...
#No poll
def topUpRetry(transData,printOut):
    result = topUp(transData["ECRREF"],inputAmountStringToLongOCT(transData["AMT"]),transData)
    return result

#No poll
def subsidyRetry(transData,printOut):
    result = topUp(transData["ECRREF"],0,transData)
    return result
