...
#
# Generated Wed Jul 15 17:21:03 2020 by generateDS.py version 2.35.24.
...
#
# Command line:
#   /root/init-build-jenkins.Go8g10/opennebula-5.12.0.1/src/oca/python/bin/generateDS -q -f -o "pyone/bindings/supbind.py" -s "pyone/bindings/__init__.py" --super="supbind" --external-encoding="utf-8" --silence ../../../share/doc/xsd/index.xsd
#
...
class MONITORINGType99Sub(TemplatedType, supermod.MONITORINGType99):
    def __init__(self, CPU=None, DISKRDBYTES=None, DISKRDIOPS=None, DISKWRBYTES=None, DISKWRIOPS=None, ID=None, MEMORY=None, NETTX=None, NETRX=None, TIMESTAMP=None, **kwargs_):
        super(MONITORINGType99Sub, self).__init__(CPU, DISKRDBYTES, DISKRDIOPS, DISKWRBYTES, DISKWRIOPS, ID, MEMORY, NETTX, NETRX, TIMESTAMP,  **kwargs_)
