...
try:
    ...
    util_send_gui_p = util_sp.add_parser('send-gui', parents=[cravat_util.parser_result2gui], add_help=False, help='Copy a command line job into the GUI submission list')
