...
import os
import time
from chilli import CairoNumberWidth as CNW
from chilli import cairo
from chilli import GelMobility
...
def main():
    size_list = [100, 114, 128, 144, 161, 179, 198, 219, 242, 266, 292, 320, 350, 383, 418, 456, 497, 541, 588, 639,
                 694, 753, 816, 885, 958, 1038, 1123, 1215, 1314, 1421, 1536, 1660, 1793]
    ...
    a = [90, 104, 119, 135, 151, 169, 189, 209, 231, 255, 283, 313, 346, 381, 416, 454, 495, 543, 595, 647, 708, 768,
         833, 910, 993, 1076, 1173, 1269, 1383, 1507, 1641, 1787, 1944]
