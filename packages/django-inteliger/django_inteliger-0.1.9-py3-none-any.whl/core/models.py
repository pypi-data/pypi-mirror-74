...
class UsrLog(models.Model):
    ...
    origem_insercao_tipo = models.CharField(null=True, max_length=200, default='USR.ORIGEM')
    ...
    origem_edicao_tipo = models.CharField(null=True, max_length=200, default='USR.ORIGEM')
    ...
    origem_delete_tipo = models.CharField(null=True, max_length=200, default='USR.ORIGEM')
