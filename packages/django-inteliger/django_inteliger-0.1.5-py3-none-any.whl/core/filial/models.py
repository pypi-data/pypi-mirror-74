...
class Filial(core.models.Log, core.models.EmpresaLog, core.models.EnderecoComplementoLog):
    ...
    servicos = models.ManyToManyField('filial.Servico', through='FilialServico', through_fields=('filial', 'servico'))
...
class FilialServico(core.models.Log):
    ...
    filial = models.ForeignKey('filial.Filial', on_delete=models.DO_NOTHING, null=True)
