...
def effector_add(
        type: typing.Union[int, str] = 'FORCE',
        radius: float = 1.0,
        view_align: bool = False,
        enter_editmode: bool = False,
        location: typing.List[float] = (0.0, 0.0, 0.0),
...
def empty_add(type: typing.Union[int, str] = 'PLAIN_AXES',
              ...
              location: typing.List[float] = (0.0, 0.0, 0.0),
              rotation: typing.List[float] = (0.0, 0.0, 0.0),
              layers: typing.List[bool] = (False, False, False, False, False,
...
def group_link(group: typing.Union[int, str] = ''):
...
def lamp_add(type: typing.Union[int, str] = 'POINT',
             radius: float = 1.0,
             view_align: bool = False,
             location: typing.List[float] = (0.0, 0.0, 0.0),
             rotation: typing.List[float] = (0.0, 0.0, 0.0),
...
def quick_fluid(style: typing.Union[int, str] = 'BASIC',
                initial_velocity: typing.List[float] = (0.0, 0.0, 0.0),
    ...
    :type initial_velocity: typing.List[float]
...
def select_by_layer(match: typing.Union[int, str] = 'EXACT',
                    extend: bool = False,
                    layers: int = 1):
    ''' Select all visible objects on a layer

    :param match: Match
    :type match: typing.Union[int, str]
...
def vertex_group_smooth(group_select_mode: typing.Union[int, str] = '',
                        ...
                        repeat: int = 1,
                        expand: float = 0.0,
                        source: typing.Union[int, str] = 'ALL'):
    ...
    :type source: typing.Union[int, str]
    '''
