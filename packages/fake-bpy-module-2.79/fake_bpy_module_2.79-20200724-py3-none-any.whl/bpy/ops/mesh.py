...
def rip(mirror: bool = False,
        proportional: typing.Union[int, str] = 'DISABLED',
    ...
    :type proportional: typing.Union[int, str]
...
def select_axis(mode: typing.Union[int, str] = 'POSITIVE',
                axis: typing.Union[int, str] = 'X_AXIS',
                threshold: float = 0.0001):
