...
def brush_change(brush: typing.Union[int, str] = 'DEFAULT'):
    ''' Change active Grease Pencil drawing brush

    :param brush: Grease Pencil Brush
    :type brush: typing.Union[int, str]
    '''
...
def brush_move(type: typing.Union[int, str] = 'UP'):
...
def move_to_layer(layer: typing.Union[int, str] = 'DEFAULT'):
...
def palette_change(palette: typing.Union[int, str] = 'DEFAULT'):
    ''' Change active Grease Pencil palette

    :param palette: Grease Pencil Palette
    :type palette: typing.Union[int, str]
    '''
...
def palettecolor_move(direction: typing.Union[int, str] = 'UP'):
...
def paste(type: typing.Union[int, str] = 'COPY'):
...
def reproject(type: typing.Union[int, str] = 'PLANAR'):
    ''' Reproject the selected strokes from the current viewpoint as if they had been newly drawn (e.g. to fix problems from accidental 3D cursor movement or accidental viewport changes, or for matching deforming geometry)

    :param type: Projection Type * PLANAR Planar, Reproject the strokes to end up on the same plane, as if drawn from the current viewpoint using 'Cursor' Stroke Placement. * SURFACE Surface, Reproject the strokes on to the scene geometry, as if drawn using 'Surface' placement.
    :type type: typing.Union[int, str]
    '''
