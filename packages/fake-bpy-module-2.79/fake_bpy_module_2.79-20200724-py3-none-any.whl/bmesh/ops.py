...
def automerge(bm: 'bmesh.types.BMesh',
    ...
    ''' Auto Merge. Finds groups of vertices closer then **dist** and merges them together, using the weld verts bmop. The merges must go from a vert not in **verts** to one in **verts**.
...
def bevel(bm: 'bmesh.types.BMesh',
          geom: typing.Union[typing.List['bmesh.types.BMEdge'], typing.
                             ...
                             List['bmesh.types.BMVert']], offset: float,
          offset_type: int, segments: int, profile: float, vertex_only: bool,
          clamp_overlap: bool, material: int, loop_slide: bool) -> dict:
...
def bisect_plane(
        ...
        Union[typing.List['bmesh.types.BMEdge'], typing.
              List['bmesh.types.BMFace'], typing.List['bmesh.types.BMVert']],
...
def delete(bm: 'bmesh.types.BMesh',
           geom: typing.Union[typing.List['bmesh.types.BMEdge'], typing.
                              List['bmesh.types.BMFace'], typing.
                              List['bmesh.types.BMVert']], context: int):
...
def extrude_face_region(
        ...
        geom: typing.Union[typing.List['bmesh.types.BMEdge'], typing.
                           List['bmesh.types.BMFace'], typing.
                           List['bmesh.types.BMVert']], edges_exclude: set,
        use_keep_orig: bool, use_select_history: bool) -> dict:
...
def similar_verts(bm: 'bmesh.types.BMesh',
    ...
    :param compare: comparison method
    :type compare: int
    :return: - verts : output vertices **type** list of ( bmesh.types.BMVert )
    '''
...
def smooth_laplacian_vert(
    ...
    ''' Vertext Smooth Laplacian. Smooths vertices by using Laplacian smoothing propose by. Desbrun, et al. Implicit Fairing of Irregular Meshes using Diffusion and Curvature Flow.
...
def spin(bm: 'bmesh.types.BMesh', geom: typing.
         ...
         space: 'mathutils.Matrix', steps: int, use_duplicate: bool) -> dict:
...
def symmetrize(bm: 'bmesh.types.BMesh',
               input: typing.Union[typing.List['bmesh.types.BMEdge'], typing.
                                   List['bmesh.types.BMFace'], typing.
                                   List['bmesh.types.BMVert']], direction: int,
               dist: float) -> dict:
