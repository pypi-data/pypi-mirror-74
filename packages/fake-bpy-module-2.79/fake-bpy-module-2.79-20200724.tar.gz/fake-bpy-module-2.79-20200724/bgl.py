...
def glAreTexturesResident(
        n: int, textures: typing.Union['bpy.context.object', 'Buffer'],
        residences: typing.Union[bool, 'bpy.context.object', 'Buffer']):
    ...
    :type residences: typing.Union[bool, 'bpy.context.object', 'Buffer']
    '''
...
def glBitmap(width: int, height: int, xorig: float, yorig: float, xmove: float,
             ymove: float,
             bitmap: typing.Union['bpy.context.object', 'Buffer']):
    ''' Draw a bitmap
    ...
    :type bitmap: typing.Union['bpy.context.object', 'Buffer']
    '''
...
def glCallLists(n: int, type: typing.Union[int, str],
                lists: typing.Union['bpy.context.object', 'Buffer']):
    ...
    :type lists: typing.Union['bpy.context.object', 'Buffer']
    '''
...
def glDrawPixels(width: int, height: int, format: typing.Union[int, str],
                 type: typing.Union[int, str],
...
def glGetPolygonStipple(mask: typing.Union['bpy.context.object', 'Buffer']):
    ''' Return the polygon stipple pattern

    :param mask: Returns the stipple pattern. The initial value is all 1's.
    :type mask: typing.Union['bpy.context.object', 'Buffer']
    '''
...
def glPolygonStipple(mask: typing.Union['bpy.context.object', 'Buffer']):
