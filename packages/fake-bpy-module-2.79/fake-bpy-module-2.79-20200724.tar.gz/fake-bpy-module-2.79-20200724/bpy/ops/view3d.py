...
def manipulator(constraint_axis: typing.List[bool] = (False, False, False),
                constraint_orientation: typing.Union[int, str] = 'GLOBAL',
    ...
    :type constraint_orientation: typing.Union[int, str]
...
def select_menu(name: typing.Union[int, str] = '', toggle: bool = False):
...
def viewnumpad(type: typing.Union[int, str] = 'LEFT',
