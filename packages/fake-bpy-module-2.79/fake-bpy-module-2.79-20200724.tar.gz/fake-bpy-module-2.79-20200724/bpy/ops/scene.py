...
def new(type: typing.Union[int, str] = 'NEW'):
    ...
    :param type: Type * NEW New, Add new scene. * EMPTY Copy Settings, Make a copy without any objects. * LINK_OBJECTS Link Objects, Link to the objects from the current scene. * LINK_OBJECT_DATA Link Object Data, Copy objects linked to data from the current scene. * FULL_COPY Full Copy, Make a full copy of the current scene.
    :type type: typing.Union[int, str]
    '''
