...
def collada_export(
        ...
        export_transformation_type_selection: typing.
        Union[int, str] = 'matrix',
        export_texture_type: int = 0,
        export_texture_type_selection: typing.Union[int, str] = 'mat',
        open_sim: bool = False,
    ...
    :type export_transformation_type_selection: typing.Union[int, str]
    ...
    :type export_texture_type_selection: typing.Union[int, str]
...
def previews_clear(id_type: typing.Union[typing.Set[int], typing.Set[str]] = {
...
def recover_auto_save(filepath: str = "",
                      ...
                      filter_blenlib: bool = False,
                      filemode: int = 8,
                      display_type: typing.Union[int, str] = 'LIST_LONG',
