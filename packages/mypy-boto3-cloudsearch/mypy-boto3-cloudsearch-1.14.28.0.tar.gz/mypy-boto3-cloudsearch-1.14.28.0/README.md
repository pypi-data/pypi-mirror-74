...
[boto3.CloudSearch 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/cloudsearch.html#CloudSearch) service
...
`mypy_boto3_cloudsearch` and other installed services.
...
session_client = boto3.Session().client("cloudsearch")
```
