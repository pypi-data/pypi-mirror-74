...
@click.pass_obj
@click.pass_context
def topology(ctx, obj):
    """DNA Center Topology API (version: 2.1.1).

    Wraps the DNA Center Topology API and exposes the API as native Python commands.

    """
    ctx.obj = obj.topology
