...
@click.pass_obj
@click.pass_context
def device_onboarding_pnp(ctx, obj):
    """DNA Center Device Onboarding (PnP) API (version: 2.1.1).

    Wraps the DNA Center Device Onboarding (PnP) API and exposes the API as native Python commands.

    """
    ctx.obj = obj.device_onboarding_pnp


@device_onboarding_pnp.command()
