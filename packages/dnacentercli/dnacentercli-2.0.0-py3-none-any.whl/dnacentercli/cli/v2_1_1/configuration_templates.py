...
@click.pass_obj
@click.pass_context
def configuration_templates(ctx, obj):
    """DNA Center Configuration Templates API (version: 2.1.1).

    Wraps the DNA Center Configuration Templates API and exposes the API as native Python commands.

    """
    ctx.obj = obj.configuration_templates


@configuration_templates.command()
