...
"""
    ...
    The version of the OpenAPI document: 1.39.3
...
class ApiResponseConnectorResponse(object):
    ...
    def __init__(self, input=None, mapping_name=None, api=None, api_doc_link=None, http_request_raw_data=None, code=None, response=None, response_en=None, platform=None, request_count=None, response_time=None, local_vars_configuration=None):  # noqa: E501
    ...
    def input(self):
        ...
        The input of a NomadMapping, usually it's JSON format.  # noqa: E501
    ...
    @property
    def api_doc_link(self):
        """Gets the api_doc_link of this ApiResponseConnectorResponse.  # noqa: E501

        The link of current mapping, usually a url.  # noqa: E501

        :return: The api_doc_link of this ApiResponseConnectorResponse.  # noqa: E501
        :rtype: str
        """
        return self._api_doc_link

    @api_doc_link.setter
    def api_doc_link(self, api_doc_link):
        """Sets the api_doc_link of this ApiResponseConnectorResponse.

        The link of current mapping, usually a url.  # noqa: E501

        :param api_doc_link: The api_doc_link of this ApiResponseConnectorResponse.  # noqa: E501
        :type: str
        """

        self._api_doc_link = api_doc_link
    ...
    def response_time(self):
        ...
        The response time of current NomadMapping request, including sub-NomadMapping. The time unit is millisecond.  # noqa: E501
