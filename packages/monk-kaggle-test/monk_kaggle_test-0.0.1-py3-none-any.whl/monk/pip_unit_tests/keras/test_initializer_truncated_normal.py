...
def test_initializer_truncated_normal(system_dict):
    forward = True;

    test = "test_initializer_truncated_normal";
    ...
    if(forward):
        try:
            ...
            gtf.Compile_Network(network, data_shape=(3, 32, 32), network_initializer="truncated_normal");
