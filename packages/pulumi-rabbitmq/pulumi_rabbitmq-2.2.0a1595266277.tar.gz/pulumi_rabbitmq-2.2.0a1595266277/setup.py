...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', '2.2.0-alpha.1595266277+4e0cdac8'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq 2.2.0-alpha.1595266277+4e0cdac8`
                """)
            else:
                raise
