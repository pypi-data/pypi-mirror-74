...
""" * Struct(
    ...
    "is_64bit" / Int32ul,
    "computer_name" / PaddedString(0x20, "UTF_16_le"),
    "system_root" / PaddedString(0x208, "UTF_16_le"),
    ...
    "windows_major_number" / Int32ul,
    "windows_minor_number" / Int32ul,
    "windows_build_number" / Int32ul,
    "windows_build_number_after_decimal_point" / Int32ul,
    "service_pack_name" / PaddedString(0x32, "UTF-16_le"),
    "reserved4" / Bytes(0xd6) * "!!Unknown field!!",
    "number_of_logical_processors" / Int32ul,
    "ram_memory_size" / Int64ul,
    "header_size" / Int64ul,
    "hosts_and_ports_tables_offset" / Int64ul,

    "header_end_offset" / Tell,

    CheckCustom(lambda this: this.events_offset == this.header_size == this.header_end_offset,
