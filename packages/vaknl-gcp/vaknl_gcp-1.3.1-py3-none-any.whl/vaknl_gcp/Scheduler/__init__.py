    ...
    def get_schedulers(self):
        ...
        for element in super().list_jobs(self.parent):
            ...
            if element.pubsub_target.topic_name:
                ...
                result.append(PubSub(name=name, cors=element.schedule, description=description,
                ...
                result.append(AppEngine(name=name, cors=element.schedule, description=description,
                ...
                result.append(HTTP(name=name, cors=element.schedule, description=description,
