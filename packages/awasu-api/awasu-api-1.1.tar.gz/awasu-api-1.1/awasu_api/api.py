...
class AwasuApi( object ) : #pylint: disable=too-many-public-methods
    ...
    def get_channel_summary( self , id ) : #pylint: disable=redefined-builtin
        ...
        if isinstance(id,list) : raise AwasuApiException("Can't get multiple channels.")
    ...
    def get_report( self , id ) : #pylint: disable=redefined-builtin
        ...
        if isinstance(id,list) : raise AwasuApiException("Can't get multiple reports.")
    ...
    def get_workpad( self , id ) : #pylint: disable=redefined-builtin
        ...
        if isinstance(id,list) : raise AwasuApiException("Can't get multiple workpads.")
    ...
    def __str__( self ) : return "AwasuApi @ {}".format( self.api_url )
