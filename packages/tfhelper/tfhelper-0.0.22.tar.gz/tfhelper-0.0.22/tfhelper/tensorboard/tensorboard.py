...
class ModelSaverCallback(tf.keras.callbacks.Callback):
    def __init__(self, best_metric=float('inf'), save_root="./", save_metric='val_loss', enable=True, epoch=0):
        ...
        :param best_metric: Set best score of previous training session if resuming
        :param save_root: Model save path
        :param save_metric: One of 'val_loss', 'val_accuracy'
        :param enable: (bool)
        :param epoch: Set previous epoch number if resuming
        """
