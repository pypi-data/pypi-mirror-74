...
class ConfuseCallback(tf.keras.callbacks.Callback):
    ...
    def __init__(self, x_test, y_test, file_writer, class_names=None, figure_size=(12, 10), batch_size=32):
...
def get_tf_callbacks(root,
                     ...
                     confuse_callback=True, label_info=None, x_test=None, y_test=None, test_generator_=None, figure_size=(12, 10),
