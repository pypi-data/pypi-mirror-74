...
class mesh(static_factory):
    ...
    def create_from_data(*args, **kwargs):
        ...
        :type normals: std::vector< glm::vec4,std::allocator< glm::vec4 > >, optional
        :param normals: A list of 3D vertex normals. If indices aren't supplied, this must be a multiple of 3.
        :type colors: std::vector< glm::vec4,std::allocator< glm::vec4 > >, optional
        :param colors: A list of per-vertex colors. If indices aren't supplied, this must be a multiple of 3.
        :type texcoords: std::vector< glm::vec2,std::allocator< glm::vec2 > >, optional
