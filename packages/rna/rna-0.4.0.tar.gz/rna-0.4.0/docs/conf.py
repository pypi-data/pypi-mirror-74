...
def setup(app):
    ...
    if os.path.basename(os.path.abspath(".")) == "docs":
        subprocess.call(
            [
                "sphinx-apidoc",
                "-o",
...
latex_documents = [
    (master_doc, "rna.tex", "rna Documentation", "Daniel Böckenhoff", "manual"),
]
...
man_pages = [(master_doc, "rna", "rna Documentation", [author], 1)]
