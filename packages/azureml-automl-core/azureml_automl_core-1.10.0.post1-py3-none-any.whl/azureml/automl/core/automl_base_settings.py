...
from azureml.automl.core.shared._diagnostics.automl_error_definitions import InvalidArgumentWithSupportedValues, \
    InvalidArgumentType, FeatureUnsupportedForIncompatibleArguments, AllowedModelsSubsetOfBlockedModels, \
    AllAlgorithmsAreBlocked, NonDnnTextFeaturizationUnsupported, ConflictingValueForArguments
from azureml.automl.core.shared import constants, logging_utilities
from azureml.automl.core.shared import log_server
from azureml.automl.core.shared.constants import ModelNameMappings, SupportedModelNames, TimeSeries
...
class AutoMLBaseSettings:
    ...
    def __init__(self,
        ...
        if is_timeseries:
            forecasting_parameters = kwargs.pop(constants.TimeSeries.FORECASTING_PARAMETERS, None)
            if forecasting_parameters is None:
                ...
                forecasting_parameters = ForecastingParameters.from_parameters_dict(kwargs, True)
            ...
            self.country_or_region = forecasting_parameters.holiday_country
            ...
            self.short_series_handling = forecasting_parameters.short_series_handling
    ...
    def _verify_settings(self):
        ...
        if self.enable_onnx_compatible_models:
            ...
            if sys.version_info >= OnnxConvertConstants.OnnxIncompatiblePythonVersion:
                incompatibility_reasons.append("Python Version >= 3.8")
            if self.is_timeseries:
