...
class ForecastingParameters:
    DEPRECATED_DICT = {
        ...
        TimeSeries.COUNTRY_OR_REGION: TimeSeries.HOLIDAY_COUNTRY,
        TimeSeries.COUNTRY: TimeSeries.HOLIDAY_COUNTRY
    }
    ...
    def __init__(
            ...
            seasonality: Optional[int] = TimeSeriesInternal.SEASONALITY_VALUE_DEFAULT,
        ...
        self._holiday_country = holiday_country
    ...
    def holiday_country(self) -> Optional[str]:
        ...
        """
        return self._holiday_country

    @holiday_country.setter
    def holiday_country(self, holiday_country: Optional[str]) -> None:
        self._holiday_country = holiday_country
    ...
    def seasonality(self) -> Optional[int]:
        """
        Set time series seasonality. If seasonality is set to -1, it will be inferred.
        If use_stl is not set, this parameter will not be used.
        """
        return self._seasonality

    @seasonality.setter
    def seasonality(self, seasonality: Optional[int]) -> None:
        self._seasonality = seasonality
        ...
        for param in TimeSeries.ALL_FORECASTING_PARAMETERS:
            ...
            if param in parameter_dict:
                ...
                if param in ForecastingParameters.DEPRECATED_DICT.keys():
                    ...
                    if new_param in parameter_dict:
    ...
    def _check_column_name_type(self, col_name: Any, target: str, reference_code: str) -> None:
        logger.error("Incorrect type for time_series_id_column_names. Expected string, list of strings or None.")
        if not isinstance(col_name, str):
            raise ConfigException._with_error(
                AzureMLError.create(
                    InvalidArgumentType, actual_type=type(col_name), expected_types="str",
