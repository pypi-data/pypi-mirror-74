...
class RichTextarea(forms.Textarea):
    template_name = 'django-richtexteditor/forms/widgets/richtextarea.html'
    ...
    # def get_context(self, name, value, attrs):
        ...
        # if DISTRIBUTION == 'inline':
            # id = self.build_attrs(attrs).get('id')
    ...
    def build_config(self):
                ...
                'v5': {
                    'classic': {
                        ...
                        'js': {
                            ...
                            'init-script': 'the init-script file ..',
                        }
                    }
                }
            }
        ...
        # Based on User Config, we need to build our Default Config
        DEFAULT_CONFIG = {}
    ...
    def media(self):
        ...
        # CONFIG is a Valid Config dictionnary, so we don't need to check it again!
        CONFIG = self.build_config()
        ...
        css = {}
        css = {'all': [CONFIG[EDITOR][VERSION][DISTRIBUTION]['css']]}
