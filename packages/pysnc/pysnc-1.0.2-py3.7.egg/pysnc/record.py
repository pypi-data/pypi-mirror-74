...
class GlideRecord(object):
    ...
    def update(self, reason=None):
        ...
        :param reason: Not supported. Can probably remove this parameter.
        ...
        if reason:
            self._log.warning("Update reason not supported!")
    ...
    def set_display_value(self, field, value):
        ...
        if isinstance(obj[field], dict):
            obj[field]['display_value'] = value
        else:
            obj[field] = dict(display_value=value)
    ...
    def _serialize(self, record, display_value, fields=None):
            ...
            for key, value in obj.items():
                ...
                if isinstance(value, dict):
                    if v_type == 'both':
                        ...
                        ret[key] = value[v_type]
                elif isinstance(value, GlideRecord):
                    ret[key] = value.serialize(display_value=display_value)
                elif isinstance(value, list):
                    transform = []
                    for e in value:
                        if isinstance(e, GlideRecord):
                            transform.append(e.serialize(display_value=display_value))
                        # TODO: support this
    ...
    def serialize(self, display_value=False, fields=None, fmt=None):
        """
        ...
        if fmt == 'pandas':
            ...
            c = self._current()
            return self._serialize(c, display_value, fields)
