...
class ContentPackageIndicesApi(object):
    ...
    def create(self, data, **kwargs):  # noqa: E501
        ...
        A ViewSet for PackageIndex.  # noqa: E501
        ...
        :param DebPackageIndex data: (required)
    ...
    def create_with_http_info(self, data, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(DebPackageIndex, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/content/deb/package_indices/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='DebPackageIndex',  # noqa: E501
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/content/deb/package_indices/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read(self, package_index_href, **kwargs):  # noqa: E501
        """Inspect a package index  # noqa: E501

        A ViewSet for PackageIndex.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(package_index_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str package_index_href: URI of Package Index. e.g.: /pulp/api/v3/content/deb/package_indices/1/ (required)
        :param str fields: A list of fields to include in the response.
        :param str exclude_fields: A list of fields to exclude from the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(package_index_href, **kwargs)  # noqa: E501

    def read_with_http_info(self, package_index_href, **kwargs):  # noqa: E501
        """Inspect a package index  # noqa: E501

        A ViewSet for PackageIndex.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(package_index_href, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['package_index_href', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('package_index_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['package_index_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `package_index_href` when calling `read`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'package_index_href' in local_var_params:
            path_params['package_index_href'] = local_var_params['package_index_href']  # noqa: E501
