import sys
from e_drone_nightly.drone import *
from e_drone_nightly.tools.update import Updater
from e_drone_nightly.gui.card import CardReader
from e_drone_nightly.gui.cards import CardReaderAndList
...
class Parser():
    ...
    def run(self):
        ...
        if (self.count > 0) and (self.arguments != None):
            ...
            # >python -m e_drone request RawCard 10 0.2
            elif    ((self.count == 4) and 
                    (self.arguments[0] == "request") and
            ...
            # >python -m e_drone request RawCardRange 10 0.2
            elif    ((self.count == 4) and 
                    (self.arguments[0] == "request") and
            ...
            # 조종
            # python -m e_drone control [accel] [wheel] [time(msec)]
    ...
    def controlPositionDriveMove(self, x, y, velocity):
        ...
        # 데이터 요청
        drone.sendControlPositionDriveMove(x, y, velocity)
        sleep(0.1)


    def controlPositionDriveHeading(self, heading, rotationalVelocity):
        ...
        # 데이터 요청
        drone.sendControlPositionDriveHeading(heading, rotationalVelocity)
        sleep(0.1)
    ...
    def help(self):
        ...
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drone " + Fore.CYAN + "card" + Style.RESET_ALL)
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drone " + Fore.CYAN + "cards" + Style.RESET_ALL)
