...
@input_mapper(input_file='orientations_coordinate_system.txt', task='estimate_ODF', method='from_CTF_file')
@input_mapper(input_file='orientations_coordinate_system.txt', task='estimate_ODF', method='from_CRC_file')
def write_orientations_coordinate_system(path, orientations_coordinate_system):
    with Path(path).open('w') as handle:
        json.dump(orientations_coordinate_system, handle)


def read_orientations_coordinate_system(path):
