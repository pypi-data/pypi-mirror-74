...
[boto3.SMSVoice 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/sms-voice.html#SMSVoice) service
...
`mypy_boto3_sms_voice` and other installed services.
...
session_client = boto3.Session().client("sms-voice")
```
