...
ConnectionTypeDef = TypedDict(
    "ConnectionTypeDef",
    {
        "Name": str,
        "Description": str,
        "ConnectionType": Literal["JDBC", "SFTP", "MONGODB", "KAFKA"],
...
WorkflowRunTypeDef = TypedDict(
    "WorkflowRunTypeDef",
    {
        ...
        "StartedOn": datetime,
        "CompletedOn": datetime,
        "Status": Literal["RUNNING", "COMPLETED", "STOPPING", "STOPPED"],
...
GetConnectionsFilterTypeDef = TypedDict(
    "GetConnectionsFilterTypeDef",
    {"MatchCriteria": List[str], "ConnectionType": Literal["JDBC", "SFTP", "MONGODB", "KAFKA"]},
    total=False,
)
