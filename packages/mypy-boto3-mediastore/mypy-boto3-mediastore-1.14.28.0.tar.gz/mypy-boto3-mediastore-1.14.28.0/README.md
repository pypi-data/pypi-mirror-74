...
[boto3.MediaStore 1.14.28](https://boto3.amazonaws.com/v1/documentation/api/1.14.28/reference/services/mediastore.html#MediaStore) service
...
`mypy_boto3_mediastore` and other installed services.
...
session_client = boto3.Session().client("mediastore")
```
