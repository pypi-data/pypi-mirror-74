...
class GetObjectRelationshipCommand(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = 'Get configuration of the specified object replication ' 'relationship.'
...
class AbortObjectReplicationCommand(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = (
        'Abort ongoing replication for the specified object '
...
class ListObjectRelationshipStatusesCommand(qumulo.lib.opts.Subcommand):
    ...
    SYNOPSIS = 'List the status for all existing object replication ' 'relationships.'
