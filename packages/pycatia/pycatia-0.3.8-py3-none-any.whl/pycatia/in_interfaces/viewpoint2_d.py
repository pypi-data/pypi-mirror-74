...
class Viewpoint2D(AnyObject):
    ...
    def get_origin(self, o_origin):
        ...
        :return: None
        """
        return self.viewpoint2_d.GetOrigin(o_origin)
        ...
        # # vba_code = """
        # # Public Function get_origin(viewpoint2_d)
        # #     Dim oOrigin (2)
        # #     viewpoint2_d.GetOrigin oOrigin
        # #     get_origin = oOrigin
        # # End Function
        # # """
    ...
    def put_origin(self, o_origin):
        ...
        :return: None
        """
        return self.viewpoint2_d.PutOrigin(o_origin)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
        ...
        # # vba_code = """
        # # Public Function put_origin(viewpoint2_d)
        # #     Dim oOrigin (2)
        # #     viewpoint2_d.PutOrigin oOrigin
        # #     put_origin = oOrigin
        # # End Function
        # # """
