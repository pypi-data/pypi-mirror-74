...
class DrawingText(AnyObject):
    ...
    def set_parameter_on_sub_string(self, i_param: int, i_first: int, inb_character: int, i_val: int) -> None:
        ...
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
        # # vba_function_name = 'set_parameter_on_sub_string'
        # # vba_code = """
        # # Public Function set_parameter_on_sub_string(drawing_text)
        # #     Dim iParam (2)
        # #     drawing_text.SetParameterOnSubString iParam
        # #     set_parameter_on_sub_string = iParam
        # # End Function
        # # """
